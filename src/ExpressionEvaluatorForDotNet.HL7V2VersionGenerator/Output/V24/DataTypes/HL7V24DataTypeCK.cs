...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V24DataTypeCK
    {
        ...
        public string Description { get { return @"This data type is used only in CDM-11-Contract number as defined in chapter 8, section 8.10.2.11. If a site is not using check digits for a particular CK field, the second and third components are not valued. 
