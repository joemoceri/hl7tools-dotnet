...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V24DataTypeCQ
    {
        ...
        public string Description { get { return @"Note: In future versions, CQ fields should be avoided because the same data can usually be sent as two separate fields, one with the value and one with the units as a CE data type.
