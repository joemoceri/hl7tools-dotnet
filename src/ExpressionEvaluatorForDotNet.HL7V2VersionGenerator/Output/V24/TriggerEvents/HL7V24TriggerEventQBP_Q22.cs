...
{
    public class HL7V24TriggerEventQBP_Q22
    {
...
public HL7V24SegmentDSC dsc{ get; init; }
        ...
        public string EventDescription { get { return @"Query - Find Candidates"; } }
        ...
        public HL7V24TriggerEventQBP_Q22(HL7V2Message message)
        {
