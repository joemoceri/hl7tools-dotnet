...
{
    public class HL7V24TriggerEventMFR_M11
    {
...
public HL7V24SegmentDSC dsc{ get; init; }
        ...
        public string Id { get { return @"MFR_M11"; } }
        public string MessageStructureId { get { return @"MFR_M11"; } }
        public string EventDescription { get { return @"Master Files Response - Test/calculated observations master file"; } }
        ...
        public HL7V24TriggerEventMFR_M11(HL7V2Message message)
        {
