...
{
    public class HL7V24TriggerEventMFQ_M10
    {
...
public HL7V24SegmentDSC dsc{ get; init; }
        ...
        public string EventDescription { get { return @"Master files query - Test/observation batteries master file"; } }
        ...
        public HL7V24TriggerEventMFQ_M10(HL7V2Message message)
        {
