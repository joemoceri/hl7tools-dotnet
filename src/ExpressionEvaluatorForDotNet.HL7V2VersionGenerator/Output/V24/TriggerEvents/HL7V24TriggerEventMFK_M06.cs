...
{
    public class HL7V24TriggerEventMFK_M06
    {
...
public readonly HL7V24SegmentMFA mfa;
        ...
        public string EventDescription { get { return @"Master file acknowledgment - Clinical study with phases and schedules master file"; } }
        ...
        public HL7V24TriggerEventMFK_M06(HL7V2Message message)
        {
