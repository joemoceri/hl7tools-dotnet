...
{
    public class HL7V24TriggerEventMFQ_M03
    {
...
public HL7V24SegmentDSC dsc{get; init;}
        ...
        public string EventDescription { get { return @"Master files query - Service/test/observation master file"; } }
        ...
        public HL7V24TriggerEventMFQ_M03(HL7V2Message message)
        {
