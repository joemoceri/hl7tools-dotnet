...
{
    public class HL7V24TriggerEventMFQ_M06
    {
...
public HL7V24SegmentDSC dsc{get; init;}
        ...
        public string EventDescription { get { return @"Master files query - Clinical study with phases and schedules master file"; } }
        ...
        public HL7V24TriggerEventMFQ_M06(HL7V2Message message)
        {
