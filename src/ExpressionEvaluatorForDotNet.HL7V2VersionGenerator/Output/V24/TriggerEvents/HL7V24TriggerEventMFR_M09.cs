...
{
    public class HL7V24TriggerEventMFR_M09
    {
...
private readonly HL7V24SegmentDSC dsc;
        ...
        public string EventDescription { get { return @"Master Files Response - Test/observation (categorical) master file"; } }
        ...
        public HL7V24TriggerEventMFR_M09(HL7V2Message message)
        {
