...
{
    public class HL7V24TriggerEventMFR_M03
    {
...
public HL7V24SegmentDSC dsc{ get; init; }
        ...
        public string EventDescription { get { return @"Master Files Response - Service/test/observation master file"; } }
        ...
        public HL7V24TriggerEventMFR_M03(HL7V2Message message)
        {
