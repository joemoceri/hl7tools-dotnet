...
{
    public class HL7V24TriggerEventRSP_K22
    {
...
public HL7V24SegmentDSC dsc{ get; init; }
        ...
        public string EventDescription { get { return @"Response - Find candidates"; } }
        ...
        public HL7V24TriggerEventRSP_K22(HL7V2Message message)
        {
