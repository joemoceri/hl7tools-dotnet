...
{
    public class HL7V24TriggerEventMFQ_M07
    {
...
private readonly HL7V24SegmentDSC dsc;
        ...
        public string EventDescription { get { return @"Master files query - Clinical study without phases but with schedules master file"; } }
        ...
        public HL7V24TriggerEventMFQ_M07(HL7V2Message message)
        {
