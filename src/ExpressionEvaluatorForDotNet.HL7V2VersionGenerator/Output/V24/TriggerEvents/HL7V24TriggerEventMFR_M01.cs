...
{
    public class HL7V24TriggerEventMFR_M01
    {
...
private readonly HL7V24SegmentDSC dsc;
        ...
        public string EventDescription { get { return @"Master Files Response - Master file not otherwise specified"; } }
        ...
        public HL7V24TriggerEventMFR_M01(HL7V2Message message)
        {
