...
{
    public class HL7V24TriggerEventMFQ_M11
    {
...
public HL7V24SegmentDSC dsc{ get; init; }
        ...
        public string EventDescription { get { return @"Master files query - Test/calculated observations master file"; } }
        ...
        public HL7V24TriggerEventMFQ_M11(HL7V2Message message)
        {
