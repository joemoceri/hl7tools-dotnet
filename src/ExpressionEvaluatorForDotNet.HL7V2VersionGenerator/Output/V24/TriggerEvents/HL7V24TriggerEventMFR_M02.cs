...
{
    public class HL7V24TriggerEventMFR_M02
    {
...
private readonly HL7V24SegmentDSC dsc;
        ...
        public string Id { get { return @"MFR_M02"; } }
        public string MessageStructureId { get { return @"MFR_M02"; } }
        public string EventDescription { get { return @"Master Files Response - Staff/practitioner master file"; } }
        ...
        public HL7V24TriggerEventMFR_M02(HL7V2Message message)
        {
