...
{
    public class HL7V24TriggerEventMFQ_M04
    {
...
public readonly HL7V24SegmentDSC dsc;
        ...
        public string EventDescription { get { return @"Master files query - Charge description master file"; } }
        ...
        public HL7V24TriggerEventMFQ_M04(HL7V2Message message)
        {
