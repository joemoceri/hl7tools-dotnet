...
{
    public class HL7V24TriggerEventRTB_Q13
    {
...
public HL7V24SegmentDSC dsc{ get; init; }
        ...
        public string Id { get { return @"RTB_Q13"; } }
        public string MessageStructureId { get { return @"RTB_Q13"; } }
        public string EventDescription { get { return @"Tabular response"; } }
        ...
        public HL7V24TriggerEventRTB_Q13(HL7V2Message message)
        {
