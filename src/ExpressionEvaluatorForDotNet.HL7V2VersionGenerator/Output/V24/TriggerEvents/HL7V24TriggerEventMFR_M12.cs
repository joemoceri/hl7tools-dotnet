...
{
    public class HL7V24TriggerEventMFR_M12
    {
...
public HL7V24SegmentDSC dsc{ get; init; }
        ...
        public string Id { get { return @"MFR_M12"; } }
        public string MessageStructureId { get { return @"MFR_M12"; } }
        public string EventDescription { get { return @"Master Files Response - Service/text/observation master file"; } }
        ...
        public HL7V24TriggerEventMFR_M12(HL7V2Message message)
        {
