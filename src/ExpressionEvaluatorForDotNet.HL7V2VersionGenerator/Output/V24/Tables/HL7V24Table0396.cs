                ...
                return new[]
                    {
                        ...
                        new HL7V2TableEntry
                        {
                            ...
                            Comment = @"Public Health Practice Program Office, Centers for Disease Control and Prevention, 4770 Buford Highway, Atlanta, GA, 30421.  Also available via FTP: ftp.cdc.gov/pub/laboratory _info/CLIA and Gopher: gopher.cdc.gov:70/11/laboratory_info/CLIA"
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"CDS",
                        ...
                        new HL7V2TableEntry
                        {
                            ...
                            Comment = @"From the Message Standards Classes table of the SNOMED-DICOM-Microglossary. College of American Pathologists, Skokie, IL, 60077-1034"
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"DCM",
                            Description = @"DICOM modality codes",
                            Comment = @"Dean Bidgood, MD; Duke University Medical Center, Durham NC. Digital Imaging and Communications in Medicine (DICOM).  From NEMA Publications PS-3.1 - PS 3.12: The ACR-NEMA DICOM Standard. National Electrical Manufacturers Association (NEMA). Rosslyn, VA, 22209., 1992, 1993, 1995"
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"DQL",
                            Description = @"DICOM Query Label",
                            Comment = @"HL7 Image Management Special Interest Group, Health Level Seven, Ann Arbor, MI."
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"E",
                        ...
                        {
                            Value = @"HCPCS",
                            Description = @"HCFA Common Procedure Coding System",
                        ...
                        {
                            Value = @"HPC",
                            Description = @"HCFA Procedure Codes (HCPCS)",
                            Comment = @"Health Care Financing Administration (HCFA) Common Procedure Coding System (HCPCS) including modifiers.[4]"
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"I10",
                        ...
                        new HL7V2TableEntry
                        {
                            ...
                            Comment = @"Procedure Coding System (ICD-10-PCS.)  See http://www/hcfa.gov/stats/icd10.icd10.htm for more information."
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"I9",
                        ...
                        new HL7V2TableEntry
                        {
                            Value = @"IBT",
                            Description = @"ISBT",
                            Comment = @"International Society of Blood Transfusion.  Blood Group Terminology 1990.  VOX Sanquines 1990 58(2):152-169."
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"IC2",
                        ...
                        new HL7V2TableEntry
                        {
                            ...
                            Comment = @"Clinical examination classification code.  Japan Association of Clinical Pathology.  Version 8, 1990.  A multiaxial code  including a subject code (e.g., Rubella = 5f395, identification code (e.g., virus ab IGG), a specimen code (e.g., serum =023) and a method code (e.g., ELISA = 022)"
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"LB",
                        ...
                        new HL7V2TableEntry
                        {
                            ...
                            Comment = @"Regenstrief Institute, c/o LOINC, 1050 Wishard Blvd., 5th floor, Indianapolis, IN  46202.  317/630-7433.   Available from the Regenstrief Institute server at http://www. Regenstrief.org/loinc/loinc.htm.  Also available via HL7 file server: FTP/Gopher (www.mcis.duke.edu/standards/ termcode/loinclab and www.mcis.duke.edu/standards/termcode/loinclin ) and World Wide Web ( http:// www.mcis.duke.edu/ standards/termcode/loincl.htm ).   January 2000 version has identifiers, synonyms and cross-reference codes for reporting over 26,000 laboratory and related observations and 1,500 clinical measures."
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"MCD",
                        ...
                        new HL7V2TableEntry
                        {
                            ...
                            Comment = @"Dr. Louise Wood, Medicines Control Agency, Market Towers, 1 Nine Elms Lane, London SW85NQ, UK   Tel: (44)0 171-273-0000 WWW:  http://www.open.gov.uk/mca/mcahome.htm"
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"MEDX",
                        ...
                        new HL7V2TableEntry
                        {
                            ...
                            Comment = @"Health Care Finance Administration, US Dep’t. of Health and Human Services, 7500 Security Blvd., Baltimore, MD 21244."
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"OHA",
                        ...
                        new HL7V2TableEntry
                        {
                            ...
                            Comment = @"HCFA Place of Service Codes for Professional Claims (see http://www.hcfa.gov/medicare/poscode.htm )."
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"RC",
                        ...
                        new HL7V2TableEntry
                        {
                            Value = @"UMD",
                            Description = @"MDNS",
                            Comment = @"Universal Medical Device Nomenclature System.  ECRI, 5200 Butler Pike, Plymouth Meeting, PA  19462 USA.  Phone: 215-825-6000, Fax: 215-834-1275."
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"UML",
                        ...
                        new HL7V2TableEntry
                        {
                            Value = @"UPIN",
                            Description = @"UPIN",
                            Comment = @"Medicare/HCFA’s universal physician identification numbers, available from Health Care Financing Administration, U.S. Dept. of Health and Human Services, Bureau of Program Operations, 6325 Security Blvd., Meadows East Bldg., Room 300, Baltimore, MD 21207"
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"W1",
