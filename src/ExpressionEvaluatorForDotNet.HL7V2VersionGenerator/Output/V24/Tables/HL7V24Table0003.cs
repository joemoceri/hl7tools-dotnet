                ...
                return new[]
                    {
                        ...
                        {
                            Value = @"K11",
                            Description = @"RSP - Segment pattern response",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"K13",
                            Description = @"RTB - Tabular response",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"K15",
                            Description = @"RDY - Display response",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                        ...
                        {
                            Value = @"QNC",
                            Description = @"Varies - Query cancellation",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
