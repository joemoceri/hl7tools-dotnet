...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V24SegmentOM6
    {
        ...
        public string LongName { get { return @"Observations that are Calculated from Other Observ"; } }
...
The Technical Steward for the OM6 segment is ORDERS."; } }
        ...
        public HL7V24SegmentOM6(HL7V2Message message)
        {
...
internal HL7V24Field _derivationRule;

public HL7V24Field DerivationRule
{
    get
    {
        ...
        _derivationRule = new HL7V24Field
        {
            field = message[@"OM6"][2],
            fieldData = fieldData
        };
        ...
        {
            _derivationRule.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_derivationRule, fieldData);
        }
