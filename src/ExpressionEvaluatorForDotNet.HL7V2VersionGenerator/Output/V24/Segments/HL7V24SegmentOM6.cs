...
internal HL7V24Field derivationRule;
...
public HL7V24Field DerivationRule
{
    get
    {
        ...
        derivationRule = new HL7V24Field
        {
            field = message[@"OM6"][2],
            Id = @"OM6.2",
            Type = @"Field",
        ...
        if (derivationRule.field.FieldRepetitions != null && derivationRule.field.FieldRepetitions.Count > 0)
        {
            ...
            derivationRule.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(derivationRule, fieldData);
        }
