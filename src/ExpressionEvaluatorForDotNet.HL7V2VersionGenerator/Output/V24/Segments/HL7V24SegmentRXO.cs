...
public HL7V24Field RequestedGiveCode
{
    get
    {
        ...
        if (requestedGiveCode.field.FieldRepetitions != null && requestedGiveCode.field.FieldRepetitions.Count > 0)
        {
            ...
            requestedGiveCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(requestedGiveCode, fieldData);
        }
...
public HL7V24Field RequestedGiveAmountMinimum
{
    get
    {
        ...
        if (requestedGiveAmountMinimum.field.FieldRepetitions != null && requestedGiveAmountMinimum.field.FieldRepetitions.Count > 0)
        {
            ...
            requestedGiveAmountMinimum.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(requestedGiveAmountMinimum, fieldData);
        }
...
public HL7V24Field RequestedGiveAmountMaximum
{
    get
    {
        ...
        if (requestedGiveAmountMaximum.field.FieldRepetitions != null && requestedGiveAmountMaximum.field.FieldRepetitions.Count > 0)
        {
            ...
            requestedGiveAmountMaximum.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(requestedGiveAmountMaximum, fieldData);
        }
...
public HL7V24Field RequestedGiveUnits
{
    get
    {
        ...
        if (requestedGiveUnits.field.FieldRepetitions != null && requestedGiveUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            requestedGiveUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(requestedGiveUnits, fieldData);
        }
...
public HL7V24Field RequestedDosageForm
{
    get
    {
        ...
        if (requestedDosageForm.field.FieldRepetitions != null && requestedDosageForm.field.FieldRepetitions.Count > 0)
        {
            ...
            requestedDosageForm.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(requestedDosageForm, fieldData);
        }
...
public HL7V24Field ProvidersPharmacyTreatmentInstructions
{
    get
    {
        ...
        if (providersPharmacyTreatmentInstructions.field.FieldRepetitions != null && providersPharmacyTreatmentInstructions.field.FieldRepetitions.Count > 0)
        {
            ...
            providersPharmacyTreatmentInstructions.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(providersPharmacyTreatmentInstructions, fieldData);
        }
...
public HL7V24Field AllowSubstitutions
{
    get
    {
        ...
        if (allowSubstitutions.field.FieldRepetitions != null && allowSubstitutions.field.FieldRepetitions.Count > 0)
        {
            ...
            allowSubstitutions.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(allowSubstitutions, fieldData);
        }
...
public HL7V24Field RequestedDispenseCode
{
    get
    {
        ...
        if (requestedDispenseCode.field.FieldRepetitions != null && requestedDispenseCode.field.FieldRepetitions.Count > 0)
        {
            ...
            requestedDispenseCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(requestedDispenseCode, fieldData);
        }
...
public HL7V24Field RequestedDispenseAmount
{
    get
    {
        ...
        if (requestedDispenseAmount.field.FieldRepetitions != null && requestedDispenseAmount.field.FieldRepetitions.Count > 0)
        {
            ...
            requestedDispenseAmount.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(requestedDispenseAmount, fieldData);
        }
...
public HL7V24Field RequestedDispenseUnits
{
    get
    {
        ...
        if (requestedDispenseUnits.field.FieldRepetitions != null && requestedDispenseUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            requestedDispenseUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(requestedDispenseUnits, fieldData);
        }
...
public HL7V24Field RequestedGivePer
{
    get
    {
        ...
        if (requestedGivePer.field.FieldRepetitions != null && requestedGivePer.field.FieldRepetitions.Count > 0)
        {
            ...
            requestedGivePer.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(requestedGivePer, fieldData);
        }
...
public HL7V24Field RequestedGiveStrength
{
    get
    {
        ...
        if (requestedGiveStrength.field.FieldRepetitions != null && requestedGiveStrength.field.FieldRepetitions.Count > 0)
        {
            ...
            requestedGiveStrength.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(requestedGiveStrength, fieldData);
        }
...
public HL7V24Field RequestedGiveStrengthUnits
{
    get
    {
        ...
        if (requestedGiveStrengthUnits.field.FieldRepetitions != null && requestedGiveStrengthUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            requestedGiveStrengthUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(requestedGiveStrengthUnits, fieldData);
        }
...
public HL7V24Field Indication
{
    get
    {
        ...
        if (indication.field.FieldRepetitions != null && indication.field.FieldRepetitions.Count > 0)
        {
            ...
            indication.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(indication, fieldData);
        }
...
public HL7V24Field RequestedGiveRateAmount
{
    get
    {
        ...
        if (requestedGiveRateAmount.field.FieldRepetitions != null && requestedGiveRateAmount.field.FieldRepetitions.Count > 0)
        {
            ...
            requestedGiveRateAmount.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(requestedGiveRateAmount, fieldData);
        }
...
public HL7V24Field RequestedGiveRateUnits
{
    get
    {
        ...
        if (requestedGiveRateUnits.field.FieldRepetitions != null && requestedGiveRateUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            requestedGiveRateUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(requestedGiveRateUnits, fieldData);
        }
