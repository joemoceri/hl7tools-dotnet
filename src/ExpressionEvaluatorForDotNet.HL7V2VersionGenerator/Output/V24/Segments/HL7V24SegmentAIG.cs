...
Refer to User-defined table 0396 Coding Systems for valid values. When an HL7 table is used for a CE data type, the name of coding system component is defined as HL7nnnn where nnnn is the HL7 table number. ",
                        ...
                        new HL7V2FieldData
                        {
                            ...
                            TableId = null,
                            TableName = null,
                            Description = @"This field contains the offset that this resource needs for the appointment, expressed in units of time relative to the scheduled start date/time. This field indicates to the application that the resource is required for the appointment at a different time than the appointments start date/time. The first component indicates the offset amount. An offset of zero (0), or an unvalued field, indicates that the resource is required at the start date/time of the appointment.",
                            Sample = @"",
                            FieldDatas = null
                        },
...
Refer to User-defined table 0396 Coding Systems for valid values. When an HL7 table is used for a CE data type, the name of coding system component is defined as HL7nnnn where nnnn is the HL7 table number. ",
        ...
        public HL7V24SegmentAIG(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V24Field setIDAIG;

public HL7V24Field SetIDAIG
{
    get
    {
        if (setIDAIG != null)
        ...
        if (setIDAIG.field.FieldRepetitions != null && setIDAIG.field.FieldRepetitions.Count > 0)
        {
            ...
            setIDAIG.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(setIDAIG, fieldData);
        }
...
internal HL7V24Field resourceID;

public HL7V24Field ResourceID
{
    get
    {
        if (resourceID != null)
        ...
        if (resourceID.field.FieldRepetitions != null && resourceID.field.FieldRepetitions.Count > 0)
        {
            ...
            resourceID.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(resourceID, fieldData);
        }
...
internal HL7V24Field resourceType;

public HL7V24Field ResourceType
{
    get
    {
        ...
        if (resourceType.field.FieldRepetitions != null && resourceType.field.FieldRepetitions.Count > 0)
        {
            ...
            resourceType.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(resourceType, fieldData);
        }
...
public HL7V24Field ResourceGroup
{
    get
    {
        ...
        if (resourceGroup.field.FieldRepetitions != null && resourceGroup.field.FieldRepetitions.Count > 0)
        {
            ...
            resourceGroup.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(resourceGroup, fieldData);
        }
...
internal HL7V24Field resourceQuantity;

public HL7V24Field ResourceQuantity
{
    get
    {
        ...
        resourceQuantity = new HL7V24Field
        {
            field = message[@"AIG"][6],
            Id = @"AIG.6",
            Type = @"Field",
        ...
        if (resourceQuantity.field.FieldRepetitions != null && resourceQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            resourceQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(resourceQuantity, fieldData);
        }
...
internal HL7V24Field resourceQuantityUnits;

public HL7V24Field ResourceQuantityUnits
{
    get
    {
        ...
        resourceQuantityUnits = new HL7V24Field
        {
            field = message[@"AIG"][7],
            Id = @"AIG.7",
            Type = @"Field",
        ...
        if (resourceQuantityUnits.field.FieldRepetitions != null && resourceQuantityUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            resourceQuantityUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(resourceQuantityUnits, fieldData);
        }
