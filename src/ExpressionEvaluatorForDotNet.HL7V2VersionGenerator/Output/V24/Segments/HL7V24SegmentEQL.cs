...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V24SegmentEQL
    {
        ...
        public HL7V24SegmentEQL(HL7V2Message message)
        {
...
internal HL7V24Field _eQLQueryName;

public HL7V24Field EQLQueryName
{
    get
    {
...
Refer to User-defined table 0396 Coding Systems for valid values. When an HL7 table is used for a CE data type, the name of coding system component is defined as HL7nnnn where nnnn is the HL7 table number. ",
        ...
        {
            _eQLQueryName.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_eQLQueryName, fieldData);
        }
...
internal HL7V24Field _eQLQueryStatement;

public HL7V24Field EQLQueryStatement
{
    get
    {
        ...
        _eQLQueryStatement = new HL7V24Field
        {
            field = message[@"EQL"][4],
            fieldData = fieldData
        };
        ...
        {
            _eQLQueryStatement.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_eQLQueryStatement, fieldData);
        }
