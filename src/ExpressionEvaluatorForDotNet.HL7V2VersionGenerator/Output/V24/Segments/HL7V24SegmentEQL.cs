...
internal HL7V24Field eQLQueryName;
...
public HL7V24Field EQLQueryName
{
    get
    {
        ...
        if (eQLQueryName.field.FieldRepetitions != null && eQLQueryName.field.FieldRepetitions.Count > 0)
        {
            ...
            eQLQueryName.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(eQLQueryName, fieldData);
        }
...
internal HL7V24Field eQLQueryStatement;
...
public HL7V24Field EQLQueryStatement
{
    get
    {
        ...
        eQLQueryStatement = new HL7V24Field
        {
            field = message[@"EQL"][4],
            Id = @"EQL.4",
            Type = @"Field",
        ...
        if (eQLQueryStatement.field.FieldRepetitions != null && eQLQueryStatement.field.FieldRepetitions.Count > 0)
        {
            ...
            eQLQueryStatement.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(eQLQueryStatement, fieldData);
        }
