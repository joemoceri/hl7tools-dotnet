...
This field may be defined as a CM data type for backward compatibility with HL7 Versions 2.2 and 2.1 with each total being carried as a separate component.  Each component in this case is an NM data type",
        ...
        public HL7V24SegmentBTS(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V24Field batchMessageCount;

public HL7V24Field BatchMessageCount
{
    get
    {
        ...
        batchMessageCount = new HL7V24Field
        {
            field = message[@"BTS"][1],
            Id = @"BTS.1",
            Type = @"Field",
        ...
        if (batchMessageCount.field.FieldRepetitions != null && batchMessageCount.field.FieldRepetitions.Count > 0)
        {
            ...
            batchMessageCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(batchMessageCount, fieldData);
        }
...
internal HL7V24Field batchTotals;

public HL7V24Field BatchTotals
{
    get
    {
        if (batchTotals != null)
...
This field may be defined as a CM data type for backward compatibility with HL7 Versions 2.2 and 2.1 with each total being carried as a separate component.  Each component in this case is an NM data type",
        ...
        if (batchTotals.field.FieldRepetitions != null && batchTotals.field.FieldRepetitions.Count > 0)
        {
            ...
            batchTotals.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(batchTotals, fieldData);
        }
