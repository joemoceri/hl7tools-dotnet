...
public HL7V24Field SetIDDG1
{
    get
    {
        ...
        if (setIDDG1.field.FieldRepetitions != null && setIDDG1.field.FieldRepetitions.Count > 0)
        {
            ...
            setIDDG1.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(setIDDG1, fieldData);
        }
...
public HL7V24Field DiagnosisCodingMethod
{
    get
    {
        ...
        if (diagnosisCodingMethod.field.FieldRepetitions != null && diagnosisCodingMethod.field.FieldRepetitions.Count > 0)
        {
            ...
            diagnosisCodingMethod.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(diagnosisCodingMethod, fieldData);
        }
...
public HL7V24Field DiagnosisCodeDG1
{
    get
    {
        ...
        if (diagnosisCodeDG1.field.FieldRepetitions != null && diagnosisCodeDG1.field.FieldRepetitions.Count > 0)
        {
            ...
            diagnosisCodeDG1.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(diagnosisCodeDG1, fieldData);
        }
...
public HL7V24Field DiagnosisDescription
{
    get
    {
        ...
        if (diagnosisDescription.field.FieldRepetitions != null && diagnosisDescription.field.FieldRepetitions.Count > 0)
        {
            ...
            diagnosisDescription.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(diagnosisDescription, fieldData);
        }
...
public HL7V24Field DiagnosisDateTime
{
    get
    {
        ...
        if (diagnosisDateTime.field.FieldRepetitions != null && diagnosisDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            diagnosisDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(diagnosisDateTime, fieldData);
        }
...
public HL7V24Field DiagnosisType
{
    get
    {
        ...
        if (diagnosisType.field.FieldRepetitions != null && diagnosisType.field.FieldRepetitions.Count > 0)
        {
            ...
            diagnosisType.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(diagnosisType, fieldData);
        }
...
public HL7V24Field MajorDiagnosticCategory
{
    get
    {
        ...
        if (majorDiagnosticCategory.field.FieldRepetitions != null && majorDiagnosticCategory.field.FieldRepetitions.Count > 0)
        {
            ...
            majorDiagnosticCategory.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(majorDiagnosticCategory, fieldData);
        }
...
public HL7V24Field GrouperVersionAndType
{
    get
    {
        ...
        if (grouperVersionAndType.field.FieldRepetitions != null && grouperVersionAndType.field.FieldRepetitions.Count > 0)
        {
            ...
            grouperVersionAndType.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(grouperVersionAndType, fieldData);
        }
...
public HL7V24Field DiagnosisPriority
{
    get
    {
        ...
        if (diagnosisPriority.field.FieldRepetitions != null && diagnosisPriority.field.FieldRepetitions.Count > 0)
        {
            ...
            diagnosisPriority.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(diagnosisPriority, fieldData);
        }
...
public HL7V24Field DiagnosingClinician
{
    get
    {
        ...
        if (diagnosingClinician.field.FieldRepetitions != null && diagnosingClinician.field.FieldRepetitions.Count > 0)
        {
            ...
            diagnosingClinician.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(diagnosingClinician, fieldData);
        }
...
public HL7V24Field DiagnosisClassification
{
    get
    {
        ...
        if (diagnosisClassification.field.FieldRepetitions != null && diagnosisClassification.field.FieldRepetitions.Count > 0)
        {
            ...
            diagnosisClassification.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(diagnosisClassification, fieldData);
        }
...
public HL7V24Field AttestationDateTime
{
    get
    {
        ...
        if (attestationDateTime.field.FieldRepetitions != null && attestationDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            attestationDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(attestationDateTime, fieldData);
        }
