...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V24SegmentADD
    {
        ...
        public string Description { get { return @"The ADD segment is used to define the continuation of the prior segment in a continuation message. See Section2.15.2, Continuation messages and segments, for details."; } }
        ...
        public HL7V24SegmentADD(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V24Field _addendumContinuationPointer;

public HL7V24Field AddendumContinuationPointer
{
    get
    {
        ...
        _addendumContinuationPointer = new HL7V24Field
        {
            field = message[@"ADD"][1],
            fieldData = fieldData
        };
        ...
        {
            _addendumContinuationPointer.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_addendumContinuationPointer, fieldData);
        }
