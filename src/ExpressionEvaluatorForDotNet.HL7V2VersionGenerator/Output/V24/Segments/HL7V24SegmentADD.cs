...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V24SegmentADD
    {
        ...
        internal HL7V24Field addendumContinuationPointer;
...
public HL7V24Field AddendumContinuationPointer
{
    get
    {
        ...
        addendumContinuationPointer = new HL7V24Field
        {
            field = message[@"ADD"][1],
            Id = @"ADD.1",
            Type = @"Field",
        ...
        if (addendumContinuationPointer.field.FieldRepetitions != null && addendumContinuationPointer.field.FieldRepetitions.Count > 0)
        {
            ...
            addendumContinuationPointer.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(addendumContinuationPointer, fieldData);
        }
