...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V24SegmentDSP
    {
        ...
        internal HL7V24Field _setIDDSP;
...
public HL7V24Field SetIDDSP
{
    get
    {
        ...
        {
            _setIDDSP.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_setIDDSP, fieldData);
        }
...
internal HL7V24Field _displayLevel;
...
public HL7V24Field DisplayLevel
{
    get
    {
        ...
        {
            _displayLevel.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_displayLevel, fieldData);
        }
...
internal HL7V24Field _dataLine;
...
public HL7V24Field DataLine
{
    get
    {
        ...
        {
            _dataLine.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_dataLine, fieldData);
        }
...
internal HL7V24Field _logicalBreakPoint;
...
public HL7V24Field LogicalBreakPoint
{
    get
    {
        ...
        _logicalBreakPoint = new HL7V24Field
        {
            field = message[@"DSP"][4],
            fieldData = fieldData
        };
        ...
        {
            _logicalBreakPoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_logicalBreakPoint, fieldData);
        }
...
internal HL7V24Field _resultID;
...
public HL7V24Field ResultID
{
    get
    {
        ...
        {
            _resultID.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_resultID, fieldData);
        }
