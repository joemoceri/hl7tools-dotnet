...
public HL7V24Field SetIDDSP
{
    get
    {
        ...
        if (setIDDSP.field.FieldRepetitions != null && setIDDSP.field.FieldRepetitions.Count > 0)
        {
            ...
            setIDDSP.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(setIDDSP, fieldData);
        }
...
public HL7V24Field DisplayLevel
{
    get
    {
        ...
        if (displayLevel.field.FieldRepetitions != null && displayLevel.field.FieldRepetitions.Count > 0)
        {
            ...
            displayLevel.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(displayLevel, fieldData);
        }
...
public HL7V24Field DataLine
{
    get
    {
        ...
        if (dataLine.field.FieldRepetitions != null && dataLine.field.FieldRepetitions.Count > 0)
        {
            ...
            dataLine.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(dataLine, fieldData);
        }
...
public HL7V24Field LogicalBreakPoint
{
    get
    {
        ...
        if (logicalBreakPoint.field.FieldRepetitions != null && logicalBreakPoint.field.FieldRepetitions.Count > 0)
        {
            ...
            logicalBreakPoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(logicalBreakPoint, fieldData);
        }
...
public HL7V24Field ResultID
{
    get
    {
        ...
        if (resultID.field.FieldRepetitions != null && resultID.field.FieldRepetitions.Count > 0)
        {
            ...
            resultID.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(resultID, fieldData);
        }
