...
public HL7V24Field FileBatchCount
{
    get
    {
        ...
        fileBatchCount = new HL7V24Field
        {
            field = message[@"FTS"][1],
            Id = @"FTS.1",
            Type = @"Field",
        ...
        if (fileBatchCount.field.FieldRepetitions != null && fileBatchCount.field.FieldRepetitions.Count > 0)
        {
            ...
            fileBatchCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(fileBatchCount, fieldData);
        }
...
internal HL7V24Field fileTrailerComment;
...
public HL7V24Field FileTrailerComment
{
    get
    {
        ...
        fileTrailerComment = new HL7V24Field
        {
            field = message[@"FTS"][2],
            Id = @"FTS.2",
            Type = @"Field",
        ...
        if (fileTrailerComment.field.FieldRepetitions != null && fileTrailerComment.field.FieldRepetitions.Count > 0)
        {
            ...
            fileTrailerComment.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(fileTrailerComment, fieldData);
        }
