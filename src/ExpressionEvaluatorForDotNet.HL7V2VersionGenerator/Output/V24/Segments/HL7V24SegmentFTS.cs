...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V24SegmentFTS
    {
        ...
        public HL7V24SegmentFTS(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V24Field _fileBatchCount;
...
public HL7V24Field FileBatchCount
{
    get
    {
        ...
        _fileBatchCount = new HL7V24Field
        {
            field = message[@"FTS"][1],
            fieldData = fieldData
        };
        ...
        {
            _fileBatchCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_fileBatchCount, fieldData);
        }
...
internal HL7V24Field _fileTrailerComment;

public HL7V24Field FileTrailerComment
{
    get
    {
        ...
        _fileTrailerComment = new HL7V24Field
        {
            field = message[@"FTS"][2],
            fieldData = fieldData
        };
        ...
        {
            _fileTrailerComment.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_fileTrailerComment, fieldData);
        }
