...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V24SegmentNPU
    {
        ...
        internal HL7V24Field _bedLocation;
...
public HL7V24Field BedLocation
{
    get
    {
        ...
        {
            _bedLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_bedLocation, fieldData);
        }
