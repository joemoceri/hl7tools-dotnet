...
internal HL7V24Field _testObservationsIncludedwithinanOrderedTestBattery;
...
Refer to User-defined table 0396 Coding Systems for valid values. When an HL7 table is used for a CE data type, the name of coding system component is defined as HL7nnnn where nnnn is the HL7 table number. ",
        ...
        _testObservationsIncludedwithinanOrderedTestBattery = new HL7V24Field
        {
            field = message[@"OM5"][2],
            fieldData = fieldData
        };
        ...
        {
            _testObservationsIncludedwithinanOrderedTestBattery.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_testObservationsIncludedwithinanOrderedTestBattery, fieldData);
        }
...
internal HL7V24Field _observationIDSuffixes;
...
public HL7V24Field ObservationIDSuffixes
{
    get
    {
        ...
        _observationIDSuffixes = new HL7V24Field
        {
            field = message[@"OM5"][3],
            fieldData = fieldData
        };
        ...
        {
            _observationIDSuffixes.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_observationIDSuffixes, fieldData);
        }
