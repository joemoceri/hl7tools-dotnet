...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V24SegmentRDT
    {
        ...
        internal HL7V24Field columnValue;
...
public HL7V24Field ColumnValue
{
    get
    {
        ...
        if (columnValue.field.FieldRepetitions != null && columnValue.field.FieldRepetitions.Count > 0)
        {
            ...
            columnValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(columnValue, fieldData);
        }
