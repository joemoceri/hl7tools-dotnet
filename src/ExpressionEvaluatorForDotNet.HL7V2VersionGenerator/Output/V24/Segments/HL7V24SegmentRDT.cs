...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V24SegmentRDT
    {
        ...
        public HL7V24SegmentRDT(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V24Field _columnValue;

public HL7V24Field ColumnValue
{
    get
    {
        ...
        {
            _columnValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_columnValue, fieldData);
        }
