...
internal HL7V24Field _datetimeStudyPhaseBegan;
...
public HL7V24Field DatetimeStudyPhaseBegan
{
    get
    {
        ...
        _datetimeStudyPhaseBegan = new HL7V24Field
        {
            field = message[@"CSP"][2],
            fieldData = fieldData
        };
        ...
        {
            _datetimeStudyPhaseBegan.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_datetimeStudyPhaseBegan, fieldData);
        }
...
internal HL7V24Field _datetimeStudyPhaseEnded;
...
public HL7V24Field DatetimeStudyPhaseEnded
{
    get
    {
        ...
        _datetimeStudyPhaseEnded = new HL7V24Field
        {
            field = message[@"CSP"][3],
            fieldData = fieldData
        };
        ...
        {
            _datetimeStudyPhaseEnded.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_datetimeStudyPhaseEnded, fieldData);
        }
...
internal HL7V24Field _studyPhaseEvaluability;
...
Refer to User-defined table 0396 Coding Systems for valid values. When an HL7 table is used for a CE data type, the name of coding system component is defined as HL7nnnn where nnnn is the HL7 table number. ",
        ...
        _studyPhaseEvaluability = new HL7V24Field
        {
            field = message[@"CSP"][4],
            fieldData = fieldData
        };
        ...
        {
            _studyPhaseEvaluability.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_studyPhaseEvaluability, fieldData);
        }
