...
public HL7V24Field MasterFileIdentifier
{
    get
    {
        ...
        if (masterFileIdentifier.field.FieldRepetitions != null && masterFileIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            masterFileIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(masterFileIdentifier, fieldData);
        }
...
public HL7V24Field MasterFileApplicationIdentifier
{
    get
    {
        ...
        if (masterFileApplicationIdentifier.field.FieldRepetitions != null && masterFileApplicationIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            masterFileApplicationIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(masterFileApplicationIdentifier, fieldData);
        }
...
public HL7V24Field FileLevelEventCode
{
    get
    {
        ...
        if (fileLevelEventCode.field.FieldRepetitions != null && fileLevelEventCode.field.FieldRepetitions.Count > 0)
        {
            ...
            fileLevelEventCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(fileLevelEventCode, fieldData);
        }
...
public HL7V24Field EnteredDateTime
{
    get
    {
        ...
        if (enteredDateTime.field.FieldRepetitions != null && enteredDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            enteredDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(enteredDateTime, fieldData);
        }
...
public HL7V24Field EffectiveDateTime
{
    get
    {
        ...
        if (effectiveDateTime.field.FieldRepetitions != null && effectiveDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            effectiveDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(effectiveDateTime, fieldData);
        }
...
public HL7V24Field ResponseLevelCode
{
    get
    {
        ...
        if (responseLevelCode.field.FieldRepetitions != null && responseLevelCode.field.FieldRepetitions.Count > 0)
        {
            ...
            responseLevelCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(responseLevelCode, fieldData);
        }
