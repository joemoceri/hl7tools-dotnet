...
The Technical Steward for the CM2 segment is ORDERS."; } }
        ...
        internal HL7V24Field _setIDCM2;
...
public HL7V24Field SetIDCM2
{
    get
    {
        ...
        {
            _setIDCM2.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_setIDCM2, fieldData);
        }
...
internal HL7V24Field _scheduledTimePoint;
...
Refer to User-defined table 0396 Coding Systems for valid values. When an HL7 table is used for a CE data type, the name of coding system component is defined as HL7nnnn where nnnn is the HL7 table number. ",
        ...
        _scheduledTimePoint = new HL7V24Field
        {
            field = message[@"CM2"][2],
            fieldData = fieldData
        };
        ...
        {
            _scheduledTimePoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_scheduledTimePoint, fieldData);
        }
...
internal HL7V24Field _descriptionofTimePoint;
...
public HL7V24Field DescriptionofTimePoint
{
    get
    {
        ...
        _descriptionofTimePoint = new HL7V24Field
        {
            field = message[@"CM2"][3],
            fieldData = fieldData
        };
        ...
        {
            _descriptionofTimePoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_descriptionofTimePoint, fieldData);
        }
...
internal HL7V24Field _eventsScheduledThisTimePoint;
...
Refer to User-defined table 0396 Coding Systems for valid values. When an HL7 table is used for a CE data type, the name of coding system component is defined as HL7nnnn where nnnn is the HL7 table number. ",
        ...
        _eventsScheduledThisTimePoint = new HL7V24Field
        {
            field = message[@"CM2"][4],
            fieldData = fieldData
        };
        ...
        {
            _eventsScheduledThisTimePoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_eventsScheduledThisTimePoint, fieldData);
        }
