...
Refer to User-defined table 0396 Coding Systems for valid values. When an HL7 table is used for a CE data type, the name of coding system component is defined as HL7nnnn where nnnn is the HL7 table number. ",
        ...
        internal HL7V24Field studyScheduledTimePoint;
...
public HL7V24Field StudyScheduledTimePoint
{
    get
    {
        ...
        studyScheduledTimePoint = new HL7V24Field
        {
            field = message[@"CSS"][1],
            Id = @"CSS.1",
            Type = @"Field",
        ...
        if (studyScheduledTimePoint.field.FieldRepetitions != null && studyScheduledTimePoint.field.FieldRepetitions.Count > 0)
        {
            ...
            studyScheduledTimePoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(studyScheduledTimePoint, fieldData);
        }
...
internal HL7V24Field studyScheduledPatientTimePoint;
...
public HL7V24Field StudyScheduledPatientTimePoint
{
    get
    {
        ...
        studyScheduledPatientTimePoint = new HL7V24Field
        {
            field = message[@"CSS"][2],
            Id = @"CSS.2",
            Type = @"Field",
        ...
        if (studyScheduledPatientTimePoint.field.FieldRepetitions != null && studyScheduledPatientTimePoint.field.FieldRepetitions.Count > 0)
        {
            ...
            studyScheduledPatientTimePoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(studyScheduledPatientTimePoint, fieldData);
        }
...
internal HL7V24Field studyQualityControlCodes;
...
public HL7V24Field StudyQualityControlCodes
{
    get
    {
        ...
        studyQualityControlCodes = new HL7V24Field
        {
            field = message[@"CSS"][3],
            Id = @"CSS.3",
            Type = @"Field",
        ...
        if (studyQualityControlCodes.field.FieldRepetitions != null && studyQualityControlCodes.field.FieldRepetitions.Count > 0)
        {
            ...
            studyQualityControlCodes.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(studyQualityControlCodes, fieldData);
        }
