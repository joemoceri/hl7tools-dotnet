...
public HL7V24Field DiagnosticRelatedGroup
{
    get
    {
        ...
        if (diagnosticRelatedGroup.field.FieldRepetitions != null && diagnosticRelatedGroup.field.FieldRepetitions.Count > 0)
        {
            ...
            diagnosticRelatedGroup.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(diagnosticRelatedGroup, fieldData);
        }
...
public HL7V24Field DRGAssignedDateTime
{
    get
    {
        ...
        if (dRGAssignedDateTime.field.FieldRepetitions != null && dRGAssignedDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            dRGAssignedDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(dRGAssignedDateTime, fieldData);
        }
...
public HL7V24Field DRGApprovalIndicator
{
    get
    {
        ...
        if (dRGApprovalIndicator.field.FieldRepetitions != null && dRGApprovalIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            dRGApprovalIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(dRGApprovalIndicator, fieldData);
        }
...
public HL7V24Field DRGGrouperReviewCode
{
    get
    {
        ...
        if (dRGGrouperReviewCode.field.FieldRepetitions != null && dRGGrouperReviewCode.field.FieldRepetitions.Count > 0)
        {
            ...
            dRGGrouperReviewCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(dRGGrouperReviewCode, fieldData);
        }
...
public HL7V24Field OutlierType
{
    get
    {
        ...
        if (outlierType.field.FieldRepetitions != null && outlierType.field.FieldRepetitions.Count > 0)
        {
            ...
            outlierType.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(outlierType, fieldData);
        }
...
public HL7V24Field OutlierDays
{
    get
    {
        ...
        if (outlierDays.field.FieldRepetitions != null && outlierDays.field.FieldRepetitions.Count > 0)
        {
            ...
            outlierDays.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(outlierDays, fieldData);
        }
...
public HL7V24Field OutlierCost
{
    get
    {
        ...
        if (outlierCost.field.FieldRepetitions != null && outlierCost.field.FieldRepetitions.Count > 0)
        {
            ...
            outlierCost.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(outlierCost, fieldData);
        }
...
public HL7V24Field DRGPayor
{
    get
    {
        ...
        if (dRGPayor.field.FieldRepetitions != null && dRGPayor.field.FieldRepetitions.Count > 0)
        {
            ...
            dRGPayor.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(dRGPayor, fieldData);
        }
...
public HL7V24Field OutlierReimbursement
{
    get
    {
        ...
        if (outlierReimbursement.field.FieldRepetitions != null && outlierReimbursement.field.FieldRepetitions.Count > 0)
        {
            ...
            outlierReimbursement.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(outlierReimbursement, fieldData);
        }
...
- N the DRG does not contain a confidential diagnosis",
        ...
        if (confidentialIndicator.field.FieldRepetitions != null && confidentialIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            confidentialIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(confidentialIndicator, fieldData);
        }
...
public HL7V24Field DRGTransferType
{
    get
    {
        ...
        if (dRGTransferType.field.FieldRepetitions != null && dRGTransferType.field.FieldRepetitions.Count > 0)
        {
            ...
            dRGTransferType.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(dRGTransferType, fieldData);
        }
