...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V24SegmentDSC
    {
            ...
            get 
            {
                return new[]
                        ...
                        new HL7V2FieldData
                        {
                            ...
                            Description = @"Indicates whether this is a fragmented message (see Section 2.15.2, ""Continuation messages and segments""), or if it is part of an interactive continuation message (see Section 5.6.3, ""Interactive continuation of response messages"").",
                            Sample = @"",
                            FieldDatas = null
                        },
                        };
        ...
        public HL7V24SegmentDSC(HL7V2Message message)
        {
...
internal HL7V24Field continuationStyle;

public HL7V24Field ContinuationStyle
{
    get
    {
        ...
        continuationStyle = new HL7V24Field
        {
            field = message[@"DSC"][2],
            Id = @"DSC.2",
            Type = @"Field",
        ...
        if (continuationStyle.field.FieldRepetitions != null && continuationStyle.field.FieldRepetitions.Count > 0)
        {
            ...
            continuationStyle.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(continuationStyle, fieldData);
        }
