...
internal HL7V24Field _continuationStyle;
...
public HL7V24Field ContinuationStyle
{
    get
    {
        ...
        _continuationStyle = new HL7V24Field
        {
            field = message[@"DSC"][2],
            fieldData = fieldData
        };
        ...
        {
            _continuationStyle.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_continuationStyle, fieldData);
        }
