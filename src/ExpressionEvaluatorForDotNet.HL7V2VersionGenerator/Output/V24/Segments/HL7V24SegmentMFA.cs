...
internal HL7V24Field _eventCompletionDateTime;
...
public HL7V24Field EventCompletionDateTime
{
    get
    {
        ...
        _eventCompletionDateTime = new HL7V24Field
        {
            field = message[@"MFA"][3],
            fieldData = fieldData
        };
        ...
        {
            _eventCompletionDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_eventCompletionDateTime, fieldData);
        }
...
internal HL7V24Field _mFNRecordLevelErrorReturn;
...
Refer to User-defined table 0396 Coding Systems for valid values. When an HL7 table is used for a CE data type, the name of coding system component is defined as HL7nnnn where nnnn is the HL7 table number. ",
        ...
        _mFNRecordLevelErrorReturn = new HL7V24Field
        {
            field = message[@"MFA"][4],
            fieldData = fieldData
        };
        ...
        {
            _mFNRecordLevelErrorReturn.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_mFNRecordLevelErrorReturn, fieldData);
        }
...
internal HL7V24Field _primaryKeyValueMFA;
...
Refer to User-defined table 0396 Coding Systems for valid values. When an HL7 table is used for a CE data type, the name of coding system component is defined as HL7nnnn where nnnn is the HL7 table number. ",
        ...
        _primaryKeyValueMFA = new HL7V24Field
        {
            field = message[@"MFA"][5],
            fieldData = fieldData
        };
        ...
        {
            _primaryKeyValueMFA.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_primaryKeyValueMFA, fieldData);
        }
...
internal HL7V24Field _primaryKeyValueTypeMFA;
...
public HL7V24Field PrimaryKeyValueTypeMFA
{
    get
    {
        ...
        _primaryKeyValueTypeMFA = new HL7V24Field
        {
            field = message[@"MFA"][6],
            fieldData = fieldData
        };
        ...
        {
            _primaryKeyValueTypeMFA.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_primaryKeyValueTypeMFA, fieldData);
        }
