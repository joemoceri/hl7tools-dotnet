...
internal HL7V24Field patientPrimaryCareProviderName&IDNo.;

public HL7V24Field PatientPrimaryCareProviderName&IDNo.
{
    get
    {
        ...
        patientPrimaryCareProviderName&IDNo. = new HL7V24Field
        {
            field = message[@"PD1"][4],
            Id = @"PD1.4",
            Type = @"Field",
