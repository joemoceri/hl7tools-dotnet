...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V24SegmentRGS
    {
        ...
        internal HL7V24Field _setIDRGS;
...
public HL7V24Field SetIDRGS
{
    get
    {
        ...
        {
            _setIDRGS.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_setIDRGS, fieldData);
        }
...
internal HL7V24Field _resourceGroupID;
...
Refer to User-defined table 0396 Coding Systems for valid values. When an HL7 table is used for a CE data type, the name of coding system component is defined as HL7nnnn where nnnn is the HL7 table number. ",
        ...
        _resourceGroupID = new HL7V24Field
        {
            field = message[@"RGS"][3],
            fieldData = fieldData
        };
        ...
        {
            _resourceGroupID.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_resourceGroupID, fieldData);
        }
