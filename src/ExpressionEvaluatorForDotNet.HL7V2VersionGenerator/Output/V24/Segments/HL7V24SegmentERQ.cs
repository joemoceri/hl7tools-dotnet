...
internal HL7V24Field eventIdentifier;
...
public HL7V24Field EventIdentifier
{
    get
    {
        ...
        eventIdentifier = new HL7V24Field
        {
            field = message[@"ERQ"][2],
            Id = @"ERQ.2",
            Type = @"Field",
        ...
        if (eventIdentifier.field.FieldRepetitions != null && eventIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            eventIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(eventIdentifier, fieldData);
        }
