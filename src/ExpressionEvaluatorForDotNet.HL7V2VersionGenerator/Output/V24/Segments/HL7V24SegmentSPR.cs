...
Refer to User-defined table 0396 Coding Systems for valid values. When an HL7 table is used for a CE data type, the name of coding system component is defined as HL7nnnn where nnnn is the HL7 table number. ",
        ...
        public HL7V24SegmentSPR(HL7V2Message message)
        {
...
internal HL7V24Field storedProcedureName;

public HL7V24Field StoredProcedureName
{
    get
    {
        ...
        storedProcedureName = new HL7V24Field
        {
            field = message[@"SPR"][3],
            Id = @"SPR.3",
            Type = @"Field",
        ...
        if (storedProcedureName.field.FieldRepetitions != null && storedProcedureName.field.FieldRepetitions.Count > 0)
        {
            ...
            storedProcedureName.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(storedProcedureName, fieldData);
        }
...
internal HL7V24Field inputParameterList;
...
public HL7V24Field InputParameterList
{
    get
    {
        ...
        inputParameterList = new HL7V24Field
        {
            field = message[@"SPR"][4],
            Id = @"SPR.4",
            Type = @"Field",
        ...
        if (inputParameterList.field.FieldRepetitions != null && inputParameterList.field.FieldRepetitions.Count > 0)
        {
            ...
            inputParameterList.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(inputParameterList, fieldData);
        }
