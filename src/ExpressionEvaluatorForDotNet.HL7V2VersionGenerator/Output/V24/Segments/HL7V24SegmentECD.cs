...
Note:  Elements of this segment (or other elements not defined here) may be required for certain vendor-specific equipment such as centrifuges, aliquoters, sorters, uncappers, recappers, automated storage units, etc."; } }
        ...
        internal HL7V24Field _referenceCommandNumber;
...
public HL7V24Field ReferenceCommandNumber
{
    get
    {
        ...
        _referenceCommandNumber = new HL7V24Field
        {
            field = message[@"ECD"][1],
            fieldData = fieldData
        };
        ...
        {
            _referenceCommandNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_referenceCommandNumber, fieldData);
        }
...
internal HL7V24Field _remoteControlCommand;
...
Refer to User-defined table 0396 Coding Systems for valid values. When an HL7 table is used for a CE data type, the name of coding system component is defined as HL7nnnn where nnnn is the HL7 table number. ",
        ...
        _remoteControlCommand = new HL7V24Field
        {
            field = message[@"ECD"][2],
            fieldData = fieldData
        };
        ...
        {
            _remoteControlCommand.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_remoteControlCommand, fieldData);
        }
...
internal HL7V24Field _responseRequired;
...
public HL7V24Field ResponseRequired
{
    get
    {
        ...
        _responseRequired = new HL7V24Field
        {
            field = message[@"ECD"][3],
            fieldData = fieldData
        };
        ...
        {
            _responseRequired.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_responseRequired, fieldData);
        }
...
internal HL7V24Field _requestedCompletionTime;
...
Refer to User-defined table 0396 Coding Systems for valid values. When an HL7 table is used for a CE data type, the name of coding system component is defined as HL7nnnn where nnnn is the HL7 table number. ",
        ...
        _requestedCompletionTime = new HL7V24Field
        {
            field = message[@"ECD"][4],
            fieldData = fieldData
        };
        ...
        {
            _requestedCompletionTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_requestedCompletionTime, fieldData);
        }
...
internal HL7V24Field _parameters;
...
public HL7V24Field Parameters
{
    get
    {
        ...
        {
            _parameters.fieldRepetitions = HL7V2FieldGenerator.GenerateV24FieldRepetitions(_parameters, fieldData);
        }
