...
{
    public class HL7V22TriggerEventADT_A03
    {
...
public HL7V22SegmentOBX obx{get; init;}
        ...
        public string EventDescription { get { return @"Discharge a patient"; } }
        ...
        public HL7V22TriggerEventADT_A03(HL7V2Message message)
        {
