...
{
    public class HL7V22TriggerEventADT_A33
    {
...
private readonly HL7V22SegmentOBX obx;
        ...
        public string EventDescription { get { return @"Cancel patient departing"; } }
        ...
        public HL7V22TriggerEventADT_A33(HL7V2Message message)
        {
