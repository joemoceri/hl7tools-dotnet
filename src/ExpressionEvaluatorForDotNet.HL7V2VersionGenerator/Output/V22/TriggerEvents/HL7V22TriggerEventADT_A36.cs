...
{
    public class HL7V22TriggerEventADT_A36
    {
...
public HL7V22SegmentMRG mrg{get; init;}
        ...
        public string EventDescription { get { return @"pat ID and account number"; } }
        ...
        public HL7V22TriggerEventADT_A36(HL7V2Message message)
        {
