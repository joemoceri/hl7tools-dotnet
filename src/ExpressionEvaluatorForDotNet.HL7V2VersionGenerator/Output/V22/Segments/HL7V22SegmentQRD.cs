...
public HL7V22Field QueryDateTime
{
    get
    {
        ...
        if (queryDateTime.field.FieldRepetitions != null && queryDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            queryDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV22FieldRepetitions(queryDateTime, fieldData);
        }
...
public HL7V22Field QueryFormatCode
{
    get
    {
        ...
        if (queryFormatCode.field.FieldRepetitions != null && queryFormatCode.field.FieldRepetitions.Count > 0)
        {
            ...
            queryFormatCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV22FieldRepetitions(queryFormatCode, fieldData);
        }
...
public HL7V22Field QueryPriority
{
    get
    {
        ...
        if (queryPriority.field.FieldRepetitions != null && queryPriority.field.FieldRepetitions.Count > 0)
        {
            ...
            queryPriority.fieldRepetitions = HL7V2FieldGenerator.GenerateV22FieldRepetitions(queryPriority, fieldData);
        }
...
public HL7V22Field QueryId
{
    get
    {
        ...
        if (queryId.field.FieldRepetitions != null && queryId.field.FieldRepetitions.Count > 0)
        {
            ...
            queryId.fieldRepetitions = HL7V2FieldGenerator.GenerateV22FieldRepetitions(queryId, fieldData);
        }
...
public HL7V22Field DeferredResponseType
{
    get
    {
        ...
        if (deferredResponseType.field.FieldRepetitions != null && deferredResponseType.field.FieldRepetitions.Count > 0)
        {
            ...
            deferredResponseType.fieldRepetitions = HL7V2FieldGenerator.GenerateV22FieldRepetitions(deferredResponseType, fieldData);
        }
...
public HL7V22Field DeferredResponseDateTime
{
    get
    {
        ...
        if (deferredResponseDateTime.field.FieldRepetitions != null && deferredResponseDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            deferredResponseDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV22FieldRepetitions(deferredResponseDateTime, fieldData);
        }
...
public HL7V22Field QuantityLimitedRequest
{
    get
    {
        ...
        if (quantityLimitedRequest.field.FieldRepetitions != null && quantityLimitedRequest.field.FieldRepetitions.Count > 0)
        {
            ...
            quantityLimitedRequest.fieldRepetitions = HL7V2FieldGenerator.GenerateV22FieldRepetitions(quantityLimitedRequest, fieldData);
        }
...
public HL7V22Field WhoSubjectFilter
{
    get
    {
        ...
        if (whoSubjectFilter.field.FieldRepetitions != null && whoSubjectFilter.field.FieldRepetitions.Count > 0)
        {
            ...
            whoSubjectFilter.fieldRepetitions = HL7V2FieldGenerator.GenerateV22FieldRepetitions(whoSubjectFilter, fieldData);
        }
...
public HL7V22Field WhatSubjectFilter
{
    get
    {
        ...
        if (whatSubjectFilter.field.FieldRepetitions != null && whatSubjectFilter.field.FieldRepetitions.Count > 0)
        {
            ...
            whatSubjectFilter.fieldRepetitions = HL7V2FieldGenerator.GenerateV22FieldRepetitions(whatSubjectFilter, fieldData);
        }
...
public HL7V22Field WhatDepartmentDataCode
{
    get
    {
        ...
        if (whatDepartmentDataCode.field.FieldRepetitions != null && whatDepartmentDataCode.field.FieldRepetitions.Count > 0)
        {
            ...
            whatDepartmentDataCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV22FieldRepetitions(whatDepartmentDataCode, fieldData);
        }
...
public HL7V22Field WhatDataCodeValueQualifier
{
    get
    {
        ...
        if (whatDataCodeValueQualifier.field.FieldRepetitions != null && whatDataCodeValueQualifier.field.FieldRepetitions.Count > 0)
        {
            ...
            whatDataCodeValueQualifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV22FieldRepetitions(whatDataCodeValueQualifier, fieldData);
        }
...
public HL7V22Field QueryResultsLevel
{
    get
    {
        ...
        if (queryResultsLevel.field.FieldRepetitions != null && queryResultsLevel.field.FieldRepetitions.Count > 0)
        {
            ...
            queryResultsLevel.fieldRepetitions = HL7V2FieldGenerator.GenerateV22FieldRepetitions(queryResultsLevel, fieldData);
        }
