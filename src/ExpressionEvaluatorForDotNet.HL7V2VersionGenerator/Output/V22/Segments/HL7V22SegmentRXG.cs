...
internal HL7V22Field _pharmacySpecialAdministrationInstructions;
...
public HL7V22Field PharmacySpecialAdministrationInstructions
{
    get
    {
        ...
        _pharmacySpecialAdministrationInstructions = new HL7V22Field
        {
        ...
        {
            _pharmacySpecialAdministrationInstructions.fieldRepetitions = HL7V2FieldGenerator.GenerateV22FieldRepetitions(_pharmacySpecialAdministrationInstructions, fieldData);
        }
