...
public HL7V22Field BatchMessageCount
{
    get
    {
        ...
        if (batchMessageCount.field.FieldRepetitions != null && batchMessageCount.field.FieldRepetitions.Count > 0)
        {
            ...
            batchMessageCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV22FieldRepetitions(batchMessageCount, fieldData);
        }
...
public HL7V22Field BatchComment
{
    get
    {
        ...
        if (batchComment.field.FieldRepetitions != null && batchComment.field.FieldRepetitions.Count > 0)
        {
            ...
            batchComment.fieldRepetitions = HL7V2FieldGenerator.GenerateV22FieldRepetitions(batchComment, fieldData);
        }
...
public HL7V22Field BatchTotals
{
    get
    {
        ...
        if (batchTotals.field.FieldRepetitions != null && batchTotals.field.FieldRepetitions.Count > 0)
        {
            ...
            batchTotals.fieldRepetitions = HL7V2FieldGenerator.GenerateV22FieldRepetitions(batchTotals, fieldData);
        }
