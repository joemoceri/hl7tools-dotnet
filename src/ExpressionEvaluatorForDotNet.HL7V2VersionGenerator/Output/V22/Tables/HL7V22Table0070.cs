...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V222Table0070
    {
        ...
        public string Name { get { return @"SOURCE OF SPECIMEN"; } }
                ...
                return new[]
                    {
                        ...
                        {
                            Value = @"TISB",
                            Description = @"Tissue bone marrow",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"TISC",
                            Description = @"Tissue curettage",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
