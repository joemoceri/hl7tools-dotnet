...
{
    public class HL7V2251Table0292
    {
                ...
                return new[]
                    {
                        ...
                        {
                            Value = @"105",
                            Description = @"smallpox, diluted",
                            Comment = @"smallpox vaccine, diluted"
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"106",
                            Description = @"DTaP, 5 pertussis antigens [i]",
                        ...
                        new HL7V2TableEntry
                        {
                            ...
                            Comment = @"meningococcal vaccine, NOS"
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"109",
