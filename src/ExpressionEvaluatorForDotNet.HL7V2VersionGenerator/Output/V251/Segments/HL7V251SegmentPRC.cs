...
public HL7V251Field PrimaryKeyValuePRC
{
    get
    {
        ...
        if (primaryKeyValuePRC.field.FieldRepetitions != null && primaryKeyValuePRC.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValuePRC.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(primaryKeyValuePRC, fieldData);
        }
...
public HL7V251Field FacilityIDPRC
{
    get
    {
        ...
        if (facilityIDPRC.field.FieldRepetitions != null && facilityIDPRC.field.FieldRepetitions.Count > 0)
        {
            ...
            facilityIDPRC.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(facilityIDPRC, fieldData);
        }
...
public HL7V251Field Price
{
    get
    {
        ...
        if (price.field.FieldRepetitions != null && price.field.FieldRepetitions.Count > 0)
        {
            ...
            price.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(price, fieldData);
        }
...
public HL7V251Field Formula
{
    get
    {
        ...
        if (formula.field.FieldRepetitions != null && formula.field.FieldRepetitions.Count > 0)
        {
            ...
            formula.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(formula, fieldData);
        }
...
public HL7V251Field MinimumQuantity
{
    get
    {
        ...
        if (minimumQuantity.field.FieldRepetitions != null && minimumQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            minimumQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(minimumQuantity, fieldData);
        }
...
public HL7V251Field MaximumQuantity
{
    get
    {
        ...
        if (maximumQuantity.field.FieldRepetitions != null && maximumQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            maximumQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(maximumQuantity, fieldData);
        }
...
public HL7V251Field MinimumPrice
{
    get
    {
        ...
        if (minimumPrice.field.FieldRepetitions != null && minimumPrice.field.FieldRepetitions.Count > 0)
        {
            ...
            minimumPrice.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(minimumPrice, fieldData);
        }
...
public HL7V251Field MaximumPrice
{
    get
    {
        ...
        if (maximumPrice.field.FieldRepetitions != null && maximumPrice.field.FieldRepetitions.Count > 0)
        {
            ...
            maximumPrice.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(maximumPrice, fieldData);
        }
...
public HL7V251Field EffectiveStartDate
{
    get
    {
        ...
        if (effectiveStartDate.field.FieldRepetitions != null && effectiveStartDate.field.FieldRepetitions.Count > 0)
        {
            ...
            effectiveStartDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(effectiveStartDate, fieldData);
        }
...
public HL7V251Field EffectiveEndDate
{
    get
    {
        ...
        if (effectiveEndDate.field.FieldRepetitions != null && effectiveEndDate.field.FieldRepetitions.Count > 0)
        {
            ...
            effectiveEndDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(effectiveEndDate, fieldData);
        }
...
public HL7V251Field PriceOverrideFlag
{
    get
    {
        ...
        if (priceOverrideFlag.field.FieldRepetitions != null && priceOverrideFlag.field.FieldRepetitions.Count > 0)
        {
            ...
            priceOverrideFlag.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(priceOverrideFlag, fieldData);
        }
...
public HL7V251Field BillingCategory
{
    get
    {
        ...
        if (billingCategory.field.FieldRepetitions != null && billingCategory.field.FieldRepetitions.Count > 0)
        {
            ...
            billingCategory.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(billingCategory, fieldData);
        }
...
public HL7V251Field ChargeableFlag
{
    get
    {
        ...
        if (chargeableFlag.field.FieldRepetitions != null && chargeableFlag.field.FieldRepetitions.Count > 0)
        {
            ...
            chargeableFlag.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(chargeableFlag, fieldData);
        }
...
public HL7V251Field Cost
{
    get
    {
        ...
        if (cost.field.FieldRepetitions != null && cost.field.FieldRepetitions.Count > 0)
        {
            ...
            cost.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(cost, fieldData);
        }
...
public HL7V251Field ChargeOnIndicator
{
    get
    {
        ...
        if (chargeOnIndicator.field.FieldRepetitions != null && chargeOnIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            chargeOnIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(chargeOnIndicator, fieldData);
        }
