...
public HL7V251Field ReferralStatus
{
    get
    {
        ...
        if (referralStatus.field.FieldRepetitions != null && referralStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            referralStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(referralStatus, fieldData);
        }
...
public HL7V251Field ReferralPriority
{
    get
    {
        ...
        if (referralPriority.field.FieldRepetitions != null && referralPriority.field.FieldRepetitions.Count > 0)
        {
            ...
            referralPriority.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(referralPriority, fieldData);
        }
...
public HL7V251Field ReferralType
{
    get
    {
        ...
        if (referralType.field.FieldRepetitions != null && referralType.field.FieldRepetitions.Count > 0)
        {
            ...
            referralType.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(referralType, fieldData);
        }
...
public HL7V251Field ReferralDisposition
{
    get
    {
        ...
        if (referralDisposition.field.FieldRepetitions != null && referralDisposition.field.FieldRepetitions.Count > 0)
        {
            ...
            referralDisposition.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(referralDisposition, fieldData);
        }
...
public HL7V251Field ReferralCategory
{
    get
    {
        ...
        if (referralCategory.field.FieldRepetitions != null && referralCategory.field.FieldRepetitions.Count > 0)
        {
            ...
            referralCategory.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(referralCategory, fieldData);
        }
...
public HL7V251Field OriginatingReferralIdentifier
{
    get
    {
        ...
        if (originatingReferralIdentifier.field.FieldRepetitions != null && originatingReferralIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            originatingReferralIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(originatingReferralIdentifier, fieldData);
        }
...
public HL7V251Field EffectiveDate
{
    get
    {
        ...
        if (effectiveDate.field.FieldRepetitions != null && effectiveDate.field.FieldRepetitions.Count > 0)
        {
            ...
            effectiveDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(effectiveDate, fieldData);
        }
...
public HL7V251Field ReferralReason
{
    get
    {
        ...
        if (referralReason.field.FieldRepetitions != null && referralReason.field.FieldRepetitions.Count > 0)
        {
            ...
            referralReason.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(referralReason, fieldData);
        }
...
public HL7V251Field ExternalReferralIdentifier
{
    get
    {
        ...
        if (externalReferralIdentifier.field.FieldRepetitions != null && externalReferralIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            externalReferralIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(externalReferralIdentifier, fieldData);
        }
