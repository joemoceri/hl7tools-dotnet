...
{
    public class HL7V251SegmentEQL
    {
...
This segment is not carried forward to the recommended queries for v 2.4."; } }
        ...
        public HL7V251SegmentEQL(HL7V2Message message)
        {
...
internal HL7V251Field _eQLQueryName;

public HL7V251Field EQLQueryName
{
    get
    {
        ...
        _eQLQueryName = new HL7V251Field
        {
            field = message[@"EQL"][3],
            fieldData = fieldData
        };
        ...
        {
            _eQLQueryName.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(_eQLQueryName, fieldData);
        }
...
internal HL7V251Field _eQLQueryStatement;

public HL7V251Field EQLQueryStatement
{
    get
    {
        ...
        _eQLQueryStatement = new HL7V251Field
        {
            field = message[@"EQL"][4],
            fieldData = fieldData
        };
        ...
        {
            _eQLQueryStatement.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(_eQLQueryStatement, fieldData);
        }
