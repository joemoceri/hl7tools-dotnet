...
internal HL7V251Field queryResponseStatus;
...
public HL7V251Field QueryResponseStatus
{
    get
    {
        ...
        queryResponseStatus = new HL7V251Field
        {
            field = message[@"QAK"][2],
            Id = @"QAK.2",
            Type = @"Field",
        ...
        if (queryResponseStatus.field.FieldRepetitions != null && queryResponseStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            queryResponseStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(queryResponseStatus, fieldData);
        }
...
public HL7V251Field MessageQueryName
{
    get
    {
        ...
        if (messageQueryName.field.FieldRepetitions != null && messageQueryName.field.FieldRepetitions.Count > 0)
        {
            ...
            messageQueryName.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(messageQueryName, fieldData);
        }
...
internal HL7V251Field hitCount;
...
public HL7V251Field HitCount
{
    get
    {
        ...
        if (hitCount.field.FieldRepetitions != null && hitCount.field.FieldRepetitions.Count > 0)
        {
            ...
            hitCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(hitCount, fieldData);
        }
...
internal HL7V251Field thispayload;
...
public HL7V251Field Thispayload
{
    get
    {
        ...
        if (thispayload.field.FieldRepetitions != null && thispayload.field.FieldRepetitions.Count > 0)
        {
            ...
            thispayload.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(thispayload, fieldData);
        }
...
internal HL7V251Field hitsremaining;
...
public HL7V251Field Hitsremaining
{
    get
    {
        ...
        hitsremaining = new HL7V251Field
        {
            field = message[@"QAK"][6],
            Id = @"QAK.6",
            Type = @"Field",
        ...
        if (hitsremaining.field.FieldRepetitions != null && hitsremaining.field.FieldRepetitions.Count > 0)
        {
            ...
            hitsremaining.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(hitsremaining, fieldData);
        }
