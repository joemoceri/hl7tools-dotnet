...
internal HL7V251Field _studyScheduledPatientTimePoint;
...
Indicates the degree of precision of the time stamp (Y = year, L = month, D = day, H = hour, M = minute, S = second). Refer to HL7 Table 0529 - Precision for valid value.",
        ...
        _studyScheduledPatientTimePoint = new HL7V251Field
        {
            field = message[@"CSS"][2],
            fieldData = fieldData
        };
        ...
        {
            _studyScheduledPatientTimePoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(_studyScheduledPatientTimePoint, fieldData);
        }
...
internal HL7V251Field _studyQualityControlCodes;
...
public HL7V251Field StudyQualityControlCodes
{
    get
    {
        ...
        _studyQualityControlCodes = new HL7V251Field
        {
            field = message[@"CSS"][3],
            fieldData = fieldData
        };
        ...
        {
            _studyQualityControlCodes.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(_studyQualityControlCodes, fieldData);
        }
