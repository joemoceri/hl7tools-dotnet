...
public HL7V251Field ProblemID
{
    get
    {
        ...
        if (problemID.field.FieldRepetitions != null && problemID.field.FieldRepetitions.Count > 0)
        {
            ...
            problemID.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(problemID, fieldData);
        }
...
Note:  It is required that this value remain unique over time.  This instance ID identifies a specific instance for a specific patient and is unique across all patients.",
        ...
        if (problemInstanceID.field.FieldRepetitions != null && problemInstanceID.field.FieldRepetitions.Count > 0)
        {
            ...
            problemInstanceID.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(problemInstanceID, fieldData);
        }
...
public HL7V251Field ProblemListPriority
{
    get
    {
        ...
        if (problemListPriority.field.FieldRepetitions != null && problemListPriority.field.FieldRepetitions.Count > 0)
        {
            ...
            problemListPriority.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(problemListPriority, fieldData);
        }
...
public HL7V251Field ProblemEstablishedDateTime
{
    get
    {
        ...
        if (problemEstablishedDateTime.field.FieldRepetitions != null && problemEstablishedDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            problemEstablishedDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(problemEstablishedDateTime, fieldData);
        }
...
public HL7V251Field AnticipatedProblemResolutionDateTime
{
    get
    {
        ...
        if (anticipatedProblemResolutionDateTime.field.FieldRepetitions != null && anticipatedProblemResolutionDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            anticipatedProblemResolutionDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(anticipatedProblemResolutionDateTime, fieldData);
        }
...
public HL7V251Field ActualProblemResolutionDateTime
{
    get
    {
        ...
        if (actualProblemResolutionDateTime.field.FieldRepetitions != null && actualProblemResolutionDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            actualProblemResolutionDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(actualProblemResolutionDateTime, fieldData);
        }
...
public HL7V251Field ProblemClassification
{
    get
    {
        ...
        if (problemClassification.field.FieldRepetitions != null && problemClassification.field.FieldRepetitions.Count > 0)
        {
            ...
            problemClassification.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(problemClassification, fieldData);
        }
...
public HL7V251Field ProblemManagementDiscipline
{
    get
    {
        ...
        if (problemManagementDiscipline.field.FieldRepetitions != null && problemManagementDiscipline.field.FieldRepetitions.Count > 0)
        {
            ...
            problemManagementDiscipline.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(problemManagementDiscipline, fieldData);
        }
...
public HL7V251Field ProblemPersistence
{
    get
    {
        ...
        if (problemPersistence.field.FieldRepetitions != null && problemPersistence.field.FieldRepetitions.Count > 0)
        {
            ...
            problemPersistence.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(problemPersistence, fieldData);
        }
...
public HL7V251Field ProblemConfirmationStatus
{
    get
    {
        ...
        if (problemConfirmationStatus.field.FieldRepetitions != null && problemConfirmationStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            problemConfirmationStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(problemConfirmationStatus, fieldData);
        }
...
public HL7V251Field ProblemLifeCycleStatus
{
    get
    {
        ...
        if (problemLifeCycleStatus.field.FieldRepetitions != null && problemLifeCycleStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            problemLifeCycleStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(problemLifeCycleStatus, fieldData);
        }
...
public HL7V251Field ProblemLifeCycleStatusDateTime
{
    get
    {
        ...
        if (problemLifeCycleStatusDateTime.field.FieldRepetitions != null && problemLifeCycleStatusDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            problemLifeCycleStatusDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(problemLifeCycleStatusDateTime, fieldData);
        }
...
public HL7V251Field ProblemDateofOnset
{
    get
    {
        ...
        if (problemDateofOnset.field.FieldRepetitions != null && problemDateofOnset.field.FieldRepetitions.Count > 0)
        {
            ...
            problemDateofOnset.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(problemDateofOnset, fieldData);
        }
...
public HL7V251Field ProblemOnsetText
{
    get
    {
        ...
        if (problemOnsetText.field.FieldRepetitions != null && problemOnsetText.field.FieldRepetitions.Count > 0)
        {
            ...
            problemOnsetText.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(problemOnsetText, fieldData);
        }
...
public HL7V251Field ProblemRanking
{
    get
    {
        ...
        if (problemRanking.field.FieldRepetitions != null && problemRanking.field.FieldRepetitions.Count > 0)
        {
            ...
            problemRanking.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(problemRanking, fieldData);
        }
...
public HL7V251Field CertaintyofProblem01
{
    get
    {
        ...
        if (certaintyofProblem01.field.FieldRepetitions != null && certaintyofProblem01.field.FieldRepetitions.Count > 0)
        {
            ...
            certaintyofProblem01.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(certaintyofProblem01, fieldData);
        }
...
public HL7V251Field ProbabilityofProblem
{
    get
    {
        ...
        if (probabilityofProblem.field.FieldRepetitions != null && probabilityofProblem.field.FieldRepetitions.Count > 0)
        {
            ...
            probabilityofProblem.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(probabilityofProblem, fieldData);
        }
...
public HL7V251Field IndividualAwarenessofProblem
{
    get
    {
        ...
        if (individualAwarenessofProblem.field.FieldRepetitions != null && individualAwarenessofProblem.field.FieldRepetitions.Count > 0)
        {
            ...
            individualAwarenessofProblem.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(individualAwarenessofProblem, fieldData);
        }
...
public HL7V251Field ProblemPrognosis
{
    get
    {
        ...
        if (problemPrognosis.field.FieldRepetitions != null && problemPrognosis.field.FieldRepetitions.Count > 0)
        {
            ...
            problemPrognosis.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(problemPrognosis, fieldData);
        }
...
public HL7V251Field IndividualAwarenessofPrognosis
{
    get
    {
        ...
        if (individualAwarenessofPrognosis.field.FieldRepetitions != null && individualAwarenessofPrognosis.field.FieldRepetitions.Count > 0)
        {
            ...
            individualAwarenessofPrognosis.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(individualAwarenessofPrognosis, fieldData);
        }
...
public HL7V251Field FamilySignificantOtherAwarenessofProblemPrognosis
{
    get
    {
        ...
        if (familySignificantOtherAwarenessofProblemPrognosis.field.FieldRepetitions != null && familySignificantOtherAwarenessofProblemPrognosis.field.FieldRepetitions.Count > 0)
        {
            ...
            familySignificantOtherAwarenessofProblemPrognosis.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(familySignificantOtherAwarenessofProblemPrognosis, fieldData);
        }
...
public HL7V251Field SecuritySensitivity
{
    get
    {
        ...
        if (securitySensitivity.field.FieldRepetitions != null && securitySensitivity.field.FieldRepetitions.Count > 0)
        {
            ...
            securitySensitivity.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(securitySensitivity, fieldData);
        }
