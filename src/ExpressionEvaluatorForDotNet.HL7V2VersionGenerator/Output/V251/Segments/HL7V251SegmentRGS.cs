...
{
    public class HL7V251SegmentRGS
    {
...
This field is conditionally required.  It is required for all updating or modifying trigger events. ais",
        ...
        public HL7V251SegmentRGS(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V251Field setIDRGS;

public HL7V251Field SetIDRGS
{
    get
    {
        if (setIDRGS != null)
...
internal HL7V251Field resourceGroupID;

public HL7V251Field ResourceGroupID
{
    get
    {
        ...
        resourceGroupID = new HL7V251Field
        {
            field = message[@"RGS"][3],
            Id = @"RGS.3",
            Type = @"Field",
