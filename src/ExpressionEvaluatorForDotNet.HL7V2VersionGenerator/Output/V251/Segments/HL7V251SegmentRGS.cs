...
public HL7V251Field SetIDRGS
{
    get
    {
        ...
        if (setIDRGS.field.FieldRepetitions != null && setIDRGS.field.FieldRepetitions.Count > 0)
        {
            ...
            setIDRGS.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(setIDRGS, fieldData);
        }
...
public HL7V251Field ResourceGroupID
{
    get
    {
        ...
        if (resourceGroupID.field.FieldRepetitions != null && resourceGroupID.field.FieldRepetitions.Count > 0)
        {
            ...
            resourceGroupID.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(resourceGroupID, fieldData);
        }
