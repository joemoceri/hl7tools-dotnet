...
public HL7V251Field SetIDCM0
{
    get
    {
        ...
        if (setIDCM0.field.FieldRepetitions != null && setIDCM0.field.FieldRepetitions.Count > 0)
        {
            ...
            setIDCM0.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(setIDCM0, fieldData);
        }
...
public HL7V251Field SponsorStudyID
{
    get
    {
        ...
        if (sponsorStudyID.field.FieldRepetitions != null && sponsorStudyID.field.FieldRepetitions.Count > 0)
        {
            ...
            sponsorStudyID.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(sponsorStudyID, fieldData);
        }
...
public HL7V251Field AlternateStudyID
{
    get
    {
        ...
        if (alternateStudyID.field.FieldRepetitions != null && alternateStudyID.field.FieldRepetitions.Count > 0)
        {
            ...
            alternateStudyID.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(alternateStudyID, fieldData);
        }
...
public HL7V251Field TitleofStudy
{
    get
    {
        ...
        if (titleofStudy.field.FieldRepetitions != null && titleofStudy.field.FieldRepetitions.Count > 0)
        {
            ...
            titleofStudy.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(titleofStudy, fieldData);
        }
...
public HL7V251Field ChairmanofStudy
{
    get
    {
        ...
        if (chairmanofStudy.field.FieldRepetitions != null && chairmanofStudy.field.FieldRepetitions.Count > 0)
        {
            ...
            chairmanofStudy.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(chairmanofStudy, fieldData);
        }
...
public HL7V251Field LastIRBApprovalDate
{
    get
    {
        ...
        if (lastIRBApprovalDate.field.FieldRepetitions != null && lastIRBApprovalDate.field.FieldRepetitions.Count > 0)
        {
            ...
            lastIRBApprovalDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(lastIRBApprovalDate, fieldData);
        }
...
public HL7V251Field TotalAccrualtoDate
{
    get
    {
        ...
        if (totalAccrualtoDate.field.FieldRepetitions != null && totalAccrualtoDate.field.FieldRepetitions.Count > 0)
        {
            ...
            totalAccrualtoDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(totalAccrualtoDate, fieldData);
        }
...
public HL7V251Field LastAccrualDate
{
    get
    {
        ...
        if (lastAccrualDate.field.FieldRepetitions != null && lastAccrualDate.field.FieldRepetitions.Count > 0)
        {
            ...
            lastAccrualDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(lastAccrualDate, fieldData);
        }
...
public HL7V251Field ContactforStudy
{
    get
    {
        ...
        if (contactforStudy.field.FieldRepetitions != null && contactforStudy.field.FieldRepetitions.Count > 0)
        {
            ...
            contactforStudy.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(contactforStudy, fieldData);
        }
...
public HL7V251Field ContactsTelephoneNumber
{
    get
    {
        ...
        if (contactsTelephoneNumber.field.FieldRepetitions != null && contactsTelephoneNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            contactsTelephoneNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(contactsTelephoneNumber, fieldData);
        }
...
public HL7V251Field ContactsAddress
{
    get
    {
        ...
        if (contactsAddress.field.FieldRepetitions != null && contactsAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            contactsAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(contactsAddress, fieldData);
        }
