...
public HL7V251Field QueryDateTime
{
    get
    {
        ...
        if (queryDateTime.field.FieldRepetitions != null && queryDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            queryDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(queryDateTime, fieldData);
        }
...
public HL7V251Field QueryFormatCode
{
    get
    {
        ...
        if (queryFormatCode.field.FieldRepetitions != null && queryFormatCode.field.FieldRepetitions.Count > 0)
        {
            ...
            queryFormatCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(queryFormatCode, fieldData);
        }
...
public HL7V251Field QueryID
{
    get
    {
        ...
        if (queryID.field.FieldRepetitions != null && queryID.field.FieldRepetitions.Count > 0)
        {
            ...
            queryID.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(queryID, fieldData);
        }
...
public HL7V251Field DeferredResponseType
{
    get
    {
        ...
        if (deferredResponseType.field.FieldRepetitions != null && deferredResponseType.field.FieldRepetitions.Count > 0)
        {
            ...
            deferredResponseType.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(deferredResponseType, fieldData);
        }
...
public HL7V251Field DeferredResponseDateTime
{
    get
    {
        ...
        if (deferredResponseDateTime.field.FieldRepetitions != null && deferredResponseDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            deferredResponseDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(deferredResponseDateTime, fieldData);
        }
...
Note:  This field should not have been a required field. However, for backward compatibility it remains a required field. There are some queries in the standard that have not required this field.",
        ...
        if (whoSubjectFilter.field.FieldRepetitions != null && whoSubjectFilter.field.FieldRepetitions.Count > 0)
        {
            ...
            whoSubjectFilter.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(whoSubjectFilter, fieldData);
        }
...
public HL7V251Field WhatSubjectFilter
{
    get
    {
        ...
        if (whatSubjectFilter.field.FieldRepetitions != null && whatSubjectFilter.field.FieldRepetitions.Count > 0)
        {
            ...
            whatSubjectFilter.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(whatSubjectFilter, fieldData);
        }
...
Note:  This field should not have been a required field. However, for backwards compatibility it remains a required field. There are some queries in the standard that have not required this field.  ",
        ...
        if (whatDepartmentDataCode.field.FieldRepetitions != null && whatDepartmentDataCode.field.FieldRepetitions.Count > 0)
        {
            ...
            whatDepartmentDataCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(whatDepartmentDataCode, fieldData);
        }
...
public HL7V251Field WhatDataCodeValueQual
{
    get
    {
        ...
        if (whatDataCodeValueQual.field.FieldRepetitions != null && whatDataCodeValueQual.field.FieldRepetitions.Count > 0)
        {
            ...
            whatDataCodeValueQual.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(whatDataCodeValueQual, fieldData);
        }
...
public HL7V251Field QueryResultsLevel
{
    get
    {
        ...
        if (queryResultsLevel.field.FieldRepetitions != null && queryResultsLevel.field.FieldRepetitions.Count > 0)
        {
            ...
            queryResultsLevel.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(queryResultsLevel, fieldData);
        }
