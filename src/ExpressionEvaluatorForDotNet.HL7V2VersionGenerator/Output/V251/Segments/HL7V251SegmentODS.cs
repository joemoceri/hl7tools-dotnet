...
internal HL7V251Field diet,Supplement,orPreferenceCode;

public HL7V251Field Diet,Supplement,orPreferenceCode
{
    get
    {
        ...
        diet,Supplement,orPreferenceCode = new HL7V251Field
        {
            field = message[@"ODS"][3],
            Id = @"ODS.3",
            Type = @"Field",
