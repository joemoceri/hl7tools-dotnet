...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V251SegmentQRI
    {
        ...
        internal HL7V251Field candidateConfidence;
...
public HL7V251Field CandidateConfidence
{
    get
    {
        ...
        candidateConfidence = new HL7V251Field
        {
            field = message[@"QRI"][1],
            Id = @"QRI.1",
            Type = @"Field",
        ...
        if (candidateConfidence.field.FieldRepetitions != null && candidateConfidence.field.FieldRepetitions.Count > 0)
        {
            ...
            candidateConfidence.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(candidateConfidence, fieldData);
        }
...
internal HL7V251Field matchReasonCode;
...
public HL7V251Field MatchReasonCode
{
    get
    {
        ...
        matchReasonCode = new HL7V251Field
        {
            field = message[@"QRI"][2],
            Id = @"QRI.2",
            Type = @"Field",
        ...
        if (matchReasonCode.field.FieldRepetitions != null && matchReasonCode.field.FieldRepetitions.Count > 0)
        {
            ...
            matchReasonCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(matchReasonCode, fieldData);
        }
...
internal HL7V251Field algorithmDescriptor;
...
public HL7V251Field AlgorithmDescriptor
{
    get
    {
        ...
        algorithmDescriptor = new HL7V251Field
        {
            field = message[@"QRI"][3],
            Id = @"QRI.3",
            Type = @"Field",
        ...
        if (algorithmDescriptor.field.FieldRepetitions != null && algorithmDescriptor.field.FieldRepetitions.Count > 0)
        {
            ...
            algorithmDescriptor.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(algorithmDescriptor, fieldData);
        }
