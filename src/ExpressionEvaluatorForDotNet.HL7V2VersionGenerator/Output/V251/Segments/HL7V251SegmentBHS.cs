...
Note: the text regarding ""extra components"" has been retained for backward compatibility, but it is not currently an accepted format for the ST data type",
        ...
        internal HL7V251Field batchFieldSeparator;
...
public HL7V251Field BatchFieldSeparator
{
    get
    {
        ...
        batchFieldSeparator = new HL7V251Field
        {
            field = message[@"BHS"][1],
            Id = @"BHS.1",
            Type = @"Field",
        ...
        if (batchFieldSeparator.field.FieldRepetitions != null && batchFieldSeparator.field.FieldRepetitions.Count > 0)
        {
            ...
            batchFieldSeparator.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(batchFieldSeparator, fieldData);
        }
...
internal HL7V251Field batchEncodingCharacters;
...
public HL7V251Field BatchEncodingCharacters
{
    get
    {
        ...
        batchEncodingCharacters = new HL7V251Field
        {
            field = message[@"BHS"][2],
            Id = @"BHS.2",
            Type = @"Field",
        ...
        if (batchEncodingCharacters.field.FieldRepetitions != null && batchEncodingCharacters.field.FieldRepetitions.Count > 0)
        {
            ...
            batchEncodingCharacters.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(batchEncodingCharacters, fieldData);
        }
...
internal HL7V251Field batchSendingApplication;
...
public HL7V251Field BatchSendingApplication
{
    get
    {
        ...
        batchSendingApplication = new HL7V251Field
        {
            field = message[@"BHS"][3],
            Id = @"BHS.3",
            Type = @"Field",
        ...
        if (batchSendingApplication.field.FieldRepetitions != null && batchSendingApplication.field.FieldRepetitions.Count > 0)
        {
            ...
            batchSendingApplication.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(batchSendingApplication, fieldData);
        }
...
internal HL7V251Field batchSendingFacility;
...
public HL7V251Field BatchSendingFacility
{
    get
    {
        ...
        batchSendingFacility = new HL7V251Field
        {
            field = message[@"BHS"][4],
            Id = @"BHS.4",
            Type = @"Field",
        ...
        if (batchSendingFacility.field.FieldRepetitions != null && batchSendingFacility.field.FieldRepetitions.Count > 0)
        {
            ...
            batchSendingFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(batchSendingFacility, fieldData);
        }
...
internal HL7V251Field batchReceivingApplication;
...
public HL7V251Field BatchReceivingApplication
{
    get
    {
        ...
        batchReceivingApplication = new HL7V251Field
        {
            field = message[@"BHS"][5],
            Id = @"BHS.5",
            Type = @"Field",
        ...
        if (batchReceivingApplication.field.FieldRepetitions != null && batchReceivingApplication.field.FieldRepetitions.Count > 0)
        {
            ...
            batchReceivingApplication.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(batchReceivingApplication, fieldData);
        }
...
internal HL7V251Field batchReceivingFacility;
...
public HL7V251Field BatchReceivingFacility
{
    get
    {
        ...
        batchReceivingFacility = new HL7V251Field
        {
            field = message[@"BHS"][6],
            Id = @"BHS.6",
            Type = @"Field",
        ...
        if (batchReceivingFacility.field.FieldRepetitions != null && batchReceivingFacility.field.FieldRepetitions.Count > 0)
        {
            ...
            batchReceivingFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(batchReceivingFacility, fieldData);
        }
...
internal HL7V251Field batchCreationDateTime;
...
public HL7V251Field BatchCreationDateTime
{
    get
    {
        ...
        batchCreationDateTime = new HL7V251Field
        {
            field = message[@"BHS"][7],
            Id = @"BHS.7",
            Type = @"Field",
        ...
        if (batchCreationDateTime.field.FieldRepetitions != null && batchCreationDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            batchCreationDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(batchCreationDateTime, fieldData);
        }
...
internal HL7V251Field batchSecurity;
...
public HL7V251Field BatchSecurity
{
    get
    {
        ...
        batchSecurity = new HL7V251Field
        {
            field = message[@"BHS"][8],
            Id = @"BHS.8",
            Type = @"Field",
        ...
        if (batchSecurity.field.FieldRepetitions != null && batchSecurity.field.FieldRepetitions.Count > 0)
        {
            ...
            batchSecurity.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(batchSecurity, fieldData);
        }
...
internal HL7V251Field batchNameIDType;
...
public HL7V251Field BatchNameIDType
{
    get
    {
        ...
        batchNameIDType = new HL7V251Field
        {
            field = message[@"BHS"][9],
            Id = @"BHS.9",
            Type = @"Field",
...
Note: the text regarding ""extra components"" has been retained for backward compatibility, but it is not currently an accepted format for the ST data type",
        ...
        if (batchNameIDType.field.FieldRepetitions != null && batchNameIDType.field.FieldRepetitions.Count > 0)
        {
            ...
            batchNameIDType.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(batchNameIDType, fieldData);
        }
...
internal HL7V251Field batchControlID;
...
public HL7V251Field BatchControlID
{
    get
    {
        ...
        batchControlID = new HL7V251Field
        {
        ...
        if (batchControlID.field.FieldRepetitions != null && batchControlID.field.FieldRepetitions.Count > 0)
        {
            ...
            batchControlID.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(batchControlID, fieldData);
        }
...
internal HL7V251Field referenceBatchControlID;
...
public HL7V251Field ReferenceBatchControlID
{
    get
    {
        ...
        referenceBatchControlID = new HL7V251Field
        {
        ...
        if (referenceBatchControlID.field.FieldRepetitions != null && referenceBatchControlID.field.FieldRepetitions.Count > 0)
        {
            ...
            referenceBatchControlID.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(referenceBatchControlID, fieldData);
        }
