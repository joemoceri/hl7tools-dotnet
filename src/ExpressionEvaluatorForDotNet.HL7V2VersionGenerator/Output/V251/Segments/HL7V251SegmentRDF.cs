...
{
    public class HL7V251SegmentRDF
    {
        ...
        public HL7V251SegmentRDF(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V251Field _numberofColumnsperRow;

public HL7V251Field NumberofColumnsperRow
{
    get
    {
        ...
        _numberofColumnsperRow = new HL7V251Field
        {
            field = message[@"RDF"][1],
            fieldData = fieldData
        };
        ...
        {
            _numberofColumnsperRow.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(_numberofColumnsperRow, fieldData);
        }
...
internal HL7V251Field _columnDescription;

public HL7V251Field ColumnDescription
{
    get
    {
        ...
        _columnDescription = new HL7V251Field
        {
            field = message[@"RDF"][2],
            fieldData = fieldData
        };
        ...
        {
            _columnDescription.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(_columnDescription, fieldData);
        }
