...
{
    public class HL7V251SegmentLRL
    {
        ...
        public string Description { get { return @"The LRL segment is used to identify one location’s relationship to another location, the nearest lab, pharmacy, etc."; } }
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
                        ...
                        new HL7V2FieldData
                        {
                            ...
                            TableId = null,
                            TableName = null,
                            Description = @"This field is conditional on the value of LRL-4 - Location Relationship ID. When LRL-4 -Location Relationship ID contains ""RX""- Nearest Pharmacy, ""RX2""- Other Pharmacy, ""LAB""- Nearest Lab, ""LB2""- Other Lab, or ""DTY""- Dietary, this field holds that organizations extended name i.e., the value of this field is conditional on the value of LRL-4 - Location Relationship ID . For example, for an inpatient location, this could be an in-house department ID code using only the third component of this data type. For an outpatient location, this could be the nearest external pharmacy.",
                            Sample = @"",
                            FieldDatas = new []{new HL7V2FieldData
                        {
                            Id = @"LRL.5.1",
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        public HL7V251SegmentLRL(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V251Field primaryKeyValueLRL;

public HL7V251Field PrimaryKeyValueLRL
{
    get
    {
        ...
        primaryKeyValueLRL = new HL7V251Field
        {
            field = message[@"LRL"][1],
            Id = @"LRL.1",
            Type = @"Field",
        ...
        if (primaryKeyValueLRL.field.FieldRepetitions != null && primaryKeyValueLRL.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValueLRL.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(primaryKeyValueLRL, fieldData);
        }
...
public HL7V251Field SegmentActionCode
{
    get
    {
        ...
        if (segmentActionCode.field.FieldRepetitions != null && segmentActionCode.field.FieldRepetitions.Count > 0)
        {
            ...
            segmentActionCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(segmentActionCode, fieldData);
        }
...
internal HL7V251Field segmentUniqueKey;

public HL7V251Field SegmentUniqueKey
{
    get
    {
        ...
        segmentUniqueKey = new HL7V251Field
        {
            field = message[@"LRL"][3],
            Id = @"LRL.3",
            Type = @"Field",
        ...
        if (segmentUniqueKey.field.FieldRepetitions != null && segmentUniqueKey.field.FieldRepetitions.Count > 0)
        {
            ...
            segmentUniqueKey.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(segmentUniqueKey, fieldData);
        }
...
internal HL7V251Field locationRelationshipID;

public HL7V251Field LocationRelationshipID
{
    get
    {
        ...
        locationRelationshipID = new HL7V251Field
        {
            field = message[@"LRL"][4],
            Id = @"LRL.4",
            Type = @"Field",
        ...
        if (locationRelationshipID.field.FieldRepetitions != null && locationRelationshipID.field.FieldRepetitions.Count > 0)
        {
            ...
            locationRelationshipID.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(locationRelationshipID, fieldData);
        }
...
internal HL7V251Field organizationalLocationRelationshipValue;

public HL7V251Field OrganizationalLocationRelationshipValue
{
    get
    {
        ...
        organizationalLocationRelationshipValue = new HL7V251Field
        {
            field = message[@"LRL"][5],
            Id = @"LRL.5",
            Type = @"Field",
        ...
        if (organizationalLocationRelationshipValue.field.FieldRepetitions != null && organizationalLocationRelationshipValue.field.FieldRepetitions.Count > 0)
        {
            ...
            organizationalLocationRelationshipValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(organizationalLocationRelationshipValue, fieldData);
        }
...
internal HL7V251Field patientLocationRelationshipValue;

public HL7V251Field PatientLocationRelationshipValue
{
    get
    {
        ...
        patientLocationRelationshipValue = new HL7V251Field
        {
            field = message[@"LRL"][6],
            Id = @"LRL.6",
            Type = @"Field",
        ...
        if (patientLocationRelationshipValue.field.FieldRepetitions != null && patientLocationRelationshipValue.field.FieldRepetitions.Count > 0)
        {
            ...
            patientLocationRelationshipValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(patientLocationRelationshipValue, fieldData);
        }
