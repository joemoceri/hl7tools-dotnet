...
{
    public class HL7V251SegmentARQ
    {
...
This field is described in detail in Section 4.5.1.2.  It is an optional field, but if a Placer order number is present, then a Filler order number (Section 10.6.1.25) must also be present",
                            Sample = @"",
                            FieldDatas = new []{
                        new HL7V2FieldData
                        {
...
This field is described in detail in Section 4.5.1.3.  It is conditionally mandatory depending on the presence of the Placer order number (Section 10.6.1.24).  This conditionally mandatory requirement addresses the concern that a Scheduling system cannot and should not create or fill an order.  Therefore, an order must have been accepted by the filler application before scheduling the resources associated with that order",
        ...
        public HL7V251SegmentARQ(HL7V2Message message)
        {
...
internal HL7V251Field requestEventReason;

public HL7V251Field RequestEventReason
{
    get
    {
        ...
        requestEventReason = new HL7V251Field
        {
            field = message[@"ARQ"][6],
            Id = @"ARQ.6",
            Type = @"Field",
...
internal HL7V251Field requestedStartDateTimeRange;

public HL7V251Field RequestedStartDateTimeRange
{
    get
    {
        ...
        requestedStartDateTimeRange = new HL7V251Field
        {
...
internal HL7V251Field priorityARQ;

public HL7V251Field PriorityARQ
{
    get
    {
        if (priorityARQ != null)
...
internal HL7V251Field repeatingInterval;

public HL7V251Field RepeatingInterval
{
    get
    {
        ...
        repeatingInterval = new HL7V251Field
        {
...
internal HL7V251Field repeatingIntervalDuration;

public HL7V251Field RepeatingIntervalDuration
{
    get
    {
        ...
        repeatingIntervalDuration = new HL7V251Field
        {
