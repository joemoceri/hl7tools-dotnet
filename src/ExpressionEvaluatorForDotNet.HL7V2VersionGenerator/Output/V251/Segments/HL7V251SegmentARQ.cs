...
public HL7V251Field RequestEventReason
{
    get
    {
        ...
        if (requestEventReason.field.FieldRepetitions != null && requestEventReason.field.FieldRepetitions.Count > 0)
        {
            ...
            requestEventReason.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(requestEventReason, fieldData);
        }
...
public HL7V251Field RequestedStartDateTimeRange
{
    get
    {
        ...
        if (requestedStartDateTimeRange.field.FieldRepetitions != null && requestedStartDateTimeRange.field.FieldRepetitions.Count > 0)
        {
            ...
            requestedStartDateTimeRange.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(requestedStartDateTimeRange, fieldData);
        }
...
public HL7V251Field PriorityARQ
{
    get
    {
        ...
        if (priorityARQ.field.FieldRepetitions != null && priorityARQ.field.FieldRepetitions.Count > 0)
        {
            ...
            priorityARQ.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(priorityARQ, fieldData);
        }
...
Note:  The subcomponent delimiter defined for the Interval component of the Quantity/Timing field definition has been replaced by a component delimiter for this field. ",
        ...
        if (repeatingInterval.field.FieldRepetitions != null && repeatingInterval.field.FieldRepetitions.Count > 0)
        {
            ...
            repeatingInterval.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(repeatingInterval, fieldData);
        }
...
public HL7V251Field RepeatingIntervalDuration
{
    get
    {
        ...
        if (repeatingIntervalDuration.field.FieldRepetitions != null && repeatingIntervalDuration.field.FieldRepetitions.Count > 0)
        {
            ...
            repeatingIntervalDuration.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(repeatingIntervalDuration, fieldData);
        }
