...
internal HL7V251Field eventCompletionDateTime;
...
public HL7V251Field EventCompletionDateTime
{
    get
    {
        ...
        eventCompletionDateTime = new HL7V251Field
        {
            field = message[@"MFA"][3],
            Id = @"MFA.3",
            Type = @"Field",
        ...
        if (eventCompletionDateTime.field.FieldRepetitions != null && eventCompletionDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            eventCompletionDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(eventCompletionDateTime, fieldData);
        }
...
internal HL7V251Field mFNRecordLevelErrorReturn;
...
public HL7V251Field MFNRecordLevelErrorReturn
{
    get
    {
        ...
        mFNRecordLevelErrorReturn = new HL7V251Field
        {
            field = message[@"MFA"][4],
            Id = @"MFA.4",
            Type = @"Field",
        ...
        if (mFNRecordLevelErrorReturn.field.FieldRepetitions != null && mFNRecordLevelErrorReturn.field.FieldRepetitions.Count > 0)
        {
            ...
            mFNRecordLevelErrorReturn.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(mFNRecordLevelErrorReturn, fieldData);
        }
...
internal HL7V251Field primaryKeyValueMFA;
...
public HL7V251Field PrimaryKeyValueMFA
{
    get
    {
        ...
        primaryKeyValueMFA = new HL7V251Field
        {
            field = message[@"MFA"][5],
            Id = @"MFA.5",
            Type = @"Field",
...
The following exception to the use of the CE data type is deprecated in V2.3.1, and left in for backward compatibility.  When the CE data type is used, the first component of this CE data field carries an optional subcomponent, the application ID, that uniquely defines the application responsible for creating the primary key value.  The application ID subcomponents can be used to guarantee uniqueness of the primary key across multiple applications.",
        ...
        if (primaryKeyValueMFA.field.FieldRepetitions != null && primaryKeyValueMFA.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValueMFA.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(primaryKeyValueMFA, fieldData);
        }
...
internal HL7V251Field primaryKeyValueTypeMFA;
...
public HL7V251Field PrimaryKeyValueTypeMFA
{
    get
    {
        ...
        primaryKeyValueTypeMFA = new HL7V251Field
        {
            field = message[@"MFA"][6],
            Id = @"MFA.6",
            Type = @"Field",
        ...
        if (primaryKeyValueTypeMFA.field.FieldRepetitions != null && primaryKeyValueTypeMFA.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValueTypeMFA.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(primaryKeyValueTypeMFA, fieldData);
        }
