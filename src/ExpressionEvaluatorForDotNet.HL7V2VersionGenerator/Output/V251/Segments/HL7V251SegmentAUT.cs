...
public HL7V251Field AuthorizingPayorPlanID
{
    get
    {
        ...
        if (authorizingPayorPlanID.field.FieldRepetitions != null && authorizingPayorPlanID.field.FieldRepetitions.Count > 0)
        {
            ...
            authorizingPayorPlanID.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(authorizingPayorPlanID, fieldData);
        }
...
public HL7V251Field AuthorizingPayorCompanyID
{
    get
    {
        ...
        if (authorizingPayorCompanyID.field.FieldRepetitions != null && authorizingPayorCompanyID.field.FieldRepetitions.Count > 0)
        {
            ...
            authorizingPayorCompanyID.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(authorizingPayorCompanyID, fieldData);
        }
...
public HL7V251Field AuthorizingPayorCompanyName
{
    get
    {
        ...
        if (authorizingPayorCompanyName.field.FieldRepetitions != null && authorizingPayorCompanyName.field.FieldRepetitions.Count > 0)
        {
            ...
            authorizingPayorCompanyName.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(authorizingPayorCompanyName, fieldData);
        }
...
public HL7V251Field AuthorizationEffectiveDate
{
    get
    {
        ...
        if (authorizationEffectiveDate.field.FieldRepetitions != null && authorizationEffectiveDate.field.FieldRepetitions.Count > 0)
        {
            ...
            authorizationEffectiveDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(authorizationEffectiveDate, fieldData);
        }
...
public HL7V251Field AuthorizationExpirationDate
{
    get
    {
        ...
        if (authorizationExpirationDate.field.FieldRepetitions != null && authorizationExpirationDate.field.FieldRepetitions.Count > 0)
        {
            ...
            authorizationExpirationDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(authorizationExpirationDate, fieldData);
        }
...
public HL7V251Field AuthorizationIdentifier
{
    get
    {
        ...
        if (authorizationIdentifier.field.FieldRepetitions != null && authorizationIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            authorizationIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(authorizationIdentifier, fieldData);
        }
...
public HL7V251Field ReimbursementLimit
{
    get
    {
        ...
        if (reimbursementLimit.field.FieldRepetitions != null && reimbursementLimit.field.FieldRepetitions.Count > 0)
        {
            ...
            reimbursementLimit.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(reimbursementLimit, fieldData);
        }
...
public HL7V251Field RequestedNumberofTreatments
{
    get
    {
        ...
        if (requestedNumberofTreatments.field.FieldRepetitions != null && requestedNumberofTreatments.field.FieldRepetitions.Count > 0)
        {
            ...
            requestedNumberofTreatments.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(requestedNumberofTreatments, fieldData);
        }
...
public HL7V251Field AuthorizedNumberofTreatments
{
    get
    {
        ...
        if (authorizedNumberofTreatments.field.FieldRepetitions != null && authorizedNumberofTreatments.field.FieldRepetitions.Count > 0)
        {
            ...
            authorizedNumberofTreatments.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(authorizedNumberofTreatments, fieldData);
        }
...
public HL7V251Field ProcessDate
{
    get
    {
        ...
        if (processDate.field.FieldRepetitions != null && processDate.field.FieldRepetitions.Count > 0)
        {
            ...
            processDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(processDate, fieldData);
        }
