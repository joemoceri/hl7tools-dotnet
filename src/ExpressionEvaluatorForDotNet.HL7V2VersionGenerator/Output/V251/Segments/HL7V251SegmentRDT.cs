...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V251SegmentRDT
    {
        ...
        internal HL7V251Field _columnValue;
...
public HL7V251Field ColumnValue
{
    get
    {
        ...
        {
            _columnValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(_columnValue, fieldData);
        }
