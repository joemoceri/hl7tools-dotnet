...
internal HL7V251Field _continuationStyle;
...
Refer to HL7 Table 0398 – Continuation Style Code for valid values.",
        ...
        _continuationStyle = new HL7V251Field
        {
            field = message[@"DSC"][2],
            fieldData = fieldData
        };
        ...
        {
            _continuationStyle.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(_continuationStyle, fieldData);
        }
