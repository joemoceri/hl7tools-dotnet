...
public HL7V251Field SetIDORG
{
    get
    {
        ...
        if (setIDORG.field.FieldRepetitions != null && setIDORG.field.FieldRepetitions.Count > 0)
        {
            ...
            setIDORG.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(setIDORG, fieldData);
        }
...
public HL7V251Field OrganizationUnitCode
{
    get
    {
        ...
        if (organizationUnitCode.field.FieldRepetitions != null && organizationUnitCode.field.FieldRepetitions.Count > 0)
        {
            ...
            organizationUnitCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(organizationUnitCode, fieldData);
        }
...
public HL7V251Field OrganizationUnitTypeCode
{
    get
    {
        ...
        if (organizationUnitTypeCode.field.FieldRepetitions != null && organizationUnitTypeCode.field.FieldRepetitions.Count > 0)
        {
            ...
            organizationUnitTypeCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(organizationUnitTypeCode, fieldData);
        }
...
public HL7V251Field PrimaryOrgUnitIndicator
{
    get
    {
        ...
        if (primaryOrgUnitIndicator.field.FieldRepetitions != null && primaryOrgUnitIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryOrgUnitIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(primaryOrgUnitIndicator, fieldData);
        }
...
public HL7V251Field PractitionerOrgUnitIdentifier
{
    get
    {
        ...
        if (practitionerOrgUnitIdentifier.field.FieldRepetitions != null && practitionerOrgUnitIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            practitionerOrgUnitIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(practitionerOrgUnitIdentifier, fieldData);
        }
...
public HL7V251Field HealthCareProviderTypeCode
{
    get
    {
        ...
        if (healthCareProviderTypeCode.field.FieldRepetitions != null && healthCareProviderTypeCode.field.FieldRepetitions.Count > 0)
        {
            ...
            healthCareProviderTypeCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(healthCareProviderTypeCode, fieldData);
        }
...
public HL7V251Field HealthCareProviderClassificationCode
{
    get
    {
        ...
        if (healthCareProviderClassificationCode.field.FieldRepetitions != null && healthCareProviderClassificationCode.field.FieldRepetitions.Count > 0)
        {
            ...
            healthCareProviderClassificationCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(healthCareProviderClassificationCode, fieldData);
        }
...
public HL7V251Field HealthCareProviderAreaofSpecializationCode
{
    get
    {
        ...
        if (healthCareProviderAreaofSpecializationCode.field.FieldRepetitions != null && healthCareProviderAreaofSpecializationCode.field.FieldRepetitions.Count > 0)
        {
            ...
            healthCareProviderAreaofSpecializationCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(healthCareProviderAreaofSpecializationCode, fieldData);
        }
...
public HL7V251Field EffectiveDateRange
{
    get
    {
        ...
        if (effectiveDateRange.field.FieldRepetitions != null && effectiveDateRange.field.FieldRepetitions.Count > 0)
        {
            ...
            effectiveDateRange.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(effectiveDateRange, fieldData);
        }
...
public HL7V251Field BoardApprovalIndicator
{
    get
    {
        ...
        if (boardApprovalIndicator.field.FieldRepetitions != null && boardApprovalIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            boardApprovalIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(boardApprovalIndicator, fieldData);
        }
...
public HL7V251Field PrimaryCarePhysicianIndicator
{
    get
    {
        ...
        if (primaryCarePhysicianIndicator.field.FieldRepetitions != null && primaryCarePhysicianIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryCarePhysicianIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(primaryCarePhysicianIndicator, fieldData);
        }
