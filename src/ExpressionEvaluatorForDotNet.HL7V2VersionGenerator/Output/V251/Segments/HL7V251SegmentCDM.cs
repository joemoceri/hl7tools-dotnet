...
public HL7V251Field ChargeCodeAlias
{
    get
    {
        ...
        if (chargeCodeAlias.field.FieldRepetitions != null && chargeCodeAlias.field.FieldRepetitions.Count > 0)
        {
            ...
            chargeCodeAlias.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(chargeCodeAlias, fieldData);
        }
...
public HL7V251Field ChargeDescriptionShort
{
    get
    {
        ...
        if (chargeDescriptionShort.field.FieldRepetitions != null && chargeDescriptionShort.field.FieldRepetitions.Count > 0)
        {
            ...
            chargeDescriptionShort.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(chargeDescriptionShort, fieldData);
        }
...
public HL7V251Field ChargeDescriptionLong
{
    get
    {
        ...
        if (chargeDescriptionLong.field.FieldRepetitions != null && chargeDescriptionLong.field.FieldRepetitions.Count > 0)
        {
            ...
            chargeDescriptionLong.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(chargeDescriptionLong, fieldData);
        }
...
public HL7V251Field DescriptionOverrideIndicator
{
    get
    {
        ...
        if (descriptionOverrideIndicator.field.FieldRepetitions != null && descriptionOverrideIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            descriptionOverrideIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(descriptionOverrideIndicator, fieldData);
        }
...
public HL7V251Field ExplodingCharges
{
    get
    {
        ...
        if (explodingCharges.field.FieldRepetitions != null && explodingCharges.field.FieldRepetitions.Count > 0)
        {
            ...
            explodingCharges.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(explodingCharges, fieldData);
        }
...
public HL7V251Field InventoryNumber
{
    get
    {
        ...
        if (inventoryNumber.field.FieldRepetitions != null && inventoryNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(inventoryNumber, fieldData);
        }
...
public HL7V251Field ResourceLoad
{
    get
    {
        ...
        if (resourceLoad.field.FieldRepetitions != null && resourceLoad.field.FieldRepetitions.Count > 0)
        {
            ...
            resourceLoad.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(resourceLoad, fieldData);
        }
...
public HL7V251Field ContractNumber
{
    get
    {
        ...
        if (contractNumber.field.FieldRepetitions != null && contractNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            contractNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(contractNumber, fieldData);
        }
...
public HL7V251Field ContractOrganization
{
    get
    {
        ...
        if (contractOrganization.field.FieldRepetitions != null && contractOrganization.field.FieldRepetitions.Count > 0)
        {
            ...
            contractOrganization.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(contractOrganization, fieldData);
        }
...
public HL7V251Field RoomFeeIndicator
{
    get
    {
        ...
        if (roomFeeIndicator.field.FieldRepetitions != null && roomFeeIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            roomFeeIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(roomFeeIndicator, fieldData);
        }
