...
public HL7V251Field DerivedSpecimen
{
    get
    {
        ...
        if (derivedSpecimen.field.FieldRepetitions != null && derivedSpecimen.field.FieldRepetitions.Count > 0)
        {
            ...
            derivedSpecimen.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(derivedSpecimen, fieldData);
        }
...
public HL7V251Field ContainerDescription
{
    get
    {
        ...
        if (containerDescription.field.FieldRepetitions != null && containerDescription.field.FieldRepetitions.Count > 0)
        {
            ...
            containerDescription.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(containerDescription, fieldData);
        }
...
public HL7V251Field ContainerUnits
{
    get
    {
        ...
        if (containerUnits.field.FieldRepetitions != null && containerUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            containerUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(containerUnits, fieldData);
        }
...
public HL7V251Field Specimen
{
    get
    {
        ...
        if (specimen.field.FieldRepetitions != null && specimen.field.FieldRepetitions.Count > 0)
        {
            ...
            specimen.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(specimen, fieldData);
        }
...
public HL7V251Field Preparation
{
    get
    {
        ...
        if (preparation.field.FieldRepetitions != null && preparation.field.FieldRepetitions.Count > 0)
        {
            ...
            preparation.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(preparation, fieldData);
        }
...
public HL7V251Field SpecialHandlingRequirements
{
    get
    {
        ...
        if (specialHandlingRequirements.field.FieldRepetitions != null && specialHandlingRequirements.field.FieldRepetitions.Count > 0)
        {
            ...
            specialHandlingRequirements.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(specialHandlingRequirements, fieldData);
        }
...
public HL7V251Field NormalCollectionVolume
{
    get
    {
        ...
        if (normalCollectionVolume.field.FieldRepetitions != null && normalCollectionVolume.field.FieldRepetitions.Count > 0)
        {
            ...
            normalCollectionVolume.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(normalCollectionVolume, fieldData);
        }
...
public HL7V251Field MinimumCollectionVolume
{
    get
    {
        ...
        if (minimumCollectionVolume.field.FieldRepetitions != null && minimumCollectionVolume.field.FieldRepetitions.Count > 0)
        {
            ...
            minimumCollectionVolume.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(minimumCollectionVolume, fieldData);
        }
...
public HL7V251Field SpecimenRequirements
{
    get
    {
        ...
        if (specimenRequirements.field.FieldRepetitions != null && specimenRequirements.field.FieldRepetitions.Count > 0)
        {
            ...
            specimenRequirements.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(specimenRequirements, fieldData);
        }
...
public HL7V251Field SpecimenPriorities
{
    get
    {
        ...
        if (specimenPriorities.field.FieldRepetitions != null && specimenPriorities.field.FieldRepetitions.Count > 0)
        {
            ...
            specimenPriorities.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(specimenPriorities, fieldData);
        }
...
public HL7V251Field SpecimenRetentionTime
{
    get
    {
        ...
        if (specimenRetentionTime.field.FieldRepetitions != null && specimenRetentionTime.field.FieldRepetitions.Count > 0)
        {
            ...
            specimenRetentionTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(specimenRetentionTime, fieldData);
        }
