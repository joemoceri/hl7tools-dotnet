...
internal HL7V251Field _userParametersinsuccessivefields;
...
public HL7V251Field UserParametersinsuccessivefields
{
    get
    {
        ...
        _userParametersinsuccessivefields = new HL7V251Field
        {
            field = message[@"QPD"][3],
            fieldData = fieldData
        };
        ...
        {
            _userParametersinsuccessivefields.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(_userParametersinsuccessivefields, fieldData);
        }
