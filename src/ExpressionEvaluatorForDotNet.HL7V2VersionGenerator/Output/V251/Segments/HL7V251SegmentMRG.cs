...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V251SegmentMRG
    {
        ...
        internal HL7V251Field _priorPatientIdentifierList;
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _priorPatientIdentifierList = new HL7V251Field
        {
            field = message[@"MRG"][1],
            fieldData = fieldData
        };
        ...
        {
            _priorPatientIdentifierList.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(_priorPatientIdentifierList, fieldData);
        }
...
internal HL7V251Field _priorAlternatePatientID;
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _priorAlternatePatientID = new HL7V251Field
        {
            field = message[@"MRG"][2],
            fieldData = fieldData
        };
        ...
        {
            _priorAlternatePatientID.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(_priorAlternatePatientID, fieldData);
        }
...
internal HL7V251Field _priorPatientAccountNumber;
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _priorPatientAccountNumber = new HL7V251Field
        {
            field = message[@"MRG"][3],
            fieldData = fieldData
        };
        ...
        {
            _priorPatientAccountNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(_priorPatientAccountNumber, fieldData);
        }
...
internal HL7V251Field _priorPatientID;
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _priorPatientID = new HL7V251Field
        {
            field = message[@"MRG"][4],
            fieldData = fieldData
        };
        ...
        {
            _priorPatientID.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(_priorPatientID, fieldData);
        }
...
internal HL7V251Field _priorVisitNumber;
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _priorVisitNumber = new HL7V251Field
        {
            field = message[@"MRG"][5],
            fieldData = fieldData
        };
        ...
        {
            _priorVisitNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(_priorVisitNumber, fieldData);
        }
...
internal HL7V251Field _priorAlternateVisitID;
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _priorAlternateVisitID = new HL7V251Field
        {
            field = message[@"MRG"][6],
            fieldData = fieldData
        };
        ...
        {
            _priorAlternateVisitID.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(_priorAlternateVisitID, fieldData);
        }
...
internal HL7V251Field _priorPatientName;
...
Indicates the degree of precision of the time stamp (Y = year, L = month, D = day, H = hour, M = minute, S = second). Refer to HL7 Table 0529 - Precision for valid value.",
        ...
        _priorPatientName = new HL7V251Field
        {
            field = message[@"MRG"][7],
            fieldData = fieldData
        };
        ...
        {
            _priorPatientName.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(_priorPatientName, fieldData);
        }
