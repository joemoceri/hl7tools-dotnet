...
internal HL7V251Field _storedProcedureName;
...
public HL7V251Field StoredProcedureName
{
    get
    {
        ...
        _storedProcedureName = new HL7V251Field
        {
            field = message[@"SPR"][3],
            fieldData = fieldData
        };
        ...
        {
            _storedProcedureName.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(_storedProcedureName, fieldData);
        }
