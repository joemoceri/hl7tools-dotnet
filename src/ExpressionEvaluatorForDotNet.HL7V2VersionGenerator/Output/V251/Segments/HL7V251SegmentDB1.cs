...
public HL7V251Field SetIDDB1
{
    get
    {
        ...
        if (setIDDB1.field.FieldRepetitions != null && setIDDB1.field.FieldRepetitions.Count > 0)
        {
            ...
            setIDDB1.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(setIDDB1, fieldData);
        }
...
public HL7V251Field DisabledPersonCode
{
    get
    {
        ...
        if (disabledPersonCode.field.FieldRepetitions != null && disabledPersonCode.field.FieldRepetitions.Count > 0)
        {
            ...
            disabledPersonCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(disabledPersonCode, fieldData);
        }
...
public HL7V251Field DisabledPersonIdentifier
{
    get
    {
        ...
        if (disabledPersonIdentifier.field.FieldRepetitions != null && disabledPersonIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            disabledPersonIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(disabledPersonIdentifier, fieldData);
        }
...
public HL7V251Field DisabledIndicator
{
    get
    {
        ...
        if (disabledIndicator.field.FieldRepetitions != null && disabledIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            disabledIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(disabledIndicator, fieldData);
        }
...
public HL7V251Field DisabilityStartDate
{
    get
    {
        ...
        if (disabilityStartDate.field.FieldRepetitions != null && disabilityStartDate.field.FieldRepetitions.Count > 0)
        {
            ...
            disabilityStartDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(disabilityStartDate, fieldData);
        }
...
public HL7V251Field DisabilityEndDate
{
    get
    {
        ...
        if (disabilityEndDate.field.FieldRepetitions != null && disabilityEndDate.field.FieldRepetitions.Count > 0)
        {
            ...
            disabilityEndDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(disabilityEndDate, fieldData);
        }
...
public HL7V251Field DisabilityReturntoWorkDate
{
    get
    {
        ...
        if (disabilityReturntoWorkDate.field.FieldRepetitions != null && disabilityReturntoWorkDate.field.FieldRepetitions.Count > 0)
        {
            ...
            disabilityReturntoWorkDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(disabilityReturntoWorkDate, fieldData);
        }
...
public HL7V251Field DisabilityUnabletoWorkDate
{
    get
    {
        ...
        if (disabilityUnabletoWorkDate.field.FieldRepetitions != null && disabilityUnabletoWorkDate.field.FieldRepetitions.Count > 0)
        {
            ...
            disabilityUnabletoWorkDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(disabilityUnabletoWorkDate, fieldData);
        }
