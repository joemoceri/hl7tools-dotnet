...
{
    public class HL7V251SegmentEQP
    {
...
Indicates the degree of precision of the time stamp (Y = year, L = month, D = day, H = hour, M = minute, S = second). Refer to HL7 Table 0529 - Precision for valid value.",
        ...
        public HL7V251SegmentEQP(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V251Field eventtype;

public HL7V251Field Eventtype
{
    get
    {
        if (eventtype != null)
        ...
        if (eventtype.field.FieldRepetitions != null && eventtype.field.FieldRepetitions.Count > 0)
        {
            ...
            eventtype.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(eventtype, fieldData);
        }
...
internal HL7V251Field fileName;

public HL7V251Field FileName
{
    get
    {
        if (fileName != null)
        ...
        if (fileName.field.FieldRepetitions != null && fileName.field.FieldRepetitions.Count > 0)
        {
            ...
            fileName.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(fileName, fieldData);
        }
...
internal HL7V251Field transactionData;

public HL7V251Field TransactionData
{
    get
    {
        ...
        transactionData = new HL7V251Field
        {
            field = message[@"EQP"][5],
            Id = @"EQP.5",
            Type = @"Field",
        ...
        if (transactionData.field.FieldRepetitions != null && transactionData.field.FieldRepetitions.Count > 0)
        {
            ...
            transactionData.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(transactionData, fieldData);
        }
