...
{
    public class HL7V251SegmentNPU
    {
        ...
        public HL7V251SegmentNPU(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V251Field _bedLocation;

public HL7V251Field BedLocation
{
    get
    {
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        {
            _bedLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(_bedLocation, fieldData);
        }
