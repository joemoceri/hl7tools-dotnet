...
public HL7V251Field PrimaryKeyValueLCC
{
    get
    {
        ...
        if (primaryKeyValueLCC.field.FieldRepetitions != null && primaryKeyValueLCC.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValueLCC.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(primaryKeyValueLCC, fieldData);
        }
...
public HL7V251Field AccommodationType
{
    get
    {
        ...
        if (accommodationType.field.FieldRepetitions != null && accommodationType.field.FieldRepetitions.Count > 0)
        {
            ...
            accommodationType.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(accommodationType, fieldData);
        }
...
public HL7V251Field ChargeCode
{
    get
    {
        ...
        if (chargeCode.field.FieldRepetitions != null && chargeCode.field.FieldRepetitions.Count > 0)
        {
            ...
            chargeCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(chargeCode, fieldData);
        }
