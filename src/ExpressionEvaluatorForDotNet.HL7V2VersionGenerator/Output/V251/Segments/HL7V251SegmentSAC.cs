...
internal HL7V251Field primary(parent)ContainerIdentifier;

public HL7V251Field Primary(parent)ContainerIdentifier
{
    get
    {
        ...
        primary(parent)ContainerIdentifier = new HL7V251Field
        {
            field = message[@"SAC"][4],
            Id = @"SAC.4",
            Type = @"Field",
