...
{
    public class HL7V251SegmentVTQ
    {
...
The VTQ segment is used to define queries that are responded to with the Tabular Data Message (TBR).  The VTQ query message is an alternate method to the EQQ query message that some systems may find easier to implement, due to its use of HL7 delimiters that separate components of the selection definition, and its limited selection criteria.  Queries involving complex selection criteria (nested operators, etc.) may need to be formatted as an EQL segment. "; } }
        ...
        public HL7V251SegmentVTQ(HL7V2Message message)
        {
...
internal HL7V251Field _queryResponseFormatCode;
...
public HL7V251Field QueryResponseFormatCode
{
    get
    {
        ...
        _queryResponseFormatCode = new HL7V251Field
        {
            field = message[@"VTQ"][2],
            fieldData = fieldData
        };
        ...
        {
            _queryResponseFormatCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(_queryResponseFormatCode, fieldData);
        }
...
internal HL7V251Field _vTQueryName;

public HL7V251Field VTQueryName
{
    get
    {
        ...
        {
            _vTQueryName.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(_vTQueryName, fieldData);
        }
...
internal HL7V251Field _virtualTableName;

public HL7V251Field VirtualTableName
{
    get
    {
        ...
        _virtualTableName = new HL7V251Field
        {
            field = message[@"VTQ"][4],
            fieldData = fieldData
        };
        ...
        {
            _virtualTableName.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(_virtualTableName, fieldData);
        }
...
internal HL7V251Field _selectionCriteria;

public HL7V251Field SelectionCriteria
{
    get
    {
...
If more than one comparison is to be made to select qualifying rows, a conjunction (defined by HL7 Table 0210 - Relational conjunction) relating this repetition of the field to the next: ",
        ...
        _selectionCriteria = new HL7V251Field
        {
            field = message[@"VTQ"][5],
            fieldData = fieldData
        };
        ...
        {
            _selectionCriteria.fieldRepetitions = HL7V2FieldGenerator.GenerateV251FieldRepetitions(_selectionCriteria, fieldData);
        }
