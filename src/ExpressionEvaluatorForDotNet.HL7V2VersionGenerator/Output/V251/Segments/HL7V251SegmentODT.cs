...
{
    public class HL7V251SegmentODT
    {
            ...
            get 
            {
                return new[]
                        ...
                        new HL7V2FieldData
                        {
                            ...
                            TableId = null,
                            TableName = null,
                            Description = @"When blank, the modifier applies to all service periods. This field allows you to designate one or more of the feeding periods during a day by combining the codes as needed. It can also combine with quantity/timing to give such information as which service period the order belongs with. This field is identical in meaning with ODS-2-service period.",
                            Sample = @"",
                            FieldDatas = new []{new HL7V2FieldData
                        {
                            Id = @"ODT.2.1",
        ...
        public HL7V251SegmentODT(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V251Field trayType;

public HL7V251Field TrayType
{
    get
    {
        if (trayType != null)
        ...
        if (trayType.field.FieldRepetitions != null && trayType.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < trayType.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V251FieldRepetition
                {
                    fieldRepetition = trayType.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    for (var j = 0; j < trayType.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V251Component
                        {
                            component = trayType.field.FieldRepetitions[i].Components[j],
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < trayType.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V251SubComponent
                                {
                                    subComponent = trayType.field.FieldRepetitions[i].Components[j].SubComponents[k],
            ...
            trayType.fieldRepetitions = fieldRepetitions;
        }
...
internal HL7V251Field servicePeriod;

public HL7V251Field ServicePeriod
{
    get
    {
        ...
        servicePeriod = new HL7V251Field
        {
            field = message[@"ODT"][2],
            Id = @"ODT.2",
            Type = @"Field",
