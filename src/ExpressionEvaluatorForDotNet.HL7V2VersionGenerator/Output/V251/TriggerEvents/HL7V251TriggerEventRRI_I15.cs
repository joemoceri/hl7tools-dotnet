...
{
    public class HL7V251TriggerEventRRI_I15
    {
...
public HL7V251SegmentNTE nte{ get; init; }
        ...
        public string EventDescription { get { return @"Request patient referral status acknowledgement"; } }
        ...
        public HL7V251TriggerEventRRI_I15(HL7V2Message message)
        {
