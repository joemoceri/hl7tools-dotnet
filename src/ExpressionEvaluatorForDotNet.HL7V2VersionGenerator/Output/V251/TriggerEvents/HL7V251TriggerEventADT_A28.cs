...
{
    public class HL7V251TriggerEventADT_A28
    {
...
public HL7V251SegmentUB1 ub1{get; init;}
public HL7V251SegmentUB2 ub2{get; init;}


        public string Id { get { return @"ADT_A28"; } }
        public string MessageStructureId { get { return @"ADT_A28"; } }
        public string EventDescription { get { return @"Add Person or Patient Information"; } }
        ...
        public HL7V251TriggerEventADT_A28(HL7V2Message message)
        {
