...
{
    public class HL7V251TriggerEventQRY_Q01
    {
...
public HL7V251SegmentDSC dsc{get; init;}
        ...
        public string EventDescription { get { return @"Original Mode Display Query Sent for Immediate Response"; } }
        ...
        public HL7V251TriggerEventQRY_Q01(HL7V2Message message)
        {
