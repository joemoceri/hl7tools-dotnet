...
{
    public class HL7V251TriggerEventQBP_Z89
    {
...
public HL7V251SegmentDSC dsc{ get; init; }
        ...
        public string EventDescription { get { return @"Lab Results History Query"; } }
        ...
        public HL7V251TriggerEventQBP_Z89(HL7V2Message message)
        {
