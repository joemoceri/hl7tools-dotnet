...
{
    public class HL7V251TriggerEventQBP_Z85
    {
...
public HL7V251SegmentDSC dsc{get; init;}
        ...
        public string EventDescription { get { return @"Pharmacy Information Comprehensive Query"; } }
        ...
        public HL7V251TriggerEventQBP_Z85(HL7V2Message message)
        {
