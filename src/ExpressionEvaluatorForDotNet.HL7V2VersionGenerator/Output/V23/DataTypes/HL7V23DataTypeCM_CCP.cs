...
{
    public class HL7V23DataTypeCM_CCP
    {
        public string Id { get { return @"CM_CCP"; } }

        public string Type { get { return @"DataType"; } }

        public string Name { get { return @"Channel Calibration Parameters"; } }

        public string Description { get { return @"This component consists of three optional subcomponents (each a maximum of 20 characters, data type NM), separated from each other by subcomponent delimiters (&), which define corrections to channel sensitivity, baseline, and channel time skew which may be derived from a calibration procedure"; } }
            ...
            get 
            {
                return new[]
                            ...
                            new HL7V2FieldData
                        {
                            ...
                            TableId = null,
                            TableName = null,
                            Description = @"Defines a correction factor for channel sensitivity which may be derived from the last calibration procedure performed.  The actual channel sensitivity is the nominal channel sensitivity given in the previous component multiplied by the unitless correction factor.",
                            Sample = null,
                            FieldDatas = null
                        },
