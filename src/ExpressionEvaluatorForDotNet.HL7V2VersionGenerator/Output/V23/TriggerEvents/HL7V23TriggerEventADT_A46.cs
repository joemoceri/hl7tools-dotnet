...
{
    public class HL7V23TriggerEventADT_A46
    {
...
public HL7V23SegmentMRG mrg{get; init;}
        ...
        public string EventDescription { get { return @"Change external ID"; } }
        ...
        public HL7V23TriggerEventADT_A46(HL7V2Message message)
        {
