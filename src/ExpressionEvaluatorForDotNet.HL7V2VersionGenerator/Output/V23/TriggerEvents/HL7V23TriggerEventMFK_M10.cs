...
{
    public class HL7V23TriggerEventMFK_M10
    {
...
public HL7V23SegmentMFA mfa{get; init;}
        ...
        public string EventDescription { get { return @"Test/observation batteries master file acknowledgment"; } }
        ...
        public HL7V23TriggerEventMFK_M10(HL7V2Message message)
        {
