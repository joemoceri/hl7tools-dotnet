...
{
    public class HL7V23TriggerEventRPA_I10
    {
...
private readonly HL7V23SegmentNTE nte;
        ...
        public string EventDescription { get { return @"Response for resubmission of an authorization "; } }
        ...
        public HL7V23TriggerEventRPA_I10(HL7V2Message message)
        {
