...
{
    public class HL7V23TriggerEventSRR_S04
    {
...
public readonly HL7V23SegmentERR err;
        ...
        public string EventDescription { get { return @"Response appointment cancellation "; } }
        ...
        public HL7V23TriggerEventSRR_S04(HL7V2Message message)
        {
