...
{
    public class HL7V23TriggerEventRPA_I09
    {
...
private readonly HL7V23SegmentNTE nte;
        ...
        public string EventDescription { get { return @"Response for modification to an authorization"; } }
        ...
        public HL7V23TriggerEventRPA_I09(HL7V2Message message)
        {
