...
{
    public class HL7V23TriggerEventSRR_S10
    {
...
public HL7V23SegmentERR err{get; init;}
        ...
        public string EventDescription { get { return @"Response discontinuation of service/resource on appointment"; } }
        ...
        public HL7V23TriggerEventSRR_S10(HL7V2Message message)
        {
