...
{
    public class HL7V23TriggerEventDSR_P04
    {
...
public HL7V23SegmentDSC dsc{ get; init; }
        ...
        public string EventDescription { get { return @"Generate bills and accounts receivable statements response"; } }
        ...
        public HL7V23TriggerEventDSR_P04(HL7V2Message message)
        {
