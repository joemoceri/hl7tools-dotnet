...
{
    public class HL7V23TriggerEventRPA_I08
    {
...
private readonly HL7V23SegmentNTE nte;
        ...
        public string EventDescription { get { return @"Response for treatment authorization information "; } }
        ...
        public HL7V23TriggerEventRPA_I08(HL7V2Message message)
        {
