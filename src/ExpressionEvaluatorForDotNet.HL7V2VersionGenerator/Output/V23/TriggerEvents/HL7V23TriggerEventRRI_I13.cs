...
{
    public class HL7V23TriggerEventRRI_I13
    {
...
public HL7V23SegmentNTE nte{ get; init; }
        ...
        public string EventDescription { get { return @"Response modify patient referral"; } }
        ...
        public HL7V23TriggerEventRRI_I13(HL7V2Message message)
        {
