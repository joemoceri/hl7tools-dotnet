...
{
    public class HL7V23TriggerEventSRR_S01
    {
...
public readonly HL7V23SegmentERR err;
        ...
        public string EventDescription { get { return @"Response new appointment booking "; } }
        ...
        public HL7V23TriggerEventSRR_S01(HL7V2Message message)
        {
