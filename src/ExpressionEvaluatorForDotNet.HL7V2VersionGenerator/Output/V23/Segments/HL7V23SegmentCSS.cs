...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V23SegmentCSS
    {
        ...
        internal HL7V23Field studyScheduledTimePoint;
...
public HL7V23Field StudyScheduledTimePoint
{
    get
    {
        ...
        studyScheduledTimePoint = new HL7V23Field
        {
            field = message[@"CSS"][1],
            Id = @"CSS.1",
            Type = @"Field",
        ...
        if (studyScheduledTimePoint.field.FieldRepetitions != null && studyScheduledTimePoint.field.FieldRepetitions.Count > 0)
        {
            ...
            studyScheduledTimePoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(studyScheduledTimePoint, fieldData);
        }
...
internal HL7V23Field studyScheduledPatientTimePoint;
...
public HL7V23Field StudyScheduledPatientTimePoint
{
    get
    {
        ...
        studyScheduledPatientTimePoint = new HL7V23Field
        {
            field = message[@"CSS"][2],
            Id = @"CSS.2",
            Type = @"Field",
        ...
        if (studyScheduledPatientTimePoint.field.FieldRepetitions != null && studyScheduledPatientTimePoint.field.FieldRepetitions.Count > 0)
        {
            ...
            studyScheduledPatientTimePoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(studyScheduledPatientTimePoint, fieldData);
        }
...
internal HL7V23Field studyQualityControlCodes;
...
public HL7V23Field StudyQualityControlCodes
{
    get
    {
        ...
        studyQualityControlCodes = new HL7V23Field
        {
            field = message[@"CSS"][3],
            Id = @"CSS.3",
            Type = @"Field",
        ...
        if (studyQualityControlCodes.field.FieldRepetitions != null && studyQualityControlCodes.field.FieldRepetitions.Count > 0)
        {
            ...
            studyQualityControlCodes.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(studyQualityControlCodes, fieldData);
        }
