...
public HL7V23Field ProblemID
{
    get
    {
        ...
        if (problemID.field.FieldRepetitions != null && problemID.field.FieldRepetitions.Count > 0)
        {
            ...
            problemID.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(problemID, fieldData);
        }
...
Note: It is required that this value remain unique over time .  This instance ID identifies a specific instance for a specific patient and is unique across all patients.  See entity ID data type description in Chapter 2. ",
        ...
        if (problemInstanceID.field.FieldRepetitions != null && problemInstanceID.field.FieldRepetitions.Count > 0)
        {
            ...
            problemInstanceID.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(problemInstanceID, fieldData);
        }
...
public HL7V23Field ProblemListPriority
{
    get
    {
        ...
        if (problemListPriority.field.FieldRepetitions != null && problemListPriority.field.FieldRepetitions.Count > 0)
        {
            ...
            problemListPriority.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(problemListPriority, fieldData);
        }
...
public HL7V23Field ProblemEstablishedDateTime
{
    get
    {
        ...
        if (problemEstablishedDateTime.field.FieldRepetitions != null && problemEstablishedDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            problemEstablishedDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(problemEstablishedDateTime, fieldData);
        }
...
public HL7V23Field AnticipatedProblemResolutionDateTime
{
    get
    {
        ...
        if (anticipatedProblemResolutionDateTime.field.FieldRepetitions != null && anticipatedProblemResolutionDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            anticipatedProblemResolutionDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(anticipatedProblemResolutionDateTime, fieldData);
        }
...
public HL7V23Field ActualProblemResolutionDateTime
{
    get
    {
        ...
        if (actualProblemResolutionDateTime.field.FieldRepetitions != null && actualProblemResolutionDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            actualProblemResolutionDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(actualProblemResolutionDateTime, fieldData);
        }
...
public HL7V23Field ProblemClassification
{
    get
    {
        ...
        if (problemClassification.field.FieldRepetitions != null && problemClassification.field.FieldRepetitions.Count > 0)
        {
            ...
            problemClassification.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(problemClassification, fieldData);
        }
...
public HL7V23Field ProblemManagementDiscipline
{
    get
    {
        ...
        if (problemManagementDiscipline.field.FieldRepetitions != null && problemManagementDiscipline.field.FieldRepetitions.Count > 0)
        {
            ...
            problemManagementDiscipline.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(problemManagementDiscipline, fieldData);
        }
...
public HL7V23Field ProblemPersistence
{
    get
    {
        ...
        if (problemPersistence.field.FieldRepetitions != null && problemPersistence.field.FieldRepetitions.Count > 0)
        {
            ...
            problemPersistence.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(problemPersistence, fieldData);
        }
...
public HL7V23Field ProblemConfirmationStatus
{
    get
    {
        ...
        if (problemConfirmationStatus.field.FieldRepetitions != null && problemConfirmationStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            problemConfirmationStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(problemConfirmationStatus, fieldData);
        }
...
public HL7V23Field ProblemLifeCycleStatus
{
    get
    {
        ...
        if (problemLifeCycleStatus.field.FieldRepetitions != null && problemLifeCycleStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            problemLifeCycleStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(problemLifeCycleStatus, fieldData);
        }
...
public HL7V23Field ProblemLifeCycleStatusDateTime
{
    get
    {
        ...
        if (problemLifeCycleStatusDateTime.field.FieldRepetitions != null && problemLifeCycleStatusDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            problemLifeCycleStatusDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(problemLifeCycleStatusDateTime, fieldData);
        }
...
public HL7V23Field ProblemDateofOnset
{
    get
    {
        ...
        if (problemDateofOnset.field.FieldRepetitions != null && problemDateofOnset.field.FieldRepetitions.Count > 0)
        {
            ...
            problemDateofOnset.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(problemDateofOnset, fieldData);
        }
...
public HL7V23Field ProblemOnsetText
{
    get
    {
        ...
        if (problemOnsetText.field.FieldRepetitions != null && problemOnsetText.field.FieldRepetitions.Count > 0)
        {
            ...
            problemOnsetText.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(problemOnsetText, fieldData);
        }
...
public HL7V23Field ProblemRanking
{
    get
    {
        ...
        if (problemRanking.field.FieldRepetitions != null && problemRanking.field.FieldRepetitions.Count > 0)
        {
            ...
            problemRanking.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(problemRanking, fieldData);
        }
...
public HL7V23Field CertaintyofProblem
{
    get
    {
        ...
        if (certaintyofProblem.field.FieldRepetitions != null && certaintyofProblem.field.FieldRepetitions.Count > 0)
        {
            ...
            certaintyofProblem.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(certaintyofProblem, fieldData);
        }
...
Note: We have provided for two different representations of the certainty of the problem due to varying representations in applications",
        ...
        if (probabilityofProblem.field.FieldRepetitions != null && probabilityofProblem.field.FieldRepetitions.Count > 0)
        {
            ...
            probabilityofProblem.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(probabilityofProblem, fieldData);
        }
...
public HL7V23Field IndividualAwarenessofProblem
{
    get
    {
        ...
        if (individualAwarenessofProblem.field.FieldRepetitions != null && individualAwarenessofProblem.field.FieldRepetitions.Count > 0)
        {
            ...
            individualAwarenessofProblem.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(individualAwarenessofProblem, fieldData);
        }
...
public HL7V23Field ProblemPrognosis
{
    get
    {
        ...
        if (problemPrognosis.field.FieldRepetitions != null && problemPrognosis.field.FieldRepetitions.Count > 0)
        {
            ...
            problemPrognosis.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(problemPrognosis, fieldData);
        }
...
public HL7V23Field IndividualAwarenessofPrognosis
{
    get
    {
        ...
        if (individualAwarenessofPrognosis.field.FieldRepetitions != null && individualAwarenessofPrognosis.field.FieldRepetitions.Count > 0)
        {
            ...
            individualAwarenessofPrognosis.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(individualAwarenessofPrognosis, fieldData);
        }
...
public HL7V23Field FamilySignificantOtherAwarenessofProblemPrognosis
{
    get
    {
        ...
        if (familySignificantOtherAwarenessofProblemPrognosis.field.FieldRepetitions != null && familySignificantOtherAwarenessofProblemPrognosis.field.FieldRepetitions.Count > 0)
        {
            ...
            familySignificantOtherAwarenessofProblemPrognosis.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(familySignificantOtherAwarenessofProblemPrognosis, fieldData);
        }
...
public HL7V23Field SecuritySensitivity
{
    get
    {
        ...
        if (securitySensitivity.field.FieldRepetitions != null && securitySensitivity.field.FieldRepetitions.Count > 0)
        {
            ...
            securitySensitivity.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(securitySensitivity, fieldData);
        }
