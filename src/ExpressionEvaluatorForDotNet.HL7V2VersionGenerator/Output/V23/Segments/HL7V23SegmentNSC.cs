...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V23SegmentNSC
    {
        ...
        internal HL7V23Field _networkChangeType;
...
public HL7V23Field NetworkChangeType
{
    get
    {
        ...
        _networkChangeType = new HL7V23Field
        {
            field = message[@"NSC"][1],
            fieldData = fieldData
        };
        ...
        {
            _networkChangeType.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_networkChangeType, fieldData);
        }
...
internal HL7V23Field _currentCPU;
...
public HL7V23Field CurrentCPU
{
    get
    {
        ...
        {
            _currentCPU.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_currentCPU, fieldData);
        }
...
internal HL7V23Field _currentFileserver;
...
public HL7V23Field CurrentFileserver
{
    get
    {
        ...
        _currentFileserver = new HL7V23Field
        {
            field = message[@"NSC"][3],
            fieldData = fieldData
        };
        ...
        {
            _currentFileserver.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_currentFileserver, fieldData);
        }
...
internal HL7V23Field _currentApplication;
...
public HL7V23Field CurrentApplication
{
    get
    {
        ...
        _currentApplication = new HL7V23Field
        {
            field = message[@"NSC"][4],
            fieldData = fieldData
        };
        ...
        {
            _currentApplication.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_currentApplication, fieldData);
        }
...
internal HL7V23Field _currentFacility;
...
public HL7V23Field CurrentFacility
{
    get
    {
        ...
        _currentFacility = new HL7V23Field
        {
            field = message[@"NSC"][5],
            fieldData = fieldData
        };
        ...
        {
            _currentFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_currentFacility, fieldData);
        }
...
public HL7V23Field NewCPU
{
    get
    {
        ...
        {
            _newCPU.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_newCPU, fieldData);
        }
...
internal HL7V23Field _newFileserver;
...
public HL7V23Field NewFileserver
{
    get
    {
        ...
        _newFileserver = new HL7V23Field
        {
            field = message[@"NSC"][7],
            fieldData = fieldData
        };
        ...
        {
            _newFileserver.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_newFileserver, fieldData);
        }
...
internal HL7V23Field _newApplication;
...
public HL7V23Field NewApplication
{
    get
    {
        ...
        _newApplication = new HL7V23Field
        {
            field = message[@"NSC"][8],
            fieldData = fieldData
        };
        ...
        {
            _newApplication.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_newApplication, fieldData);
        }
...
internal HL7V23Field _newFacility;
...
public HL7V23Field NewFacility
{
    get
    {
        ...
        {
            _newFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_newFacility, fieldData);
        }
