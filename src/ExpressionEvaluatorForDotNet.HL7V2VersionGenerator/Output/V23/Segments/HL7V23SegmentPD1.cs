...
internal HL7V23Field patientPrimaryCareProviderName&IDNo.;

public HL7V23Field PatientPrimaryCareProviderName&IDNo.
{
    get
    {
        ...
        patientPrimaryCareProviderName&IDNo. = new HL7V23Field
        {
            field = message[@"PD1"][4],
            Id = @"PD1.4",
            Type = @"Field",
