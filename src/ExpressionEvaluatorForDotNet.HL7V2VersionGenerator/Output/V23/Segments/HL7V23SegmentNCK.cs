...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V23SegmentNCK
    {
        ...
        public HL7V23SegmentNCK(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V23Field _systemDateTime;

public HL7V23Field SystemDateTime
{
    get
    {
        ...
        _systemDateTime = new HL7V23Field
        {
            field = message[@"NCK"][1],
            fieldData = fieldData
        };
        ...
        {
            _systemDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_systemDateTime, fieldData);
        }
