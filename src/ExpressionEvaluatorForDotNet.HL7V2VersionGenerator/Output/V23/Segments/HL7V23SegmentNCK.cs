...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V23SegmentNCK
    {
        ...
        internal HL7V23Field systemDateTime;
...
public HL7V23Field SystemDateTime
{
    get
    {
        ...
        systemDateTime = new HL7V23Field
        {
            field = message[@"NCK"][1],
            Id = @"NCK.1",
            Type = @"Field",
        ...
        if (systemDateTime.field.FieldRepetitions != null && systemDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            systemDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(systemDateTime, fieldData);
        }
