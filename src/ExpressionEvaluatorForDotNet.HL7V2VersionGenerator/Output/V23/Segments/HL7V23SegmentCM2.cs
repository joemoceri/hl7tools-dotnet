...
public HL7V23Field CM2SetID
{
    get
    {
        ...
        if (cM2SetID.field.FieldRepetitions != null && cM2SetID.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < cM2SetID.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V23FieldRepetition
                {
                    fieldRepetition = cM2SetID.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    for (var j = 0; j < cM2SetID.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V23Component
                        {
                            component = cM2SetID.field.FieldRepetitions[i].Components[j],
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < cM2SetID.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V23SubComponent
                                {
                                    subComponent = cM2SetID.field.FieldRepetitions[i].Components[j].SubComponents[k],
            ...
            cM2SetID.fieldRepetitions = fieldRepetitions;
        }
