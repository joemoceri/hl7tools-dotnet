...
public HL7V23Field GiveCode
{
    get
    {
        ...
        if (giveCode.field.FieldRepetitions != null && giveCode.field.FieldRepetitions.Count > 0)
        {
            ...
            giveCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(giveCode, fieldData);
        }
...
internal HL7V23Field giveAmountMinimum;
...
public HL7V23Field GiveAmountMinimum
{
    get
    {
        ...
        giveAmountMinimum = new HL7V23Field
        {
            field = message[@"RXE"][3],
            Id = @"RXE.3",
            Type = @"Field",
        ...
        if (giveAmountMinimum.field.FieldRepetitions != null && giveAmountMinimum.field.FieldRepetitions.Count > 0)
        {
            ...
            giveAmountMinimum.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(giveAmountMinimum, fieldData);
        }
...
internal HL7V23Field giveAmountMaximum;
...
public HL7V23Field GiveAmountMaximum
{
    get
    {
        ...
        giveAmountMaximum = new HL7V23Field
        {
            field = message[@"RXE"][4],
            Id = @"RXE.4",
            Type = @"Field",
        ...
        if (giveAmountMaximum.field.FieldRepetitions != null && giveAmountMaximum.field.FieldRepetitions.Count > 0)
        {
            ...
            giveAmountMaximum.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(giveAmountMaximum, fieldData);
        }
...
internal HL7V23Field giveUnits;
...
public HL7V23Field GiveUnits
{
    get
    {
        ...
        if (giveUnits.field.FieldRepetitions != null && giveUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            giveUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(giveUnits, fieldData);
        }
...
internal HL7V23Field giveDosageForm;
...
public HL7V23Field GiveDosageForm
{
    get
    {
        ...
        giveDosageForm = new HL7V23Field
        {
            field = message[@"RXE"][6],
            Id = @"RXE.6",
            Type = @"Field",
        ...
        if (giveDosageForm.field.FieldRepetitions != null && giveDosageForm.field.FieldRepetitions.Count > 0)
        {
            ...
            giveDosageForm.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(giveDosageForm, fieldData);
        }
...
e.g., |^this is a free text administration instruction|",
        ...
        if (providersAdministrationInstructions.field.FieldRepetitions != null && providersAdministrationInstructions.field.FieldRepetitions.Count > 0)
        {
            ...
            providersAdministrationInstructions.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(providersAdministrationInstructions, fieldData);
        }
...
public HL7V23Field DeliverToLocation
{
    get
    {
        ...
        if (deliverToLocation.field.FieldRepetitions != null && deliverToLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            deliverToLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(deliverToLocation, fieldData);
        }
...
internal HL7V23Field substitutionStatus;
...
public HL7V23Field SubstitutionStatus
{
    get
    {
        ...
        substitutionStatus = new HL7V23Field
        {
            field = message[@"RXE"][9],
            Id = @"RXE.9",
            Type = @"Field",
        ...
        if (substitutionStatus.field.FieldRepetitions != null && substitutionStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            substitutionStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(substitutionStatus, fieldData);
        }
...
internal HL7V23Field dispenseAmount;
...
public HL7V23Field DispenseAmount
{
    get
    {
        ...
        dispenseAmount = new HL7V23Field
        {
        ...
        if (dispenseAmount.field.FieldRepetitions != null && dispenseAmount.field.FieldRepetitions.Count > 0)
        {
            ...
            dispenseAmount.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(dispenseAmount, fieldData);
        }
...
internal HL7V23Field dispenseUnits;
...
public HL7V23Field DispenseUnits
{
    get
    {
        ...
        if (dispenseUnits.field.FieldRepetitions != null && dispenseUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            dispenseUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(dispenseUnits, fieldData);
        }
...
public HL7V23Field NumberofRefills
{
    get
    {
        ...
        if (numberofRefills.field.FieldRepetitions != null && numberofRefills.field.FieldRepetitions.Count > 0)
        {
            ...
            numberofRefills.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(numberofRefills, fieldData);
        }
...
public HL7V23Field OrderingProvidersDEANumber
{
    get
    {
        ...
        if (orderingProvidersDEANumber.field.FieldRepetitions != null && orderingProvidersDEANumber.field.FieldRepetitions.Count > 0)
        {
            ...
            orderingProvidersDEANumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(orderingProvidersDEANumber, fieldData);
        }
...
public HL7V23Field PharmacistTreatmentSuppliersVerifierID
{
    get
    {
        ...
        if (pharmacistTreatmentSuppliersVerifierID.field.FieldRepetitions != null && pharmacistTreatmentSuppliersVerifierID.field.FieldRepetitions.Count > 0)
        {
            ...
            pharmacistTreatmentSuppliersVerifierID.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(pharmacistTreatmentSuppliersVerifierID, fieldData);
        }
...
internal HL7V23Field prescriptionNumber;
...
public HL7V23Field PrescriptionNumber
{
    get
    {
        ...
        prescriptionNumber = new HL7V23Field
        {
        ...
        if (prescriptionNumber.field.FieldRepetitions != null && prescriptionNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            prescriptionNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(prescriptionNumber, fieldData);
        }
...
internal HL7V23Field numberofRefillsRemaining;
...
public HL7V23Field NumberofRefillsRemaining
{
    get
    {
        ...
        numberofRefillsRemaining = new HL7V23Field
        {
        ...
        if (numberofRefillsRemaining.field.FieldRepetitions != null && numberofRefillsRemaining.field.FieldRepetitions.Count > 0)
        {
            ...
            numberofRefillsRemaining.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(numberofRefillsRemaining, fieldData);
        }
...
internal HL7V23Field numberofRefillsDosesDispensed;
...
public HL7V23Field NumberofRefillsDosesDispensed
{
    get
    {
        ...
        numberofRefillsDosesDispensed = new HL7V23Field
        {
        ...
        if (numberofRefillsDosesDispensed.field.FieldRepetitions != null && numberofRefillsDosesDispensed.field.FieldRepetitions.Count > 0)
        {
            ...
            numberofRefillsDosesDispensed.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(numberofRefillsDosesDispensed, fieldData);
        }
...
internal HL7V23Field datetimeofmostrecentrefillordosedispensed;
...
public HL7V23Field Datetimeofmostrecentrefillordosedispensed
{
    get
    {
        ...
        datetimeofmostrecentrefillordosedispensed = new HL7V23Field
        {
        ...
        if (datetimeofmostrecentrefillordosedispensed.field.FieldRepetitions != null && datetimeofmostrecentrefillordosedispensed.field.FieldRepetitions.Count > 0)
        {
            ...
            datetimeofmostrecentrefillordosedispensed.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(datetimeofmostrecentrefillordosedispensed, fieldData);
        }
...
internal HL7V23Field totalDailyDose;
...
public HL7V23Field TotalDailyDose
{
    get
    {
        ...
        totalDailyDose = new HL7V23Field
        {
        ...
        if (totalDailyDose.field.FieldRepetitions != null && totalDailyDose.field.FieldRepetitions.Count > 0)
        {
            ...
            totalDailyDose.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(totalDailyDose, fieldData);
        }
...
public HL7V23Field NeedsHumanReview
{
    get
    {
        ...
        if (needsHumanReview.field.FieldRepetitions != null && needsHumanReview.field.FieldRepetitions.Count > 0)
        {
            ...
            needsHumanReview.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(needsHumanReview, fieldData);
        }
...
public HL7V23Field PharmacyTreatmentSuppliersSpecialDispensingInstructions
{
    get
    {
        ...
        if (pharmacyTreatmentSuppliersSpecialDispensingInstructions.field.FieldRepetitions != null && pharmacyTreatmentSuppliersSpecialDispensingInstructions.field.FieldRepetitions.Count > 0)
        {
            ...
            pharmacyTreatmentSuppliersSpecialDispensingInstructions.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(pharmacyTreatmentSuppliersSpecialDispensingInstructions, fieldData);
        }
...
INDEF = do indefinitely - also the default ",
        ...
        if (givePer.field.FieldRepetitions != null && givePer.field.FieldRepetitions.Count > 0)
        {
            ...
            givePer.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(givePer, fieldData);
        }
...
internal HL7V23Field giveRateAmount;
...
public HL7V23Field GiveRateAmount
{
    get
    {
        ...
        giveRateAmount = new HL7V23Field
        {
        ...
        if (giveRateAmount.field.FieldRepetitions != null && giveRateAmount.field.FieldRepetitions.Count > 0)
        {
            ...
            giveRateAmount.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(giveRateAmount, fieldData);
        }
...
internal HL7V23Field giveRateUnits;
...
public HL7V23Field GiveRateUnits
{
    get
    {
        ...
        if (giveRateUnits.field.FieldRepetitions != null && giveRateUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            giveRateUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(giveRateUnits, fieldData);
        }
...
internal HL7V23Field giveStrength;
...
public HL7V23Field GiveStrength
{
    get
    {
        ...
        if (giveStrength.field.FieldRepetitions != null && giveStrength.field.FieldRepetitions.Count > 0)
        {
            ...
            giveStrength.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(giveStrength, fieldData);
        }
...
internal HL7V23Field giveStrengthUnits;
...
public HL7V23Field GiveStrengthUnits
{
    get
    {
        ...
        giveStrengthUnits = new HL7V23Field
        {
        ...
        if (giveStrengthUnits.field.FieldRepetitions != null && giveStrengthUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            giveStrengthUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(giveStrengthUnits, fieldData);
        }
...
internal HL7V23Field giveIndication;
...
public HL7V23Field GiveIndication
{
    get
    {
        ...
        giveIndication = new HL7V23Field
        {
        ...
        if (giveIndication.field.FieldRepetitions != null && giveIndication.field.FieldRepetitions.Count > 0)
        {
            ...
            giveIndication.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(giveIndication, fieldData);
        }
...
internal HL7V23Field dispensePackageSize;
...
public HL7V23Field DispensePackageSize
{
    get
    {
        ...
        dispensePackageSize = new HL7V23Field
        {
        ...
        if (dispensePackageSize.field.FieldRepetitions != null && dispensePackageSize.field.FieldRepetitions.Count > 0)
        {
            ...
            dispensePackageSize.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(dispensePackageSize, fieldData);
        }
...
internal HL7V23Field dispensePackageSizeUnit;
...
public HL7V23Field DispensePackageSizeUnit
{
    get
    {
        ...
        dispensePackageSizeUnit = new HL7V23Field
        {
        ...
        if (dispensePackageSizeUnit.field.FieldRepetitions != null && dispensePackageSizeUnit.field.FieldRepetitions.Count > 0)
        {
            ...
            dispensePackageSizeUnit.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(dispensePackageSizeUnit, fieldData);
        }
...
internal HL7V23Field dispensePackageMethod;
...
public HL7V23Field DispensePackageMethod
{
    get
    {
        ...
        dispensePackageMethod = new HL7V23Field
        {
        ...
        if (dispensePackageMethod.field.FieldRepetitions != null && dispensePackageMethod.field.FieldRepetitions.Count > 0)
        {
            ...
            dispensePackageMethod.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(dispensePackageMethod, fieldData);
        }
