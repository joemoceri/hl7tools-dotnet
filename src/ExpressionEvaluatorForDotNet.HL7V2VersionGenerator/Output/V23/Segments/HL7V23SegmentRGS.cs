...
If a message does not require any grouping of resources, then specify a single RGS in the message, and follow it with all of the Appointment Information segments for the scheduled event.   (At least one RGS segment is required in each message — even if no grouping of resources is required — to allow parsers to properly understand the message.) "; } }
        ...
        internal HL7V23Field _setIDRGS;
...
public HL7V23Field SetIDRGS
{
    get
    {
        ...
        {
            _setIDRGS.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_setIDRGS, fieldData);
        }
...
internal HL7V23Field _resourceGroupID;
...
public HL7V23Field ResourceGroupID
{
    get
    {
        ...
        _resourceGroupID = new HL7V23Field
        {
            field = message[@"RGS"][3],
            fieldData = fieldData
        };
        ...
        {
            _resourceGroupID.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_resourceGroupID, fieldData);
        }
