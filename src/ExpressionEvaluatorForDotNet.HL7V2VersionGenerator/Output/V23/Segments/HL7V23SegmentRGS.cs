...
public HL7V23Field SetIDRGS
{
    get
    {
        ...
        if (setIDRGS.field.FieldRepetitions != null && setIDRGS.field.FieldRepetitions.Count > 0)
        {
            ...
            setIDRGS.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(setIDRGS, fieldData);
        }
...
public HL7V23Field ResourceGroupID
{
    get
    {
        ...
        if (resourceGroupID.field.FieldRepetitions != null && resourceGroupID.field.FieldRepetitions.Count > 0)
        {
            ...
            resourceGroupID.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(resourceGroupID, fieldData);
        }
