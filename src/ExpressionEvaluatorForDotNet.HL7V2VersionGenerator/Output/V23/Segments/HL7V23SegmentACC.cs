...
public HL7V23Field AccidentDateTime
{
    get
    {
        ...
        if (accidentDateTime.field.FieldRepetitions != null && accidentDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            accidentDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(accidentDateTime, fieldData);
        }
...
public HL7V23Field AccidentCode
{
    get
    {
        ...
        if (accidentCode.field.FieldRepetitions != null && accidentCode.field.FieldRepetitions.Count > 0)
        {
            ...
            accidentCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(accidentCode, fieldData);
        }
...
public HL7V23Field AccidentLocation
{
    get
    {
        ...
        if (accidentLocation.field.FieldRepetitions != null && accidentLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            accidentLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(accidentLocation, fieldData);
        }
...
public HL7V23Field AutoAccidentState
{
    get
    {
        ...
        if (autoAccidentState.field.FieldRepetitions != null && autoAccidentState.field.FieldRepetitions.Count > 0)
        {
            ...
            autoAccidentState.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(autoAccidentState, fieldData);
        }
...
N the accident was not job related ",
        ...
        if (accidentJobRelatedIndicator.field.FieldRepetitions != null && accidentJobRelatedIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            accidentJobRelatedIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(accidentJobRelatedIndicator, fieldData);
        }
...
N the patient has not died as a result of an accident",
        ...
        if (accidentDeathIndicator.field.FieldRepetitions != null && accidentDeathIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            accidentDeathIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(accidentDeathIndicator, fieldData);
        }
