...
Allowable Values:  codes defined by government",
        ...
        public HL7V23SegmentCTD(HL7V2Message message)
        {
...
internal HL7V23Field contactName;

public HL7V23Field ContactName
{
    get
    {
        if (contactName != null)
        ...
        if (contactName.field.FieldRepetitions != null && contactName.field.FieldRepetitions.Count > 0)
        {
            ...
            contactName.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(contactName, fieldData);
        }
...
internal HL7V23Field contactLocation;

public HL7V23Field ContactLocation
{
    get
    {
        ...
        contactLocation = new HL7V23Field
        {
            field = message[@"CTD"][4],
            Id = @"CTD.4",
            Type = @"Field",
        ...
        if (contactLocation.field.FieldRepetitions != null && contactLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            contactLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(contactLocation, fieldData);
        }
...
internal HL7V23Field contactCommunicationInformation;

public HL7V23Field ContactCommunicationInformation
{
    get
    {
        ...
        contactCommunicationInformation = new HL7V23Field
        {
            field = message[@"CTD"][5],
            Id = @"CTD.5",
            Type = @"Field",
        ...
        if (contactCommunicationInformation.field.FieldRepetitions != null && contactCommunicationInformation.field.FieldRepetitions.Count > 0)
        {
            ...
            contactCommunicationInformation.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(contactCommunicationInformation, fieldData);
        }
...
internal HL7V23Field contactIdentifiers;

public HL7V23Field ContactIdentifiers
{
    get
    {
        ...
        contactIdentifiers = new HL7V23Field
        {
            field = message[@"CTD"][7],
            Id = @"CTD.7",
            Type = @"Field",
        ...
        if (contactIdentifiers.field.FieldRepetitions != null && contactIdentifiers.field.FieldRepetitions.Count > 0)
        {
            ...
            contactIdentifiers.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(contactIdentifiers, fieldData);
        }
