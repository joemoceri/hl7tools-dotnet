...
public HL7V23Field FileBatchCount
{
    get
    {
        ...
        if (fileBatchCount.field.FieldRepetitions != null && fileBatchCount.field.FieldRepetitions.Count > 0)
        {
            ...
            fileBatchCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(fileBatchCount, fieldData);
        }
...
public HL7V23Field FileTrailerComment
{
    get
    {
        ...
        if (fileTrailerComment.field.FieldRepetitions != null && fileTrailerComment.field.FieldRepetitions.Count > 0)
        {
            ...
            fileTrailerComment.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(fileTrailerComment, fieldData);
        }
