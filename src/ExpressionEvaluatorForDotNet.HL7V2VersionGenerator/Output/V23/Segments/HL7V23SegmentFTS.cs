...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V23SegmentFTS
    {
        ...
        internal HL7V23Field _fileBatchCount;
...
public HL7V23Field FileBatchCount
{
    get
    {
        ...
        _fileBatchCount = new HL7V23Field
        {
            field = message[@"FTS"][1],
            fieldData = fieldData
        };
        ...
        {
            _fileBatchCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_fileBatchCount, fieldData);
        }
...
internal HL7V23Field _fileTrailerComment;
...
public HL7V23Field FileTrailerComment
{
    get
    {
        ...
        _fileTrailerComment = new HL7V23Field
        {
            field = message[@"FTS"][2],
            fieldData = fieldData
        };
        ...
        {
            _fileTrailerComment.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_fileTrailerComment, fieldData);
        }
