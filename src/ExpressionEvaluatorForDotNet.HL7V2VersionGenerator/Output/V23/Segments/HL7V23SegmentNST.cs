...
public HL7V23Field StatisticsAvailable
{
    get
    {
        ...
        if (statisticsAvailable.field.FieldRepetitions != null && statisticsAvailable.field.FieldRepetitions.Count > 0)
        {
            ...
            statisticsAvailable.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(statisticsAvailable, fieldData);
        }
...
public HL7V23Field SourceIdentifier
{
    get
    {
        ...
        if (sourceIdentifier.field.FieldRepetitions != null && sourceIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            sourceIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(sourceIdentifier, fieldData);
        }
...
public HL7V23Field SourceType
{
    get
    {
        ...
        if (sourceType.field.FieldRepetitions != null && sourceType.field.FieldRepetitions.Count > 0)
        {
            ...
            sourceType.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(sourceType, fieldData);
        }
...
public HL7V23Field StatisticsStart
{
    get
    {
        ...
        if (statisticsStart.field.FieldRepetitions != null && statisticsStart.field.FieldRepetitions.Count > 0)
        {
            ...
            statisticsStart.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(statisticsStart, fieldData);
        }
...
public HL7V23Field StatisticsEnd
{
    get
    {
        ...
        if (statisticsEnd.field.FieldRepetitions != null && statisticsEnd.field.FieldRepetitions.Count > 0)
        {
            ...
            statisticsEnd.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(statisticsEnd, fieldData);
        }
...
public HL7V23Field ReceiveCharacterCount
{
    get
    {
        ...
        if (receiveCharacterCount.field.FieldRepetitions != null && receiveCharacterCount.field.FieldRepetitions.Count > 0)
        {
            ...
            receiveCharacterCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(receiveCharacterCount, fieldData);
        }
...
public HL7V23Field SendCharacterCount
{
    get
    {
        ...
        if (sendCharacterCount.field.FieldRepetitions != null && sendCharacterCount.field.FieldRepetitions.Count > 0)
        {
            ...
            sendCharacterCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(sendCharacterCount, fieldData);
        }
...
public HL7V23Field MessagesReceived
{
    get
    {
        ...
        if (messagesReceived.field.FieldRepetitions != null && messagesReceived.field.FieldRepetitions.Count > 0)
        {
            ...
            messagesReceived.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(messagesReceived, fieldData);
        }
...
public HL7V23Field MessagesSent
{
    get
    {
        ...
        if (messagesSent.field.FieldRepetitions != null && messagesSent.field.FieldRepetitions.Count > 0)
        {
            ...
            messagesSent.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(messagesSent, fieldData);
        }
...
public HL7V23Field ChecksumErrorsReceived
{
    get
    {
        ...
        if (checksumErrorsReceived.field.FieldRepetitions != null && checksumErrorsReceived.field.FieldRepetitions.Count > 0)
        {
            ...
            checksumErrorsReceived.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(checksumErrorsReceived, fieldData);
        }
...
public HL7V23Field LengthErrorsReceived
{
    get
    {
        ...
        if (lengthErrorsReceived.field.FieldRepetitions != null && lengthErrorsReceived.field.FieldRepetitions.Count > 0)
        {
            ...
            lengthErrorsReceived.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(lengthErrorsReceived, fieldData);
        }
...
public HL7V23Field OtherErrorsReceived
{
    get
    {
        ...
        if (otherErrorsReceived.field.FieldRepetitions != null && otherErrorsReceived.field.FieldRepetitions.Count > 0)
        {
            ...
            otherErrorsReceived.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(otherErrorsReceived, fieldData);
        }
...
public HL7V23Field ConnectTimeouts
{
    get
    {
        ...
        if (connectTimeouts.field.FieldRepetitions != null && connectTimeouts.field.FieldRepetitions.Count > 0)
        {
            ...
            connectTimeouts.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(connectTimeouts, fieldData);
        }
...
public HL7V23Field ReceiveTimeouts
{
    get
    {
        ...
        if (receiveTimeouts.field.FieldRepetitions != null && receiveTimeouts.field.FieldRepetitions.Count > 0)
        {
            ...
            receiveTimeouts.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(receiveTimeouts, fieldData);
        }
...
public HL7V23Field NetworkErrors
{
    get
    {
        ...
        if (networkErrors.field.FieldRepetitions != null && networkErrors.field.FieldRepetitions.Count > 0)
        {
            ...
            networkErrors.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(networkErrors, fieldData);
        }
