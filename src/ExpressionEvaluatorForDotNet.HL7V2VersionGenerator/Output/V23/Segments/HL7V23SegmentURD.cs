...
public HL7V23Field RUDateTime
{
    get
    {
        ...
        if (rUDateTime.field.FieldRepetitions != null && rUDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            rUDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(rUDateTime, fieldData);
        }
...
public HL7V23Field ReportPriority
{
    get
    {
        ...
        if (reportPriority.field.FieldRepetitions != null && reportPriority.field.FieldRepetitions.Count > 0)
        {
            ...
            reportPriority.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(reportPriority, fieldData);
        }
...
public HL7V23Field RUWhoSubjectDefinition
{
    get
    {
        ...
        if (rUWhoSubjectDefinition.field.FieldRepetitions != null && rUWhoSubjectDefinition.field.FieldRepetitions.Count > 0)
        {
            ...
            rUWhoSubjectDefinition.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(rUWhoSubjectDefinition, fieldData);
        }
...
This table may be extended by local agreement during implementation.  See the HL7 Implementation Guide for detailed examples of use of various query filter fields",
        ...
        if (rUWhatSubjectDefinition.field.FieldRepetitions != null && rUWhatSubjectDefinition.field.FieldRepetitions.Count > 0)
        {
            ...
            rUWhatSubjectDefinition.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(rUWhatSubjectDefinition, fieldData);
        }
...
public HL7V23Field RUWhatDepartmentCode
{
    get
    {
        ...
        if (rUWhatDepartmentCode.field.FieldRepetitions != null && rUWhatDepartmentCode.field.FieldRepetitions.Count > 0)
        {
            ...
            rUWhatDepartmentCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(rUWhatDepartmentCode, fieldData);
        }
...
public HL7V23Field RUDisplayPrintLocations
{
    get
    {
        ...
        if (rUDisplayPrintLocations.field.FieldRepetitions != null && rUDisplayPrintLocations.field.FieldRepetitions.Count > 0)
        {
            ...
            rUDisplayPrintLocations.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(rUDisplayPrintLocations, fieldData);
        }
...
public HL7V23Field RUResultsLevel
{
    get
    {
        ...
        if (rUResultsLevel.field.FieldRepetitions != null && rUResultsLevel.field.FieldRepetitions.Count > 0)
        {
            ...
            rUResultsLevel.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(rUResultsLevel, fieldData);
        }
