...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V23SegmentCM0
    {
        ...
        internal HL7V23Field _cM0SetID;
...
public HL7V23Field CM0SetID
{
    get
    {
        ...
        if (_cM0SetID.field.FieldRepetitions != null && _cM0SetID.field.FieldRepetitions.Count > 0)
        {
            _cM0SetID.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_cM0SetID, fieldData);
        }
...
internal HL7V23Field _titleofStudy;
...
public HL7V23Field TitleofStudy
{
    get
    {
        ...
        {
            _titleofStudy.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_titleofStudy, fieldData);
        }
...
internal HL7V23Field _chairmanofStudy;
...
public HL7V23Field ChairmanofStudy
{
    get
    {
        ...
        _chairmanofStudy = new HL7V23Field
        {
            field = message[@"CM0"][5],
            fieldData = fieldData
        };
        ...
        {
            _chairmanofStudy.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_chairmanofStudy, fieldData);
        }
...
internal HL7V23Field _lastIRBApprovalDate;
...
public HL7V23Field LastIRBApprovalDate
{
    get
    {
        ...
        _lastIRBApprovalDate = new HL7V23Field
        {
            field = message[@"CM0"][6],
            fieldData = fieldData
        };
        ...
        {
            _lastIRBApprovalDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_lastIRBApprovalDate, fieldData);
        }
...
internal HL7V23Field _totalAccrualtoDate;
...
public HL7V23Field TotalAccrualtoDate
{
    get
    {
        ...
        _totalAccrualtoDate = new HL7V23Field
        {
            field = message[@"CM0"][7],
            fieldData = fieldData
        };
        ...
        {
            _totalAccrualtoDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_totalAccrualtoDate, fieldData);
        }
...
internal HL7V23Field _lastAccrualDate;
...
public HL7V23Field LastAccrualDate
{
    get
    {
        ...
        _lastAccrualDate = new HL7V23Field
        {
            field = message[@"CM0"][8],
            fieldData = fieldData
        };
        ...
        {
            _lastAccrualDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_lastAccrualDate, fieldData);
        }
...
internal HL7V23Field _contactforStudy;
...
public HL7V23Field ContactforStudy
{
    get
    {
        ...
        _contactforStudy = new HL7V23Field
        {
            field = message[@"CM0"][9],
            fieldData = fieldData
        };
        ...
        {
            _contactforStudy.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_contactforStudy, fieldData);
        }
...
internal HL7V23Field _contactsTelNumber;

public HL7V23Field ContactsTelNumber
{
    get
    {
        if (_contactsTelNumber != null)
        {
            return _contactsTelNumber;
        }
        ...
        _contactsTelNumber = new HL7V23Field
        {
        ...
        // check for repetitions
        if (_contactsTelNumber.field.FieldRepetitions != null && _contactsTelNumber.field.FieldRepetitions.Count > 0)
        {
            _contactsTelNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_contactsTelNumber, fieldData);
        }
...
internal HL7V23Field _contactsAddress;
...
Allowable Values:  codes defined by government",
        ...
        _contactsAddress = new HL7V23Field
        {
        ...
        {
            _contactsAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_contactsAddress, fieldData);
        }
