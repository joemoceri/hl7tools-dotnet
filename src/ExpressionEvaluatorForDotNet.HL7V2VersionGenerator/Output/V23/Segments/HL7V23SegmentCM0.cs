...
Allowable Values:  codes defined by government",
        ...
        public HL7V23SegmentCM0(HL7V2Message message)
        {
            this.message = message;
        }

        
internal HL7V23Field cM0SetID;

public HL7V23Field CM0SetID
{
    get
    {
        if (cM0SetID != null)
        ...
        if (cM0SetID.field.FieldRepetitions != null && cM0SetID.field.FieldRepetitions.Count > 0)
        {
            // get this fields data
            var fieldData = Fields.First(fd => fd.Id.Equals(cM0SetID.Id));
            var fieldRepetitions = new List<HL7V23FieldRepetition>();

            for (var i = 0; i < cM0SetID.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V23FieldRepetition
                {
                    fieldRepetition = cM0SetID.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    for (var j = 0; j < cM0SetID.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V23Component
                        {
                            component = cM0SetID.field.FieldRepetitions[i].Components[j],
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < cM0SetID.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V23SubComponent
                                {
                                    subComponent = cM0SetID.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = componentFieldData.Id,
                                    Type = componentFieldData.Type,
                                    Position = componentFieldData.Position,
                                    Name = componentFieldData.Name,
            ...
            cM0SetID.fieldRepetitions = fieldRepetitions;
        }
...
internal HL7V23Field sponsorStudyID;
...
public HL7V23Field SponsorStudyID
{
    get
    {
        ...
        sponsorStudyID = new HL7V23Field
        {
            field = message[@"CM0"][2],
            Id = @"CM0.2",
            Type = @"Field",
...
internal HL7V23Field alternateStudyID;

public HL7V23Field AlternateStudyID
{
    get
    {
        ...
        alternateStudyID = new HL7V23Field
        {
            field = message[@"CM0"][3],
            Id = @"CM0.3",
            Type = @"Field",
...
internal HL7V23Field titleofStudy;

public HL7V23Field TitleofStudy
{
    get
    {
...
internal HL7V23Field chairmanofStudy;

public HL7V23Field ChairmanofStudy
{
    get
    {
        ...
        chairmanofStudy = new HL7V23Field
        {
            field = message[@"CM0"][5],
            Id = @"CM0.5",
            Type = @"Field",
...
internal HL7V23Field lastIRBApprovalDate;

public HL7V23Field LastIRBApprovalDate
{
    get
    {
        ...
        lastIRBApprovalDate = new HL7V23Field
        {
            field = message[@"CM0"][6],
            Id = @"CM0.6",
            Type = @"Field",
...
internal HL7V23Field totalAccrualtoDate;

public HL7V23Field TotalAccrualtoDate
{
    get
    {
        ...
        totalAccrualtoDate = new HL7V23Field
        {
            field = message[@"CM0"][7],
            Id = @"CM0.7",
            Type = @"Field",
...
internal HL7V23Field lastAccrualDate;

public HL7V23Field LastAccrualDate
{
    get
    {
        ...
        lastAccrualDate = new HL7V23Field
        {
            field = message[@"CM0"][8],
            Id = @"CM0.8",
            Type = @"Field",
...
internal HL7V23Field contactforStudy;

public HL7V23Field ContactforStudy
{
    get
    {
        ...
        contactforStudy = new HL7V23Field
        {
            field = message[@"CM0"][9],
            Id = @"CM0.9",
            Type = @"Field",
...
internal HL7V23Field contact'sTelNumber;

public HL7V23Field Contact'sTelNumber
{
    get
    {
        if (contact'sTelNumber != null)
        {
            return contact'sTelNumber;
        }

        contact'sTelNumber = new HL7V23Field
        {
        ...
        // check for repetitions
        if (contact'sTelNumber.field.FieldRepetitions != null && contact'sTelNumber.field.FieldRepetitions.Count > 0)
        {
            // get this fields data
            var fieldData = Fields.First(fd => fd.Id.Equals(contact'sTelNumber.Id));
            var fieldRepetitions = new List<HL7V23FieldRepetition>();

            for (var i = 0; i < contact'sTelNumber.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V23FieldRepetition
                {
                    fieldRepetition = contact'sTelNumber.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < contact'sTelNumber.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V23Component
                        {
                            component = contact'sTelNumber.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < contact'sTelNumber.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V23SubComponent
                                {
                                    subComponent = contact'sTelNumber.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = componentFieldData.Id,
                                    Type = componentFieldData.Type,
                                    Position = componentFieldData.Position,
                                    Name = componentFieldData.Name,
            ...
            contact'sTelNumber.fieldRepetitions = fieldRepetitions;
        }
...
internal HL7V23Field contact'sAddress;

public HL7V23Field Contact'sAddress
{
    get
    {
        ...
        contact'sAddress = new HL7V23Field
        {
