...
internal HL7V23Field contact'sTel.Number;

public HL7V23Field Contact'sTel.Number
{
    get
    {
        if (contact'sTel.Number != null)
        {
            return contact'sTel.Number;
        }

        contact'sTel.Number = new HL7V23Field
        {
