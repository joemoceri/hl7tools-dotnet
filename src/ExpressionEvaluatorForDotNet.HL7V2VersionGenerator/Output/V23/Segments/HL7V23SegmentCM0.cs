...
public HL7V23Field CM0SetID
{
    get
    {
        ...
        if (cM0SetID.field.FieldRepetitions != null && cM0SetID.field.FieldRepetitions.Count > 0)
        {
            ...
            cM0SetID.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(cM0SetID, fieldData);
        }
...
public HL7V23Field TitleofStudy
{
    get
    {
        ...
        if (titleofStudy.field.FieldRepetitions != null && titleofStudy.field.FieldRepetitions.Count > 0)
        {
            ...
            titleofStudy.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(titleofStudy, fieldData);
        }
...
public HL7V23Field ChairmanofStudy
{
    get
    {
        ...
        if (chairmanofStudy.field.FieldRepetitions != null && chairmanofStudy.field.FieldRepetitions.Count > 0)
        {
            ...
            chairmanofStudy.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(chairmanofStudy, fieldData);
        }
...
public HL7V23Field LastIRBApprovalDate
{
    get
    {
        ...
        if (lastIRBApprovalDate.field.FieldRepetitions != null && lastIRBApprovalDate.field.FieldRepetitions.Count > 0)
        {
            ...
            lastIRBApprovalDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(lastIRBApprovalDate, fieldData);
        }
...
public HL7V23Field TotalAccrualtoDate
{
    get
    {
        ...
        if (totalAccrualtoDate.field.FieldRepetitions != null && totalAccrualtoDate.field.FieldRepetitions.Count > 0)
        {
            ...
            totalAccrualtoDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(totalAccrualtoDate, fieldData);
        }
...
public HL7V23Field LastAccrualDate
{
    get
    {
        ...
        if (lastAccrualDate.field.FieldRepetitions != null && lastAccrualDate.field.FieldRepetitions.Count > 0)
        {
            ...
            lastAccrualDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(lastAccrualDate, fieldData);
        }
...
public HL7V23Field ContactforStudy
{
    get
    {
        ...
        if (contactforStudy.field.FieldRepetitions != null && contactforStudy.field.FieldRepetitions.Count > 0)
        {
            ...
            contactforStudy.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(contactforStudy, fieldData);
        }
...
public HL7V23Field ContactsTelNumber
{
    get
    {
        ...
        if (contactsTelNumber.field.FieldRepetitions != null && contactsTelNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            contactsTelNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(contactsTelNumber, fieldData);
        }
...
public HL7V23Field ContactsAddress
{
    get
    {
        ...
        if (contactsAddress.field.FieldRepetitions != null && contactsAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            contactsAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(contactsAddress, fieldData);
        }
