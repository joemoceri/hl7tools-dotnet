...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V23SegmentQRF
    {
        ...
        internal HL7V23Field _whereSubjectFilter;
...
public HL7V23Field WhereSubjectFilter
{
    get
    {
        ...
        _whereSubjectFilter = new HL7V23Field
        {
            field = message[@"QRF"][1],
            fieldData = fieldData
        };
        ...
        {
            _whereSubjectFilter.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_whereSubjectFilter, fieldData);
        }
...
internal HL7V23Field _whenDataStartDateTime;
...
public HL7V23Field WhenDataStartDateTime
{
    get
    {
        ...
        _whenDataStartDateTime = new HL7V23Field
        {
            field = message[@"QRF"][2],
            fieldData = fieldData
        };
        ...
        {
            _whenDataStartDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_whenDataStartDateTime, fieldData);
        }
...
internal HL7V23Field _whenDataEndDateTime;
...
public HL7V23Field WhenDataEndDateTime
{
    get
    {
        ...
        _whenDataEndDateTime = new HL7V23Field
        {
            field = message[@"QRF"][3],
            fieldData = fieldData
        };
        ...
        {
            _whenDataEndDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_whenDataEndDateTime, fieldData);
        }
...
internal HL7V23Field _whatUserQualifier;
...
public HL7V23Field WhatUserQualifier
{
    get
    {
        ...
        _whatUserQualifier = new HL7V23Field
        {
            field = message[@"QRF"][4],
            fieldData = fieldData
        };
        ...
        {
            _whatUserQualifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_whatUserQualifier, fieldData);
        }
...
internal HL7V23Field _otherQRYSubjectFilter;
...
public HL7V23Field OtherQRYSubjectFilter
{
    get
    {
        ...
        _otherQRYSubjectFilter = new HL7V23Field
        {
            field = message[@"QRF"][5],
            fieldData = fieldData
        };
        ...
        {
            _otherQRYSubjectFilter.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_otherQRYSubjectFilter, fieldData);
        }
...
internal HL7V23Field _whichDateTimeQualifier;
...
public HL7V23Field WhichDateTimeQualifier
{
    get
    {
        ...
        _whichDateTimeQualifier = new HL7V23Field
        {
            field = message[@"QRF"][6],
            fieldData = fieldData
        };
        ...
        {
            _whichDateTimeQualifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_whichDateTimeQualifier, fieldData);
        }
...
internal HL7V23Field _whichDateTimeStatusQualifier;
...
public HL7V23Field WhichDateTimeStatusQualifier
{
    get
    {
        ...
        _whichDateTimeStatusQualifier = new HL7V23Field
        {
            field = message[@"QRF"][7],
            fieldData = fieldData
        };
        ...
        {
            _whichDateTimeStatusQualifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_whichDateTimeStatusQualifier, fieldData);
        }
...
internal HL7V23Field _dateTimeSelectionQualifier;
...
public HL7V23Field DateTimeSelectionQualifier
{
    get
    {
        ...
        _dateTimeSelectionQualifier = new HL7V23Field
        {
            field = message[@"QRF"][8],
            fieldData = fieldData
        };
        ...
        {
            _dateTimeSelectionQualifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_dateTimeSelectionQualifier, fieldData);
        }
...
internal HL7V23Field _whenQuantityTimingQualifier;
...
The time specifies the interval between the predecessor and successor starts or ends (see following examples). Where <time> is defined as:  
 ...
 - L<integer> do for <integer> months",
        ...
        _whenQuantityTimingQualifier = new HL7V23Field
        {
            field = message[@"QRF"][9],
            fieldData = fieldData
        };
        ...
        {
            _whenQuantityTimingQualifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_whenQuantityTimingQualifier, fieldData);
        }
