...
internal HL7V23Field derivedSpecimen;
...
public HL7V23Field DerivedSpecimen
{
    get
    {
        ...
        derivedSpecimen = new HL7V23Field
        {
            field = message[@"OM4"][2],
            Id = @"OM4.2",
            Type = @"Field",
        ...
        if (derivedSpecimen.field.FieldRepetitions != null && derivedSpecimen.field.FieldRepetitions.Count > 0)
        {
            ...
            derivedSpecimen.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(derivedSpecimen, fieldData);
        }
...
internal HL7V23Field containerDescription;
...
public HL7V23Field ContainerDescription
{
    get
    {
        ...
        containerDescription = new HL7V23Field
        {
            field = message[@"OM4"][3],
            Id = @"OM4.3",
            Type = @"Field",
        ...
        if (containerDescription.field.FieldRepetitions != null && containerDescription.field.FieldRepetitions.Count > 0)
        {
            ...
            containerDescription.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(containerDescription, fieldData);
        }
...
internal HL7V23Field containerVolume;
...
public HL7V23Field ContainerVolume
{
    get
    {
        ...
        containerVolume = new HL7V23Field
        {
            field = message[@"OM4"][4],
            Id = @"OM4.4",
            Type = @"Field",
        ...
        if (containerVolume.field.FieldRepetitions != null && containerVolume.field.FieldRepetitions.Count > 0)
        {
            ...
            containerVolume.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(containerVolume, fieldData);
        }
...
internal HL7V23Field containerUnits;
...
public HL7V23Field ContainerUnits
{
    get
    {
        ...
        containerUnits = new HL7V23Field
        {
            field = message[@"OM4"][5],
            Id = @"OM4.5",
            Type = @"Field",
        ...
        if (containerUnits.field.FieldRepetitions != null && containerUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            containerUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(containerUnits, fieldData);
        }
...
public HL7V23Field Specimen
{
    get
    {
        ...
        if (specimen.field.FieldRepetitions != null && specimen.field.FieldRepetitions.Count > 0)
        {
            ...
            specimen.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(specimen, fieldData);
        }
...
public HL7V23Field Additive
{
    get
    {
        ...
        if (additive.field.FieldRepetitions != null && additive.field.FieldRepetitions.Count > 0)
        {
            ...
            additive.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(additive, fieldData);
        }
...
internal HL7V23Field preparation;
...
public HL7V23Field Preparation
{
    get
    {
        ...
        if (preparation.field.FieldRepetitions != null && preparation.field.FieldRepetitions.Count > 0)
        {
            ...
            preparation.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(preparation, fieldData);
        }
...
internal HL7V23Field specialHandlingRequirements;
...
public HL7V23Field SpecialHandlingRequirements
{
    get
    {
        ...
        specialHandlingRequirements = new HL7V23Field
        {
            field = message[@"OM4"][9],
            Id = @"OM4.9",
            Type = @"Field",
        ...
        if (specialHandlingRequirements.field.FieldRepetitions != null && specialHandlingRequirements.field.FieldRepetitions.Count > 0)
        {
            ...
            specialHandlingRequirements.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(specialHandlingRequirements, fieldData);
        }
...
internal HL7V23Field normalCollectionVolume;
...
public HL7V23Field NormalCollectionVolume
{
    get
    {
        ...
        normalCollectionVolume = new HL7V23Field
        {
        ...
        if (normalCollectionVolume.field.FieldRepetitions != null && normalCollectionVolume.field.FieldRepetitions.Count > 0)
        {
            ...
            normalCollectionVolume.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(normalCollectionVolume, fieldData);
        }
...
internal HL7V23Field minimumCollectionVolume;
...
public HL7V23Field MinimumCollectionVolume
{
    get
    {
        ...
        minimumCollectionVolume = new HL7V23Field
        {
        ...
        if (minimumCollectionVolume.field.FieldRepetitions != null && minimumCollectionVolume.field.FieldRepetitions.Count > 0)
        {
            ...
            minimumCollectionVolume.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(minimumCollectionVolume, fieldData);
        }
...
internal HL7V23Field specimenRequirements;
...
public HL7V23Field SpecimenRequirements
{
    get
    {
        ...
        specimenRequirements = new HL7V23Field
        {
        ...
        if (specimenRequirements.field.FieldRepetitions != null && specimenRequirements.field.FieldRepetitions.Count > 0)
        {
            ...
            specimenRequirements.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(specimenRequirements, fieldData);
        }
...
internal HL7V23Field specimenPriorities;
...
public HL7V23Field SpecimenPriorities
{
    get
    {
        ...
        specimenPriorities = new HL7V23Field
        {
        ...
        if (specimenPriorities.field.FieldRepetitions != null && specimenPriorities.field.FieldRepetitions.Count > 0)
        {
            ...
            specimenPriorities.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(specimenPriorities, fieldData);
        }
...
internal HL7V23Field specimenRetentionTime;
...
public HL7V23Field SpecimenRetentionTime
{
    get
    {
        ...
        specimenRetentionTime = new HL7V23Field
        {
        ...
        if (specimenRetentionTime.field.FieldRepetitions != null && specimenRetentionTime.field.FieldRepetitions.Count > 0)
        {
            ...
            specimenRetentionTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(specimenRetentionTime, fieldData);
        }
