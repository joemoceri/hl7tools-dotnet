...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V23SegmentADD
    {
        ...
        internal HL7V23Field _addendumContinuationPointer;
...
public HL7V23Field AddendumContinuationPointer
{
    get
    {
        ...
        _addendumContinuationPointer = new HL7V23Field
        {
            field = message[@"ADD"][1],
            fieldData = fieldData
        };
        ...
        {
            _addendumContinuationPointer.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_addendumContinuationPointer, fieldData);
        }
