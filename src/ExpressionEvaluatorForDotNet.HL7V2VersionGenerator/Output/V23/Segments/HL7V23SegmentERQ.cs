...
internal HL7V23Field _eventidentifier;
...
public HL7V23Field Eventidentifier
{
    get
    {
        ...
        _eventidentifier = new HL7V23Field
        {
            field = message[@"ERQ"][2],
            fieldData = fieldData
        };
        ...
        {
            _eventidentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_eventidentifier, fieldData);
        }
