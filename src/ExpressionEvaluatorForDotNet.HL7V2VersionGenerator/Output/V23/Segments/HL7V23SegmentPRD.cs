...
public HL7V23Field Role
{
    get
    {
        ...
        if (_role.field.FieldRepetitions != null && _role.field.FieldRepetitions.Count > 0)
        {
            _role.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_role, fieldData);
        }
...
internal HL7V23Field _providerName;
...
public HL7V23Field ProviderName
{
    get
    {
        ...
        {
            _providerName.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_providerName, fieldData);
        }
...
internal HL7V23Field _providerAddress;
...
Allowable Values:  codes defined by government",
        ...
        _providerAddress = new HL7V23Field
        {
            field = message[@"PRD"][3],
            fieldData = fieldData
        };
        ...
        {
            _providerAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_providerAddress, fieldData);
        }
...
internal HL7V23Field _providerLocation;
...
public HL7V23Field ProviderLocation
{
    get
    {
        ...
        _providerLocation = new HL7V23Field
        {
            field = message[@"PRD"][4],
            fieldData = fieldData
        };
        ...
        {
            _providerLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_providerLocation, fieldData);
        }
...
internal HL7V23Field _providerCommunicationInformation;
...
public HL7V23Field ProviderCommunicationInformation
{
    get
    {
        ...
        _providerCommunicationInformation = new HL7V23Field
        {
            field = message[@"PRD"][5],
            fieldData = fieldData
        };
        ...
        {
            _providerCommunicationInformation.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_providerCommunicationInformation, fieldData);
        }
...
internal HL7V23Field _providerIdentifiers;
...
public HL7V23Field ProviderIdentifiers
{
    get
    {
        ...
        _providerIdentifiers = new HL7V23Field
        {
            field = message[@"PRD"][7],
            fieldData = fieldData
        };
        ...
        {
            _providerIdentifiers.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_providerIdentifiers, fieldData);
        }
...
internal HL7V23Field _effectiveStartDateofRole;

public HL7V23Field EffectiveStartDateofRole
{
    get
    {
        if (_effectiveStartDateofRole != null)
        {
            return _effectiveStartDateofRole;
        }
...
Note: The PRD-8-effective start date of role and PRD-9-effective end date of role fields should not be used as trigger events.  For example, they should not be used to trigger a change in role.  These two dates are for informational purposes only. ",
        ...
        _effectiveStartDateofRole = new HL7V23Field
        {
            field = message[@"PRD"][8],
            fieldData = fieldData
        };
        ...
        // check for repetitions
        if (_effectiveStartDateofRole.field.FieldRepetitions != null && _effectiveStartDateofRole.field.FieldRepetitions.Count > 0)
        {
            _effectiveStartDateofRole.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_effectiveStartDateofRole, fieldData);
        }
...
internal HL7V23Field _effectiveEndDateofRole;

public HL7V23Field EffectiveEndDateofRole
{
    get
    {
        if (_effectiveEndDateofRole != null)
        {
            return _effectiveEndDateofRole;
        }
...
Note: The PRD-8-effective start date of role and PRD-9-effective end date of role fields should not be used as trigger events.  For example, they should not be used to trigger a change in role.  These two dates are for informational purposes only. ",
        ...
        _effectiveEndDateofRole = new HL7V23Field
        {
            field = message[@"PRD"][9],
            fieldData = fieldData
        };
        ...
        // check for repetitions
        if (_effectiveEndDateofRole.field.FieldRepetitions != null && _effectiveEndDateofRole.field.FieldRepetitions.Count > 0)
        {
            _effectiveEndDateofRole.fieldRepetitions = HL7V2FieldGenerator.GenerateV23FieldRepetitions(_effectiveEndDateofRole, fieldData);
        }
