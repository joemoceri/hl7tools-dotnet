...
public HL7V25Field RevenueCode
{
    get
    {
        ...
        if (revenueCode.field.FieldRepetitions != null && revenueCode.field.FieldRepetitions.Count > 0)
        {
            ...
            revenueCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(revenueCode, fieldData);
        }
...
internal HL7V25Field numberofServiceUnits;
...
public HL7V25Field NumberofServiceUnits
{
    get
    {
        ...
        numberofServiceUnits = new HL7V25Field
        {
            field = message[@"GP2"][2],
            Id = @"GP2.2",
            Type = @"Field",
        ...
        if (numberofServiceUnits.field.FieldRepetitions != null && numberofServiceUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            numberofServiceUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(numberofServiceUnits, fieldData);
        }
...
public HL7V25Field Charge
{
    get
    {
        ...
        if (charge.field.FieldRepetitions != null && charge.field.FieldRepetitions.Count > 0)
        {
            ...
            charge.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(charge, fieldData);
        }
...
internal HL7V25Field reimbursementActionCode;
...
public HL7V25Field ReimbursementActionCode
{
    get
    {
        ...
        reimbursementActionCode = new HL7V25Field
        {
            field = message[@"GP2"][4],
            Id = @"GP2.4",
            Type = @"Field",
        ...
        if (reimbursementActionCode.field.FieldRepetitions != null && reimbursementActionCode.field.FieldRepetitions.Count > 0)
        {
            ...
            reimbursementActionCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(reimbursementActionCode, fieldData);
        }
...
internal HL7V25Field denialorRejectionCode;
...
public HL7V25Field DenialorRejectionCode
{
    get
    {
        ...
        denialorRejectionCode = new HL7V25Field
        {
            field = message[@"GP2"][5],
            Id = @"GP2.5",
            Type = @"Field",
        ...
        if (denialorRejectionCode.field.FieldRepetitions != null && denialorRejectionCode.field.FieldRepetitions.Count > 0)
        {
            ...
            denialorRejectionCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(denialorRejectionCode, fieldData);
        }
...
internal HL7V25Field oCEEditCode;
...
public HL7V25Field OCEEditCode
{
    get
    {
        ...
        if (oCEEditCode.field.FieldRepetitions != null && oCEEditCode.field.FieldRepetitions.Count > 0)
        {
            ...
            oCEEditCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(oCEEditCode, fieldData);
        }
...
internal HL7V25Field ambulatoryPaymentClassificationCode;
...
public HL7V25Field AmbulatoryPaymentClassificationCode
{
    get
    {
        ...
        ambulatoryPaymentClassificationCode = new HL7V25Field
        {
            field = message[@"GP2"][7],
            Id = @"GP2.7",
            Type = @"Field",
        ...
        if (ambulatoryPaymentClassificationCode.field.FieldRepetitions != null && ambulatoryPaymentClassificationCode.field.FieldRepetitions.Count > 0)
        {
            ...
            ambulatoryPaymentClassificationCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(ambulatoryPaymentClassificationCode, fieldData);
        }
...
internal HL7V25Field modifierEditCode;
...
public HL7V25Field ModifierEditCode
{
    get
    {
        ...
        modifierEditCode = new HL7V25Field
        {
            field = message[@"GP2"][8],
            Id = @"GP2.8",
            Type = @"Field",
        ...
        if (modifierEditCode.field.FieldRepetitions != null && modifierEditCode.field.FieldRepetitions.Count > 0)
        {
            ...
            modifierEditCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(modifierEditCode, fieldData);
        }
...
internal HL7V25Field paymentAdjustmentCode;
...
public HL7V25Field PaymentAdjustmentCode
{
    get
    {
        ...
        paymentAdjustmentCode = new HL7V25Field
        {
            field = message[@"GP2"][9],
            Id = @"GP2.9",
            Type = @"Field",
        ...
        if (paymentAdjustmentCode.field.FieldRepetitions != null && paymentAdjustmentCode.field.FieldRepetitions.Count > 0)
        {
            ...
            paymentAdjustmentCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(paymentAdjustmentCode, fieldData);
        }
...
internal HL7V25Field packagingStatusCode;
...
public HL7V25Field PackagingStatusCode
{
    get
    {
        ...
        packagingStatusCode = new HL7V25Field
        {
        ...
        if (packagingStatusCode.field.FieldRepetitions != null && packagingStatusCode.field.FieldRepetitions.Count > 0)
        {
            ...
            packagingStatusCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(packagingStatusCode, fieldData);
        }
...
internal HL7V25Field expectedCMSPaymentAmount;
...
public HL7V25Field ExpectedCMSPaymentAmount
{
    get
    {
        ...
        expectedCMSPaymentAmount = new HL7V25Field
        {
        ...
        if (expectedCMSPaymentAmount.field.FieldRepetitions != null && expectedCMSPaymentAmount.field.FieldRepetitions.Count > 0)
        {
            ...
            expectedCMSPaymentAmount.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(expectedCMSPaymentAmount, fieldData);
        }
...
internal HL7V25Field reimbursementTypeCode;
...
public HL7V25Field ReimbursementTypeCode
{
    get
    {
        ...
        reimbursementTypeCode = new HL7V25Field
        {
        ...
        if (reimbursementTypeCode.field.FieldRepetitions != null && reimbursementTypeCode.field.FieldRepetitions.Count > 0)
        {
            ...
            reimbursementTypeCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(reimbursementTypeCode, fieldData);
        }
...
internal HL7V25Field coPayAmount;
...
public HL7V25Field CoPayAmount
{
    get
    {
        ...
        if (coPayAmount.field.FieldRepetitions != null && coPayAmount.field.FieldRepetitions.Count > 0)
        {
            ...
            coPayAmount.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(coPayAmount, fieldData);
        }
...
internal HL7V25Field payRateperServiceUnit;
...
public HL7V25Field PayRateperServiceUnit
{
    get
    {
        ...
        payRateperServiceUnit = new HL7V25Field
        {
        ...
        if (payRateperServiceUnit.field.FieldRepetitions != null && payRateperServiceUnit.field.FieldRepetitions.Count > 0)
        {
            ...
            payRateperServiceUnit.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(payRateperServiceUnit, fieldData);
        }
