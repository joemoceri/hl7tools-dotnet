...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V25SegmentRQ1
    {
        ...
        internal HL7V25Field _anticipatedPrice;
...
public HL7V25Field AnticipatedPrice
{
    get
    {
        ...
        _anticipatedPrice = new HL7V25Field
        {
            field = message[@"RQ1"][1],
            fieldData = fieldData
        };
        ...
        {
            _anticipatedPrice.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_anticipatedPrice, fieldData);
        }
...
internal HL7V25Field _manufacturersCatalog;
...
public HL7V25Field ManufacturersCatalog
{
    get
    {
        ...
        _manufacturersCatalog = new HL7V25Field
        {
            field = message[@"RQ1"][3],
            fieldData = fieldData
        };
        ...
        {
            _manufacturersCatalog.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_manufacturersCatalog, fieldData);
        }
...
internal HL7V25Field _vendorID;
...
public HL7V25Field VendorID
{
    get
    {
        ...
        {
            _vendorID.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_vendorID, fieldData);
        }
...
internal HL7V25Field _vendorCatalog;
...
public HL7V25Field VendorCatalog
{
    get
    {
        ...
        _vendorCatalog = new HL7V25Field
        {
            field = message[@"RQ1"][5],
            fieldData = fieldData
        };
        ...
        {
            _vendorCatalog.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_vendorCatalog, fieldData);
        }
...
public HL7V25Field Taxable
{
    get
    {
        ...
        {
            _taxable.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_taxable, fieldData);
        }
...
internal HL7V25Field _substituteAllowed;
...
public HL7V25Field SubstituteAllowed
{
    get
    {
        ...
        _substituteAllowed = new HL7V25Field
        {
            field = message[@"RQ1"][7],
            fieldData = fieldData
        };
        ...
        {
            _substituteAllowed.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_substituteAllowed, fieldData);
        }
