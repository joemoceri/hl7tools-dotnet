...
internal HL7V25Field patientPrimaryFacility;
...
public HL7V25Field PatientPrimaryFacility
{
    get
    {
        ...
        patientPrimaryFacility = new HL7V25Field
        {
            field = message[@"PD1"][3],
            Id = @"PD1.3",
            Type = @"Field",
        ...
        if (patientPrimaryFacility.field.FieldRepetitions != null && patientPrimaryFacility.field.FieldRepetitions.Count > 0)
        {
            ...
            patientPrimaryFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(patientPrimaryFacility, fieldData);
        }
...
internal HL7V25Field patientPrimaryCareProviderNameandIDNo;
...
public HL7V25Field PatientPrimaryCareProviderNameandIDNo
{
    get
    {
        ...
        patientPrimaryCareProviderNameandIDNo = new HL7V25Field
        {
            field = message[@"PD1"][4],
            Id = @"PD1.4",
            Type = @"Field",
        ...
        if (patientPrimaryCareProviderNameandIDNo.field.FieldRepetitions != null && patientPrimaryCareProviderNameandIDNo.field.FieldRepetitions.Count > 0)
        {
            ...
            patientPrimaryCareProviderNameandIDNo.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(patientPrimaryCareProviderNameandIDNo, fieldData);
        }
...
internal HL7V25Field separateBill;
...
public HL7V25Field SeparateBill
{
    get
    {
        ...
        if (separateBill.field.FieldRepetitions != null && separateBill.field.FieldRepetitions.Count > 0)
        {
            ...
            separateBill.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(separateBill, fieldData);
        }
...
internal HL7V25Field duplicatePatient;
...
public HL7V25Field DuplicatePatient
{
    get
    {
        ...
        duplicatePatient = new HL7V25Field
        {
        ...
        if (duplicatePatient.field.FieldRepetitions != null && duplicatePatient.field.FieldRepetitions.Count > 0)
        {
            ...
            duplicatePatient.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(duplicatePatient, fieldData);
        }
...
internal HL7V25Field protectionIndicatorEffectiveDate;
...
public HL7V25Field ProtectionIndicatorEffectiveDate
{
    get
    {
        ...
        protectionIndicatorEffectiveDate = new HL7V25Field
        {
        ...
        if (protectionIndicatorEffectiveDate.field.FieldRepetitions != null && protectionIndicatorEffectiveDate.field.FieldRepetitions.Count > 0)
        {
            ...
            protectionIndicatorEffectiveDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(protectionIndicatorEffectiveDate, fieldData);
        }
...
internal HL7V25Field placeofWorship;
...
public HL7V25Field PlaceofWorship
{
    get
    {
        ...
        placeofWorship = new HL7V25Field
        {
        ...
        if (placeofWorship.field.FieldRepetitions != null && placeofWorship.field.FieldRepetitions.Count > 0)
        {
            ...
            placeofWorship.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(placeofWorship, fieldData);
        }
...
internal HL7V25Field immunizationRegistryStatus;
...
public HL7V25Field ImmunizationRegistryStatus
{
    get
    {
        ...
        immunizationRegistryStatus = new HL7V25Field
        {
        ...
        if (immunizationRegistryStatus.field.FieldRepetitions != null && immunizationRegistryStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            immunizationRegistryStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(immunizationRegistryStatus, fieldData);
        }
...
internal HL7V25Field immunizationRegistryStatusEffectiveDate;
...
public HL7V25Field ImmunizationRegistryStatusEffectiveDate
{
    get
    {
        ...
        immunizationRegistryStatusEffectiveDate = new HL7V25Field
        {
        ...
        if (immunizationRegistryStatusEffectiveDate.field.FieldRepetitions != null && immunizationRegistryStatusEffectiveDate.field.FieldRepetitions.Count > 0)
        {
            ...
            immunizationRegistryStatusEffectiveDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(immunizationRegistryStatusEffectiveDate, fieldData);
        }
...
internal HL7V25Field publicityCodeEffectiveDate;
...
public HL7V25Field PublicityCodeEffectiveDate
{
    get
    {
        ...
        publicityCodeEffectiveDate = new HL7V25Field
        {
        ...
        if (publicityCodeEffectiveDate.field.FieldRepetitions != null && publicityCodeEffectiveDate.field.FieldRepetitions.Count > 0)
        {
            ...
            publicityCodeEffectiveDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(publicityCodeEffectiveDate, fieldData);
        }
...
internal HL7V25Field militaryBranch;
...
public HL7V25Field MilitaryBranch
{
    get
    {
        ...
        militaryBranch = new HL7V25Field
        {
        ...
        if (militaryBranch.field.FieldRepetitions != null && militaryBranch.field.FieldRepetitions.Count > 0)
        {
            ...
            militaryBranch.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(militaryBranch, fieldData);
        }
