...
Conditionality Rule:  This field is required when used in Patient Care and Personnel Management messages.  The field is optional when used in ADT and Finance messages. ",
        ...
        if (roleInstanceID.field.FieldRepetitions != null && roleInstanceID.field.FieldRepetitions.Count > 0)
        {
            ...
            roleInstanceID.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(roleInstanceID, fieldData);
        }
...
public HL7V25Field RoleROL
{
    get
    {
        ...
        if (roleROL.field.FieldRepetitions != null && roleROL.field.FieldRepetitions.Count > 0)
        {
            ...
            roleROL.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(roleROL, fieldData);
        }
...
public HL7V25Field RolePerson
{
    get
    {
        ...
        if (rolePerson.field.FieldRepetitions != null && rolePerson.field.FieldRepetitions.Count > 0)
        {
            ...
            rolePerson.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(rolePerson, fieldData);
        }
...
public HL7V25Field RoleBeginDateTime
{
    get
    {
        ...
        if (roleBeginDateTime.field.FieldRepetitions != null && roleBeginDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            roleBeginDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(roleBeginDateTime, fieldData);
        }
...
public HL7V25Field RoleEndDateTime
{
    get
    {
        ...
        if (roleEndDateTime.field.FieldRepetitions != null && roleEndDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            roleEndDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(roleEndDateTime, fieldData);
        }
...
public HL7V25Field RoleDuration
{
    get
    {
        ...
        if (roleDuration.field.FieldRepetitions != null && roleDuration.field.FieldRepetitions.Count > 0)
        {
            ...
            roleDuration.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(roleDuration, fieldData);
        }
...
public HL7V25Field RoleActionReason
{
    get
    {
        ...
        if (roleActionReason.field.FieldRepetitions != null && roleActionReason.field.FieldRepetitions.Count > 0)
        {
            ...
            roleActionReason.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(roleActionReason, fieldData);
        }
...
public HL7V25Field ProviderType
{
    get
    {
        ...
        if (providerType.field.FieldRepetitions != null && providerType.field.FieldRepetitions.Count > 0)
        {
            ...
            providerType.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(providerType, fieldData);
        }
...
public HL7V25Field OrganizationUnitType
{
    get
    {
        ...
        if (organizationUnitType.field.FieldRepetitions != null && organizationUnitType.field.FieldRepetitions.Count > 0)
        {
            ...
            organizationUnitType.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(organizationUnitType, fieldData);
        }
