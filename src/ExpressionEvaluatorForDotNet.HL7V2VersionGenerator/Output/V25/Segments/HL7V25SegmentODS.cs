...
internal HL7V25Field diet,Supplement,orPreferenceCode;

public HL7V25Field Diet,Supplement,orPreferenceCode
{
    get
    {
        ...
        diet,Supplement,orPreferenceCode = new HL7V25Field
        {
            field = message[@"ODS"][3],
            Id = @"ODS.3",
            Type = @"Field",
