...
public HL7V25Field AuthorizingPayorPlanID
{
    get
    {
        ...
        if (authorizingPayorPlanID.field.FieldRepetitions != null && authorizingPayorPlanID.field.FieldRepetitions.Count > 0)
        {
            ...
            authorizingPayorPlanID.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(authorizingPayorPlanID, fieldData);
        }
...
public HL7V25Field AuthorizingPayorCompanyID
{
    get
    {
        ...
        if (authorizingPayorCompanyID.field.FieldRepetitions != null && authorizingPayorCompanyID.field.FieldRepetitions.Count > 0)
        {
            ...
            authorizingPayorCompanyID.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(authorizingPayorCompanyID, fieldData);
        }
...
public HL7V25Field AuthorizingPayorCompanyName
{
    get
    {
        ...
        if (authorizingPayorCompanyName.field.FieldRepetitions != null && authorizingPayorCompanyName.field.FieldRepetitions.Count > 0)
        {
            ...
            authorizingPayorCompanyName.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(authorizingPayorCompanyName, fieldData);
        }
...
public HL7V25Field AuthorizationEffectiveDate
{
    get
    {
        ...
        if (authorizationEffectiveDate.field.FieldRepetitions != null && authorizationEffectiveDate.field.FieldRepetitions.Count > 0)
        {
            ...
            authorizationEffectiveDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(authorizationEffectiveDate, fieldData);
        }
...
public HL7V25Field AuthorizationExpirationDate
{
    get
    {
        ...
        if (authorizationExpirationDate.field.FieldRepetitions != null && authorizationExpirationDate.field.FieldRepetitions.Count > 0)
        {
            ...
            authorizationExpirationDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(authorizationExpirationDate, fieldData);
        }
...
public HL7V25Field AuthorizationIdentifier
{
    get
    {
        ...
        if (authorizationIdentifier.field.FieldRepetitions != null && authorizationIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            authorizationIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(authorizationIdentifier, fieldData);
        }
...
public HL7V25Field ReimbursementLimit
{
    get
    {
        ...
        if (reimbursementLimit.field.FieldRepetitions != null && reimbursementLimit.field.FieldRepetitions.Count > 0)
        {
            ...
            reimbursementLimit.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(reimbursementLimit, fieldData);
        }
...
public HL7V25Field RequestedNumberofTreatments
{
    get
    {
        ...
        if (requestedNumberofTreatments.field.FieldRepetitions != null && requestedNumberofTreatments.field.FieldRepetitions.Count > 0)
        {
            ...
            requestedNumberofTreatments.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(requestedNumberofTreatments, fieldData);
        }
...
public HL7V25Field AuthorizedNumberofTreatments
{
    get
    {
        ...
        if (authorizedNumberofTreatments.field.FieldRepetitions != null && authorizedNumberofTreatments.field.FieldRepetitions.Count > 0)
        {
            ...
            authorizedNumberofTreatments.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(authorizedNumberofTreatments, fieldData);
        }
