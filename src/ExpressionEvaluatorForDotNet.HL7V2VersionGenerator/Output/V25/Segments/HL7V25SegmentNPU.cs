...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V25SegmentNPU
    {
        ...
        internal HL7V25Field _bedLocation;
...
public HL7V25Field BedLocation
{
    get
    {
        ...
        {
            _bedLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_bedLocation, fieldData);
        }
