...
internal HL7V25Field continuationStyle;
...
public HL7V25Field ContinuationStyle
{
    get
    {
        ...
        continuationStyle = new HL7V25Field
        {
            field = message[@"DSC"][2],
            Id = @"DSC.2",
            Type = @"Field",
...
Refer to HL7 Table 0398 – Continuation Style Code for valid values.",
        ...
        if (continuationStyle.field.FieldRepetitions != null && continuationStyle.field.FieldRepetitions.Count > 0)
        {
            ...
            continuationStyle.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(continuationStyle, fieldData);
        }
