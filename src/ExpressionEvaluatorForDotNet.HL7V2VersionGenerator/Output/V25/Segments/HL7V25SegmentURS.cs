...
public HL7V25Field RUWhereSubjectDefinition
{
    get
    {
        ...
        if (rUWhereSubjectDefinition.field.FieldRepetitions != null && rUWhereSubjectDefinition.field.FieldRepetitions.Count > 0)
        {
            ...
            rUWhereSubjectDefinition.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(rUWhereSubjectDefinition, fieldData);
        }
...
public HL7V25Field RUWhenDataStartDateTime
{
    get
    {
        ...
        if (rUWhenDataStartDateTime.field.FieldRepetitions != null && rUWhenDataStartDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            rUWhenDataStartDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(rUWhenDataStartDateTime, fieldData);
        }
...
public HL7V25Field RUWhenDataEndDateTime
{
    get
    {
        ...
        if (rUWhenDataEndDateTime.field.FieldRepetitions != null && rUWhenDataEndDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            rUWhenDataEndDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(rUWhenDataEndDateTime, fieldData);
        }
...
public HL7V25Field RUWhatUserQualifier
{
    get
    {
        ...
        if (rUWhatUserQualifier.field.FieldRepetitions != null && rUWhatUserQualifier.field.FieldRepetitions.Count > 0)
        {
            ...
            rUWhatUserQualifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(rUWhatUserQualifier, fieldData);
        }
...
public HL7V25Field RUOtherResultsSubjectDefinition
{
    get
    {
        ...
        if (rUOtherResultsSubjectDefinition.field.FieldRepetitions != null && rUOtherResultsSubjectDefinition.field.FieldRepetitions.Count > 0)
        {
            ...
            rUOtherResultsSubjectDefinition.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(rUOtherResultsSubjectDefinition, fieldData);
        }
...
public HL7V25Field RUWhichDateTimeQualifier
{
    get
    {
        ...
        if (rUWhichDateTimeQualifier.field.FieldRepetitions != null && rUWhichDateTimeQualifier.field.FieldRepetitions.Count > 0)
        {
            ...
            rUWhichDateTimeQualifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(rUWhichDateTimeQualifier, fieldData);
        }
...
public HL7V25Field RUWhichDateTimeStatusQualifier
{
    get
    {
        ...
        if (rUWhichDateTimeStatusQualifier.field.FieldRepetitions != null && rUWhichDateTimeStatusQualifier.field.FieldRepetitions.Count > 0)
        {
            ...
            rUWhichDateTimeStatusQualifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(rUWhichDateTimeStatusQualifier, fieldData);
        }
...
public HL7V25Field RUDateTimeSelectionQualifier
{
    get
    {
        ...
        if (rUDateTimeSelectionQualifier.field.FieldRepetitions != null && rUDateTimeSelectionQualifier.field.FieldRepetitions.Count > 0)
        {
            ...
            rUDateTimeSelectionQualifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(rUDateTimeSelectionQualifier, fieldData);
        }
...
Note: This field is of data type TQ, which has been deprecated in Version 2.5. ",
        ...
        if (rUQuantityTimingQualifier.field.FieldRepetitions != null && rUQuantityTimingQualifier.field.FieldRepetitions.Count > 0)
        {
            ...
            rUQuantityTimingQualifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(rUQuantityTimingQualifier, fieldData);
        }
