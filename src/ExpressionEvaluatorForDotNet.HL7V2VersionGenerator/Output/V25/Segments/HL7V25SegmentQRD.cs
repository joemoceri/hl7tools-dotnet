...
public HL7V25Field QueryDateTime
{
    get
    {
        ...
        if (queryDateTime.field.FieldRepetitions != null && queryDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            queryDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(queryDateTime, fieldData);
        }
...
public HL7V25Field QueryFormatCode
{
    get
    {
        ...
        if (queryFormatCode.field.FieldRepetitions != null && queryFormatCode.field.FieldRepetitions.Count > 0)
        {
            ...
            queryFormatCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(queryFormatCode, fieldData);
        }
...
public HL7V25Field QueryID
{
    get
    {
        ...
        if (queryID.field.FieldRepetitions != null && queryID.field.FieldRepetitions.Count > 0)
        {
            ...
            queryID.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(queryID, fieldData);
        }
...
public HL7V25Field DeferredResponseType
{
    get
    {
        ...
        if (deferredResponseType.field.FieldRepetitions != null && deferredResponseType.field.FieldRepetitions.Count > 0)
        {
            ...
            deferredResponseType.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(deferredResponseType, fieldData);
        }
...
public HL7V25Field DeferredResponseDateTime
{
    get
    {
        ...
        if (deferredResponseDateTime.field.FieldRepetitions != null && deferredResponseDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            deferredResponseDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(deferredResponseDateTime, fieldData);
        }
...
Note:  This field should not have been a required field. However, for backward compatibility it remains a required field. There are some queries in the standard that have not required this field.",
        ...
        if (whoSubjectFilter.field.FieldRepetitions != null && whoSubjectFilter.field.FieldRepetitions.Count > 0)
        {
            ...
            whoSubjectFilter.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(whoSubjectFilter, fieldData);
        }
...
public HL7V25Field WhatSubjectFilter
{
    get
    {
        ...
        if (whatSubjectFilter.field.FieldRepetitions != null && whatSubjectFilter.field.FieldRepetitions.Count > 0)
        {
            ...
            whatSubjectFilter.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(whatSubjectFilter, fieldData);
        }
...
Note:  This field should not have been a required field. However, for backwards compatibility it remains a required field. There are some queries in the standard that have not required this field.  ",
        ...
        if (whatDepartmentDataCode.field.FieldRepetitions != null && whatDepartmentDataCode.field.FieldRepetitions.Count > 0)
        {
            ...
            whatDepartmentDataCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(whatDepartmentDataCode, fieldData);
        }
...
public HL7V25Field WhatDataCodeValueQual
{
    get
    {
        ...
        if (whatDataCodeValueQual.field.FieldRepetitions != null && whatDataCodeValueQual.field.FieldRepetitions.Count > 0)
        {
            ...
            whatDataCodeValueQual.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(whatDataCodeValueQual, fieldData);
        }
...
public HL7V25Field QueryResultsLevel
{
    get
    {
        ...
        if (queryResultsLevel.field.FieldRepetitions != null && queryResultsLevel.field.FieldRepetitions.Count > 0)
        {
            ...
            queryResultsLevel.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(queryResultsLevel, fieldData);
        }
