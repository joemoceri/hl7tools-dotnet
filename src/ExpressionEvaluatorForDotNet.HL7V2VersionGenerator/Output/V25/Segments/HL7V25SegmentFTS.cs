...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V25SegmentFTS
    {
        ...
        internal HL7V25Field fileBatchCount;
...
public HL7V25Field FileBatchCount
{
    get
    {
        ...
        fileBatchCount = new HL7V25Field
        {
            field = message[@"FTS"][1],
            Id = @"FTS.1",
            Type = @"Field",
        ...
        if (fileBatchCount.field.FieldRepetitions != null && fileBatchCount.field.FieldRepetitions.Count > 0)
        {
            ...
            fileBatchCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(fileBatchCount, fieldData);
        }
...
internal HL7V25Field fileTrailerComment;
...
public HL7V25Field FileTrailerComment
{
    get
    {
        ...
        fileTrailerComment = new HL7V25Field
        {
            field = message[@"FTS"][2],
            Id = @"FTS.2",
            Type = @"Field",
        ...
        if (fileTrailerComment.field.FieldRepetitions != null && fileTrailerComment.field.FieldRepetitions.Count > 0)
        {
            ...
            fileTrailerComment.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(fileTrailerComment, fieldData);
        }
