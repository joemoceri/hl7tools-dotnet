...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V25SegmentFTS
    {
        ...
        public HL7V25SegmentFTS(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V25Field _fileBatchCount;

public HL7V25Field FileBatchCount
{
    get
    {
        ...
        _fileBatchCount = new HL7V25Field
        {
            field = message[@"FTS"][1],
            fieldData = fieldData
        };
        ...
        {
            _fileBatchCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_fileBatchCount, fieldData);
        }
...
internal HL7V25Field _fileTrailerComment;

public HL7V25Field FileTrailerComment
{
    get
    {
        ...
        _fileTrailerComment = new HL7V25Field
        {
            field = message[@"FTS"][2],
            fieldData = fieldData
        };
        ...
        {
            _fileTrailerComment.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_fileTrailerComment, fieldData);
        }
