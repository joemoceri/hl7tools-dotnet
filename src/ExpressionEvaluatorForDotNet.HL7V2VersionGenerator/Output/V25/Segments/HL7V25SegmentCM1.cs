...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V25SegmentCM1
    {
        ...
        internal HL7V25Field _setIDCM1;
...
public HL7V25Field SetIDCM1
{
    get
    {
        ...
        {
            _setIDCM1.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_setIDCM1, fieldData);
        }
...
internal HL7V25Field _descriptionofStudyPhase;
...
public HL7V25Field DescriptionofStudyPhase
{
    get
    {
        ...
        _descriptionofStudyPhase = new HL7V25Field
        {
            field = message[@"CM1"][3],
            fieldData = fieldData
        };
        ...
        {
            _descriptionofStudyPhase.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_descriptionofStudyPhase, fieldData);
        }
