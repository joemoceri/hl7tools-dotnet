...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V25SegmentRDF
    {
        ...
        internal HL7V25Field numberofColumnsperRow;
...
public HL7V25Field NumberofColumnsperRow
{
    get
    {
        ...
        numberofColumnsperRow = new HL7V25Field
        {
            field = message[@"RDF"][1],
            Id = @"RDF.1",
            Type = @"Field",
        ...
        if (numberofColumnsperRow.field.FieldRepetitions != null && numberofColumnsperRow.field.FieldRepetitions.Count > 0)
        {
            ...
            numberofColumnsperRow.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(numberofColumnsperRow, fieldData);
        }
...
internal HL7V25Field columnDescription;
...
public HL7V25Field ColumnDescription
{
    get
    {
        ...
        columnDescription = new HL7V25Field
        {
            field = message[@"RDF"][2],
            Id = @"RDF.2",
            Type = @"Field",
        ...
        if (columnDescription.field.FieldRepetitions != null && columnDescription.field.FieldRepetitions.Count > 0)
        {
            ...
            columnDescription.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(columnDescription, fieldData);
        }
