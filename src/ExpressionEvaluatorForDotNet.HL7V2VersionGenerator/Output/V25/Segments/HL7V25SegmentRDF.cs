...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V25SegmentRDF
    {
        ...
        public HL7V25SegmentRDF(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V25Field _numberofColumnsperRow;

public HL7V25Field NumberofColumnsperRow
{
    get
    {
        ...
        _numberofColumnsperRow = new HL7V25Field
        {
            field = message[@"RDF"][1],
            fieldData = fieldData
        };
        ...
        {
            _numberofColumnsperRow.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_numberofColumnsperRow, fieldData);
        }
...
internal HL7V25Field _columnDescription;

public HL7V25Field ColumnDescription
{
    get
    {
        ...
        _columnDescription = new HL7V25Field
        {
            field = message[@"RDF"][2],
            fieldData = fieldData
        };
        ...
        {
            _columnDescription.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_columnDescription, fieldData);
        }
