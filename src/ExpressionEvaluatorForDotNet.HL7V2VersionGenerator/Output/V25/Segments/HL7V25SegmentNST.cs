...
Usage Notes: Fields 2-15.  These are all marked optional since the statistics kept on a particular link and negotiated between the two systems in question will vary.  Not all values will apply to each system.  Some values are concerned with the type of port, and some values pertain to the lower level protocol."; } }
        ...
        internal HL7V25Field _statisticsAvailable;
...
public HL7V25Field StatisticsAvailable
{
    get
    {
        ...
        _statisticsAvailable = new HL7V25Field
        {
            field = message[@"NST"][1],
            fieldData = fieldData
        };
        ...
        {
            _statisticsAvailable.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_statisticsAvailable, fieldData);
        }
...
internal HL7V25Field _sourceIdentifier;
...
public HL7V25Field SourceIdentifier
{
    get
    {
        ...
        _sourceIdentifier = new HL7V25Field
        {
            field = message[@"NST"][2],
            fieldData = fieldData
        };
        ...
        {
            _sourceIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_sourceIdentifier, fieldData);
        }
...
internal HL7V25Field _sourceType;
...
public HL7V25Field SourceType
{
    get
    {
        ...
        {
            _sourceType.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_sourceType, fieldData);
        }
...
internal HL7V25Field _statisticsStart;
...
Indicates the degree of precision of the time stamp (Y = year, L = month, D = day, H = hour, M = minute, S = second). Refer to HL7 Table 0529 - Precision for valid value.",
        ...
        _statisticsStart = new HL7V25Field
        {
            field = message[@"NST"][4],
            fieldData = fieldData
        };
        ...
        {
            _statisticsStart.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_statisticsStart, fieldData);
        }
...
internal HL7V25Field _statisticsEnd;
...
Indicates the degree of precision of the time stamp (Y = year, L = month, D = day, H = hour, M = minute, S = second). Refer to HL7 Table 0529 - Precision for valid value.",
        ...
        _statisticsEnd = new HL7V25Field
        {
            field = message[@"NST"][5],
            fieldData = fieldData
        };
        ...
        {
            _statisticsEnd.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_statisticsEnd, fieldData);
        }
...
internal HL7V25Field _receiveCharacterCount;
...
public HL7V25Field ReceiveCharacterCount
{
    get
    {
        ...
        _receiveCharacterCount = new HL7V25Field
        {
            field = message[@"NST"][6],
            fieldData = fieldData
        };
        ...
        {
            _receiveCharacterCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_receiveCharacterCount, fieldData);
        }
...
internal HL7V25Field _sendCharacterCount;
...
public HL7V25Field SendCharacterCount
{
    get
    {
        ...
        _sendCharacterCount = new HL7V25Field
        {
            field = message[@"NST"][7],
            fieldData = fieldData
        };
        ...
        {
            _sendCharacterCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_sendCharacterCount, fieldData);
        }
...
internal HL7V25Field _messagesReceived;
...
public HL7V25Field MessagesReceived
{
    get
    {
        ...
        _messagesReceived = new HL7V25Field
        {
            field = message[@"NST"][8],
            fieldData = fieldData
        };
        ...
        {
            _messagesReceived.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_messagesReceived, fieldData);
        }
...
internal HL7V25Field _messagesSent;
...
public HL7V25Field MessagesSent
{
    get
    {
        ...
        {
            _messagesSent.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_messagesSent, fieldData);
        }
...
internal HL7V25Field _checksumErrorsReceived;
...
public HL7V25Field ChecksumErrorsReceived
{
    get
    {
        ...
        _checksumErrorsReceived = new HL7V25Field
        {
        ...
        {
            _checksumErrorsReceived.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_checksumErrorsReceived, fieldData);
        }
...
internal HL7V25Field _lengthErrorsReceived;
...
public HL7V25Field LengthErrorsReceived
{
    get
    {
        ...
        _lengthErrorsReceived = new HL7V25Field
        {
        ...
        {
            _lengthErrorsReceived.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_lengthErrorsReceived, fieldData);
        }
...
internal HL7V25Field _otherErrorsReceived;
...
public HL7V25Field OtherErrorsReceived
{
    get
    {
        ...
        _otherErrorsReceived = new HL7V25Field
        {
        ...
        {
            _otherErrorsReceived.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_otherErrorsReceived, fieldData);
        }
...
internal HL7V25Field _connectTimeouts;
...
public HL7V25Field ConnectTimeouts
{
    get
    {
        ...
        _connectTimeouts = new HL7V25Field
        {
        ...
        {
            _connectTimeouts.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_connectTimeouts, fieldData);
        }
...
internal HL7V25Field _receiveTimeouts;
...
public HL7V25Field ReceiveTimeouts
{
    get
    {
        ...
        _receiveTimeouts = new HL7V25Field
        {
        ...
        {
            _receiveTimeouts.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_receiveTimeouts, fieldData);
        }
...
internal HL7V25Field _applicationcontrollevelErrors;
...
public HL7V25Field ApplicationcontrollevelErrors
{
    get
    {
        ...
        _applicationcontrollevelErrors = new HL7V25Field
        {
        ...
        {
            _applicationcontrollevelErrors.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_applicationcontrollevelErrors, fieldData);
        }
