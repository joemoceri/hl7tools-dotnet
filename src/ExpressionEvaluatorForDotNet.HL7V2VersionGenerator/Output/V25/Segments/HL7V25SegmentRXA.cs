...
internal HL7V25Field administeredPer(TimeUnit);

public HL7V25Field AdministeredPer(TimeUnit)
{
    get
    {
        ...
        administeredPer(TimeUnit) = new HL7V25Field
        {
