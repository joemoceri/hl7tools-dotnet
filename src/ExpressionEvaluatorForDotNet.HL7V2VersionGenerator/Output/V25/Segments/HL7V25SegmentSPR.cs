...
internal HL7V25Field storedProcedureName;
...
public HL7V25Field StoredProcedureName
{
    get
    {
        ...
        storedProcedureName = new HL7V25Field
        {
            field = message[@"SPR"][3],
            Id = @"SPR.3",
            Type = @"Field",
        ...
        if (storedProcedureName.field.FieldRepetitions != null && storedProcedureName.field.FieldRepetitions.Count > 0)
        {
            ...
            storedProcedureName.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(storedProcedureName, fieldData);
        }
