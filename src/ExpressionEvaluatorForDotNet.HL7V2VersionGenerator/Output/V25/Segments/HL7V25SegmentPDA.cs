...
public HL7V25Field DeathCauseCode
{
    get
    {
        ...
        deathCauseCode = new HL7V25Field
        {
            field = message[@"PDA"][1],
            Id = @"PDA.1",
            Type = @"Field",
        ...
        if (deathCauseCode.field.FieldRepetitions != null && deathCauseCode.field.FieldRepetitions.Count > 0)
        {
            ...
            deathCauseCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(deathCauseCode, fieldData);
        }
...
public HL7V25Field DeathLocation
{
    get
    {
        ...
        if (deathLocation.field.FieldRepetitions != null && deathLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            deathLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(deathLocation, fieldData);
        }
...
public HL7V25Field DeathCertifiedIndicator
{
    get
    {
        ...
        deathCertifiedIndicator = new HL7V25Field
        {
            field = message[@"PDA"][3],
            Id = @"PDA.3",
            Type = @"Field",
        ...
        if (deathCertifiedIndicator.field.FieldRepetitions != null && deathCertifiedIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            deathCertifiedIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(deathCertifiedIndicator, fieldData);
        }
...
public HL7V25Field DeathCertificateSignedDateTime
{
    get
    {
        ...
        deathCertificateSignedDateTime = new HL7V25Field
        {
            field = message[@"PDA"][4],
            Id = @"PDA.4",
            Type = @"Field",
        ...
        if (deathCertificateSignedDateTime.field.FieldRepetitions != null && deathCertificateSignedDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            deathCertificateSignedDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(deathCertificateSignedDateTime, fieldData);
        }
...
public HL7V25Field DeathCertifiedBy
{
    get
    {
        ...
        deathCertifiedBy = new HL7V25Field
        {
            field = message[@"PDA"][5],
            Id = @"PDA.5",
            Type = @"Field",
        ...
        if (deathCertifiedBy.field.FieldRepetitions != null && deathCertifiedBy.field.FieldRepetitions.Count > 0)
        {
            ...
            deathCertifiedBy.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(deathCertifiedBy, fieldData);
        }
...
public HL7V25Field AutopsyIndicator
{
    get
    {
        ...
        autopsyIndicator = new HL7V25Field
        {
            field = message[@"PDA"][6],
            Id = @"PDA.6",
            Type = @"Field",
        ...
        if (autopsyIndicator.field.FieldRepetitions != null && autopsyIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            autopsyIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(autopsyIndicator, fieldData);
        }
...
public HL7V25Field AutopsyStartandEndDateTime
{
    get
    {
        ...
        autopsyStartandEndDateTime = new HL7V25Field
        {
            field = message[@"PDA"][7],
            Id = @"PDA.7",
            Type = @"Field",
        ...
        if (autopsyStartandEndDateTime.field.FieldRepetitions != null && autopsyStartandEndDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            autopsyStartandEndDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(autopsyStartandEndDateTime, fieldData);
        }
...
public HL7V25Field AutopsyPerformedBy
{
    get
    {
        ...
        autopsyPerformedBy = new HL7V25Field
        {
            field = message[@"PDA"][8],
            Id = @"PDA.8",
            Type = @"Field",
        ...
        if (autopsyPerformedBy.field.FieldRepetitions != null && autopsyPerformedBy.field.FieldRepetitions.Count > 0)
        {
            ...
            autopsyPerformedBy.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(autopsyPerformedBy, fieldData);
        }
...
public HL7V25Field CoronerIndicator
{
    get
    {
        ...
        coronerIndicator = new HL7V25Field
        {
            field = message[@"PDA"][9],
            Id = @"PDA.9",
            Type = @"Field",
        ...
        if (coronerIndicator.field.FieldRepetitions != null && coronerIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            coronerIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(coronerIndicator, fieldData);
        }
