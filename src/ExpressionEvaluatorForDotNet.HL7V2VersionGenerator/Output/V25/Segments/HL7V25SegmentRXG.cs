...
public HL7V25Field DispenseSubIDCounter
{
    get
    {
        ...
        if (dispenseSubIDCounter.field.FieldRepetitions != null && dispenseSubIDCounter.field.FieldRepetitions.Count > 0)
        {
            ...
            dispenseSubIDCounter.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(dispenseSubIDCounter, fieldData);
        }
...
public HL7V25Field DispensetoLocation
{
    get
    {
        ...
        if (dispensetoLocation.field.FieldRepetitions != null && dispensetoLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            dispensetoLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(dispensetoLocation, fieldData);
        }
...
public HL7V25Field PharmacyTreatmentSuppliersSpecialAdministrationInstructions
{
    get
    {
        ...
        if (pharmacyTreatmentSuppliersSpecialAdministrationInstructions.field.FieldRepetitions != null && pharmacyTreatmentSuppliersSpecialAdministrationInstructions.field.FieldRepetitions.Count > 0)
        {
            ...
            pharmacyTreatmentSuppliersSpecialAdministrationInstructions.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(pharmacyTreatmentSuppliersSpecialAdministrationInstructions, fieldData);
        }
...
public HL7V25Field GivePerTimeUnit
{
    get
    {
        ...
        if (givePerTimeUnit.field.FieldRepetitions != null && givePerTimeUnit.field.FieldRepetitions.Count > 0)
        {
            ...
            givePerTimeUnit.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(givePerTimeUnit, fieldData);
        }
...
public HL7V25Field GiveBarcodeIdentifier
{
    get
    {
        ...
        if (giveBarcodeIdentifier.field.FieldRepetitions != null && giveBarcodeIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            giveBarcodeIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(giveBarcodeIdentifier, fieldData);
        }
