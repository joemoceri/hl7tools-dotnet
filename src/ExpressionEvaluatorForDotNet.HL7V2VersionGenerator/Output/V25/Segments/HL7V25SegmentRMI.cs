...
Indicates the degree of precision of the time stamp (Y = year, L = month, D = day, H = hour, M = minute, S = second). Refer to HL7 Table 0529 - Precision for valid value.",
        ...
        internal HL7V25Field riskManagementIncidentCode;
...
public HL7V25Field RiskManagementIncidentCode
{
    get
    {
        ...
        riskManagementIncidentCode = new HL7V25Field
        {
            field = message[@"RMI"][1],
            Id = @"RMI.1",
            Type = @"Field",
        ...
        if (riskManagementIncidentCode.field.FieldRepetitions != null && riskManagementIncidentCode.field.FieldRepetitions.Count > 0)
        {
            ...
            riskManagementIncidentCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(riskManagementIncidentCode, fieldData);
        }
...
internal HL7V25Field dateTimeIncident;
...
public HL7V25Field DateTimeIncident
{
    get
    {
        ...
        dateTimeIncident = new HL7V25Field
        {
            field = message[@"RMI"][2],
            Id = @"RMI.2",
            Type = @"Field",
        ...
        if (dateTimeIncident.field.FieldRepetitions != null && dateTimeIncident.field.FieldRepetitions.Count > 0)
        {
            ...
            dateTimeIncident.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(dateTimeIncident, fieldData);
        }
...
internal HL7V25Field incidentTypeCode;
...
public HL7V25Field IncidentTypeCode
{
    get
    {
        ...
        incidentTypeCode = new HL7V25Field
        {
            field = message[@"RMI"][3],
            Id = @"RMI.3",
            Type = @"Field",
        ...
        if (incidentTypeCode.field.FieldRepetitions != null && incidentTypeCode.field.FieldRepetitions.Count > 0)
        {
            ...
            incidentTypeCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(incidentTypeCode, fieldData);
        }
