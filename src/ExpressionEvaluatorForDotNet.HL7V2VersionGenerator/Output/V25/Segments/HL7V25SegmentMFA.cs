...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V25SegmentMFA
    {
        ...
        internal HL7V25Field _recordLevelEventCode;
...
Note:  If the MFI-3 - File-level event code is ""REP"" (replace file), then each MFA segment must have an MFA-1 - Record-level event code of ""MAD"" (add record to master file). ",
        ...
        _recordLevelEventCode = new HL7V25Field
        {
            field = message[@"MFA"][1],
            fieldData = fieldData
        };
        ...
        {
            _recordLevelEventCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_recordLevelEventCode, fieldData);
        }
...
internal HL7V25Field _mFNControlID;
...
public HL7V25Field MFNControlID
{
    get
    {
        ...
        {
            _mFNControlID.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_mFNControlID, fieldData);
        }
...
internal HL7V25Field _eventCompletionDateTime;
...
Indicates the degree of precision of the time stamp (Y = year, L = month, D = day, H = hour, M = minute, S = second). Refer to HL7 Table 0529 - Precision for valid value.",
        ...
        _eventCompletionDateTime = new HL7V25Field
        {
            field = message[@"MFA"][3],
            fieldData = fieldData
        };
        ...
        {
            _eventCompletionDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_eventCompletionDateTime, fieldData);
        }
...
internal HL7V25Field _mFNRecordLevelErrorReturn;
...
public HL7V25Field MFNRecordLevelErrorReturn
{
    get
    {
        ...
        _mFNRecordLevelErrorReturn = new HL7V25Field
        {
            field = message[@"MFA"][4],
            fieldData = fieldData
        };
        ...
        {
            _mFNRecordLevelErrorReturn.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_mFNRecordLevelErrorReturn, fieldData);
        }
...
internal HL7V25Field _primaryKeyValueMFA;
...
The following exception to the use of the CE data type is deprecated in V2.3.1, and left in for backward compatibility.  When the CE data type is used, the first component of this CE data field carries an optional subcomponent, the application ID, that uniquely defines the application responsible for creating the primary key value.  The application ID subcomponents can be used to guarantee uniqueness of the primary key across multiple applications.",
        ...
        _primaryKeyValueMFA = new HL7V25Field
        {
            field = message[@"MFA"][5],
            fieldData = fieldData
        };
        ...
        {
            _primaryKeyValueMFA.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_primaryKeyValueMFA, fieldData);
        }
...
internal HL7V25Field _primaryKeyValueTypeMFA;
...
public HL7V25Field PrimaryKeyValueTypeMFA
{
    get
    {
        ...
        _primaryKeyValueTypeMFA = new HL7V25Field
        {
            field = message[@"MFA"][6],
            fieldData = fieldData
        };
        ...
        {
            _primaryKeyValueTypeMFA.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_primaryKeyValueTypeMFA, fieldData);
        }
