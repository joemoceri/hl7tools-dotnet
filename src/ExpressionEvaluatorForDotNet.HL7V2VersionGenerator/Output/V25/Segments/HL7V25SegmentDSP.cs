...
public HL7V25Field SetIDDSP
{
    get
    {
        ...
        if (setIDDSP.field.FieldRepetitions != null && setIDDSP.field.FieldRepetitions.Count > 0)
        {
            ...
            setIDDSP.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(setIDDSP, fieldData);
        }
...
internal HL7V25Field displayLevel;
...
public HL7V25Field DisplayLevel
{
    get
    {
        ...
        if (displayLevel.field.FieldRepetitions != null && displayLevel.field.FieldRepetitions.Count > 0)
        {
            ...
            displayLevel.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(displayLevel, fieldData);
        }
...
public HL7V25Field DataLine
{
    get
    {
        ...
        if (dataLine.field.FieldRepetitions != null && dataLine.field.FieldRepetitions.Count > 0)
        {
            ...
            dataLine.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(dataLine, fieldData);
        }
...
internal HL7V25Field logicalBreakPoint;
...
public HL7V25Field LogicalBreakPoint
{
    get
    {
        ...
        logicalBreakPoint = new HL7V25Field
        {
            field = message[@"DSP"][4],
            Id = @"DSP.4",
            Type = @"Field",
        ...
        if (logicalBreakPoint.field.FieldRepetitions != null && logicalBreakPoint.field.FieldRepetitions.Count > 0)
        {
            ...
            logicalBreakPoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(logicalBreakPoint, fieldData);
        }
...
public HL7V25Field ResultID
{
    get
    {
        ...
        if (resultID.field.FieldRepetitions != null && resultID.field.FieldRepetitions.Count > 0)
        {
            ...
            resultID.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(resultID, fieldData);
        }
