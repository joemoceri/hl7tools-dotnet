...
internal HL7V25Field _eQLQueryName;
...
public HL7V25Field EQLQueryName
{
    get
    {
        ...
        {
            _eQLQueryName.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_eQLQueryName, fieldData);
        }
...
internal HL7V25Field _eQLQueryStatement;
...
public HL7V25Field EQLQueryStatement
{
    get
    {
        ...
        _eQLQueryStatement = new HL7V25Field
        {
            field = message[@"EQL"][4],
            fieldData = fieldData
        };
        ...
        {
            _eQLQueryStatement.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_eQLQueryStatement, fieldData);
        }
