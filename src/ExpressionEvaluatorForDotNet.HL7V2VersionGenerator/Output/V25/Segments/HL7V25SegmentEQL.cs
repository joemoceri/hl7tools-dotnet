...
public HL7V25Field EQLQueryName
{
    get
    {
        ...
        if (eQLQueryName.field.FieldRepetitions != null && eQLQueryName.field.FieldRepetitions.Count > 0)
        {
            ...
            eQLQueryName.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(eQLQueryName, fieldData);
        }
...
public HL7V25Field EQLQueryStatement
{
    get
    {
        ...
        if (eQLQueryStatement.field.FieldRepetitions != null && eQLQueryStatement.field.FieldRepetitions.Count > 0)
        {
            ...
            eQLQueryStatement.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(eQLQueryStatement, fieldData);
        }
