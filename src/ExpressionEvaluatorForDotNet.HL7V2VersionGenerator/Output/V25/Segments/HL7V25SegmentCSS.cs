...
Indicates the degree of precision of the time stamp (Y = year, L = month, D = day, H = hour, M = minute, S = second). Refer to HL7 Table 0529 - Precision for valid value.",
        ...
        internal HL7V25Field studyScheduledTimePoint;
...
public HL7V25Field StudyScheduledTimePoint
{
    get
    {
        ...
        studyScheduledTimePoint = new HL7V25Field
        {
            field = message[@"CSS"][1],
            Id = @"CSS.1",
            Type = @"Field",
        ...
        if (studyScheduledTimePoint.field.FieldRepetitions != null && studyScheduledTimePoint.field.FieldRepetitions.Count > 0)
        {
            ...
            studyScheduledTimePoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(studyScheduledTimePoint, fieldData);
        }
...
internal HL7V25Field studyScheduledPatientTimePoint;
...
public HL7V25Field StudyScheduledPatientTimePoint
{
    get
    {
        ...
        studyScheduledPatientTimePoint = new HL7V25Field
        {
            field = message[@"CSS"][2],
            Id = @"CSS.2",
            Type = @"Field",
        ...
        if (studyScheduledPatientTimePoint.field.FieldRepetitions != null && studyScheduledPatientTimePoint.field.FieldRepetitions.Count > 0)
        {
            ...
            studyScheduledPatientTimePoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(studyScheduledPatientTimePoint, fieldData);
        }
...
internal HL7V25Field studyQualityControlCodes;
...
public HL7V25Field StudyQualityControlCodes
{
    get
    {
        ...
        studyQualityControlCodes = new HL7V25Field
        {
            field = message[@"CSS"][3],
            Id = @"CSS.3",
            Type = @"Field",
        ...
        if (studyQualityControlCodes.field.FieldRepetitions != null && studyQualityControlCodes.field.FieldRepetitions.Count > 0)
        {
            ...
            studyQualityControlCodes.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(studyQualityControlCodes, fieldData);
        }
