...
internal HL7V25Field _derivationRule;
...
public HL7V25Field DerivationRule
{
    get
    {
        ...
        _derivationRule = new HL7V25Field
        {
            field = message[@"OM6"][2],
            fieldData = fieldData
        };
        ...
        {
            _derivationRule.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_derivationRule, fieldData);
        }
