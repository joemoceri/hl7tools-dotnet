...
Indicates the degree of precision of the time stamp (Y = year, L = month, D = day, H = hour, M = minute, S = second). Refer to HL7 Table 0529 - Precision for valid value.",
        ...
        internal HL7V25Field systemDateTime;
...
public HL7V25Field SystemDateTime
{
    get
    {
        ...
        systemDateTime = new HL7V25Field
        {
            field = message[@"NCK"][1],
            Id = @"NCK.1",
            Type = @"Field",
        ...
        if (systemDateTime.field.FieldRepetitions != null && systemDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            systemDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(systemDateTime, fieldData);
        }
