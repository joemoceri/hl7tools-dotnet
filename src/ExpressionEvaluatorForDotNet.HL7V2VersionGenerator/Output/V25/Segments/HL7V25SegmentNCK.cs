...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V25SegmentNCK
    {
        ...
        public HL7V25SegmentNCK(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V25Field _systemDateTime;

public HL7V25Field SystemDateTime
{
    get
    {
...
Indicates the degree of precision of the time stamp (Y = year, L = month, D = day, H = hour, M = minute, S = second). Refer to HL7 Table 0529 - Precision for valid value.",
        ...
        _systemDateTime = new HL7V25Field
        {
            field = message[@"NCK"][1],
            fieldData = fieldData
        };
        ...
        {
            _systemDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_systemDateTime, fieldData);
        }
