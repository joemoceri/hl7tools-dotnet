...
public HL7V25Field EventReason
{
    get
    {
        ...
        if (eventReason.field.FieldRepetitions != null && eventReason.field.FieldRepetitions.Count > 0)
        {
            ...
            eventReason.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(eventReason, fieldData);
        }
...
This field contains the scheduled appointment's timing and quantity, as scheduled by the filler application. The TQ1 segment fully describes the components and the appropriate data values for the components of this field.",
        ...
        if (appointmentTimingQuantity.field.FieldRepetitions != null && appointmentTimingQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            appointmentTimingQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(appointmentTimingQuantity, fieldData);
        }
...
public HL7V25Field FillerContactPerson
{
    get
    {
        ...
        if (fillerContactPerson.field.FieldRepetitions != null && fillerContactPerson.field.FieldRepetitions.Count > 0)
        {
            ...
            fillerContactPerson.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(fillerContactPerson, fieldData);
        }
...
public HL7V25Field FillerContactPhoneNumber
{
    get
    {
        ...
        if (fillerContactPhoneNumber.field.FieldRepetitions != null && fillerContactPhoneNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            fillerContactPhoneNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(fillerContactPhoneNumber, fieldData);
        }
...
public HL7V25Field FillerContactAddress
{
    get
    {
        ...
        if (fillerContactAddress.field.FieldRepetitions != null && fillerContactAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            fillerContactAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(fillerContactAddress, fieldData);
        }
...
public HL7V25Field FillerContactLocation
{
    get
    {
        ...
        if (fillerContactLocation.field.FieldRepetitions != null && fillerContactLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            fillerContactLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(fillerContactLocation, fieldData);
        }
