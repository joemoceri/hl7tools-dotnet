...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V25SegmentODT
    {
        ...
        public HL7V25SegmentODT(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V25Field trayType;

public HL7V25Field TrayType
{
    get
    {
        if (trayType != null)
