...
public HL7V25Field TrayType
{
    get
    {
        ...
        if (trayType.field.FieldRepetitions != null && trayType.field.FieldRepetitions.Count > 0)
        {
            ...
            trayType.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(trayType, fieldData);
        }
...
public HL7V25Field ServicePeriod
{
    get
    {
        ...
        if (servicePeriod.field.FieldRepetitions != null && servicePeriod.field.FieldRepetitions.Count > 0)
        {
            ...
            servicePeriod.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(servicePeriod, fieldData);
        }
