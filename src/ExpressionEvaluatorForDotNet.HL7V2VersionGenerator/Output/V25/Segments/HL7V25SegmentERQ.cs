...
internal HL7V25Field _eventIdentifier;
...
public HL7V25Field EventIdentifier
{
    get
    {
        ...
        _eventIdentifier = new HL7V25Field
        {
            field = message[@"ERQ"][2],
            fieldData = fieldData
        };
        ...
        {
            _eventIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_eventIdentifier, fieldData);
        }
