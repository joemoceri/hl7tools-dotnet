...
public HL7V25Field RUDateTime
{
    get
    {
        ...
        if (rUDateTime.field.FieldRepetitions != null && rUDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            rUDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(rUDateTime, fieldData);
        }
...
public HL7V25Field ReportPriority
{
    get
    {
        ...
        if (reportPriority.field.FieldRepetitions != null && reportPriority.field.FieldRepetitions.Count > 0)
        {
            ...
            reportPriority.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(reportPriority, fieldData);
        }
...
public HL7V25Field RUWhoSubjectDefinition
{
    get
    {
        ...
        if (rUWhoSubjectDefinition.field.FieldRepetitions != null && rUWhoSubjectDefinition.field.FieldRepetitions.Count > 0)
        {
            ...
            rUWhoSubjectDefinition.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(rUWhoSubjectDefinition, fieldData);
        }
...
public HL7V25Field RUWhatSubjectDefinition
{
    get
    {
        ...
        if (rUWhatSubjectDefinition.field.FieldRepetitions != null && rUWhatSubjectDefinition.field.FieldRepetitions.Count > 0)
        {
            ...
            rUWhatSubjectDefinition.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(rUWhatSubjectDefinition, fieldData);
        }
...
public HL7V25Field RUWhatDepartmentCode
{
    get
    {
        ...
        if (rUWhatDepartmentCode.field.FieldRepetitions != null && rUWhatDepartmentCode.field.FieldRepetitions.Count > 0)
        {
            ...
            rUWhatDepartmentCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(rUWhatDepartmentCode, fieldData);
        }
...
public HL7V25Field RUDisplayPrintLocations
{
    get
    {
        ...
        if (rUDisplayPrintLocations.field.FieldRepetitions != null && rUDisplayPrintLocations.field.FieldRepetitions.Count > 0)
        {
            ...
            rUDisplayPrintLocations.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(rUDisplayPrintLocations, fieldData);
        }
...
public HL7V25Field RUResultsLevel
{
    get
    {
        ...
        if (rUResultsLevel.field.FieldRepetitions != null && rUResultsLevel.field.FieldRepetitions.Count > 0)
        {
            ...
            rUResultsLevel.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(rUResultsLevel, fieldData);
        }
