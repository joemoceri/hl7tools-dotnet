...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V25SegmentAIP
    {
        ...
        public HL7V25SegmentAIP(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V25Field _setIDAIP;

public HL7V25Field SetIDAIP
{
    get
    {
        if (_setIDAIP != null)
        ...
        {
            _setIDAIP.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_setIDAIP, fieldData);
        }
...
internal HL7V25Field _personnelResourceID;

public HL7V25Field PersonnelResourceID
{
    get
    {
...
Indicates the degree of precision of the time stamp (Y = year, L = month, D = day, H = hour, M = minute, S = second). Refer to HL7 Table 0529 - Precision for valid value.",
        ...
        _personnelResourceID = new HL7V25Field
        {
            field = message[@"AIP"][3],
            fieldData = fieldData
        };
        ...
        {
            _personnelResourceID.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_personnelResourceID, fieldData);
        }
