...
public HL7V25Field PrimaryKeyValueLOC
{
    get
    {
        ...
        if (primaryKeyValueLOC.field.FieldRepetitions != null && primaryKeyValueLOC.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValueLOC.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(primaryKeyValueLOC, fieldData);
        }
...
public HL7V25Field LocationDescription
{
    get
    {
        ...
        if (locationDescription.field.FieldRepetitions != null && locationDescription.field.FieldRepetitions.Count > 0)
        {
            ...
            locationDescription.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(locationDescription, fieldData);
        }
...
public HL7V25Field LocationTypeLOC
{
    get
    {
        ...
        if (locationTypeLOC.field.FieldRepetitions != null && locationTypeLOC.field.FieldRepetitions.Count > 0)
        {
            ...
            locationTypeLOC.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(locationTypeLOC, fieldData);
        }
...
public HL7V25Field OrganizationNameLOC
{
    get
    {
        ...
        if (organizationNameLOC.field.FieldRepetitions != null && organizationNameLOC.field.FieldRepetitions.Count > 0)
        {
            ...
            organizationNameLOC.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(organizationNameLOC, fieldData);
        }
...
public HL7V25Field LocationAddress
{
    get
    {
        ...
        if (locationAddress.field.FieldRepetitions != null && locationAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            locationAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(locationAddress, fieldData);
        }
...
public HL7V25Field LocationPhone
{
    get
    {
        ...
        if (locationPhone.field.FieldRepetitions != null && locationPhone.field.FieldRepetitions.Count > 0)
        {
            ...
            locationPhone.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(locationPhone, fieldData);
        }
...
public HL7V25Field LicenseNumber
{
    get
    {
        ...
        if (licenseNumber.field.FieldRepetitions != null && licenseNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            licenseNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(licenseNumber, fieldData);
        }
...
public HL7V25Field LocationEquipment
{
    get
    {
        ...
        if (locationEquipment.field.FieldRepetitions != null && locationEquipment.field.FieldRepetitions.Count > 0)
        {
            ...
            locationEquipment.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(locationEquipment, fieldData);
        }
...
public HL7V25Field LocationServiceCode
{
    get
    {
        ...
        if (locationServiceCode.field.FieldRepetitions != null && locationServiceCode.field.FieldRepetitions.Count > 0)
        {
            ...
            locationServiceCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(locationServiceCode, fieldData);
        }
