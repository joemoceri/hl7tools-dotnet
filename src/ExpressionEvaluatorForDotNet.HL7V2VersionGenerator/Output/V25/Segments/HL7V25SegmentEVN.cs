...
Indicates the degree of precision of the time stamp (Y = year, L = month, D = day, H = hour, M = minute, S = second). Refer to HL7 Table 0529 - Precision for valid value.",
        ...
        internal HL7V25Field eventTypeCode;
...
public HL7V25Field EventTypeCode
{
    get
    {
        ...
        if (eventTypeCode.field.FieldRepetitions != null && eventTypeCode.field.FieldRepetitions.Count > 0)
        {
            ...
            eventTypeCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(eventTypeCode, fieldData);
        }
...
internal HL7V25Field recordedDateTime;
...
public HL7V25Field RecordedDateTime
{
    get
    {
        ...
        recordedDateTime = new HL7V25Field
        {
            field = message[@"EVN"][2],
            Id = @"EVN.2",
            Type = @"Field",
        ...
        if (recordedDateTime.field.FieldRepetitions != null && recordedDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            recordedDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(recordedDateTime, fieldData);
        }
...
internal HL7V25Field dateTimePlannedEvent;
...
public HL7V25Field DateTimePlannedEvent
{
    get
    {
        ...
        dateTimePlannedEvent = new HL7V25Field
        {
            field = message[@"EVN"][3],
            Id = @"EVN.3",
            Type = @"Field",
        ...
        if (dateTimePlannedEvent.field.FieldRepetitions != null && dateTimePlannedEvent.field.FieldRepetitions.Count > 0)
        {
            ...
            dateTimePlannedEvent.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(dateTimePlannedEvent, fieldData);
        }
...
internal HL7V25Field eventReasonCode;
...
public HL7V25Field EventReasonCode
{
    get
    {
        ...
        eventReasonCode = new HL7V25Field
        {
            field = message[@"EVN"][4],
            Id = @"EVN.4",
            Type = @"Field",
        ...
        if (eventReasonCode.field.FieldRepetitions != null && eventReasonCode.field.FieldRepetitions.Count > 0)
        {
            ...
            eventReasonCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(eventReasonCode, fieldData);
        }
...
internal HL7V25Field operatorID;
...
public HL7V25Field OperatorID
{
    get
    {
        ...
        if (operatorID.field.FieldRepetitions != null && operatorID.field.FieldRepetitions.Count > 0)
        {
            ...
            operatorID.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(operatorID, fieldData);
        }
...
internal HL7V25Field eventOccurred;
...
public HL7V25Field EventOccurred
{
    get
    {
        ...
        if (eventOccurred.field.FieldRepetitions != null && eventOccurred.field.FieldRepetitions.Count > 0)
        {
            ...
            eventOccurred.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(eventOccurred, fieldData);
        }
...
internal HL7V25Field eventFacility;
...
public HL7V25Field EventFacility
{
    get
    {
        ...
        if (eventFacility.field.FieldRepetitions != null && eventFacility.field.FieldRepetitions.Count > 0)
        {
            ...
            eventFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(eventFacility, fieldData);
        }
