...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V25SegmentRDT
    {
        ...
        public HL7V25SegmentRDT(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V25Field _columnValue;

public HL7V25Field ColumnValue
{
    get
    {
        ...
        {
            _columnValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(_columnValue, fieldData);
        }
