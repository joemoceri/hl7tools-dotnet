...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V25SegmentRDT
    {
        ...
        internal HL7V25Field columnValue;
...
public HL7V25Field ColumnValue
{
    get
    {
        ...
        if (columnValue.field.FieldRepetitions != null && columnValue.field.FieldRepetitions.Count > 0)
        {
            ...
            columnValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(columnValue, fieldData);
        }
