...
public HL7V25Field BusinessRuleOverrideType
{
    get
    {
        ...
        if (businessRuleOverrideType.field.FieldRepetitions != null && businessRuleOverrideType.field.FieldRepetitions.Count > 0)
        {
            ...
            businessRuleOverrideType.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(businessRuleOverrideType, fieldData);
        }
...
public HL7V25Field BusinessRuleOverrideCode
{
    get
    {
        ...
        if (businessRuleOverrideCode.field.FieldRepetitions != null && businessRuleOverrideCode.field.FieldRepetitions.Count > 0)
        {
            ...
            businessRuleOverrideCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(businessRuleOverrideCode, fieldData);
        }
...
public HL7V25Field OverrideComments
{
    get
    {
        ...
        if (overrideComments.field.FieldRepetitions != null && overrideComments.field.FieldRepetitions.Count > 0)
        {
            ...
            overrideComments.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(overrideComments, fieldData);
        }
...
public HL7V25Field OverrideEnteredBy
{
    get
    {
        ...
        if (overrideEnteredBy.field.FieldRepetitions != null && overrideEnteredBy.field.FieldRepetitions.Count > 0)
        {
            ...
            overrideEnteredBy.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(overrideEnteredBy, fieldData);
        }
...
public HL7V25Field OverrideAuthorizedBy
{
    get
    {
        ...
        if (overrideAuthorizedBy.field.FieldRepetitions != null && overrideAuthorizedBy.field.FieldRepetitions.Count > 0)
        {
            ...
            overrideAuthorizedBy.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(overrideAuthorizedBy, fieldData);
        }
