...
public HL7V25Field SetIDCM0
{
    get
    {
        ...
        if (setIDCM0.field.FieldRepetitions != null && setIDCM0.field.FieldRepetitions.Count > 0)
        {
            ...
            setIDCM0.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(setIDCM0, fieldData);
        }
...
public HL7V25Field TitleofStudy
{
    get
    {
        ...
        if (titleofStudy.field.FieldRepetitions != null && titleofStudy.field.FieldRepetitions.Count > 0)
        {
            ...
            titleofStudy.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(titleofStudy, fieldData);
        }
...
public HL7V25Field ChairmanofStudy
{
    get
    {
        ...
        if (chairmanofStudy.field.FieldRepetitions != null && chairmanofStudy.field.FieldRepetitions.Count > 0)
        {
            ...
            chairmanofStudy.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(chairmanofStudy, fieldData);
        }
...
public HL7V25Field LastIRBApprovalDate
{
    get
    {
        ...
        if (lastIRBApprovalDate.field.FieldRepetitions != null && lastIRBApprovalDate.field.FieldRepetitions.Count > 0)
        {
            ...
            lastIRBApprovalDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(lastIRBApprovalDate, fieldData);
        }
...
public HL7V25Field TotalAccrualtoDate
{
    get
    {
        ...
        if (totalAccrualtoDate.field.FieldRepetitions != null && totalAccrualtoDate.field.FieldRepetitions.Count > 0)
        {
            ...
            totalAccrualtoDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(totalAccrualtoDate, fieldData);
        }
...
public HL7V25Field LastAccrualDate
{
    get
    {
        ...
        if (lastAccrualDate.field.FieldRepetitions != null && lastAccrualDate.field.FieldRepetitions.Count > 0)
        {
            ...
            lastAccrualDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(lastAccrualDate, fieldData);
        }
...
public HL7V25Field ContactforStudy
{
    get
    {
        ...
        if (contactforStudy.field.FieldRepetitions != null && contactforStudy.field.FieldRepetitions.Count > 0)
        {
            ...
            contactforStudy.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(contactforStudy, fieldData);
        }
...
public HL7V25Field ContactsTelephoneNumber
{
    get
    {
        ...
        if (contactsTelephoneNumber.field.FieldRepetitions != null && contactsTelephoneNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            contactsTelephoneNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(contactsTelephoneNumber, fieldData);
        }
...
public HL7V25Field ContactsAddress
{
    get
    {
        ...
        if (contactsAddress.field.FieldRepetitions != null && contactsAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            contactsAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(contactsAddress, fieldData);
        }
