...
As of version 2.5 this field is deprecated and retained for backward compatibility.  This field is conditional, meaning that, in case where the SPM segment is used in a message together with the SAC, this field should be ignored. The reader is referred to the SPM Specimen segment.",
        ...
        public HL7V25SegmentTCC(HL7V2Message message)
        {
...
internal HL7V25Field testApplicationIdentifier;

public HL7V25Field TestApplicationIdentifier
{
    get
    {
        ...
        testApplicationIdentifier = new HL7V25Field
        {
            field = message[@"TCC"][2],
            Id = @"TCC.2",
            Type = @"Field",
        ...
        // check for repetitions
        if (testApplicationIdentifier.field.FieldRepetitions != null && testApplicationIdentifier.field.FieldRepetitions.Count > 0)
        {
            // get this fields data
            var fieldData = Fields.First(fd => fd.Id.Equals(testApplicationIdentifier.Id));
            var fieldRepetitions = new List<HL7V25FieldRepetition>();

            for (var i = 0; i < testApplicationIdentifier.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V25FieldRepetition
                {
                    fieldRepetition = testApplicationIdentifier.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < testApplicationIdentifier.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V25Component
                        {
                            component = testApplicationIdentifier.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < testApplicationIdentifier.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V25SubComponent
                                {
                                    subComponent = testApplicationIdentifier.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = subComponentFieldData.Id,
                                    Type = subComponentFieldData.Type,
                                    Position = subComponentFieldData.Position,
                                    Name = subComponentFieldData.Name,
            ...
            testApplicationIdentifier.fieldRepetitions = fieldRepetitions;
        }
...
internal HL7V25Field autoDilutionFactorDefault;

public HL7V25Field AutoDilutionFactorDefault
{
    get
    {
        ...
        autoDilutionFactorDefault = new HL7V25Field
        {
            field = message[@"TCC"][4],
            Id = @"TCC.4",
            Type = @"Field",
...
internal HL7V25Field rerunDilutionFactorDefault;

public HL7V25Field RerunDilutionFactorDefault
{
    get
    {
        ...
        rerunDilutionFactorDefault = new HL7V25Field
        {
            field = message[@"TCC"][5],
            Id = @"TCC.5",
            Type = @"Field",
...
internal HL7V25Field preDilutionFactorDefault;

public HL7V25Field PreDilutionFactorDefault
{
    get
    {
        ...
        preDilutionFactorDefault = new HL7V25Field
        {
            field = message[@"TCC"][6],
            Id = @"TCC.6",
            Type = @"Field",
...
internal HL7V25Field endogenousContentofPreDilutionDiluent;
...
public HL7V25Field EndogenousContentofPreDilutionDiluent
{
    get
    {
        ...
        endogenousContentofPreDilutionDiluent = new HL7V25Field
        {
            field = message[@"TCC"][7],
            Id = @"TCC.7",
            Type = @"Field",
...
internal HL7V25Field inventoryLimitsWarningLevel;

public HL7V25Field InventoryLimitsWarningLevel
{
    get
    {
        ...
        inventoryLimitsWarningLevel = new HL7V25Field
        {
            field = message[@"TCC"][8],
            Id = @"TCC.8",
            Type = @"Field",
...
internal HL7V25Field automaticRerunAllowed;

public HL7V25Field AutomaticRerunAllowed
{
    get
    {
        ...
        automaticRerunAllowed = new HL7V25Field
        {
            field = message[@"TCC"][9],
            Id = @"TCC.9",
            Type = @"Field",
...
internal HL7V25Field automaticRepeatAllowed;
...
public HL7V25Field AutomaticRepeatAllowed
{
    get
    {
        ...
        automaticRepeatAllowed = new HL7V25Field
        {
...
internal HL7V25Field automaticReflexAllowed;

public HL7V25Field AutomaticReflexAllowed
{
    get
    {
        ...
        automaticReflexAllowed = new HL7V25Field
        {
...
internal HL7V25Field equipmentDynamicRange;

public HL7V25Field EquipmentDynamicRange
{
    get
    {
        ...
        equipmentDynamicRange = new HL7V25Field
        {
...
internal HL7V25Field units;

public HL7V25Field Units
{
    get
    {
        if (units != null)
...
internal HL7V25Field processingType;

public HL7V25Field ProcessingType
{
    get
    {
        ...
        processingType = new HL7V25Field
        {
