...
internal HL7V25Field userParameters(insuccessivefields);

public HL7V25Field UserParameters(insuccessivefields)
{
    get
    {
        ...
        userParameters(insuccessivefields) = new HL7V25Field
        {
            field = message[@"QPD"][3],
            Id = @"QPD.3",
            Type = @"Field",
