...
public HL7V25Field ReferenceInteractionNumberuniqueidentifier
{
    get
    {
        ...
        if (referenceInteractionNumberuniqueidentifier.field.FieldRepetitions != null && referenceInteractionNumberuniqueidentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            referenceInteractionNumberuniqueidentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(referenceInteractionNumberuniqueidentifier, fieldData);
        }
...
public HL7V25Field InteractionTypeIdentifier
{
    get
    {
        ...
        if (interactionTypeIdentifier.field.FieldRepetitions != null && interactionTypeIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            interactionTypeIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(interactionTypeIdentifier, fieldData);
        }
...
public HL7V25Field InteractionActiveState
{
    get
    {
        ...
        if (interactionActiveState.field.FieldRepetitions != null && interactionActiveState.field.FieldRepetitions.Count > 0)
        {
            ...
            interactionActiveState.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(interactionActiveState, fieldData);
        }
