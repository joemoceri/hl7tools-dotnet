...
internal HL7V25Field preferredCodingSystem;
...
public HL7V25Field PreferredCodingSystem
{
    get
    {
        ...
        preferredCodingSystem = new HL7V25Field
        {
            field = message[@"OM3"][2],
            Id = @"OM3.2",
            Type = @"Field",
        ...
        if (preferredCodingSystem.field.FieldRepetitions != null && preferredCodingSystem.field.FieldRepetitions.Count > 0)
        {
            ...
            preferredCodingSystem.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(preferredCodingSystem, fieldData);
        }
...
public HL7V25Field ValidCodedAnswers
{
    get
    {
        ...
        if (validCodedAnswers.field.FieldRepetitions != null && validCodedAnswers.field.FieldRepetitions.Count > 0)
        {
            ...
            validCodedAnswers.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(validCodedAnswers, fieldData);
        }
...
internal HL7V25Field normalTextCodesforCategoricalObservations;
...
public HL7V25Field NormalTextCodesforCategoricalObservations
{
    get
    {
        ...
        normalTextCodesforCategoricalObservations = new HL7V25Field
        {
            field = message[@"OM3"][4],
            Id = @"OM3.4",
            Type = @"Field",
        ...
        if (normalTextCodesforCategoricalObservations.field.FieldRepetitions != null && normalTextCodesforCategoricalObservations.field.FieldRepetitions.Count > 0)
        {
            ...
            normalTextCodesforCategoricalObservations.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(normalTextCodesforCategoricalObservations, fieldData);
        }
...
internal HL7V25Field abnormalTextCodesforCategoricalObservations;
...
public HL7V25Field AbnormalTextCodesforCategoricalObservations
{
    get
    {
        ...
        abnormalTextCodesforCategoricalObservations = new HL7V25Field
        {
            field = message[@"OM3"][5],
            Id = @"OM3.5",
            Type = @"Field",
...
Note:  Backward compatibility note - As of v2.5 this field is allowed to repeat.  When used for versions prior to v2.5, extra repetitions sent will be lost.",
        ...
        if (abnormalTextCodesforCategoricalObservations.field.FieldRepetitions != null && abnormalTextCodesforCategoricalObservations.field.FieldRepetitions.Count > 0)
        {
            ...
            abnormalTextCodesforCategoricalObservations.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(abnormalTextCodesforCategoricalObservations, fieldData);
        }
...
internal HL7V25Field criticalTextCodesforCategoricalObservations;
...
public HL7V25Field CriticalTextCodesforCategoricalObservations
{
    get
    {
        ...
        criticalTextCodesforCategoricalObservations = new HL7V25Field
        {
            field = message[@"OM3"][6],
            Id = @"OM3.6",
            Type = @"Field",
...
Note:  Backward compatibility note - As of v2.5 this field is allowed to repeat.  When used for versions prior to v2.5, extra repetitions sent will be lost.",
        ...
        if (criticalTextCodesforCategoricalObservations.field.FieldRepetitions != null && criticalTextCodesforCategoricalObservations.field.FieldRepetitions.Count > 0)
        {
            ...
            criticalTextCodesforCategoricalObservations.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(criticalTextCodesforCategoricalObservations, fieldData);
        }
