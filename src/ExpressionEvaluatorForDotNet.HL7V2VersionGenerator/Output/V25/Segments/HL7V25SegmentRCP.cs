...
Note: Although the codes for segment groups are taken from HL7 Table 0391, the exact segment-level definition of a segment group (e.g. PIDG) is given only in the conformance statement of the query in which this segment group appears.",
        ...
        internal HL7V25Field queryPriority;
...
public HL7V25Field QueryPriority
{
    get
    {
        ...
        if (queryPriority.field.FieldRepetitions != null && queryPriority.field.FieldRepetitions.Count > 0)
        {
            ...
            queryPriority.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(queryPriority, fieldData);
        }
...
internal HL7V25Field quantityLimitedRequest;
...
public HL7V25Field QuantityLimitedRequest
{
    get
    {
        ...
        quantityLimitedRequest = new HL7V25Field
        {
            field = message[@"RCP"][2],
            Id = @"RCP.2",
            Type = @"Field",
        ...
        if (quantityLimitedRequest.field.FieldRepetitions != null && quantityLimitedRequest.field.FieldRepetitions.Count > 0)
        {
            ...
            quantityLimitedRequest.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(quantityLimitedRequest, fieldData);
        }
...
internal HL7V25Field responseModality;
...
public HL7V25Field ResponseModality
{
    get
    {
        ...
        responseModality = new HL7V25Field
        {
            field = message[@"RCP"][3],
            Id = @"RCP.3",
            Type = @"Field",
        ...
        if (responseModality.field.FieldRepetitions != null && responseModality.field.FieldRepetitions.Count > 0)
        {
            ...
            responseModality.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(responseModality, fieldData);
        }
...
internal HL7V25Field executionandDeliveryTime;
...
public HL7V25Field ExecutionandDeliveryTime
{
    get
    {
        ...
        executionandDeliveryTime = new HL7V25Field
        {
            field = message[@"RCP"][4],
            Id = @"RCP.4",
            Type = @"Field",
        ...
        if (executionandDeliveryTime.field.FieldRepetitions != null && executionandDeliveryTime.field.FieldRepetitions.Count > 0)
        {
            ...
            executionandDeliveryTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(executionandDeliveryTime, fieldData);
        }
...
internal HL7V25Field modifyIndicator;
...
public HL7V25Field ModifyIndicator
{
    get
    {
        ...
        modifyIndicator = new HL7V25Field
        {
            field = message[@"RCP"][5],
            Id = @"RCP.5",
            Type = @"Field",
        ...
        if (modifyIndicator.field.FieldRepetitions != null && modifyIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            modifyIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(modifyIndicator, fieldData);
        }
...
internal HL7V25Field sortbyField;
...
public HL7V25Field SortbyField
{
    get
    {
        ...
        if (sortbyField.field.FieldRepetitions != null && sortbyField.field.FieldRepetitions.Count > 0)
        {
            ...
            sortbyField.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(sortbyField, fieldData);
        }
...
internal HL7V25Field segmentgroupinclusion;
...
public HL7V25Field Segmentgroupinclusion
{
    get
    {
        ...
        segmentgroupinclusion = new HL7V25Field
        {
            field = message[@"RCP"][7],
            Id = @"RCP.7",
            Type = @"Field",
...
Note: Although the codes for segment groups are taken from HL7 Table 0391, the exact segment-level definition of a segment group (e.g. PIDG) is given only in the conformance statement of the query in which this segment group appears.",
        ...
        if (segmentgroupinclusion.field.FieldRepetitions != null && segmentgroupinclusion.field.FieldRepetitions.Count > 0)
        {
            ...
            segmentgroupinclusion.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(segmentgroupinclusion, fieldData);
        }
