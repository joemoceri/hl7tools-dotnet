...
public HL7V25Field DRGAssignedDateTime
{
    get
    {
        ...
        if (dRGAssignedDateTime.field.FieldRepetitions != null && dRGAssignedDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            dRGAssignedDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(dRGAssignedDateTime, fieldData);
        }
...
public HL7V25Field DRGPayor
{
    get
    {
        ...
        if (dRGPayor.field.FieldRepetitions != null && dRGPayor.field.FieldRepetitions.Count > 0)
        {
            ...
            dRGPayor.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(dRGPayor, fieldData);
        }
...
public HL7V25Field OutlierReimbursement
{
    get
    {
        ...
        if (outlierReimbursement.field.FieldRepetitions != null && outlierReimbursement.field.FieldRepetitions.Count > 0)
        {
            ...
            outlierReimbursement.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(outlierReimbursement, fieldData);
        }
...
public HL7V25Field DRGTransferType
{
    get
    {
        ...
        if (dRGTransferType.field.FieldRepetitions != null && dRGTransferType.field.FieldRepetitions.Count > 0)
        {
            ...
            dRGTransferType.fieldRepetitions = HL7V2FieldGenerator.GenerateV25FieldRepetitions(dRGTransferType, fieldData);
        }
