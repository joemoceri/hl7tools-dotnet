...
{
    public class HL7V27TriggerEventADT_A20
    {
...
private readonly HL7V27SegmentNPU npu;
        ...
        public HL7V27TriggerEventADT_A20(HL7V2Message message)
        {
...
this.npu = new HL7V27SegmentNPU(this.message);
