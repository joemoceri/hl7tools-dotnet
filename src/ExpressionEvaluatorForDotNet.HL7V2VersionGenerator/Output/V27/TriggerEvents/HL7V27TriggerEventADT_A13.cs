...
{
    public class HL7V27TriggerEventADT_A13
    {
...
private readonly HL7V27SegmentPDA pda;


        public string Id { get { return @"ADT_A13"; } }
        public string MessageStructureId { get { return @"ADT_A13"; } }
        public string EventDescription { get { return @"Cancel discharge/end visit"; } }
        ...
        public HL7V27TriggerEventADT_A13(HL7V2Message message)
        {
...
this.pda = new HL7V27SegmentPDA(this.message);
