...
Preference order numbers need not be sequential (i.e., three numbers with the priority orders of 0, 5 and 15 are legitimate).  The preference order numbers must be non-negative.",
        ...
        internal HL7V27Field dispenseSubidCounter;
...
public HL7V27Field DispenseSubidCounter
{
    get
    {
        ...
        dispenseSubidCounter = new HL7V27Field
        {
            field = message[@"RXD"][1],
            Id = @"RXD.1",
            Type = @"Field",
        ...
        if (dispenseSubidCounter.field.FieldRepetitions != null && dispenseSubidCounter.field.FieldRepetitions.Count > 0)
        {
            ...
            dispenseSubidCounter.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(dispenseSubidCounter, fieldData);
        }
...
internal HL7V27Field dispenseGiveCode;
...
public HL7V27Field DispenseGiveCode
{
    get
    {
        ...
        dispenseGiveCode = new HL7V27Field
        {
            field = message[@"RXD"][2],
            Id = @"RXD.2",
            Type = @"Field",
...
Note: The contents of RXD-2-dispense/give code should be compatible with the comparable field in the RXE (RXE-2-give code). The RDS message refers ONLY to the dispensing of the drug or treatment by the pharmacy or treatment supplier.",
        ...
        if (dispenseGiveCode.field.FieldRepetitions != null && dispenseGiveCode.field.FieldRepetitions.Count > 0)
        {
            ...
            dispenseGiveCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(dispenseGiveCode, fieldData);
        }
...
internal HL7V27Field dateTimeDispensed;
...
public HL7V27Field DateTimeDispensed
{
    get
    {
        ...
        dateTimeDispensed = new HL7V27Field
        {
            field = message[@"RXD"][3],
            Id = @"RXD.3",
            Type = @"Field",
        ...
        if (dateTimeDispensed.field.FieldRepetitions != null && dateTimeDispensed.field.FieldRepetitions.Count > 0)
        {
            ...
            dateTimeDispensed.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(dateTimeDispensed, fieldData);
        }
...
internal HL7V27Field actualDispenseAmount;
...
public HL7V27Field ActualDispenseAmount
{
    get
    {
        ...
        actualDispenseAmount = new HL7V27Field
        {
            field = message[@"RXD"][4],
            Id = @"RXD.4",
            Type = @"Field",
        ...
        if (actualDispenseAmount.field.FieldRepetitions != null && actualDispenseAmount.field.FieldRepetitions.Count > 0)
        {
            ...
            actualDispenseAmount.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(actualDispenseAmount, fieldData);
        }
...
internal HL7V27Field actualDispenseUnits;
...
public HL7V27Field ActualDispenseUnits
{
    get
    {
        ...
        actualDispenseUnits = new HL7V27Field
        {
            field = message[@"RXD"][5],
            Id = @"RXD.5",
            Type = @"Field",
        ...
        if (actualDispenseUnits.field.FieldRepetitions != null && actualDispenseUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            actualDispenseUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(actualDispenseUnits, fieldData);
        }
...
internal HL7V27Field actualDosageForm;
...
public HL7V27Field ActualDosageForm
{
    get
    {
        ...
        actualDosageForm = new HL7V27Field
        {
            field = message[@"RXD"][6],
            Id = @"RXD.6",
            Type = @"Field",
        ...
        if (actualDosageForm.field.FieldRepetitions != null && actualDosageForm.field.FieldRepetitions.Count > 0)
        {
            ...
            actualDosageForm.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(actualDosageForm, fieldData);
        }
...
internal HL7V27Field prescriptionNumber;
...
public HL7V27Field PrescriptionNumber
{
    get
    {
        ...
        prescriptionNumber = new HL7V27Field
        {
            field = message[@"RXD"][7],
            Id = @"RXD.7",
            Type = @"Field",
        ...
        if (prescriptionNumber.field.FieldRepetitions != null && prescriptionNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            prescriptionNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(prescriptionNumber, fieldData);
        }
...
internal HL7V27Field numberOfRefillsRemaining;
...
public HL7V27Field NumberOfRefillsRemaining
{
    get
    {
        ...
        numberOfRefillsRemaining = new HL7V27Field
        {
            field = message[@"RXD"][8],
            Id = @"RXD.8",
            Type = @"Field",
        ...
        if (numberOfRefillsRemaining.field.FieldRepetitions != null && numberOfRefillsRemaining.field.FieldRepetitions.Count > 0)
        {
            ...
            numberOfRefillsRemaining.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(numberOfRefillsRemaining, fieldData);
        }
...
internal HL7V27Field dispenseNotes;
...
public HL7V27Field DispenseNotes
{
    get
    {
        ...
        if (dispenseNotes.field.FieldRepetitions != null && dispenseNotes.field.FieldRepetitions.Count > 0)
        {
            ...
            dispenseNotes.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(dispenseNotes, fieldData);
        }
...
internal HL7V27Field dispensingProvider;
...
public HL7V27Field DispensingProvider
{
    get
    {
        ...
        dispensingProvider = new HL7V27Field
        {
...
This field contains the provider ID of the person dispensing the pharmaceutical. If the person referenced in this field is also referenced in PRT segment, they must contain the same information.  However, if there is a difference, then PRT segment takes precedence.",
        ...
        if (dispensingProvider.field.FieldRepetitions != null && dispensingProvider.field.FieldRepetitions.Count > 0)
        {
            ...
            dispensingProvider.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(dispensingProvider, fieldData);
        }
...
internal HL7V27Field substitutionStatus;
...
public HL7V27Field SubstitutionStatus
{
    get
    {
        ...
        substitutionStatus = new HL7V27Field
        {
        ...
        if (substitutionStatus.field.FieldRepetitions != null && substitutionStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            substitutionStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(substitutionStatus, fieldData);
        }
...
internal HL7V27Field totalDailyDose;
...
public HL7V27Field TotalDailyDose
{
    get
    {
        ...
        totalDailyDose = new HL7V27Field
        {
...
Note: The next two fields are equivalent to the corresponding fields of the RXE segment. They are included (optionally) in the RXD so that it may ""stand alone"" as a dispense result instruction segment.",
        ...
        if (totalDailyDose.field.FieldRepetitions != null && totalDailyDose.field.FieldRepetitions.Count > 0)
        {
            ...
            totalDailyDose.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(totalDailyDose, fieldData);
        }
...
internal HL7V27Field dispensetoLocation;
...
public HL7V27Field DispensetoLocation
{
    get
    {
        ...
        dispensetoLocation = new HL7V27Field
        {
        ...
        if (dispensetoLocation.field.FieldRepetitions != null && dispensetoLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            dispensetoLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(dispensetoLocation, fieldData);
        }
...
internal HL7V27Field needsHumanReview;
...
public HL7V27Field NeedsHumanReview
{
    get
    {
        ...
        needsHumanReview = new HL7V27Field
        {
...
N - Indicates no warning is present. This is the equivalent default (null) value.",
        ...
        if (needsHumanReview.field.FieldRepetitions != null && needsHumanReview.field.FieldRepetitions.Count > 0)
        {
            ...
            needsHumanReview.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(needsHumanReview, fieldData);
        }
...
internal HL7V27Field pharmacyTreatmentSuppliersSpecialDispensingInstructions;
...
public HL7V27Field PharmacyTreatmentSuppliersSpecialDispensingInstructions
{
    get
    {
        ...
        pharmacyTreatmentSuppliersSpecialDispensingInstructions = new HL7V27Field
        {
        ...
        if (pharmacyTreatmentSuppliersSpecialDispensingInstructions.field.FieldRepetitions != null && pharmacyTreatmentSuppliersSpecialDispensingInstructions.field.FieldRepetitions.Count > 0)
        {
            ...
            pharmacyTreatmentSuppliersSpecialDispensingInstructions.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(pharmacyTreatmentSuppliersSpecialDispensingInstructions, fieldData);
        }
...
internal HL7V27Field actualStrength;
...
public HL7V27Field ActualStrength
{
    get
    {
        ...
        actualStrength = new HL7V27Field
        {
        ...
        if (actualStrength.field.FieldRepetitions != null && actualStrength.field.FieldRepetitions.Count > 0)
        {
            ...
            actualStrength.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(actualStrength, fieldData);
        }
...
internal HL7V27Field actualStrengthUnit;
...
public HL7V27Field ActualStrengthUnit
{
    get
    {
        ...
        actualStrengthUnit = new HL7V27Field
        {
...
Note: These units can be a ""compound quantity;"" i.e., the units may express a quantity per unit of time. For example, micrograms per hour (micg/h) is an acceptable value. These compound units are contained in the ISO+ table. See Chapter 7 for full definition of ISO+ units.",
        ...
        if (actualStrengthUnit.field.FieldRepetitions != null && actualStrengthUnit.field.FieldRepetitions.Count > 0)
        {
            ...
            actualStrengthUnit.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(actualStrengthUnit, fieldData);
        }
...
internal HL7V27Field substanceLotNumber;
...
public HL7V27Field SubstanceLotNumber
{
    get
    {
        ...
        substanceLotNumber = new HL7V27Field
        {
...
Note: The lot number is the number printed on the label attached to the container holding the substance and on the packaging which houses the container. If the substance is a vaccine, for example, and a diluent is required, a lot number may appear on the vial containing the diluent; however, any such identifier associated with a diluent is not the identifier of interest. The substance lot number should be reported, not that of the diluent.",
        ...
        if (substanceLotNumber.field.FieldRepetitions != null && substanceLotNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            substanceLotNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(substanceLotNumber, fieldData);
        }
...
internal HL7V27Field substanceExpirationDate;
...
public HL7V27Field SubstanceExpirationDate
{
    get
    {
        ...
        substanceExpirationDate = new HL7V27Field
        {
...
Note: Vaccine expiration date does not always have a ""day"" component; therefore, such a date may be transmitted as YYYYMM^L.",
        ...
        if (substanceExpirationDate.field.FieldRepetitions != null && substanceExpirationDate.field.FieldRepetitions.Count > 0)
        {
            ...
            substanceExpirationDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(substanceExpirationDate, fieldData);
        }
...
internal HL7V27Field substanceManufacturerName;
...
public HL7V27Field SubstanceManufacturerName
{
    get
    {
        ...
        substanceManufacturerName = new HL7V27Field
        {
...
Note: For vaccines, code system MVX may be used to code this field. See Section 4A.7.1, ""Vaccine administration data"". This field may be used if the manufacturer of the substance is not identified by the code used in RXA-5-Administered code.",
        ...
        if (substanceManufacturerName.field.FieldRepetitions != null && substanceManufacturerName.field.FieldRepetitions.Count > 0)
        {
            ...
            substanceManufacturerName.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(substanceManufacturerName, fieldData);
        }
...
internal HL7V27Field indication;
...
public HL7V27Field Indication
{
    get
    {
        ...
        if (indication.field.FieldRepetitions != null && indication.field.FieldRepetitions.Count > 0)
        {
            ...
            indication.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(indication, fieldData);
        }
...
internal HL7V27Field dispensePackageSize;
...
public HL7V27Field DispensePackageSize
{
    get
    {
        ...
        dispensePackageSize = new HL7V27Field
        {
        ...
        if (dispensePackageSize.field.FieldRepetitions != null && dispensePackageSize.field.FieldRepetitions.Count > 0)
        {
            ...
            dispensePackageSize.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(dispensePackageSize, fieldData);
        }
...
internal HL7V27Field dispensePackageSizeUnit;
...
public HL7V27Field DispensePackageSizeUnit
{
    get
    {
        ...
        dispensePackageSizeUnit = new HL7V27Field
        {
        ...
        if (dispensePackageSizeUnit.field.FieldRepetitions != null && dispensePackageSizeUnit.field.FieldRepetitions.Count > 0)
        {
            ...
            dispensePackageSizeUnit.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(dispensePackageSizeUnit, fieldData);
        }
...
internal HL7V27Field dispensePackageMethod;
...
public HL7V27Field DispensePackageMethod
{
    get
    {
        ...
        dispensePackageMethod = new HL7V27Field
        {
        ...
        if (dispensePackageMethod.field.FieldRepetitions != null && dispensePackageMethod.field.FieldRepetitions.Count > 0)
        {
            ...
            dispensePackageMethod.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(dispensePackageMethod, fieldData);
        }
...
internal HL7V27Field supplementaryCode;
...
public HL7V27Field SupplementaryCode
{
    get
    {
        ...
        supplementaryCode = new HL7V27Field
        {
        ...
        if (supplementaryCode.field.FieldRepetitions != null && supplementaryCode.field.FieldRepetitions.Count > 0)
        {
            ...
            supplementaryCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(supplementaryCode, fieldData);
        }
...
internal HL7V27Field initiatingLocation;
...
public HL7V27Field InitiatingLocation
{
    get
    {
        ...
        initiatingLocation = new HL7V27Field
        {
...
Example: Pharmacy A (the Intake/Receiving) receives a phone call from the patient requesting a medication refill, but stipulates that the prescription will be picked up in pharmacy B. In accordance with the business process the prescription will be packaged/assembled in Pharmacy C.",
        ...
        if (initiatingLocation.field.FieldRepetitions != null && initiatingLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            initiatingLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(initiatingLocation, fieldData);
        }
...
internal HL7V27Field packagingAssemblyLocation;
...
public HL7V27Field PackagingAssemblyLocation
{
    get
    {
        ...
        packagingAssemblyLocation = new HL7V27Field
        {
        ...
        if (packagingAssemblyLocation.field.FieldRepetitions != null && packagingAssemblyLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            packagingAssemblyLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(packagingAssemblyLocation, fieldData);
        }
...
internal HL7V27Field actualDrugStrengthVolume;
...
public HL7V27Field ActualDrugStrengthVolume
{
    get
    {
        ...
        actualDrugStrengthVolume = new HL7V27Field
        {
        ...
        if (actualDrugStrengthVolume.field.FieldRepetitions != null && actualDrugStrengthVolume.field.FieldRepetitions.Count > 0)
        {
            ...
            actualDrugStrengthVolume.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(actualDrugStrengthVolume, fieldData);
        }
...
internal HL7V27Field actualDrugStrengthVolumeUnits;
...
public HL7V27Field ActualDrugStrengthVolumeUnits
{
    get
    {
        ...
        actualDrugStrengthVolumeUnits = new HL7V27Field
        {
        ...
        if (actualDrugStrengthVolumeUnits.field.FieldRepetitions != null && actualDrugStrengthVolumeUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            actualDrugStrengthVolumeUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(actualDrugStrengthVolumeUnits, fieldData);
        }
...
internal HL7V27Field dispenseToPharmacy;
...
public HL7V27Field DispenseToPharmacy
{
    get
    {
        ...
        dispenseToPharmacy = new HL7V27Field
        {
...
This field specifies the pharmacy that will dispense or has dispensed the prescription. In the context of an order/request (i.e., in an RXO segment) this field represents the requested dispensing pharmacy. In the context of a registered order (i.e., in an RXE segment) this field represents the intended dispensing pharmacy, the pharmacy that is expected to dispense the prescription.",
        ...
        if (dispenseToPharmacy.field.FieldRepetitions != null && dispenseToPharmacy.field.FieldRepetitions.Count > 0)
        {
            ...
            dispenseToPharmacy.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(dispenseToPharmacy, fieldData);
        }
...
internal HL7V27Field dispenseToPharmacyAddress;
...
public HL7V27Field DispenseToPharmacyAddress
{
    get
    {
        ...
        dispenseToPharmacyAddress = new HL7V27Field
        {
...
This field specifies the address of the dispensing facility or the patient's location where the dispensing will occur.",
        ...
        if (dispenseToPharmacyAddress.field.FieldRepetitions != null && dispenseToPharmacyAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            dispenseToPharmacyAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(dispenseToPharmacyAddress, fieldData);
        }
...
internal HL7V27Field pharmacyOrderType;
...
public HL7V27Field PharmacyOrderType
{
    get
    {
        ...
        pharmacyOrderType = new HL7V27Field
        {
...
Usage Rule: This field is optional for all Pharmacy transactions.  When not populated, a default value of ""M"" is assumed.",
        ...
        if (pharmacyOrderType.field.FieldRepetitions != null && pharmacyOrderType.field.FieldRepetitions.Count > 0)
        {
            ...
            pharmacyOrderType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(pharmacyOrderType, fieldData);
        }
...
internal HL7V27Field dispenseType;
...
public HL7V27Field DispenseType
{
    get
    {
        ...
        if (dispenseType.field.FieldRepetitions != null && dispenseType.field.FieldRepetitions.Count > 0)
        {
            ...
            dispenseType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(dispenseType, fieldData);
        }
...
internal HL7V27Field pharmacyPhoneNumber;
...
public HL7V27Field PharmacyPhoneNumber
{
    get
    {
        ...
        pharmacyPhoneNumber = new HL7V27Field
        {
        ...
        if (pharmacyPhoneNumber.field.FieldRepetitions != null && pharmacyPhoneNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            pharmacyPhoneNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(pharmacyPhoneNumber, fieldData);
        }
