...
Value set version ID is required if CWE.21 is populated.",
        ...
        internal HL7V27Field primaryKeyValueLdp;
...
public HL7V27Field PrimaryKeyValueLdp
{
    get
    {
        ...
        primaryKeyValueLdp = new HL7V27Field
        {
            field = message[@"LDP"][1],
            Id = @"LDP.1",
            Type = @"Field",
        ...
        if (primaryKeyValueLdp.field.FieldRepetitions != null && primaryKeyValueLdp.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValueLdp.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(primaryKeyValueLdp, fieldData);
        }
...
internal HL7V27Field locationDepartment;
...
public HL7V27Field LocationDepartment
{
    get
    {
        ...
        locationDepartment = new HL7V27Field
        {
            field = message[@"LDP"][2],
            Id = @"LDP.2",
            Type = @"Field",
        ...
        if (locationDepartment.field.FieldRepetitions != null && locationDepartment.field.FieldRepetitions.Count > 0)
        {
            ...
            locationDepartment.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(locationDepartment, fieldData);
        }
...
internal HL7V27Field locationService;
...
public HL7V27Field LocationService
{
    get
    {
        ...
        locationService = new HL7V27Field
        {
            field = message[@"LDP"][3],
            Id = @"LDP.3",
            Type = @"Field",
        ...
        if (locationService.field.FieldRepetitions != null && locationService.field.FieldRepetitions.Count > 0)
        {
            ...
            locationService.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(locationService, fieldData);
        }
...
internal HL7V27Field specialtyType;
...
public HL7V27Field SpecialtyType
{
    get
    {
        ...
        if (specialtyType.field.FieldRepetitions != null && specialtyType.field.FieldRepetitions.Count > 0)
        {
            ...
            specialtyType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(specialtyType, fieldData);
        }
...
internal HL7V27Field activationDateLdp;
...
public HL7V27Field ActivationDateLdp
{
    get
    {
        ...
        activationDateLdp = new HL7V27Field
        {
            field = message[@"LDP"][7],
            Id = @"LDP.7",
            Type = @"Field",
        ...
        if (activationDateLdp.field.FieldRepetitions != null && activationDateLdp.field.FieldRepetitions.Count > 0)
        {
            ...
            activationDateLdp.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(activationDateLdp, fieldData);
        }
...
internal HL7V27Field inactivationDateLdp;
...
public HL7V27Field InactivationDateLdp
{
    get
    {
        ...
        inactivationDateLdp = new HL7V27Field
        {
            field = message[@"LDP"][8],
            Id = @"LDP.8",
            Type = @"Field",
        ...
        if (inactivationDateLdp.field.FieldRepetitions != null && inactivationDateLdp.field.FieldRepetitions.Count > 0)
        {
            ...
            inactivationDateLdp.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(inactivationDateLdp, fieldData);
        }
...
internal HL7V27Field inactivatedReason;
...
public HL7V27Field InactivatedReason
{
    get
    {
        ...
        inactivatedReason = new HL7V27Field
        {
            field = message[@"LDP"][9],
            Id = @"LDP.9",
            Type = @"Field",
        ...
        if (inactivatedReason.field.FieldRepetitions != null && inactivatedReason.field.FieldRepetitions.Count > 0)
        {
            ...
            inactivatedReason.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(inactivatedReason, fieldData);
        }
...
internal HL7V27Field visitingHours;
...
public HL7V27Field VisitingHours
{
    get
    {
        ...
        if (visitingHours.field.FieldRepetitions != null && visitingHours.field.FieldRepetitions.Count > 0)
        {
            ...
            visitingHours.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(visitingHours, fieldData);
        }
...
internal HL7V27Field contactPhone;
...
public HL7V27Field ContactPhone
{
    get
    {
        ...
        if (contactPhone.field.FieldRepetitions != null && contactPhone.field.FieldRepetitions.Count > 0)
        {
            ...
            contactPhone.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(contactPhone, fieldData);
        }
...
internal HL7V27Field locationCostCenter;
...
public HL7V27Field LocationCostCenter
{
    get
    {
        ...
        locationCostCenter = new HL7V27Field
        {
        ...
        if (locationCostCenter.field.FieldRepetitions != null && locationCostCenter.field.FieldRepetitions.Count > 0)
        {
            ...
            locationCostCenter.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(locationCostCenter, fieldData);
        }
