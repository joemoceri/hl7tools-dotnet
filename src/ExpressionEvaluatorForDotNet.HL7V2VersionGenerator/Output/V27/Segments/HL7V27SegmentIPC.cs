...
Note: References, field names and definitions in this section were developed in collaboration with DICOM with the goal of keeping HL7 transmission of imaging procedure control information consistent with the DICOM Standard, available at http://medical.nema.org."; } }
        ...
        public HL7V27SegmentIPC(HL7V2Message message)
        {
...
internal HL7V27Field _requestedProcedureId;

public HL7V27Field RequestedProcedureId
{
    get
    {
...
Refer to HL7 Table 0301 - Universal ID Type for valid values.",
        ...
        _requestedProcedureId = new HL7V27Field
        {
            field = message[@"IPC"][2],
            fieldData = fieldData
        };
        ...
        {
            _requestedProcedureId.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_requestedProcedureId, fieldData);
        }
...
internal HL7V27Field _studyInstanceUid;

public HL7V27Field StudyInstanceUid
{
    get
    {
...
Refer to HL7 Table 0301 - Universal ID Type for valid values.",
        ...
        _studyInstanceUid = new HL7V27Field
        {
            field = message[@"IPC"][3],
            fieldData = fieldData
        };
        ...
        {
            _studyInstanceUid.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_studyInstanceUid, fieldData);
        }
...
internal HL7V27Field _scheduledProcedureStepId;

public HL7V27Field ScheduledProcedureStepId
{
    get
    {
...
Refer to HL7 Table 0301 - Universal ID Type for valid values.",
        ...
        _scheduledProcedureStepId = new HL7V27Field
        {
            field = message[@"IPC"][4],
            fieldData = fieldData
        };
        ...
        {
            _scheduledProcedureStepId.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_scheduledProcedureStepId, fieldData);
        }
...
internal HL7V27Field _modality;

public HL7V27Field Modality
{
    get
    {
        if (_modality != null)
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _modality.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_modality, fieldData);
        }
...
internal HL7V27Field _protocolCode;

public HL7V27Field ProtocolCode
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _protocolCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_protocolCode, fieldData);
        }
...
internal HL7V27Field _scheduledStationName;

public HL7V27Field ScheduledStationName
{
    get
    {
...
Refer to HL7 Table 0301 - Universal ID Type for valid values.",
        ...
        _scheduledStationName = new HL7V27Field
        {
            field = message[@"IPC"][7],
            fieldData = fieldData
        };
        ...
        {
            _scheduledStationName.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_scheduledStationName, fieldData);
        }
...
internal HL7V27Field _scheduledProcedureStepLocation;

public HL7V27Field ScheduledProcedureStepLocation
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _scheduledProcedureStepLocation = new HL7V27Field
        {
            field = message[@"IPC"][8],
            fieldData = fieldData
        };
        ...
        {
            _scheduledProcedureStepLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_scheduledProcedureStepLocation, fieldData);
        }
...
internal HL7V27Field _scheduledStationAeTitle;

public HL7V27Field ScheduledStationAeTitle
{
    get
    {
...
If the Scheduled Procedure Step is to be performed by an unspecified member of a pool of resources, this field shall be empty and IPC-8 Scheduled Procedure Step Location is used to identify the site-specific resource pool. See section 4.5.6.8 for explanation of the resource pool.",
        ...
        _scheduledStationAeTitle = new HL7V27Field
        {
            field = message[@"IPC"][9],
            fieldData = fieldData
        };
        ...
        {
            _scheduledStationAeTitle.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_scheduledStationAeTitle, fieldData);
        }
