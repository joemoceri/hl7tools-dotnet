...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V27SegmentMSH
    {
        ...
        public HL7V27SegmentMSH(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V27Field _fieldSeparator;

public HL7V27Field FieldSeparator
{
    get
    {
        ...
        _fieldSeparator = new HL7V27Field
        {
            field = message[@"MSH"][1],
            fieldData = fieldData
        };
        ...
        {
            _fieldSeparator.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_fieldSeparator, fieldData);
        }
...
internal HL7V27Field _encodingCharacters;

public HL7V27Field EncodingCharacters
{
    get
    {
        ...
        _encodingCharacters = new HL7V27Field
        {
            field = message[@"MSH"][2],
            fieldData = fieldData
        };
        ...
        {
            _encodingCharacters.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_encodingCharacters, fieldData);
        }
...
internal HL7V27Field _sendingApplication;

public HL7V27Field SendingApplication
{
    get
    {
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _sendingApplication = new HL7V27Field
        {
            field = message[@"MSH"][3],
            fieldData = fieldData
        };
        ...
        {
            _sendingApplication.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_sendingApplication, fieldData);
        }
...
internal HL7V27Field _sendingFacility;

public HL7V27Field SendingFacility
{
    get
    {
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _sendingFacility = new HL7V27Field
        {
            field = message[@"MSH"][4],
            fieldData = fieldData
        };
        ...
        {
            _sendingFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_sendingFacility, fieldData);
        }
...
internal HL7V27Field _receivingApplication;

public HL7V27Field ReceivingApplication
{
    get
    {
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _receivingApplication = new HL7V27Field
        {
            field = message[@"MSH"][5],
            fieldData = fieldData
        };
        ...
        {
            _receivingApplication.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_receivingApplication, fieldData);
        }
...
internal HL7V27Field _receivingFacility;

public HL7V27Field ReceivingFacility
{
    get
    {
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _receivingFacility = new HL7V27Field
        {
            field = message[@"MSH"][6],
            fieldData = fieldData
        };
        ...
        {
            _receivingFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_receivingFacility, fieldData);
        }
...
internal HL7V27Field _dateTimeOfMessage;

public HL7V27Field DateTimeOfMessage
{
    get
    {
...
Note: This field was made required in version 2.4. Messages with versions prior to 2.4 are not required to value this field. This usage supports backward compatibility.",
        ...
        _dateTimeOfMessage = new HL7V27Field
        {
            field = message[@"MSH"][7],
            fieldData = fieldData
        };
        ...
        {
            _dateTimeOfMessage.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_dateTimeOfMessage, fieldData);
        }
...
internal HL7V27Field _security;

public HL7V27Field Security
{
    get
    {
        if (_security != null)
        ...
        {
            _security.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_security, fieldData);
        }
...
internal HL7V27Field _messageType;

public HL7V27Field MessageType
{
    get
    {
...
This table contains values like A01, O01, R01 etc.",
        ...
        {
            _messageType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_messageType, fieldData);
        }
...
internal HL7V27Field _messageControlId;
...
public HL7V27Field MessageControlId
{
    get
    {
        ...
        _messageControlId = new HL7V27Field
        {
        ...
        {
            _messageControlId.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_messageControlId, fieldData);
        }
...
internal HL7V27Field _processingId;

public HL7V27Field ProcessingId
{
    get
    {
        ...
        {
            _processingId.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_processingId, fieldData);
        }
...
internal HL7V27Field _versionId;

public HL7V27Field VersionId
{
    get
    {
        if (_versionId != null)
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _versionId.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_versionId, fieldData);
        }
...
internal HL7V27Field _sequenceNumber;

public HL7V27Field SequenceNumber
{
    get
    {
        ...
        _sequenceNumber = new HL7V27Field
        {
        ...
        {
            _sequenceNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_sequenceNumber, fieldData);
        }
...
internal HL7V27Field _continuationPointer;

public HL7V27Field ContinuationPointer
{
    get
    {
        ...
        _continuationPointer = new HL7V27Field
        {
        ...
        {
            _continuationPointer.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_continuationPointer, fieldData);
        }
...
internal HL7V27Field _acceptAcknowledgmentType;

public HL7V27Field AcceptAcknowledgmentType
{
    get
    {
        ...
        _acceptAcknowledgmentType = new HL7V27Field
        {
        ...
        {
            _acceptAcknowledgmentType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_acceptAcknowledgmentType, fieldData);
        }
...
internal HL7V27Field _applicationAcknowledgmentType;

public HL7V27Field ApplicationAcknowledgmentType
{
    get
    {
...
If MSH-15-accept acknowledgment type and MSH-16-application acknowledgment type are omitted (or are both null), the original acknowledgment mode rules are used.",
        ...
        _applicationAcknowledgmentType = new HL7V27Field
        {
        ...
        {
            _applicationAcknowledgmentType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_applicationAcknowledgmentType, fieldData);
        }
...
internal HL7V27Field _countryCode;

public HL7V27Field CountryCode
{
    get
    {
...
Refer to External Table 0399 - Country Code for the 3-character codes as defined by ISO 3166-1.",
        ...
        {
            _countryCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_countryCode, fieldData);
        }
...
internal HL7V27Field _characterSet;

public HL7V27Field CharacterSet
{
    get
    {
...
Note: When describing encoding rules, this standard always speaks in terms of character position, not byte offset. Similarly, comparisons should be done on character values, not their byte equivalents. For this reason, delimiter characters should always have representation in the standard 7-bit ASCII character set, regardless of the actual character set being used, so that a search for the character CR (carriage return) can be performed.
   ...
   c) elements in the remainder of the sequence (i.e., elements 2..n) are alternate character sets that may be used.",
        ...
        {
            _characterSet.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_characterSet, fieldData);
        }
...
internal HL7V27Field _principalLanguageOfMessage;

public HL7V27Field PrincipalLanguageOfMessage
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _principalLanguageOfMessage = new HL7V27Field
        {
        ...
        {
            _principalLanguageOfMessage.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_principalLanguageOfMessage, fieldData);
        }
...
internal HL7V27Field _alternateCharacterSetHandlingScheme;

public HL7V27Field AlternateCharacterSetHandlingScheme
{
    get
    {
        ...
        _alternateCharacterSetHandlingScheme = new HL7V27Field
        {
        ...
        {
            _alternateCharacterSetHandlingScheme.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_alternateCharacterSetHandlingScheme, fieldData);
        }
...
internal HL7V27Field _messageProfileIdentifier;

public HL7V27Field MessageProfileIdentifier
{
    get
    {
...
Refer to HL7 Table 0301 - Universal ID Type for valid values.",
        ...
        _messageProfileIdentifier = new HL7V27Field
        {
        ...
        {
            _messageProfileIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_messageProfileIdentifier, fieldData);
        }
...
internal HL7V27Field _sendingResponsibleOrganization;

public HL7V27Field SendingResponsibleOrganization
{
    get
    {
...
Note: The check digit and code identifying check digit scheme are null if Organization identifier is alphanumeric.",
        ...
        _sendingResponsibleOrganization = new HL7V27Field
        {
        ...
        {
            _sendingResponsibleOrganization.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_sendingResponsibleOrganization, fieldData);
        }
...
internal HL7V27Field _receivingResponsibleOrganization;

public HL7V27Field ReceivingResponsibleOrganization
{
    get
    {
...
Note: The check digit and code identifying check digit scheme are null if Organization identifier is alphanumeric.",
        ...
        _receivingResponsibleOrganization = new HL7V27Field
        {
        ...
        {
            _receivingResponsibleOrganization.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_receivingResponsibleOrganization, fieldData);
        }
...
internal HL7V27Field _sendingNetworkAddress;

public HL7V27Field SendingNetworkAddress
{
    get
    {
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _sendingNetworkAddress = new HL7V27Field
        {
        ...
        {
            _sendingNetworkAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_sendingNetworkAddress, fieldData);
        }
...
internal HL7V27Field _receivingNetworkAddress;

public HL7V27Field ReceivingNetworkAddress
{
    get
    {
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _receivingNetworkAddress = new HL7V27Field
        {
        ...
        {
            _receivingNetworkAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_receivingNetworkAddress, fieldData);
        }
