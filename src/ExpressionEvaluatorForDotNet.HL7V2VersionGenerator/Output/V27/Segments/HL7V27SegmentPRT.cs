...
internal HL7V27Field participationBeginDateTime(arrivalTime);

public HL7V27Field ParticipationBeginDateTime(arrivalTime)
{
    get
    {
        ...
        participationBeginDateTime(arrivalTime) = new HL7V27Field
        {
...
internal HL7V27Field participationEndDateTime(departureTime);

public HL7V27Field ParticipationEndDateTime(departureTime)
{
    get
    {
        ...
        participationEndDateTime(departureTime) = new HL7V27Field
        {
