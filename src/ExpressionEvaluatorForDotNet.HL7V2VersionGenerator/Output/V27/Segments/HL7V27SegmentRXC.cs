...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V27SegmentRXC
    {
        ...
        public HL7V27SegmentRXC(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V27Field _rxComponentType;

public HL7V27Field RxComponentType
{
    get
    {
...
If any ""base"" components are present then these should be transmitted first. The first ""base"" component in the transmission should be considered the ""primary base"" if such a distinction is necessary. Similarly, the first ""additive"" in the transmission should be considered the ""primary additive"" if such a distinction is necessary.",
        ...
        _rxComponentType = new HL7V27Field
        {
            field = message[@"RXC"][1],
            fieldData = fieldData
        };
        ...
        {
            _rxComponentType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_rxComponentType, fieldData);
        }
...
internal HL7V27Field _componentCode;

public HL7V27Field ComponentCode
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _componentCode = new HL7V27Field
        {
            field = message[@"RXC"][2],
            fieldData = fieldData
        };
        ...
        {
            _componentCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_componentCode, fieldData);
        }
...
internal HL7V27Field _componentAmount;

public HL7V27Field ComponentAmount
{
    get
    {
        ...
        _componentAmount = new HL7V27Field
        {
            field = message[@"RXC"][3],
            fieldData = fieldData
        };
        ...
        {
            _componentAmount.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_componentAmount, fieldData);
        }
...
internal HL7V27Field _componentUnits;

public HL7V27Field ComponentUnits
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _componentUnits = new HL7V27Field
        {
            field = message[@"RXC"][4],
            fieldData = fieldData
        };
        ...
        {
            _componentUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_componentUnits, fieldData);
        }
...
internal HL7V27Field _componentStrength;

public HL7V27Field ComponentStrength
{
    get
    {
        ...
        _componentStrength = new HL7V27Field
        {
            field = message[@"RXC"][5],
            fieldData = fieldData
        };
        ...
        {
            _componentStrength.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_componentStrength, fieldData);
        }
...
internal HL7V27Field _componentStrengthUnits;

public HL7V27Field ComponentStrengthUnits
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _componentStrengthUnits = new HL7V27Field
        {
            field = message[@"RXC"][6],
            fieldData = fieldData
        };
        ...
        {
            _componentStrengthUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_componentStrengthUnits, fieldData);
        }
...
internal HL7V27Field _componentDrugStrengthVolume;

public HL7V27Field ComponentDrugStrengthVolume
{
    get
    {
...
RXC|||||120|mg^^ISO||5|ml^^ISO ...<cr>",
        ...
        _componentDrugStrengthVolume = new HL7V27Field
        {
            field = message[@"RXC"][8],
            fieldData = fieldData
        };
        ...
        {
            _componentDrugStrengthVolume.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_componentDrugStrengthVolume, fieldData);
        }
...
internal HL7V27Field _componentDrugStrengthVolumeUnits;

public HL7V27Field ComponentDrugStrengthVolumeUnits
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _componentDrugStrengthVolumeUnits = new HL7V27Field
        {
            field = message[@"RXC"][9],
            fieldData = fieldData
        };
        ...
        {
            _componentDrugStrengthVolumeUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_componentDrugStrengthVolumeUnits, fieldData);
        }
