...
Value set version ID is required if CWE.21 is populated.",
        ...
        internal HL7V27Field typeOfBillCode;
...
public HL7V27Field TypeOfBillCode
{
    get
    {
        ...
        typeOfBillCode = new HL7V27Field
        {
            field = message[@"GP1"][1],
            Id = @"GP1.1",
            Type = @"Field",
        ...
        if (typeOfBillCode.field.FieldRepetitions != null && typeOfBillCode.field.FieldRepetitions.Count > 0)
        {
            ...
            typeOfBillCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(typeOfBillCode, fieldData);
        }
...
internal HL7V27Field overallClaimDispositionCode;
...
public HL7V27Field OverallClaimDispositionCode
{
    get
    {
        ...
        overallClaimDispositionCode = new HL7V27Field
        {
            field = message[@"GP1"][3],
            Id = @"GP1.3",
            Type = @"Field",
        ...
        if (overallClaimDispositionCode.field.FieldRepetitions != null && overallClaimDispositionCode.field.FieldRepetitions.Count > 0)
        {
            ...
            overallClaimDispositionCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(overallClaimDispositionCode, fieldData);
        }
...
internal HL7V27Field oceEditsPerVisitCode;
...
public HL7V27Field OceEditsPerVisitCode
{
    get
    {
        ...
        oceEditsPerVisitCode = new HL7V27Field
        {
            field = message[@"GP1"][4],
            Id = @"GP1.4",
            Type = @"Field",
        ...
        if (oceEditsPerVisitCode.field.FieldRepetitions != null && oceEditsPerVisitCode.field.FieldRepetitions.Count > 0)
        {
            ...
            oceEditsPerVisitCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(oceEditsPerVisitCode, fieldData);
        }
