...
Note:  If the MFI-3 - File-Level Event Code is ""REP"" (replace file), then each MFE segment must have an MFE-1 - Record-Level Event Code of ""MAD"" (add record to master file).",
        ...
        internal HL7V27Field masterFileIdentifier;
...
public HL7V27Field MasterFileIdentifier
{
    get
    {
        ...
        masterFileIdentifier = new HL7V27Field
        {
            field = message[@"MFI"][1],
            Id = @"MFI.1",
            Type = @"Field",
        ...
        if (masterFileIdentifier.field.FieldRepetitions != null && masterFileIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            masterFileIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(masterFileIdentifier, fieldData);
        }
...
internal HL7V27Field masterFileApplicationIdentifier;
...
public HL7V27Field MasterFileApplicationIdentifier
{
    get
    {
        ...
        masterFileApplicationIdentifier = new HL7V27Field
        {
            field = message[@"MFI"][2],
            Id = @"MFI.2",
            Type = @"Field",
        ...
        if (masterFileApplicationIdentifier.field.FieldRepetitions != null && masterFileApplicationIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            masterFileApplicationIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(masterFileApplicationIdentifier, fieldData);
        }
...
internal HL7V27Field filelevelEventCode;
...
public HL7V27Field FilelevelEventCode
{
    get
    {
        ...
        filelevelEventCode = new HL7V27Field
        {
            field = message[@"MFI"][3],
            Id = @"MFI.3",
            Type = @"Field",
...
Note:  If the MFI-3 - File-Level Event Code is ""REP"" (replace file), then each MFE segment must have an MFE-1 - Record-Level Event Code of ""MAD"" (add record to master file).",
        ...
        if (filelevelEventCode.field.FieldRepetitions != null && filelevelEventCode.field.FieldRepetitions.Count > 0)
        {
            ...
            filelevelEventCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(filelevelEventCode, fieldData);
        }
...
internal HL7V27Field responseLevelCode;
...
public HL7V27Field ResponseLevelCode
{
    get
    {
        ...
        responseLevelCode = new HL7V27Field
        {
            field = message[@"MFI"][6],
            Id = @"MFI.6",
            Type = @"Field",
        ...
        if (responseLevelCode.field.FieldRepetitions != null && responseLevelCode.field.FieldRepetitions.Count > 0)
        {
            ...
            responseLevelCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(responseLevelCode, fieldData);
        }
