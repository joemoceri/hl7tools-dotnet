...
Value set version ID is required if CWE.21 is populated.",
        ...
        public HL7V27SegmentTCD(HL7V2Message message)
        {
...
internal HL7V27Field autodilutionFactor;

public HL7V27Field AutodilutionFactor
{
    get
    {
        ...
        autodilutionFactor = new HL7V27Field
        {
            field = message[@"TCD"][2],
            Id = @"TCD.2",
            Type = @"Field",
        ...
        if (autodilutionFactor.field.FieldRepetitions != null && autodilutionFactor.field.FieldRepetitions.Count > 0)
        {
            ...
            autodilutionFactor.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(autodilutionFactor, fieldData);
        }
...
internal HL7V27Field rerunDilutionFactor;

public HL7V27Field RerunDilutionFactor
{
    get
    {
        ...
        rerunDilutionFactor = new HL7V27Field
        {
            field = message[@"TCD"][3],
            Id = @"TCD.3",
            Type = @"Field",
        ...
        if (rerunDilutionFactor.field.FieldRepetitions != null && rerunDilutionFactor.field.FieldRepetitions.Count > 0)
        {
            ...
            rerunDilutionFactor.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(rerunDilutionFactor, fieldData);
        }
...
internal HL7V27Field predilutionFactor;

public HL7V27Field PredilutionFactor
{
    get
    {
        ...
        predilutionFactor = new HL7V27Field
        {
            field = message[@"TCD"][4],
            Id = @"TCD.4",
            Type = @"Field",
        ...
        if (predilutionFactor.field.FieldRepetitions != null && predilutionFactor.field.FieldRepetitions.Count > 0)
        {
            ...
            predilutionFactor.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(predilutionFactor, fieldData);
        }
...
internal HL7V27Field reflexAllowed;

public HL7V27Field ReflexAllowed
{
    get
    {
        ...
        if (reflexAllowed.field.FieldRepetitions != null && reflexAllowed.field.FieldRepetitions.Count > 0)
        {
            ...
            reflexAllowed.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(reflexAllowed, fieldData);
        }
...
internal HL7V27Field analyteRepeatStatus;

public HL7V27Field AnalyteRepeatStatus
{
    get
    {
        ...
        analyteRepeatStatus = new HL7V27Field
        {
            field = message[@"TCD"][8],
            Id = @"TCD.8",
            Type = @"Field",
...
- Reflex test — this test is performed as the consequence of rules triggered based on other test result(s).",
        ...
        if (analyteRepeatStatus.field.FieldRepetitions != null && analyteRepeatStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            analyteRepeatStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(analyteRepeatStatus, fieldData);
        }
