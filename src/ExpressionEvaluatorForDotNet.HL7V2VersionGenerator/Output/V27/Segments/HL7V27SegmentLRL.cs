...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V27SegmentLRL
    {
        ...
        internal HL7V27Field _primaryKeyValueLrl;
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _primaryKeyValueLrl = new HL7V27Field
        {
            field = message[@"LRL"][1],
            fieldData = fieldData
        };
        ...
        {
            _primaryKeyValueLrl.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_primaryKeyValueLrl, fieldData);
        }
...
internal HL7V27Field _locationRelationshipId;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _locationRelationshipId = new HL7V27Field
        {
            field = message[@"LRL"][4],
            fieldData = fieldData
        };
        ...
        {
            _locationRelationshipId.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_locationRelationshipId, fieldData);
        }
...
internal HL7V27Field _organizationalLocationRelationshipValue;
...
Note: The check digit and code identifying check digit scheme are null if Organization identifier is alphanumeric.",
        ...
        _organizationalLocationRelationshipValue = new HL7V27Field
        {
            field = message[@"LRL"][5],
            fieldData = fieldData
        };
        ...
        {
            _organizationalLocationRelationshipValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_organizationalLocationRelationshipValue, fieldData);
        }
...
internal HL7V27Field _patientLocationRelationshipValue;
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _patientLocationRelationshipValue = new HL7V27Field
        {
            field = message[@"LRL"][6],
            fieldData = fieldData
        };
        ...
        {
            _patientLocationRelationshipValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_patientLocationRelationshipValue, fieldData);
        }
