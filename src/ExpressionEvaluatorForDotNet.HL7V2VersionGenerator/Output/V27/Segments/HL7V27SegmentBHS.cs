...
public HL7V27Field BatchFieldSeparator
{
    get
    {
        ...
        if (batchFieldSeparator.field.FieldRepetitions != null && batchFieldSeparator.field.FieldRepetitions.Count > 0)
        {
            ...
            batchFieldSeparator.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(batchFieldSeparator, fieldData);
        }
...
public HL7V27Field BatchEncodingCharacters
{
    get
    {
        ...
        if (batchEncodingCharacters.field.FieldRepetitions != null && batchEncodingCharacters.field.FieldRepetitions.Count > 0)
        {
            ...
            batchEncodingCharacters.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(batchEncodingCharacters, fieldData);
        }
...
public HL7V27Field BatchSendingApplication
{
    get
    {
        ...
        if (batchSendingApplication.field.FieldRepetitions != null && batchSendingApplication.field.FieldRepetitions.Count > 0)
        {
            ...
            batchSendingApplication.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(batchSendingApplication, fieldData);
        }
...
public HL7V27Field BatchSendingFacility
{
    get
    {
        ...
        if (batchSendingFacility.field.FieldRepetitions != null && batchSendingFacility.field.FieldRepetitions.Count > 0)
        {
            ...
            batchSendingFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(batchSendingFacility, fieldData);
        }
...
public HL7V27Field BatchReceivingApplication
{
    get
    {
        ...
        if (batchReceivingApplication.field.FieldRepetitions != null && batchReceivingApplication.field.FieldRepetitions.Count > 0)
        {
            ...
            batchReceivingApplication.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(batchReceivingApplication, fieldData);
        }
...
public HL7V27Field BatchReceivingFacility
{
    get
    {
        ...
        if (batchReceivingFacility.field.FieldRepetitions != null && batchReceivingFacility.field.FieldRepetitions.Count > 0)
        {
            ...
            batchReceivingFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(batchReceivingFacility, fieldData);
        }
...
public HL7V27Field BatchCreationDateTime
{
    get
    {
        ...
        if (batchCreationDateTime.field.FieldRepetitions != null && batchCreationDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            batchCreationDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(batchCreationDateTime, fieldData);
        }
...
public HL7V27Field BatchSecurity
{
    get
    {
        ...
        if (batchSecurity.field.FieldRepetitions != null && batchSecurity.field.FieldRepetitions.Count > 0)
        {
            ...
            batchSecurity.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(batchSecurity, fieldData);
        }
...
Note: the text regarding ""extra components"" has been retained for backward compatibility, but it is not currently an accepted format for the ST data type.",
        ...
        if (batchNameIdType.field.FieldRepetitions != null && batchNameIdType.field.FieldRepetitions.Count > 0)
        {
            ...
            batchNameIdType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(batchNameIdType, fieldData);
        }
...
public HL7V27Field BatchComment
{
    get
    {
        ...
        if (batchComment.field.FieldRepetitions != null && batchComment.field.FieldRepetitions.Count > 0)
        {
            ...
            batchComment.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(batchComment, fieldData);
        }
...
public HL7V27Field BatchControlId
{
    get
    {
        ...
        if (batchControlId.field.FieldRepetitions != null && batchControlId.field.FieldRepetitions.Count > 0)
        {
            ...
            batchControlId.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(batchControlId, fieldData);
        }
...
public HL7V27Field ReferenceBatchControlId
{
    get
    {
        ...
        if (referenceBatchControlId.field.FieldRepetitions != null && referenceBatchControlId.field.FieldRepetitions.Count > 0)
        {
            ...
            referenceBatchControlId.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(referenceBatchControlId, fieldData);
        }
...
The specific values and usage must be site negotiated",
        ...
        if (batchSendingNetworkAddress.field.FieldRepetitions != null && batchSendingNetworkAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            batchSendingNetworkAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(batchSendingNetworkAddress, fieldData);
        }
...
This field should only be populated when the underlying communication protocol does not support identification receiving network locations.",
        ...
        if (batchReceivingNetworkAddress.field.FieldRepetitions != null && batchReceivingNetworkAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            batchReceivingNetworkAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(batchReceivingNetworkAddress, fieldData);
        }
