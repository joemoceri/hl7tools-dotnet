...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V27SegmentRQD
    {
        ...
        public HL7V27SegmentRQD(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V27Field _requisitionLineNumber;

public HL7V27Field RequisitionLineNumber
{
    get
    {
        ...
        _requisitionLineNumber = new HL7V27Field
        {
            field = message[@"RQD"][1],
            fieldData = fieldData
        };
        ...
        {
            _requisitionLineNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_requisitionLineNumber, fieldData);
        }
...
internal HL7V27Field _itemCodeInternal;

public HL7V27Field ItemCodeInternal
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _itemCodeInternal = new HL7V27Field
        {
            field = message[@"RQD"][2],
            fieldData = fieldData
        };
        ...
        {
            _itemCodeInternal.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_itemCodeInternal, fieldData);
        }
...
internal HL7V27Field _itemCodeExternal;

public HL7V27Field ItemCodeExternal
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _itemCodeExternal = new HL7V27Field
        {
            field = message[@"RQD"][3],
            fieldData = fieldData
        };
        ...
        {
            _itemCodeExternal.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_itemCodeExternal, fieldData);
        }
...
internal HL7V27Field _hospitalItemCode;

public HL7V27Field HospitalItemCode
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _hospitalItemCode = new HL7V27Field
        {
            field = message[@"RQD"][4],
            fieldData = fieldData
        };
        ...
        {
            _hospitalItemCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_hospitalItemCode, fieldData);
        }
...
internal HL7V27Field _requisitionQuantity;

public HL7V27Field RequisitionQuantity
{
    get
    {
        ...
        _requisitionQuantity = new HL7V27Field
        {
            field = message[@"RQD"][5],
            fieldData = fieldData
        };
        ...
        {
            _requisitionQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_requisitionQuantity, fieldData);
        }
...
internal HL7V27Field _requisitionUnitOfMeasure;

public HL7V27Field RequisitionUnitOfMeasure
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _requisitionUnitOfMeasure = new HL7V27Field
        {
            field = message[@"RQD"][6],
            fieldData = fieldData
        };
        ...
        {
            _requisitionUnitOfMeasure.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_requisitionUnitOfMeasure, fieldData);
        }
...
internal HL7V27Field _deliverToId;

public HL7V27Field DeliverToId
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _deliverToId.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_deliverToId, fieldData);
        }
...
internal HL7V27Field _dateNeeded;

public HL7V27Field DateNeeded
{
    get
    {
        if (_dateNeeded != null)
...
Hospital accounting applications use RQD-7-Dept. Cost Center concatenated with RQD-8-Item Natural Account Code in order to post this transaction to the General Ledger. This concatenated value should correspond to a valid entry in the accounting applications ""Chart of Accounts.""",
        ...
        {
            _dateNeeded.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_dateNeeded, fieldData);
        }
