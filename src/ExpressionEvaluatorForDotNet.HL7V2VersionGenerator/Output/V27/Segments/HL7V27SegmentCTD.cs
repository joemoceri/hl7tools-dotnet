...
Value set version ID is required if CWE.21 is populated.",
        ...
        internal HL7V27Field contactRole;
...
public HL7V27Field ContactRole
{
    get
    {
        ...
        if (contactRole.field.FieldRepetitions != null && contactRole.field.FieldRepetitions.Count > 0)
        {
            ...
            contactRole.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(contactRole, fieldData);
        }
...
internal HL7V27Field contactName;
...
public HL7V27Field ContactName
{
    get
    {
        ...
        if (contactName.field.FieldRepetitions != null && contactName.field.FieldRepetitions.Count > 0)
        {
            ...
            contactName.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(contactName, fieldData);
        }
...
internal HL7V27Field contactLocation;
...
public HL7V27Field ContactLocation
{
    get
    {
        ...
        contactLocation = new HL7V27Field
        {
            field = message[@"CTD"][4],
            Id = @"CTD.4",
            Type = @"Field",
        ...
        if (contactLocation.field.FieldRepetitions != null && contactLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            contactLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(contactLocation, fieldData);
        }
...
internal HL7V27Field contactCommunicationInformation;
...
public HL7V27Field ContactCommunicationInformation
{
    get
    {
        ...
        contactCommunicationInformation = new HL7V27Field
        {
            field = message[@"CTD"][5],
            Id = @"CTD.5",
            Type = @"Field",
        ...
        if (contactCommunicationInformation.field.FieldRepetitions != null && contactCommunicationInformation.field.FieldRepetitions.Count > 0)
        {
            ...
            contactCommunicationInformation.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(contactCommunicationInformation, fieldData);
        }
...
internal HL7V27Field contactIdentifiers;
...
public HL7V27Field ContactIdentifiers
{
    get
    {
        ...
        contactIdentifiers = new HL7V27Field
        {
            field = message[@"CTD"][7],
            Id = @"CTD.7",
            Type = @"Field",
        ...
        if (contactIdentifiers.field.FieldRepetitions != null && contactIdentifiers.field.FieldRepetitions.Count > 0)
        {
            ...
            contactIdentifiers.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(contactIdentifiers, fieldData);
        }
