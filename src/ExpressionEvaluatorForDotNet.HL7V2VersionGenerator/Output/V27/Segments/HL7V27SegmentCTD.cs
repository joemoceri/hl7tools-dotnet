...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V27SegmentCTD
    {
        ...
        public HL7V27SegmentCTD(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V27Field _contactRole;

public HL7V27Field ContactRole
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _contactRole.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_contactRole, fieldData);
        }
...
internal HL7V27Field _contactName;

public HL7V27Field ContactName
{
    get
    {
...
Examples:
 ...
 - Mary Margaret Elizabeth Jones is Called By Meg.",
        ...
        {
            _contactName.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_contactName, fieldData);
        }
...
internal HL7V27Field _contactLocation;

public HL7V27Field ContactLocation
{
    get
    {
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _contactLocation = new HL7V27Field
        {
            field = message[@"CTD"][4],
            fieldData = fieldData
        };
        ...
        {
            _contactLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_contactLocation, fieldData);
        }
...
internal HL7V27Field _contactCommunicationInformation;

public HL7V27Field ContactCommunicationInformation
{
    get
    {
...
Preference order numbers need not be sequential (i.e., three numbers with the priority orders of 0, 5 and 15 are legitimate).  The preference order numbers must be non-negative.",
        ...
        _contactCommunicationInformation = new HL7V27Field
        {
            field = message[@"CTD"][5],
            fieldData = fieldData
        };
        ...
        {
            _contactCommunicationInformation.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_contactCommunicationInformation, fieldData);
        }
...
internal HL7V27Field _contactIdentifiers;

public HL7V27Field ContactIdentifiers
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _contactIdentifiers = new HL7V27Field
        {
            field = message[@"CTD"][7],
            fieldData = fieldData
        };
        ...
        {
            _contactIdentifiers.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_contactIdentifiers, fieldData);
        }
