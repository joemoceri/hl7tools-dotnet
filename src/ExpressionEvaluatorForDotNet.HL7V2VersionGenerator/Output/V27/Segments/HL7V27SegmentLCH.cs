...
When the LCH segment appears immediately following the LOC segment, it communicates characteristics which are the same across multiple departments that may use the same room.  When the LCH segment appears immediately following the LDP segment, it communicates characteristics which differ for different departments that may use the same room.  For example, the following characteristics are more likely to vary by which department is using the room: teaching, gender, staffed, set up, overflow, whereas the other characteristics are likely to remain the same."; } }
        ...
        internal HL7V27Field _primaryKeyValueLch;
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _primaryKeyValueLch = new HL7V27Field
        {
            field = message[@"LCH"][1],
            fieldData = fieldData
        };
        ...
        {
            _primaryKeyValueLch.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_primaryKeyValueLch, fieldData);
        }
...
internal HL7V27Field _segmentUniqueKey;
...
Refer to HL7 Table 0301 - Universal ID Type for valid values.",
        ...
        _segmentUniqueKey = new HL7V27Field
        {
            field = message[@"LCH"][3],
            fieldData = fieldData
        };
        ...
        {
            _segmentUniqueKey.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_segmentUniqueKey, fieldData);
        }
...
internal HL7V27Field _locationCharacteristicId;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _locationCharacteristicId = new HL7V27Field
        {
            field = message[@"LCH"][4],
            fieldData = fieldData
        };
        ...
        {
            _locationCharacteristicId.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_locationCharacteristicId, fieldData);
        }
...
internal HL7V27Field _locationCharacteristicValueLch;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _locationCharacteristicValueLch = new HL7V27Field
        {
            field = message[@"LCH"][5],
            fieldData = fieldData
        };
        ...
        {
            _locationCharacteristicValueLch.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_locationCharacteristicValueLch, fieldData);
        }
