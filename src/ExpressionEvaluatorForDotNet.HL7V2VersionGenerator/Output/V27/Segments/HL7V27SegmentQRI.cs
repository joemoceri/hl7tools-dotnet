...
Examples of the use of this segment appear in Chapter 3, ""Patient Administration,"" section 3.3.57, ""Find Candidates and Response."""; } }
        ...
        internal HL7V27Field _candidateConfidence;
...
One use of this optional field is in Patient Look-up transactions where the searching system employs a numeric algorithm for determining potential matches to patient/person look-ups.",
        ...
        _candidateConfidence = new HL7V27Field
        {
            field = message[@"QRI"][1],
            fieldData = fieldData
        };
        ...
        {
            _candidateConfidence.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_candidateConfidence, fieldData);
        }
...
internal HL7V27Field _matchReasonCode;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _matchReasonCode = new HL7V27Field
        {
            field = message[@"QRI"][2],
            fieldData = fieldData
        };
        ...
        {
            _matchReasonCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_matchReasonCode, fieldData);
        }
...
internal HL7V27Field _algorithmDescriptor;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _algorithmDescriptor = new HL7V27Field
        {
            field = message[@"QRI"][3],
            fieldData = fieldData
        };
        ...
        {
            _algorithmDescriptor.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_algorithmDescriptor, fieldData);
        }
