...
internal HL7V27Field userParameters(inSuccessiveFields);

public HL7V27Field UserParameters(inSuccessiveFields)
{
    get
    {
        ...
        userParameters(inSuccessiveFields) = new HL7V27Field
        {
            field = message[@"QPD"][3],
            Id = @"QPD.3",
            Type = @"Field",
