...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V27SegmentQPD
    {
        ...
        public HL7V27SegmentQPD(HL7V2Message message)
        {
...
internal HL7V27Field _userParametersinSuccessiveFields;

public HL7V27Field UserParametersinSuccessiveFields
{
    get
    {
...
Parameter fields in the QPD segment appear in the same order as in the Query Profile.",
        ...
        _userParametersinSuccessiveFields = new HL7V27Field
        {
            field = message[@"QPD"][3],
            fieldData = fieldData
        };
        ...
        {
            _userParametersinSuccessiveFields.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_userParametersinSuccessiveFields, fieldData);
        }
