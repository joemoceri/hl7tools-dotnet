...
402^Electrolytes~352^Urinalysis~432^CBC~520^SMA12",
        ...
        if (testObservationsIncludedWithinAnOrderedTestBattery.field.FieldRepetitions != null && testObservationsIncludedWithinAnOrderedTestBattery.field.FieldRepetitions.Count > 0)
        {
            ...
            testObservationsIncludedWithinAnOrderedTestBattery.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(testObservationsIncludedWithinAnOrderedTestBattery, fieldData);
        }
...
public HL7V27Field ObservationIdSuffixes
{
    get
    {
        ...
        if (observationIdSuffixes.field.FieldRepetitions != null && observationIdSuffixes.field.FieldRepetitions.Count > 0)
        {
            ...
            observationIdSuffixes.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(observationIdSuffixes, fieldData);
        }
