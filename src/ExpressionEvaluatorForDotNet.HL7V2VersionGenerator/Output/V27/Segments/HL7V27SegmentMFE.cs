...
public HL7V27Field RecordlevelEventCode
{
    get
    {
        ...
        if (recordlevelEventCode.field.FieldRepetitions != null && recordlevelEventCode.field.FieldRepetitions.Count > 0)
        {
            ...
            recordlevelEventCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(recordlevelEventCode, fieldData);
        }
...
public HL7V27Field MfnControlId
{
    get
    {
        ...
        if (mfnControlId.field.FieldRepetitions != null && mfnControlId.field.FieldRepetitions.Count > 0)
        {
            ...
            mfnControlId.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(mfnControlId, fieldData);
        }
...
internal HL7V27Field effectiveDateTime;
...
public HL7V27Field EffectiveDateTime
{
    get
    {
        ...
        effectiveDateTime = new HL7V27Field
        {
            field = message[@"MFE"][3],
            Id = @"MFE.3",
            Type = @"Field",
        ...
        if (effectiveDateTime.field.FieldRepetitions != null && effectiveDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            effectiveDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(effectiveDateTime, fieldData);
        }
...
internal HL7V27Field primaryKeyValueMfe;
...
public HL7V27Field PrimaryKeyValueMfe
{
    get
    {
        ...
        primaryKeyValueMfe = new HL7V27Field
        {
            field = message[@"MFE"][4],
            Id = @"MFE.4",
            Type = @"Field",
        ...
        if (primaryKeyValueMfe.field.FieldRepetitions != null && primaryKeyValueMfe.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValueMfe.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(primaryKeyValueMfe, fieldData);
        }
...
internal HL7V27Field primaryKeyValueType;
...
public HL7V27Field PrimaryKeyValueType
{
    get
    {
        ...
        primaryKeyValueType = new HL7V27Field
        {
            field = message[@"MFE"][5],
            Id = @"MFE.5",
            Type = @"Field",
        ...
        if (primaryKeyValueType.field.FieldRepetitions != null && primaryKeyValueType.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValueType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(primaryKeyValueType, fieldData);
        }
