...
public HL7V27Field SetIdBpo
{
    get
    {
        ...
        if (setIdBpo.field.FieldRepetitions != null && setIdBpo.field.FieldRepetitions.Count > 0)
        {
            ...
            setIdBpo.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(setIdBpo, fieldData);
        }
...
Blood Product Orders for commercial products, such as Rh Immune Globulin or Factor VIII concentrate, are not at this time defined in an international or national coding system as are blood products. Therefore, locally defined codes can be used for the Universal Service Identifier for commercial products.",
        ...
        if (bpUniversalServiceIdentifier.field.FieldRepetitions != null && bpUniversalServiceIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            bpUniversalServiceIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(bpUniversalServiceIdentifier, fieldData);
        }
...
public HL7V27Field BpProcessingRequirements
{
    get
    {
        ...
        if (bpProcessingRequirements.field.FieldRepetitions != null && bpProcessingRequirements.field.FieldRepetitions.Count > 0)
        {
            ...
            bpProcessingRequirements.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(bpProcessingRequirements, fieldData);
        }
...
This is the time when the placer expects the product to be available within the transfusion service. For example, the product should be available for use, but not dispensed, on this date/time.",
        ...
        if (bpIntendedUseDateTime.field.FieldRepetitions != null && bpIntendedUseDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            bpIntendedUseDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(bpIntendedUseDateTime, fieldData);
        }
...
public HL7V27Field BpIntendedDispenseFromLocation
{
    get
    {
        ...
        if (bpIntendedDispenseFromLocation.field.FieldRepetitions != null && bpIntendedDispenseFromLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            bpIntendedDispenseFromLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(bpIntendedDispenseFromLocation, fieldData);
        }
...
public HL7V27Field BpIntendedDispenseFromAddress
{
    get
    {
        ...
        if (bpIntendedDispenseFromAddress.field.FieldRepetitions != null && bpIntendedDispenseFromAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            bpIntendedDispenseFromAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(bpIntendedDispenseFromAddress, fieldData);
        }
...
public HL7V27Field BpRequestedDispenseDateTime
{
    get
    {
        ...
        if (bpRequestedDispenseDateTime.field.FieldRepetitions != null && bpRequestedDispenseDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            bpRequestedDispenseDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(bpRequestedDispenseDateTime, fieldData);
        }
...
public HL7V27Field BpRequestedDispenseToLocation
{
    get
    {
        ...
        if (bpRequestedDispenseToLocation.field.FieldRepetitions != null && bpRequestedDispenseToLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            bpRequestedDispenseToLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(bpRequestedDispenseToLocation, fieldData);
        }
...
public HL7V27Field BpRequestedDispenseToAddress
{
    get
    {
        ...
        if (bpRequestedDispenseToAddress.field.FieldRepetitions != null && bpRequestedDispenseToAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            bpRequestedDispenseToAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(bpRequestedDispenseToAddress, fieldData);
        }
...
public HL7V27Field BpIndicationForUse
{
    get
    {
        ...
        if (bpIndicationForUse.field.FieldRepetitions != null && bpIndicationForUse.field.FieldRepetitions.Count > 0)
        {
            ...
            bpIndicationForUse.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(bpIndicationForUse, fieldData);
        }
...
public HL7V27Field BpInformedConsentIndicator
{
    get
    {
        ...
        if (bpInformedConsentIndicator.field.FieldRepetitions != null && bpInformedConsentIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            bpInformedConsentIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(bpInformedConsentIndicator, fieldData);
        }
