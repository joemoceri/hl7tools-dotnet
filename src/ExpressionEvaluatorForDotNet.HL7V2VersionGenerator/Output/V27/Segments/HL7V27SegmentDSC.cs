...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V27SegmentDSC
    {
        ...
        public HL7V27SegmentDSC(HL7V2Message message)
        {
...
internal HL7V27Field _continuationStyle;

public HL7V27Field ContinuationStyle
{
    get
    {
        ...
        _continuationStyle = new HL7V27Field
        {
            field = message[@"DSC"][2],
            fieldData = fieldData
        };
        ...
        {
            _continuationStyle.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_continuationStyle, fieldData);
        }
