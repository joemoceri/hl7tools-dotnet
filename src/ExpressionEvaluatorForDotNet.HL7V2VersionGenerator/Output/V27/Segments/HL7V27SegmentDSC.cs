...
internal HL7V27Field continuationStyle;
...
public HL7V27Field ContinuationStyle
{
    get
    {
        ...
        continuationStyle = new HL7V27Field
        {
            field = message[@"DSC"][2],
            Id = @"DSC.2",
            Type = @"Field",
        ...
        if (continuationStyle.field.FieldRepetitions != null && continuationStyle.field.FieldRepetitions.Count > 0)
        {
            ...
            continuationStyle.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(continuationStyle, fieldData);
        }
