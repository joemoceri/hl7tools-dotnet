...
public HL7V27Field DeviceDataState
{
    get
    {
        ...
        if (deviceDataState.field.FieldRepetitions != null && deviceDataState.field.FieldRepetitions.Count > 0)
        {
            ...
            deviceDataState.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(deviceDataState, fieldData);
        }
...
public HL7V27Field LoadStatus
{
    get
    {
        ...
        if (loadStatus.field.FieldRepetitions != null && loadStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            loadStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(loadStatus, fieldData);
        }
...
public HL7V27Field ControlCode
{
    get
    {
        ...
        if (controlCode.field.FieldRepetitions != null && controlCode.field.FieldRepetitions.Count > 0)
        {
            ...
            controlCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(controlCode, fieldData);
        }
...
public HL7V27Field OperatorName
{
    get
    {
        ...
        if (operatorName.field.FieldRepetitions != null && operatorName.field.FieldRepetitions.Count > 0)
        {
            ...
            operatorName.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(operatorName, fieldData);
        }
