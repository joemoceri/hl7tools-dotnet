...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V27SegmentEQP
    {
        ...
        public HL7V27SegmentEQP(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V27Field _eventType;

public HL7V27Field EventType
{
    get
    {
        if (_eventType != null)
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _eventType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_eventType, fieldData);
        }
...
internal HL7V27Field _fileName;

public HL7V27Field FileName
{
    get
    {
        if (_fileName != null)
        ...
        {
            _fileName.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_fileName, fieldData);
        }
...
internal HL7V27Field _transactionData;

public HL7V27Field TransactionData
{
    get
    {
        ...
        _transactionData = new HL7V27Field
        {
            field = message[@"EQP"][5],
            fieldData = fieldData
        };
        ...
        {
            _transactionData.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_transactionData, fieldData);
        }
