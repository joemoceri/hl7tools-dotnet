...
Value set version ID is required if CWE.21 is populated.",
        ...
        internal HL7V27Field eventType;
...
public HL7V27Field EventType
{
    get
    {
        ...
        if (eventType.field.FieldRepetitions != null && eventType.field.FieldRepetitions.Count > 0)
        {
            ...
            eventType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(eventType, fieldData);
        }
...
public HL7V27Field FileName
{
    get
    {
        ...
        if (fileName.field.FieldRepetitions != null && fileName.field.FieldRepetitions.Count > 0)
        {
            ...
            fileName.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(fileName, fieldData);
        }
...
internal HL7V27Field transactionData;
...
public HL7V27Field TransactionData
{
    get
    {
        ...
        transactionData = new HL7V27Field
        {
            field = message[@"EQP"][5],
            Id = @"EQP.5",
            Type = @"Field",
        ...
        if (transactionData.field.FieldRepetitions != null && transactionData.field.FieldRepetitions.Count > 0)
        {
            ...
            transactionData.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(transactionData, fieldData);
        }
