...
Refer to HL7 Table 0301 - Universal ID Type for valid values.",
        ...
        internal HL7V27Field giveSubidCounter;
...
public HL7V27Field GiveSubidCounter
{
    get
    {
        ...
        giveSubidCounter = new HL7V27Field
        {
            field = message[@"RXA"][1],
            Id = @"RXA.1",
            Type = @"Field",
        ...
        if (giveSubidCounter.field.FieldRepetitions != null && giveSubidCounter.field.FieldRepetitions.Count > 0)
        {
            ...
            giveSubidCounter.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(giveSubidCounter, fieldData);
        }
...
internal HL7V27Field administrationSubidCounter;
...
public HL7V27Field AdministrationSubidCounter
{
    get
    {
        ...
        administrationSubidCounter = new HL7V27Field
        {
            field = message[@"RXA"][2],
            Id = @"RXA.2",
            Type = @"Field",
...
Note: More than one RXA segment can be ""matched"" to a single RXG segment, as is the case when recording a change of the rate of administration of an IV solution.",
        ...
        if (administrationSubidCounter.field.FieldRepetitions != null && administrationSubidCounter.field.FieldRepetitions.Count > 0)
        {
            ...
            administrationSubidCounter.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(administrationSubidCounter, fieldData);
        }
...
internal HL7V27Field dateTimeStartOfAdministration;
...
public HL7V27Field DateTimeStartOfAdministration
{
    get
    {
        ...
        dateTimeStartOfAdministration = new HL7V27Field
        {
            field = message[@"RXA"][3],
            Id = @"RXA.3",
            Type = @"Field",
        ...
        if (dateTimeStartOfAdministration.field.FieldRepetitions != null && dateTimeStartOfAdministration.field.FieldRepetitions.Count > 0)
        {
            ...
            dateTimeStartOfAdministration.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(dateTimeStartOfAdministration, fieldData);
        }
...
internal HL7V27Field dateTimeEndOfAdministration;
...
public HL7V27Field DateTimeEndOfAdministration
{
    get
    {
        ...
        dateTimeEndOfAdministration = new HL7V27Field
        {
            field = message[@"RXA"][4],
            Id = @"RXA.4",
            Type = @"Field",
        ...
        if (dateTimeEndOfAdministration.field.FieldRepetitions != null && dateTimeEndOfAdministration.field.FieldRepetitions.Count > 0)
        {
            ...
            dateTimeEndOfAdministration.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(dateTimeEndOfAdministration, fieldData);
        }
...
internal HL7V27Field administeredCode;
...
public HL7V27Field AdministeredCode
{
    get
    {
        ...
        administeredCode = new HL7V27Field
        {
            field = message[@"RXA"][5],
            Id = @"RXA.5",
            Type = @"Field",
...
Fpr vaccines use in RXA-5- administered code to identify the particular vaccine administered. The codes listed are used by immunization by immunization registries in the U.S. Entries will be added as needed to accommodate international requirements. Refer to chapter 2C Imported Table 0292 – Vaccines administered for valid values. If CVX code is used to identify vaccines, the coding system component (RXA-5.3) should be valued as ""CVX"", not as ""HL70292.""",
        ...
        if (administeredCode.field.FieldRepetitions != null && administeredCode.field.FieldRepetitions.Count > 0)
        {
            ...
            administeredCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(administeredCode, fieldData);
        }
...
internal HL7V27Field administeredAmount;
...
public HL7V27Field AdministeredAmount
{
    get
    {
        ...
        administeredAmount = new HL7V27Field
        {
            field = message[@"RXA"][6],
            Id = @"RXA.6",
            Type = @"Field",
        ...
        if (administeredAmount.field.FieldRepetitions != null && administeredAmount.field.FieldRepetitions.Count > 0)
        {
            ...
            administeredAmount.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(administeredAmount, fieldData);
        }
...
internal HL7V27Field administeredUnits;
...
public HL7V27Field AdministeredUnits
{
    get
    {
        ...
        administeredUnits = new HL7V27Field
        {
            field = message[@"RXA"][7],
            Id = @"RXA.7",
            Type = @"Field",
        ...
        if (administeredUnits.field.FieldRepetitions != null && administeredUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            administeredUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(administeredUnits, fieldData);
        }
...
internal HL7V27Field administeredDosageForm;
...
public HL7V27Field AdministeredDosageForm
{
    get
    {
        ...
        administeredDosageForm = new HL7V27Field
        {
            field = message[@"RXA"][8],
            Id = @"RXA.8",
            Type = @"Field",
        ...
        if (administeredDosageForm.field.FieldRepetitions != null && administeredDosageForm.field.FieldRepetitions.Count > 0)
        {
            ...
            administeredDosageForm.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(administeredDosageForm, fieldData);
        }
...
internal HL7V27Field administrationNotes;
...
public HL7V27Field AdministrationNotes
{
    get
    {
        ...
        administrationNotes = new HL7V27Field
        {
            field = message[@"RXA"][9],
            Id = @"RXA.9",
            Type = @"Field",
        ...
        if (administrationNotes.field.FieldRepetitions != null && administrationNotes.field.FieldRepetitions.Count > 0)
        {
            ...
            administrationNotes.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(administrationNotes, fieldData);
        }
...
internal HL7V27Field administeringProvider;
...
public HL7V27Field AdministeringProvider
{
    get
    {
        ...
        administeringProvider = new HL7V27Field
        {
...
This field contains the provider ID of the person administering the pharmaceutical/treatment. If the person referenced in this field is also referenced in PRT segment, they must contain the same information.  However, if there is a difference, then PRT segment takes precedence.",
        ...
        if (administeringProvider.field.FieldRepetitions != null && administeringProvider.field.FieldRepetitions.Count > 0)
        {
            ...
            administeringProvider.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(administeringProvider, fieldData);
        }
...
internal HL7V27Field administeredatLocation;
...
public HL7V27Field AdministeredatLocation
{
    get
    {
        ...
        administeredatLocation = new HL7V27Field
        {
        ...
        if (administeredatLocation.field.FieldRepetitions != null && administeredatLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            administeredatLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(administeredatLocation, fieldData);
        }
...
internal HL7V27Field administeredPertimeUnit;
...
public HL7V27Field AdministeredPertimeUnit
{
    get
    {
        ...
        administeredPertimeUnit = new HL7V27Field
        {
        ...
        if (administeredPertimeUnit.field.FieldRepetitions != null && administeredPertimeUnit.field.FieldRepetitions.Count > 0)
        {
            ...
            administeredPertimeUnit.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(administeredPertimeUnit, fieldData);
        }
...
internal HL7V27Field administeredStrength;
...
public HL7V27Field AdministeredStrength
{
    get
    {
        ...
        administeredStrength = new HL7V27Field
        {
        ...
        if (administeredStrength.field.FieldRepetitions != null && administeredStrength.field.FieldRepetitions.Count > 0)
        {
            ...
            administeredStrength.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(administeredStrength, fieldData);
        }
...
internal HL7V27Field administeredStrengthUnits;
...
public HL7V27Field AdministeredStrengthUnits
{
    get
    {
        ...
        administeredStrengthUnits = new HL7V27Field
        {
...
Note: These units can be a ""compound quantity;"" i.e., the units may express a quantity per unit of time. For example, micrograms per hour (micg/h) is an acceptable value. These compound units are contained in the ISO+ table. See Chapter 7 for full definition of ISO+ units.",
        ...
        if (administeredStrengthUnits.field.FieldRepetitions != null && administeredStrengthUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            administeredStrengthUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(administeredStrengthUnits, fieldData);
        }
...
internal HL7V27Field substanceTreatmentRefusalReason;
...
public HL7V27Field SubstanceTreatmentRefusalReason
{
    get
    {
        ...
        substanceTreatmentRefusalReason = new HL7V27Field
        {
        ...
        if (substanceTreatmentRefusalReason.field.FieldRepetitions != null && substanceTreatmentRefusalReason.field.FieldRepetitions.Count > 0)
        {
            ...
            substanceTreatmentRefusalReason.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(substanceTreatmentRefusalReason, fieldData);
        }
...
internal HL7V27Field completionStatus;
...
public HL7V27Field CompletionStatus
{
    get
    {
        ...
        completionStatus = new HL7V27Field
        {
        ...
        if (completionStatus.field.FieldRepetitions != null && completionStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            completionStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(completionStatus, fieldData);
        }
...
internal HL7V27Field actionCodeRxa;
...
public HL7V27Field ActionCodeRxa
{
    get
    {
        ...
        if (actionCodeRxa.field.FieldRepetitions != null && actionCodeRxa.field.FieldRepetitions.Count > 0)
        {
            ...
            actionCodeRxa.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(actionCodeRxa, fieldData);
        }
...
internal HL7V27Field systemEntryDateTime;
...
public HL7V27Field SystemEntryDateTime
{
    get
    {
        ...
        systemEntryDateTime = new HL7V27Field
        {
        ...
        if (systemEntryDateTime.field.FieldRepetitions != null && systemEntryDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            systemEntryDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(systemEntryDateTime, fieldData);
        }
...
internal HL7V27Field administeredDrugStrengthVolume;
...
public HL7V27Field AdministeredDrugStrengthVolume
{
    get
    {
        ...
        administeredDrugStrengthVolume = new HL7V27Field
        {
...
RXA|||||||||||||120|mg^^ISO|||||||||5|ml^^ISO ...<cr>",
        ...
        if (administeredDrugStrengthVolume.field.FieldRepetitions != null && administeredDrugStrengthVolume.field.FieldRepetitions.Count > 0)
        {
            ...
            administeredDrugStrengthVolume.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(administeredDrugStrengthVolume, fieldData);
        }
...
internal HL7V27Field administeredDrugStrengthVolumeUnits;
...
public HL7V27Field AdministeredDrugStrengthVolumeUnits
{
    get
    {
        ...
        administeredDrugStrengthVolumeUnits = new HL7V27Field
        {
        ...
        if (administeredDrugStrengthVolumeUnits.field.FieldRepetitions != null && administeredDrugStrengthVolumeUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            administeredDrugStrengthVolumeUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(administeredDrugStrengthVolumeUnits, fieldData);
        }
...
internal HL7V27Field administeredBarcodeIdentifier;
...
public HL7V27Field AdministeredBarcodeIdentifier
{
    get
    {
        ...
        administeredBarcodeIdentifier = new HL7V27Field
        {
...
Example: 12345678901^IV bottle^3X9",
        ...
        if (administeredBarcodeIdentifier.field.FieldRepetitions != null && administeredBarcodeIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            administeredBarcodeIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(administeredBarcodeIdentifier, fieldData);
        }
...
internal HL7V27Field administerat;
...
public HL7V27Field Administerat
{
    get
    {
        ...
        if (administerat.field.FieldRepetitions != null && administerat.field.FieldRepetitions.Count > 0)
        {
            ...
            administerat.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(administerat, fieldData);
        }
...
internal HL7V27Field administeredatAddress;
...
public HL7V27Field AdministeredatAddress
{
    get
    {
        ...
        administeredatAddress = new HL7V27Field
        {
        ...
        if (administeredatAddress.field.FieldRepetitions != null && administeredatAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            administeredatAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(administeredatAddress, fieldData);
        }
