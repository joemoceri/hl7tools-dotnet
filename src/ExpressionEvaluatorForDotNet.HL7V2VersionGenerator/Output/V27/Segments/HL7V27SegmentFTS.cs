...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V27SegmentFTS
    {
        ...
        public HL7V27SegmentFTS(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V27Field _fileBatchCount;

public HL7V27Field FileBatchCount
{
    get
    {
        ...
        _fileBatchCount = new HL7V27Field
        {
            field = message[@"FTS"][1],
            fieldData = fieldData
        };
        ...
        {
            _fileBatchCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_fileBatchCount, fieldData);
        }
...
internal HL7V27Field _fileTrailerComment;

public HL7V27Field FileTrailerComment
{
    get
    {
        ...
        _fileTrailerComment = new HL7V27Field
        {
            field = message[@"FTS"][2],
            fieldData = fieldData
        };
        ...
        {
            _fileTrailerComment.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_fileTrailerComment, fieldData);
        }
