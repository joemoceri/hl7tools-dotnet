...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V27SegmentADD
    {
        ...
        internal HL7V27Field addendumContinuationPointer;
...
public HL7V27Field AddendumContinuationPointer
{
    get
    {
        ...
        addendumContinuationPointer = new HL7V27Field
        {
            field = message[@"ADD"][1],
            Id = @"ADD.1",
            Type = @"Field",
        ...
        if (addendumContinuationPointer.field.FieldRepetitions != null && addendumContinuationPointer.field.FieldRepetitions.Count > 0)
        {
            ...
            addendumContinuationPointer.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(addendumContinuationPointer, fieldData);
        }
