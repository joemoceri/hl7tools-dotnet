...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V27SegmentADD
    {
        ...
        public HL7V27SegmentADD(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V27Field _addendumContinuationPointer;

public HL7V27Field AddendumContinuationPointer
{
    get
    {
        ...
        _addendumContinuationPointer = new HL7V27Field
        {
            field = message[@"ADD"][1],
            fieldData = fieldData
        };
        ...
        {
            _addendumContinuationPointer.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_addendumContinuationPointer, fieldData);
        }
