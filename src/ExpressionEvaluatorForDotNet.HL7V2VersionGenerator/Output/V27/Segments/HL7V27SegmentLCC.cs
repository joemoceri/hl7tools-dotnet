...
public HL7V27Field PrimaryKeyValueLcc
{
    get
    {
        ...
        if (primaryKeyValueLcc.field.FieldRepetitions != null && primaryKeyValueLcc.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValueLcc.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(primaryKeyValueLcc, fieldData);
        }
...
public HL7V27Field AccommodationType
{
    get
    {
        ...
        if (accommodationType.field.FieldRepetitions != null && accommodationType.field.FieldRepetitions.Count > 0)
        {
            ...
            accommodationType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(accommodationType, fieldData);
        }
...
public HL7V27Field ChargeCode
{
    get
    {
        ...
        if (chargeCode.field.FieldRepetitions != null && chargeCode.field.FieldRepetitions.Count > 0)
        {
            ...
            chargeCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(chargeCode, fieldData);
        }
