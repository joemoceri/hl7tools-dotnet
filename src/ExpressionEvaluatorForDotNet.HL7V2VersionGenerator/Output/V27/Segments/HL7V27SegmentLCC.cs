...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V27SegmentLCC
    {
        ...
        internal HL7V27Field _primaryKeyValueLcc;
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _primaryKeyValueLcc = new HL7V27Field
        {
            field = message[@"LCC"][1],
            fieldData = fieldData
        };
        ...
        {
            _primaryKeyValueLcc.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_primaryKeyValueLcc, fieldData);
        }
...
internal HL7V27Field _accommodationType;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _accommodationType = new HL7V27Field
        {
            field = message[@"LCC"][3],
            fieldData = fieldData
        };
        ...
        {
            _accommodationType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_accommodationType, fieldData);
        }
...
internal HL7V27Field _chargeCode;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _chargeCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_chargeCode, fieldData);
        }
