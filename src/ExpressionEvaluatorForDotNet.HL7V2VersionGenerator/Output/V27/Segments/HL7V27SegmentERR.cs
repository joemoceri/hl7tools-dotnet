...
Support for multiple Error Locations: Two fields are marked as conditional, with the condition that one of the two must be specified. The sending application leaves both blank. The receiving application detects the problem, and sends back a single error indicating that one of the fields must be filled in. The ERR segment identifies both positions within the message that relate to the error."; } }
        ...
        internal HL7V27Field _errorCodeAndLocation;
...
public HL7V27Field ErrorCodeAndLocation
{
    get
    {
        ...
        _errorCodeAndLocation = new HL7V27Field
        {
            field = message[@"ERR"][1],
            fieldData = fieldData
        };
        ...
        {
            _errorCodeAndLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_errorCodeAndLocation, fieldData);
        }
...
internal HL7V27Field _errorLocation;
...
public HL7V27Field ErrorLocation
{
    get
    {
        ...
        _errorLocation = new HL7V27Field
        {
            field = message[@"ERR"][2],
            fieldData = fieldData
        };
        ...
        {
            _errorLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_errorLocation, fieldData);
        }
...
internal HL7V27Field _hl7ErrorCode;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _hl7ErrorCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_hl7ErrorCode, fieldData);
        }
...
internal HL7V27Field _severity;
...
Example of Information: When submitting a claim, a payor might indicate remaining coverage under limit.",
        ...
        {
            _severity.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_severity, fieldData);
        }
...
internal HL7V27Field _applicationErrorCode;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _applicationErrorCode = new HL7V27Field
        {
            field = message[@"ERR"][5],
            fieldData = fieldData
        };
        ...
        {
            _applicationErrorCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_applicationErrorCode, fieldData);
        }
...
internal HL7V27Field _applicationErrorParameter;
...
Example: If the application error code specified in ERR.5 corresponded with the English message ""The patient has a remaining deductible of {0, number, currency} for the period ending {1, date, medium}."", and the first two repetitions of ERR.6 were ""250"" and ""20021231"", then a receiving application in the U.S. would display the message as ""The patient has a remaining deductible of $250.00 for the period ending Dec 31, 2002.""",
        ...
        _applicationErrorParameter = new HL7V27Field
        {
            field = message[@"ERR"][6],
            fieldData = fieldData
        };
        ...
        {
            _applicationErrorParameter.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_applicationErrorParameter, fieldData);
        }
...
internal HL7V27Field _diagnosticInformation;
...
public HL7V27Field DiagnosticInformation
{
    get
    {
        ...
        _diagnosticInformation = new HL7V27Field
        {
            field = message[@"ERR"][7],
            fieldData = fieldData
        };
        ...
        {
            _diagnosticInformation.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_diagnosticInformation, fieldData);
        }
...
internal HL7V27Field _userMessage;
...
This differs from the actual error code and may provide more diagnostic information.",
        ...
        {
            _userMessage.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_userMessage, fieldData);
        }
...
internal HL7V27Field _informPersonIndicator;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _informPersonIndicator = new HL7V27Field
        {
            field = message[@"ERR"][9],
            fieldData = fieldData
        };
        ...
        {
            _informPersonIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_informPersonIndicator, fieldData);
        }
...
internal HL7V27Field _overrideType;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _overrideType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_overrideType, fieldData);
        }
...
internal HL7V27Field _overrideReasonCode;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _overrideReasonCode = new HL7V27Field
        {
        ...
        {
            _overrideReasonCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_overrideReasonCode, fieldData);
        }
...
internal HL7V27Field _helpDeskContactPoint;
...
Preference order numbers need not be sequential (i.e., three numbers with the priority orders of 0, 5 and 15 are legitimate).  The preference order numbers must be non-negative.",
        ...
        _helpDeskContactPoint = new HL7V27Field
        {
        ...
        {
            _helpDeskContactPoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_helpDeskContactPoint, fieldData);
        }
