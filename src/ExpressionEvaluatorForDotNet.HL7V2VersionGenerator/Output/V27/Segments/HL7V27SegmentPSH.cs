...
public HL7V27Field ReportType
{
    get
    {
        ...
        if (reportType.field.FieldRepetitions != null && reportType.field.FieldRepetitions.Count > 0)
        {
            ...
            reportType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(reportType, fieldData);
        }
...
public HL7V27Field ReportFormIdentifier
{
    get
    {
        ...
        if (reportFormIdentifier.field.FieldRepetitions != null && reportFormIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            reportFormIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(reportFormIdentifier, fieldData);
        }
...
public HL7V27Field ReportDate
{
    get
    {
        ...
        if (reportDate.field.FieldRepetitions != null && reportDate.field.FieldRepetitions.Count > 0)
        {
            ...
            reportDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(reportDate, fieldData);
        }
...
public HL7V27Field ReportIntervalStartDate
{
    get
    {
        ...
        if (reportIntervalStartDate.field.FieldRepetitions != null && reportIntervalStartDate.field.FieldRepetitions.Count > 0)
        {
            ...
            reportIntervalStartDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(reportIntervalStartDate, fieldData);
        }
...
public HL7V27Field ReportIntervalEndDate
{
    get
    {
        ...
        if (reportIntervalEndDate.field.FieldRepetitions != null && reportIntervalEndDate.field.FieldRepetitions.Count > 0)
        {
            ...
            reportIntervalEndDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(reportIntervalEndDate, fieldData);
        }
...
public HL7V27Field QuantityManufactured
{
    get
    {
        ...
        if (quantityManufactured.field.FieldRepetitions != null && quantityManufactured.field.FieldRepetitions.Count > 0)
        {
            ...
            quantityManufactured.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(quantityManufactured, fieldData);
        }
...
public HL7V27Field QuantityDistributed
{
    get
    {
        ...
        if (quantityDistributed.field.FieldRepetitions != null && quantityDistributed.field.FieldRepetitions.Count > 0)
        {
            ...
            quantityDistributed.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(quantityDistributed, fieldData);
        }
...
public HL7V27Field QuantityDistributedMethod
{
    get
    {
        ...
        if (quantityDistributedMethod.field.FieldRepetitions != null && quantityDistributedMethod.field.FieldRepetitions.Count > 0)
        {
            ...
            quantityDistributedMethod.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(quantityDistributedMethod, fieldData);
        }
...
public HL7V27Field QuantityDistributedComment
{
    get
    {
        ...
        if (quantityDistributedComment.field.FieldRepetitions != null && quantityDistributedComment.field.FieldRepetitions.Count > 0)
        {
            ...
            quantityDistributedComment.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(quantityDistributedComment, fieldData);
        }
...
public HL7V27Field QuantityInUse
{
    get
    {
        ...
        if (quantityInUse.field.FieldRepetitions != null && quantityInUse.field.FieldRepetitions.Count > 0)
        {
            ...
            quantityInUse.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(quantityInUse, fieldData);
        }
...
public HL7V27Field QuantityInUseMethod
{
    get
    {
        ...
        if (quantityInUseMethod.field.FieldRepetitions != null && quantityInUseMethod.field.FieldRepetitions.Count > 0)
        {
            ...
            quantityInUseMethod.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(quantityInUseMethod, fieldData);
        }
...
public HL7V27Field QuantityInUseComment
{
    get
    {
        ...
        if (quantityInUseComment.field.FieldRepetitions != null && quantityInUseComment.field.FieldRepetitions.Count > 0)
        {
            ...
            quantityInUseComment.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(quantityInUseComment, fieldData);
        }
...
public HL7V27Field NumberOfProductExperienceReportsFiledByFacility
{
    get
    {
        ...
        if (numberOfProductExperienceReportsFiledByFacility.field.FieldRepetitions != null && numberOfProductExperienceReportsFiledByFacility.field.FieldRepetitions.Count > 0)
        {
            ...
            numberOfProductExperienceReportsFiledByFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(numberOfProductExperienceReportsFiledByFacility, fieldData);
        }
...
public HL7V27Field NumberOfProductExperienceReportsFiledByDistributor
{
    get
    {
        ...
        if (numberOfProductExperienceReportsFiledByDistributor.field.FieldRepetitions != null && numberOfProductExperienceReportsFiledByDistributor.field.FieldRepetitions.Count > 0)
        {
            ...
            numberOfProductExperienceReportsFiledByDistributor.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(numberOfProductExperienceReportsFiledByDistributor, fieldData);
        }
