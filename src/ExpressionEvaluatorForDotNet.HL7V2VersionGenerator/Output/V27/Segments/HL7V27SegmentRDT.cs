...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V27SegmentRDT
    {
        ...
        internal HL7V27Field _columnValue;
...
public HL7V27Field ColumnValue
{
    get
    {
        ...
        {
            _columnValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_columnValue, fieldData);
        }
