...
public HL7V27Field SetIdrel
{
    get
    {
        ...
        if (setIdrel.field.FieldRepetitions != null && setIdrel.field.FieldRepetitions.Count > 0)
        {
            ...
            setIdrel.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(setIdrel, fieldData);
        }
...
public HL7V27Field RelationshipType
{
    get
    {
        ...
        if (relationshipType.field.FieldRepetitions != null && relationshipType.field.FieldRepetitions.Count > 0)
        {
            ...
            relationshipType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(relationshipType, fieldData);
        }
...
public HL7V27Field ThisRelationshipInstanceIdentifier
{
    get
    {
        ...
        if (thisRelationshipInstanceIdentifier.field.FieldRepetitions != null && thisRelationshipInstanceIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            thisRelationshipInstanceIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(thisRelationshipInstanceIdentifier, fieldData);
        }
...
public HL7V27Field SourceInformationInstanceIdentifier
{
    get
    {
        ...
        if (sourceInformationInstanceIdentifier.field.FieldRepetitions != null && sourceInformationInstanceIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            sourceInformationInstanceIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(sourceInformationInstanceIdentifier, fieldData);
        }
...
public HL7V27Field TargetInformationInstanceIdentifier
{
    get
    {
        ...
        if (targetInformationInstanceIdentifier.field.FieldRepetitions != null && targetInformationInstanceIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            targetInformationInstanceIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(targetInformationInstanceIdentifier, fieldData);
        }
...
public HL7V27Field AssertingEntityInstanceId
{
    get
    {
        ...
        if (assertingEntityInstanceId.field.FieldRepetitions != null && assertingEntityInstanceId.field.FieldRepetitions.Count > 0)
        {
            ...
            assertingEntityInstanceId.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(assertingEntityInstanceId, fieldData);
        }
...
public HL7V27Field AssertingPerson
{
    get
    {
        ...
        if (assertingPerson.field.FieldRepetitions != null && assertingPerson.field.FieldRepetitions.Count > 0)
        {
            ...
            assertingPerson.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(assertingPerson, fieldData);
        }
...
public HL7V27Field AssertingOrganization
{
    get
    {
        ...
        if (assertingOrganization.field.FieldRepetitions != null && assertingOrganization.field.FieldRepetitions.Count > 0)
        {
            ...
            assertingOrganization.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(assertingOrganization, fieldData);
        }
...
public HL7V27Field AssertorAddress
{
    get
    {
        ...
        if (assertorAddress.field.FieldRepetitions != null && assertorAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            assertorAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(assertorAddress, fieldData);
        }
...
public HL7V27Field AssertorContact
{
    get
    {
        ...
        if (assertorContact.field.FieldRepetitions != null && assertorContact.field.FieldRepetitions.Count > 0)
        {
            ...
            assertorContact.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(assertorContact, fieldData);
        }
...
public HL7V27Field AssertionDateRange
{
    get
    {
        ...
        if (assertionDateRange.field.FieldRepetitions != null && assertionDateRange.field.FieldRepetitions.Count > 0)
        {
            ...
            assertionDateRange.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(assertionDateRange, fieldData);
        }
...
public HL7V27Field NegationIndicator
{
    get
    {
        ...
        if (negationIndicator.field.FieldRepetitions != null && negationIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            negationIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(negationIndicator, fieldData);
        }
...
public HL7V27Field CertaintyOfRelationship
{
    get
    {
        ...
        if (certaintyOfRelationship.field.FieldRepetitions != null && certaintyOfRelationship.field.FieldRepetitions.Count > 0)
        {
            ...
            certaintyOfRelationship.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(certaintyOfRelationship, fieldData);
        }
...
public HL7V27Field PriorityNo
{
    get
    {
        ...
        if (priorityNo.field.FieldRepetitions != null && priorityNo.field.FieldRepetitions.Count > 0)
        {
            ...
            priorityNo.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(priorityNo, fieldData);
        }
...
public HL7V27Field PrioritySequenceNorelPreferenceForConsideration
{
    get
    {
        ...
        if (prioritySequenceNorelPreferenceForConsideration.field.FieldRepetitions != null && prioritySequenceNorelPreferenceForConsideration.field.FieldRepetitions.Count > 0)
        {
            ...
            prioritySequenceNorelPreferenceForConsideration.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(prioritySequenceNorelPreferenceForConsideration, fieldData);
        }
...
public HL7V27Field SeparabilityIndicator
{
    get
    {
        ...
        if (separabilityIndicator.field.FieldRepetitions != null && separabilityIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            separabilityIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(separabilityIndicator, fieldData);
        }
