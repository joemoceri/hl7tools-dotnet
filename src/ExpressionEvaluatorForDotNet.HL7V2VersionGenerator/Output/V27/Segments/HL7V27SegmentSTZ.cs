...
Value set version ID is required if CWE.21 is populated.",
        ...
        internal HL7V27Field sterilizationType;
...
public HL7V27Field SterilizationType
{
    get
    {
        ...
        sterilizationType = new HL7V27Field
        {
            field = message[@"STZ"][1],
            Id = @"STZ.1",
            Type = @"Field",
        ...
        if (sterilizationType.field.FieldRepetitions != null && sterilizationType.field.FieldRepetitions.Count > 0)
        {
            ...
            sterilizationType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(sterilizationType, fieldData);
        }
...
internal HL7V27Field sterilizationCycle;
...
public HL7V27Field SterilizationCycle
{
    get
    {
        ...
        sterilizationCycle = new HL7V27Field
        {
            field = message[@"STZ"][2],
            Id = @"STZ.2",
            Type = @"Field",
        ...
        if (sterilizationCycle.field.FieldRepetitions != null && sterilizationCycle.field.FieldRepetitions.Count > 0)
        {
            ...
            sterilizationCycle.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(sterilizationCycle, fieldData);
        }
...
internal HL7V27Field maintenanceCycle;
...
public HL7V27Field MaintenanceCycle
{
    get
    {
        ...
        maintenanceCycle = new HL7V27Field
        {
            field = message[@"STZ"][3],
            Id = @"STZ.3",
            Type = @"Field",
        ...
        if (maintenanceCycle.field.FieldRepetitions != null && maintenanceCycle.field.FieldRepetitions.Count > 0)
        {
            ...
            maintenanceCycle.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(maintenanceCycle, fieldData);
        }
...
internal HL7V27Field maintenanceType;
...
public HL7V27Field MaintenanceType
{
    get
    {
        ...
        maintenanceType = new HL7V27Field
        {
            field = message[@"STZ"][4],
            Id = @"STZ.4",
            Type = @"Field",
        ...
        if (maintenanceType.field.FieldRepetitions != null && maintenanceType.field.FieldRepetitions.Count > 0)
        {
            ...
            maintenanceType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(maintenanceType, fieldData);
        }
