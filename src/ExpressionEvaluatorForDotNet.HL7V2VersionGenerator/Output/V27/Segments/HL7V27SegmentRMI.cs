...
Value set version ID is required if CWE.21 is populated.",
        ...
        internal HL7V27Field riskManagementIncidentCode;
...
public HL7V27Field RiskManagementIncidentCode
{
    get
    {
        ...
        riskManagementIncidentCode = new HL7V27Field
        {
            field = message[@"RMI"][1],
            Id = @"RMI.1",
            Type = @"Field",
        ...
        if (riskManagementIncidentCode.field.FieldRepetitions != null && riskManagementIncidentCode.field.FieldRepetitions.Count > 0)
        {
            ...
            riskManagementIncidentCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(riskManagementIncidentCode, fieldData);
        }
...
internal HL7V27Field dateTimeIncident;
...
public HL7V27Field DateTimeIncident
{
    get
    {
        ...
        dateTimeIncident = new HL7V27Field
        {
            field = message[@"RMI"][2],
            Id = @"RMI.2",
            Type = @"Field",
        ...
        if (dateTimeIncident.field.FieldRepetitions != null && dateTimeIncident.field.FieldRepetitions.Count > 0)
        {
            ...
            dateTimeIncident.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(dateTimeIncident, fieldData);
        }
...
internal HL7V27Field incidentTypeCode;
...
public HL7V27Field IncidentTypeCode
{
    get
    {
        ...
        incidentTypeCode = new HL7V27Field
        {
            field = message[@"RMI"][3],
            Id = @"RMI.3",
            Type = @"Field",
        ...
        if (incidentTypeCode.field.FieldRepetitions != null && incidentTypeCode.field.FieldRepetitions.Count > 0)
        {
            ...
            incidentTypeCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(incidentTypeCode, fieldData);
        }
