...
Preference order numbers need not be sequential (i.e., three numbers with the priority orders of 0, 5 and 15 are legitimate).  The preference order numbers must be non-negative.",
        ...
        internal HL7V27Field facilityIdfac;
...
public HL7V27Field FacilityIdfac
{
    get
    {
        ...
        if (facilityIdfac.field.FieldRepetitions != null && facilityIdfac.field.FieldRepetitions.Count > 0)
        {
            ...
            facilityIdfac.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(facilityIdfac, fieldData);
        }
...
internal HL7V27Field facilityType;
...
public HL7V27Field FacilityType
{
    get
    {
        ...
        if (facilityType.field.FieldRepetitions != null && facilityType.field.FieldRepetitions.Count > 0)
        {
            ...
            facilityType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(facilityType, fieldData);
        }
...
internal HL7V27Field facilityAddress;
...
public HL7V27Field FacilityAddress
{
    get
    {
        ...
        facilityAddress = new HL7V27Field
        {
            field = message[@"FAC"][3],
            Id = @"FAC.3",
            Type = @"Field",
        ...
        if (facilityAddress.field.FieldRepetitions != null && facilityAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            facilityAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(facilityAddress, fieldData);
        }
...
internal HL7V27Field facilityTelecommunication;
...
public HL7V27Field FacilityTelecommunication
{
    get
    {
        ...
        facilityTelecommunication = new HL7V27Field
        {
            field = message[@"FAC"][4],
            Id = @"FAC.4",
            Type = @"Field",
        ...
        if (facilityTelecommunication.field.FieldRepetitions != null && facilityTelecommunication.field.FieldRepetitions.Count > 0)
        {
            ...
            facilityTelecommunication.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(facilityTelecommunication, fieldData);
        }
...
internal HL7V27Field contactPerson;
...
public HL7V27Field ContactPerson
{
    get
    {
        ...
        if (contactPerson.field.FieldRepetitions != null && contactPerson.field.FieldRepetitions.Count > 0)
        {
            ...
            contactPerson.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(contactPerson, fieldData);
        }
...
internal HL7V27Field contactTitle;
...
public HL7V27Field ContactTitle
{
    get
    {
        ...
        if (contactTitle.field.FieldRepetitions != null && contactTitle.field.FieldRepetitions.Count > 0)
        {
            ...
            contactTitle.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(contactTitle, fieldData);
        }
...
internal HL7V27Field contactAddress;
...
public HL7V27Field ContactAddress
{
    get
    {
        ...
        contactAddress = new HL7V27Field
        {
            field = message[@"FAC"][7],
            Id = @"FAC.7",
            Type = @"Field",
        ...
        if (contactAddress.field.FieldRepetitions != null && contactAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            contactAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(contactAddress, fieldData);
        }
...
internal HL7V27Field contactTelecommunication;
...
public HL7V27Field ContactTelecommunication
{
    get
    {
        ...
        contactTelecommunication = new HL7V27Field
        {
            field = message[@"FAC"][8],
            Id = @"FAC.8",
            Type = @"Field",
        ...
        if (contactTelecommunication.field.FieldRepetitions != null && contactTelecommunication.field.FieldRepetitions.Count > 0)
        {
            ...
            contactTelecommunication.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(contactTelecommunication, fieldData);
        }
...
internal HL7V27Field signatureAuthority;
...
public HL7V27Field SignatureAuthority
{
    get
    {
        ...
        signatureAuthority = new HL7V27Field
        {
            field = message[@"FAC"][9],
            Id = @"FAC.9",
            Type = @"Field",
        ...
        if (signatureAuthority.field.FieldRepetitions != null && signatureAuthority.field.FieldRepetitions.Count > 0)
        {
            ...
            signatureAuthority.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(signatureAuthority, fieldData);
        }
...
internal HL7V27Field signatureAuthorityTitle;
...
public HL7V27Field SignatureAuthorityTitle
{
    get
    {
        ...
        signatureAuthorityTitle = new HL7V27Field
        {
        ...
        if (signatureAuthorityTitle.field.FieldRepetitions != null && signatureAuthorityTitle.field.FieldRepetitions.Count > 0)
        {
            ...
            signatureAuthorityTitle.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(signatureAuthorityTitle, fieldData);
        }
...
internal HL7V27Field signatureAuthorityAddress;
...
public HL7V27Field SignatureAuthorityAddress
{
    get
    {
        ...
        signatureAuthorityAddress = new HL7V27Field
        {
        ...
        if (signatureAuthorityAddress.field.FieldRepetitions != null && signatureAuthorityAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            signatureAuthorityAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(signatureAuthorityAddress, fieldData);
        }
...
internal HL7V27Field signatureAuthorityTelecommunication;
...
public HL7V27Field SignatureAuthorityTelecommunication
{
    get
    {
        ...
        signatureAuthorityTelecommunication = new HL7V27Field
        {
        ...
        if (signatureAuthorityTelecommunication.field.FieldRepetitions != null && signatureAuthorityTelecommunication.field.FieldRepetitions.Count > 0)
        {
            ...
            signatureAuthorityTelecommunication.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(signatureAuthorityTelecommunication, fieldData);
        }
