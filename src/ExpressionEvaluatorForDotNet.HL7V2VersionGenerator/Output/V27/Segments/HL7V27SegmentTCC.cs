...
public HL7V27Field EquipmentTestApplicationIdentifier
{
    get
    {
        ...
        if (equipmentTestApplicationIdentifier.field.FieldRepetitions != null && equipmentTestApplicationIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            equipmentTestApplicationIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(equipmentTestApplicationIdentifier, fieldData);
        }
...
public HL7V27Field SpecimenSource
{
    get
    {
        ...
        if (specimenSource.field.FieldRepetitions != null && specimenSource.field.FieldRepetitions.Count > 0)
        {
            ...
            specimenSource.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(specimenSource, fieldData);
        }
...
public HL7V27Field AutodilutionFactorDefault
{
    get
    {
        ...
        if (autodilutionFactorDefault.field.FieldRepetitions != null && autodilutionFactorDefault.field.FieldRepetitions.Count > 0)
        {
            ...
            autodilutionFactorDefault.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(autodilutionFactorDefault, fieldData);
        }
...
public HL7V27Field RerunDilutionFactorDefault
{
    get
    {
        ...
        if (rerunDilutionFactorDefault.field.FieldRepetitions != null && rerunDilutionFactorDefault.field.FieldRepetitions.Count > 0)
        {
            ...
            rerunDilutionFactorDefault.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(rerunDilutionFactorDefault, fieldData);
        }
...
public HL7V27Field PredilutionFactorDefault
{
    get
    {
        ...
        if (predilutionFactorDefault.field.FieldRepetitions != null && predilutionFactorDefault.field.FieldRepetitions.Count > 0)
        {
            ...
            predilutionFactorDefault.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(predilutionFactorDefault, fieldData);
        }
...
public HL7V27Field EndogenousContentOfPredilutionDiluent
{
    get
    {
        ...
        if (endogenousContentOfPredilutionDiluent.field.FieldRepetitions != null && endogenousContentOfPredilutionDiluent.field.FieldRepetitions.Count > 0)
        {
            ...
            endogenousContentOfPredilutionDiluent.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(endogenousContentOfPredilutionDiluent, fieldData);
        }
...
public HL7V27Field InventoryLimitsWarningLevel
{
    get
    {
        ...
        if (inventoryLimitsWarningLevel.field.FieldRepetitions != null && inventoryLimitsWarningLevel.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryLimitsWarningLevel.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(inventoryLimitsWarningLevel, fieldData);
        }
...
public HL7V27Field AutomaticRerunAllowed
{
    get
    {
        ...
        if (automaticRerunAllowed.field.FieldRepetitions != null && automaticRerunAllowed.field.FieldRepetitions.Count > 0)
        {
            ...
            automaticRerunAllowed.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(automaticRerunAllowed, fieldData);
        }
...
public HL7V27Field AutomaticRepeatAllowed
{
    get
    {
        ...
        if (automaticRepeatAllowed.field.FieldRepetitions != null && automaticRepeatAllowed.field.FieldRepetitions.Count > 0)
        {
            ...
            automaticRepeatAllowed.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(automaticRepeatAllowed, fieldData);
        }
...
public HL7V27Field AutomaticReflexAllowed
{
    get
    {
        ...
        if (automaticReflexAllowed.field.FieldRepetitions != null && automaticReflexAllowed.field.FieldRepetitions.Count > 0)
        {
            ...
            automaticReflexAllowed.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(automaticReflexAllowed, fieldData);
        }
...
public HL7V27Field EquipmentDynamicRange
{
    get
    {
        ...
        if (equipmentDynamicRange.field.FieldRepetitions != null && equipmentDynamicRange.field.FieldRepetitions.Count > 0)
        {
            ...
            equipmentDynamicRange.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(equipmentDynamicRange, fieldData);
        }
...
public HL7V27Field ProcessingType
{
    get
    {
        ...
        if (processingType.field.FieldRepetitions != null && processingType.field.FieldRepetitions.Count > 0)
        {
            ...
            processingType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(processingType, fieldData);
        }
