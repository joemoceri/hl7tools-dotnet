...
|PLASTIC SILVERWARE|.",
        ...
        public HL7V27SegmentODT(HL7V2Message message)
        {
            this.message = message;
        }

        
internal HL7V27Field trayType;

public HL7V27Field TrayType
{
    get
    {
        if (trayType != null)
...
internal HL7V27Field servicePeriod;
