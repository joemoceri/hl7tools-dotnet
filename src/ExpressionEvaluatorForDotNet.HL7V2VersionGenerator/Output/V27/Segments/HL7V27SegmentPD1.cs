...
internal HL7V27Field patientPrimaryCareProviderName&IdNo.;

public HL7V27Field PatientPrimaryCareProviderName&IdNo.
{
    get
    {
        ...
        patientPrimaryCareProviderName&IdNo. = new HL7V27Field
        {
            field = message[@"PD1"][4],
            Id = @"PD1.4",
            Type = @"Field",
