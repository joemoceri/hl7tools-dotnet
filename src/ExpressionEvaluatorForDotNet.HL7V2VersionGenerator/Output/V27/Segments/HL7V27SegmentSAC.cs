...
internal HL7V27Field primaryparentContainerIdentifier;

public HL7V27Field PrimaryparentContainerIdentifier
{
    get
    {
        ...
        primaryparentContainerIdentifier = new HL7V27Field
        {
            field = message[@"SAC"][4],
            Id = @"SAC.4",
            Type = @"Field",
