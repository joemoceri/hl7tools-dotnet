...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V27SegmentDSP
    {
        ...
        public HL7V27SegmentDSP(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V27Field _setIdDsp;

public HL7V27Field SetIdDsp
{
    get
    {
        if (_setIdDsp != null)
        ...
        {
            _setIdDsp.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_setIdDsp, fieldData);
        }
...
internal HL7V27Field _displayLevel;

public HL7V27Field DisplayLevel
{
    get
    {
        ...
        {
            _displayLevel.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_displayLevel, fieldData);
        }
...
internal HL7V27Field _dataLine;

public HL7V27Field DataLine
{
    get
    {
        if (_dataLine != null)
        ...
        {
            _dataLine.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_dataLine, fieldData);
        }
...
internal HL7V27Field _logicalBreakPoint;

public HL7V27Field LogicalBreakPoint
{
    get
    {
...
Often the lines of display text will fall into logical groups that differ from the physical size of a screen or printer page.  For example, a complete battery or an entire radiology report might be thought of as comprising a logical group, though it might have as few as six or as many as 120 lines.  Knowledge of the logical break points in the display data can be useful to the application system that is displaying or printing data.  For this reason, DSP-4-Logical break point is used.  The sending application (the one that formats the data) places the logical break points where appropriate.  If there is a particular ancillary result ID associated with the data delineated by DSP-4-Logical break point, the value of this ID also can be returned in DSP-5-Result ID.  Then if the user selects the area of the display delineated by DSP-4-Logical break point, the displaying system can query for the associated DSP-5-Result ID.",
        ...
        _logicalBreakPoint = new HL7V27Field
        {
            field = message[@"DSP"][4],
            fieldData = fieldData
        };
        ...
        {
            _logicalBreakPoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_logicalBreakPoint, fieldData);
        }
...
internal HL7V27Field _resultId;

public HL7V27Field ResultId
{
    get
    {
        if (_resultId != null)
        ...
        {
            _resultId.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_resultId, fieldData);
        }
