...
internal HL7V27Field unitsOfMeasure;
...
public HL7V27Field UnitsOfMeasure
{
    get
    {
        ...
        unitsOfMeasure = new HL7V27Field
        {
            field = message[@"OM2"][2],
            Id = @"OM2.2",
            Type = @"Field",
        ...
        if (unitsOfMeasure.field.FieldRepetitions != null && unitsOfMeasure.field.FieldRepetitions.Count > 0)
        {
            ...
            unitsOfMeasure.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(unitsOfMeasure, fieldData);
        }
...
internal HL7V27Field rangeOfDecimalPrecision;
...
public HL7V27Field RangeOfDecimalPrecision
{
    get
    {
        ...
        rangeOfDecimalPrecision = new HL7V27Field
        {
            field = message[@"OM2"][3],
            Id = @"OM2.3",
            Type = @"Field",
        ...
        if (rangeOfDecimalPrecision.field.FieldRepetitions != null && rangeOfDecimalPrecision.field.FieldRepetitions.Count > 0)
        {
            ...
            rangeOfDecimalPrecision.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(rangeOfDecimalPrecision, fieldData);
        }
...
internal HL7V27Field correspondingSiUnitsOfMeasure;
...
public HL7V27Field CorrespondingSiUnitsOfMeasure
{
    get
    {
        ...
        correspondingSiUnitsOfMeasure = new HL7V27Field
        {
            field = message[@"OM2"][4],
            Id = @"OM2.4",
            Type = @"Field",
        ...
        if (correspondingSiUnitsOfMeasure.field.FieldRepetitions != null && correspondingSiUnitsOfMeasure.field.FieldRepetitions.Count > 0)
        {
            ...
            correspondingSiUnitsOfMeasure.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(correspondingSiUnitsOfMeasure, fieldData);
        }
...
internal HL7V27Field siConversionFactor;
...
public HL7V27Field SiConversionFactor
{
    get
    {
        ...
        siConversionFactor = new HL7V27Field
        {
            field = message[@"OM2"][5],
            Id = @"OM2.5",
            Type = @"Field",
...
In the case that the relation is simply multiplicative, this field shall include only the conversion factor.  For example, if (results SI units) = c * (results reporting units), then only c would be stored in this field.  In the case of any other functional relationship, the entire equation would be stored as a test.",
        ...
        if (siConversionFactor.field.FieldRepetitions != null && siConversionFactor.field.FieldRepetitions.Count > 0)
        {
            ...
            siConversionFactor.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(siConversionFactor, fieldData);
        }
...
When two different methods result in two different reference ranges, two different observations and corresponding OMx segments should be defined.",
        ...
        if (referencenormalRangeForOrdinalAndContinuousObservations.field.FieldRepetitions != null && referencenormalRangeForOrdinalAndContinuousObservations.field.FieldRepetitions.Count > 0)
        {
            ...
            referencenormalRangeForOrdinalAndContinuousObservations.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(referencenormalRangeForOrdinalAndContinuousObservations, fieldData);
        }
...
internal HL7V27Field criticalRangeForOrdinalAndContinuousObservations;
...
public HL7V27Field CriticalRangeForOrdinalAndContinuousObservations
{
    get
    {
        ...
        criticalRangeForOrdinalAndContinuousObservations = new HL7V27Field
        {
            field = message[@"OM2"][7],
            Id = @"OM2.7",
            Type = @"Field",
        ...
        if (criticalRangeForOrdinalAndContinuousObservations.field.FieldRepetitions != null && criticalRangeForOrdinalAndContinuousObservations.field.FieldRepetitions.Count > 0)
        {
            ...
            criticalRangeForOrdinalAndContinuousObservations.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(criticalRangeForOrdinalAndContinuousObservations, fieldData);
        }
...
internal HL7V27Field absoluteRangeForOrdinalAndContinuousObservations;
...
public HL7V27Field AbsoluteRangeForOrdinalAndContinuousObservations
{
    get
    {
        ...
        absoluteRangeForOrdinalAndContinuousObservations = new HL7V27Field
        {
            field = message[@"OM2"][8],
            Id = @"OM2.8",
            Type = @"Field",
        ...
        if (absoluteRangeForOrdinalAndContinuousObservations.field.FieldRepetitions != null && absoluteRangeForOrdinalAndContinuousObservations.field.FieldRepetitions.Count > 0)
        {
            ...
            absoluteRangeForOrdinalAndContinuousObservations.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(absoluteRangeForOrdinalAndContinuousObservations, fieldData);
        }
...
internal HL7V27Field deltaCheckCriteria;
...
public HL7V27Field DeltaCheckCriteria
{
    get
    {
        ...
        deltaCheckCriteria = new HL7V27Field
        {
            field = message[@"OM2"][9],
            Id = @"OM2.9",
            Type = @"Field",
        ...
        if (deltaCheckCriteria.field.FieldRepetitions != null && deltaCheckCriteria.field.FieldRepetitions.Count > 0)
        {
            ...
            deltaCheckCriteria.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(deltaCheckCriteria, fieldData);
        }
...
internal HL7V27Field minimumMeaningfulIncrements;
...
public HL7V27Field MinimumMeaningfulIncrements
{
    get
    {
        ...
        minimumMeaningfulIncrements = new HL7V27Field
        {
        ...
        if (minimumMeaningfulIncrements.field.FieldRepetitions != null && minimumMeaningfulIncrements.field.FieldRepetitions.Count > 0)
        {
            ...
            minimumMeaningfulIncrements.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(minimumMeaningfulIncrements, fieldData);
        }
