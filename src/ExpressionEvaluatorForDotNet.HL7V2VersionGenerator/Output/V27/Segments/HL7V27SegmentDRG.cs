...
public HL7V27Field DiagnosticRelatedGroup
{
    get
    {
        ...
        if (diagnosticRelatedGroup.field.FieldRepetitions != null && diagnosticRelatedGroup.field.FieldRepetitions.Count > 0)
        {
            ...
            diagnosticRelatedGroup.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(diagnosticRelatedGroup, fieldData);
        }
...
public HL7V27Field DrgAssignedDateTime
{
    get
    {
        ...
        if (drgAssignedDateTime.field.FieldRepetitions != null && drgAssignedDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            drgAssignedDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(drgAssignedDateTime, fieldData);
        }
...
N - the DRG has not been approved",
        ...
        if (drgApprovalIndicator.field.FieldRepetitions != null && drgApprovalIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            drgApprovalIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(drgApprovalIndicator, fieldData);
        }
...
public HL7V27Field DrgGrouperReviewCode
{
    get
    {
        ...
        if (drgGrouperReviewCode.field.FieldRepetitions != null && drgGrouperReviewCode.field.FieldRepetitions.Count > 0)
        {
            ...
            drgGrouperReviewCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(drgGrouperReviewCode, fieldData);
        }
...
public HL7V27Field OutlierType
{
    get
    {
        ...
        if (outlierType.field.FieldRepetitions != null && outlierType.field.FieldRepetitions.Count > 0)
        {
            ...
            outlierType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(outlierType, fieldData);
        }
...
public HL7V27Field OutlierDays
{
    get
    {
        ...
        if (outlierDays.field.FieldRepetitions != null && outlierDays.field.FieldRepetitions.Count > 0)
        {
            ...
            outlierDays.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(outlierDays, fieldData);
        }
...
public HL7V27Field OutlierCost
{
    get
    {
        ...
        if (outlierCost.field.FieldRepetitions != null && outlierCost.field.FieldRepetitions.Count > 0)
        {
            ...
            outlierCost.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(outlierCost, fieldData);
        }
...
public HL7V27Field DrgPayor
{
    get
    {
        ...
        if (drgPayor.field.FieldRepetitions != null && drgPayor.field.FieldRepetitions.Count > 0)
        {
            ...
            drgPayor.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(drgPayor, fieldData);
        }
...
public HL7V27Field OutlierReimbursement
{
    get
    {
        ...
        if (outlierReimbursement.field.FieldRepetitions != null && outlierReimbursement.field.FieldRepetitions.Count > 0)
        {
            ...
            outlierReimbursement.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(outlierReimbursement, fieldData);
        }
...
N - the DRG does not contain a confidential diagnosis",
        ...
        if (confidentialIndicator.field.FieldRepetitions != null && confidentialIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            confidentialIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(confidentialIndicator, fieldData);
        }
...
public HL7V27Field DrgTransferType
{
    get
    {
        ...
        if (drgTransferType.field.FieldRepetitions != null && drgTransferType.field.FieldRepetitions.Count > 0)
        {
            ...
            drgTransferType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(drgTransferType, fieldData);
        }
...
public HL7V27Field NameOfCoder
{
    get
    {
        ...
        if (nameOfCoder.field.FieldRepetitions != null && nameOfCoder.field.FieldRepetitions.Count > 0)
        {
            ...
            nameOfCoder.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(nameOfCoder, fieldData);
        }
...
public HL7V27Field GrouperStatus
{
    get
    {
        ...
        if (grouperStatus.field.FieldRepetitions != null && grouperStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            grouperStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(grouperStatus, fieldData);
        }
...
public HL7V27Field PcclValueCode
{
    get
    {
        ...
        if (pcclValueCode.field.FieldRepetitions != null && pcclValueCode.field.FieldRepetitions.Count > 0)
        {
            ...
            pcclValueCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(pcclValueCode, fieldData);
        }
...
public HL7V27Field EffectiveWeight
{
    get
    {
        ...
        if (effectiveWeight.field.FieldRepetitions != null && effectiveWeight.field.FieldRepetitions.Count > 0)
        {
            ...
            effectiveWeight.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(effectiveWeight, fieldData);
        }
...
public HL7V27Field MonetaryAmount
{
    get
    {
        ...
        if (monetaryAmount.field.FieldRepetitions != null && monetaryAmount.field.FieldRepetitions.Count > 0)
        {
            ...
            monetaryAmount.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(monetaryAmount, fieldData);
        }
...
This field is also used along with DRG-23 and DRG-24 as an indication of whether a surcharge (long length of stay) or a discount (short length of stay) has been determined.",
        ...
        if (statusPatient.field.FieldRepetitions != null && statusPatient.field.FieldRepetitions.Count > 0)
        {
            ...
            statusPatient.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(statusPatient, fieldData);
        }
...
public HL7V27Field GrouperSoftwareName
{
    get
    {
        ...
        if (grouperSoftwareName.field.FieldRepetitions != null && grouperSoftwareName.field.FieldRepetitions.Count > 0)
        {
            ...
            grouperSoftwareName.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(grouperSoftwareName, fieldData);
        }
...
public HL7V27Field GrouperSoftwareVersion
{
    get
    {
        ...
        if (grouperSoftwareVersion.field.FieldRepetitions != null && grouperSoftwareVersion.field.FieldRepetitions.Count > 0)
        {
            ...
            grouperSoftwareVersion.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(grouperSoftwareVersion, fieldData);
        }
...
public HL7V27Field StatusFinancialCalculation
{
    get
    {
        ...
        if (statusFinancialCalculation.field.FieldRepetitions != null && statusFinancialCalculation.field.FieldRepetitions.Count > 0)
        {
            ...
            statusFinancialCalculation.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(statusFinancialCalculation, fieldData);
        }
...
public HL7V27Field RelativeDiscountSurcharge
{
    get
    {
        ...
        if (relativeDiscountSurcharge.field.FieldRepetitions != null && relativeDiscountSurcharge.field.FieldRepetitions.Count > 0)
        {
            ...
            relativeDiscountSurcharge.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(relativeDiscountSurcharge, fieldData);
        }
...
public HL7V27Field BasicCharge
{
    get
    {
        ...
        if (basicCharge.field.FieldRepetitions != null && basicCharge.field.FieldRepetitions.Count > 0)
        {
            ...
            basicCharge.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(basicCharge, fieldData);
        }
...
public HL7V27Field TotalCharge
{
    get
    {
        ...
        if (totalCharge.field.FieldRepetitions != null && totalCharge.field.FieldRepetitions.Count > 0)
        {
            ...
            totalCharge.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(totalCharge, fieldData);
        }
...
public HL7V27Field DiscountSurcharge
{
    get
    {
        ...
        if (discountSurcharge.field.FieldRepetitions != null && discountSurcharge.field.FieldRepetitions.Count > 0)
        {
            ...
            discountSurcharge.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(discountSurcharge, fieldData);
        }
...
public HL7V27Field CalculatedDays
{
    get
    {
        ...
        if (calculatedDays.field.FieldRepetitions != null && calculatedDays.field.FieldRepetitions.Count > 0)
        {
            ...
            calculatedDays.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(calculatedDays, fieldData);
        }
...
public HL7V27Field StatusGender
{
    get
    {
        ...
        if (statusGender.field.FieldRepetitions != null && statusGender.field.FieldRepetitions.Count > 0)
        {
            ...
            statusGender.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(statusGender, fieldData);
        }
...
public HL7V27Field StatusAge
{
    get
    {
        ...
        if (statusAge.field.FieldRepetitions != null && statusAge.field.FieldRepetitions.Count > 0)
        {
            ...
            statusAge.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(statusAge, fieldData);
        }
...
public HL7V27Field StatusLengthOfStay
{
    get
    {
        ...
        if (statusLengthOfStay.field.FieldRepetitions != null && statusLengthOfStay.field.FieldRepetitions.Count > 0)
        {
            ...
            statusLengthOfStay.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(statusLengthOfStay, fieldData);
        }
...
public HL7V27Field StatusSameDayFlag
{
    get
    {
        ...
        if (statusSameDayFlag.field.FieldRepetitions != null && statusSameDayFlag.field.FieldRepetitions.Count > 0)
        {
            ...
            statusSameDayFlag.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(statusSameDayFlag, fieldData);
        }
...
public HL7V27Field StatusSeparationMode
{
    get
    {
        ...
        if (statusSeparationMode.field.FieldRepetitions != null && statusSeparationMode.field.FieldRepetitions.Count > 0)
        {
            ...
            statusSeparationMode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(statusSeparationMode, fieldData);
        }
...
public HL7V27Field StatusWeightAtBirth
{
    get
    {
        ...
        if (statusWeightAtBirth.field.FieldRepetitions != null && statusWeightAtBirth.field.FieldRepetitions.Count > 0)
        {
            ...
            statusWeightAtBirth.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(statusWeightAtBirth, fieldData);
        }
...
public HL7V27Field StatusRespirationMinutes
{
    get
    {
        ...
        if (statusRespirationMinutes.field.FieldRepetitions != null && statusRespirationMinutes.field.FieldRepetitions.Count > 0)
        {
            ...
            statusRespirationMinutes.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(statusRespirationMinutes, fieldData);
        }
...
public HL7V27Field StatusAdmission
{
    get
    {
        ...
        if (statusAdmission.field.FieldRepetitions != null && statusAdmission.field.FieldRepetitions.Count > 0)
        {
            ...
            statusAdmission.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(statusAdmission, fieldData);
        }
