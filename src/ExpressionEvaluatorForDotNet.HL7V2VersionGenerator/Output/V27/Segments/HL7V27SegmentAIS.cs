...
public HL7V27Field SetIdAis
{
    get
    {
        ...
        if (setIdAis.field.FieldRepetitions != null && setIdAis.field.FieldRepetitions.Count > 0)
        {
            ...
            setIdAis.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(setIdAis, fieldData);
        }
...
public HL7V27Field PlacerSupplementalServiceInformation
{
    get
    {
        ...
        if (placerSupplementalServiceInformation.field.FieldRepetitions != null && placerSupplementalServiceInformation.field.FieldRepetitions.Count > 0)
        {
            ...
            placerSupplementalServiceInformation.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(placerSupplementalServiceInformation, fieldData);
        }
...
public HL7V27Field FillerSupplementalServiceInformation
{
    get
    {
        ...
        if (fillerSupplementalServiceInformation.field.FieldRepetitions != null && fillerSupplementalServiceInformation.field.FieldRepetitions.Count > 0)
        {
            ...
            fillerSupplementalServiceInformation.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(fillerSupplementalServiceInformation, fieldData);
        }
