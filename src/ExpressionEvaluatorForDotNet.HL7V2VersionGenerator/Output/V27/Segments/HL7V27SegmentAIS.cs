...
Value set version ID is required if CWE.21 is populated.",
        ...
        public HL7V27SegmentAIS(HL7V2Message message)
        {
            this.message = message;
        }

        
internal HL7V27Field setIdAis;

public HL7V27Field SetIdAis
{
    get
    {
        if (setIdAis != null)
        ...
        if (setIdAis.field.FieldRepetitions != null && setIdAis.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < setIdAis.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V27FieldRepetition
                {
                    fieldRepetition = setIdAis.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    for (var j = 0; j < setIdAis.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V27Component
                        {
                            component = setIdAis.field.FieldRepetitions[i].Components[j],
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < setIdAis.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V27SubComponent
                                {
                                    subComponent = setIdAis.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = componentFieldData.Id,
                                    Type = componentFieldData.Type,
                                    Position = componentFieldData.Position,
                                    Name = componentFieldData.Name,
            ...
            setIdAis.fieldRepetitions = fieldRepetitions;
        }
...
internal HL7V27Field placerSupplementalServiceInformation;

public HL7V27Field PlacerSupplementalServiceInformation
{
    get
    {
        ...
        placerSupplementalServiceInformation = new HL7V27Field
        {
...
internal HL7V27Field fillerSupplementalServiceInformation;

public HL7V27Field FillerSupplementalServiceInformation
{
    get
    {
        ...
        fillerSupplementalServiceInformation = new HL7V27Field
        {
