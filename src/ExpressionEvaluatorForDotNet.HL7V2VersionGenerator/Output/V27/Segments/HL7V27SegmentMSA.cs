...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V27SegmentMSA
    {
        ...
        internal HL7V27Field _acknowledgmentCode;
...
public HL7V27Field AcknowledgmentCode
{
    get
    {
        ...
        _acknowledgmentCode = new HL7V27Field
        {
            field = message[@"MSA"][1],
            fieldData = fieldData
        };
        ...
        {
            _acknowledgmentCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_acknowledgmentCode, fieldData);
        }
...
internal HL7V27Field _textMessage;
...
public HL7V27Field TextMessage
{
    get
    {
        ...
        {
            _textMessage.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_textMessage, fieldData);
        }
...
internal HL7V27Field _expectedSequenceNumber;
...
public HL7V27Field ExpectedSequenceNumber
{
    get
    {
        ...
        _expectedSequenceNumber = new HL7V27Field
        {
            field = message[@"MSA"][4],
            fieldData = fieldData
        };
        ...
        {
            _expectedSequenceNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_expectedSequenceNumber, fieldData);
        }
...
internal HL7V27Field _delayedAcknowledgmentType;
...
public HL7V27Field DelayedAcknowledgmentType
{
    get
    {
        ...
        _delayedAcknowledgmentType = new HL7V27Field
        {
            field = message[@"MSA"][5],
            fieldData = fieldData
        };
        ...
        {
            _delayedAcknowledgmentType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_delayedAcknowledgmentType, fieldData);
        }
...
internal HL7V27Field _errorCondition;
...
public HL7V27Field ErrorCondition
{
    get
    {
        ...
        _errorCondition = new HL7V27Field
        {
            field = message[@"MSA"][6],
            fieldData = fieldData
        };
        ...
        {
            _errorCondition.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_errorCondition, fieldData);
        }
...
internal HL7V27Field _messageWaitingNumber;
...
See MSA-7 above for Use Case.",
        ...
        _messageWaitingNumber = new HL7V27Field
        {
            field = message[@"MSA"][7],
            fieldData = fieldData
        };
        ...
        {
            _messageWaitingNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_messageWaitingNumber, fieldData);
        }
...
internal HL7V27Field _messageWaitingPriority;
...
See MSA-7 above for Use Case.",
        ...
        _messageWaitingPriority = new HL7V27Field
        {
            field = message[@"MSA"][8],
            fieldData = fieldData
        };
        ...
        {
            _messageWaitingPriority.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_messageWaitingPriority, fieldData);
        }
