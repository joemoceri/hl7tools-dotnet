...
internal HL7V27Field diet,Supplement,OrPreferenceCode;

public HL7V27Field Diet,Supplement,OrPreferenceCode
{
    get
    {
        ...
        diet,Supplement,OrPreferenceCode = new HL7V27Field
        {
            field = message[@"ODS"][3],
            Id = @"ODS.3",
            Type = @"Field",
