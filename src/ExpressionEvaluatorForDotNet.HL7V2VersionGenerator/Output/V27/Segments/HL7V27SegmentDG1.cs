...
public HL7V27Field SetIdDg1
{
    get
    {
        ...
        if (setIdDg1.field.FieldRepetitions != null && setIdDg1.field.FieldRepetitions.Count > 0)
        {
            ...
            setIdDg1.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(setIdDg1, fieldData);
        }
...
public HL7V27Field DiagnosisCodingMethod
{
    get
    {
        ...
        if (diagnosisCodingMethod.field.FieldRepetitions != null && diagnosisCodingMethod.field.FieldRepetitions.Count > 0)
        {
            ...
            diagnosisCodingMethod.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(diagnosisCodingMethod, fieldData);
        }
...
Names of various diagnosis coding systems are listed in Chapter 2, Section 2.16.4, “Coding system table.”",
        ...
        if (diagnosisCodeDg1.field.FieldRepetitions != null && diagnosisCodeDg1.field.FieldRepetitions.Count > 0)
        {
            ...
            diagnosisCodeDg1.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(diagnosisCodeDg1, fieldData);
        }
...
public HL7V27Field DiagnosisDescription
{
    get
    {
        ...
        if (diagnosisDescription.field.FieldRepetitions != null && diagnosisDescription.field.FieldRepetitions.Count > 0)
        {
            ...
            diagnosisDescription.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(diagnosisDescription, fieldData);
        }
...
public HL7V27Field DiagnosisDateTime
{
    get
    {
        ...
        if (diagnosisDateTime.field.FieldRepetitions != null && diagnosisDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            diagnosisDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(diagnosisDateTime, fieldData);
        }
...
public HL7V27Field DiagnosisType
{
    get
    {
        ...
        if (diagnosisType.field.FieldRepetitions != null && diagnosisType.field.FieldRepetitions.Count > 0)
        {
            ...
            diagnosisType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(diagnosisType, fieldData);
        }
...
public HL7V27Field MajorDiagnosticCategory
{
    get
    {
        ...
        if (majorDiagnosticCategory.field.FieldRepetitions != null && majorDiagnosticCategory.field.FieldRepetitions.Count > 0)
        {
            ...
            majorDiagnosticCategory.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(majorDiagnosticCategory, fieldData);
        }
...
public HL7V27Field GrouperVersionAndType
{
    get
    {
        ...
        if (grouperVersionAndType.field.FieldRepetitions != null && grouperVersionAndType.field.FieldRepetitions.Count > 0)
        {
            ...
            grouperVersionAndType.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(grouperVersionAndType, fieldData);
        }
...
Note: As of v2.7, the data type has been changed to numeric. The meaning of the values remains the same as those in HL7 Table 0418 – Procedure Priority, The value 0 conveys that this procedure is not included in the ranking. The value 1 means that this is the primary procedure. Values 2-99 convey ranked secondary procedures.",
        ...
        if (diagnosisPriority.field.FieldRepetitions != null && diagnosisPriority.field.FieldRepetitions.Count > 0)
        {
            ...
            diagnosisPriority.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(diagnosisPriority, fieldData);
        }
...
public HL7V27Field DiagnosingClinician
{
    get
    {
        ...
        if (diagnosingClinician.field.FieldRepetitions != null && diagnosingClinician.field.FieldRepetitions.Count > 0)
        {
            ...
            diagnosingClinician.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(diagnosingClinician, fieldData);
        }
...
public HL7V27Field DiagnosisClassification
{
    get
    {
        ...
        if (diagnosisClassification.field.FieldRepetitions != null && diagnosisClassification.field.FieldRepetitions.Count > 0)
        {
            ...
            diagnosisClassification.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(diagnosisClassification, fieldData);
        }
...
public HL7V27Field AttestationDateTime
{
    get
    {
        ...
        if (attestationDateTime.field.FieldRepetitions != null && attestationDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            attestationDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(attestationDateTime, fieldData);
        }
...
public HL7V27Field DiagnosisIdentifier
{
    get
    {
        ...
        if (diagnosisIdentifier.field.FieldRepetitions != null && diagnosisIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            diagnosisIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(diagnosisIdentifier, fieldData);
        }
...
public HL7V27Field DiagnosisActionCode
{
    get
    {
        ...
        if (diagnosisActionCode.field.FieldRepetitions != null && diagnosisActionCode.field.FieldRepetitions.Count > 0)
        {
            ...
            diagnosisActionCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(diagnosisActionCode, fieldData);
        }
...
public HL7V27Field ParentDiagnosis
{
    get
    {
        ...
        if (parentDiagnosis.field.FieldRepetitions != null && parentDiagnosis.field.FieldRepetitions.Count > 0)
        {
            ...
            parentDiagnosis.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(parentDiagnosis, fieldData);
        }
...
public HL7V27Field DrgCclValueCode
{
    get
    {
        ...
        if (drgCclValueCode.field.FieldRepetitions != null && drgCclValueCode.field.FieldRepetitions.Count > 0)
        {
            ...
            drgCclValueCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(drgCclValueCode, fieldData);
        }
...
N - Indicates that the diagnosis has not been used for the DRG determination",
        ...
        if (drgGroupingUsage.field.FieldRepetitions != null && drgGroupingUsage.field.FieldRepetitions.Count > 0)
        {
            ...
            drgGroupingUsage.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(drgGroupingUsage, fieldData);
        }
...
public HL7V27Field DrgDiagnosisDeterminationStatus
{
    get
    {
        ...
        if (drgDiagnosisDeterminationStatus.field.FieldRepetitions != null && drgDiagnosisDeterminationStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            drgDiagnosisDeterminationStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(drgDiagnosisDeterminationStatus, fieldData);
        }
...
public HL7V27Field PresentOnAdmissionpoaIndicator
{
    get
    {
        ...
        if (presentOnAdmissionpoaIndicator.field.FieldRepetitions != null && presentOnAdmissionpoaIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            presentOnAdmissionpoaIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(presentOnAdmissionpoaIndicator, fieldData);
        }
