...
public HL7V27Field TimeSelectionCriteria
{
    get
    {
        ...
        timeSelectionCriteria = new HL7V27Field
        {
            field = message[@"APR"][1],
            Id = @"APR.1",
            Type = @"Field",
...
The valid set of preferences should be determined by the placer and filler applications during implementation of the interface.",
        ...
        if (timeSelectionCriteria.field.FieldRepetitions != null && timeSelectionCriteria.field.FieldRepetitions.Count > 0)
        {
            ...
            timeSelectionCriteria.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(timeSelectionCriteria, fieldData);
        }
...
internal HL7V27Field resourceSelectionCriteria;
...
public HL7V27Field ResourceSelectionCriteria
{
    get
    {
        ...
        resourceSelectionCriteria = new HL7V27Field
        {
            field = message[@"APR"][2],
            Id = @"APR.2",
            Type = @"Field",
...
The valid set of preferences should be determined by the placer and filler applications during implementation of the interface.  Refer to User-defined Table 0294 - Time Selection Criteria Parameter Class Codes for suggested examples, documented in Chapter 2C, Code Tables.",
        ...
        if (resourceSelectionCriteria.field.FieldRepetitions != null && resourceSelectionCriteria.field.FieldRepetitions.Count > 0)
        {
            ...
            resourceSelectionCriteria.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(resourceSelectionCriteria, fieldData);
        }
...
internal HL7V27Field locationSelectionCriteria;
...
public HL7V27Field LocationSelectionCriteria
{
    get
    {
        ...
        locationSelectionCriteria = new HL7V27Field
        {
            field = message[@"APR"][3],
            Id = @"APR.3",
            Type = @"Field",
...
The valid set of preferences should be determined by the placer and filler applications during implementation of the interface.  Refer to User-defined Table 0294 - Time Selection Criteria Parameter Class Codes for suggested examples, documented in Chapter 2C, Code Tables.",
        ...
        if (locationSelectionCriteria.field.FieldRepetitions != null && locationSelectionCriteria.field.FieldRepetitions.Count > 0)
        {
            ...
            locationSelectionCriteria.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(locationSelectionCriteria, fieldData);
        }
...
internal HL7V27Field slotSpacingCriteria;
...
public HL7V27Field SlotSpacingCriteria
{
    get
    {
        ...
        slotSpacingCriteria = new HL7V27Field
        {
            field = message[@"APR"][4],
            Id = @"APR.4",
            Type = @"Field",
...
10:00 - 11:30",
        ...
        if (slotSpacingCriteria.field.FieldRepetitions != null && slotSpacingCriteria.field.FieldRepetitions.Count > 0)
        {
            ...
            slotSpacingCriteria.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(slotSpacingCriteria, fieldData);
        }
...
internal HL7V27Field fillerOverrideCriteria;
...
public HL7V27Field FillerOverrideCriteria
{
    get
    {
        ...
        fillerOverrideCriteria = new HL7V27Field
        {
            field = message[@"APR"][5],
            Id = @"APR.5",
            Type = @"Field",
...
The valid set of parameters should be determined by the placer and filler applications during implementation of the interface.",
        ...
        if (fillerOverrideCriteria.field.FieldRepetitions != null && fillerOverrideCriteria.field.FieldRepetitions.Count > 0)
        {
            ...
            fillerOverrideCriteria.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(fillerOverrideCriteria, fieldData);
        }
