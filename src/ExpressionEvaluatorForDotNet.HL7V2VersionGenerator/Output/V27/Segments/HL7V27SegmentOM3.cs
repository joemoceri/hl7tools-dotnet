...
internal HL7V27Field preferredCodingSystem;
...
public HL7V27Field PreferredCodingSystem
{
    get
    {
        ...
        preferredCodingSystem = new HL7V27Field
        {
            field = message[@"OM3"][2],
            Id = @"OM3.2",
            Type = @"Field",
        ...
        if (preferredCodingSystem.field.FieldRepetitions != null && preferredCodingSystem.field.FieldRepetitions.Count > 0)
        {
            ...
            preferredCodingSystem.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(preferredCodingSystem, fieldData);
        }
...
internal HL7V27Field validCodedanswers;
...
public HL7V27Field ValidCodedanswers
{
    get
    {
        ...
        validCodedanswers = new HL7V27Field
        {
            field = message[@"OM3"][3],
            Id = @"OM3.3",
            Type = @"Field",
        ...
        if (validCodedanswers.field.FieldRepetitions != null && validCodedanswers.field.FieldRepetitions.Count > 0)
        {
            ...
            validCodedanswers.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(validCodedanswers, fieldData);
        }
...
internal HL7V27Field normalTextCodesForCategoricalObservations;
...
public HL7V27Field NormalTextCodesForCategoricalObservations
{
    get
    {
        ...
        normalTextCodesForCategoricalObservations = new HL7V27Field
        {
            field = message[@"OM3"][4],
            Id = @"OM3.4",
            Type = @"Field",
...
Care should be taken to transmit only those results that are considered normal for that test.  A drug screen may have possible results of ""negative"" and ""positive.""  However, only a result of ""negative"" is considered to be normal.  When an observation has more than one ""normal"" result, multiple values in this field should be separated with a repeat delimiter.",
        ...
        if (normalTextCodesForCategoricalObservations.field.FieldRepetitions != null && normalTextCodesForCategoricalObservations.field.FieldRepetitions.Count > 0)
        {
            ...
            normalTextCodesForCategoricalObservations.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(normalTextCodesForCategoricalObservations, fieldData);
        }
...
internal HL7V27Field abnormalTextCodesForCategoricalObservations;
...
public HL7V27Field AbnormalTextCodesForCategoricalObservations
{
    get
    {
        ...
        abnormalTextCodesForCategoricalObservations = new HL7V27Field
        {
            field = message[@"OM3"][5],
            Id = @"OM3.5",
            Type = @"Field",
        ...
        if (abnormalTextCodesForCategoricalObservations.field.FieldRepetitions != null && abnormalTextCodesForCategoricalObservations.field.FieldRepetitions.Count > 0)
        {
            ...
            abnormalTextCodesForCategoricalObservations.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(abnormalTextCodesForCategoricalObservations, fieldData);
        }
...
internal HL7V27Field criticalTextCodesForCategoricalObservations;
...
public HL7V27Field CriticalTextCodesForCategoricalObservations
{
    get
    {
        ...
        criticalTextCodesForCategoricalObservations = new HL7V27Field
        {
            field = message[@"OM3"][6],
            Id = @"OM3.6",
            Type = @"Field",
        ...
        if (criticalTextCodesForCategoricalObservations.field.FieldRepetitions != null && criticalTextCodesForCategoricalObservations.field.FieldRepetitions.Count > 0)
        {
            ...
            criticalTextCodesForCategoricalObservations.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(criticalTextCodesForCategoricalObservations, fieldData);
        }
