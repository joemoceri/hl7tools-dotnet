...
public HL7V27Field CommandResponse
{
    get
    {
        ...
        if (commandResponse.field.FieldRepetitions != null && commandResponse.field.FieldRepetitions.Count > 0)
        {
            ...
            commandResponse.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(commandResponse, fieldData);
        }
...
public HL7V27Field DateTimeCompleted
{
    get
    {
        ...
        if (dateTimeCompleted.field.FieldRepetitions != null && dateTimeCompleted.field.FieldRepetitions.Count > 0)
        {
            ...
            dateTimeCompleted.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(dateTimeCompleted, fieldData);
        }
...
public HL7V27Field CommandResponseParameters
{
    get
    {
        ...
        if (commandResponseParameters.field.FieldRepetitions != null && commandResponseParameters.field.FieldRepetitions.Count > 0)
        {
            ...
            commandResponseParameters.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(commandResponseParameters, fieldData);
        }
