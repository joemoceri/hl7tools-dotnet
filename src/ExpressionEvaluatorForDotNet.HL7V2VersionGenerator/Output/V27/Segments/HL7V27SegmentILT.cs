...
public HL7V27Field SetIdIlt
{
    get
    {
        ...
        if (setIdIlt.field.FieldRepetitions != null && setIdIlt.field.FieldRepetitions.Count > 0)
        {
            ...
            setIdIlt.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(setIdIlt, fieldData);
        }
...
internal HL7V27Field inventoryLotNumber;
...
public HL7V27Field InventoryLotNumber
{
    get
    {
        ...
        inventoryLotNumber = new HL7V27Field
        {
            field = message[@"ILT"][2],
            Id = @"ILT.2",
            Type = @"Field",
...
Note:  The lot number is the number printed on the label attached to the item or container holding the substance.  If the substance is a vaccine, for example, and a diluent is required, a lot number may appear on the vial containing the diluent; however, any such identifier associated with a diluent is not the identifier of interest. The substance lot number should be reported, not that of the diluent.",
        ...
        if (inventoryLotNumber.field.FieldRepetitions != null && inventoryLotNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryLotNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(inventoryLotNumber, fieldData);
        }
...
internal HL7V27Field inventoryExpirationDate;
...
public HL7V27Field InventoryExpirationDate
{
    get
    {
        ...
        inventoryExpirationDate = new HL7V27Field
        {
            field = message[@"ILT"][3],
            Id = @"ILT.3",
            Type = @"Field",
...
Note: Expiration date does not always have a ""day"" component; therefore, such a date may be transmitted as YYYYMM.",
        ...
        if (inventoryExpirationDate.field.FieldRepetitions != null && inventoryExpirationDate.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryExpirationDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(inventoryExpirationDate, fieldData);
        }
...
internal HL7V27Field inventoryReceivedDate;
...
public HL7V27Field InventoryReceivedDate
{
    get
    {
        ...
        inventoryReceivedDate = new HL7V27Field
        {
            field = message[@"ILT"][4],
            Id = @"ILT.4",
            Type = @"Field",
        ...
        if (inventoryReceivedDate.field.FieldRepetitions != null && inventoryReceivedDate.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryReceivedDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(inventoryReceivedDate, fieldData);
        }
...
internal HL7V27Field inventoryReceivedQuantity;
...
public HL7V27Field InventoryReceivedQuantity
{
    get
    {
        ...
        inventoryReceivedQuantity = new HL7V27Field
        {
            field = message[@"ILT"][5],
            Id = @"ILT.5",
            Type = @"Field",
        ...
        if (inventoryReceivedQuantity.field.FieldRepetitions != null && inventoryReceivedQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryReceivedQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(inventoryReceivedQuantity, fieldData);
        }
...
internal HL7V27Field inventoryReceivedQuantityUnit;
...
public HL7V27Field InventoryReceivedQuantityUnit
{
    get
    {
        ...
        inventoryReceivedQuantityUnit = new HL7V27Field
        {
            field = message[@"ILT"][6],
            Id = @"ILT.6",
            Type = @"Field",
        ...
        if (inventoryReceivedQuantityUnit.field.FieldRepetitions != null && inventoryReceivedQuantityUnit.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryReceivedQuantityUnit.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(inventoryReceivedQuantityUnit, fieldData);
        }
...
internal HL7V27Field inventoryReceivedItemCost;
...
public HL7V27Field InventoryReceivedItemCost
{
    get
    {
        ...
        inventoryReceivedItemCost = new HL7V27Field
        {
            field = message[@"ILT"][7],
            Id = @"ILT.7",
            Type = @"Field",
        ...
        if (inventoryReceivedItemCost.field.FieldRepetitions != null && inventoryReceivedItemCost.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryReceivedItemCost.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(inventoryReceivedItemCost, fieldData);
        }
...
internal HL7V27Field inventoryOnHandDate;
...
public HL7V27Field InventoryOnHandDate
{
    get
    {
        ...
        inventoryOnHandDate = new HL7V27Field
        {
            field = message[@"ILT"][8],
            Id = @"ILT.8",
            Type = @"Field",
        ...
        if (inventoryOnHandDate.field.FieldRepetitions != null && inventoryOnHandDate.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryOnHandDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(inventoryOnHandDate, fieldData);
        }
...
internal HL7V27Field inventoryOnHandQuantity;
...
public HL7V27Field InventoryOnHandQuantity
{
    get
    {
        ...
        inventoryOnHandQuantity = new HL7V27Field
        {
            field = message[@"ILT"][9],
            Id = @"ILT.9",
            Type = @"Field",
        ...
        if (inventoryOnHandQuantity.field.FieldRepetitions != null && inventoryOnHandQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryOnHandQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(inventoryOnHandQuantity, fieldData);
        }
...
internal HL7V27Field inventoryOnHandQuantityUnit;
...
public HL7V27Field InventoryOnHandQuantityUnit
{
    get
    {
        ...
        inventoryOnHandQuantityUnit = new HL7V27Field
        {
        ...
        if (inventoryOnHandQuantityUnit.field.FieldRepetitions != null && inventoryOnHandQuantityUnit.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryOnHandQuantityUnit.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(inventoryOnHandQuantityUnit, fieldData);
        }
