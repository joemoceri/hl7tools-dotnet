...
Note that on-hand quantities do NOT refer to a continuously updated quantity.  The expectation is for periodic physical inventory.  "; } }
        ...
        public HL7V27SegmentILT(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V27Field _setIdIlt;
...
public HL7V27Field SetIdIlt
{
    get
    {
        ...
        {
            _setIdIlt.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(_setIdIlt, fieldData);
        }
