...
Value set version ID is required if CWE.21 is populated.",
        ...
        public HL7V27SegmentOM4(HL7V2Message message)
        {
...
internal HL7V27Field derivedSpecimen;

public HL7V27Field DerivedSpecimen
{
    get
    {
        ...
        derivedSpecimen = new HL7V27Field
        {
            field = message[@"OM4"][2],
            Id = @"OM4.2",
            Type = @"Field",
        ...
        if (derivedSpecimen.field.FieldRepetitions != null && derivedSpecimen.field.FieldRepetitions.Count > 0)
        {
            ...
            derivedSpecimen.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(derivedSpecimen, fieldData);
        }
...
internal HL7V27Field containerDescription;

public HL7V27Field ContainerDescription
{
    get
    {
        ...
        containerDescription = new HL7V27Field
        {
            field = message[@"OM4"][3],
            Id = @"OM4.3",
            Type = @"Field",
        ...
        if (containerDescription.field.FieldRepetitions != null && containerDescription.field.FieldRepetitions.Count > 0)
        {
            ...
            containerDescription.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(containerDescription, fieldData);
        }
...
public HL7V27Field ContainerVolume
{
    get
    {
        ...
        if (containerVolume.field.FieldRepetitions != null && containerVolume.field.FieldRepetitions.Count > 0)
        {
            ...
            containerVolume.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(containerVolume, fieldData);
        }
...
internal HL7V27Field containerUnits;

public HL7V27Field ContainerUnits
{
    get
    {
        ...
        containerUnits = new HL7V27Field
        {
            field = message[@"OM4"][5],
            Id = @"OM4.5",
            Type = @"Field",
        ...
        if (containerUnits.field.FieldRepetitions != null && containerUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            containerUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(containerUnits, fieldData);
        }
...
internal HL7V27Field specimen;

public HL7V27Field Specimen
{
    get
    {
        if (specimen != null)
        ...
        if (specimen.field.FieldRepetitions != null && specimen.field.FieldRepetitions.Count > 0)
        {
            ...
            specimen.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(specimen, fieldData);
        }
...
This table was not specified in previous versions and thus sites may choose to use other site-specific tables.",
        ...
        if (additive.field.FieldRepetitions != null && additive.field.FieldRepetitions.Count > 0)
        {
            ...
            additive.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(additive, fieldData);
        }
...
internal HL7V27Field preparation;

public HL7V27Field Preparation
{
    get
    {
        if (preparation != null)
        ...
        if (preparation.field.FieldRepetitions != null && preparation.field.FieldRepetitions.Count > 0)
        {
            ...
            preparation.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(preparation, fieldData);
        }
...
internal HL7V27Field specialHandlingRequirements;

public HL7V27Field SpecialHandlingRequirements
{
    get
    {
        ...
        specialHandlingRequirements = new HL7V27Field
        {
            field = message[@"OM4"][9],
            Id = @"OM4.9",
            Type = @"Field",
        ...
        if (specialHandlingRequirements.field.FieldRepetitions != null && specialHandlingRequirements.field.FieldRepetitions.Count > 0)
        {
            ...
            specialHandlingRequirements.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(specialHandlingRequirements, fieldData);
        }
...
internal HL7V27Field normalCollectionVolume;

public HL7V27Field NormalCollectionVolume
{
    get
    {
        ...
        normalCollectionVolume = new HL7V27Field
        {
        ...
        if (normalCollectionVolume.field.FieldRepetitions != null && normalCollectionVolume.field.FieldRepetitions.Count > 0)
        {
            ...
            normalCollectionVolume.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(normalCollectionVolume, fieldData);
        }
...
internal HL7V27Field minimumCollectionVolume;

public HL7V27Field MinimumCollectionVolume
{
    get
    {
        ...
        minimumCollectionVolume = new HL7V27Field
        {
        ...
        if (minimumCollectionVolume.field.FieldRepetitions != null && minimumCollectionVolume.field.FieldRepetitions.Count > 0)
        {
            ...
            minimumCollectionVolume.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(minimumCollectionVolume, fieldData);
        }
...
internal HL7V27Field specimenRequirements;

public HL7V27Field SpecimenRequirements
{
    get
    {
        ...
        specimenRequirements = new HL7V27Field
        {
        ...
        if (specimenRequirements.field.FieldRepetitions != null && specimenRequirements.field.FieldRepetitions.Count > 0)
        {
            ...
            specimenRequirements.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(specimenRequirements, fieldData);
        }
...
internal HL7V27Field specimenPriorities;

public HL7V27Field SpecimenPriorities
{
    get
    {
        ...
        specimenPriorities = new HL7V27Field
        {
        ...
        if (specimenPriorities.field.FieldRepetitions != null && specimenPriorities.field.FieldRepetitions.Count > 0)
        {
            ...
            specimenPriorities.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(specimenPriorities, fieldData);
        }
...
internal HL7V27Field specimenRetentionTime;

public HL7V27Field SpecimenRetentionTime
{
    get
    {
        ...
        specimenRetentionTime = new HL7V27Field
        {
        ...
        if (specimenRetentionTime.field.FieldRepetitions != null && specimenRetentionTime.field.FieldRepetitions.Count > 0)
        {
            ...
            specimenRetentionTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(specimenRetentionTime, fieldData);
        }
