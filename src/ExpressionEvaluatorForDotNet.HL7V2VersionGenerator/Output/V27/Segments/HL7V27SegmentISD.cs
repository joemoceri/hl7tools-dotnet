...
public HL7V27Field ReferenceInteractionNumber
{
    get
    {
        ...
        if (referenceInteractionNumber.field.FieldRepetitions != null && referenceInteractionNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            referenceInteractionNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(referenceInteractionNumber, fieldData);
        }
...
public HL7V27Field InteractionTypeIdentifier
{
    get
    {
        ...
        if (interactionTypeIdentifier.field.FieldRepetitions != null && interactionTypeIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            interactionTypeIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(interactionTypeIdentifier, fieldData);
        }
...
public HL7V27Field InteractionActiveState
{
    get
    {
        ...
        if (interactionActiveState.field.FieldRepetitions != null && interactionActiveState.field.FieldRepetitions.Count > 0)
        {
            ...
            interactionActiveState.fieldRepetitions = HL7V2FieldGenerator.GenerateV27FieldRepetitions(interactionActiveState, fieldData);
        }
