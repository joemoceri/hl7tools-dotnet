...
{
    public class HL7V26TriggerEventRQI_I01
    {
...
public HL7V26SegmentNTE nte{get; init;}
        ...
        public string EventDescription { get { return @"Request Insurance Information"; } }
        ...
        public HL7V26TriggerEventRQI_I01(HL7V2Message message)
        {
