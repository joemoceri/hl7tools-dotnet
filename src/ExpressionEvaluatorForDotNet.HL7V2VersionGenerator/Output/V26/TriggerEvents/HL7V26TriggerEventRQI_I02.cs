...
{
    public class HL7V26TriggerEventRQI_I02
    {
...
public readonly HL7V26SegmentNTE nte;
        ...
        public string EventDescription { get { return @"Request Patient Selection Display List"; } }
        ...
        public HL7V26TriggerEventRQI_I02(HL7V2Message message)
        {
