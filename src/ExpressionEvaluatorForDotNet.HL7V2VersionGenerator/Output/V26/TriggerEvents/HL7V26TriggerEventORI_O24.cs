...
{
    public class HL7V26TriggerEventORI_O24
    {
...
public readonly HL7V26SegmentNTE nte;
        ...
        public string EventDescription { get { return @"General Imaging Order Response"; } }
        ...
        public HL7V26TriggerEventORI_O24(HL7V2Message message)
        {
