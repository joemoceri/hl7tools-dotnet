...
{
    public class HL7V26TriggerEventMFK_M03
    {
...
public HL7V26SegmentMFA mfa{get; init;}
        ...
        public string EventDescription { get { return @"Test/Observation Master File Application Acknowledgment"; } }
        ...
        public HL7V26TriggerEventMFK_M03(HL7V2Message message)
        {
