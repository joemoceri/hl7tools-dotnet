...
{
    public class HL7V26TriggerEventRTB_Z76
    {
...
public readonly HL7V26SegmentDSC dsc;
        ...
        public string EventDescription { get { return @"Tabular response - Tabular Patient List"; } }
        ...
        public HL7V26TriggerEventRTB_Z76(HL7V2Message message)
        {
