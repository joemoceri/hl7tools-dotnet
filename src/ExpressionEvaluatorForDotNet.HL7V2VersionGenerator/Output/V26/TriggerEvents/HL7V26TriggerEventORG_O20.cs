...
{
    public class HL7V26TriggerEventORG_O20
    {
...
public readonly HL7V26SegmentNTE nte;
        ...
        public string EventDescription { get { return @"General Clinical Order Acknowledgement Response"; } }
        ...
        public HL7V26TriggerEventORG_O20(HL7V2Message message)
        {
