...
{
    public class HL7V26TriggerEventRPA_I08
    {
...
public HL7V26SegmentNTE nte{get; init;}
        ...
        public string EventDescription { get { return @"Return Treatment Authorization Information"; } }
        ...
        public HL7V26TriggerEventRPA_I08(HL7V2Message message)
        {
