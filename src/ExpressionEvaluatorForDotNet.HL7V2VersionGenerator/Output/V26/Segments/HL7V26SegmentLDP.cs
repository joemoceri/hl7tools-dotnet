...
The LDP segment identifies how a patient location room is being used by a certain department.  Multiple departments can use the same patient location, so there can be multiple LDP segments following an LOC segment.  There must be at least one LDP segment for each LOC segment.  This is not intended to include any current occupant information.  "; } }
        ...
        internal HL7V26Field _primaryKeyValueLDP;
...
public HL7V26Field PrimaryKeyValueLDP
{
    get
    {
        ...
        _primaryKeyValueLDP = new HL7V26Field
        {
            field = message[@"LDP"][1],
            fieldData = fieldData
        };
        ...
        {
            _primaryKeyValueLDP.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_primaryKeyValueLDP, fieldData);
        }
...
internal HL7V26Field _locationDepartment;
...
public HL7V26Field LocationDepartment
{
    get
    {
        ...
        _locationDepartment = new HL7V26Field
        {
            field = message[@"LDP"][2],
            fieldData = fieldData
        };
        ...
        {
            _locationDepartment.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_locationDepartment, fieldData);
        }
...
internal HL7V26Field _locationService;
...
public HL7V26Field LocationService
{
    get
    {
        ...
        _locationService = new HL7V26Field
        {
            field = message[@"LDP"][3],
            fieldData = fieldData
        };
        ...
        {
            _locationService.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_locationService, fieldData);
        }
...
internal HL7V26Field _specialtyType;
...
public HL7V26Field SpecialtyType
{
    get
    {
        ...
        _specialtyType = new HL7V26Field
        {
            field = message[@"LDP"][4],
            fieldData = fieldData
        };
        ...
        {
            _specialtyType.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_specialtyType, fieldData);
        }
...
internal HL7V26Field _activationDateLDP;
...
public HL7V26Field ActivationDateLDP
{
    get
    {
        ...
        _activationDateLDP = new HL7V26Field
        {
            field = message[@"LDP"][7],
            fieldData = fieldData
        };
        ...
        {
            _activationDateLDP.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_activationDateLDP, fieldData);
        }
...
internal HL7V26Field _inactivationDateLDP;
...
public HL7V26Field InactivationDateLDP
{
    get
    {
        ...
        _inactivationDateLDP = new HL7V26Field
        {
            field = message[@"LDP"][8],
            fieldData = fieldData
        };
        ...
        {
            _inactivationDateLDP.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_inactivationDateLDP, fieldData);
        }
...
internal HL7V26Field _inactivatedReason;
...
public HL7V26Field InactivatedReason
{
    get
    {
        ...
        _inactivatedReason = new HL7V26Field
        {
            field = message[@"LDP"][9],
            fieldData = fieldData
        };
        ...
        {
            _inactivatedReason.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_inactivatedReason, fieldData);
        }
...
internal HL7V26Field _visitingHours;
...
public HL7V26Field VisitingHours
{
    get
    {
        ...
        _visitingHours = new HL7V26Field
        {
        ...
        {
            _visitingHours.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_visitingHours, fieldData);
        }
...
internal HL7V26Field _contactPhone;
...
public HL7V26Field ContactPhone
{
    get
    {
        ...
        {
            _contactPhone.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_contactPhone, fieldData);
        }
...
internal HL7V26Field _locationCostCenter;
...
public HL7V26Field LocationCostCenter
{
    get
    {
        ...
        _locationCostCenter = new HL7V26Field
        {
        ...
        {
            _locationCostCenter.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_locationCostCenter, fieldData);
        }
