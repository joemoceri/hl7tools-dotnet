...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentLDP
    {
        ...
        public string Description { get { return @"The Technical Steward for the LDP segment is Patient Administration.
...
The LDP segment identifies how a patient location room is being used by a certain department.  Multiple departments can use the same patient location, so there can be multiple LDP segments following an LOC segment.  There must be at least one LDP segment for each LOC segment.  This is not intended to include any current occupant information.  "; } }
        ...
        public HL7V26SegmentLDP(HL7V2Message message)
        {
...
public HL7V26Field PrimaryKeyValueLDP
{
    get
    {
        ...
        primaryKeyValueLDP = new HL7V26Field
        {
            field = message[@"LDP"][1],
            Id = @"LDP.1",
            Type = @"Field",
        ...
        if (primaryKeyValueLDP.field.FieldRepetitions != null && primaryKeyValueLDP.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValueLDP.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(primaryKeyValueLDP, fieldData);
        }
...
internal HL7V26Field locationDepartment;

public HL7V26Field LocationDepartment
{
    get
    {
        ...
        locationDepartment = new HL7V26Field
        {
            field = message[@"LDP"][2],
            Id = @"LDP.2",
            Type = @"Field",
        ...
        if (locationDepartment.field.FieldRepetitions != null && locationDepartment.field.FieldRepetitions.Count > 0)
        {
            ...
            locationDepartment.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(locationDepartment, fieldData);
        }
...
internal HL7V26Field locationService;

public HL7V26Field LocationService
{
    get
    {
        ...
        locationService = new HL7V26Field
        {
            field = message[@"LDP"][3],
            Id = @"LDP.3",
            Type = @"Field",
        ...
        if (locationService.field.FieldRepetitions != null && locationService.field.FieldRepetitions.Count > 0)
        {
            ...
            locationService.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(locationService, fieldData);
        }
...
internal HL7V26Field specialtyType;

public HL7V26Field SpecialtyType
{
    get
    {
        ...
        if (specialtyType.field.FieldRepetitions != null && specialtyType.field.FieldRepetitions.Count > 0)
        {
            ...
            specialtyType.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(specialtyType, fieldData);
        }
...
internal HL7V26Field validPatientClasses;
...
public HL7V26Field ValidPatientClasses
{
    get
    {
        ...
        validPatientClasses = new HL7V26Field
        {
            field = message[@"LDP"][5],
            Id = @"LDP.5",
            Type = @"Field",
        ...
        if (validPatientClasses.field.FieldRepetitions != null && validPatientClasses.field.FieldRepetitions.Count > 0)
        {
            ...
            validPatientClasses.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(validPatientClasses, fieldData);
        }
...
internal HL7V26Field activationDateLDP;

public HL7V26Field ActivationDateLDP
{
    get
    {
        ...
        activationDateLDP = new HL7V26Field
        {
            field = message[@"LDP"][7],
            Id = @"LDP.7",
            Type = @"Field",
        ...
        if (activationDateLDP.field.FieldRepetitions != null && activationDateLDP.field.FieldRepetitions.Count > 0)
        {
            ...
            activationDateLDP.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(activationDateLDP, fieldData);
        }
...
internal HL7V26Field inactivationDateLDP;

public HL7V26Field InactivationDateLDP
{
    get
    {
        ...
        inactivationDateLDP = new HL7V26Field
        {
            field = message[@"LDP"][8],
            Id = @"LDP.8",
            Type = @"Field",
        ...
        if (inactivationDateLDP.field.FieldRepetitions != null && inactivationDateLDP.field.FieldRepetitions.Count > 0)
        {
            ...
            inactivationDateLDP.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(inactivationDateLDP, fieldData);
        }
...
internal HL7V26Field inactivatedReason;

public HL7V26Field InactivatedReason
{
    get
    {
        ...
        inactivatedReason = new HL7V26Field
        {
            field = message[@"LDP"][9],
            Id = @"LDP.9",
            Type = @"Field",
        ...
        if (inactivatedReason.field.FieldRepetitions != null && inactivatedReason.field.FieldRepetitions.Count > 0)
        {
            ...
            inactivatedReason.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(inactivatedReason, fieldData);
        }
...
internal HL7V26Field visitingHours;

public HL7V26Field VisitingHours
{
    get
    {
        ...
        if (visitingHours.field.FieldRepetitions != null && visitingHours.field.FieldRepetitions.Count > 0)
        {
            ...
            visitingHours.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(visitingHours, fieldData);
        }
...
internal HL7V26Field contactPhone;

public HL7V26Field ContactPhone
{
    get
    {
        ...
        if (contactPhone.field.FieldRepetitions != null && contactPhone.field.FieldRepetitions.Count > 0)
        {
            ...
            contactPhone.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(contactPhone, fieldData);
        }
...
internal HL7V26Field locationCostCenter;

public HL7V26Field LocationCostCenter
{
    get
    {
        ...
        locationCostCenter = new HL7V26Field
        {
        ...
        if (locationCostCenter.field.FieldRepetitions != null && locationCostCenter.field.FieldRepetitions.Count > 0)
        {
            ...
            locationCostCenter.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(locationCostCenter, fieldData);
        }
