...
public HL7V26Field SetIDAIG
{
    get
    {
        ...
        if (setIDAIG.field.FieldRepetitions != null && setIDAIG.field.FieldRepetitions.Count > 0)
        {
            ...
            setIDAIG.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(setIDAIG, fieldData);
        }
...
This field is optional for all query transactions.",
        ...
        if (resourceID.field.FieldRepetitions != null && resourceID.field.FieldRepetitions.Count > 0)
        {
            ...
            resourceID.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(resourceID, fieldData);
        }
...
public HL7V26Field ResourceQuantity
{
    get
    {
        ...
        if (resourceQuantity.field.FieldRepetitions != null && resourceQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            resourceQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(resourceQuantity, fieldData);
        }
...
public HL7V26Field ResourceQuantityUnits
{
    get
    {
        ...
        if (resourceQuantityUnits.field.FieldRepetitions != null && resourceQuantityUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            resourceQuantityUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(resourceQuantityUnits, fieldData);
        }
