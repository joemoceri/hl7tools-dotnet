...
public HL7V26Field Route
{
    get
    {
        ...
        if (route.field.FieldRepetitions != null && route.field.FieldRepetitions.Count > 0)
        {
            ...
            route.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(route, fieldData);
        }
...
internal HL7V26Field administrationSite;
...
public HL7V26Field AdministrationSite
{
    get
    {
        ...
        administrationSite = new HL7V26Field
        {
            field = message[@"RXR"][2],
            Id = @"RXR.2",
            Type = @"Field",
        ...
        if (administrationSite.field.FieldRepetitions != null && administrationSite.field.FieldRepetitions.Count > 0)
        {
            ...
            administrationSite.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(administrationSite, fieldData);
        }
...
internal HL7V26Field administrationDevice;
...
public HL7V26Field AdministrationDevice
{
    get
    {
        ...
        administrationDevice = new HL7V26Field
        {
            field = message[@"RXR"][3],
            Id = @"RXR.3",
            Type = @"Field",
        ...
        if (administrationDevice.field.FieldRepetitions != null && administrationDevice.field.FieldRepetitions.Count > 0)
        {
            ...
            administrationDevice.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(administrationDevice, fieldData);
        }
...
internal HL7V26Field administrationMethod;
...
public HL7V26Field AdministrationMethod
{
    get
    {
        ...
        administrationMethod = new HL7V26Field
        {
            field = message[@"RXR"][4],
            Id = @"RXR.4",
            Type = @"Field",
        ...
        if (administrationMethod.field.FieldRepetitions != null && administrationMethod.field.FieldRepetitions.Count > 0)
        {
            ...
            administrationMethod.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(administrationMethod, fieldData);
        }
...
internal HL7V26Field routingInstruction;
...
public HL7V26Field RoutingInstruction
{
    get
    {
        ...
        routingInstruction = new HL7V26Field
        {
            field = message[@"RXR"][5],
            Id = @"RXR.5",
            Type = @"Field",
        ...
        if (routingInstruction.field.FieldRepetitions != null && routingInstruction.field.FieldRepetitions.Count > 0)
        {
            ...
            routingInstruction.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(routingInstruction, fieldData);
        }
...
internal HL7V26Field administrationSiteModifier;
...
public HL7V26Field AdministrationSiteModifier
{
    get
    {
        ...
        administrationSiteModifier = new HL7V26Field
        {
            field = message[@"RXR"][6],
            Id = @"RXR.6",
            Type = @"Field",
        ...
        if (administrationSiteModifier.field.FieldRepetitions != null && administrationSiteModifier.field.FieldRepetitions.Count > 0)
        {
            ...
            administrationSiteModifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(administrationSiteModifier, fieldData);
        }
