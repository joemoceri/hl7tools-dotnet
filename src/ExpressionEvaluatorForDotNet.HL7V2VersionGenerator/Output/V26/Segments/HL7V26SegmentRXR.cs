...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentRXR
    {
        ...
        public HL7V26SegmentRXR(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V26Field _route;

public HL7V26Field Route
{
    get
    {
        if (_route != null)
        ...
        {
            _route.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_route, fieldData);
        }
...
internal HL7V26Field _administrationSite;

public HL7V26Field AdministrationSite
{
    get
    {
        ...
        _administrationSite = new HL7V26Field
        {
            field = message[@"RXR"][2],
            fieldData = fieldData
        };
        ...
        {
            _administrationSite.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_administrationSite, fieldData);
        }
...
internal HL7V26Field _administrationDevice;

public HL7V26Field AdministrationDevice
{
    get
    {
        ...
        _administrationDevice = new HL7V26Field
        {
            field = message[@"RXR"][3],
            fieldData = fieldData
        };
        ...
        {
            _administrationDevice.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_administrationDevice, fieldData);
        }
...
internal HL7V26Field _administrationMethod;

public HL7V26Field AdministrationMethod
{
    get
    {
        ...
        var fieldData = new HL7V26FieldData
        {
            ...
            Description = @"This field identifies the specific method requested for the administration of the drug or treatment to the patient. Refer To User-defined Table 0165 - Administration M ethod for valid values.",
            Sample = @"",
            Fields = new[]
                        {
                            new HL7V2FieldData
        ...
        _administrationMethod = new HL7V26Field
        {
            field = message[@"RXR"][4],
            fieldData = fieldData
        };
        ...
        {
            _administrationMethod.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_administrationMethod, fieldData);
        }
...
internal HL7V26Field _routingInstruction;

public HL7V26Field RoutingInstruction
{
    get
    {
        ...
        _routingInstruction = new HL7V26Field
        {
            field = message[@"RXR"][5],
            fieldData = fieldData
        };
        ...
        {
            _routingInstruction.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_routingInstruction, fieldData);
        }
...
internal HL7V26Field _administrationSiteModifier;

public HL7V26Field AdministrationSiteModifier
{
    get
    {
        ...
        _administrationSiteModifier = new HL7V26Field
        {
            field = message[@"RXR"][6],
            fieldData = fieldData
        };
        ...
        {
            _administrationSiteModifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_administrationSiteModifier, fieldData);
        }
