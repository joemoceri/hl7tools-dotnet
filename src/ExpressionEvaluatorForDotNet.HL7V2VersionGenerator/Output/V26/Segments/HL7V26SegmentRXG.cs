...
public HL7V26Field DispenseSubIDCounter
{
    get
    {
        ...
        if (dispenseSubIDCounter.field.FieldRepetitions != null && dispenseSubIDCounter.field.FieldRepetitions.Count > 0)
        {
            ...
            dispenseSubIDCounter.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(dispenseSubIDCounter, fieldData);
        }
...
public HL7V26Field DispensetoLocation
{
    get
    {
        ...
        if (dispensetoLocation.field.FieldRepetitions != null && dispensetoLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            dispensetoLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(dispensetoLocation, fieldData);
        }
...
public HL7V26Field PharmacyTreatmentSuppliersSpecialAdministrationInstructions
{
    get
    {
        ...
        if (pharmacyTreatmentSuppliersSpecialAdministrationInstructions.field.FieldRepetitions != null && pharmacyTreatmentSuppliersSpecialAdministrationInstructions.field.FieldRepetitions.Count > 0)
        {
            ...
            pharmacyTreatmentSuppliersSpecialAdministrationInstructions.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(pharmacyTreatmentSuppliersSpecialAdministrationInstructions, fieldData);
        }
...
public HL7V26Field GiveBarcodeIdentifier
{
    get
    {
        ...
        if (giveBarcodeIdentifier.field.FieldRepetitions != null && giveBarcodeIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            giveBarcodeIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(giveBarcodeIdentifier, fieldData);
        }
...
public HL7V26Field DispensetoPharmacy
{
    get
    {
        ...
        if (dispensetoPharmacy.field.FieldRepetitions != null && dispensetoPharmacy.field.FieldRepetitions.Count > 0)
        {
            ...
            dispensetoPharmacy.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(dispensetoPharmacy, fieldData);
        }
...
public HL7V26Field DispensetoPharmacyAddress
{
    get
    {
        ...
        if (dispensetoPharmacyAddress.field.FieldRepetitions != null && dispensetoPharmacyAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            dispensetoPharmacyAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(dispensetoPharmacyAddress, fieldData);
        }
