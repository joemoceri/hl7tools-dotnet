...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentFTS
    {
        ...
        public HL7V26SegmentFTS(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V26Field _fileBatchCount;

public HL7V26Field FileBatchCount
{
    get
    {
        ...
        _fileBatchCount = new HL7V26Field
        {
            field = message[@"FTS"][1],
            fieldData = fieldData
        };
        ...
        {
            _fileBatchCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_fileBatchCount, fieldData);
        }
...
internal HL7V26Field _fileTrailerComment;

public HL7V26Field FileTrailerComment
{
    get
    {
        ...
        _fileTrailerComment = new HL7V26Field
        {
            field = message[@"FTS"][2],
            fieldData = fieldData
        };
        ...
        {
            _fileTrailerComment.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_fileTrailerComment, fieldData);
        }
