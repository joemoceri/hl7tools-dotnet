...
public HL7V26Field ReferenceCommandNumber
{
    get
    {
        ...
        if (referenceCommandNumber.field.FieldRepetitions != null && referenceCommandNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            referenceCommandNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(referenceCommandNumber, fieldData);
        }
...
public HL7V26Field RemoteControlCommand
{
    get
    {
        ...
        if (remoteControlCommand.field.FieldRepetitions != null && remoteControlCommand.field.FieldRepetitions.Count > 0)
        {
            ...
            remoteControlCommand.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(remoteControlCommand, fieldData);
        }
...
public HL7V26Field ResponseRequired
{
    get
    {
        ...
        if (responseRequired.field.FieldRepetitions != null && responseRequired.field.FieldRepetitions.Count > 0)
        {
            ...
            responseRequired.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(responseRequired, fieldData);
        }
...
As of version 2.5 this field is defined for backward compatibility only.",
        ...
        if (requestedCompletionTime.field.FieldRepetitions != null && requestedCompletionTime.field.FieldRepetitions.Count > 0)
        {
            ...
            requestedCompletionTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(requestedCompletionTime, fieldData);
        }
...
Note:  	Elements of this segment (or other elements not defined here) may be required for certain vendor-specific equipment such as centrifuges, aliquoters, sorters, uncappers, recappers, automated storage units, etc.",
        ...
        if (parameters.field.FieldRepetitions != null && parameters.field.FieldRepetitions.Count > 0)
        {
            ...
            parameters.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(parameters, fieldData);
        }
