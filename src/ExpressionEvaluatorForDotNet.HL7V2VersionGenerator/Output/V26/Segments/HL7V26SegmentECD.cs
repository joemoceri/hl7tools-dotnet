...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentECD
    {
        ...
        internal HL7V26Field _referenceCommandNumber;
...
public HL7V26Field ReferenceCommandNumber
{
    get
    {
        ...
        _referenceCommandNumber = new HL7V26Field
        {
            field = message[@"ECD"][1],
            fieldData = fieldData
        };
        ...
        {
            _referenceCommandNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_referenceCommandNumber, fieldData);
        }
...
internal HL7V26Field _remoteControlCommand;
...
public HL7V26Field RemoteControlCommand
{
    get
    {
        ...
        _remoteControlCommand = new HL7V26Field
        {
            field = message[@"ECD"][2],
            fieldData = fieldData
        };
        ...
        {
            _remoteControlCommand.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_remoteControlCommand, fieldData);
        }
...
internal HL7V26Field _responseRequired;
...
public HL7V26Field ResponseRequired
{
    get
    {
        ...
        _responseRequired = new HL7V26Field
        {
            field = message[@"ECD"][3],
            fieldData = fieldData
        };
        ...
        {
            _responseRequired.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_responseRequired, fieldData);
        }
...
internal HL7V26Field _requestedCompletionTime;
...
The sequencing conditions supported by this 10th component are based on the completion of a predecessor service.",
        ...
        _requestedCompletionTime = new HL7V26Field
        {
            field = message[@"ECD"][4],
            fieldData = fieldData
        };
        ...
        {
            _requestedCompletionTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_requestedCompletionTime, fieldData);
        }
...
internal HL7V26Field _parameters;
...
Note:  	Elements of this segment (or other elements not defined here) may be required for certain vendor-specific equipment such as centrifuges, aliquoters, sorters, uncappers, recappers, automated storage units, etc.",
        ...
        {
            _parameters.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_parameters, fieldData);
        }
