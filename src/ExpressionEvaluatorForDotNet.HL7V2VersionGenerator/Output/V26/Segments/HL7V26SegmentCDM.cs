...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentCDM
    {
        ...
        public string Description { get { return @"The Technical Steward for the CDM segment is Financial Management.
...
The CDM segment contains the fields for identifying anything which is charged to patient accounts, including procedures, services, supplies.  It is intended to be used to maintain a list of valid chargeable utilization items.  Its purpose is to keep billing codes synchronized between HIS, Patient Accounting, and other departmental systems.  It is not intended to completely support materials management, inventory, or complex pricing structures for which additional complex fields would be required.  Given an identifying charge code, the associated fields in the charge description master file will provide basic pricing and billing data.  All the additional information necessary for patient accounting systems to do billing and claims is not intended to be included in this segment; those should be part of insurance or billing profile tables.  "; } }
        ...
        public HL7V26SegmentCDM(HL7V2Message message)
        {
...
internal HL7V26Field chargeCodeAlias;

public HL7V26Field ChargeCodeAlias
{
    get
    {
        ...
        chargeCodeAlias = new HL7V26Field
        {
            field = message[@"CDM"][2],
            Id = @"CDM.2",
            Type = @"Field",
...
internal HL7V26Field chargeDescriptionShort;

public HL7V26Field ChargeDescriptionShort
{
    get
    {
        ...
        chargeDescriptionShort = new HL7V26Field
        {
            field = message[@"CDM"][3],
            Id = @"CDM.3",
            Type = @"Field",
...
internal HL7V26Field chargeDescriptionLong;

public HL7V26Field ChargeDescriptionLong
{
    get
    {
        ...
        chargeDescriptionLong = new HL7V26Field
        {
            field = message[@"CDM"][4],
            Id = @"CDM.4",
            Type = @"Field",
...
internal HL7V26Field descriptionOverrideIndicator;

public HL7V26Field DescriptionOverrideIndicator
{
    get
    {
        ...
        descriptionOverrideIndicator = new HL7V26Field
        {
            field = message[@"CDM"][5],
            Id = @"CDM.5",
            Type = @"Field",
...
internal HL7V26Field explodingCharges;

public HL7V26Field ExplodingCharges
{
    get
    {
        ...
        explodingCharges = new HL7V26Field
        {
            field = message[@"CDM"][6],
            Id = @"CDM.6",
            Type = @"Field",
...
internal HL7V26Field inventoryNumber;

public HL7V26Field InventoryNumber
{
    get
    {
        ...
        inventoryNumber = new HL7V26Field
        {
            field = message[@"CDM"][9],
            Id = @"CDM.9",
            Type = @"Field",
...
internal HL7V26Field resourceLoad;

public HL7V26Field ResourceLoad
{
    get
    {
...
internal HL7V26Field contractNumber;

public HL7V26Field ContractNumber
{
    get
    {
        ...
        contractNumber = new HL7V26Field
        {
...
internal HL7V26Field contractOrganization;

public HL7V26Field ContractOrganization
{
    get
    {
        ...
        contractOrganization = new HL7V26Field
        {
...
internal HL7V26Field roomFeeIndicator;

public HL7V26Field RoomFeeIndicator
{
    get
    {
        ...
        roomFeeIndicator = new HL7V26Field
        {
