            ...
            get 
            {
                return new[]
                        ...
                        new HL7V2FieldData
                        {
                            ...
                            Description = @"This field contains the type of accident. Refer to User-defined Table 0050 - Accident Codefor suggested values. ICD accident codes are recommended.",
                            Sample = @"",
...
Used to specify an educational degree (e.g., MD). Refer to User-defined Table 0360 – Degree for suggested values.",
                        ...
                        new HL7V2FieldData
                        {
                            ...
                            TableId = @"0136",
                            TableName = @"Yes/no indicator",
                            Description = @"This field indicates if the police were notified. Refer to HL7 Table 0136 - Yes/No Indicator for valid values.",
                            Sample = @"",
                            FieldDatas = null
                        },
        ...
        public HL7V26SegmentACC(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V26Field accidentDateTime;

public HL7V26Field AccidentDateTime
{
    get
    {
        ...
        accidentDateTime = new HL7V26Field
        {
            field = message[@"ACC"][1],
            Id = @"ACC.1",
            Type = @"Field",
...
internal HL7V26Field accidentCode;

public HL7V26Field AccidentCode
{
    get
    {
...
internal HL7V26Field accidentLocation;

public HL7V26Field AccidentLocation
{
    get
    {
        ...
        accidentLocation = new HL7V26Field
        {
            field = message[@"ACC"][3],
            Id = @"ACC.3",
            Type = @"Field",
...
internal HL7V26Field autoAccidentState;

public HL7V26Field AutoAccidentState
{
    get
    {
        ...
        autoAccidentState = new HL7V26Field
        {
            field = message[@"ACC"][4],
            Id = @"ACC.4",
            Type = @"Field",
...
internal HL7V26Field accidentJobRelatedIndicator;

public HL7V26Field AccidentJobRelatedIndicator
{
    get
    {
        ...
        accidentJobRelatedIndicator = new HL7V26Field
        {
            field = message[@"ACC"][5],
            Id = @"ACC.5",
            Type = @"Field",
...
internal HL7V26Field accidentDeathIndicator;

public HL7V26Field AccidentDeathIndicator
{
    get
    {
        ...
        accidentDeathIndicator = new HL7V26Field
        {
            field = message[@"ACC"][6],
            Id = @"ACC.6",
            Type = @"Field",
...
internal HL7V26Field accidentDescription;

public HL7V26Field AccidentDescription
{
    get
    {
        ...
        accidentDescription = new HL7V26Field
        {
            field = message[@"ACC"][8],
            Id = @"ACC.8",
            Type = @"Field",
...
internal HL7V26Field broughtInBy;

public HL7V26Field BroughtInBy
{
    get
    {
        if (broughtInBy != null)
...
internal HL7V26Field policeNotifiedIndicator;

public HL7V26Field PoliceNotifiedIndicator
{
    get
    {
        ...
        policeNotifiedIndicator = new HL7V26Field
        {
...
internal HL7V26Field accidentAddress;

public HL7V26Field AccidentAddress
{
    get
    {
        ...
        accidentAddress = new HL7V26Field
        {
