...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentADD
    {
        ...
        public HL7V26SegmentADD(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V26Field _addendumContinuationPointer;

public HL7V26Field AddendumContinuationPointer
{
    get
    {
        ...
        _addendumContinuationPointer = new HL7V26Field
        {
            field = message[@"ADD"][1],
            fieldData = fieldData
        };
        ...
        {
            _addendumContinuationPointer.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_addendumContinuationPointer, fieldData);
        }
