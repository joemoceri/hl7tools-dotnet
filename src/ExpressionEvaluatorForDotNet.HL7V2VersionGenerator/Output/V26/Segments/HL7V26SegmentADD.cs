...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentADD
    {
        ...
        internal HL7V26Field addendumContinuationPointer;
...
public HL7V26Field AddendumContinuationPointer
{
    get
    {
        ...
        addendumContinuationPointer = new HL7V26Field
        {
            field = message[@"ADD"][1],
            Id = @"ADD.1",
            Type = @"Field",
        ...
        if (addendumContinuationPointer.field.FieldRepetitions != null && addendumContinuationPointer.field.FieldRepetitions.Count > 0)
        {
            ...
            addendumContinuationPointer.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(addendumContinuationPointer, fieldData);
        }
