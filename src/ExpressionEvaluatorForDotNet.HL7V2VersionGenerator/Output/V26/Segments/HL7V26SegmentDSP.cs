...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentDSP
    {
        ...
        internal HL7V26Field _setIDDSP;
...
public HL7V26Field SetIDDSP
{
    get
    {
        ...
        {
            _setIDDSP.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_setIDDSP, fieldData);
        }
...
internal HL7V26Field _displayLevel;
...
public HL7V26Field DisplayLevel
{
    get
    {
        ...
        {
            _displayLevel.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_displayLevel, fieldData);
        }
...
internal HL7V26Field _dataLine;
...
public HL7V26Field DataLine
{
    get
    {
        ...
        {
            _dataLine.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_dataLine, fieldData);
        }
...
internal HL7V26Field _logicalBreakPoint;
...
public HL7V26Field LogicalBreakPoint
{
    get
    {
        ...
        _logicalBreakPoint = new HL7V26Field
        {
            field = message[@"DSP"][4],
            fieldData = fieldData
        };
        ...
        {
            _logicalBreakPoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_logicalBreakPoint, fieldData);
        }
...
internal HL7V26Field _resultID;
...
public HL7V26Field ResultID
{
    get
    {
        ...
        {
            _resultID.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_resultID, fieldData);
        }
