...
Used to specify an educational degree (e.g., MD). Refer to User-defined Table 0360 – Degree for suggested values.",
        ...
        internal HL7V26Field rUDateTime;
...
public HL7V26Field RUDateTime
{
    get
    {
        ...
        if (rUDateTime.field.FieldRepetitions != null && rUDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            rUDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(rUDateTime, fieldData);
        }
...
internal HL7V26Field reportPriority;
...
public HL7V26Field ReportPriority
{
    get
    {
        ...
        reportPriority = new HL7V26Field
        {
            field = message[@"URD"][2],
            Id = @"URD.2",
            Type = @"Field",
        ...
        if (reportPriority.field.FieldRepetitions != null && reportPriority.field.FieldRepetitions.Count > 0)
        {
            ...
            reportPriority.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(reportPriority, fieldData);
        }
...
internal HL7V26Field rUWhoSubjectDefinition;
...
public HL7V26Field RUWhoSubjectDefinition
{
    get
    {
        ...
        rUWhoSubjectDefinition = new HL7V26Field
        {
            field = message[@"URD"][3],
            Id = @"URD.3",
            Type = @"Field",
        ...
        if (rUWhoSubjectDefinition.field.FieldRepetitions != null && rUWhoSubjectDefinition.field.FieldRepetitions.Count > 0)
        {
            ...
            rUWhoSubjectDefinition.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(rUWhoSubjectDefinition, fieldData);
        }
...
internal HL7V26Field rUWhatSubjectDefinition;
...
public HL7V26Field RUWhatSubjectDefinition
{
    get
    {
        ...
        rUWhatSubjectDefinition = new HL7V26Field
        {
            field = message[@"URD"][4],
            Id = @"URD.4",
            Type = @"Field",
        ...
        if (rUWhatSubjectDefinition.field.FieldRepetitions != null && rUWhatSubjectDefinition.field.FieldRepetitions.Count > 0)
        {
            ...
            rUWhatSubjectDefinition.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(rUWhatSubjectDefinition, fieldData);
        }
...
internal HL7V26Field rUWhatDepartmentCode;
...
public HL7V26Field RUWhatDepartmentCode
{
    get
    {
        ...
        rUWhatDepartmentCode = new HL7V26Field
        {
            field = message[@"URD"][5],
            Id = @"URD.5",
            Type = @"Field",
        ...
        if (rUWhatDepartmentCode.field.FieldRepetitions != null && rUWhatDepartmentCode.field.FieldRepetitions.Count > 0)
        {
            ...
            rUWhatDepartmentCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(rUWhatDepartmentCode, fieldData);
        }
...
internal HL7V26Field rUDisplayPrintLocations;
...
public HL7V26Field RUDisplayPrintLocations
{
    get
    {
        ...
        rUDisplayPrintLocations = new HL7V26Field
        {
            field = message[@"URD"][6],
            Id = @"URD.6",
            Type = @"Field",
        ...
        if (rUDisplayPrintLocations.field.FieldRepetitions != null && rUDisplayPrintLocations.field.FieldRepetitions.Count > 0)
        {
            ...
            rUDisplayPrintLocations.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(rUDisplayPrintLocations, fieldData);
        }
...
internal HL7V26Field rUResultsLevel;
...
public HL7V26Field RUResultsLevel
{
    get
    {
        ...
        rUResultsLevel = new HL7V26Field
        {
            field = message[@"URD"][7],
            Id = @"URD.7",
            Type = @"Field",
        ...
        if (rUResultsLevel.field.FieldRepetitions != null && rUResultsLevel.field.FieldRepetitions.Count > 0)
        {
            ...
            rUResultsLevel.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(rUResultsLevel, fieldData);
        }
