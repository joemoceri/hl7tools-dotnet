...
This segment is retained for backward compatibility only as of V2.4."; } }
        ...
        public HL7V26SegmentURD(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V26Field _rUDateTime;

public HL7V26Field RUDateTime
{
    get
    {
        if (_rUDateTime != null)
        ...
        {
            _rUDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_rUDateTime, fieldData);
        }
...
internal HL7V26Field _reportPriority;

public HL7V26Field ReportPriority
{
    get
    {
        ...
        _reportPriority = new HL7V26Field
        {
            field = message[@"URD"][2],
            fieldData = fieldData
        };
        ...
        {
            _reportPriority.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_reportPriority, fieldData);
        }
...
internal HL7V26Field _rUWhoSubjectDefinition;

public HL7V26Field RUWhoSubjectDefinition
{
    get
    {
...
Used to specify an educational degree (e.g., MD). Refer to User-defined Table 0360 – Degree for suggested values.",
        ...
        _rUWhoSubjectDefinition = new HL7V26Field
        {
            field = message[@"URD"][3],
            fieldData = fieldData
        };
        ...
        {
            _rUWhoSubjectDefinition.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_rUWhoSubjectDefinition, fieldData);
        }
...
internal HL7V26Field _rUWhatSubjectDefinition;

public HL7V26Field RUWhatSubjectDefinition
{
    get
    {
        ...
        _rUWhatSubjectDefinition = new HL7V26Field
        {
            field = message[@"URD"][4],
            fieldData = fieldData
        };
        ...
        {
            _rUWhatSubjectDefinition.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_rUWhatSubjectDefinition, fieldData);
        }
...
internal HL7V26Field _rUWhatDepartmentCode;

public HL7V26Field RUWhatDepartmentCode
{
    get
    {
        ...
        _rUWhatDepartmentCode = new HL7V26Field
        {
            field = message[@"URD"][5],
            fieldData = fieldData
        };
        ...
        {
            _rUWhatDepartmentCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_rUWhatDepartmentCode, fieldData);
        }
...
internal HL7V26Field _rUDisplayPrintLocations;

public HL7V26Field RUDisplayPrintLocations
{
    get
    {
        ...
        _rUDisplayPrintLocations = new HL7V26Field
        {
            field = message[@"URD"][6],
            fieldData = fieldData
        };
        ...
        {
            _rUDisplayPrintLocations.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_rUDisplayPrintLocations, fieldData);
        }
...
internal HL7V26Field _rUResultsLevel;

public HL7V26Field RUResultsLevel
{
    get
    {
        ...
        _rUResultsLevel = new HL7V26Field
        {
            field = message[@"URD"][7],
            fieldData = fieldData
        };
        ...
        {
            _rUResultsLevel.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_rUResultsLevel, fieldData);
        }
