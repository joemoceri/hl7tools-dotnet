...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentRMI
    {
        ...
        internal HL7V26Field riskManagementIncidentCode;
...
public HL7V26Field RiskManagementIncidentCode
{
    get
    {
        ...
        riskManagementIncidentCode = new HL7V26Field
        {
            field = message[@"RMI"][1],
            Id = @"RMI.1",
            Type = @"Field",
        ...
        if (riskManagementIncidentCode.field.FieldRepetitions != null && riskManagementIncidentCode.field.FieldRepetitions.Count > 0)
        {
            ...
            riskManagementIncidentCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(riskManagementIncidentCode, fieldData);
        }
...
internal HL7V26Field dateTimeIncident;
...
public HL7V26Field DateTimeIncident
{
    get
    {
        ...
        dateTimeIncident = new HL7V26Field
        {
            field = message[@"RMI"][2],
            Id = @"RMI.2",
            Type = @"Field",
        ...
        if (dateTimeIncident.field.FieldRepetitions != null && dateTimeIncident.field.FieldRepetitions.Count > 0)
        {
            ...
            dateTimeIncident.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(dateTimeIncident, fieldData);
        }
...
internal HL7V26Field incidentTypeCode;
...
public HL7V26Field IncidentTypeCode
{
    get
    {
        ...
        incidentTypeCode = new HL7V26Field
        {
            field = message[@"RMI"][3],
            Id = @"RMI.3",
            Type = @"Field",
        ...
        if (incidentTypeCode.field.FieldRepetitions != null && incidentTypeCode.field.FieldRepetitions.Count > 0)
        {
            ...
            incidentTypeCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(incidentTypeCode, fieldData);
        }
