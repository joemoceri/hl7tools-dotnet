...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentLCC
    {
        ...
        public string Description { get { return @"The Technical Steward for the LCC segment is PA.
...
The optional LCC segment identifies how a patient location room can be billed by a certain department.  A department can use different charge codes for the same room or bed, so there can be multiple LCC segments following an LDP segment."; } }
        ...
        public HL7V26SegmentLCC(HL7V2Message message)
        {
            this.message = message;
        }

        
internal HL7V26Field primaryKeyValueLCC;

public HL7V26Field PrimaryKeyValueLCC
{
    get
    {
        ...
        primaryKeyValueLCC = new HL7V26Field
        {
            field = message[@"LCC"][1],
            Id = @"LCC.1",
            Type = @"Field",
...
internal HL7V26Field accommodationType;

public HL7V26Field AccommodationType
{
    get
    {
        ...
        accommodationType = new HL7V26Field
        {
            field = message[@"LCC"][3],
            Id = @"LCC.3",
            Type = @"Field",
...
internal HL7V26Field chargeCode;

public HL7V26Field ChargeCode
{
    get
    {
        if (chargeCode != null)
