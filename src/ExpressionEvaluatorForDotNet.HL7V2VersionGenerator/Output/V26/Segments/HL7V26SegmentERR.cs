...
public HL7V26Field ErrorCodeandLocation
{
    get
    {
        ...
        if (errorCodeandLocation.field.FieldRepetitions != null && errorCodeandLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            errorCodeandLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(errorCodeandLocation, fieldData);
        }
...
public HL7V26Field ErrorLocation
{
    get
    {
        ...
        if (errorLocation.field.FieldRepetitions != null && errorLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            errorLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(errorLocation, fieldData);
        }
...
public HL7V26Field HL7ErrorCode
{
    get
    {
        ...
        if (hL7ErrorCode.field.FieldRepetitions != null && hL7ErrorCode.field.FieldRepetitions.Count > 0)
        {
            ...
            hL7ErrorCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(hL7ErrorCode, fieldData);
        }
...
public HL7V26Field Severity
{
    get
    {
        ...
        if (severity.field.FieldRepetitions != null && severity.field.FieldRepetitions.Count > 0)
        {
            ...
            severity.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(severity, fieldData);
        }
...
If the message associated with the code has parameters, it is recommended that the message be indicated in the format of the java text MessageFormat appproach. This style provides information on the paramter type to allow numbers, dates and times to be formatted appropriately for the language.",
        ...
        if (applicationErrorCode.field.FieldRepetitions != null && applicationErrorCode.field.FieldRepetitions.Count > 0)
        {
            ...
            applicationErrorCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(applicationErrorCode, fieldData);
        }
...
public HL7V26Field ApplicationErrorParameter
{
    get
    {
        ...
        if (applicationErrorParameter.field.FieldRepetitions != null && applicationErrorParameter.field.FieldRepetitions.Count > 0)
        {
            ...
            applicationErrorParameter.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(applicationErrorParameter, fieldData);
        }
...
public HL7V26Field DiagnosticInformation
{
    get
    {
        ...
        if (diagnosticInformation.field.FieldRepetitions != null && diagnosticInformation.field.FieldRepetitions.Count > 0)
        {
            ...
            diagnosticInformation.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(diagnosticInformation, fieldData);
        }
...
public HL7V26Field UserMessage
{
    get
    {
        ...
        if (userMessage.field.FieldRepetitions != null && userMessage.field.FieldRepetitions.Count > 0)
        {
            ...
            userMessage.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(userMessage, fieldData);
        }
...
public HL7V26Field InformPersonIndicator
{
    get
    {
        ...
        if (informPersonIndicator.field.FieldRepetitions != null && informPersonIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            informPersonIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(informPersonIndicator, fieldData);
        }
...
public HL7V26Field OverrideType
{
    get
    {
        ...
        if (overrideType.field.FieldRepetitions != null && overrideType.field.FieldRepetitions.Count > 0)
        {
            ...
            overrideType.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(overrideType, fieldData);
        }
...
public HL7V26Field OverrideReasonCode
{
    get
    {
        ...
        if (overrideReasonCode.field.FieldRepetitions != null && overrideReasonCode.field.FieldRepetitions.Count > 0)
        {
            ...
            overrideReasonCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(overrideReasonCode, fieldData);
        }
...
public HL7V26Field HelpDeskContactPoint
{
    get
    {
        ...
        if (helpDeskContactPoint.field.FieldRepetitions != null && helpDeskContactPoint.field.FieldRepetitions.Count > 0)
        {
            ...
            helpDeskContactPoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(helpDeskContactPoint, fieldData);
        }
