...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentNCK
    {
        ...
        internal HL7V26Field _systemDateTime;
...
public HL7V26Field SystemDateTime
{
    get
    {
        ...
        _systemDateTime = new HL7V26Field
        {
            field = message[@"NCK"][1],
            fieldData = fieldData
        };
        ...
        {
            _systemDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_systemDateTime, fieldData);
        }
