...
public HL7V26Field ExternalAccessionIdentifier
{
    get
    {
        ...
        if (externalAccessionIdentifier.field.FieldRepetitions != null && externalAccessionIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            externalAccessionIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(externalAccessionIdentifier, fieldData);
        }
...
The NCCLS standard requires a unique identifier for each container introduced into the Laboratory Automation System. The combination of the fields: Primary Container ID, Container ID, Carrier ID / Position, Tray ID / Position must identify the container uniquely within the LAS. The naturally best solution is unique machine-readable ID attached to the container (which of course is sufficient to ensure the uniqueness of the fields' combination). A bar code that symbolizes this ID should meet the proposed standard NCCLS AUTO2 (Laboratory Automation: Bar Codes for Specimen Container Identification).",
        ...
        if (containerIdentifier.field.FieldRepetitions != null && containerIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            containerIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(containerIdentifier, fieldData);
        }
...
public HL7V26Field PrimaryParentContainerIdentifier
{
    get
    {
        ...
        if (primaryParentContainerIdentifier.field.FieldRepetitions != null && primaryParentContainerIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryParentContainerIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(primaryParentContainerIdentifier, fieldData);
        }
...
public HL7V26Field EquipmentContainerIdentifier
{
    get
    {
        ...
        if (equipmentContainerIdentifier.field.FieldRepetitions != null && equipmentContainerIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            equipmentContainerIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(equipmentContainerIdentifier, fieldData);
        }
...
public HL7V26Field RegistrationDateTime
{
    get
    {
        ...
        if (registrationDateTime.field.FieldRepetitions != null && registrationDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            registrationDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(registrationDateTime, fieldData);
        }
...
public HL7V26Field ContainerStatus
{
    get
    {
        ...
        if (containerStatus.field.FieldRepetitions != null && containerStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            containerStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(containerStatus, fieldData);
        }
...
public HL7V26Field CarrierType
{
    get
    {
        ...
        if (carrierType.field.FieldRepetitions != null && carrierType.field.FieldRepetitions.Count > 0)
        {
            ...
            carrierType.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(carrierType, fieldData);
        }
...
public HL7V26Field CarrierIdentifier
{
    get
    {
        ...
        if (carrierIdentifier.field.FieldRepetitions != null && carrierIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            carrierIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(carrierIdentifier, fieldData);
        }
...
public HL7V26Field PositioninCarrier
{
    get
    {
        ...
        if (positioninCarrier.field.FieldRepetitions != null && positioninCarrier.field.FieldRepetitions.Count > 0)
        {
            ...
            positioninCarrier.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(positioninCarrier, fieldData);
        }
...
public HL7V26Field TrayTypeSAC
{
    get
    {
        ...
        if (trayTypeSAC.field.FieldRepetitions != null && trayTypeSAC.field.FieldRepetitions.Count > 0)
        {
            ...
            trayTypeSAC.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(trayTypeSAC, fieldData);
        }
...
public HL7V26Field TrayIdentifier
{
    get
    {
        ...
        if (trayIdentifier.field.FieldRepetitions != null && trayIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            trayIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(trayIdentifier, fieldData);
        }
...
public HL7V26Field PositioninTray
{
    get
    {
        ...
        if (positioninTray.field.FieldRepetitions != null && positioninTray.field.FieldRepetitions.Count > 0)
        {
            ...
            positioninTray.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(positioninTray, fieldData);
        }
...
public HL7V26Field Location
{
    get
    {
        ...
        if (location.field.FieldRepetitions != null && location.field.FieldRepetitions.Count > 0)
        {
            ...
            location.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(location, fieldData);
        }
...
public HL7V26Field ContainerHeight
{
    get
    {
        ...
        if (containerHeight.field.FieldRepetitions != null && containerHeight.field.FieldRepetitions.Count > 0)
        {
            ...
            containerHeight.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(containerHeight, fieldData);
        }
...
public HL7V26Field ContainerDiameter
{
    get
    {
        ...
        if (containerDiameter.field.FieldRepetitions != null && containerDiameter.field.FieldRepetitions.Count > 0)
        {
            ...
            containerDiameter.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(containerDiameter, fieldData);
        }
...
public HL7V26Field BarrierDelta
{
    get
    {
        ...
        if (barrierDelta.field.FieldRepetitions != null && barrierDelta.field.FieldRepetitions.Count > 0)
        {
            ...
            barrierDelta.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(barrierDelta, fieldData);
        }
...
public HL7V26Field BottomDelta
{
    get
    {
        ...
        if (bottomDelta.field.FieldRepetitions != null && bottomDelta.field.FieldRepetitions.Count > 0)
        {
            ...
            bottomDelta.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(bottomDelta, fieldData);
        }
...
public HL7V26Field ContainerHeightDiameterDeltaUnits
{
    get
    {
        ...
        if (containerHeightDiameterDeltaUnits.field.FieldRepetitions != null && containerHeightDiameterDeltaUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            containerHeightDiameterDeltaUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(containerHeightDiameterDeltaUnits, fieldData);
        }
...
public HL7V26Field ContainerVolume
{
    get
    {
        ...
        if (containerVolume.field.FieldRepetitions != null && containerVolume.field.FieldRepetitions.Count > 0)
        {
            ...
            containerVolume.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(containerVolume, fieldData);
        }
...
public HL7V26Field AvailableSpecimenVolume
{
    get
    {
        ...
        if (availableSpecimenVolume.field.FieldRepetitions != null && availableSpecimenVolume.field.FieldRepetitions.Count > 0)
        {
            ...
            availableSpecimenVolume.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(availableSpecimenVolume, fieldData);
        }
...
public HL7V26Field InitialSpecimenVolume
{
    get
    {
        ...
        if (initialSpecimenVolume.field.FieldRepetitions != null && initialSpecimenVolume.field.FieldRepetitions.Count > 0)
        {
            ...
            initialSpecimenVolume.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(initialSpecimenVolume, fieldData);
        }
...
public HL7V26Field VolumeUnits
{
    get
    {
        ...
        if (volumeUnits.field.FieldRepetitions != null && volumeUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            volumeUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(volumeUnits, fieldData);
        }
...
public HL7V26Field SeparatorType
{
    get
    {
        ...
        if (separatorType.field.FieldRepetitions != null && separatorType.field.FieldRepetitions.Count > 0)
        {
            ...
            separatorType.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(separatorType, fieldData);
        }
...
public HL7V26Field CapType
{
    get
    {
        ...
        if (capType.field.FieldRepetitions != null && capType.field.FieldRepetitions.Count > 0)
        {
            ...
            capType.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(capType, fieldData);
        }
...
public HL7V26Field Additive
{
    get
    {
        ...
        if (additive.field.FieldRepetitions != null && additive.field.FieldRepetitions.Count > 0)
        {
            ...
            additive.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(additive, fieldData);
        }
...
public HL7V26Field SpecimenComponent
{
    get
    {
        ...
        if (specimenComponent.field.FieldRepetitions != null && specimenComponent.field.FieldRepetitions.Count > 0)
        {
            ...
            specimenComponent.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(specimenComponent, fieldData);
        }
...
public HL7V26Field Treatment
{
    get
    {
        ...
        if (treatment.field.FieldRepetitions != null && treatment.field.FieldRepetitions.Count > 0)
        {
            ...
            treatment.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(treatment, fieldData);
        }
...
public HL7V26Field Temperature
{
    get
    {
        ...
        if (temperature.field.FieldRepetitions != null && temperature.field.FieldRepetitions.Count > 0)
        {
            ...
            temperature.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(temperature, fieldData);
        }
...
public HL7V26Field HemolysisIndex
{
    get
    {
        ...
        if (hemolysisIndex.field.FieldRepetitions != null && hemolysisIndex.field.FieldRepetitions.Count > 0)
        {
            ...
            hemolysisIndex.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(hemolysisIndex, fieldData);
        }
...
public HL7V26Field HemolysisIndexUnits
{
    get
    {
        ...
        if (hemolysisIndexUnits.field.FieldRepetitions != null && hemolysisIndexUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            hemolysisIndexUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(hemolysisIndexUnits, fieldData);
        }
...
public HL7V26Field LipemiaIndex
{
    get
    {
        ...
        if (lipemiaIndex.field.FieldRepetitions != null && lipemiaIndex.field.FieldRepetitions.Count > 0)
        {
            ...
            lipemiaIndex.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(lipemiaIndex, fieldData);
        }
...
public HL7V26Field LipemiaIndexUnits
{
    get
    {
        ...
        if (lipemiaIndexUnits.field.FieldRepetitions != null && lipemiaIndexUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            lipemiaIndexUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(lipemiaIndexUnits, fieldData);
        }
...
public HL7V26Field IcterusIndex
{
    get
    {
        ...
        if (icterusIndex.field.FieldRepetitions != null && icterusIndex.field.FieldRepetitions.Count > 0)
        {
            ...
            icterusIndex.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(icterusIndex, fieldData);
        }
...
public HL7V26Field IcterusIndexUnits
{
    get
    {
        ...
        if (icterusIndexUnits.field.FieldRepetitions != null && icterusIndexUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            icterusIndexUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(icterusIndexUnits, fieldData);
        }
...
public HL7V26Field FibrinIndex
{
    get
    {
        ...
        if (fibrinIndex.field.FieldRepetitions != null && fibrinIndex.field.FieldRepetitions.Count > 0)
        {
            ...
            fibrinIndex.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(fibrinIndex, fieldData);
        }
...
public HL7V26Field FibrinIndexUnits
{
    get
    {
        ...
        if (fibrinIndexUnits.field.FieldRepetitions != null && fibrinIndexUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            fibrinIndexUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(fibrinIndexUnits, fieldData);
        }
...
public HL7V26Field SystemInducedContaminants
{
    get
    {
        ...
        if (systemInducedContaminants.field.FieldRepetitions != null && systemInducedContaminants.field.FieldRepetitions.Count > 0)
        {
            ...
            systemInducedContaminants.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(systemInducedContaminants, fieldData);
        }
...
public HL7V26Field DrugInterference
{
    get
    {
        ...
        if (drugInterference.field.FieldRepetitions != null && drugInterference.field.FieldRepetitions.Count > 0)
        {
            ...
            drugInterference.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(drugInterference, fieldData);
        }
...
public HL7V26Field ArtificialBlood
{
    get
    {
        ...
        if (artificialBlood.field.FieldRepetitions != null && artificialBlood.field.FieldRepetitions.Count > 0)
        {
            ...
            artificialBlood.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(artificialBlood, fieldData);
        }
...
public HL7V26Field OtherEnvironmentalFactors
{
    get
    {
        ...
        if (otherEnvironmentalFactors.field.FieldRepetitions != null && otherEnvironmentalFactors.field.FieldRepetitions.Count > 0)
        {
            ...
            otherEnvironmentalFactors.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(otherEnvironmentalFactors, fieldData);
        }
