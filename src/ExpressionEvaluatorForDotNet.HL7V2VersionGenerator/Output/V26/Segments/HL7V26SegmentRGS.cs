...
public HL7V26Field SetIDRGS
{
    get
    {
        ...
        if (setIDRGS.field.FieldRepetitions != null && setIDRGS.field.FieldRepetitions.Count > 0)
        {
            ...
            setIDRGS.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(setIDRGS, fieldData);
        }
...
public HL7V26Field ResourceGroupID
{
    get
    {
        ...
        if (resourceGroupID.field.FieldRepetitions != null && resourceGroupID.field.FieldRepetitions.Count > 0)
        {
            ...
            resourceGroupID.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(resourceGroupID, fieldData);
        }
