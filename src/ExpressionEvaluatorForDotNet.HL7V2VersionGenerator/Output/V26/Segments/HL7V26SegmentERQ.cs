...
internal HL7V26Field eventIdentifier;
...
public HL7V26Field EventIdentifier
{
    get
    {
        ...
        eventIdentifier = new HL7V26Field
        {
            field = message[@"ERQ"][2],
            Id = @"ERQ.2",
            Type = @"Field",
        ...
        if (eventIdentifier.field.FieldRepetitions != null && eventIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            eventIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(eventIdentifier, fieldData);
        }
