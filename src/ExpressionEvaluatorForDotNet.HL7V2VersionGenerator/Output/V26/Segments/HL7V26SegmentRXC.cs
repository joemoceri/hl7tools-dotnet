...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentRXC
    {
        ...
        internal HL7V26Field _rXComponentType;
...
If any ""base"" components are present then these should be transmitted first.  The first ""base"" component in the transmission should be considered the ""primary base"" if such a distinction is necessary.  Similarly, the first ""additive"" in the transmission should be considered the ""primary additive"" if such a distinction is necessary.",
        ...
        _rXComponentType = new HL7V26Field
        {
            field = message[@"RXC"][1],
            fieldData = fieldData
        };
        ...
        {
            _rXComponentType.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_rXComponentType, fieldData);
        }
...
internal HL7V26Field _componentCode;
...
public HL7V26Field ComponentCode
{
    get
    {
        ...
        _componentCode = new HL7V26Field
        {
            field = message[@"RXC"][2],
            fieldData = fieldData
        };
        ...
        {
            _componentCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_componentCode, fieldData);
        }
...
internal HL7V26Field _componentAmount;
...
public HL7V26Field ComponentAmount
{
    get
    {
        ...
        _componentAmount = new HL7V26Field
        {
            field = message[@"RXC"][3],
            fieldData = fieldData
        };
        ...
        {
            _componentAmount.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_componentAmount, fieldData);
        }
...
internal HL7V26Field _componentUnits;
...
public HL7V26Field ComponentUnits
{
    get
    {
        ...
        _componentUnits = new HL7V26Field
        {
            field = message[@"RXC"][4],
            fieldData = fieldData
        };
        ...
        {
            _componentUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_componentUnits, fieldData);
        }
...
internal HL7V26Field _componentStrength;
...
public HL7V26Field ComponentStrength
{
    get
    {
        ...
        _componentStrength = new HL7V26Field
        {
            field = message[@"RXC"][5],
            fieldData = fieldData
        };
        ...
        {
            _componentStrength.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_componentStrength, fieldData);
        }
...
internal HL7V26Field _componentStrengthUnits;
...
public HL7V26Field ComponentStrengthUnits
{
    get
    {
        ...
        _componentStrengthUnits = new HL7V26Field
        {
            field = message[@"RXC"][6],
            fieldData = fieldData
        };
        ...
        {
            _componentStrengthUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_componentStrengthUnits, fieldData);
        }
...
internal HL7V26Field _componentDrugStrengthVolume;
...
RXC| | | | |120|mg^^ISO| |5|ml^^ISO ...<cr> ",
        ...
        _componentDrugStrengthVolume = new HL7V26Field
        {
            field = message[@"RXC"][8],
            fieldData = fieldData
        };
        ...
        {
            _componentDrugStrengthVolume.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_componentDrugStrengthVolume, fieldData);
        }
...
internal HL7V26Field _componentDrugStrengthVolumeUnits;
...
public HL7V26Field ComponentDrugStrengthVolumeUnits
{
    get
    {
        ...
        _componentDrugStrengthVolumeUnits = new HL7V26Field
        {
            field = message[@"RXC"][9],
            fieldData = fieldData
        };
        ...
        {
            _componentDrugStrengthVolumeUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_componentDrugStrengthVolumeUnits, fieldData);
        }
