...
public HL7V26Field SetIDAFF
{
    get
    {
        ...
        if (setIDAFF.field.FieldRepetitions != null && setIDAFF.field.FieldRepetitions.Count > 0)
        {
            ...
            setIDAFF.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(setIDAFF, fieldData);
        }
...
public HL7V26Field ProfessionalOrganization
{
    get
    {
        ...
        if (professionalOrganization.field.FieldRepetitions != null && professionalOrganization.field.FieldRepetitions.Count > 0)
        {
            ...
            professionalOrganization.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(professionalOrganization, fieldData);
        }
...
public HL7V26Field ProfessionalOrganizationAddress
{
    get
    {
        ...
        if (professionalOrganizationAddress.field.FieldRepetitions != null && professionalOrganizationAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            professionalOrganizationAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(professionalOrganizationAddress, fieldData);
        }
...
public HL7V26Field ProfessionalOrganizationAffiliationDateRange
{
    get
    {
        ...
        if (professionalOrganizationAffiliationDateRange.field.FieldRepetitions != null && professionalOrganizationAffiliationDateRange.field.FieldRepetitions.Count > 0)
        {
            ...
            professionalOrganizationAffiliationDateRange.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(professionalOrganizationAffiliationDateRange, fieldData);
        }
...
public HL7V26Field ProfessionalAffiliationAdditionalInformation
{
    get
    {
        ...
        if (professionalAffiliationAdditionalInformation.field.FieldRepetitions != null && professionalAffiliationAdditionalInformation.field.FieldRepetitions.Count > 0)
        {
            ...
            professionalAffiliationAdditionalInformation.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(professionalAffiliationAdditionalInformation, fieldData);
        }
