...
public HL7V26Field PrimaryKeyValuePRC
{
    get
    {
        ...
        primaryKeyValuePRC = new HL7V26Field
        {
            field = message[@"PRC"][1],
            Id = @"PRC.1",
            Type = @"Field",
        ...
        if (primaryKeyValuePRC.field.FieldRepetitions != null && primaryKeyValuePRC.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValuePRC.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(primaryKeyValuePRC, fieldData);
        }
...
internal HL7V26Field facilityIDPRC;
...
public HL7V26Field FacilityIDPRC
{
    get
    {
        ...
        if (facilityIDPRC.field.FieldRepetitions != null && facilityIDPRC.field.FieldRepetitions.Count > 0)
        {
            ...
            facilityIDPRC.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(facilityIDPRC, fieldData);
        }
...
public HL7V26Field Formula
{
    get
    {
        ...
        if (formula.field.FieldRepetitions != null && formula.field.FieldRepetitions.Count > 0)
        {
            ...
            formula.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(formula, fieldData);
        }
...
internal HL7V26Field minimumQuantity;
...
public HL7V26Field MinimumQuantity
{
    get
    {
        ...
        minimumQuantity = new HL7V26Field
        {
            field = message[@"PRC"][7],
            Id = @"PRC.7",
            Type = @"Field",
        ...
        if (minimumQuantity.field.FieldRepetitions != null && minimumQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            minimumQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(minimumQuantity, fieldData);
        }
...
internal HL7V26Field maximumQuantity;
...
public HL7V26Field MaximumQuantity
{
    get
    {
        ...
        maximumQuantity = new HL7V26Field
        {
            field = message[@"PRC"][8],
            Id = @"PRC.8",
            Type = @"Field",
        ...
        if (maximumQuantity.field.FieldRepetitions != null && maximumQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            maximumQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(maximumQuantity, fieldData);
        }
...
internal HL7V26Field minimumPrice;
...
public HL7V26Field MinimumPrice
{
    get
    {
        ...
        if (minimumPrice.field.FieldRepetitions != null && minimumPrice.field.FieldRepetitions.Count > 0)
        {
            ...
            minimumPrice.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(minimumPrice, fieldData);
        }
...
internal HL7V26Field maximumPrice;
...
public HL7V26Field MaximumPrice
{
    get
    {
        ...
        if (maximumPrice.field.FieldRepetitions != null && maximumPrice.field.FieldRepetitions.Count > 0)
        {
            ...
            maximumPrice.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(maximumPrice, fieldData);
        }
...
internal HL7V26Field effectiveEndDate;
...
public HL7V26Field EffectiveEndDate
{
    get
    {
        ...
        effectiveEndDate = new HL7V26Field
        {
        ...
        if (effectiveEndDate.field.FieldRepetitions != null && effectiveEndDate.field.FieldRepetitions.Count > 0)
        {
            ...
            effectiveEndDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(effectiveEndDate, fieldData);
        }
...
internal HL7V26Field priceOverrideFlag;
...
public HL7V26Field PriceOverrideFlag
{
    get
    {
        ...
        priceOverrideFlag = new HL7V26Field
        {
        ...
        if (priceOverrideFlag.field.FieldRepetitions != null && priceOverrideFlag.field.FieldRepetitions.Count > 0)
        {
            ...
            priceOverrideFlag.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(priceOverrideFlag, fieldData);
        }
...
internal HL7V26Field billingCategory;
...
public HL7V26Field BillingCategory
{
    get
    {
        ...
        billingCategory = new HL7V26Field
        {
        ...
        if (billingCategory.field.FieldRepetitions != null && billingCategory.field.FieldRepetitions.Count > 0)
        {
            ...
            billingCategory.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(billingCategory, fieldData);
        }
...
internal HL7V26Field chargeableFlag;
...
public HL7V26Field ChargeableFlag
{
    get
    {
        ...
        chargeableFlag = new HL7V26Field
        {
        ...
        if (chargeableFlag.field.FieldRepetitions != null && chargeableFlag.field.FieldRepetitions.Count > 0)
        {
            ...
            chargeableFlag.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(chargeableFlag, fieldData);
        }
...
public HL7V26Field Cost
{
    get
    {
        ...
        if (cost.field.FieldRepetitions != null && cost.field.FieldRepetitions.Count > 0)
        {
            ...
            cost.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(cost, fieldData);
        }
...
internal HL7V26Field chargeOnIndicator;
...
public HL7V26Field ChargeOnIndicator
{
    get
    {
        ...
        chargeOnIndicator = new HL7V26Field
        {
        ...
        if (chargeOnIndicator.field.FieldRepetitions != null && chargeOnIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            chargeOnIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(chargeOnIndicator, fieldData);
        }
