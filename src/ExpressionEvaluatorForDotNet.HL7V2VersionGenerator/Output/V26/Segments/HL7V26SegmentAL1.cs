...
public HL7V26Field SetIDAL1
{
    get
    {
        ...
        if (setIDAL1.field.FieldRepetitions != null && setIDAL1.field.FieldRepetitions.Count > 0)
        {
            ...
            setIDAL1.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(setIDAL1, fieldData);
        }
...
public HL7V26Field AllergenTypeCode
{
    get
    {
        ...
        if (allergenTypeCode.field.FieldRepetitions != null && allergenTypeCode.field.FieldRepetitions.Count > 0)
        {
            ...
            allergenTypeCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(allergenTypeCode, fieldData);
        }
...
public HL7V26Field AllergenCodeMnemonicDescription
{
    get
    {
        ...
        if (allergenCodeMnemonicDescription.field.FieldRepetitions != null && allergenCodeMnemonicDescription.field.FieldRepetitions.Count > 0)
        {
            ...
            allergenCodeMnemonicDescription.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(allergenCodeMnemonicDescription, fieldData);
        }
...
public HL7V26Field AllergySeverityCode
{
    get
    {
        ...
        if (allergySeverityCode.field.FieldRepetitions != null && allergySeverityCode.field.FieldRepetitions.Count > 0)
        {
            ...
            allergySeverityCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(allergySeverityCode, fieldData);
        }
...
public HL7V26Field AllergyReactionCode
{
    get
    {
        ...
        if (allergyReactionCode.field.FieldRepetitions != null && allergyReactionCode.field.FieldRepetitions.Count > 0)
        {
            ...
            allergyReactionCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(allergyReactionCode, fieldData);
        }
...
public HL7V26Field IdentificationDate
{
    get
    {
        ...
        if (identificationDate.field.FieldRepetitions != null && identificationDate.field.FieldRepetitions.Count > 0)
        {
            ...
            identificationDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(identificationDate, fieldData);
        }
