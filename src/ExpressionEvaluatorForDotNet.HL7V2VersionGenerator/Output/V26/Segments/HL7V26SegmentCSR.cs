...
public HL7V26Field SponsorStudyID
{
    get
    {
        ...
        if (sponsorStudyID.field.FieldRepetitions != null && sponsorStudyID.field.FieldRepetitions.Count > 0)
        {
            ...
            sponsorStudyID.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(sponsorStudyID, fieldData);
        }
...
public HL7V26Field AlternateStudyID
{
    get
    {
        ...
        if (alternateStudyID.field.FieldRepetitions != null && alternateStudyID.field.FieldRepetitions.Count > 0)
        {
            ...
            alternateStudyID.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(alternateStudyID, fieldData);
        }
...
internal HL7V26Field institutionRegisteringthePatient;
...
public HL7V26Field InstitutionRegisteringthePatient
{
    get
    {
        ...
        institutionRegisteringthePatient = new HL7V26Field
        {
            field = message[@"CSR"][3],
            Id = @"CSR.3",
            Type = @"Field",
        ...
        if (institutionRegisteringthePatient.field.FieldRepetitions != null && institutionRegisteringthePatient.field.FieldRepetitions.Count > 0)
        {
            ...
            institutionRegisteringthePatient.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(institutionRegisteringthePatient, fieldData);
        }
...
internal HL7V26Field sponsorPatientID;
...
public HL7V26Field SponsorPatientID
{
    get
    {
        ...
        sponsorPatientID = new HL7V26Field
        {
            field = message[@"CSR"][4],
            Id = @"CSR.4",
            Type = @"Field",
        ...
        if (sponsorPatientID.field.FieldRepetitions != null && sponsorPatientID.field.FieldRepetitions.Count > 0)
        {
            ...
            sponsorPatientID.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(sponsorPatientID, fieldData);
        }
...
internal HL7V26Field alternatePatientIDCSR;
...
public HL7V26Field AlternatePatientIDCSR
{
    get
    {
        ...
        alternatePatientIDCSR = new HL7V26Field
        {
            field = message[@"CSR"][5],
            Id = @"CSR.5",
            Type = @"Field",
        ...
        if (alternatePatientIDCSR.field.FieldRepetitions != null && alternatePatientIDCSR.field.FieldRepetitions.Count > 0)
        {
            ...
            alternatePatientIDCSR.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(alternatePatientIDCSR, fieldData);
        }
...
internal HL7V26Field dateTimeOfPatientStudyRegistration;
...
public HL7V26Field DateTimeOfPatientStudyRegistration
{
    get
    {
        ...
        dateTimeOfPatientStudyRegistration = new HL7V26Field
        {
            field = message[@"CSR"][6],
            Id = @"CSR.6",
            Type = @"Field",
        ...
        if (dateTimeOfPatientStudyRegistration.field.FieldRepetitions != null && dateTimeOfPatientStudyRegistration.field.FieldRepetitions.Count > 0)
        {
            ...
            dateTimeOfPatientStudyRegistration.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(dateTimeOfPatientStudyRegistration, fieldData);
        }
...
internal HL7V26Field personPerformingStudyRegistration;
...
public HL7V26Field PersonPerformingStudyRegistration
{
    get
    {
        ...
        personPerformingStudyRegistration = new HL7V26Field
        {
            field = message[@"CSR"][7],
            Id = @"CSR.7",
            Type = @"Field",
        ...
        if (personPerformingStudyRegistration.field.FieldRepetitions != null && personPerformingStudyRegistration.field.FieldRepetitions.Count > 0)
        {
            ...
            personPerformingStudyRegistration.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(personPerformingStudyRegistration, fieldData);
        }
...
internal HL7V26Field studyAuthorizingProvider;
...
public HL7V26Field StudyAuthorizingProvider
{
    get
    {
        ...
        studyAuthorizingProvider = new HL7V26Field
        {
            field = message[@"CSR"][8],
            Id = @"CSR.8",
            Type = @"Field",
        ...
        if (studyAuthorizingProvider.field.FieldRepetitions != null && studyAuthorizingProvider.field.FieldRepetitions.Count > 0)
        {
            ...
            studyAuthorizingProvider.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(studyAuthorizingProvider, fieldData);
        }
...
internal HL7V26Field datetimePatientStudyConsentSigned;
...
public HL7V26Field DatetimePatientStudyConsentSigned
{
    get
    {
        ...
        datetimePatientStudyConsentSigned = new HL7V26Field
        {
            field = message[@"CSR"][9],
            Id = @"CSR.9",
            Type = @"Field",
        ...
        if (datetimePatientStudyConsentSigned.field.FieldRepetitions != null && datetimePatientStudyConsentSigned.field.FieldRepetitions.Count > 0)
        {
            ...
            datetimePatientStudyConsentSigned.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(datetimePatientStudyConsentSigned, fieldData);
        }
...
internal HL7V26Field patientStudyEligibilityStatus;
...
public HL7V26Field PatientStudyEligibilityStatus
{
    get
    {
        ...
        patientStudyEligibilityStatus = new HL7V26Field
        {
        ...
        if (patientStudyEligibilityStatus.field.FieldRepetitions != null && patientStudyEligibilityStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            patientStudyEligibilityStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(patientStudyEligibilityStatus, fieldData);
        }
...
internal HL7V26Field studyRandomizationDatetime;
...
public HL7V26Field StudyRandomizationDatetime
{
    get
    {
        ...
        studyRandomizationDatetime = new HL7V26Field
        {
        ...
        if (studyRandomizationDatetime.field.FieldRepetitions != null && studyRandomizationDatetime.field.FieldRepetitions.Count > 0)
        {
            ...
            studyRandomizationDatetime.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(studyRandomizationDatetime, fieldData);
        }
...
internal HL7V26Field randomizedStudyArm;
...
public HL7V26Field RandomizedStudyArm
{
    get
    {
        ...
        randomizedStudyArm = new HL7V26Field
        {
        ...
        if (randomizedStudyArm.field.FieldRepetitions != null && randomizedStudyArm.field.FieldRepetitions.Count > 0)
        {
            ...
            randomizedStudyArm.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(randomizedStudyArm, fieldData);
        }
...
internal HL7V26Field stratumforStudyRandomization;
...
public HL7V26Field StratumforStudyRandomization
{
    get
    {
        ...
        stratumforStudyRandomization = new HL7V26Field
        {
        ...
        if (stratumforStudyRandomization.field.FieldRepetitions != null && stratumforStudyRandomization.field.FieldRepetitions.Count > 0)
        {
            ...
            stratumforStudyRandomization.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(stratumforStudyRandomization, fieldData);
        }
...
internal HL7V26Field patientEvaluabilityStatus;
...
public HL7V26Field PatientEvaluabilityStatus
{
    get
    {
        ...
        patientEvaluabilityStatus = new HL7V26Field
        {
        ...
        if (patientEvaluabilityStatus.field.FieldRepetitions != null && patientEvaluabilityStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            patientEvaluabilityStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(patientEvaluabilityStatus, fieldData);
        }
...
internal HL7V26Field dateTimeEndedStudy;
...
public HL7V26Field DateTimeEndedStudy
{
    get
    {
        ...
        dateTimeEndedStudy = new HL7V26Field
        {
        ...
        if (dateTimeEndedStudy.field.FieldRepetitions != null && dateTimeEndedStudy.field.FieldRepetitions.Count > 0)
        {
            ...
            dateTimeEndedStudy.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(dateTimeEndedStudy, fieldData);
        }
...
internal HL7V26Field reasonEndedStudy;
...
public HL7V26Field ReasonEndedStudy
{
    get
    {
        ...
        reasonEndedStudy = new HL7V26Field
        {
        ...
        if (reasonEndedStudy.field.FieldRepetitions != null && reasonEndedStudy.field.FieldRepetitions.Count > 0)
        {
            ...
            reasonEndedStudy.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(reasonEndedStudy, fieldData);
        }
