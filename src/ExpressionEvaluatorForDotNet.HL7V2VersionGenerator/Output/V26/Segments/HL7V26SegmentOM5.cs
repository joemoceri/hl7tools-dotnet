...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentOM5
    {
        ...
        public string Description { get { return @"The Technical Steward for the OM5 segment is Orders and Observations.
...
This segment contains the information about batteries and supersets (a nature code of F, P or S, as described in OM1-18 - Nature of Service/Test/Observation)."; } }
        ...
        public HL7V26SegmentOM5(HL7V2Message message)
        {
...
internal HL7V26Field _testObservationsIncludedWithinanOrderedTestBattery;

public HL7V26Field TestObservationsIncludedWithinanOrderedTestBattery
{
    get
    {
        ...
        _testObservationsIncludedWithinanOrderedTestBattery = new HL7V26Field
        {
            field = message[@"OM5"][2],
            fieldData = fieldData
        };
        ...
        {
            _testObservationsIncludedWithinanOrderedTestBattery.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_testObservationsIncludedWithinanOrderedTestBattery, fieldData);
        }
...
internal HL7V26Field _observationIDSuffixes;

public HL7V26Field ObservationIDSuffixes
{
    get
    {
        ...
        _observationIDSuffixes = new HL7V26Field
        {
            field = message[@"OM5"][3],
            fieldData = fieldData
        };
        ...
        {
            _observationIDSuffixes.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_observationIDSuffixes, fieldData);
        }
