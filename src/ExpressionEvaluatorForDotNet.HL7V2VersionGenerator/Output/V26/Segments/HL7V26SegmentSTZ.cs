...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentSTZ
    {
        ...
        internal HL7V26Field sterilizationType;
...
public HL7V26Field SterilizationType
{
    get
    {
        ...
        sterilizationType = new HL7V26Field
        {
            field = message[@"STZ"][1],
            Id = @"STZ.1",
            Type = @"Field",
        ...
        if (sterilizationType.field.FieldRepetitions != null && sterilizationType.field.FieldRepetitions.Count > 0)
        {
            ...
            sterilizationType.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(sterilizationType, fieldData);
        }
...
internal HL7V26Field sterilizationCycle;
...
public HL7V26Field SterilizationCycle
{
    get
    {
        ...
        sterilizationCycle = new HL7V26Field
        {
            field = message[@"STZ"][2],
            Id = @"STZ.2",
            Type = @"Field",
        ...
        if (sterilizationCycle.field.FieldRepetitions != null && sterilizationCycle.field.FieldRepetitions.Count > 0)
        {
            ...
            sterilizationCycle.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(sterilizationCycle, fieldData);
        }
...
internal HL7V26Field maintenanceCycle;
...
public HL7V26Field MaintenanceCycle
{
    get
    {
        ...
        maintenanceCycle = new HL7V26Field
        {
            field = message[@"STZ"][3],
            Id = @"STZ.3",
            Type = @"Field",
        ...
        if (maintenanceCycle.field.FieldRepetitions != null && maintenanceCycle.field.FieldRepetitions.Count > 0)
        {
            ...
            maintenanceCycle.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(maintenanceCycle, fieldData);
        }
...
internal HL7V26Field maintenanceType;
...
public HL7V26Field MaintenanceType
{
    get
    {
        ...
        maintenanceType = new HL7V26Field
        {
            field = message[@"STZ"][4],
            Id = @"STZ.4",
            Type = @"Field",
        ...
        if (maintenanceType.field.FieldRepetitions != null && maintenanceType.field.FieldRepetitions.Count > 0)
        {
            ...
            maintenanceType.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(maintenanceType, fieldData);
        }
