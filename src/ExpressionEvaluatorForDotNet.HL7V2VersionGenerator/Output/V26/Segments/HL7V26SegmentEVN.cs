...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentEVN
    {
        ...
        public HL7V26SegmentEVN(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V26Field _eventTypeCode;

public HL7V26Field EventTypeCode
{
    get
    {
        ...
        _eventTypeCode = new HL7V26Field
        {
            field = message[@"EVN"][1],
            fieldData = fieldData
        };
        ...
        {
            _eventTypeCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_eventTypeCode, fieldData);
        }
...
internal HL7V26Field _recordedDateTime;

public HL7V26Field RecordedDateTime
{
    get
    {
        ...
        _recordedDateTime = new HL7V26Field
        {
            field = message[@"EVN"][2],
            fieldData = fieldData
        };
        ...
        {
            _recordedDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_recordedDateTime, fieldData);
        }
...
internal HL7V26Field _dateTimePlannedEvent;

public HL7V26Field DateTimePlannedEvent
{
    get
    {
        ...
        _dateTimePlannedEvent = new HL7V26Field
        {
            field = message[@"EVN"][3],
            fieldData = fieldData
        };
        ...
        {
            _dateTimePlannedEvent.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_dateTimePlannedEvent, fieldData);
        }
...
internal HL7V26Field _eventReasonCode;

public HL7V26Field EventReasonCode
{
    get
    {
        ...
        _eventReasonCode = new HL7V26Field
        {
            field = message[@"EVN"][4],
            fieldData = fieldData
        };
        ...
        {
            _eventReasonCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_eventReasonCode, fieldData);
        }
...
internal HL7V26Field _operatorID;

public HL7V26Field OperatorID
{
    get
    {
        if (_operatorID != null)
...
Used to specify an educational degree (e.g., MD). Refer to User-defined Table 0360 – Degree for suggested values.",
        ...
        {
            _operatorID.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_operatorID, fieldData);
        }
...
internal HL7V26Field _eventOccurred;

public HL7V26Field EventOccurred
{
    get
    {
        ...
        _eventOccurred = new HL7V26Field
        {
            field = message[@"EVN"][6],
            fieldData = fieldData
        };
        ...
        {
            _eventOccurred.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_eventOccurred, fieldData);
        }
...
internal HL7V26Field _eventFacility;

public HL7V26Field EventFacility
{
    get
    {
        ...
        _eventFacility = new HL7V26Field
        {
            field = message[@"EVN"][7],
            fieldData = fieldData
        };
        ...
        {
            _eventFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_eventFacility, fieldData);
        }
