...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentRDT
    {
        ...
        internal HL7V26Field columnValue;
...
public HL7V26Field ColumnValue
{
    get
    {
        ...
        if (columnValue.field.FieldRepetitions != null && columnValue.field.FieldRepetitions.Count > 0)
        {
            ...
            columnValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(columnValue, fieldData);
        }
