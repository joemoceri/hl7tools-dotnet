...
public HL7V26Field SetIDCM2
{
    get
    {
        ...
        if (setIDCM2.field.FieldRepetitions != null && setIDCM2.field.FieldRepetitions.Count > 0)
        {
            ...
            setIDCM2.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(setIDCM2, fieldData);
        }
...
public HL7V26Field ScheduledTimePoint
{
    get
    {
        ...
        if (scheduledTimePoint.field.FieldRepetitions != null && scheduledTimePoint.field.FieldRepetitions.Count > 0)
        {
            ...
            scheduledTimePoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(scheduledTimePoint, fieldData);
        }
...
public HL7V26Field DescriptionofTimePoint
{
    get
    {
        ...
        if (descriptionofTimePoint.field.FieldRepetitions != null && descriptionofTimePoint.field.FieldRepetitions.Count > 0)
        {
            ...
            descriptionofTimePoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(descriptionofTimePoint, fieldData);
        }
...
public HL7V26Field EventsScheduledThisTimePoint
{
    get
    {
        ...
        if (eventsScheduledThisTimePoint.field.FieldRepetitions != null && eventsScheduledThisTimePoint.field.FieldRepetitions.Count > 0)
        {
            ...
            eventsScheduledThisTimePoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(eventsScheduledThisTimePoint, fieldData);
        }
