...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentCM2
    {
        ...
        public string Description { get { return @"The Technical Steward for the CM2 segment is Orders and Observations.
...
The Clinical Study Schedule Master (CM2) contains the information about the scheduled time points for study or phase-related treatment or evaluation events.  The fact that a patient has data satisfying a scheduled time point is sent in the CSS segment, sequence 2.  The CM2 segment describes the scheduled time points in general."; } }
        ...
        public HL7V26SegmentCM2(HL7V2Message message)
        {
...
internal HL7V26Field scheduledTimePoint;

public HL7V26Field ScheduledTimePoint
{
    get
    {
        ...
        scheduledTimePoint = new HL7V26Field
        {
            field = message[@"CM2"][2],
            Id = @"CM2.2",
            Type = @"Field",
...
internal HL7V26Field descriptionofTimePoint;

public HL7V26Field DescriptionofTimePoint
{
    get
    {
        ...
        descriptionofTimePoint = new HL7V26Field
        {
            field = message[@"CM2"][3],
            Id = @"CM2.3",
            Type = @"Field",
...
internal HL7V26Field eventsScheduledThisTimePoint;

public HL7V26Field EventsScheduledThisTimePoint
{
    get
    {
        ...
        eventsScheduledThisTimePoint = new HL7V26Field
        {
            field = message[@"CM2"][4],
            Id = @"CM2.4",
            Type = @"Field",
