...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentAPR
    {
        ...
        internal HL7V26Field timeSelectionCriteria;
...
public HL7V26Field TimeSelectionCriteria
{
    get
    {
        ...
        timeSelectionCriteria = new HL7V26Field
        {
            field = message[@"APR"][1],
            Id = @"APR.1",
            Type = @"Field",
        ...
        if (timeSelectionCriteria.field.FieldRepetitions != null && timeSelectionCriteria.field.FieldRepetitions.Count > 0)
        {
            ...
            timeSelectionCriteria.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(timeSelectionCriteria, fieldData);
        }
...
internal HL7V26Field resourceSelectionCriteria;
...
public HL7V26Field ResourceSelectionCriteria
{
    get
    {
        ...
        resourceSelectionCriteria = new HL7V26Field
        {
            field = message[@"APR"][2],
            Id = @"APR.2",
            Type = @"Field",
        ...
        if (resourceSelectionCriteria.field.FieldRepetitions != null && resourceSelectionCriteria.field.FieldRepetitions.Count > 0)
        {
            ...
            resourceSelectionCriteria.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(resourceSelectionCriteria, fieldData);
        }
...
internal HL7V26Field locationSelectionCriteria;
...
public HL7V26Field LocationSelectionCriteria
{
    get
    {
        ...
        locationSelectionCriteria = new HL7V26Field
        {
            field = message[@"APR"][3],
            Id = @"APR.3",
            Type = @"Field",
        ...
        if (locationSelectionCriteria.field.FieldRepetitions != null && locationSelectionCriteria.field.FieldRepetitions.Count > 0)
        {
            ...
            locationSelectionCriteria.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(locationSelectionCriteria, fieldData);
        }
...
internal HL7V26Field slotSpacingCriteria;
...
public HL7V26Field SlotSpacingCriteria
{
    get
    {
        ...
        slotSpacingCriteria = new HL7V26Field
        {
            field = message[@"APR"][4],
            Id = @"APR.4",
            Type = @"Field",
        ...
        if (slotSpacingCriteria.field.FieldRepetitions != null && slotSpacingCriteria.field.FieldRepetitions.Count > 0)
        {
            ...
            slotSpacingCriteria.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(slotSpacingCriteria, fieldData);
        }
...
internal HL7V26Field fillerOverrideCriteria;
...
public HL7V26Field FillerOverrideCriteria
{
    get
    {
        ...
        fillerOverrideCriteria = new HL7V26Field
        {
            field = message[@"APR"][5],
            Id = @"APR.5",
            Type = @"Field",
        ...
        if (fillerOverrideCriteria.field.FieldRepetitions != null && fillerOverrideCriteria.field.FieldRepetitions.Count > 0)
        {
            ...
            fillerOverrideCriteria.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(fillerOverrideCriteria, fieldData);
        }
