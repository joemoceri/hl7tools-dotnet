...
The LRL segment is used to identify one location's relationship to another location, the nearest lab, pharmacy, etc."; } }
        ...
        internal HL7V26Field primaryKeyValueLRL;
...
public HL7V26Field PrimaryKeyValueLRL
{
    get
    {
        ...
        primaryKeyValueLRL = new HL7V26Field
        {
            field = message[@"LRL"][1],
            Id = @"LRL.1",
            Type = @"Field",
        ...
        if (primaryKeyValueLRL.field.FieldRepetitions != null && primaryKeyValueLRL.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValueLRL.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(primaryKeyValueLRL, fieldData);
        }
...
public HL7V26Field SegmentUniqueKey
{
    get
    {
        ...
        if (segmentUniqueKey.field.FieldRepetitions != null && segmentUniqueKey.field.FieldRepetitions.Count > 0)
        {
            ...
            segmentUniqueKey.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(segmentUniqueKey, fieldData);
        }
...
internal HL7V26Field locationRelationshipID;
...
public HL7V26Field LocationRelationshipID
{
    get
    {
        ...
        locationRelationshipID = new HL7V26Field
        {
            field = message[@"LRL"][4],
            Id = @"LRL.4",
            Type = @"Field",
        ...
        if (locationRelationshipID.field.FieldRepetitions != null && locationRelationshipID.field.FieldRepetitions.Count > 0)
        {
            ...
            locationRelationshipID.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(locationRelationshipID, fieldData);
        }
...
internal HL7V26Field organizationalLocationRelationshipValue;
...
public HL7V26Field OrganizationalLocationRelationshipValue
{
    get
    {
        ...
        organizationalLocationRelationshipValue = new HL7V26Field
        {
            field = message[@"LRL"][5],
            Id = @"LRL.5",
            Type = @"Field",
        ...
        if (organizationalLocationRelationshipValue.field.FieldRepetitions != null && organizationalLocationRelationshipValue.field.FieldRepetitions.Count > 0)
        {
            ...
            organizationalLocationRelationshipValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(organizationalLocationRelationshipValue, fieldData);
        }
...
internal HL7V26Field patientLocationRelationshipValue;
...
public HL7V26Field PatientLocationRelationshipValue
{
    get
    {
        ...
        patientLocationRelationshipValue = new HL7V26Field
        {
            field = message[@"LRL"][6],
            Id = @"LRL.6",
            Type = @"Field",
        ...
        if (patientLocationRelationshipValue.field.FieldRepetitions != null && patientLocationRelationshipValue.field.FieldRepetitions.Count > 0)
        {
            ...
            patientLocationRelationshipValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(patientLocationRelationshipValue, fieldData);
        }
