...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentLRL
    {
        ...
        public string Description { get { return @"The Technical Steward for the LRL segment is Patient Administration.
...
The LRL segment is used to identify one location's relationship to another location, the nearest lab, pharmacy, etc."; } }
        ...
        public HL7V26SegmentLRL(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V26Field _primaryKeyValueLRL;

public HL7V26Field PrimaryKeyValueLRL
{
    get
    {
        ...
        _primaryKeyValueLRL = new HL7V26Field
        {
            field = message[@"LRL"][1],
            fieldData = fieldData
        };
        ...
        {
            _primaryKeyValueLRL.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_primaryKeyValueLRL, fieldData);
        }
...
internal HL7V26Field _segmentUniqueKey;
...
public HL7V26Field SegmentUniqueKey
{
    get
    {
        ...
        _segmentUniqueKey = new HL7V26Field
        {
            field = message[@"LRL"][3],
            fieldData = fieldData
        };
        ...
        {
            _segmentUniqueKey.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_segmentUniqueKey, fieldData);
        }
...
internal HL7V26Field _locationRelationshipID;

public HL7V26Field LocationRelationshipID
{
    get
    {
        ...
        _locationRelationshipID = new HL7V26Field
        {
            field = message[@"LRL"][4],
            fieldData = fieldData
        };
        ...
        {
            _locationRelationshipID.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_locationRelationshipID, fieldData);
        }
...
internal HL7V26Field _organizationalLocationRelationshipValue;

public HL7V26Field OrganizationalLocationRelationshipValue
{
    get
    {
        ...
        _organizationalLocationRelationshipValue = new HL7V26Field
        {
            field = message[@"LRL"][5],
            fieldData = fieldData
        };
        ...
        {
            _organizationalLocationRelationshipValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_organizationalLocationRelationshipValue, fieldData);
        }
...
internal HL7V26Field _patientLocationRelationshipValue;

public HL7V26Field PatientLocationRelationshipValue
{
    get
    {
        ...
        _patientLocationRelationshipValue = new HL7V26Field
        {
            field = message[@"LRL"][6],
            fieldData = fieldData
        };
        ...
        {
            _patientLocationRelationshipValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_patientLocationRelationshipValue, fieldData);
        }
