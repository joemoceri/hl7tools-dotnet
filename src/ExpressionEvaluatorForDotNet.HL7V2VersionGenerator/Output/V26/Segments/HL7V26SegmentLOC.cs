...
The LOC segment can identify any patient location referenced by information systems.  This segment gives physical set up information about the location.  This is not intended to include any current occupant or current use information.  There should be one LOC segment for each patient location.  If desired, there can also be one LOC segment for each nursing unit and room."; } }
        ...
        internal HL7V26Field _primaryKeyValueLOC;
...
public HL7V26Field PrimaryKeyValueLOC
{
    get
    {
        ...
        _primaryKeyValueLOC = new HL7V26Field
        {
            field = message[@"LOC"][1],
            fieldData = fieldData
        };
        ...
        {
            _primaryKeyValueLOC.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_primaryKeyValueLOC, fieldData);
        }
...
internal HL7V26Field _locationDescription;
...
public HL7V26Field LocationDescription
{
    get
    {
        ...
        _locationDescription = new HL7V26Field
        {
            field = message[@"LOC"][2],
            fieldData = fieldData
        };
        ...
        {
            _locationDescription.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_locationDescription, fieldData);
        }
...
internal HL7V26Field _locationTypeLOC;
...
public HL7V26Field LocationTypeLOC
{
    get
    {
        ...
        _locationTypeLOC = new HL7V26Field
        {
            field = message[@"LOC"][3],
            fieldData = fieldData
        };
        ...
        {
            _locationTypeLOC.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_locationTypeLOC, fieldData);
        }
...
internal HL7V26Field _organizationNameLOC;
...
public HL7V26Field OrganizationNameLOC
{
    get
    {
        ...
        _organizationNameLOC = new HL7V26Field
        {
            field = message[@"LOC"][4],
            fieldData = fieldData
        };
        ...
        {
            _organizationNameLOC.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_organizationNameLOC, fieldData);
        }
...
internal HL7V26Field _locationAddress;
...
public HL7V26Field LocationAddress
{
    get
    {
        ...
        _locationAddress = new HL7V26Field
        {
            field = message[@"LOC"][5],
            fieldData = fieldData
        };
        ...
        {
            _locationAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_locationAddress, fieldData);
        }
...
internal HL7V26Field _locationPhone;
...
public HL7V26Field LocationPhone
{
    get
    {
        ...
        _locationPhone = new HL7V26Field
        {
            field = message[@"LOC"][6],
            fieldData = fieldData
        };
        ...
        {
            _locationPhone.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_locationPhone, fieldData);
        }
...
internal HL7V26Field _licenseNumber;
...
public HL7V26Field LicenseNumber
{
    get
    {
        ...
        _licenseNumber = new HL7V26Field
        {
            field = message[@"LOC"][7],
            fieldData = fieldData
        };
        ...
        {
            _licenseNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_licenseNumber, fieldData);
        }
...
internal HL7V26Field _locationEquipment;
...
public HL7V26Field LocationEquipment
{
    get
    {
        ...
        _locationEquipment = new HL7V26Field
        {
            field = message[@"LOC"][8],
            fieldData = fieldData
        };
        ...
        {
            _locationEquipment.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_locationEquipment, fieldData);
        }
...
internal HL7V26Field _locationServiceCode;
...
public HL7V26Field LocationServiceCode
{
    get
    {
        ...
        _locationServiceCode = new HL7V26Field
        {
            field = message[@"LOC"][9],
            fieldData = fieldData
        };
        ...
        {
            _locationServiceCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_locationServiceCode, fieldData);
        }
