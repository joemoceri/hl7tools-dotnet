...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentLOC
    {
        ...
        public string Description { get { return @"The Technical Steward for the LOC segment is Patient Administration.
...
The LOC segment can identify any patient location referenced by information systems.  This segment gives physical set up information about the location.  This is not intended to include any current occupant or current use information.  There should be one LOC segment for each patient location.  If desired, there can also be one LOC segment for each nursing unit and room."; } }
        ...
        public HL7V26SegmentLOC(HL7V2Message message)
        {
            this.message = message;
        }

        
internal HL7V26Field primaryKeyValueLOC;

public HL7V26Field PrimaryKeyValueLOC
{
    get
    {
        ...
        primaryKeyValueLOC = new HL7V26Field
        {
            field = message[@"LOC"][1],
            Id = @"LOC.1",
            Type = @"Field",
...
internal HL7V26Field locationDescription;

public HL7V26Field LocationDescription
{
    get
    {
        ...
        locationDescription = new HL7V26Field
        {
            field = message[@"LOC"][2],
            Id = @"LOC.2",
            Type = @"Field",
...
internal HL7V26Field locationTypeLOC;

public HL7V26Field LocationTypeLOC
{
    get
    {
        ...
        locationTypeLOC = new HL7V26Field
        {
            field = message[@"LOC"][3],
            Id = @"LOC.3",
            Type = @"Field",
...
internal HL7V26Field organizationNameLOC;

public HL7V26Field OrganizationNameLOC
{
    get
    {
        ...
        organizationNameLOC = new HL7V26Field
        {
            field = message[@"LOC"][4],
            Id = @"LOC.4",
            Type = @"Field",
...
internal HL7V26Field locationAddress;

public HL7V26Field LocationAddress
{
    get
    {
        ...
        locationAddress = new HL7V26Field
        {
            field = message[@"LOC"][5],
            Id = @"LOC.5",
            Type = @"Field",
...
internal HL7V26Field locationPhone;

public HL7V26Field LocationPhone
{
    get
    {
...
internal HL7V26Field licenseNumber;

public HL7V26Field LicenseNumber
{
    get
    {
...
internal HL7V26Field locationEquipment;

public HL7V26Field LocationEquipment
{
    get
    {
        ...
        locationEquipment = new HL7V26Field
        {
            field = message[@"LOC"][8],
            Id = @"LOC.8",
            Type = @"Field",
...
internal HL7V26Field locationServiceCode;

public HL7V26Field LocationServiceCode
{
    get
    {
        ...
        locationServiceCode = new HL7V26Field
        {
            field = message[@"LOC"][9],
            Id = @"LOC.9",
            Type = @"Field",
