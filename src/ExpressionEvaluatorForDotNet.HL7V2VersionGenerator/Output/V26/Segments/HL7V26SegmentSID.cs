...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentSID
    {
        ...
        public HL7V26SegmentSID(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V26Field applicationMethodIdentifier;

public HL7V26Field ApplicationMethodIdentifier
{
    get
    {
        ...
        applicationMethodIdentifier = new HL7V26Field
        {
            field = message[@"SID"][1],
            Id = @"SID.1",
            Type = @"Field",
        ...
        if (applicationMethodIdentifier.field.FieldRepetitions != null && applicationMethodIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            applicationMethodIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(applicationMethodIdentifier, fieldData);
        }
...
internal HL7V26Field substanceContainerIdentifier;

public HL7V26Field SubstanceContainerIdentifier
{
    get
    {
        ...
        substanceContainerIdentifier = new HL7V26Field
        {
            field = message[@"SID"][3],
            Id = @"SID.3",
            Type = @"Field",
        ...
        if (substanceContainerIdentifier.field.FieldRepetitions != null && substanceContainerIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            substanceContainerIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(substanceContainerIdentifier, fieldData);
        }
...
internal HL7V26Field substanceManufacturerIdentifier;

public HL7V26Field SubstanceManufacturerIdentifier
{
    get
    {
        ...
        substanceManufacturerIdentifier = new HL7V26Field
        {
            field = message[@"SID"][4],
            Id = @"SID.4",
            Type = @"Field",
        ...
        if (substanceManufacturerIdentifier.field.FieldRepetitions != null && substanceManufacturerIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            substanceManufacturerIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(substanceManufacturerIdentifier, fieldData);
        }
