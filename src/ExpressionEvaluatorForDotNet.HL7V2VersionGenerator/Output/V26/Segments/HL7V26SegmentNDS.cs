...
public HL7V26Field NotificationReferenceNumber
{
    get
    {
        ...
        if (notificationReferenceNumber.field.FieldRepetitions != null && notificationReferenceNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            notificationReferenceNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(notificationReferenceNumber, fieldData);
        }
...
public HL7V26Field NotificationDateTime
{
    get
    {
        ...
        if (notificationDateTime.field.FieldRepetitions != null && notificationDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            notificationDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(notificationDateTime, fieldData);
        }
...
public HL7V26Field NotificationAlertSeverity
{
    get
    {
        ...
        if (notificationAlertSeverity.field.FieldRepetitions != null && notificationAlertSeverity.field.FieldRepetitions.Count > 0)
        {
            ...
            notificationAlertSeverity.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(notificationAlertSeverity, fieldData);
        }
...
public HL7V26Field NotificationCode
{
    get
    {
        ...
        if (notificationCode.field.FieldRepetitions != null && notificationCode.field.FieldRepetitions.Count > 0)
        {
            ...
            notificationCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(notificationCode, fieldData);
        }
