...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentRDF
    {
        ...
        internal HL7V26Field _numberofColumnsperRow;
...
public HL7V26Field NumberofColumnsperRow
{
    get
    {
        ...
        _numberofColumnsperRow = new HL7V26Field
        {
            field = message[@"RDF"][1],
            fieldData = fieldData
        };
        ...
        {
            _numberofColumnsperRow.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_numberofColumnsperRow, fieldData);
        }
...
internal HL7V26Field _columnDescription;
...
The maximum width of the column, as dictated by the responding system.  (This may vary from the HL7-defined maximum field length.)",
        ...
        _columnDescription = new HL7V26Field
        {
            field = message[@"RDF"][2],
            fieldData = fieldData
        };
        ...
        {
            _columnDescription.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_columnDescription, fieldData);
        }
