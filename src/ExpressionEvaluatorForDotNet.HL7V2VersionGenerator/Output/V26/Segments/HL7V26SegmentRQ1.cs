...
public HL7V26Field AnticipatedPrice
{
    get
    {
        ...
        if (anticipatedPrice.field.FieldRepetitions != null && anticipatedPrice.field.FieldRepetitions.Count > 0)
        {
            ...
            anticipatedPrice.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(anticipatedPrice, fieldData);
        }
...
public HL7V26Field ManufacturersCatalog
{
    get
    {
        ...
        if (manufacturersCatalog.field.FieldRepetitions != null && manufacturersCatalog.field.FieldRepetitions.Count > 0)
        {
            ...
            manufacturersCatalog.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(manufacturersCatalog, fieldData);
        }
...
public HL7V26Field VendorID
{
    get
    {
        ...
        if (vendorID.field.FieldRepetitions != null && vendorID.field.FieldRepetitions.Count > 0)
        {
            ...
            vendorID.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(vendorID, fieldData);
        }
...
public HL7V26Field VendorCatalog
{
    get
    {
        ...
        if (vendorCatalog.field.FieldRepetitions != null && vendorCatalog.field.FieldRepetitions.Count > 0)
        {
            ...
            vendorCatalog.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(vendorCatalog, fieldData);
        }
...
public HL7V26Field Taxable
{
    get
    {
        ...
        if (taxable.field.FieldRepetitions != null && taxable.field.FieldRepetitions.Count > 0)
        {
            ...
            taxable.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(taxable, fieldData);
        }
...
public HL7V26Field SubstituteAllowed
{
    get
    {
        ...
        if (substituteAllowed.field.FieldRepetitions != null && substituteAllowed.field.FieldRepetitions.Count > 0)
        {
            ...
            substituteAllowed.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(substituteAllowed, fieldData);
        }
