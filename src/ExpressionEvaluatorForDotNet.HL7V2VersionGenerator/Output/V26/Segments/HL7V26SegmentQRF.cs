...
This segment is retained for backward compatibility as of V2.4.  "; } }
        ...
        public HL7V26SegmentQRF(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V26Field _whereSubjectFilter;
...
public HL7V26Field WhereSubjectFilter
{
    get
    {
        ...
        _whereSubjectFilter = new HL7V26Field
        {
            field = message[@"QRF"][1],
            fieldData = fieldData
        };
        ...
        {
            _whereSubjectFilter.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_whereSubjectFilter, fieldData);
        }
...
internal HL7V26Field _whenDataStartDateTime;

public HL7V26Field WhenDataStartDateTime
{
    get
    {
        ...
        _whenDataStartDateTime = new HL7V26Field
        {
            field = message[@"QRF"][2],
            fieldData = fieldData
        };
        ...
        {
            _whenDataStartDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_whenDataStartDateTime, fieldData);
        }
...
internal HL7V26Field _whenDataEndDateTime;

public HL7V26Field WhenDataEndDateTime
{
    get
    {
        ...
        _whenDataEndDateTime = new HL7V26Field
        {
            field = message[@"QRF"][3],
            fieldData = fieldData
        };
        ...
        {
            _whenDataEndDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_whenDataEndDateTime, fieldData);
        }
...
internal HL7V26Field _whatUserQualifier;

public HL7V26Field WhatUserQualifier
{
    get
    {
        ...
        _whatUserQualifier = new HL7V26Field
        {
            field = message[@"QRF"][4],
            fieldData = fieldData
        };
        ...
        {
            _whatUserQualifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_whatUserQualifier, fieldData);
        }
...
internal HL7V26Field _otherQRYSubjectFilter;

public HL7V26Field OtherQRYSubjectFilter
{
    get
    {
        ...
        _otherQRYSubjectFilter = new HL7V26Field
        {
            field = message[@"QRF"][5],
            fieldData = fieldData
        };
        ...
        {
            _otherQRYSubjectFilter.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_otherQRYSubjectFilter, fieldData);
        }
...
internal HL7V26Field _whichDateTimeQualifier;

public HL7V26Field WhichDateTimeQualifier
{
    get
    {
        ...
        _whichDateTimeQualifier = new HL7V26Field
        {
            field = message[@"QRF"][6],
            fieldData = fieldData
        };
        ...
        {
            _whichDateTimeQualifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_whichDateTimeQualifier, fieldData);
        }
...
internal HL7V26Field _whichDateTimeStatusQualifier;

public HL7V26Field WhichDateTimeStatusQualifier
{
    get
    {
        ...
        _whichDateTimeStatusQualifier = new HL7V26Field
        {
            field = message[@"QRF"][7],
            fieldData = fieldData
        };
        ...
        {
            _whichDateTimeStatusQualifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_whichDateTimeStatusQualifier, fieldData);
        }
...
internal HL7V26Field _dateTimeSelectionQualifier;

public HL7V26Field DateTimeSelectionQualifier
{
    get
    {
        ...
        _dateTimeSelectionQualifier = new HL7V26Field
        {
            field = message[@"QRF"][8],
            fieldData = fieldData
        };
        ...
        {
            _dateTimeSelectionQualifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_dateTimeSelectionQualifier, fieldData);
        }
...
internal HL7V26Field _whenQuantityTimingQualifier;

public HL7V26Field WhenQuantityTimingQualifier
{
    get
    {
...
The sequencing conditions supported by this 10th component are based on the completion of a predecessor service.",
        ...
        _whenQuantityTimingQualifier = new HL7V26Field
        {
            field = message[@"QRF"][9],
            fieldData = fieldData
        };
        ...
        {
            _whenQuantityTimingQualifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_whenQuantityTimingQualifier, fieldData);
        }
...
internal HL7V26Field _searchConfidenceThreshold;

public HL7V26Field SearchConfidenceThreshold
{
    get
    {
        ...
        _searchConfidenceThreshold = new HL7V26Field
        {
        ...
        {
            _searchConfidenceThreshold.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_searchConfidenceThreshold, fieldData);
        }
