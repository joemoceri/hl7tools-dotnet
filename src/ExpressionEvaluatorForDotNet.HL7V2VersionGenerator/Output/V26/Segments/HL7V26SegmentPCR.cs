...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentPCR
    {
        ...
        internal HL7V26Field implicatedProduct;
...
public HL7V26Field ImplicatedProduct
{
    get
    {
        ...
        implicatedProduct = new HL7V26Field
        {
            field = message[@"PCR"][1],
            Id = @"PCR.1",
            Type = @"Field",
        ...
        if (implicatedProduct.field.FieldRepetitions != null && implicatedProduct.field.FieldRepetitions.Count > 0)
        {
            ...
            implicatedProduct.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(implicatedProduct, fieldData);
        }
...
internal HL7V26Field genericProduct;
...
public HL7V26Field GenericProduct
{
    get
    {
        ...
        genericProduct = new HL7V26Field
        {
            field = message[@"PCR"][2],
            Id = @"PCR.2",
            Type = @"Field",
        ...
        if (genericProduct.field.FieldRepetitions != null && genericProduct.field.FieldRepetitions.Count > 0)
        {
            ...
            genericProduct.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(genericProduct, fieldData);
        }
...
internal HL7V26Field productClass;
...
public HL7V26Field ProductClass
{
    get
    {
        ...
        if (productClass.field.FieldRepetitions != null && productClass.field.FieldRepetitions.Count > 0)
        {
            ...
            productClass.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(productClass, fieldData);
        }
...
internal HL7V26Field totalDurationOfTherapy;
...
public HL7V26Field TotalDurationOfTherapy
{
    get
    {
        ...
        totalDurationOfTherapy = new HL7V26Field
        {
            field = message[@"PCR"][4],
            Id = @"PCR.4",
            Type = @"Field",
        ...
        if (totalDurationOfTherapy.field.FieldRepetitions != null && totalDurationOfTherapy.field.FieldRepetitions.Count > 0)
        {
            ...
            totalDurationOfTherapy.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(totalDurationOfTherapy, fieldData);
        }
...
internal HL7V26Field productManufactureDate;
...
public HL7V26Field ProductManufactureDate
{
    get
    {
        ...
        productManufactureDate = new HL7V26Field
        {
            field = message[@"PCR"][5],
            Id = @"PCR.5",
            Type = @"Field",
        ...
        if (productManufactureDate.field.FieldRepetitions != null && productManufactureDate.field.FieldRepetitions.Count > 0)
        {
            ...
            productManufactureDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(productManufactureDate, fieldData);
        }
...
internal HL7V26Field productExpirationDate;
...
public HL7V26Field ProductExpirationDate
{
    get
    {
        ...
        productExpirationDate = new HL7V26Field
        {
            field = message[@"PCR"][6],
            Id = @"PCR.6",
            Type = @"Field",
        ...
        if (productExpirationDate.field.FieldRepetitions != null && productExpirationDate.field.FieldRepetitions.Count > 0)
        {
            ...
            productExpirationDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(productExpirationDate, fieldData);
        }
...
internal HL7V26Field productImplantationDate;
...
public HL7V26Field ProductImplantationDate
{
    get
    {
        ...
        productImplantationDate = new HL7V26Field
        {
            field = message[@"PCR"][7],
            Id = @"PCR.7",
            Type = @"Field",
        ...
        if (productImplantationDate.field.FieldRepetitions != null && productImplantationDate.field.FieldRepetitions.Count > 0)
        {
            ...
            productImplantationDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(productImplantationDate, fieldData);
        }
...
internal HL7V26Field productExplantationDate;
...
public HL7V26Field ProductExplantationDate
{
    get
    {
        ...
        productExplantationDate = new HL7V26Field
        {
            field = message[@"PCR"][8],
            Id = @"PCR.8",
            Type = @"Field",
        ...
        if (productExplantationDate.field.FieldRepetitions != null && productExplantationDate.field.FieldRepetitions.Count > 0)
        {
            ...
            productExplantationDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(productExplantationDate, fieldData);
        }
...
internal HL7V26Field singleUseDevice;
...
public HL7V26Field SingleUseDevice
{
    get
    {
        ...
        singleUseDevice = new HL7V26Field
        {
            field = message[@"PCR"][9],
            Id = @"PCR.9",
            Type = @"Field",
        ...
        if (singleUseDevice.field.FieldRepetitions != null && singleUseDevice.field.FieldRepetitions.Count > 0)
        {
            ...
            singleUseDevice.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(singleUseDevice, fieldData);
        }
...
internal HL7V26Field indicationForProductUse;
...
public HL7V26Field IndicationForProductUse
{
    get
    {
        ...
        indicationForProductUse = new HL7V26Field
        {
        ...
        if (indicationForProductUse.field.FieldRepetitions != null && indicationForProductUse.field.FieldRepetitions.Count > 0)
        {
            ...
            indicationForProductUse.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(indicationForProductUse, fieldData);
        }
...
internal HL7V26Field productProblem;
...
public HL7V26Field ProductProblem
{
    get
    {
        ...
        productProblem = new HL7V26Field
        {
        ...
        if (productProblem.field.FieldRepetitions != null && productProblem.field.FieldRepetitions.Count > 0)
        {
            ...
            productProblem.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(productProblem, fieldData);
        }
...
internal HL7V26Field productSerialLotNumber;
...
public HL7V26Field ProductSerialLotNumber
{
    get
    {
        ...
        productSerialLotNumber = new HL7V26Field
        {
        ...
        if (productSerialLotNumber.field.FieldRepetitions != null && productSerialLotNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            productSerialLotNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(productSerialLotNumber, fieldData);
        }
...
internal HL7V26Field productAvailableForInspection;
...
public HL7V26Field ProductAvailableForInspection
{
    get
    {
        ...
        productAvailableForInspection = new HL7V26Field
        {
        ...
        if (productAvailableForInspection.field.FieldRepetitions != null && productAvailableForInspection.field.FieldRepetitions.Count > 0)
        {
            ...
            productAvailableForInspection.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(productAvailableForInspection, fieldData);
        }
...
internal HL7V26Field productEvaluationPerformed;
...
public HL7V26Field ProductEvaluationPerformed
{
    get
    {
        ...
        productEvaluationPerformed = new HL7V26Field
        {
        ...
        if (productEvaluationPerformed.field.FieldRepetitions != null && productEvaluationPerformed.field.FieldRepetitions.Count > 0)
        {
            ...
            productEvaluationPerformed.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(productEvaluationPerformed, fieldData);
        }
...
internal HL7V26Field productEvaluationStatus;
...
public HL7V26Field ProductEvaluationStatus
{
    get
    {
        ...
        productEvaluationStatus = new HL7V26Field
        {
        ...
        if (productEvaluationStatus.field.FieldRepetitions != null && productEvaluationStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            productEvaluationStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(productEvaluationStatus, fieldData);
        }
...
internal HL7V26Field productEvaluationResults;
...
public HL7V26Field ProductEvaluationResults
{
    get
    {
        ...
        productEvaluationResults = new HL7V26Field
        {
        ...
        if (productEvaluationResults.field.FieldRepetitions != null && productEvaluationResults.field.FieldRepetitions.Count > 0)
        {
            ...
            productEvaluationResults.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(productEvaluationResults, fieldData);
        }
...
internal HL7V26Field evaluatedProductSource;
...
public HL7V26Field EvaluatedProductSource
{
    get
    {
        ...
        evaluatedProductSource = new HL7V26Field
        {
        ...
        if (evaluatedProductSource.field.FieldRepetitions != null && evaluatedProductSource.field.FieldRepetitions.Count > 0)
        {
            ...
            evaluatedProductSource.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(evaluatedProductSource, fieldData);
        }
...
internal HL7V26Field dateProductReturnedToManufacturer;
...
public HL7V26Field DateProductReturnedToManufacturer
{
    get
    {
        ...
        dateProductReturnedToManufacturer = new HL7V26Field
        {
        ...
        if (dateProductReturnedToManufacturer.field.FieldRepetitions != null && dateProductReturnedToManufacturer.field.FieldRepetitions.Count > 0)
        {
            ...
            dateProductReturnedToManufacturer.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(dateProductReturnedToManufacturer, fieldData);
        }
...
internal HL7V26Field deviceOperatorQualifications;
...
public HL7V26Field DeviceOperatorQualifications
{
    get
    {
        ...
        deviceOperatorQualifications = new HL7V26Field
        {
        ...
        if (deviceOperatorQualifications.field.FieldRepetitions != null && deviceOperatorQualifications.field.FieldRepetitions.Count > 0)
        {
            ...
            deviceOperatorQualifications.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(deviceOperatorQualifications, fieldData);
        }
...
internal HL7V26Field relatednessAssessment;
...
public HL7V26Field RelatednessAssessment
{
    get
    {
        ...
        relatednessAssessment = new HL7V26Field
        {
        ...
        if (relatednessAssessment.field.FieldRepetitions != null && relatednessAssessment.field.FieldRepetitions.Count > 0)
        {
            ...
            relatednessAssessment.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(relatednessAssessment, fieldData);
        }
...
internal HL7V26Field actionTakenInResponseToTheEvent;
...
public HL7V26Field ActionTakenInResponseToTheEvent
{
    get
    {
        ...
        actionTakenInResponseToTheEvent = new HL7V26Field
        {
        ...
        if (actionTakenInResponseToTheEvent.field.FieldRepetitions != null && actionTakenInResponseToTheEvent.field.FieldRepetitions.Count > 0)
        {
            ...
            actionTakenInResponseToTheEvent.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(actionTakenInResponseToTheEvent, fieldData);
        }
...
internal HL7V26Field eventCausalityObservations;
...
public HL7V26Field EventCausalityObservations
{
    get
    {
        ...
        eventCausalityObservations = new HL7V26Field
        {
        ...
        if (eventCausalityObservations.field.FieldRepetitions != null && eventCausalityObservations.field.FieldRepetitions.Count > 0)
        {
            ...
            eventCausalityObservations.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(eventCausalityObservations, fieldData);
        }
...
internal HL7V26Field indirectExposureMechanism;
...
public HL7V26Field IndirectExposureMechanism
{
    get
    {
        ...
        indirectExposureMechanism = new HL7V26Field
        {
        ...
        if (indirectExposureMechanism.field.FieldRepetitions != null && indirectExposureMechanism.field.FieldRepetitions.Count > 0)
        {
            ...
            indirectExposureMechanism.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(indirectExposureMechanism, fieldData);
        }
