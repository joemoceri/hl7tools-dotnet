...
public HL7V26Field SetIDIAM
{
    get
    {
        ...
        if (setIDIAM.field.FieldRepetitions != null && setIDIAM.field.FieldRepetitions.Count > 0)
        {
            ...
            setIDIAM.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(setIDIAM, fieldData);
        }
...
public HL7V26Field AllergyActionCode
{
    get
    {
        ...
        if (allergyActionCode.field.FieldRepetitions != null && allergyActionCode.field.FieldRepetitions.Count > 0)
        {
            ...
            allergyActionCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(allergyActionCode, fieldData);
        }
...
This field is conditionally required.  The surrogate field to use is IAM-3 - Allergen Code/Mnemonic/Description if that field can uniquely identify the allergy on the receiving system.",
        ...
        if (allergyUniqueIdentifier.field.FieldRepetitions != null && allergyUniqueIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            allergyUniqueIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(allergyUniqueIdentifier, fieldData);
        }
...
public HL7V26Field ActionReason
{
    get
    {
        ...
        if (actionReason.field.FieldRepetitions != null && actionReason.field.FieldRepetitions.Count > 0)
        {
            ...
            actionReason.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(actionReason, fieldData);
        }
...
public HL7V26Field SensitivitytoCausativeAgentCode
{
    get
    {
        ...
        if (sensitivitytoCausativeAgentCode.field.FieldRepetitions != null && sensitivitytoCausativeAgentCode.field.FieldRepetitions.Count > 0)
        {
            ...
            sensitivitytoCausativeAgentCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(sensitivitytoCausativeAgentCode, fieldData);
        }
...
public HL7V26Field AllergenGroupCodeMnemonicDescription
{
    get
    {
        ...
        if (allergenGroupCodeMnemonicDescription.field.FieldRepetitions != null && allergenGroupCodeMnemonicDescription.field.FieldRepetitions.Count > 0)
        {
            ...
            allergenGroupCodeMnemonicDescription.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(allergenGroupCodeMnemonicDescription, fieldData);
        }
...
public HL7V26Field OnsetDate
{
    get
    {
        ...
        if (onsetDate.field.FieldRepetitions != null && onsetDate.field.FieldRepetitions.Count > 0)
        {
            ...
            onsetDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(onsetDate, fieldData);
        }
...
public HL7V26Field OnsetDateText
{
    get
    {
        ...
        if (onsetDateText.field.FieldRepetitions != null && onsetDateText.field.FieldRepetitions.Count > 0)
        {
            ...
            onsetDateText.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(onsetDateText, fieldData);
        }
...
public HL7V26Field ReportedDateTime
{
    get
    {
        ...
        if (reportedDateTime.field.FieldRepetitions != null && reportedDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            reportedDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(reportedDateTime, fieldData);
        }
...
public HL7V26Field ReportedBy
{
    get
    {
        ...
        if (reportedBy.field.FieldRepetitions != null && reportedBy.field.FieldRepetitions.Count > 0)
        {
            ...
            reportedBy.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(reportedBy, fieldData);
        }
...
public HL7V26Field RelationshiptoPatientCode
{
    get
    {
        ...
        if (relationshiptoPatientCode.field.FieldRepetitions != null && relationshiptoPatientCode.field.FieldRepetitions.Count > 0)
        {
            ...
            relationshiptoPatientCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(relationshiptoPatientCode, fieldData);
        }
...
public HL7V26Field AlertDeviceCode
{
    get
    {
        ...
        if (alertDeviceCode.field.FieldRepetitions != null && alertDeviceCode.field.FieldRepetitions.Count > 0)
        {
            ...
            alertDeviceCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(alertDeviceCode, fieldData);
        }
...
public HL7V26Field AllergyClinicalStatusCode
{
    get
    {
        ...
        if (allergyClinicalStatusCode.field.FieldRepetitions != null && allergyClinicalStatusCode.field.FieldRepetitions.Count > 0)
        {
            ...
            allergyClinicalStatusCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(allergyClinicalStatusCode, fieldData);
        }
...
public HL7V26Field StatusedbyPerson
{
    get
    {
        ...
        if (statusedbyPerson.field.FieldRepetitions != null && statusedbyPerson.field.FieldRepetitions.Count > 0)
        {
            ...
            statusedbyPerson.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(statusedbyPerson, fieldData);
        }
...
public HL7V26Field StatusedbyOrganization
{
    get
    {
        ...
        if (statusedbyOrganization.field.FieldRepetitions != null && statusedbyOrganization.field.FieldRepetitions.Count > 0)
        {
            ...
            statusedbyOrganization.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(statusedbyOrganization, fieldData);
        }
...
public HL7V26Field StatusedatDateTime
{
    get
    {
        ...
        if (statusedatDateTime.field.FieldRepetitions != null && statusedatDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            statusedatDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(statusedatDateTime, fieldData);
        }
