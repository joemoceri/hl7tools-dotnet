...
public HL7V26Field SetIDBPX
{
    get
    {
        ...
        if (setIDBPX.field.FieldRepetitions != null && setIDBPX.field.FieldRepetitions.Count > 0)
        {
            ...
            setIDBPX.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(setIDBPX, fieldData);
        }
...
public HL7V26Field BPDispenseStatus
{
    get
    {
        ...
        if (bPDispenseStatus.field.FieldRepetitions != null && bPDispenseStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            bPDispenseStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(bPDispenseStatus, fieldData);
        }
...
public HL7V26Field BPStatus
{
    get
    {
        ...
        if (bPStatus.field.FieldRepetitions != null && bPStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            bPStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(bPStatus, fieldData);
        }
...
This field is optional for blood component messages and is not applicable for commercial product messages.",
        ...
        if (bCDonationTypeIntendedUse.field.FieldRepetitions != null && bCDonationTypeIntendedUse.field.FieldRepetitions.Count > 0)
        {
            ...
            bCDonationTypeIntendedUse.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(bCDonationTypeIntendedUse, fieldData);
        }
...
This field is required for blood components and certain commercial products (such as solvent detergent plasma).",
        ...
        if (bPBloodGroup.field.FieldRepetitions != null && bPBloodGroup.field.FieldRepetitions.Count > 0)
        {
            ...
            bPBloodGroup.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(bPBloodGroup, fieldData);
        }
...
This field is optional for blood component messages.  It is not applicable for non-commercial product messages.",
        ...
        if (bCSpecialTesting.field.FieldRepetitions != null && bCSpecialTesting.field.FieldRepetitions.Count > 0)
        {
            ...
            bCSpecialTesting.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(bCSpecialTesting, fieldData);
        }
...
This field applies to blood components as well as commercial products.   There are a few commercial products that have no expiration date.  Therefore, the field is not required for those specific products.",
        ...
        if (bPExpirationDateTime.field.FieldRepetitions != null && bPExpirationDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            bPExpirationDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(bPExpirationDateTime, fieldData);
        }
...
The sending and receiving systems must agree upon the use of this field.",
        ...
        if (bPUniqueID.field.FieldRepetitions != null && bPUniqueID.field.FieldRepetitions.Count > 0)
        {
            ...
            bPUniqueID.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(bPUniqueID, fieldData);
        }
...
public HL7V26Field BPActualDispensedToLocation
{
    get
    {
        ...
        if (bPActualDispensedToLocation.field.FieldRepetitions != null && bPActualDispensedToLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            bPActualDispensedToLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(bPActualDispensedToLocation, fieldData);
        }
...
public HL7V26Field BPActualDispensedToAddress
{
    get
    {
        ...
        if (bPActualDispensedToAddress.field.FieldRepetitions != null && bPActualDispensedToAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            bPActualDispensedToAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(bPActualDispensedToAddress, fieldData);
        }
...
public HL7V26Field BPDispensedtoReceiver
{
    get
    {
        ...
        if (bPDispensedtoReceiver.field.FieldRepetitions != null && bPDispensedtoReceiver.field.FieldRepetitions.Count > 0)
        {
            ...
            bPDispensedtoReceiver.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(bPDispensedtoReceiver, fieldData);
        }
...
public HL7V26Field BPDispensingIndividual
{
    get
    {
        ...
        if (bPDispensingIndividual.field.FieldRepetitions != null && bPDispensingIndividual.field.FieldRepetitions.Count > 0)
        {
            ...
            bPDispensingIndividual.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(bPDispensingIndividual, fieldData);
        }
