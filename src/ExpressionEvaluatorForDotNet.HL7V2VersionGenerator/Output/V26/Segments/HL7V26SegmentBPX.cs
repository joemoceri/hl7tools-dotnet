...
Used to specify an educational degree (e.g., MD). Refer to User-defined Table 0360 – Degree for suggested values.",
        ...
        public HL7V26SegmentBPX(HL7V2Message message)
        {
            this.message = message;
        }

        
internal HL7V26Field setID–BPX;

public HL7V26Field SetID–BPX
{
    get
    {
        if (setID–BPX != null)
        ...
        if (setID–BPX.field.FieldRepetitions != null && setID–BPX.field.FieldRepetitions.Count > 0)
        {
            // get this fields data
            var fieldData = Fields.First(fd => fd.Id.Equals(setID–BPX.Id));
            var fieldRepetitions = new List<HL7V26FieldRepetition>();

            for (var i = 0; i < setID–BPX.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V26FieldRepetition
                {
                    fieldRepetition = setID–BPX.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    for (var j = 0; j < setID–BPX.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V26Component
                        {
                            component = setID–BPX.field.FieldRepetitions[i].Components[j],
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < setID–BPX.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V26SubComponent
                                {
                                    subComponent = setID–BPX.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = componentFieldData.Id,
                                    Type = componentFieldData.Type,
                                    Position = componentFieldData.Position,
                                    Name = componentFieldData.Name,
            ...
            setID–BPX.fieldRepetitions = fieldRepetitions;
        }
...
internal HL7V26Field bPDispenseStatus;

public HL7V26Field BPDispenseStatus
{
    get
    {
        ...
        bPDispenseStatus = new HL7V26Field
        {
            field = message[@"BPX"][2],
            Id = @"BPX.2",
            Type = @"Field",
...
internal HL7V26Field bPStatus;

public HL7V26Field BPStatus
{
    get
    {
        if (bPStatus != null)
...
internal HL7V26Field bCDonationTypeIntendedUse;

public HL7V26Field BCDonationTypeIntendedUse
{
    get
    {
        ...
        bCDonationTypeIntendedUse = new HL7V26Field
        {
            field = message[@"BPX"][7],
            Id = @"BPX.7",
            Type = @"Field",
...
internal HL7V26Field bPBloodGroup;

public HL7V26Field BPBloodGroup
{
    get
    {
...
internal HL7V26Field bCSpecialTesting;

public HL7V26Field BCSpecialTesting
{
    get
    {
        ...
        bCSpecialTesting = new HL7V26Field
        {
...
internal HL7V26Field bPExpirationDateTime;

public HL7V26Field BPExpirationDateTime
{
    get
    {
        ...
        bPExpirationDateTime = new HL7V26Field
        {
...
internal HL7V26Field bPUniqueID;

public HL7V26Field BPUniqueID
{
    get
    {
        if (bPUniqueID != null)
...
internal HL7V26Field bPActualDispensedToLocation;

public HL7V26Field BPActualDispensedToLocation
{
    get
    {
        ...
        bPActualDispensedToLocation = new HL7V26Field
        {
...
internal HL7V26Field bPActualDispensedToAddress;

public HL7V26Field BPActualDispensedToAddress
{
    get
    {
        ...
        bPActualDispensedToAddress = new HL7V26Field
        {
...
internal HL7V26Field bPDispensedtoReceiver;

public HL7V26Field BPDispensedtoReceiver
{
    get
    {
        ...
        bPDispensedtoReceiver = new HL7V26Field
        {
...
internal HL7V26Field bPDispensingIndividual;

public HL7V26Field BPDispensingIndividual
{
    get
    {
        ...
        bPDispensingIndividual = new HL7V26Field
        {
