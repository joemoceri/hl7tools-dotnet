...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentNSC
    {
        ...
        internal HL7V26Field _applicationChangeType;
...
public HL7V26Field ApplicationChangeType
{
    get
    {
        ...
        _applicationChangeType = new HL7V26Field
        {
            field = message[@"NSC"][1],
            fieldData = fieldData
        };
        ...
        {
            _applicationChangeType.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_applicationChangeType, fieldData);
        }
...
internal HL7V26Field _currentCPU;
...
public HL7V26Field CurrentCPU
{
    get
    {
        ...
        {
            _currentCPU.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_currentCPU, fieldData);
        }
...
internal HL7V26Field _currentFileserver;
...
public HL7V26Field CurrentFileserver
{
    get
    {
        ...
        _currentFileserver = new HL7V26Field
        {
            field = message[@"NSC"][3],
            fieldData = fieldData
        };
        ...
        {
            _currentFileserver.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_currentFileserver, fieldData);
        }
...
internal HL7V26Field _currentApplication;
...
Note: By site agreement, implementors may continue to use User-defined Table 0300 – Namespace ID for the first component.",
        ...
        _currentApplication = new HL7V26Field
        {
            field = message[@"NSC"][4],
            fieldData = fieldData
        };
        ...
        {
            _currentApplication.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_currentApplication, fieldData);
        }
...
internal HL7V26Field _currentFacility;
...
Note: By site agreement, implementors may continue to use User-defined table 0300 – Namespace ID for the first component.",
        ...
        _currentFacility = new HL7V26Field
        {
            field = message[@"NSC"][5],
            fieldData = fieldData
        };
        ...
        {
            _currentFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_currentFacility, fieldData);
        }
...
public HL7V26Field NewCPU
{
    get
    {
        ...
        {
            _newCPU.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_newCPU, fieldData);
        }
...
internal HL7V26Field _newFileserver;
...
public HL7V26Field NewFileserver
{
    get
    {
        ...
        _newFileserver = new HL7V26Field
        {
            field = message[@"NSC"][7],
            fieldData = fieldData
        };
        ...
        {
            _newFileserver.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_newFileserver, fieldData);
        }
...
internal HL7V26Field _newApplication;
...
Note: By site agreement, implementors may continue to use User-defined table 0300 – Namespace ID for the first component.",
        ...
        _newApplication = new HL7V26Field
        {
            field = message[@"NSC"][8],
            fieldData = fieldData
        };
        ...
        {
            _newApplication.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_newApplication, fieldData);
        }
...
internal HL7V26Field _newFacility;
...
Note: By site agreement, implementors may continue to use User-defined table 0300 – Namespace ID for the first component.",
        ...
        {
            _newFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_newFacility, fieldData);
        }
