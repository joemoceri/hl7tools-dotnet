...
public HL7V26Field SetIDDB1
{
    get
    {
        ...
        if (setIDDB1.field.FieldRepetitions != null && setIDDB1.field.FieldRepetitions.Count > 0)
        {
            ...
            setIDDB1.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(setIDDB1, fieldData);
        }
...
internal HL7V26Field disabledPersonCode;
...
public HL7V26Field DisabledPersonCode
{
    get
    {
        ...
        disabledPersonCode = new HL7V26Field
        {
            field = message[@"DB1"][2],
            Id = @"DB1.2",
            Type = @"Field",
        ...
        if (disabledPersonCode.field.FieldRepetitions != null && disabledPersonCode.field.FieldRepetitions.Count > 0)
        {
            ...
            disabledPersonCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(disabledPersonCode, fieldData);
        }
...
internal HL7V26Field disabledPersonIdentifier;
...
public HL7V26Field DisabledPersonIdentifier
{
    get
    {
        ...
        disabledPersonIdentifier = new HL7V26Field
        {
            field = message[@"DB1"][3],
            Id = @"DB1.3",
            Type = @"Field",
        ...
        if (disabledPersonIdentifier.field.FieldRepetitions != null && disabledPersonIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            disabledPersonIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(disabledPersonIdentifier, fieldData);
        }
...
internal HL7V26Field disabledIndicator;
...
public HL7V26Field DisabledIndicator
{
    get
    {
        ...
        disabledIndicator = new HL7V26Field
        {
            field = message[@"DB1"][4],
            Id = @"DB1.4",
            Type = @"Field",
        ...
        if (disabledIndicator.field.FieldRepetitions != null && disabledIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            disabledIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(disabledIndicator, fieldData);
        }
...
internal HL7V26Field disabilityStartDate;
...
public HL7V26Field DisabilityStartDate
{
    get
    {
        ...
        disabilityStartDate = new HL7V26Field
        {
            field = message[@"DB1"][5],
            Id = @"DB1.5",
            Type = @"Field",
        ...
        if (disabilityStartDate.field.FieldRepetitions != null && disabilityStartDate.field.FieldRepetitions.Count > 0)
        {
            ...
            disabilityStartDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(disabilityStartDate, fieldData);
        }
...
internal HL7V26Field disabilityEndDate;
...
public HL7V26Field DisabilityEndDate
{
    get
    {
        ...
        disabilityEndDate = new HL7V26Field
        {
            field = message[@"DB1"][6],
            Id = @"DB1.6",
            Type = @"Field",
        ...
        if (disabilityEndDate.field.FieldRepetitions != null && disabilityEndDate.field.FieldRepetitions.Count > 0)
        {
            ...
            disabilityEndDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(disabilityEndDate, fieldData);
        }
...
internal HL7V26Field disabilityReturntoWorkDate;
...
public HL7V26Field DisabilityReturntoWorkDate
{
    get
    {
        ...
        disabilityReturntoWorkDate = new HL7V26Field
        {
            field = message[@"DB1"][7],
            Id = @"DB1.7",
            Type = @"Field",
        ...
        if (disabilityReturntoWorkDate.field.FieldRepetitions != null && disabilityReturntoWorkDate.field.FieldRepetitions.Count > 0)
        {
            ...
            disabilityReturntoWorkDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(disabilityReturntoWorkDate, fieldData);
        }
...
internal HL7V26Field disabilityUnabletoWorkDate;
...
public HL7V26Field DisabilityUnabletoWorkDate
{
    get
    {
        ...
        disabilityUnabletoWorkDate = new HL7V26Field
        {
            field = message[@"DB1"][8],
            Id = @"DB1.8",
            Type = @"Field",
        ...
        if (disabilityUnabletoWorkDate.field.FieldRepetitions != null && disabilityUnabletoWorkDate.field.FieldRepetitions.Count > 0)
        {
            ...
            disabilityUnabletoWorkDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(disabilityUnabletoWorkDate, fieldData);
        }
