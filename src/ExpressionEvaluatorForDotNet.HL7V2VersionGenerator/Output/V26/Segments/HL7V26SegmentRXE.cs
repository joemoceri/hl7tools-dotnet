...
public HL7V26Field QuantityTiming
{
    get
    {
        ...
        if (quantityTiming.field.FieldRepetitions != null && quantityTiming.field.FieldRepetitions.Count > 0)
        {
            ...
            quantityTiming.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(quantityTiming, fieldData);
        }
...
For vaccines, HL7 Table 0292 – Vaccines Administered is the preferred coding system.  For non-vaccine products, the coding system may be a local implementation of User-defined Table 0479 – Pharmaceutical Substances or an external coding system. ",
        ...
        if (giveCode.field.FieldRepetitions != null && giveCode.field.FieldRepetitions.Count > 0)
        {
            ...
            giveCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(giveCode, fieldData);
        }
...
Another way to say this is that, for pharmacy/treatment orders, the quantity component of the quantity/timing field refers to what is to be given out at each service interval; thus, in terms of the RX order, that first component always defaults to 1.  Hence, in the actual execution of the order, the value of 1 in the first component of the quantity/timing field always refers to one administration of the amount specified in this field (the requested Give Amount field).",
        ...
        if (giveAmountMinimum.field.FieldRepetitions != null && giveAmountMinimum.field.FieldRepetitions.Count > 0)
        {
            ...
            giveAmountMinimum.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(giveAmountMinimum, fieldData);
        }
...
public HL7V26Field GiveAmountMaximum
{
    get
    {
        ...
        if (giveAmountMaximum.field.FieldRepetitions != null && giveAmountMaximum.field.FieldRepetitions.Count > 0)
        {
            ...
            giveAmountMaximum.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(giveAmountMaximum, fieldData);
        }
...
Note: These units can be a ""compound quantity""; i.e., the units may contain the word ""per.""  For example, micrograms per KG (micg/kg) is an acceptable value, which means that the units are micrograms per KG (of body weight).",
        ...
        if (giveUnits.field.FieldRepetitions != null && giveUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            giveUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(giveUnits, fieldData);
        }
...
public HL7V26Field GiveDosageForm
{
    get
    {
        ...
        if (giveDosageForm.field.FieldRepetitions != null && giveDosageForm.field.FieldRepetitions.Count > 0)
        {
            ...
            giveDosageForm.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(giveDosageForm, fieldData);
        }
...
public HL7V26Field SubstitutionStatus
{
    get
    {
        ...
        if (substitutionStatus.field.FieldRepetitions != null && substitutionStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            substitutionStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(substitutionStatus, fieldData);
        }
...
public HL7V26Field DispenseAmount
{
    get
    {
        ...
        if (dispenseAmount.field.FieldRepetitions != null && dispenseAmount.field.FieldRepetitions.Count > 0)
        {
            ...
            dispenseAmount.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(dispenseAmount, fieldData);
        }
...
public HL7V26Field DispenseUnits
{
    get
    {
        ...
        if (dispenseUnits.field.FieldRepetitions != null && dispenseUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            dispenseUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(dispenseUnits, fieldData);
        }
...
public HL7V26Field PrescriptionNumber
{
    get
    {
        ...
        if (prescriptionNumber.field.FieldRepetitions != null && prescriptionNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            prescriptionNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(prescriptionNumber, fieldData);
        }
...
public HL7V26Field NumberofRefillsRemaining
{
    get
    {
        ...
        if (numberofRefillsRemaining.field.FieldRepetitions != null && numberofRefillsRemaining.field.FieldRepetitions.Count > 0)
        {
            ...
            numberofRefillsRemaining.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(numberofRefillsRemaining, fieldData);
        }
...
public HL7V26Field NumberofRefillsDosesDispensed
{
    get
    {
        ...
        if (numberofRefillsDosesDispensed.field.FieldRepetitions != null && numberofRefillsDosesDispensed.field.FieldRepetitions.Count > 0)
        {
            ...
            numberofRefillsDosesDispensed.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(numberofRefillsDosesDispensed, fieldData);
        }
...
public HL7V26Field DTofMostRecentRefillorDoseDispensed
{
    get
    {
        ...
        if (dTofMostRecentRefillorDoseDispensed.field.FieldRepetitions != null && dTofMostRecentRefillorDoseDispensed.field.FieldRepetitions.Count > 0)
        {
            ...
            dTofMostRecentRefillorDoseDispensed.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(dTofMostRecentRefillorDoseDispensed, fieldData);
        }
...
public HL7V26Field PharmacyTreatmentSuppliersSpecialDispensingInstructions
{
    get
    {
        ...
        if (pharmacyTreatmentSuppliersSpecialDispensingInstructions.field.FieldRepetitions != null && pharmacyTreatmentSuppliersSpecialDispensingInstructions.field.FieldRepetitions.Count > 0)
        {
            ...
            pharmacyTreatmentSuppliersSpecialDispensingInstructions.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(pharmacyTreatmentSuppliersSpecialDispensingInstructions, fieldData);
        }
...
This field is defined as conditional because it is required when the ordered substance is to be administered continuously at a prescribed rate (e.g., certain IVs).  For example, if the ""give amount/units"" were 300 ml and the ""give per"" time unit were H1 (equivalent to one hour), the rate is 300ml/hr.",
        ...
        if (givePerTimeUnit.field.FieldRepetitions != null && givePerTimeUnit.field.FieldRepetitions.Count > 0)
        {
            ...
            givePerTimeUnit.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(givePerTimeUnit, fieldData);
        }
...
public HL7V26Field GiveRateAmount
{
    get
    {
        ...
        if (giveRateAmount.field.FieldRepetitions != null && giveRateAmount.field.FieldRepetitions.Count > 0)
        {
            ...
            giveRateAmount.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(giveRateAmount, fieldData);
        }
...
public HL7V26Field GiveRateUnits
{
    get
    {
        ...
        if (giveRateUnits.field.FieldRepetitions != null && giveRateUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            giveRateUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(giveRateUnits, fieldData);
        }
...
public HL7V26Field GiveStrength
{
    get
    {
        ...
        if (giveStrength.field.FieldRepetitions != null && giveStrength.field.FieldRepetitions.Count > 0)
        {
            ...
            giveStrength.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(giveStrength, fieldData);
        }
...
Note:  These units can be a ""compound quantity""; i.e., the units may express a quantity per unit of time.  For example, micrograms per hour (micg/h) is an acceptable value.  These compound units are contained in the ISO+ table. See Chapter 7 for full definition of ISO+ units.",
        ...
        if (giveStrengthUnits.field.FieldRepetitions != null && giveStrengthUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            giveStrengthUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(giveStrengthUnits, fieldData);
        }
...
public HL7V26Field GiveIndication
{
    get
    {
        ...
        if (giveIndication.field.FieldRepetitions != null && giveIndication.field.FieldRepetitions.Count > 0)
        {
            ...
            giveIndication.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(giveIndication, fieldData);
        }
...
public HL7V26Field DispensePackageSize
{
    get
    {
        ...
        if (dispensePackageSize.field.FieldRepetitions != null && dispensePackageSize.field.FieldRepetitions.Count > 0)
        {
            ...
            dispensePackageSize.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(dispensePackageSize, fieldData);
        }
...
public HL7V26Field DispensePackageSizeUnit
{
    get
    {
        ...
        if (dispensePackageSizeUnit.field.FieldRepetitions != null && dispensePackageSizeUnit.field.FieldRepetitions.Count > 0)
        {
            ...
            dispensePackageSizeUnit.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(dispensePackageSizeUnit, fieldData);
        }
...
public HL7V26Field DispensePackageMethod
{
    get
    {
        ...
        if (dispensePackageMethod.field.FieldRepetitions != null && dispensePackageMethod.field.FieldRepetitions.Count > 0)
        {
            ...
            dispensePackageMethod.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(dispensePackageMethod, fieldData);
        }
...
public HL7V26Field OriginalOrderDateTime
{
    get
    {
        ...
        if (originalOrderDateTime.field.FieldRepetitions != null && originalOrderDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            originalOrderDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(originalOrderDateTime, fieldData);
        }
...
public HL7V26Field GiveDrugStrengthVolume
{
    get
    {
        ...
        if (giveDrugStrengthVolume.field.FieldRepetitions != null && giveDrugStrengthVolume.field.FieldRepetitions.Count > 0)
        {
            ...
            giveDrugStrengthVolume.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(giveDrugStrengthVolume, fieldData);
        }
...
public HL7V26Field GiveDrugStrengthVolumeUnits
{
    get
    {
        ...
        if (giveDrugStrengthVolumeUnits.field.FieldRepetitions != null && giveDrugStrengthVolumeUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            giveDrugStrengthVolumeUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(giveDrugStrengthVolumeUnits, fieldData);
        }
...
public HL7V26Field ControlledSubstanceSchedule
{
    get
    {
        ...
        if (controlledSubstanceSchedule.field.FieldRepetitions != null && controlledSubstanceSchedule.field.FieldRepetitions.Count > 0)
        {
            ...
            controlledSubstanceSchedule.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(controlledSubstanceSchedule, fieldData);
        }
...
public HL7V26Field FormularyStatus
{
    get
    {
        ...
        if (formularyStatus.field.FieldRepetitions != null && formularyStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            formularyStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(formularyStatus, fieldData);
        }
...
public HL7V26Field PharmaceuticalSubstanceAlternative
{
    get
    {
        ...
        if (pharmaceuticalSubstanceAlternative.field.FieldRepetitions != null && pharmaceuticalSubstanceAlternative.field.FieldRepetitions.Count > 0)
        {
            ...
            pharmaceuticalSubstanceAlternative.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(pharmaceuticalSubstanceAlternative, fieldData);
        }
...
public HL7V26Field PharmacyofMostRecentFill
{
    get
    {
        ...
        if (pharmacyofMostRecentFill.field.FieldRepetitions != null && pharmacyofMostRecentFill.field.FieldRepetitions.Count > 0)
        {
            ...
            pharmacyofMostRecentFill.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(pharmacyofMostRecentFill, fieldData);
        }
...
public HL7V26Field InitialDispenseAmount
{
    get
    {
        ...
        if (initialDispenseAmount.field.FieldRepetitions != null && initialDispenseAmount.field.FieldRepetitions.Count > 0)
        {
            ...
            initialDispenseAmount.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(initialDispenseAmount, fieldData);
        }
