...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentOM6
    {
        ...
        public string Description { get { return @"The Technical Steward for the OM6 segment is Orders and Observations.
...
This segment contains the information about quantities that are derived from one or more other quantities or direct observations by mathematical or logical means."; } }
        ...
        public HL7V26SegmentOM6(HL7V2Message message)
        {
...
internal HL7V26Field _derivationRule;

public HL7V26Field DerivationRule
{
    get
    {
        ...
        _derivationRule = new HL7V26Field
        {
            field = message[@"OM6"][2],
            fieldData = fieldData
        };
        ...
        {
            _derivationRule.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(_derivationRule, fieldData);
        }
