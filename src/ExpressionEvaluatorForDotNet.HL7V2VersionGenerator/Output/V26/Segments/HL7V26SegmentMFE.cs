...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V26SegmentMFE
    {
        ...
        public string Description { get { return @"The Technical Steward for the MFE segment is Infrastructure and Messaging."; } }
...
Used to specify an educational degree (e.g., MD). Refer to User-defined Table 0360 – Degree for suggested values.",
        ...
        public HL7V26SegmentMFE(HL7V2Message message)
        {
...
public HL7V26Field RecordLevelEventCode
{
    get
    {
        ...
        if (recordLevelEventCode.field.FieldRepetitions != null && recordLevelEventCode.field.FieldRepetitions.Count > 0)
        {
            ...
            recordLevelEventCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(recordLevelEventCode, fieldData);
        }
...
public HL7V26Field MFNControlID
{
    get
    {
        ...
        if (mFNControlID.field.FieldRepetitions != null && mFNControlID.field.FieldRepetitions.Count > 0)
        {
            ...
            mFNControlID.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(mFNControlID, fieldData);
        }
...
public HL7V26Field EffectiveDateTime
{
    get
    {
        ...
        if (effectiveDateTime.field.FieldRepetitions != null && effectiveDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            effectiveDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(effectiveDateTime, fieldData);
        }
...
internal HL7V26Field primaryKeyValueMFE;

public HL7V26Field PrimaryKeyValueMFE
{
    get
    {
        ...
        primaryKeyValueMFE = new HL7V26Field
        {
            field = message[@"MFE"][4],
            Id = @"MFE.4",
            Type = @"Field",
        ...
        if (primaryKeyValueMFE.field.FieldRepetitions != null && primaryKeyValueMFE.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValueMFE.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(primaryKeyValueMFE, fieldData);
        }
...
internal HL7V26Field primaryKeyValueType;

public HL7V26Field PrimaryKeyValueType
{
    get
    {
        ...
        primaryKeyValueType = new HL7V26Field
        {
            field = message[@"MFE"][5],
            Id = @"MFE.5",
            Type = @"Field",
        ...
        if (primaryKeyValueType.field.FieldRepetitions != null && primaryKeyValueType.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValueType.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(primaryKeyValueType, fieldData);
        }
