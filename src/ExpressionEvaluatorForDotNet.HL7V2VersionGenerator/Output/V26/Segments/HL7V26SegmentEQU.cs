...
internal HL7V26Field eventDateTime;
...
internal HL7V26Field equipmentState;
...
public HL7V26Field EquipmentState
{
    get
    {
        ...
        equipmentState = new HL7V26Field
        {
            field = message[@"EQU"][3],
            Id = @"EQU.3",
            Type = @"Field",
...
internal HL7V26Field localRemoteControlState;
...
public HL7V26Field LocalRemoteControlState
{
    get
    {
        ...
        localRemoteControlState = new HL7V26Field
        {
            field = message[@"EQU"][4],
            Id = @"EQU.4",
            Type = @"Field",
...
internal HL7V26Field alertLevel;
