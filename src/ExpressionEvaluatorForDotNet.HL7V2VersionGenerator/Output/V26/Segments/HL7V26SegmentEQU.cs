...
public HL7V26Field EventDateTime
{
    get
    {
        ...
        if (eventDateTime.field.FieldRepetitions != null && eventDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            eventDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(eventDateTime, fieldData);
        }
...
public HL7V26Field EquipmentState
{
    get
    {
        ...
        if (equipmentState.field.FieldRepetitions != null && equipmentState.field.FieldRepetitions.Count > 0)
        {
            ...
            equipmentState.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(equipmentState, fieldData);
        }
...
public HL7V26Field LocalRemoteControlState
{
    get
    {
        ...
        if (localRemoteControlState.field.FieldRepetitions != null && localRemoteControlState.field.FieldRepetitions.Count > 0)
        {
            ...
            localRemoteControlState.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(localRemoteControlState, fieldData);
        }
...
public HL7V26Field AlertLevel
{
    get
    {
        ...
        if (alertLevel.field.FieldRepetitions != null && alertLevel.field.FieldRepetitions.Count > 0)
        {
            ...
            alertLevel.fieldRepetitions = HL7V2FieldGenerator.GenerateV26FieldRepetitions(alertLevel, fieldData);
        }
