...
{
    public class HL7V271SegmentCON
    {
...
The segment will be used in conjunction with various other segments to identify the practitioner (PRA/STF) or patient (PID) the consent is for, the various individuals involved in the consent (ROL) as witnesses, consenting person (not always the patient), translators, consulting providers, etc., and the specific procedures being proposed (PR1)."; } }
        ...
        public HL7V271SegmentCON(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V271Field _setIdCon;

public HL7V271Field SetIdCon
{
    get
    {
        if (_setIdCon != null)
        ...
        {
            _setIdCon.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_setIdCon, fieldData);
        }
...
internal HL7V271Field _consentType;

public HL7V271Field ConsentType
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _consentType.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_consentType, fieldData);
        }
...
internal HL7V271Field _consentFormIdAndVersion;

public HL7V271Field ConsentFormIdAndVersion
{
    get
    {
        if (_consentFormIdAndVersion != null)
        {
            return _consentFormIdAndVersion;
        }
        ...
        _consentFormIdAndVersion = new HL7V271Field
        {
            field = message[@"CON"][3],
            fieldData = fieldData
        };
        ...
        // check for repetitions
        if (_consentFormIdAndVersion.field.FieldRepetitions != null && _consentFormIdAndVersion.field.FieldRepetitions.Count > 0)
        {
            _consentFormIdAndVersion.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_consentFormIdAndVersion, fieldData);
        }
...
internal HL7V271Field _consentFormNumber;

public HL7V271Field ConsentFormNumber
{
    get
    {
...
Refer to HL7 Table 0301 - Universal ID Type for valid values.",
        ...
        _consentFormNumber = new HL7V271Field
        {
            field = message[@"CON"][4],
            fieldData = fieldData
        };
        ...
        {
            _consentFormNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_consentFormNumber, fieldData);
        }
...
internal HL7V271Field _consentText;

public HL7V271Field ConsentText
{
    get
    {
        ...
        {
            _consentText.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_consentText, fieldData);
        }
...
internal HL7V271Field _subjectspecificConsentText;

public HL7V271Field SubjectspecificConsentText
{
    get
    {
        ...
        _subjectspecificConsentText = new HL7V271Field
        {
            field = message[@"CON"][6],
            fieldData = fieldData
        };
        ...
        {
            _subjectspecificConsentText.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_subjectspecificConsentText, fieldData);
        }
...
internal HL7V271Field _consentBackgroundInformation;

public HL7V271Field ConsentBackgroundInformation
{
    get
    {
        if (_consentBackgroundInformation != null)
        {
            return _consentBackgroundInformation;
        }
        ...
        _consentBackgroundInformation = new HL7V271Field
        {
            field = message[@"CON"][7],
            fieldData = fieldData
        };
        ...
        // check for repetitions
        if (_consentBackgroundInformation.field.FieldRepetitions != null && _consentBackgroundInformation.field.FieldRepetitions.Count > 0)
        {
            _consentBackgroundInformation.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_consentBackgroundInformation, fieldData);
        }
...
internal HL7V271Field _subjectspecificConsentBackgroundText;

public HL7V271Field SubjectspecificConsentBackgroundText
{
    get
    {
        if (_subjectspecificConsentBackgroundText != null)
        {
            return _subjectspecificConsentBackgroundText;
        }
        ...
        _subjectspecificConsentBackgroundText = new HL7V271Field
        {
            field = message[@"CON"][8],
            fieldData = fieldData
        };
        ...
        // check for repetitions
        if (_subjectspecificConsentBackgroundText.field.FieldRepetitions != null && _subjectspecificConsentBackgroundText.field.FieldRepetitions.Count > 0)
        {
            _subjectspecificConsentBackgroundText.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_subjectspecificConsentBackgroundText, fieldData);
        }
...
internal HL7V271Field _consenterimposedLimitations;

public HL7V271Field ConsenterimposedLimitations
{
    get
    {
        ...
        _consenterimposedLimitations = new HL7V271Field
        {
            field = message[@"CON"][9],
            fieldData = fieldData
        };
        ...
        {
            _consenterimposedLimitations.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_consenterimposedLimitations, fieldData);
        }
...
internal HL7V271Field _consentMode;

public HL7V271Field ConsentMode
{
    get
    {
...
Value set version ID is required if CNE.21 is populated.",
        ...
        {
            _consentMode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_consentMode, fieldData);
        }
...
internal HL7V271Field _consentStatus;

public HL7V271Field ConsentStatus
{
    get
    {
...
Value set version ID is required if CNE.21 is populated.",
        ...
        _consentStatus = new HL7V271Field
        {
        ...
        {
            _consentStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_consentStatus, fieldData);
        }
...
internal HL7V271Field _consentDiscussionDateTime;

public HL7V271Field ConsentDiscussionDateTime
{
    get
    {
        ...
        _consentDiscussionDateTime = new HL7V271Field
        {
        ...
        {
            _consentDiscussionDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_consentDiscussionDateTime, fieldData);
        }
...
internal HL7V271Field _consentDecisionDateTime;

public HL7V271Field ConsentDecisionDateTime
{
    get
    {
        ...
        _consentDecisionDateTime = new HL7V271Field
        {
        ...
        {
            _consentDecisionDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_consentDecisionDateTime, fieldData);
        }
...
internal HL7V271Field _consentEffectiveDateTime;

public HL7V271Field ConsentEffectiveDateTime
{
    get
    {
        ...
        _consentEffectiveDateTime = new HL7V271Field
        {
        ...
        {
            _consentEffectiveDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_consentEffectiveDateTime, fieldData);
        }
...
internal HL7V271Field _consentEndDateTime;

public HL7V271Field ConsentEndDateTime
{
    get
    {
        ...
        _consentEndDateTime = new HL7V271Field
        {
        ...
        {
            _consentEndDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_consentEndDateTime, fieldData);
        }
...
internal HL7V271Field _subjectCompetenceIndicator;

public HL7V271Field SubjectCompetenceIndicator
{
    get
    {
        ...
        _subjectCompetenceIndicator = new HL7V271Field
        {
        ...
        {
            _subjectCompetenceIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_subjectCompetenceIndicator, fieldData);
        }
...
internal HL7V271Field _translatorAssistanceIndicator;

public HL7V271Field TranslatorAssistanceIndicator
{
    get
    {
        ...
        _translatorAssistanceIndicator = new HL7V271Field
        {
        ...
        {
            _translatorAssistanceIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_translatorAssistanceIndicator, fieldData);
        }
...
internal HL7V271Field _languageTranslatedTo;

public HL7V271Field LanguageTranslatedTo
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _languageTranslatedTo = new HL7V271Field
        {
        ...
        {
            _languageTranslatedTo.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_languageTranslatedTo, fieldData);
        }
...
internal HL7V271Field _informationalMaterialSuppliedIndicator;

public HL7V271Field InformationalMaterialSuppliedIndicator
{
    get
    {
        ...
        _informationalMaterialSuppliedIndicator = new HL7V271Field
        {
        ...
        {
            _informationalMaterialSuppliedIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_informationalMaterialSuppliedIndicator, fieldData);
        }
...
internal HL7V271Field _consentBypassReason;

public HL7V271Field ConsentBypassReason
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _consentBypassReason = new HL7V271Field
        {
        ...
        {
            _consentBypassReason.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_consentBypassReason, fieldData);
        }
...
internal HL7V271Field _consentDisclosureLevel;

public HL7V271Field ConsentDisclosureLevel
{
    get
    {
        ...
        _consentDisclosureLevel = new HL7V271Field
        {
        ...
        {
            _consentDisclosureLevel.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_consentDisclosureLevel, fieldData);
        }
...
internal HL7V271Field _consentNondisclosureReason;

public HL7V271Field ConsentNondisclosureReason
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _consentNondisclosureReason = new HL7V271Field
        {
        ...
        {
            _consentNondisclosureReason.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_consentNondisclosureReason, fieldData);
        }
...
internal HL7V271Field _nonsubjectConsenterReason;

public HL7V271Field NonsubjectConsenterReason
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _nonsubjectConsenterReason = new HL7V271Field
        {
        ...
        {
            _nonsubjectConsenterReason.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_nonsubjectConsenterReason, fieldData);
        }
...
internal HL7V271Field _consenterId;

public HL7V271Field ConsenterId
{
    get
    {
...
Examples:
 ...
 - Mary Margaret Elizabeth Jones is Called By Meg.",
        ...
        {
            _consenterId.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_consenterId, fieldData);
        }
...
internal HL7V271Field _relationshipToSubject;

public HL7V271Field RelationshipToSubject
{
    get
    {
        if (_relationshipToSubject != null)
        {
            return _relationshipToSubject;
        }
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _relationshipToSubject = new HL7V271Field
        {
        ...
        // check for repetitions
        if (_relationshipToSubject.field.FieldRepetitions != null && _relationshipToSubject.field.FieldRepetitions.Count > 0)
        {
            _relationshipToSubject.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_relationshipToSubject, fieldData);
        }
