...
public HL7V271Field ReferenceInteractionNumber
{
    get
    {
        ...
        if (referenceInteractionNumber.field.FieldRepetitions != null && referenceInteractionNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            referenceInteractionNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(referenceInteractionNumber, fieldData);
        }
...
public HL7V271Field InteractionTypeIdentifier
{
    get
    {
        ...
        if (interactionTypeIdentifier.field.FieldRepetitions != null && interactionTypeIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            interactionTypeIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(interactionTypeIdentifier, fieldData);
        }
...
public HL7V271Field InteractionActiveState
{
    get
    {
        ...
        if (interactionActiveState.field.FieldRepetitions != null && interactionActiveState.field.FieldRepetitions.Count > 0)
        {
            ...
            interactionActiveState.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(interactionActiveState, fieldData);
        }
