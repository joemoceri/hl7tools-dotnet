...
- As a required segment in a tabular response (RTB) to either a QBP or QBS, this segment defines the contents of the table row data (RDT) segments that follows. It is not necessarily an echo back of the segment as it appeared in the query."; } }
        ...
        internal HL7V271Field _numberOfColumnsPerRow;
...
public HL7V271Field NumberOfColumnsPerRow
{
    get
    {
        ...
        _numberOfColumnsPerRow = new HL7V271Field
        {
            field = message[@"RDF"][1],
            fieldData = fieldData
        };
        ...
        {
            _numberOfColumnsPerRow.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_numberOfColumnsPerRow, fieldData);
        }
...
internal HL7V271Field _columnDescription;
...
Note: If the “@” is being used as one of the delimiter characters defined in MSH-2-encoding characters, it must be “escaped.”  See Section 2.7.1, ""Formatting Codes"".",
        ...
        _columnDescription = new HL7V271Field
        {
            field = message[@"RDF"][2],
            fieldData = fieldData
        };
        ...
        {
            _columnDescription.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_columnDescription, fieldData);
        }
