...
{
    public class HL7V271SegmentBLC
    {
        ...
        public HL7V271SegmentBLC(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V271Field _bloodProductCode;

public HL7V271Field BloodProductCode
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _bloodProductCode = new HL7V271Field
        {
            field = message[@"BLC"][1],
            fieldData = fieldData
        };
        ...
        {
            _bloodProductCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_bloodProductCode, fieldData);
        }
...
internal HL7V271Field _bloodAmount;

public HL7V271Field BloodAmount
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _bloodAmount.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_bloodAmount, fieldData);
        }
