...
public HL7V271Field FileFieldSeparator
{
    get
    {
        ...
        if (fileFieldSeparator.field.FieldRepetitions != null && fileFieldSeparator.field.FieldRepetitions.Count > 0)
        {
            ...
            fileFieldSeparator.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(fileFieldSeparator, fieldData);
        }
...
public HL7V271Field FileEncodingCharacters
{
    get
    {
        ...
        if (fileEncodingCharacters.field.FieldRepetitions != null && fileEncodingCharacters.field.FieldRepetitions.Count > 0)
        {
            ...
            fileEncodingCharacters.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(fileEncodingCharacters, fieldData);
        }
...
public HL7V271Field FileSendingApplication
{
    get
    {
        ...
        if (fileSendingApplication.field.FieldRepetitions != null && fileSendingApplication.field.FieldRepetitions.Count > 0)
        {
            ...
            fileSendingApplication.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(fileSendingApplication, fieldData);
        }
...
public HL7V271Field FileSendingFacility
{
    get
    {
        ...
        if (fileSendingFacility.field.FieldRepetitions != null && fileSendingFacility.field.FieldRepetitions.Count > 0)
        {
            ...
            fileSendingFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(fileSendingFacility, fieldData);
        }
...
public HL7V271Field FileReceivingApplication
{
    get
    {
        ...
        if (fileReceivingApplication.field.FieldRepetitions != null && fileReceivingApplication.field.FieldRepetitions.Count > 0)
        {
            ...
            fileReceivingApplication.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(fileReceivingApplication, fieldData);
        }
...
public HL7V271Field FileReceivingFacility
{
    get
    {
        ...
        if (fileReceivingFacility.field.FieldRepetitions != null && fileReceivingFacility.field.FieldRepetitions.Count > 0)
        {
            ...
            fileReceivingFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(fileReceivingFacility, fieldData);
        }
...
public HL7V271Field FileCreationDateTime
{
    get
    {
        ...
        if (fileCreationDateTime.field.FieldRepetitions != null && fileCreationDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            fileCreationDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(fileCreationDateTime, fieldData);
        }
...
public HL7V271Field FileSecurity
{
    get
    {
        ...
        if (fileSecurity.field.FieldRepetitions != null && fileSecurity.field.FieldRepetitions.Count > 0)
        {
            ...
            fileSecurity.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(fileSecurity, fieldData);
        }
...
public HL7V271Field FileNameId
{
    get
    {
        ...
        if (fileNameId.field.FieldRepetitions != null && fileNameId.field.FieldRepetitions.Count > 0)
        {
            ...
            fileNameId.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(fileNameId, fieldData);
        }
...
public HL7V271Field FileHeaderComment
{
    get
    {
        ...
        if (fileHeaderComment.field.FieldRepetitions != null && fileHeaderComment.field.FieldRepetitions.Count > 0)
        {
            ...
            fileHeaderComment.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(fileHeaderComment, fieldData);
        }
...
public HL7V271Field FileControlId
{
    get
    {
        ...
        if (fileControlId.field.FieldRepetitions != null && fileControlId.field.FieldRepetitions.Count > 0)
        {
            ...
            fileControlId.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(fileControlId, fieldData);
        }
...
public HL7V271Field ReferenceFileControlId
{
    get
    {
        ...
        if (referenceFileControlId.field.FieldRepetitions != null && referenceFileControlId.field.FieldRepetitions.Count > 0)
        {
            ...
            referenceFileControlId.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(referenceFileControlId, fieldData);
        }
...
public HL7V271Field FileSendingNetworkAddress
{
    get
    {
        ...
        if (fileSendingNetworkAddress.field.FieldRepetitions != null && fileSendingNetworkAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            fileSendingNetworkAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(fileSendingNetworkAddress, fieldData);
        }
...
This field should only be populated when the underlying communication protocol does not support identification receiving network locations.",
        ...
        if (fileReceivingNetworkAddress.field.FieldRepetitions != null && fileReceivingNetworkAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            fileReceivingNetworkAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(fileReceivingNetworkAddress, fieldData);
        }
