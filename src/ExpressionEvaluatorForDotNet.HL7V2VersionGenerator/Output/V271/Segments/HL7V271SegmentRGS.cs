...
{
    public class HL7V271SegmentRGS
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        public HL7V271SegmentRGS(HL7V2Message message)
        {
            this.message = message;
        }

        
internal HL7V271Field setIdRgs;

public HL7V271Field SetIdRgs
{
    get
    {
        if (setIdRgs != null)
...
internal HL7V271Field resourceGroupId;

public HL7V271Field ResourceGroupId
{
    get
    {
        ...
        resourceGroupId = new HL7V271Field
        {
            field = message[@"RGS"][3],
            Id = @"RGS.3",
            Type = @"Field",
