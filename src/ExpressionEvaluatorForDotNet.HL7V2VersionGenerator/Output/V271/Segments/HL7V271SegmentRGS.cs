...
If a message does not require any grouping of resources, then specify a single RGS in the message, and follow it with all of the Appointment Information segments for the scheduled event.   (At least one RGS segment is required in each message – even if no grouping of resources is required – to allow parsers to properly understand the message.)"; } }
        ...
        internal HL7V271Field _setIdRgs;
...
public HL7V271Field SetIdRgs
{
    get
    {
        ...
        {
            _setIdRgs.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_setIdRgs, fieldData);
        }
...
internal HL7V271Field _resourceGroupId;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _resourceGroupId = new HL7V271Field
        {
            field = message[@"RGS"][3],
            fieldData = fieldData
        };
        ...
        {
            _resourceGroupId.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_resourceGroupId, fieldData);
        }
