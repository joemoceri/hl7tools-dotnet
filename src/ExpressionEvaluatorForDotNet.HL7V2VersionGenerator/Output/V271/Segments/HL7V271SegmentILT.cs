...
{
    public class HL7V271SegmentILT
    {
        ...
        public string LongName { get { return @"Material Lot"; } }
...
Note that on-hand quantities do NOT refer to a continuously updated quantity.  The expectation is for periodic physical inventory.  "; } }
        ...
        public HL7V271SegmentILT(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V271Field _setIdIlt;

public HL7V271Field SetIdIlt
{
    get
    {
        if (_setIdIlt != null)
        ...
        {
            _setIdIlt.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_setIdIlt, fieldData);
        }
