...
{
    public class HL7V271SegmentNST
    {
...
Usage Notes: Fields 2-15.  These are all marked optional since the statistics kept on a particular link and negotiated between the two systems in question will vary.  Not all values will apply to each system.  Some values are concerned with the type of port, and some values pertain to the lower level protocol."; } }
        ...
        public HL7V271SegmentNST(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V271Field _statisticsAvailable;

public HL7V271Field StatisticsAvailable
{
    get
    {
...
Y - the responding application does keep statistics, fields 4 and 5 are required (and the response message contains one or more non null fields in the range 2 3, 6 15). ",
        ...
        _statisticsAvailable = new HL7V271Field
        {
            field = message[@"NST"][1],
            fieldData = fieldData
        };
        ...
        {
            _statisticsAvailable.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_statisticsAvailable, fieldData);
        }
...
internal HL7V271Field _sourceIdentifier;

public HL7V271Field SourceIdentifier
{
    get
    {
        ...
        _sourceIdentifier = new HL7V271Field
        {
            field = message[@"NST"][2],
            fieldData = fieldData
        };
        ...
        {
            _sourceIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_sourceIdentifier, fieldData);
        }
...
internal HL7V271Field _sourceType;

public HL7V271Field SourceType
{
    get
    {
        if (_sourceType != null)
        ...
        {
            _sourceType.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_sourceType, fieldData);
        }
...
internal HL7V271Field _statisticsStart;

public HL7V271Field StatisticsStart
{
    get
    {
        ...
        _statisticsStart = new HL7V271Field
        {
            field = message[@"NST"][4],
            fieldData = fieldData
        };
        ...
        {
            _statisticsStart.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_statisticsStart, fieldData);
        }
...
internal HL7V271Field _statisticsEnd;

public HL7V271Field StatisticsEnd
{
    get
    {
        ...
        _statisticsEnd = new HL7V271Field
        {
            field = message[@"NST"][5],
            fieldData = fieldData
        };
        ...
        {
            _statisticsEnd.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_statisticsEnd, fieldData);
        }
...
internal HL7V271Field _receiveCharacterCount;

public HL7V271Field ReceiveCharacterCount
{
    get
    {
        ...
        _receiveCharacterCount = new HL7V271Field
        {
            field = message[@"NST"][6],
            fieldData = fieldData
        };
        ...
        {
            _receiveCharacterCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_receiveCharacterCount, fieldData);
        }
...
internal HL7V271Field _sendCharacterCount;

public HL7V271Field SendCharacterCount
{
    get
    {
        ...
        _sendCharacterCount = new HL7V271Field
        {
            field = message[@"NST"][7],
            fieldData = fieldData
        };
        ...
        {
            _sendCharacterCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_sendCharacterCount, fieldData);
        }
...
internal HL7V271Field _messagesReceived;

public HL7V271Field MessagesReceived
{
    get
    {
        ...
        _messagesReceived = new HL7V271Field
        {
            field = message[@"NST"][8],
            fieldData = fieldData
        };
        ...
        {
            _messagesReceived.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_messagesReceived, fieldData);
        }
...
internal HL7V271Field _messagesSent;

public HL7V271Field MessagesSent
{
    get
    {
        ...
        _messagesSent = new HL7V271Field
        {
            field = message[@"NST"][9],
            fieldData = fieldData
        };
        ...
        {
            _messagesSent.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_messagesSent, fieldData);
        }
...
internal HL7V271Field _checksumErrorsReceived;

public HL7V271Field ChecksumErrorsReceived
{
    get
    {
        ...
        _checksumErrorsReceived = new HL7V271Field
        {
        ...
        {
            _checksumErrorsReceived.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_checksumErrorsReceived, fieldData);
        }
...
internal HL7V271Field _lengthErrorsReceived;

public HL7V271Field LengthErrorsReceived
{
    get
    {
        ...
        _lengthErrorsReceived = new HL7V271Field
        {
        ...
        {
            _lengthErrorsReceived.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_lengthErrorsReceived, fieldData);
        }
...
internal HL7V271Field _otherErrorsReceived;

public HL7V271Field OtherErrorsReceived
{
    get
    {
        ...
        _otherErrorsReceived = new HL7V271Field
        {
        ...
        {
            _otherErrorsReceived.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_otherErrorsReceived, fieldData);
        }
...
internal HL7V271Field _connectTimeouts;

public HL7V271Field ConnectTimeouts
{
    get
    {
        ...
        _connectTimeouts = new HL7V271Field
        {
        ...
        {
            _connectTimeouts.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_connectTimeouts, fieldData);
        }
...
internal HL7V271Field _receiveTimeouts;

public HL7V271Field ReceiveTimeouts
{
    get
    {
        ...
        _receiveTimeouts = new HL7V271Field
        {
        ...
        {
            _receiveTimeouts.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_receiveTimeouts, fieldData);
        }
...
internal HL7V271Field _applicationControllevelErrors;

public HL7V271Field ApplicationControllevelErrors
{
    get
    {
        ...
        _applicationControllevelErrors = new HL7V271Field
        {
        ...
        {
            _applicationControllevelErrors.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_applicationControllevelErrors, fieldData);
        }
