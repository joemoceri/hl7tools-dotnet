...
Value set version ID is required if CWE.21 is populated.",
        ...
        internal HL7V271Field riskManagementIncidentCode;
...
public HL7V271Field RiskManagementIncidentCode
{
    get
    {
        ...
        riskManagementIncidentCode = new HL7V271Field
        {
            field = message[@"RMI"][1],
            Id = @"RMI.1",
            Type = @"Field",
        ...
        if (riskManagementIncidentCode.field.FieldRepetitions != null && riskManagementIncidentCode.field.FieldRepetitions.Count > 0)
        {
            ...
            riskManagementIncidentCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(riskManagementIncidentCode, fieldData);
        }
...
internal HL7V271Field dateTimeIncident;
...
public HL7V271Field DateTimeIncident
{
    get
    {
        ...
        dateTimeIncident = new HL7V271Field
        {
            field = message[@"RMI"][2],
            Id = @"RMI.2",
            Type = @"Field",
        ...
        if (dateTimeIncident.field.FieldRepetitions != null && dateTimeIncident.field.FieldRepetitions.Count > 0)
        {
            ...
            dateTimeIncident.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(dateTimeIncident, fieldData);
        }
...
internal HL7V271Field incidentTypeCode;
...
public HL7V271Field IncidentTypeCode
{
    get
    {
        ...
        incidentTypeCode = new HL7V271Field
        {
            field = message[@"RMI"][3],
            Id = @"RMI.3",
            Type = @"Field",
        ...
        if (incidentTypeCode.field.FieldRepetitions != null && incidentTypeCode.field.FieldRepetitions.Count > 0)
        {
            ...
            incidentTypeCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(incidentTypeCode, fieldData);
        }
