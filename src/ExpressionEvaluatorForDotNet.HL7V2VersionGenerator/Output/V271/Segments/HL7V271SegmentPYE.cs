...
internal HL7V271Field payeeRelationshipToInvoicepatient;

public HL7V271Field PayeeRelationshipToInvoicepatient
{
    get
    {
        ...
        payeeRelationshipToInvoicepatient = new HL7V271Field
        {
            field = message[@"PYE"][3],
            Id = @"PYE.3",
            Type = @"Field",
