...
At least the first component of this field is required.  The first component can be an identifying code for the nursing station for inpatient locations, or clinic, department or home for patient locations other than inpatient ones. ",
        ...
        if (primaryKeyValueLoc.field.FieldRepetitions != null && primaryKeyValueLoc.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValueLoc.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(primaryKeyValueLoc, fieldData);
        }
...
public HL7V271Field LocationDescription
{
    get
    {
        ...
        if (locationDescription.field.FieldRepetitions != null && locationDescription.field.FieldRepetitions.Count > 0)
        {
            ...
            locationDescription.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(locationDescription, fieldData);
        }
...
public HL7V271Field LocationTypeLoc
{
    get
    {
        ...
        if (locationTypeLoc.field.FieldRepetitions != null && locationTypeLoc.field.FieldRepetitions.Count > 0)
        {
            ...
            locationTypeLoc.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(locationTypeLoc, fieldData);
        }
...
public HL7V271Field OrganizationNameLoc
{
    get
    {
        ...
        if (organizationNameLoc.field.FieldRepetitions != null && organizationNameLoc.field.FieldRepetitions.Count > 0)
        {
            ...
            organizationNameLoc.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(organizationNameLoc, fieldData);
        }
...
public HL7V271Field LocationAddress
{
    get
    {
        ...
        if (locationAddress.field.FieldRepetitions != null && locationAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            locationAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(locationAddress, fieldData);
        }
...
public HL7V271Field LocationPhone
{
    get
    {
        ...
        if (locationPhone.field.FieldRepetitions != null && locationPhone.field.FieldRepetitions.Count > 0)
        {
            ...
            locationPhone.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(locationPhone, fieldData);
        }
...
public HL7V271Field LicenseNumber
{
    get
    {
        ...
        if (licenseNumber.field.FieldRepetitions != null && licenseNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            licenseNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(licenseNumber, fieldData);
        }
...
public HL7V271Field LocationEquipment
{
    get
    {
        ...
        if (locationEquipment.field.FieldRepetitions != null && locationEquipment.field.FieldRepetitions.Count > 0)
        {
            ...
            locationEquipment.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(locationEquipment, fieldData);
        }
...
public HL7V271Field LocationServiceCode
{
    get
    {
        ...
        if (locationServiceCode.field.FieldRepetitions != null && locationServiceCode.field.FieldRepetitions.Count > 0)
        {
            ...
            locationServiceCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(locationServiceCode, fieldData);
        }
