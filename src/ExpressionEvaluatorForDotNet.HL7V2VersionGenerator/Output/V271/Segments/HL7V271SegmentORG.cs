...
public HL7V271Field SetIdOrg
{
    get
    {
        ...
        if (setIdOrg.field.FieldRepetitions != null && setIdOrg.field.FieldRepetitions.Count > 0)
        {
            ...
            setIdOrg.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(setIdOrg, fieldData);
        }
...
public HL7V271Field OrganizationUnitCode
{
    get
    {
        ...
        if (organizationUnitCode.field.FieldRepetitions != null && organizationUnitCode.field.FieldRepetitions.Count > 0)
        {
            ...
            organizationUnitCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(organizationUnitCode, fieldData);
        }
...
public HL7V271Field OrganizationUnitTypeCode
{
    get
    {
        ...
        if (organizationUnitTypeCode.field.FieldRepetitions != null && organizationUnitTypeCode.field.FieldRepetitions.Count > 0)
        {
            ...
            organizationUnitTypeCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(organizationUnitTypeCode, fieldData);
        }
...
N - this is not the primary organization unit",
        ...
        if (primaryOrgUnitIndicator.field.FieldRepetitions != null && primaryOrgUnitIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryOrgUnitIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(primaryOrgUnitIndicator, fieldData);
        }
...
public HL7V271Field PractitionerOrgUnitIdentifier
{
    get
    {
        ...
        if (practitionerOrgUnitIdentifier.field.FieldRepetitions != null && practitionerOrgUnitIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            practitionerOrgUnitIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(practitionerOrgUnitIdentifier, fieldData);
        }
...
public HL7V271Field HealthCareProviderTypeCode
{
    get
    {
        ...
        if (healthCareProviderTypeCode.field.FieldRepetitions != null && healthCareProviderTypeCode.field.FieldRepetitions.Count > 0)
        {
            ...
            healthCareProviderTypeCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(healthCareProviderTypeCode, fieldData);
        }
...
public HL7V271Field HealthCareProviderClassificationCode
{
    get
    {
        ...
        if (healthCareProviderClassificationCode.field.FieldRepetitions != null && healthCareProviderClassificationCode.field.FieldRepetitions.Count > 0)
        {
            ...
            healthCareProviderClassificationCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(healthCareProviderClassificationCode, fieldData);
        }
...
public HL7V271Field HealthCareProviderAreaOfSpecializationCode
{
    get
    {
        ...
        if (healthCareProviderAreaOfSpecializationCode.field.FieldRepetitions != null && healthCareProviderAreaOfSpecializationCode.field.FieldRepetitions.Count > 0)
        {
            ...
            healthCareProviderAreaOfSpecializationCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(healthCareProviderAreaOfSpecializationCode, fieldData);
        }
...
public HL7V271Field EffectiveDateRange
{
    get
    {
        ...
        if (effectiveDateRange.field.FieldRepetitions != null && effectiveDateRange.field.FieldRepetitions.Count > 0)
        {
            ...
            effectiveDateRange.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(effectiveDateRange, fieldData);
        }
...
public HL7V271Field EmploymentStatusCode
{
    get
    {
        ...
        if (employmentStatusCode.field.FieldRepetitions != null && employmentStatusCode.field.FieldRepetitions.Count > 0)
        {
            ...
            employmentStatusCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(employmentStatusCode, fieldData);
        }
...
N - this practice specialty does not require board approval",
        ...
        if (boardApprovalIndicator.field.FieldRepetitions != null && boardApprovalIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            boardApprovalIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(boardApprovalIndicator, fieldData);
        }
...
N - this practice specialty may not act as a primary care physician",
        ...
        if (primaryCarePhysicianIndicator.field.FieldRepetitions != null && primaryCarePhysicianIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryCarePhysicianIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(primaryCarePhysicianIndicator, fieldData);
        }
...
public HL7V271Field CostCenterCode
{
    get
    {
        ...
        if (costCenterCode.field.FieldRepetitions != null && costCenterCode.field.FieldRepetitions.Count > 0)
        {
            ...
            costCenterCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(costCenterCode, fieldData);
        }
