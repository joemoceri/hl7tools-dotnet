...
public HL7V271Field SubstanceIdentifier
{
    get
    {
        ...
        if (substanceIdentifier.field.FieldRepetitions != null && substanceIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            substanceIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(substanceIdentifier, fieldData);
        }
...
public HL7V271Field SubstanceStatus
{
    get
    {
        ...
        if (substanceStatus.field.FieldRepetitions != null && substanceStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            substanceStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(substanceStatus, fieldData);
        }
...
public HL7V271Field SubstanceType
{
    get
    {
        ...
        if (substanceType.field.FieldRepetitions != null && substanceType.field.FieldRepetitions.Count > 0)
        {
            ...
            substanceType.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(substanceType, fieldData);
        }
...
public HL7V271Field InventoryContainerIdentifier
{
    get
    {
        ...
        if (inventoryContainerIdentifier.field.FieldRepetitions != null && inventoryContainerIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryContainerIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(inventoryContainerIdentifier, fieldData);
        }
...
public HL7V271Field ContainerCarrierIdentifier
{
    get
    {
        ...
        if (containerCarrierIdentifier.field.FieldRepetitions != null && containerCarrierIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            containerCarrierIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(containerCarrierIdentifier, fieldData);
        }
...
public HL7V271Field PositionOnCarrier
{
    get
    {
        ...
        if (positionOnCarrier.field.FieldRepetitions != null && positionOnCarrier.field.FieldRepetitions.Count > 0)
        {
            ...
            positionOnCarrier.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(positionOnCarrier, fieldData);
        }
...
public HL7V271Field InitialQuantity
{
    get
    {
        ...
        if (initialQuantity.field.FieldRepetitions != null && initialQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            initialQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(initialQuantity, fieldData);
        }
...
public HL7V271Field CurrentQuantity
{
    get
    {
        ...
        if (currentQuantity.field.FieldRepetitions != null && currentQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            currentQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(currentQuantity, fieldData);
        }
...
public HL7V271Field AvailableQuantity
{
    get
    {
        ...
        if (availableQuantity.field.FieldRepetitions != null && availableQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            availableQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(availableQuantity, fieldData);
        }
...
public HL7V271Field ConsumptionQuantity
{
    get
    {
        ...
        if (consumptionQuantity.field.FieldRepetitions != null && consumptionQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            consumptionQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(consumptionQuantity, fieldData);
        }
...
public HL7V271Field QuantityUnits
{
    get
    {
        ...
        if (quantityUnits.field.FieldRepetitions != null && quantityUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            quantityUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(quantityUnits, fieldData);
        }
...
public HL7V271Field ExpirationDateTime
{
    get
    {
        ...
        if (expirationDateTime.field.FieldRepetitions != null && expirationDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            expirationDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(expirationDateTime, fieldData);
        }
...
public HL7V271Field FirstUsedDateTime
{
    get
    {
        ...
        if (firstUsedDateTime.field.FieldRepetitions != null && firstUsedDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            firstUsedDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(firstUsedDateTime, fieldData);
        }
...
public HL7V271Field OnBoardStabilityDuration
{
    get
    {
        ...
        if (onBoardStabilityDuration.field.FieldRepetitions != null && onBoardStabilityDuration.field.FieldRepetitions.Count > 0)
        {
            ...
            onBoardStabilityDuration.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(onBoardStabilityDuration, fieldData);
        }
...
public HL7V271Field TestFluidIdentifiers
{
    get
    {
        ...
        if (testFluidIdentifiers.field.FieldRepetitions != null && testFluidIdentifiers.field.FieldRepetitions.Count > 0)
        {
            ...
            testFluidIdentifiers.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(testFluidIdentifiers, fieldData);
        }
...
public HL7V271Field ManufacturerLotNumber
{
    get
    {
        ...
        if (manufacturerLotNumber.field.FieldRepetitions != null && manufacturerLotNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            manufacturerLotNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(manufacturerLotNumber, fieldData);
        }
...
public HL7V271Field SupplierIdentifier
{
    get
    {
        ...
        if (supplierIdentifier.field.FieldRepetitions != null && supplierIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            supplierIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(supplierIdentifier, fieldData);
        }
...
The 1st component defines the time quantity and the 2nd component the time units (see HL7 Table 0255 – Duration Categories). Recommended accuracy is ""minutes"", ""hours"" and ""days"".   ",
        ...
        if (onBoardStabilityTime.field.FieldRepetitions != null && onBoardStabilityTime.field.FieldRepetitions.Count > 0)
        {
            ...
            onBoardStabilityTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(onBoardStabilityTime, fieldData);
        }
...
The 1st component defines the value and the 2nd component the measurement units.",
        ...
        if (targetValue.field.FieldRepetitions != null && targetValue.field.FieldRepetitions.Count > 0)
        {
            ...
            targetValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(targetValue, fieldData);
        }
