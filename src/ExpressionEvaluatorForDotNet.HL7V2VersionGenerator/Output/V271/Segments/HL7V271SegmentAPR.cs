...
{
    public class HL7V271SegmentAPR
    {
        ...
        public HL7V271SegmentAPR(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V271Field _timeSelectionCriteria;

public HL7V271Field TimeSelectionCriteria
{
    get
    {
...
For example, if a filler application allows preference parameters to be passed to specify a preferred start time, a preferred end time, and preferred days of the week for the appointment, it may define the following parameter class codes and valid data sets.",
        ...
        _timeSelectionCriteria = new HL7V271Field
        {
            field = message[@"APR"][1],
            fieldData = fieldData
        };
        ...
        {
            _timeSelectionCriteria.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_timeSelectionCriteria, fieldData);
        }
...
internal HL7V271Field _resourceSelectionCriteria;

public HL7V271Field ResourceSelectionCriteria
{
    get
    {
...
For example, if a filler application allows preference parameters to be passed to specify a preferred start time, a preferred end time, and preferred days of the week for the appointment, it may define the following parameter class codes and valid data sets.",
        ...
        _resourceSelectionCriteria = new HL7V271Field
        {
            field = message[@"APR"][2],
            fieldData = fieldData
        };
        ...
        {
            _resourceSelectionCriteria.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_resourceSelectionCriteria, fieldData);
        }
...
internal HL7V271Field _locationSelectionCriteria;

public HL7V271Field LocationSelectionCriteria
{
    get
    {
...
For example, if a filler application allows preference parameters to be passed to specify a preferred start time, a preferred end time, and preferred days of the week for the appointment, it may define the following parameter class codes and valid data sets.",
        ...
        _locationSelectionCriteria = new HL7V271Field
        {
            field = message[@"APR"][3],
            fieldData = fieldData
        };
        ...
        {
            _locationSelectionCriteria.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_locationSelectionCriteria, fieldData);
        }
...
internal HL7V271Field _slotSpacingCriteria;

public HL7V271Field SlotSpacingCriteria
{
    get
    {
...
10:00 - 11:30",
        ...
        _slotSpacingCriteria = new HL7V271Field
        {
            field = message[@"APR"][4],
            fieldData = fieldData
        };
        ...
        {
            _slotSpacingCriteria.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_slotSpacingCriteria, fieldData);
        }
...
internal HL7V271Field _fillerOverrideCriteria;

public HL7V271Field FillerOverrideCriteria
{
    get
    {
...
For example, if a filler application allows preference parameters to be passed to specify a preferred start time, a preferred end time, and preferred days of the week for the appointment, it may define the following parameter class codes and valid data sets.",
        ...
        _fillerOverrideCriteria = new HL7V271Field
        {
            field = message[@"APR"][5],
            fieldData = fieldData
        };
        ...
        {
            _fillerOverrideCriteria.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_fillerOverrideCriteria, fieldData);
        }
