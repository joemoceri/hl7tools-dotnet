...
Value set version ID is required if CWE.21 is populated.",
        ...
        internal HL7V271Field bedLocation;
...
public HL7V271Field BedLocation
{
    get
    {
        ...
        if (bedLocation.field.FieldRepetitions != null && bedLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            bedLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(bedLocation, fieldData);
        }
...
internal HL7V271Field bedStatus;
...
public HL7V271Field BedStatus
{
    get
    {
        ...
        if (bedStatus.field.FieldRepetitions != null && bedStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            bedStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(bedStatus, fieldData);
        }
