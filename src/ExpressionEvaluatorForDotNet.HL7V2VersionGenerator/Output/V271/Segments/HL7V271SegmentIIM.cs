...
Value set version ID is required if CNE.21 is populated.",
        ...
        internal HL7V271Field primaryKeyValueIim;
...
public HL7V271Field PrimaryKeyValueIim
{
    get
    {
        ...
        primaryKeyValueIim = new HL7V271Field
        {
            field = message[@"IIM"][1],
            Id = @"IIM.1",
            Type = @"Field",
        ...
        if (primaryKeyValueIim.field.FieldRepetitions != null && primaryKeyValueIim.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValueIim.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(primaryKeyValueIim, fieldData);
        }
...
internal HL7V271Field serviceItemCode;
...
public HL7V271Field ServiceItemCode
{
    get
    {
        ...
        serviceItemCode = new HL7V271Field
        {
            field = message[@"IIM"][2],
            Id = @"IIM.2",
            Type = @"Field",
        ...
        if (serviceItemCode.field.FieldRepetitions != null && serviceItemCode.field.FieldRepetitions.Count > 0)
        {
            ...
            serviceItemCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(serviceItemCode, fieldData);
        }
...
internal HL7V271Field inventoryLotNumber;
...
public HL7V271Field InventoryLotNumber
{
    get
    {
        ...
        inventoryLotNumber = new HL7V271Field
        {
            field = message[@"IIM"][3],
            Id = @"IIM.3",
            Type = @"Field",
...
Note:  The lot number is the number printed on the label attached to the item or container holding the substance.  If the substance is a vaccine, for example, and a diluent is required, a lot number may appear on the vial containing the diluent; however, any such identifier associated with a diluent is not the identifier of interest. The substance lot number should be reported, not that of the diluent.",
        ...
        if (inventoryLotNumber.field.FieldRepetitions != null && inventoryLotNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryLotNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(inventoryLotNumber, fieldData);
        }
...
internal HL7V271Field inventoryExpirationDate;
...
public HL7V271Field InventoryExpirationDate
{
    get
    {
        ...
        inventoryExpirationDate = new HL7V271Field
        {
            field = message[@"IIM"][4],
            Id = @"IIM.4",
            Type = @"Field",
...
Note:  Expiration date does not always have a ""day"" component; therefore, such a date may be transmitted as YYYYMM.",
        ...
        if (inventoryExpirationDate.field.FieldRepetitions != null && inventoryExpirationDate.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryExpirationDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(inventoryExpirationDate, fieldData);
        }
...
internal HL7V271Field inventoryManufacturerName;
...
public HL7V271Field InventoryManufacturerName
{
    get
    {
        ...
        inventoryManufacturerName = new HL7V271Field
        {
            field = message[@"IIM"][5],
            Id = @"IIM.5",
            Type = @"Field",
        ...
        if (inventoryManufacturerName.field.FieldRepetitions != null && inventoryManufacturerName.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryManufacturerName.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(inventoryManufacturerName, fieldData);
        }
...
internal HL7V271Field inventoryLocation;
...
public HL7V271Field InventoryLocation
{
    get
    {
        ...
        inventoryLocation = new HL7V271Field
        {
            field = message[@"IIM"][6],
            Id = @"IIM.6",
            Type = @"Field",
        ...
        if (inventoryLocation.field.FieldRepetitions != null && inventoryLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(inventoryLocation, fieldData);
        }
...
internal HL7V271Field inventoryReceivedDate;
...
public HL7V271Field InventoryReceivedDate
{
    get
    {
        ...
        inventoryReceivedDate = new HL7V271Field
        {
            field = message[@"IIM"][7],
            Id = @"IIM.7",
            Type = @"Field",
        ...
        if (inventoryReceivedDate.field.FieldRepetitions != null && inventoryReceivedDate.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryReceivedDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(inventoryReceivedDate, fieldData);
        }
...
internal HL7V271Field inventoryReceivedQuantity;
...
public HL7V271Field InventoryReceivedQuantity
{
    get
    {
        ...
        inventoryReceivedQuantity = new HL7V271Field
        {
            field = message[@"IIM"][8],
            Id = @"IIM.8",
            Type = @"Field",
        ...
        if (inventoryReceivedQuantity.field.FieldRepetitions != null && inventoryReceivedQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryReceivedQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(inventoryReceivedQuantity, fieldData);
        }
...
internal HL7V271Field inventoryReceivedQuantityUnit;
...
public HL7V271Field InventoryReceivedQuantityUnit
{
    get
    {
        ...
        inventoryReceivedQuantityUnit = new HL7V271Field
        {
            field = message[@"IIM"][9],
            Id = @"IIM.9",
            Type = @"Field",
        ...
        if (inventoryReceivedQuantityUnit.field.FieldRepetitions != null && inventoryReceivedQuantityUnit.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryReceivedQuantityUnit.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(inventoryReceivedQuantityUnit, fieldData);
        }
...
internal HL7V271Field inventoryReceivedItemCost;
...
public HL7V271Field InventoryReceivedItemCost
{
    get
    {
        ...
        inventoryReceivedItemCost = new HL7V271Field
        {
        ...
        if (inventoryReceivedItemCost.field.FieldRepetitions != null && inventoryReceivedItemCost.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryReceivedItemCost.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(inventoryReceivedItemCost, fieldData);
        }
...
internal HL7V271Field inventoryOnHandDate;
...
public HL7V271Field InventoryOnHandDate
{
    get
    {
        ...
        inventoryOnHandDate = new HL7V271Field
        {
        ...
        if (inventoryOnHandDate.field.FieldRepetitions != null && inventoryOnHandDate.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryOnHandDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(inventoryOnHandDate, fieldData);
        }
...
internal HL7V271Field inventoryOnHandQuantity;
...
public HL7V271Field InventoryOnHandQuantity
{
    get
    {
        ...
        inventoryOnHandQuantity = new HL7V271Field
        {
        ...
        if (inventoryOnHandQuantity.field.FieldRepetitions != null && inventoryOnHandQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryOnHandQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(inventoryOnHandQuantity, fieldData);
        }
...
internal HL7V271Field inventoryOnHandQuantityUnit;
...
public HL7V271Field InventoryOnHandQuantityUnit
{
    get
    {
        ...
        inventoryOnHandQuantityUnit = new HL7V271Field
        {
        ...
        if (inventoryOnHandQuantityUnit.field.FieldRepetitions != null && inventoryOnHandQuantityUnit.field.FieldRepetitions.Count > 0)
        {
            ...
            inventoryOnHandQuantityUnit.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(inventoryOnHandQuantityUnit, fieldData);
        }
