...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V271SegmentRFI
    {
        ...
        public HL7V271SegmentRFI(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V271Field _requestDate;
...
public HL7V271Field RequestDate
{
    get
    {
        ...
        {
            _requestDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_requestDate, fieldData);
        }
...
internal HL7V271Field _responseDueDate;

public HL7V271Field ResponseDueDate
{
    get
    {
        ...
        _responseDueDate = new HL7V271Field
        {
            field = message[@"RFI"][2],
            fieldData = fieldData
        };
        ...
        {
            _responseDueDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_responseDueDate, fieldData);
        }
...
internal HL7V271Field _patientConsent;

public HL7V271Field PatientConsent
{
    get
    {
        ...
        _patientConsent = new HL7V271Field
        {
            field = message[@"RFI"][3],
            fieldData = fieldData
        };
        ...
        {
            _patientConsent.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_patientConsent, fieldData);
        }
...
internal HL7V271Field _dateAdditionalInformationWasSubmitted;

public HL7V271Field DateAdditionalInformationWasSubmitted
{
    get
    {
        ...
        _dateAdditionalInformationWasSubmitted = new HL7V271Field
        {
            field = message[@"RFI"][4],
            fieldData = fieldData
        };
        ...
        {
            _dateAdditionalInformationWasSubmitted.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_dateAdditionalInformationWasSubmitted, fieldData);
        }
