...
public HL7V271Field DiagnosticRelatedGroup
{
    get
    {
        ...
        if (diagnosticRelatedGroup.field.FieldRepetitions != null && diagnosticRelatedGroup.field.FieldRepetitions.Count > 0)
        {
            ...
            diagnosticRelatedGroup.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(diagnosticRelatedGroup, fieldData);
        }
...
public HL7V271Field DrgAssignedDateTime
{
    get
    {
        ...
        if (drgAssignedDateTime.field.FieldRepetitions != null && drgAssignedDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            drgAssignedDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(drgAssignedDateTime, fieldData);
        }
...
N - the DRG has not been approved",
        ...
        if (drgApprovalIndicator.field.FieldRepetitions != null && drgApprovalIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            drgApprovalIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(drgApprovalIndicator, fieldData);
        }
...
public HL7V271Field DrgGrouperReviewCode
{
    get
    {
        ...
        if (drgGrouperReviewCode.field.FieldRepetitions != null && drgGrouperReviewCode.field.FieldRepetitions.Count > 0)
        {
            ...
            drgGrouperReviewCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(drgGrouperReviewCode, fieldData);
        }
...
public HL7V271Field OutlierType
{
    get
    {
        ...
        if (outlierType.field.FieldRepetitions != null && outlierType.field.FieldRepetitions.Count > 0)
        {
            ...
            outlierType.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(outlierType, fieldData);
        }
...
public HL7V271Field OutlierDays
{
    get
    {
        ...
        if (outlierDays.field.FieldRepetitions != null && outlierDays.field.FieldRepetitions.Count > 0)
        {
            ...
            outlierDays.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(outlierDays, fieldData);
        }
...
public HL7V271Field OutlierCost
{
    get
    {
        ...
        if (outlierCost.field.FieldRepetitions != null && outlierCost.field.FieldRepetitions.Count > 0)
        {
            ...
            outlierCost.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(outlierCost, fieldData);
        }
...
public HL7V271Field DrgPayor
{
    get
    {
        ...
        if (drgPayor.field.FieldRepetitions != null && drgPayor.field.FieldRepetitions.Count > 0)
        {
            ...
            drgPayor.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(drgPayor, fieldData);
        }
...
public HL7V271Field OutlierReimbursement
{
    get
    {
        ...
        if (outlierReimbursement.field.FieldRepetitions != null && outlierReimbursement.field.FieldRepetitions.Count > 0)
        {
            ...
            outlierReimbursement.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(outlierReimbursement, fieldData);
        }
...
N - the DRG does not contain a confidential diagnosis",
        ...
        if (confidentialIndicator.field.FieldRepetitions != null && confidentialIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            confidentialIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(confidentialIndicator, fieldData);
        }
...
public HL7V271Field DrgTransferType
{
    get
    {
        ...
        if (drgTransferType.field.FieldRepetitions != null && drgTransferType.field.FieldRepetitions.Count > 0)
        {
            ...
            drgTransferType.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(drgTransferType, fieldData);
        }
...
public HL7V271Field NameOfCoder
{
    get
    {
        ...
        if (nameOfCoder.field.FieldRepetitions != null && nameOfCoder.field.FieldRepetitions.Count > 0)
        {
            ...
            nameOfCoder.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(nameOfCoder, fieldData);
        }
...
public HL7V271Field GrouperStatus
{
    get
    {
        ...
        if (grouperStatus.field.FieldRepetitions != null && grouperStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            grouperStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(grouperStatus, fieldData);
        }
...
public HL7V271Field PcclValueCode
{
    get
    {
        ...
        if (pcclValueCode.field.FieldRepetitions != null && pcclValueCode.field.FieldRepetitions.Count > 0)
        {
            ...
            pcclValueCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(pcclValueCode, fieldData);
        }
...
public HL7V271Field EffectiveWeight
{
    get
    {
        ...
        if (effectiveWeight.field.FieldRepetitions != null && effectiveWeight.field.FieldRepetitions.Count > 0)
        {
            ...
            effectiveWeight.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(effectiveWeight, fieldData);
        }
...
public HL7V271Field MonetaryAmount
{
    get
    {
        ...
        if (monetaryAmount.field.FieldRepetitions != null && monetaryAmount.field.FieldRepetitions.Count > 0)
        {
            ...
            monetaryAmount.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(monetaryAmount, fieldData);
        }
...
This field is also used along with DRG-23 and DRG-24 as an indication of whether a surcharge (long length of stay) or a discount (short length of stay) has been determined.",
        ...
        if (statusPatient.field.FieldRepetitions != null && statusPatient.field.FieldRepetitions.Count > 0)
        {
            ...
            statusPatient.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(statusPatient, fieldData);
        }
...
public HL7V271Field GrouperSoftwareName
{
    get
    {
        ...
        if (grouperSoftwareName.field.FieldRepetitions != null && grouperSoftwareName.field.FieldRepetitions.Count > 0)
        {
            ...
            grouperSoftwareName.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(grouperSoftwareName, fieldData);
        }
...
public HL7V271Field GrouperSoftwareVersion
{
    get
    {
        ...
        if (grouperSoftwareVersion.field.FieldRepetitions != null && grouperSoftwareVersion.field.FieldRepetitions.Count > 0)
        {
            ...
            grouperSoftwareVersion.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(grouperSoftwareVersion, fieldData);
        }
...
public HL7V271Field StatusFinancialCalculation
{
    get
    {
        ...
        if (statusFinancialCalculation.field.FieldRepetitions != null && statusFinancialCalculation.field.FieldRepetitions.Count > 0)
        {
            ...
            statusFinancialCalculation.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(statusFinancialCalculation, fieldData);
        }
...
public HL7V271Field RelativeDiscountSurcharge
{
    get
    {
        ...
        if (relativeDiscountSurcharge.field.FieldRepetitions != null && relativeDiscountSurcharge.field.FieldRepetitions.Count > 0)
        {
            ...
            relativeDiscountSurcharge.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(relativeDiscountSurcharge, fieldData);
        }
...
public HL7V271Field BasicCharge
{
    get
    {
        ...
        if (basicCharge.field.FieldRepetitions != null && basicCharge.field.FieldRepetitions.Count > 0)
        {
            ...
            basicCharge.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(basicCharge, fieldData);
        }
...
public HL7V271Field TotalCharge
{
    get
    {
        ...
        if (totalCharge.field.FieldRepetitions != null && totalCharge.field.FieldRepetitions.Count > 0)
        {
            ...
            totalCharge.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(totalCharge, fieldData);
        }
...
public HL7V271Field DiscountSurcharge
{
    get
    {
        ...
        if (discountSurcharge.field.FieldRepetitions != null && discountSurcharge.field.FieldRepetitions.Count > 0)
        {
            ...
            discountSurcharge.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(discountSurcharge, fieldData);
        }
...
public HL7V271Field CalculatedDays
{
    get
    {
        ...
        if (calculatedDays.field.FieldRepetitions != null && calculatedDays.field.FieldRepetitions.Count > 0)
        {
            ...
            calculatedDays.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(calculatedDays, fieldData);
        }
...
public HL7V271Field StatusGender
{
    get
    {
        ...
        if (statusGender.field.FieldRepetitions != null && statusGender.field.FieldRepetitions.Count > 0)
        {
            ...
            statusGender.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(statusGender, fieldData);
        }
...
public HL7V271Field StatusAge
{
    get
    {
        ...
        if (statusAge.field.FieldRepetitions != null && statusAge.field.FieldRepetitions.Count > 0)
        {
            ...
            statusAge.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(statusAge, fieldData);
        }
...
public HL7V271Field StatusLengthOfStay
{
    get
    {
        ...
        if (statusLengthOfStay.field.FieldRepetitions != null && statusLengthOfStay.field.FieldRepetitions.Count > 0)
        {
            ...
            statusLengthOfStay.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(statusLengthOfStay, fieldData);
        }
...
public HL7V271Field StatusSameDayFlag
{
    get
    {
        ...
        if (statusSameDayFlag.field.FieldRepetitions != null && statusSameDayFlag.field.FieldRepetitions.Count > 0)
        {
            ...
            statusSameDayFlag.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(statusSameDayFlag, fieldData);
        }
...
public HL7V271Field StatusSeparationMode
{
    get
    {
        ...
        if (statusSeparationMode.field.FieldRepetitions != null && statusSeparationMode.field.FieldRepetitions.Count > 0)
        {
            ...
            statusSeparationMode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(statusSeparationMode, fieldData);
        }
...
public HL7V271Field StatusWeightAtBirth
{
    get
    {
        ...
        if (statusWeightAtBirth.field.FieldRepetitions != null && statusWeightAtBirth.field.FieldRepetitions.Count > 0)
        {
            ...
            statusWeightAtBirth.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(statusWeightAtBirth, fieldData);
        }
...
public HL7V271Field StatusRespirationMinutes
{
    get
    {
        ...
        if (statusRespirationMinutes.field.FieldRepetitions != null && statusRespirationMinutes.field.FieldRepetitions.Count > 0)
        {
            ...
            statusRespirationMinutes.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(statusRespirationMinutes, fieldData);
        }
...
public HL7V271Field StatusAdmission
{
    get
    {
        ...
        if (statusAdmission.field.FieldRepetitions != null && statusAdmission.field.FieldRepetitions.Count > 0)
        {
            ...
            statusAdmission.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(statusAdmission, fieldData);
        }
