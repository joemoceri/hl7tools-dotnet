...
public HL7V271Field SetIdPkg
{
    get
    {
        ...
        if (setIdPkg.field.FieldRepetitions != null && setIdPkg.field.FieldRepetitions.Count > 0)
        {
            ...
            setIdPkg.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(setIdPkg, fieldData);
        }
...
public HL7V271Field PackagingUnits
{
    get
    {
        ...
        if (packagingUnits.field.FieldRepetitions != null && packagingUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            packagingUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(packagingUnits, fieldData);
        }
...
public HL7V271Field DefaultOrderUnitOfMeasureIndicator
{
    get
    {
        ...
        if (defaultOrderUnitOfMeasureIndicator.field.FieldRepetitions != null && defaultOrderUnitOfMeasureIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            defaultOrderUnitOfMeasureIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(defaultOrderUnitOfMeasureIndicator, fieldData);
        }
...
public HL7V271Field PackageQuantity
{
    get
    {
        ...
        if (packageQuantity.field.FieldRepetitions != null && packageQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            packageQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(packageQuantity, fieldData);
        }
...
public HL7V271Field FutureItemPrice
{
    get
    {
        ...
        if (futureItemPrice.field.FieldRepetitions != null && futureItemPrice.field.FieldRepetitions.Count > 0)
        {
            ...
            futureItemPrice.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(futureItemPrice, fieldData);
        }
...
public HL7V271Field FutureItemPriceEffectiveDate
{
    get
    {
        ...
        if (futureItemPriceEffectiveDate.field.FieldRepetitions != null && futureItemPriceEffectiveDate.field.FieldRepetitions.Count > 0)
        {
            ...
            futureItemPriceEffectiveDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(futureItemPriceEffectiveDate, fieldData);
        }
