...
internal HL7V271Field _continuationStyle;
...
public HL7V271Field ContinuationStyle
{
    get
    {
        ...
        _continuationStyle = new HL7V271Field
        {
            field = message[@"DSC"][2],
            fieldData = fieldData
        };
        ...
        {
            _continuationStyle.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_continuationStyle, fieldData);
        }
