...
public HL7V271Field ProviderRole
{
    get
    {
        ...
        if (providerRole.field.FieldRepetitions != null && providerRole.field.FieldRepetitions.Count > 0)
        {
            ...
            providerRole.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(providerRole, fieldData);
        }
...
public HL7V271Field ProviderName
{
    get
    {
        ...
        if (providerName.field.FieldRepetitions != null && providerName.field.FieldRepetitions.Count > 0)
        {
            ...
            providerName.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(providerName, fieldData);
        }
...
public HL7V271Field ProviderAddress
{
    get
    {
        ...
        if (providerAddress.field.FieldRepetitions != null && providerAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            providerAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(providerAddress, fieldData);
        }
...
public HL7V271Field ProviderLocation
{
    get
    {
        ...
        if (providerLocation.field.FieldRepetitions != null && providerLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            providerLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(providerLocation, fieldData);
        }
...
public HL7V271Field ProviderCommunicationInformation
{
    get
    {
        ...
        if (providerCommunicationInformation.field.FieldRepetitions != null && providerCommunicationInformation.field.FieldRepetitions.Count > 0)
        {
            ...
            providerCommunicationInformation.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(providerCommunicationInformation, fieldData);
        }
...
public HL7V271Field PreferredMethodOfContact
{
    get
    {
        ...
        if (preferredMethodOfContact.field.FieldRepetitions != null && preferredMethodOfContact.field.FieldRepetitions.Count > 0)
        {
            ...
            preferredMethodOfContact.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(preferredMethodOfContact, fieldData);
        }
...
public HL7V271Field ProviderIdentifiers
{
    get
    {
        ...
        if (providerIdentifiers.field.FieldRepetitions != null && providerIdentifiers.field.FieldRepetitions.Count > 0)
        {
            ...
            providerIdentifiers.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(providerIdentifiers, fieldData);
        }
...
public HL7V271Field EffectiveStartDateOfProviderRole
{
    get
    {
        ...
        if (effectiveStartDateOfProviderRole.field.FieldRepetitions != null && effectiveStartDateOfProviderRole.field.FieldRepetitions.Count > 0)
        {
            ...
            effectiveStartDateOfProviderRole.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(effectiveStartDateOfProviderRole, fieldData);
        }
...
Note:  The PRD-8-Effective Start Date of Role and PRD-9-Effective End Date of Role fields should not be used as trigger events.  For example, they should not be used to trigger a change in role.  These two dates are for informational purposes only.",
        ...
        if (effectiveEndDateOfProviderRole.field.FieldRepetitions != null && effectiveEndDateOfProviderRole.field.FieldRepetitions.Count > 0)
        {
            ...
            effectiveEndDateOfProviderRole.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(effectiveEndDateOfProviderRole, fieldData);
        }
...
public HL7V271Field ProviderOrganizationNameAndIdentifier
{
    get
    {
        ...
        if (providerOrganizationNameAndIdentifier.field.FieldRepetitions != null && providerOrganizationNameAndIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            providerOrganizationNameAndIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(providerOrganizationNameAndIdentifier, fieldData);
        }
...
public HL7V271Field ProviderOrganizationAddress
{
    get
    {
        ...
        if (providerOrganizationAddress.field.FieldRepetitions != null && providerOrganizationAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            providerOrganizationAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(providerOrganizationAddress, fieldData);
        }
...
public HL7V271Field ProviderOrganizationLocationInformation
{
    get
    {
        ...
        if (providerOrganizationLocationInformation.field.FieldRepetitions != null && providerOrganizationLocationInformation.field.FieldRepetitions.Count > 0)
        {
            ...
            providerOrganizationLocationInformation.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(providerOrganizationLocationInformation, fieldData);
        }
...
public HL7V271Field ProviderOrganizationCommunicationInformation
{
    get
    {
        ...
        if (providerOrganizationCommunicationInformation.field.FieldRepetitions != null && providerOrganizationCommunicationInformation.field.FieldRepetitions.Count > 0)
        {
            ...
            providerOrganizationCommunicationInformation.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(providerOrganizationCommunicationInformation, fieldData);
        }
...
public HL7V271Field ProviderOrganizationMethodOfContact
{
    get
    {
        ...
        if (providerOrganizationMethodOfContact.field.FieldRepetitions != null && providerOrganizationMethodOfContact.field.FieldRepetitions.Count > 0)
        {
            ...
            providerOrganizationMethodOfContact.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(providerOrganizationMethodOfContact, fieldData);
        }
