...
public HL7V271Field SetIdAis
{
    get
    {
        ...
        if (setIdAis.field.FieldRepetitions != null && setIdAis.field.FieldRepetitions.Count > 0)
        {
            ...
            setIdAis.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(setIdAis, fieldData);
        }
...
public HL7V271Field PlacerSupplementalServiceInformation
{
    get
    {
        ...
        if (placerSupplementalServiceInformation.field.FieldRepetitions != null && placerSupplementalServiceInformation.field.FieldRepetitions.Count > 0)
        {
            ...
            placerSupplementalServiceInformation.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(placerSupplementalServiceInformation, fieldData);
        }
...
public HL7V271Field FillerSupplementalServiceInformation
{
    get
    {
        ...
        if (fillerSupplementalServiceInformation.field.FieldRepetitions != null && fillerSupplementalServiceInformation.field.FieldRepetitions.Count > 0)
        {
            ...
            fillerSupplementalServiceInformation.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(fillerSupplementalServiceInformation, fieldData);
        }
