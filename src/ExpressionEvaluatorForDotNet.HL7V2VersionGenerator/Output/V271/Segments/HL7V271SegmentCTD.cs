...
{
    public class HL7V271SegmentCTD
    {
        ...
        public HL7V271SegmentCTD(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V271Field _contactRole;

public HL7V271Field ContactRole
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _contactRole.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_contactRole, fieldData);
        }
...
internal HL7V271Field _contactName;

public HL7V271Field ContactName
{
    get
    {
...
Examples:
 ...
 - Mary Margaret Elizabeth Jones is Called By Meg.",
        ...
        {
            _contactName.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_contactName, fieldData);
        }
...
internal HL7V271Field _contactLocation;

public HL7V271Field ContactLocation
{
    get
    {
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _contactLocation = new HL7V271Field
        {
            field = message[@"CTD"][4],
            fieldData = fieldData
        };
        ...
        {
            _contactLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_contactLocation, fieldData);
        }
...
internal HL7V271Field _contactCommunicationInformation;

public HL7V271Field ContactCommunicationInformation
{
    get
    {
...
Preference order numbers need not be sequential (i.e., three numbers with the priority orders of 0, 5 and 15 are legitimate).  The preference order numbers must be non-negative.",
        ...
        _contactCommunicationInformation = new HL7V271Field
        {
            field = message[@"CTD"][5],
            fieldData = fieldData
        };
        ...
        {
            _contactCommunicationInformation.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_contactCommunicationInformation, fieldData);
        }
...
public HL7V271Field PreferredMethodOfContact
{
    get
    {
        ...
        var fieldData = new HL7V271FieldData
        {
            ...
            Description = @"This field contains the preferred method to use when communicating with the contact person.  Refer to User-defined Table 0185 - Preferred Method of Contact in Chapter 2C, ""Code Tables"", for suggested values. ",
            Sample = @"",
            Fields = new[]
                        {
                            new HL7V2FieldData
...
internal HL7V271Field _contactIdentifiers;

public HL7V271Field ContactIdentifiers
{
    get
    {
        ...
        var fieldData = new HL7V271FieldData
        {
            ...
            TableId = null,
            TableName = null,
            Description = @"This repeating field contains the contact's unique identifiers such as UPIN, Medicare and Medicaid numbers.  Refer to User-defined Table 0338 - Practitioner ID Number Type (see Chapter 2, ""Code Tables"") for suggested values.",
            Sample = @"",
            Fields = new[]
                        {
                            new HL7V2FieldData
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _contactIdentifiers = new HL7V271Field
        {
            field = message[@"CTD"][7],
            fieldData = fieldData
        };
        ...
        {
            _contactIdentifiers.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_contactIdentifiers, fieldData);
        }
