...
internal HL7V271Field testObservationsIncludedWithinAnOrderedTestBattery;
...
public HL7V271Field TestObservationsIncludedWithinAnOrderedTestBattery
{
    get
    {
        ...
        testObservationsIncludedWithinAnOrderedTestBattery = new HL7V271Field
        {
            field = message[@"OM5"][2],
            Id = @"OM5.2",
            Type = @"Field",
...
402^Electrolytes~352^Urinalysis~432^CBC~520^SMA12",
        ...
        if (testObservationsIncludedWithinAnOrderedTestBattery.field.FieldRepetitions != null && testObservationsIncludedWithinAnOrderedTestBattery.field.FieldRepetitions.Count > 0)
        {
            ...
            testObservationsIncludedWithinAnOrderedTestBattery.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(testObservationsIncludedWithinAnOrderedTestBattery, fieldData);
        }
...
internal HL7V271Field observationIdSuffixes;
...
public HL7V271Field ObservationIdSuffixes
{
    get
    {
        ...
        observationIdSuffixes = new HL7V271Field
        {
            field = message[@"OM5"][3],
            Id = @"OM5.3",
            Type = @"Field",
        ...
        if (observationIdSuffixes.field.FieldRepetitions != null && observationIdSuffixes.field.FieldRepetitions.Count > 0)
        {
            ...
            observationIdSuffixes.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(observationIdSuffixes, fieldData);
        }
