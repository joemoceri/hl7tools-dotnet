...
{
    public class HL7V271SegmentARQ
    {
...
Refer to HL7 Table 0301 - Universal ID Type for valid values.",
        ...
        public HL7V271SegmentARQ(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V271Field placerAppointmentId;

public HL7V271Field PlacerAppointmentId
{
    get
    {
        ...
        placerAppointmentId = new HL7V271Field
        {
            field = message[@"ARQ"][1],
            Id = @"ARQ.1",
            Type = @"Field",
...
The second through fourth components contain the assigning authority identifying information.  ",
        ...
        if (placerAppointmentId.field.FieldRepetitions != null && placerAppointmentId.field.FieldRepetitions.Count > 0)
        {
            ...
            placerAppointmentId.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(placerAppointmentId, fieldData);
        }
...
internal HL7V271Field fillerAppointmentId;

public HL7V271Field FillerAppointmentId
{
    get
    {
        ...
        fillerAppointmentId = new HL7V271Field
        {
            field = message[@"ARQ"][2],
            Id = @"ARQ.2",
            Type = @"Field",
...
The second through fourth components contain the assigning authority identifying information. This is a conditionally required field.  On initial request messages and other messages where a filler has not yet assigned a filler appointment ID, this field should not contain a value.  In all other subsequent messages, where a filler application has assigned a filler appointment ID and communicated it to other applications, this field is required.",
        ...
        if (fillerAppointmentId.field.FieldRepetitions != null && fillerAppointmentId.field.FieldRepetitions.Count > 0)
        {
            ...
            fillerAppointmentId.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(fillerAppointmentId, fieldData);
        }
...
internal HL7V271Field occurrenceNumber;

public HL7V271Field OccurrenceNumber
{
    get
    {
        ...
        occurrenceNumber = new HL7V271Field
        {
            field = message[@"ARQ"][3],
            Id = @"ARQ.3",
            Type = @"Field",
...
This field is conditionally required.  If the transaction using this segment is meant to apply only to one occurrence of a repeating appointment, and an occurrence number is required to uniquely identify the child appointment (that is, the child does not have a separate and unique placer appointment ID or filler appointment ID), then this field is required.",
        ...
        if (occurrenceNumber.field.FieldRepetitions != null && occurrenceNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            occurrenceNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(occurrenceNumber, fieldData);
        }
...
internal HL7V271Field placerGroupNumber;

public HL7V271Field PlacerGroupNumber
{
    get
    {
        ...
        placerGroupNumber = new HL7V271Field
        {
            field = message[@"ARQ"][4],
            Id = @"ARQ.4",
            Type = @"Field",
...
The second through fourth components contain the assigning authority identifying information.  ",
        ...
        if (placerGroupNumber.field.FieldRepetitions != null && placerGroupNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            placerGroupNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(placerGroupNumber, fieldData);
        }
...
internal HL7V271Field scheduleId;

public HL7V271Field ScheduleId
{
    get
    {
        if (scheduleId != null)
...
If a new appointment must be booked, it may be necessary to provide a schedule ID to uniquely identify the intended slot(s) being requested in the transaction.  After the request has been assigned to one or more slots; however, the filler application should assign a unique filler appointment ID (see sections 10.6.1.1, ""ARQ-1   Placer Appointment ID   (EI)   00860,"" and 10.6.1.2, ""ARQ-2   Filler Appointment ID   (EI)   00861).""  This filler appointment ID, as its definition indicates, should uniquely identify the appointment among all such requests and appointments within the filler application.  This means that, once assigned, the filler appointment ID should uniquely identify the appointment (either as a request or as a booked appointment) without a need to provide the schedule ID too.  As a cautionary note regarding implementation, if the filler appointment ID would not otherwise be unique, it may be necessary to include the schedule ID as part of the filler appointment ID.  This can be done either by prefixing the appointment ID with the schedule ID, or by appending the schedule ID to the appointment ID.",
        ...
        if (scheduleId.field.FieldRepetitions != null && scheduleId.field.FieldRepetitions.Count > 0)
        {
            ...
            scheduleId.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(scheduleId, fieldData);
        }
...
internal HL7V271Field requestEventReason;

public HL7V271Field RequestEventReason
{
    get
    {
        ...
        requestEventReason = new HL7V271Field
        {
            field = message[@"ARQ"][6],
            Id = @"ARQ.6",
            Type = @"Field",
        ...
        if (requestEventReason.field.FieldRepetitions != null && requestEventReason.field.FieldRepetitions.Count > 0)
        {
            ...
            requestEventReason.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(requestEventReason, fieldData);
        }
...
internal HL7V271Field appointmentReason;

public HL7V271Field AppointmentReason
{
    get
    {
        ...
        appointmentReason = new HL7V271Field
        {
            field = message[@"ARQ"][7],
            Id = @"ARQ.7",
            Type = @"Field",
        ...
        if (appointmentReason.field.FieldRepetitions != null && appointmentReason.field.FieldRepetitions.Count > 0)
        {
            ...
            appointmentReason.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(appointmentReason, fieldData);
        }
...
internal HL7V271Field appointmentType;

public HL7V271Field AppointmentType
{
    get
    {
        ...
        appointmentType = new HL7V271Field
        {
            field = message[@"ARQ"][8],
            Id = @"ARQ.8",
            Type = @"Field",
        ...
        if (appointmentType.field.FieldRepetitions != null && appointmentType.field.FieldRepetitions.Count > 0)
        {
            ...
            appointmentType.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(appointmentType, fieldData);
        }
...
internal HL7V271Field appointmentDuration;

public HL7V271Field AppointmentDuration
{
    get
    {
        ...
        appointmentDuration = new HL7V271Field
        {
            field = message[@"ARQ"][9],
            Id = @"ARQ.9",
            Type = @"Field",
...
The appointment duration field must contain a positive, non-zero number.  A negative number or zero (0) is nonsensical in the context of a duration.",
        ...
        if (appointmentDuration.field.FieldRepetitions != null && appointmentDuration.field.FieldRepetitions.Count > 0)
        {
            ...
            appointmentDuration.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(appointmentDuration, fieldData);
        }
...
internal HL7V271Field appointmentDurationUnits;

public HL7V271Field AppointmentDurationUnits
{
    get
    {
        ...
        appointmentDurationUnits = new HL7V271Field
        {
...
As of v2.6, the known applicable external coding systems include those in the table below. If the code set you are using is in this table, then you must use that designation.",
        ...
        if (appointmentDurationUnits.field.FieldRepetitions != null && appointmentDurationUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            appointmentDurationUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(appointmentDurationUnits, fieldData);
        }
...
internal HL7V271Field requestedStartDateTimeRange;

public HL7V271Field RequestedStartDateTimeRange
{
    get
    {
        ...
        requestedStartDateTimeRange = new HL7V271Field
        {
...
...|^199312231600~199312270000&D^199312300000&D~199401030800^|...",
        ...
        if (requestedStartDateTimeRange.field.FieldRepetitions != null && requestedStartDateTimeRange.field.FieldRepetitions.Count > 0)
        {
            ...
            requestedStartDateTimeRange.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(requestedStartDateTimeRange, fieldData);
        }
...
internal HL7V271Field priorityarq;

public HL7V271Field Priorityarq
{
    get
    {
        if (priorityarq != null)
        ...
        if (priorityarq.field.FieldRepetitions != null && priorityarq.field.FieldRepetitions.Count > 0)
        {
            ...
            priorityarq.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(priorityarq, fieldData);
        }
...
internal HL7V271Field repeatingInterval;

public HL7V271Field RepeatingInterval
{
    get
    {
        ...
        repeatingInterval = new HL7V271Field
        {
...
Note:  The subcomponent delimiter defined for the Interval component of the Quantity/Timing field definition has been replaced by a component delimiter for this field.",
        ...
        if (repeatingInterval.field.FieldRepetitions != null && repeatingInterval.field.FieldRepetitions.Count > 0)
        {
            ...
            repeatingInterval.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(repeatingInterval, fieldData);
        }
...
internal HL7V271Field repeatingIntervalDuration;

public HL7V271Field RepeatingIntervalDuration
{
    get
    {
        ...
        repeatingIntervalDuration = new HL7V271Field
        {
        ...
        if (repeatingIntervalDuration.field.FieldRepetitions != null && repeatingIntervalDuration.field.FieldRepetitions.Count > 0)
        {
            ...
            repeatingIntervalDuration.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(repeatingIntervalDuration, fieldData);
        }
...
internal HL7V271Field placerContactPerson;

public HL7V271Field PlacerContactPerson
{
    get
    {
        ...
        placerContactPerson = new HL7V271Field
        {
        ...
        if (placerContactPerson.field.FieldRepetitions != null && placerContactPerson.field.FieldRepetitions.Count > 0)
        {
            ...
            placerContactPerson.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(placerContactPerson, fieldData);
        }
...
internal HL7V271Field placerContactPhoneNumber;

public HL7V271Field PlacerContactPhoneNumber
{
    get
    {
        ...
        placerContactPhoneNumber = new HL7V271Field
        {
        ...
        if (placerContactPhoneNumber.field.FieldRepetitions != null && placerContactPhoneNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            placerContactPhoneNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(placerContactPhoneNumber, fieldData);
        }
...
internal HL7V271Field placerContactAddress;

public HL7V271Field PlacerContactAddress
{
    get
    {
        ...
        placerContactAddress = new HL7V271Field
        {
        ...
        if (placerContactAddress.field.FieldRepetitions != null && placerContactAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            placerContactAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(placerContactAddress, fieldData);
        }
...
internal HL7V271Field placerContactLocation;

public HL7V271Field PlacerContactLocation
{
    get
    {
        ...
        placerContactLocation = new HL7V271Field
        {
        ...
        if (placerContactLocation.field.FieldRepetitions != null && placerContactLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            placerContactLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(placerContactLocation, fieldData);
        }
...
internal HL7V271Field enteredByPerson;

public HL7V271Field EnteredByPerson
{
    get
    {
        ...
        enteredByPerson = new HL7V271Field
        {
        ...
        if (enteredByPerson.field.FieldRepetitions != null && enteredByPerson.field.FieldRepetitions.Count > 0)
        {
            ...
            enteredByPerson.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(enteredByPerson, fieldData);
        }
...
internal HL7V271Field enteredByPhoneNumber;

public HL7V271Field EnteredByPhoneNumber
{
    get
    {
        ...
        enteredByPhoneNumber = new HL7V271Field
        {
        ...
        if (enteredByPhoneNumber.field.FieldRepetitions != null && enteredByPhoneNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            enteredByPhoneNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(enteredByPhoneNumber, fieldData);
        }
...
internal HL7V271Field enteredByLocation;

public HL7V271Field EnteredByLocation
{
    get
    {
        ...
        enteredByLocation = new HL7V271Field
        {
        ...
        if (enteredByLocation.field.FieldRepetitions != null && enteredByLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            enteredByLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(enteredByLocation, fieldData);
        }
...
internal HL7V271Field parentPlacerAppointmentId;

public HL7V271Field ParentPlacerAppointmentId
{
    get
    {
        ...
        parentPlacerAppointmentId = new HL7V271Field
        {
...
The first component is a string that identifies the parent appointment request.  It is assigned by the placer application, and identifies an appointment request uniquely among all such requests from a particular requesting application.",
        ...
        if (parentPlacerAppointmentId.field.FieldRepetitions != null && parentPlacerAppointmentId.field.FieldRepetitions.Count > 0)
        {
            ...
            parentPlacerAppointmentId.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(parentPlacerAppointmentId, fieldData);
        }
...
internal HL7V271Field parentFillerAppointmentId;

public HL7V271Field ParentFillerAppointmentId
{
    get
    {
        ...
        parentFillerAppointmentId = new HL7V271Field
        {
...
The first component is a string that identifies the parent appointment request.  It is assigned by the filler application, and identifies an appointment request uniquely among all such requests on a particular processing application.",
        ...
        if (parentFillerAppointmentId.field.FieldRepetitions != null && parentFillerAppointmentId.field.FieldRepetitions.Count > 0)
        {
            ...
            parentFillerAppointmentId.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(parentFillerAppointmentId, fieldData);
        }
...
internal HL7V271Field placerOrderNumber;

public HL7V271Field PlacerOrderNumber
{
    get
    {
        ...
        placerOrderNumber = new HL7V271Field
        {
...
This field is described in detail in Chapter 4, section 4.5.1.2, ""ORC-2 – Placer Order Number.""  It is an optional field, but if a Placer order number is present, then a Filler order number (ARQ-25 – Filler Order Number) must also be present. ",
        ...
        if (placerOrderNumber.field.FieldRepetitions != null && placerOrderNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            placerOrderNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(placerOrderNumber, fieldData);
        }
...
internal HL7V271Field fillerOrderNumber;

public HL7V271Field FillerOrderNumber
{
    get
    {
        ...
        fillerOrderNumber = new HL7V271Field
        {
...
This field is described in detail in Chapter 4, section 4.5.1.3, ""ORC-3 – Filler Order Number.”  It is conditionally mandatory depending on the presence of the Placer order number (ARQ-24 – Placer Order Number).  This conditionally mandatory requirement addresses the concern that a Scheduling system cannot and should not create or fill an order.  Therefore, an order must have been accepted by the filler application before scheduling the resources associated with that order.",
        ...
        if (fillerOrderNumber.field.FieldRepetitions != null && fillerOrderNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            fillerOrderNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(fillerOrderNumber, fieldData);
        }
