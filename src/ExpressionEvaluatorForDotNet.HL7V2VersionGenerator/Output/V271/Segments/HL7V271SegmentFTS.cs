...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V271SegmentFTS
    {
        ...
        internal HL7V271Field fileBatchCount;
...
public HL7V271Field FileBatchCount
{
    get
    {
        ...
        fileBatchCount = new HL7V271Field
        {
            field = message[@"FTS"][1],
            Id = @"FTS.1",
            Type = @"Field",
        ...
        if (fileBatchCount.field.FieldRepetitions != null && fileBatchCount.field.FieldRepetitions.Count > 0)
        {
            ...
            fileBatchCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(fileBatchCount, fieldData);
        }
...
internal HL7V271Field fileTrailerComment;
...
public HL7V271Field FileTrailerComment
{
    get
    {
        ...
        fileTrailerComment = new HL7V271Field
        {
            field = message[@"FTS"][2],
            Id = @"FTS.2",
            Type = @"Field",
        ...
        if (fileTrailerComment.field.FieldRepetitions != null && fileTrailerComment.field.FieldRepetitions.Count > 0)
        {
            ...
            fileTrailerComment.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(fileTrailerComment, fieldData);
        }
