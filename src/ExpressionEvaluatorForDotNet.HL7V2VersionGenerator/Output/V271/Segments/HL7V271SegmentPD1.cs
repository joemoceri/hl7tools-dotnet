...
internal HL7V271Field patientPrimaryCareProviderName&IdNo.;

public HL7V271Field PatientPrimaryCareProviderName&IdNo.
{
    get
    {
        ...
        patientPrimaryCareProviderName&IdNo. = new HL7V271Field
        {
            field = message[@"PD1"][4],
            Id = @"PD1.4",
            Type = @"Field",
