...
Fields 2-3, 6-7: entirely site-defined."; } }
        ...
        public HL7V271SegmentNSC(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V271Field _applicationChangeType;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _applicationChangeType = new HL7V271Field
        {
            field = message[@"NSC"][1],
            fieldData = fieldData
        };
        ...
        {
            _applicationChangeType.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_applicationChangeType, fieldData);
        }
...
internal HL7V271Field _currentCpu;

public HL7V271Field CurrentCpu
{
    get
    {
        if (_currentCpu != null)
        ...
        {
            _currentCpu.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_currentCpu, fieldData);
        }
...
internal HL7V271Field _currentFileserver;

public HL7V271Field CurrentFileserver
{
    get
    {
        ...
        _currentFileserver = new HL7V271Field
        {
            field = message[@"NSC"][3],
            fieldData = fieldData
        };
        ...
        {
            _currentFileserver.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_currentFileserver, fieldData);
        }
...
internal HL7V271Field _currentApplication;

public HL7V271Field CurrentApplication
{
    get
    {
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _currentApplication = new HL7V271Field
        {
            field = message[@"NSC"][4],
            fieldData = fieldData
        };
        ...
        {
            _currentApplication.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_currentApplication, fieldData);
        }
...
internal HL7V271Field _currentFacility;

public HL7V271Field CurrentFacility
{
    get
    {
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _currentFacility = new HL7V271Field
        {
            field = message[@"NSC"][5],
            fieldData = fieldData
        };
        ...
        {
            _currentFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_currentFacility, fieldData);
        }
...
internal HL7V271Field _newCpu;

public HL7V271Field NewCpu
{
    get
    {
        if (_newCpu != null)
        ...
        {
            _newCpu.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_newCpu, fieldData);
        }
...
internal HL7V271Field _newFileserver;

public HL7V271Field NewFileserver
{
    get
    {
        ...
        _newFileserver = new HL7V271Field
        {
            field = message[@"NSC"][7],
            fieldData = fieldData
        };
        ...
        {
            _newFileserver.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_newFileserver, fieldData);
        }
...
internal HL7V271Field _newApplication;

public HL7V271Field NewApplication
{
    get
    {
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _newApplication = new HL7V271Field
        {
            field = message[@"NSC"][8],
            fieldData = fieldData
        };
        ...
        {
            _newApplication.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_newApplication, fieldData);
        }
...
internal HL7V271Field _newFacility;

public HL7V271Field NewFacility
{
    get
    {
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        {
            _newFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_newFacility, fieldData);
        }
