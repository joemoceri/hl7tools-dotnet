...
public HL7V271Field ApplicationChangeType
{
    get
    {
        ...
        applicationChangeType = new HL7V271Field
        {
            field = message[@"NSC"][1],
            Id = @"NSC.1",
            Type = @"Field",
        ...
        if (applicationChangeType.field.FieldRepetitions != null && applicationChangeType.field.FieldRepetitions.Count > 0)
        {
            ...
            applicationChangeType.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(applicationChangeType, fieldData);
        }
...
internal HL7V271Field currentCpu;
...
public HL7V271Field CurrentCpu
{
    get
    {
        ...
        if (currentCpu.field.FieldRepetitions != null && currentCpu.field.FieldRepetitions.Count > 0)
        {
            ...
            currentCpu.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(currentCpu, fieldData);
        }
...
internal HL7V271Field currentFileserver;
...
public HL7V271Field CurrentFileserver
{
    get
    {
        ...
        currentFileserver = new HL7V271Field
        {
            field = message[@"NSC"][3],
            Id = @"NSC.3",
            Type = @"Field",
        ...
        if (currentFileserver.field.FieldRepetitions != null && currentFileserver.field.FieldRepetitions.Count > 0)
        {
            ...
            currentFileserver.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(currentFileserver, fieldData);
        }
...
internal HL7V271Field currentApplication;
...
public HL7V271Field CurrentApplication
{
    get
    {
        ...
        currentApplication = new HL7V271Field
        {
            field = message[@"NSC"][4],
            Id = @"NSC.4",
            Type = @"Field",
...
Note: By site agreement, implementors may continue to use User-defined Table 0300 – Namespace ID for the first component.",
        ...
        if (currentApplication.field.FieldRepetitions != null && currentApplication.field.FieldRepetitions.Count > 0)
        {
            ...
            currentApplication.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(currentApplication, fieldData);
        }
...
internal HL7V271Field currentFacility;
...
public HL7V271Field CurrentFacility
{
    get
    {
        ...
        currentFacility = new HL7V271Field
        {
            field = message[@"NSC"][5],
            Id = @"NSC.5",
            Type = @"Field",
...
Note: By site agreement, implementors may continue to use User-defined Table 0300 – Namespace ID for the first component.",
        ...
        if (currentFacility.field.FieldRepetitions != null && currentFacility.field.FieldRepetitions.Count > 0)
        {
            ...
            currentFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(currentFacility, fieldData);
        }
...
public HL7V271Field NewCpu
{
    get
    {
        ...
        if (newCpu.field.FieldRepetitions != null && newCpu.field.FieldRepetitions.Count > 0)
        {
            ...
            newCpu.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(newCpu, fieldData);
        }
...
internal HL7V271Field newFileserver;
...
public HL7V271Field NewFileserver
{
    get
    {
        ...
        newFileserver = new HL7V271Field
        {
            field = message[@"NSC"][7],
            Id = @"NSC.7",
            Type = @"Field",
        ...
        if (newFileserver.field.FieldRepetitions != null && newFileserver.field.FieldRepetitions.Count > 0)
        {
            ...
            newFileserver.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(newFileserver, fieldData);
        }
...
internal HL7V271Field newApplication;
...
public HL7V271Field NewApplication
{
    get
    {
        ...
        newApplication = new HL7V271Field
        {
            field = message[@"NSC"][8],
            Id = @"NSC.8",
            Type = @"Field",
...
Note: By site agreement, implementors may continue to use User-defined Table 0300 – Namespace ID for the first component.",
        ...
        if (newApplication.field.FieldRepetitions != null && newApplication.field.FieldRepetitions.Count > 0)
        {
            ...
            newApplication.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(newApplication, fieldData);
        }
...
internal HL7V271Field newFacility;
...
Note: By site agreement, implementors may continue to use User-defined Table 0300 – Namespace ID for the first component.",
        ...
        if (newFacility.field.FieldRepetitions != null && newFacility.field.FieldRepetitions.Count > 0)
        {
            ...
            newFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(newFacility, fieldData);
        }
