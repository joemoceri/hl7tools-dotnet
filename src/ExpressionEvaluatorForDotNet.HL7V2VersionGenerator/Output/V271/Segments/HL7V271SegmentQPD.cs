...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V271SegmentQPD
    {
        ...
        public HL7V271SegmentQPD(HL7V2Message message)
        {
...
internal HL7V271Field _userParametersinSuccessiveFields;

public HL7V271Field UserParametersinSuccessiveFields
{
    get
    {
...
Parameter fields in the QPD segment appear in the same order as in the Query Profile.",
        ...
        _userParametersinSuccessiveFields = new HL7V271Field
        {
            field = message[@"QPD"][3],
            fieldData = fieldData
        };
        ...
        {
            _userParametersinSuccessiveFields.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_userParametersinSuccessiveFields, fieldData);
        }
