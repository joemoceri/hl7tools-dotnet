...
internal HL7V271Field userParametersinSuccessiveFields;
...
public HL7V271Field UserParametersinSuccessiveFields
{
    get
    {
        ...
        userParametersinSuccessiveFields = new HL7V271Field
        {
            field = message[@"QPD"][3],
            Id = @"QPD.3",
            Type = @"Field",
...
Parameter fields in the QPD segment appear in the same order as in the Query Profile.",
        ...
        if (userParametersinSuccessiveFields.field.FieldRepetitions != null && userParametersinSuccessiveFields.field.FieldRepetitions.Count > 0)
        {
            ...
            userParametersinSuccessiveFields.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(userParametersinSuccessiveFields, fieldData);
        }
