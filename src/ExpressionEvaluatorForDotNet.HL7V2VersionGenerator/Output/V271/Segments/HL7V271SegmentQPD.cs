...
internal HL7V271Field userParameters(inSuccessiveFields);

public HL7V271Field UserParameters(inSuccessiveFields)
{
    get
    {
        ...
        userParameters(inSuccessiveFields) = new HL7V271Field
        {
            field = message[@"QPD"][3],
            Id = @"QPD.3",
            Type = @"Field",
