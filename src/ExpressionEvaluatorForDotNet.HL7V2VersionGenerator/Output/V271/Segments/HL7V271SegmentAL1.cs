...
{
    public class HL7V271SegmentAL1
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        public HL7V271SegmentAL1(HL7V2Message message)
        {
            this.message = message;
        }

        
internal HL7V271Field setIdAl1;

public HL7V271Field SetIdAl1
{
    get
    {
        if (setIdAl1 != null)
        ...
        if (setIdAl1.field.FieldRepetitions != null && setIdAl1.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < setIdAl1.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V271FieldRepetition
                {
                    fieldRepetition = setIdAl1.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    for (var j = 0; j < setIdAl1.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V271Component
                        {
                            component = setIdAl1.field.FieldRepetitions[i].Components[j],
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < setIdAl1.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V271SubComponent
                                {
                                    subComponent = setIdAl1.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = componentFieldData.Id,
                                    Type = componentFieldData.Type,
                                    Position = componentFieldData.Position,
                                    Name = componentFieldData.Name,
            ...
            setIdAl1.fieldRepetitions = fieldRepetitions;
        }
...
internal HL7V271Field allergenTypeCode;

public HL7V271Field AllergenTypeCode
{
    get
    {
        ...
        allergenTypeCode = new HL7V271Field
        {
            field = message[@"AL1"][2],
            Id = @"AL1.2",
            Type = @"Field",
...
internal HL7V271Field allergenCodeMnemonicDescription;

public HL7V271Field AllergenCodeMnemonicDescription
{
    get
    {
        ...
        allergenCodeMnemonicDescription = new HL7V271Field
        {
            field = message[@"AL1"][3],
            Id = @"AL1.3",
            Type = @"Field",
...
internal HL7V271Field identificationDate;

public HL7V271Field IdentificationDate
{
    get
    {
        ...
        identificationDate = new HL7V271Field
        {
            field = message[@"AL1"][6],
            Id = @"AL1.6",
            Type = @"Field",
