...
public HL7V271Field GoalId
{
    get
    {
        ...
        if (goalId.field.FieldRepetitions != null && goalId.field.FieldRepetitions.Count > 0)
        {
            ...
            goalId.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(goalId, fieldData);
        }
...
Note:  It is required that the value in this field be unique over time.  This instance ID identifies a specific instance for a specific patient and is unique across all patients.  See entity ID data type description in Chapter 2.",
        ...
        if (goalInstanceId.field.FieldRepetitions != null && goalInstanceId.field.FieldRepetitions.Count > 0)
        {
            ...
            goalInstanceId.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(goalInstanceId, fieldData);
        }
...
public HL7V271Field GoalListPriority
{
    get
    {
        ...
        if (goalListPriority.field.FieldRepetitions != null && goalListPriority.field.FieldRepetitions.Count > 0)
        {
            ...
            goalListPriority.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(goalListPriority, fieldData);
        }
...
public HL7V271Field GoalEstablishedDateTime
{
    get
    {
        ...
        if (goalEstablishedDateTime.field.FieldRepetitions != null && goalEstablishedDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            goalEstablishedDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(goalEstablishedDateTime, fieldData);
        }
...
public HL7V271Field ExpectedGoalAchieveDateTime
{
    get
    {
        ...
        if (expectedGoalAchieveDateTime.field.FieldRepetitions != null && expectedGoalAchieveDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            expectedGoalAchieveDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(expectedGoalAchieveDateTime, fieldData);
        }
...
Note:  This field can be used to differentiate separate goal lists that may be managed independently within applications.",
        ...
        if (goalClassification.field.FieldRepetitions != null && goalClassification.field.FieldRepetitions.Count > 0)
        {
            ...
            goalClassification.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(goalClassification, fieldData);
        }
...
public HL7V271Field GoalManagementDiscipline
{
    get
    {
        ...
        if (goalManagementDiscipline.field.FieldRepetitions != null && goalManagementDiscipline.field.FieldRepetitions.Count > 0)
        {
            ...
            goalManagementDiscipline.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(goalManagementDiscipline, fieldData);
        }
...
public HL7V271Field CurrentGoalReviewStatus
{
    get
    {
        ...
        if (currentGoalReviewStatus.field.FieldRepetitions != null && currentGoalReviewStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            currentGoalReviewStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(currentGoalReviewStatus, fieldData);
        }
...
public HL7V271Field CurrentGoalReviewDateTime
{
    get
    {
        ...
        if (currentGoalReviewDateTime.field.FieldRepetitions != null && currentGoalReviewDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            currentGoalReviewDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(currentGoalReviewDateTime, fieldData);
        }
...
public HL7V271Field NextGoalReviewDateTime
{
    get
    {
        ...
        if (nextGoalReviewDateTime.field.FieldRepetitions != null && nextGoalReviewDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            nextGoalReviewDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(nextGoalReviewDateTime, fieldData);
        }
...
public HL7V271Field PreviousGoalReviewDateTime
{
    get
    {
        ...
        if (previousGoalReviewDateTime.field.FieldRepetitions != null && previousGoalReviewDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            previousGoalReviewDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(previousGoalReviewDateTime, fieldData);
        }
...
public HL7V271Field GoalReviewInterval
{
    get
    {
        ...
        if (goalReviewInterval.field.FieldRepetitions != null && goalReviewInterval.field.FieldRepetitions.Count > 0)
        {
            ...
            goalReviewInterval.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(goalReviewInterval, fieldData);
        }
...
public HL7V271Field GoalEvaluation
{
    get
    {
        ...
        if (goalEvaluation.field.FieldRepetitions != null && goalEvaluation.field.FieldRepetitions.Count > 0)
        {
            ...
            goalEvaluation.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(goalEvaluation, fieldData);
        }
...
public HL7V271Field GoalEvaluationComment
{
    get
    {
        ...
        if (goalEvaluationComment.field.FieldRepetitions != null && goalEvaluationComment.field.FieldRepetitions.Count > 0)
        {
            ...
            goalEvaluationComment.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(goalEvaluationComment, fieldData);
        }
...
public HL7V271Field GoalLifeCycleStatus
{
    get
    {
        ...
        if (goalLifeCycleStatus.field.FieldRepetitions != null && goalLifeCycleStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            goalLifeCycleStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(goalLifeCycleStatus, fieldData);
        }
...
public HL7V271Field GoalLifeCycleStatusDateTime
{
    get
    {
        ...
        if (goalLifeCycleStatusDateTime.field.FieldRepetitions != null && goalLifeCycleStatusDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            goalLifeCycleStatusDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(goalLifeCycleStatusDateTime, fieldData);
        }
...
Note:  This field is focused on a specific person/group that is directly patient-related.",
        ...
        if (goalTargetType.field.FieldRepetitions != null && goalTargetType.field.FieldRepetitions.Count > 0)
        {
            ...
            goalTargetType.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(goalTargetType, fieldData);
        }
...
public HL7V271Field GoalTargetName
{
    get
    {
        ...
        if (goalTargetName.field.FieldRepetitions != null && goalTargetName.field.FieldRepetitions.Count > 0)
        {
            ...
            goalTargetName.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(goalTargetName, fieldData);
        }
