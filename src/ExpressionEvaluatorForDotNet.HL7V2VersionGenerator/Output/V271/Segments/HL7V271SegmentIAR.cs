...
{
    public class HL7V271SegmentIAR
    {
        public readonly HL7V2Message message;

        public string Id { get { return @"IAR"; } }

        public string SegmentId { get { return @"IAR"; } }
        
        public string LongName { get { return @"Allergy Reaction"; } }
        
        public string Description { get { return @"The IAR segment is used to transmit a single reaction and information associated with this single reaction occurrence for a particular patient allergy (IAM – patient adverse reaction)."; } }
...
Value set version ID is required if CWE.21 is populated.",
                        ...
                        new HL7V2FieldData
                        {
                            ...
                            TableId = null,
                            TableName = null,
                            Description = @"This field contains a textual description of the actions that were performed in response to the reaction.",
                            Sample = @"",
                            FieldDatas = null
                        },
                        };
        ...
        public HL7V271SegmentIAR(HL7V2Message message)
        {
            this.message = message;
        }

        
internal HL7V271Field allergyReactionCode;

public HL7V271Field AllergyReactionCode
{
    get
    {
        ...
        allergyReactionCode = new HL7V271Field
        {
            field = message[@"IAR"][1],
            Id = @"IAR.1",
            Type = @"Field",
...
internal HL7V271Field allergySeverityCode;

public HL7V271Field AllergySeverityCode
{
    get
    {
        ...
        allergySeverityCode = new HL7V271Field
        {
            field = message[@"IAR"][2],
            Id = @"IAR.2",
            Type = @"Field",
...
internal HL7V271Field sensitivityToCausativeAgentCode;

public HL7V271Field SensitivityToCausativeAgentCode
{
    get
    {
        ...
        sensitivityToCausativeAgentCode = new HL7V271Field
        {
            field = message[@"IAR"][3],
            Id = @"IAR.3",
            Type = @"Field",
...
internal HL7V271Field management;

public HL7V271Field Management
{
    get
    {
        if (management != null)
        ...
        // check for repetitions
        if (management.field.FieldRepetitions != null && management.field.FieldRepetitions.Count > 0)
        {
            // get this fields data
            var fieldData = Fields.First(fd => fd.Id.Equals(management.Id));
            var fieldRepetitions = new List<HL7V271FieldRepetition>();

            for (var i = 0; i < management.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V271FieldRepetition
                {
                    fieldRepetition = management.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < management.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V271Component
                        {
                            component = management.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < management.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V271SubComponent
                                {
                                    subComponent = management.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = subComponentFieldData.Id,
                                    Type = subComponentFieldData.Type,
                                    Position = subComponentFieldData.Position,
                                    Name = subComponentFieldData.Name,
            ...
            management.fieldRepetitions = fieldRepetitions;
        }
