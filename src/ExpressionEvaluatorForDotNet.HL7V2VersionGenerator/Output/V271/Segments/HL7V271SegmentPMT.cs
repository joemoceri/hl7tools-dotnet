...
public HL7V271Field PaymentRemittanceAdviceNumber
{
    get
    {
        ...
        if (paymentRemittanceAdviceNumber.field.FieldRepetitions != null && paymentRemittanceAdviceNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            paymentRemittanceAdviceNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(paymentRemittanceAdviceNumber, fieldData);
        }
...
public HL7V271Field PaymentRemittanceEffectiveDateTime
{
    get
    {
        ...
        if (paymentRemittanceEffectiveDateTime.field.FieldRepetitions != null && paymentRemittanceEffectiveDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            paymentRemittanceEffectiveDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(paymentRemittanceEffectiveDateTime, fieldData);
        }
...
public HL7V271Field PaymentRemittanceExpirationDateTime
{
    get
    {
        ...
        if (paymentRemittanceExpirationDateTime.field.FieldRepetitions != null && paymentRemittanceExpirationDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            paymentRemittanceExpirationDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(paymentRemittanceExpirationDateTime, fieldData);
        }
...
public HL7V271Field PaymentMethod
{
    get
    {
        ...
        if (paymentMethod.field.FieldRepetitions != null && paymentMethod.field.FieldRepetitions.Count > 0)
        {
            ...
            paymentMethod.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(paymentMethod, fieldData);
        }
...
public HL7V271Field PaymentRemittanceDateTime
{
    get
    {
        ...
        if (paymentRemittanceDateTime.field.FieldRepetitions != null && paymentRemittanceDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            paymentRemittanceDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(paymentRemittanceDateTime, fieldData);
        }
...
public HL7V271Field PaymentRemittanceAmount
{
    get
    {
        ...
        if (paymentRemittanceAmount.field.FieldRepetitions != null && paymentRemittanceAmount.field.FieldRepetitions.Count > 0)
        {
            ...
            paymentRemittanceAmount.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(paymentRemittanceAmount, fieldData);
        }
...
public HL7V271Field CheckNumber
{
    get
    {
        ...
        if (checkNumber.field.FieldRepetitions != null && checkNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            checkNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(checkNumber, fieldData);
        }
...
public HL7V271Field PayeeBankIdentification
{
    get
    {
        ...
        if (payeeBankIdentification.field.FieldRepetitions != null && payeeBankIdentification.field.FieldRepetitions.Count > 0)
        {
            ...
            payeeBankIdentification.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(payeeBankIdentification, fieldData);
        }
...
public HL7V271Field PayeeTransitNumber
{
    get
    {
        ...
        if (payeeTransitNumber.field.FieldRepetitions != null && payeeTransitNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            payeeTransitNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(payeeTransitNumber, fieldData);
        }
...
public HL7V271Field PayeeBankAccountId
{
    get
    {
        ...
        if (payeeBankAccountId.field.FieldRepetitions != null && payeeBankAccountId.field.FieldRepetitions.Count > 0)
        {
            ...
            payeeBankAccountId.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(payeeBankAccountId, fieldData);
        }
...
public HL7V271Field PaymentOrganization
{
    get
    {
        ...
        if (paymentOrganization.field.FieldRepetitions != null && paymentOrganization.field.FieldRepetitions.Count > 0)
        {
            ...
            paymentOrganization.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(paymentOrganization, fieldData);
        }
...
public HL7V271Field Esrcodeline
{
    get
    {
        ...
        if (esrcodeline.field.FieldRepetitions != null && esrcodeline.field.FieldRepetitions.Count > 0)
        {
            ...
            esrcodeline.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(esrcodeline, fieldData);
        }
