...
public HL7V271Field PrimaryKeyValueLch
{
    get
    {
        ...
        if (primaryKeyValueLch.field.FieldRepetitions != null && primaryKeyValueLch.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValueLch.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(primaryKeyValueLch, fieldData);
        }
...
public HL7V271Field LocationCharacteristicId
{
    get
    {
        ...
        if (locationCharacteristicId.field.FieldRepetitions != null && locationCharacteristicId.field.FieldRepetitions.Count > 0)
        {
            ...
            locationCharacteristicId.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(locationCharacteristicId, fieldData);
        }
...
N - this location is not licensed",
        ...
        if (locationCharacteristicValueLch.field.FieldRepetitions != null && locationCharacteristicValueLch.field.FieldRepetitions.Count > 0)
        {
            ...
            locationCharacteristicValueLch.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(locationCharacteristicValueLch, fieldData);
        }
