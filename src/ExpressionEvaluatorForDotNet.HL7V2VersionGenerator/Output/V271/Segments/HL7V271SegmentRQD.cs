...
{
    public class HL7V271SegmentRQD
    {
        ...
        public HL7V271SegmentRQD(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V271Field _requisitionLineNumber;

public HL7V271Field RequisitionLineNumber
{
    get
    {
        ...
        _requisitionLineNumber = new HL7V271Field
        {
            field = message[@"RQD"][1],
            fieldData = fieldData
        };
        ...
        {
            _requisitionLineNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_requisitionLineNumber, fieldData);
        }
...
internal HL7V271Field _itemCodeInternal;

public HL7V271Field ItemCodeInternal
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _itemCodeInternal = new HL7V271Field
        {
            field = message[@"RQD"][2],
            fieldData = fieldData
        };
        ...
        {
            _itemCodeInternal.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_itemCodeInternal, fieldData);
        }
...
internal HL7V271Field _itemCodeExternal;

public HL7V271Field ItemCodeExternal
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _itemCodeExternal = new HL7V271Field
        {
            field = message[@"RQD"][3],
            fieldData = fieldData
        };
        ...
        {
            _itemCodeExternal.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_itemCodeExternal, fieldData);
        }
...
internal HL7V271Field _hospitalItemCode;

public HL7V271Field HospitalItemCode
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _hospitalItemCode = new HL7V271Field
        {
            field = message[@"RQD"][4],
            fieldData = fieldData
        };
        ...
        {
            _hospitalItemCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_hospitalItemCode, fieldData);
        }
...
internal HL7V271Field _requisitionQuantity;

public HL7V271Field RequisitionQuantity
{
    get
    {
        ...
        _requisitionQuantity = new HL7V271Field
        {
            field = message[@"RQD"][5],
            fieldData = fieldData
        };
        ...
        {
            _requisitionQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_requisitionQuantity, fieldData);
        }
...
internal HL7V271Field _requisitionUnitOfMeasure;

public HL7V271Field RequisitionUnitOfMeasure
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _requisitionUnitOfMeasure = new HL7V271Field
        {
            field = message[@"RQD"][6],
            fieldData = fieldData
        };
        ...
        {
            _requisitionUnitOfMeasure.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_requisitionUnitOfMeasure, fieldData);
        }
...
internal HL7V271Field _costCenterAccountNumber;

public HL7V271Field CostCenterAccountNumber
{
    get
    {
...
Refer to HL7 Table 0904 - Security Check Scheme for valid values.",
        ...
        _costCenterAccountNumber = new HL7V271Field
        {
            field = message[@"RQD"][7],
            fieldData = fieldData
        };
        ...
        {
            _costCenterAccountNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_costCenterAccountNumber, fieldData);
        }
...
internal HL7V271Field _deliverToId;

public HL7V271Field DeliverToId
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _deliverToId.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_deliverToId, fieldData);
        }
...
internal HL7V271Field _dateNeeded;

public HL7V271Field DateNeeded
{
    get
    {
        if (_dateNeeded != null)
...
Hospital accounting applications use RQD-7-Dept. Cost Center concatenated with RQD-8-Item Natural Account Code in order to post this transaction to the General Ledger. This concatenated value should correspond to a valid entry in the accounting applications ""Chart of Accounts.""",
        ...
        {
            _dateNeeded.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_dateNeeded, fieldData);
        }
