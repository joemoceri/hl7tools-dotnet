...
Hospital accounting applications use RQD-7-Dept. Cost Center concatenated with RQD-8-Item Natural Account Code in order to post this transaction to the General Ledger. This concatenated value should correspond to a valid entry in the accounting applications ""Chart of Accounts.""",
        ...
        internal HL7V271Field requisitionLineNumber;
...
public HL7V271Field RequisitionLineNumber
{
    get
    {
        ...
        requisitionLineNumber = new HL7V271Field
        {
            field = message[@"RQD"][1],
            Id = @"RQD.1",
            Type = @"Field",
        ...
        if (requisitionLineNumber.field.FieldRepetitions != null && requisitionLineNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            requisitionLineNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(requisitionLineNumber, fieldData);
        }
...
internal HL7V271Field itemCodeInternal;
...
public HL7V271Field ItemCodeInternal
{
    get
    {
        ...
        itemCodeInternal = new HL7V271Field
        {
            field = message[@"RQD"][2],
            Id = @"RQD.2",
            Type = @"Field",
        ...
        if (itemCodeInternal.field.FieldRepetitions != null && itemCodeInternal.field.FieldRepetitions.Count > 0)
        {
            ...
            itemCodeInternal.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(itemCodeInternal, fieldData);
        }
...
internal HL7V271Field itemCodeExternal;
...
public HL7V271Field ItemCodeExternal
{
    get
    {
        ...
        itemCodeExternal = new HL7V271Field
        {
            field = message[@"RQD"][3],
            Id = @"RQD.3",
            Type = @"Field",
        ...
        if (itemCodeExternal.field.FieldRepetitions != null && itemCodeExternal.field.FieldRepetitions.Count > 0)
        {
            ...
            itemCodeExternal.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(itemCodeExternal, fieldData);
        }
...
internal HL7V271Field hospitalItemCode;
...
public HL7V271Field HospitalItemCode
{
    get
    {
        ...
        hospitalItemCode = new HL7V271Field
        {
            field = message[@"RQD"][4],
            Id = @"RQD.4",
            Type = @"Field",
...
Note: At least one of the three fields 4.11.1.2 through 4.11.1.4 must be non-null.",
        ...
        if (hospitalItemCode.field.FieldRepetitions != null && hospitalItemCode.field.FieldRepetitions.Count > 0)
        {
            ...
            hospitalItemCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(hospitalItemCode, fieldData);
        }
...
internal HL7V271Field requisitionQuantity;
...
public HL7V271Field RequisitionQuantity
{
    get
    {
        ...
        requisitionQuantity = new HL7V271Field
        {
            field = message[@"RQD"][5],
            Id = @"RQD.5",
            Type = @"Field",
        ...
        if (requisitionQuantity.field.FieldRepetitions != null && requisitionQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            requisitionQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(requisitionQuantity, fieldData);
        }
...
internal HL7V271Field requisitionUnitOfMeasure;
...
public HL7V271Field RequisitionUnitOfMeasure
{
    get
    {
        ...
        requisitionUnitOfMeasure = new HL7V271Field
        {
            field = message[@"RQD"][6],
            Id = @"RQD.6",
            Type = @"Field",
        ...
        if (requisitionUnitOfMeasure.field.FieldRepetitions != null && requisitionUnitOfMeasure.field.FieldRepetitions.Count > 0)
        {
            ...
            requisitionUnitOfMeasure.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(requisitionUnitOfMeasure, fieldData);
        }
...
internal HL7V271Field costCenterAccountNumber;
...
public HL7V271Field CostCenterAccountNumber
{
    get
    {
        ...
        costCenterAccountNumber = new HL7V271Field
        {
            field = message[@"RQD"][7],
            Id = @"RQD.7",
            Type = @"Field",
        ...
        if (costCenterAccountNumber.field.FieldRepetitions != null && costCenterAccountNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            costCenterAccountNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(costCenterAccountNumber, fieldData);
        }
...
internal HL7V271Field deliverToId;
...
public HL7V271Field DeliverToId
{
    get
    {
        ...
        if (deliverToId.field.FieldRepetitions != null && deliverToId.field.FieldRepetitions.Count > 0)
        {
            ...
            deliverToId.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(deliverToId, fieldData);
        }
...
internal HL7V271Field dateNeeded;
...
Hospital accounting applications use RQD-7-Dept. Cost Center concatenated with RQD-8-Item Natural Account Code in order to post this transaction to the General Ledger. This concatenated value should correspond to a valid entry in the accounting applications ""Chart of Accounts.""",
        ...
        if (dateNeeded.field.FieldRepetitions != null && dateNeeded.field.FieldRepetitions.Count > 0)
        {
            ...
            dateNeeded.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(dateNeeded, fieldData);
        }
