...
{
    public class HL7V271SegmentBTS
    {
        ...
        public HL7V271SegmentBTS(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V271Field _batchMessageCount;

public HL7V271Field BatchMessageCount
{
    get
    {
        ...
        _batchMessageCount = new HL7V271Field
        {
            field = message[@"BTS"][1],
            fieldData = fieldData
        };
        ...
        {
            _batchMessageCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_batchMessageCount, fieldData);
        }
...
internal HL7V271Field _batchTotals;

public HL7V271Field BatchTotals
{
    get
    {
...
Prior to v2.5 this field may have been defined as a CM data type for backward compatibility with HL7 Versions 2.2 and 2.1 with each total being carried as a separate component. Each component in this case is an NM data type.",
        ...
        {
            _batchTotals.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_batchTotals, fieldData);
        }
