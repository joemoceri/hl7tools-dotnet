...
{
    public class HL7V271SegmentCSS
    {
        ...
        public HL7V271SegmentCSS(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V271Field _studyScheduledTimePoint;

public HL7V271Field StudyScheduledTimePoint
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _studyScheduledTimePoint = new HL7V271Field
        {
            field = message[@"CSS"][1],
            fieldData = fieldData
        };
        ...
        {
            _studyScheduledTimePoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_studyScheduledTimePoint, fieldData);
        }
...
internal HL7V271Field _studyScheduledPatientTimePoint;

public HL7V271Field StudyScheduledPatientTimePoint
{
    get
    {
        ...
        _studyScheduledPatientTimePoint = new HL7V271Field
        {
            field = message[@"CSS"][2],
            fieldData = fieldData
        };
        ...
        {
            _studyScheduledPatientTimePoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_studyScheduledPatientTimePoint, fieldData);
        }
...
internal HL7V271Field _studyQualityControlCodes;

public HL7V271Field StudyQualityControlCodes
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _studyQualityControlCodes = new HL7V271Field
        {
            field = message[@"CSS"][3],
            fieldData = fieldData
        };
        ...
        {
            _studyQualityControlCodes.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_studyQualityControlCodes, fieldData);
        }
