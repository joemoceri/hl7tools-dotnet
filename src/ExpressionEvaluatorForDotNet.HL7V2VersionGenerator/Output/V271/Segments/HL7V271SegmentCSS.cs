...
Value set version ID is required if CWE.21 is populated.",
        ...
        internal HL7V271Field studyScheduledTimePoint;
...
public HL7V271Field StudyScheduledTimePoint
{
    get
    {
        ...
        studyScheduledTimePoint = new HL7V271Field
        {
            field = message[@"CSS"][1],
            Id = @"CSS.1",
            Type = @"Field",
        ...
        if (studyScheduledTimePoint.field.FieldRepetitions != null && studyScheduledTimePoint.field.FieldRepetitions.Count > 0)
        {
            ...
            studyScheduledTimePoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(studyScheduledTimePoint, fieldData);
        }
...
internal HL7V271Field studyScheduledPatientTimePoint;
...
public HL7V271Field StudyScheduledPatientTimePoint
{
    get
    {
        ...
        studyScheduledPatientTimePoint = new HL7V271Field
        {
            field = message[@"CSS"][2],
            Id = @"CSS.2",
            Type = @"Field",
        ...
        if (studyScheduledPatientTimePoint.field.FieldRepetitions != null && studyScheduledPatientTimePoint.field.FieldRepetitions.Count > 0)
        {
            ...
            studyScheduledPatientTimePoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(studyScheduledPatientTimePoint, fieldData);
        }
...
internal HL7V271Field studyQualityControlCodes;
...
public HL7V271Field StudyQualityControlCodes
{
    get
    {
        ...
        studyQualityControlCodes = new HL7V271Field
        {
            field = message[@"CSS"][3],
            Id = @"CSS.3",
            Type = @"Field",
        ...
        if (studyQualityControlCodes.field.FieldRepetitions != null && studyQualityControlCodes.field.FieldRepetitions.Count > 0)
        {
            ...
            studyQualityControlCodes.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(studyQualityControlCodes, fieldData);
        }
