...
public HL7V271Field NumberOfDecontaminationSterilizationDevices
{
    get
    {
        ...
        if (numberOfDecontaminationSterilizationDevices.field.FieldRepetitions != null && numberOfDecontaminationSterilizationDevices.field.FieldRepetitions.Count > 0)
        {
            ...
            numberOfDecontaminationSterilizationDevices.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(numberOfDecontaminationSterilizationDevices, fieldData);
        }
...
public HL7V271Field LaborCalculationType
{
    get
    {
        ...
        if (laborCalculationType.field.FieldRepetitions != null && laborCalculationType.field.FieldRepetitions.Count > 0)
        {
            ...
            laborCalculationType.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(laborCalculationType, fieldData);
        }
...
public HL7V271Field DateFormat
{
    get
    {
        ...
        if (dateFormat.field.FieldRepetitions != null && dateFormat.field.FieldRepetitions.Count > 0)
        {
            ...
            dateFormat.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(dateFormat, fieldData);
        }
...
public HL7V271Field DeviceModelName
{
    get
    {
        ...
        if (deviceModelName.field.FieldRepetitions != null && deviceModelName.field.FieldRepetitions.Count > 0)
        {
            ...
            deviceModelName.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(deviceModelName, fieldData);
        }
...
public HL7V271Field DeviceType
{
    get
    {
        ...
        if (deviceType.field.FieldRepetitions != null && deviceType.field.FieldRepetitions.Count > 0)
        {
            ...
            deviceType.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(deviceType, fieldData);
        }
...
public HL7V271Field LotControl
{
    get
    {
        ...
        if (lotControl.field.FieldRepetitions != null && lotControl.field.FieldRepetitions.Count > 0)
        {
            ...
            lotControl.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(lotControl, fieldData);
        }
