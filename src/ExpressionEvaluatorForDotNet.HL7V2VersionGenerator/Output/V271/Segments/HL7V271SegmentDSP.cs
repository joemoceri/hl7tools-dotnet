...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V271SegmentDSP
    {
        ...
        public HL7V271SegmentDSP(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V271Field _setIdDsp;
...
public HL7V271Field SetIdDsp
{
    get
    {
        ...
        {
            _setIdDsp.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_setIdDsp, fieldData);
        }
...
internal HL7V271Field _displayLevel;

public HL7V271Field DisplayLevel
{
    get
    {
        ...
        _displayLevel = new HL7V271Field
        {
            field = message[@"DSP"][2],
            fieldData = fieldData
        };
        ...
        {
            _displayLevel.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_displayLevel, fieldData);
        }
...
internal HL7V271Field _dataLine;

public HL7V271Field DataLine
{
    get
    {
        if (_dataLine != null)
        ...
        {
            _dataLine.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_dataLine, fieldData);
        }
...
internal HL7V271Field _logicalBreakPoint;

public HL7V271Field LogicalBreakPoint
{
    get
    {
...
Often the lines of display text will fall into logical groups that differ from the physical size of a screen or printer page.  For example, a complete battery or an entire radiology report might be thought of as comprising a logical group, though it might have as few as six or as many as 120 lines.  Knowledge of the logical break points in the display data can be useful to the application system that is displaying or printing data.  For this reason, DSP-4-Logical break point is used.  The sending application (the one that formats the data) places the logical break points where appropriate.  If there is a particular ancillary result ID associated with the data delineated by DSP-4-Logical break point, the value of this ID also can be returned in DSP-5-Result ID.  Then if the user selects the area of the display delineated by DSP-4-Logical break point, the displaying system can query for the associated DSP-5-Result ID.",
        ...
        _logicalBreakPoint = new HL7V271Field
        {
            field = message[@"DSP"][4],
            fieldData = fieldData
        };
        ...
        {
            _logicalBreakPoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_logicalBreakPoint, fieldData);
        }
...
internal HL7V271Field _resultId;

public HL7V271Field ResultId
{
    get
    {
        if (_resultId != null)
        ...
        {
            _resultId.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_resultId, fieldData);
        }
