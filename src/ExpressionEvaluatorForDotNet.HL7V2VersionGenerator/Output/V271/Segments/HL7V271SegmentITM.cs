...
public HL7V271Field ItemDescription
{
    get
    {
        ...
        if (itemDescription.field.FieldRepetitions != null && itemDescription.field.FieldRepetitions.Count > 0)
        {
            ...
            itemDescription.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(itemDescription, fieldData);
        }
...
public HL7V271Field ItemType
{
    get
    {
        ...
        if (itemType.field.FieldRepetitions != null && itemType.field.FieldRepetitions.Count > 0)
        {
            ...
            itemType.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(itemType, fieldData);
        }
...
public HL7V271Field ItemCategory
{
    get
    {
        ...
        if (itemCategory.field.FieldRepetitions != null && itemCategory.field.FieldRepetitions.Count > 0)
        {
            ...
            itemCategory.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(itemCategory, fieldData);
        }
...
public HL7V271Field SubjectToExpirationIndicator
{
    get
    {
        ...
        if (subjectToExpirationIndicator.field.FieldRepetitions != null && subjectToExpirationIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            subjectToExpirationIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(subjectToExpirationIndicator, fieldData);
        }
...
public HL7V271Field ManufacturerIdentifier
{
    get
    {
        ...
        if (manufacturerIdentifier.field.FieldRepetitions != null && manufacturerIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            manufacturerIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(manufacturerIdentifier, fieldData);
        }
...
public HL7V271Field ManufacturerName
{
    get
    {
        ...
        if (manufacturerName.field.FieldRepetitions != null && manufacturerName.field.FieldRepetitions.Count > 0)
        {
            ...
            manufacturerName.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(manufacturerName, fieldData);
        }
...
public HL7V271Field ManufacturerCatalogNumber
{
    get
    {
        ...
        if (manufacturerCatalogNumber.field.FieldRepetitions != null && manufacturerCatalogNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            manufacturerCatalogNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(manufacturerCatalogNumber, fieldData);
        }
...
public HL7V271Field ManufacturerLabelerIdentificationCode
{
    get
    {
        ...
        if (manufacturerLabelerIdentificationCode.field.FieldRepetitions != null && manufacturerLabelerIdentificationCode.field.FieldRepetitions.Count > 0)
        {
            ...
            manufacturerLabelerIdentificationCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(manufacturerLabelerIdentificationCode, fieldData);
        }
...
public HL7V271Field SupplyRiskCodes
{
    get
    {
        ...
        if (supplyRiskCodes.field.FieldRepetitions != null && supplyRiskCodes.field.FieldRepetitions.Count > 0)
        {
            ...
            supplyRiskCodes.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(supplyRiskCodes, fieldData);
        }
...
Refer to User-defined Table 0790 – Approving Regulatory Agency for suggested values.  ",
        ...
        if (approvingRegulatoryAgency.field.FieldRepetitions != null && approvingRegulatoryAgency.field.FieldRepetitions.Count > 0)
        {
            ...
            approvingRegulatoryAgency.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(approvingRegulatoryAgency, fieldData);
        }
...
Refer to User-defined Table 0790 – Approving Regulatory Agency for suggested values.  ",
        ...
        if (latexIndicator.field.FieldRepetitions != null && latexIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            latexIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(latexIndicator, fieldData);
        }
...
public HL7V271Field RulingAct
{
    get
    {
        ...
        if (rulingAct.field.FieldRepetitions != null && rulingAct.field.FieldRepetitions.Count > 0)
        {
            ...
            rulingAct.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(rulingAct, fieldData);
        }
...
public HL7V271Field ItemNaturalAccountCode
{
    get
    {
        ...
        if (itemNaturalAccountCode.field.FieldRepetitions != null && itemNaturalAccountCode.field.FieldRepetitions.Count > 0)
        {
            ...
            itemNaturalAccountCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(itemNaturalAccountCode, fieldData);
        }
...
public HL7V271Field ApprovedToBuyQuantity
{
    get
    {
        ...
        if (approvedToBuyQuantity.field.FieldRepetitions != null && approvedToBuyQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            approvedToBuyQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(approvedToBuyQuantity, fieldData);
        }
...
public HL7V271Field ApprovedToBuyPrice
{
    get
    {
        ...
        if (approvedToBuyPrice.field.FieldRepetitions != null && approvedToBuyPrice.field.FieldRepetitions.Count > 0)
        {
            ...
            approvedToBuyPrice.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(approvedToBuyPrice, fieldData);
        }
...
public HL7V271Field TaxableItemIndicator
{
    get
    {
        ...
        if (taxableItemIndicator.field.FieldRepetitions != null && taxableItemIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            taxableItemIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(taxableItemIndicator, fieldData);
        }
...
public HL7V271Field FreightChargeIndicator
{
    get
    {
        ...
        if (freightChargeIndicator.field.FieldRepetitions != null && freightChargeIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            freightChargeIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(freightChargeIndicator, fieldData);
        }
...
public HL7V271Field ItemSetIndicator
{
    get
    {
        ...
        if (itemSetIndicator.field.FieldRepetitions != null && itemSetIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            itemSetIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(itemSetIndicator, fieldData);
        }
...
public HL7V271Field ItemSetIdentifier
{
    get
    {
        ...
        if (itemSetIdentifier.field.FieldRepetitions != null && itemSetIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            itemSetIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(itemSetIdentifier, fieldData);
        }
...
public HL7V271Field TrackDepartmentUsageIndicator
{
    get
    {
        ...
        if (trackDepartmentUsageIndicator.field.FieldRepetitions != null && trackDepartmentUsageIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            trackDepartmentUsageIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(trackDepartmentUsageIndicator, fieldData);
        }
...
As of v2.6, the known applicable external coding systems include those in the table below. If the code set you are using is in this table, then you must use that designation.",
        ...
        if (procedureCode.field.FieldRepetitions != null && procedureCode.field.FieldRepetitions.Count > 0)
        {
            ...
            procedureCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(procedureCode, fieldData);
        }
...
As of v2.6, the known applicable external coding systems include those in the table below. If the code set you are using is in this table, then you must use that designation.",
        ...
        if (procedureCodeModifier.field.FieldRepetitions != null && procedureCodeModifier.field.FieldRepetitions.Count > 0)
        {
            ...
            procedureCodeModifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(procedureCodeModifier, fieldData);
        }
