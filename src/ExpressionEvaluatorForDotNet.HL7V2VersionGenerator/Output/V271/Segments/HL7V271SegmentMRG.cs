...
{
    public class HL7V271SegmentMRG
    {
...
Examples:
 ...
 - Mary Margaret Elizabeth Jones is Called By Meg.",
        ...
        public HL7V271SegmentMRG(HL7V2Message message)
        {
            this.message = message;
        }

        
internal HL7V271Field priorPatientIdentifierList;

public HL7V271Field PriorPatientIdentifierList
{
    get
    {
        ...
        priorPatientIdentifierList = new HL7V271Field
        {
            field = message[@"MRG"][1],
            Id = @"MRG.1",
            Type = @"Field",
        ...
        if (priorPatientIdentifierList.field.FieldRepetitions != null && priorPatientIdentifierList.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < priorPatientIdentifierList.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V271FieldRepetition
                {
                    fieldRepetition = priorPatientIdentifierList.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    for (var j = 0; j < priorPatientIdentifierList.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V271Component
                        {
                            component = priorPatientIdentifierList.field.FieldRepetitions[i].Components[j],
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < priorPatientIdentifierList.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V271SubComponent
                                {
                                    subComponent = priorPatientIdentifierList.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = componentFieldData.Id,
                                    Type = componentFieldData.Type,
                                    Position = componentFieldData.Position,
                                    Name = componentFieldData.Name,
            ...
            priorPatientIdentifierList.fieldRepetitions = fieldRepetitions;
        }
...
internal HL7V271Field priorAlternatePatientId;

public HL7V271Field PriorAlternatePatientId
{
    get
    {
        ...
        priorAlternatePatientId = new HL7V271Field
        {
            field = message[@"MRG"][2],
            Id = @"MRG.2",
            Type = @"Field",
...
internal HL7V271Field priorPatientAccountNumber;

public HL7V271Field PriorPatientAccountNumber
{
    get
    {
        ...
        priorPatientAccountNumber = new HL7V271Field
        {
            field = message[@"MRG"][3],
            Id = @"MRG.3",
            Type = @"Field",
...
internal HL7V271Field priorPatientId;

public HL7V271Field PriorPatientId
{
    get
    {
        ...
        priorPatientId = new HL7V271Field
        {
            field = message[@"MRG"][4],
            Id = @"MRG.4",
            Type = @"Field",
        ...
        if (priorPatientId.field.FieldRepetitions != null && priorPatientId.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < priorPatientId.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V271FieldRepetition
                {
                    fieldRepetition = priorPatientId.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < priorPatientId.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V271Component
                        {
                            component = priorPatientId.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < priorPatientId.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V271SubComponent
                                {
                                    subComponent = priorPatientId.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = componentFieldData.Id,
                                    Type = componentFieldData.Type,
                                    Position = componentFieldData.Position,
                                    Name = componentFieldData.Name,
            ...
            priorPatientId.fieldRepetitions = fieldRepetitions;
        }
...
internal HL7V271Field priorVisitNumber;

public HL7V271Field PriorVisitNumber
{
    get
    {
        ...
        priorVisitNumber = new HL7V271Field
        {
            field = message[@"MRG"][5],
            Id = @"MRG.5",
            Type = @"Field",
...
internal HL7V271Field priorAlternateVisitId;

public HL7V271Field PriorAlternateVisitId
{
    get
    {
        ...
        priorAlternateVisitId = new HL7V271Field
        {
            field = message[@"MRG"][6],
            Id = @"MRG.6",
            Type = @"Field",
...
internal HL7V271Field priorPatientName;

public HL7V271Field PriorPatientName
{
    get
    {
        ...
        priorPatientName = new HL7V271Field
        {
            field = message[@"MRG"][7],
            Id = @"MRG.7",
            Type = @"Field",
