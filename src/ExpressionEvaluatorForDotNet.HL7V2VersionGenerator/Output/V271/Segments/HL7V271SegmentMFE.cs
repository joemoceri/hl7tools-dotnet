...
public HL7V271Field RecordlevelEventCode
{
    get
    {
        ...
        recordlevelEventCode = new HL7V271Field
        {
            field = message[@"MFE"][1],
            Id = @"MFE.1",
            Type = @"Field",
        ...
        if (recordlevelEventCode.field.FieldRepetitions != null && recordlevelEventCode.field.FieldRepetitions.Count > 0)
        {
            ...
            recordlevelEventCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(recordlevelEventCode, fieldData);
        }
...
internal HL7V271Field mfnControlId;
...
public HL7V271Field MfnControlId
{
    get
    {
        ...
        if (mfnControlId.field.FieldRepetitions != null && mfnControlId.field.FieldRepetitions.Count > 0)
        {
            ...
            mfnControlId.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(mfnControlId, fieldData);
        }
...
internal HL7V271Field effectiveDateTime;
...
public HL7V271Field EffectiveDateTime
{
    get
    {
        ...
        effectiveDateTime = new HL7V271Field
        {
            field = message[@"MFE"][3],
            Id = @"MFE.3",
            Type = @"Field",
        ...
        if (effectiveDateTime.field.FieldRepetitions != null && effectiveDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            effectiveDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(effectiveDateTime, fieldData);
        }
...
internal HL7V271Field primaryKeyValueMfe;
...
public HL7V271Field PrimaryKeyValueMfe
{
    get
    {
        ...
        primaryKeyValueMfe = new HL7V271Field
        {
            field = message[@"MFE"][4],
            Id = @"MFE.4",
            Type = @"Field",
        ...
        if (primaryKeyValueMfe.field.FieldRepetitions != null && primaryKeyValueMfe.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValueMfe.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(primaryKeyValueMfe, fieldData);
        }
...
internal HL7V271Field primaryKeyValueType;
...
public HL7V271Field PrimaryKeyValueType
{
    get
    {
        ...
        primaryKeyValueType = new HL7V271Field
        {
            field = message[@"MFE"][5],
            Id = @"MFE.5",
            Type = @"Field",
        ...
        if (primaryKeyValueType.field.FieldRepetitions != null && primaryKeyValueType.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValueType.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(primaryKeyValueType, fieldData);
        }
...
public HL7V271Field EnteredDateTime
{
    get
    {
        ...
        if (enteredDateTime.field.FieldRepetitions != null && enteredDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            enteredDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(enteredDateTime, fieldData);
        }
