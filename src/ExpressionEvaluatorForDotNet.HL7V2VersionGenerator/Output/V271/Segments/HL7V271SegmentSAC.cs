...
internal HL7V271Field primaryparentContainerIdentifier;

public HL7V271Field PrimaryparentContainerIdentifier
{
    get
    {
        ...
        primaryparentContainerIdentifier = new HL7V271Field
        {
            field = message[@"SAC"][4],
            Id = @"SAC.4",
            Type = @"Field",
