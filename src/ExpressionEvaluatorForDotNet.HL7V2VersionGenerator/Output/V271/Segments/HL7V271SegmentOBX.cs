...
When using the OBX for the ANO category, OBX-2 Value Type should be valued to CWE. Consequently, OBX-5 Observation Value could have a length of up the 65536 given the format of the data types. Note the expectations on which fields are required as well as the fields that should not be valued."; } }
        ...
        internal HL7V271Field _setIdObx;
...
public HL7V271Field SetIdObx
{
    get
    {
        ...
        {
            _setIdObx.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_setIdObx, fieldData);
        }
...
internal HL7V271Field _valueType;
...
CDA documents are to be exchanged in the OBX segment in any message that can exchange documents (such as MDM or ORU). Within the OBX segment, the MIME package is encoded as an encapsulated (ED) data type.",
        ...
        {
            _valueType.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_valueType, fieldData);
        }
...
internal HL7V271Field _observationIdentifier;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _observationIdentifier = new HL7V271Field
        {
            field = message[@"OBX"][3],
            fieldData = fieldData
        };
        ...
        {
            _observationIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_observationIdentifier, fieldData);
        }
...
internal HL7V271Field _observationSubid;
...
OBX|3|CWE|8601-7^EKG IMPRESSION ^LN|3|^poor R wave progression|...<cr>",
        ...
        _observationSubid = new HL7V271Field
        {
            field = message[@"OBX"][4],
            fieldData = fieldData
        };
        ...
        {
            _observationSubid.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_observationSubid, fieldData);
        }
...
internal HL7V271Field _observationValue;
...
- Set the value of OBX-5.5-Data to equal the MIME package. Every entity within the MIME package must be Base64-encoded. As stated in Chapter 2, ""the data component must be scanned before transmission for HL7 delimiter characters (and other non-printing ASCII or non-ASCII characters such as LineFeed), and any found must be escaped by using the HL7 escape sequences defined in Section 2.7 'Use of escape sequences in text fields.' On the receiving application, the data field must be de-escaped after being parsed."" As a result, CR/LF sequences required in the MIME package need to be escaped (i.e., converted to '\X0D0A\') prior to transmission. The content type of the first MIME entity is set to 'application/x-hl7-cda-level-one+xml', and should contain the CDA document itself. Multimedia objects referenced by the CDA document that need to be transmitted within the CDA document are to be placed in successive entities of the MIME package.",
        ...
        _observationValue = new HL7V271Field
        {
            field = message[@"OBX"][5],
            fieldData = fieldData
        };
        ...
        {
            _observationValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_observationValue, fieldData);
        }
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _units.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_units, fieldData);
        }
...
internal HL7V271Field _referencesRange;
...
When the observation quantifies the amount of a toxic substance, then the upper limit of the range identifies the toxic limit. If the observation quantifies a drug, the lower limits identify the lower therapeutic bounds and the upper limits represent the upper therapeutic bounds above which toxic side effects are common.",
        ...
        _referencesRange = new HL7V271Field
        {
            field = message[@"OBX"][7],
            fieldData = fieldData
        };
        ...
        {
            _referencesRange.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_referencesRange, fieldData);
        }
...
internal HL7V271Field _interpretationCodes;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _interpretationCodes = new HL7V271Field
        {
            field = message[@"OBX"][8],
            fieldData = fieldData
        };
        ...
        {
            _interpretationCodes.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_interpretationCodes, fieldData);
        }
...
internal HL7V271Field _probability;
...
public HL7V271Field Probability
{
    get
    {
        ...
        {
            _probability.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_probability, fieldData);
        }
...
internal HL7V271Field _natureOfAbnormalTest;
...
The constraints on the use of the codes in this table must be consistent with those defined in the PID segment, specifically PID-35-Species Code, PID-36-Breed Code and PID-37-Strain.",
        ...
        _natureOfAbnormalTest = new HL7V271Field
        {
        ...
        {
            _natureOfAbnormalTest.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_natureOfAbnormalTest, fieldData);
        }
...
internal HL7V271Field _observationResultStatus;
...
There are situations where the observation battery required for the order needs to be dynamically specified at the time of ordering. That is, this battery is then defined by the set of OBX segments transmitted along with the order and generated by the placing system. For example, timed measurements of serum glucose challenge tests may vary among laboratories. One institution may report them at –30, -15, 0, 30, 60, and 120 minutes, while another may report them at –30, 0, 30, 60, 90, and 120 minutes. Master file entries may exist for each individual element of the battery but not for the battery itself. Another example may be Renin Studies where the specification may be done upon ordering without having a master file definition for each permutation of the possible element. The OBX segments in the ORM message can be used to create dynamic specifications to accommodate these permutations without defining pre-existing master file definitions for the battery itself. The result status field in the OBX can be used to indicate whether the OBX in the ORM message is used to provide a dynamic specification or is used to communicate a result as context to the order. The status of O shall be used to indicate that the OBX segment is used for a dynamic specification of the required result. An OBX used for a dynamic specification must contain the detaile",
        ...
        _observationResultStatus = new HL7V271Field
        {
        ...
        {
            _observationResultStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_observationResultStatus, fieldData);
        }
...
internal HL7V271Field _effectiveDateOfReferenceRange;
...
When this field is present, it facilitates comparison between identical results with different reference ranges. Reference range values may vary because of changes in laboratory practice over time. Such variances could reflect updated practice in laboratory medicine, or the use of updated instrumentation.",
        ...
        _effectiveDateOfReferenceRange = new HL7V271Field
        {
        ...
        {
            _effectiveDateOfReferenceRange.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_effectiveDateOfReferenceRange, fieldData);
        }
...
internal HL7V271Field _userDefinedAccessChecks;
...
However, there are a few cases when such controls vary with the value of the observation in a complex way that the receiving system would not want to re-calculate. An example is an antimicrobial susceptibility result. Some systems prefer to display only the susceptibility results of inexpensive antimicrobials depending upon the organism, the source of the specimen and the patient’s allergy status. The sending service wants to send all of the susceptibilities so that certain privileged users (e.g., Infectious Disease specialists) can review all of the results but non-privileged users would see only the ""preferred"" antimicrobials to which the organism was susceptible. We expect that other cases also occur.",
        ...
        _userDefinedAccessChecks = new HL7V271Field
        {
        ...
        {
            _userDefinedAccessChecks.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_userDefinedAccessChecks, fieldData);
        }
...
internal HL7V271Field _dateTimeOfTheObservation;
...
In all cases, the observation date-time is the physiologically relevant date-time or the closest approximation to that date-time. In the case of tests performed on specimens, the relevant date-time is the specimen’s collection date-time. In the case of observations taken directly on the patient (e.g., X-ray images, history and physical), the observation date-time is the date-time that the observation was performed.",
        ...
        _dateTimeOfTheObservation = new HL7V271Field
        {
        ...
        {
            _dateTimeOfTheObservation.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_dateTimeOfTheObservation, fieldData);
        }
...
internal HL7V271Field _producersId;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _producersId.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_producersId, fieldData);
        }
...
internal HL7V271Field _responsibleObserver;
...
Refer to HL7 Table 0904 - Security Check Scheme for valid values",
        ...
        _responsibleObserver = new HL7V271Field
        {
        ...
        {
            _responsibleObserver.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_responsibleObserver, fieldData);
        }
...
internal HL7V271Field _observationMethod;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _observationMethod = new HL7V271Field
        {
        ...
        {
            _observationMethod.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_observationMethod, fieldData);
        }
...
internal HL7V271Field _dateTimeOfTheAnalysis;
...
public HL7V271Field DateTimeOfTheAnalysis
{
    get
    {
        ...
        _dateTimeOfTheAnalysis = new HL7V271Field
        {
        ...
        {
            _dateTimeOfTheAnalysis.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_dateTimeOfTheAnalysis, fieldData);
        }
...
internal HL7V271Field _observationSite;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _observationSite = new HL7V271Field
        {
        ...
        {
            _observationSite.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_observationSite, fieldData);
        }
...
internal HL7V271Field _observationInstanceIdentifier;
...
Refer to HL7 Table 0301 - Universal ID Type for valid values.",
        ...
        _observationInstanceIdentifier = new HL7V271Field
        {
        ...
        {
            _observationInstanceIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_observationInstanceIdentifier, fieldData);
        }
...
internal HL7V271Field _moodCode;
...
Value set version ID is required if CNE.21 is populated.",
        ...
        {
            _moodCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_moodCode, fieldData);
        }
...
internal HL7V271Field _performingOrganizationName;
...
Note: The check digit and code identifying check digit scheme are null if Organization identifier is alphanumeric.",
        ...
        _performingOrganizationName = new HL7V271Field
        {
        ...
        {
            _performingOrganizationName.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_performingOrganizationName, fieldData);
        }
...
internal HL7V271Field _performingOrganizationAddress;
...
Refer to HL7 Table 0301 - Universal ID Type for valid values.",
        ...
        _performingOrganizationAddress = new HL7V271Field
        {
        ...
        {
            _performingOrganizationAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_performingOrganizationAddress, fieldData);
        }
...
internal HL7V271Field _performingOrganizationMedicalDirector;
...
Refer to HL7 Table 0904 - Security Check Scheme for valid values",
        ...
        _performingOrganizationMedicalDirector = new HL7V271Field
        {
        ...
        {
            _performingOrganizationMedicalDirector.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_performingOrganizationMedicalDirector, fieldData);
        }
...
internal HL7V271Field _patientResultsReleaseCategory;
...
Valid values are provided in HL7 Table 0909 – Patient Results Release Categorization Scheme.",
        ...
        _patientResultsReleaseCategory = new HL7V271Field
        {
        ...
        {
            _patientResultsReleaseCategory.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_patientResultsReleaseCategory, fieldData);
        }
