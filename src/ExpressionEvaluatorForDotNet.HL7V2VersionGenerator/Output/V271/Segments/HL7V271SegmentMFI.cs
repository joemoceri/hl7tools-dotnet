...
{
    public class HL7V271SegmentMFI
    {
        ...
        public string Description { get { return @"The fields in the MFI segment are defined in HL7 Attribute Table - MFI."; } }
        ...
        public HL7V271SegmentMFI(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V271Field _masterFileIdentifier;

public HL7V271Field MasterFileIdentifier
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _masterFileIdentifier = new HL7V271Field
        {
            field = message[@"MFI"][1],
            fieldData = fieldData
        };
        ...
        {
            _masterFileIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_masterFileIdentifier, fieldData);
        }
...
internal HL7V271Field _masterFileApplicationIdentifier;

public HL7V271Field MasterFileApplicationIdentifier
{
    get
    {
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _masterFileApplicationIdentifier = new HL7V271Field
        {
            field = message[@"MFI"][2],
            fieldData = fieldData
        };
        ...
        {
            _masterFileApplicationIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_masterFileApplicationIdentifier, fieldData);
        }
...
internal HL7V271Field _filelevelEventCode;

public HL7V271Field FilelevelEventCode
{
    get
    {
...
Note:  If the MFI-3 - File-Level Event Code is ""REP"" (replace file), then each MFE segment must have an MFE-1 - Record-Level Event Code of ""MAD"" (add record to master file).",
        ...
        _filelevelEventCode = new HL7V271Field
        {
            field = message[@"MFI"][3],
            fieldData = fieldData
        };
        ...
        {
            _filelevelEventCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_filelevelEventCode, fieldData);
        }
...
internal HL7V271Field _responseLevelCode;

public HL7V271Field ResponseLevelCode
{
    get
    {
        ...
        _responseLevelCode = new HL7V271Field
        {
            field = message[@"MFI"][6],
            fieldData = fieldData
        };
        ...
        {
            _responseLevelCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_responseLevelCode, fieldData);
        }
