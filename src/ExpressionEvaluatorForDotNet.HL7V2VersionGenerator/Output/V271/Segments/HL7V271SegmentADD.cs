...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V271SegmentADD
    {
        ...
        internal HL7V271Field addendumContinuationPointer;
...
public HL7V271Field AddendumContinuationPointer
{
    get
    {
        ...
        addendumContinuationPointer = new HL7V271Field
        {
            field = message[@"ADD"][1],
            Id = @"ADD.1",
            Type = @"Field",
        ...
        if (addendumContinuationPointer.field.FieldRepetitions != null && addendumContinuationPointer.field.FieldRepetitions.Count > 0)
        {
            ...
            addendumContinuationPointer.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(addendumContinuationPointer, fieldData);
        }
