...
{
    public class HL7V271SegmentAIP
    {
        ...
        public HL7V271SegmentAIP(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V271Field _setIdAip;

public HL7V271Field SetIdAip
{
    get
    {
        if (_setIdAip != null)
        ...
        {
            _setIdAip.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_setIdAip, fieldData);
        }
...
public HL7V271Field SegmentActionCode
{
    get
    {
        ...
        var fieldData = new HL7V271FieldData
        {
            ...
            Description = @"This field contains the action to be taken when updating or modifying information in this segment from previously sent interface transactions.  Refer to HL7 Table 0206 - Segment Action Code in Chapter 2C, Code Tables.
...
internal HL7V271Field _personnelResourceId;

public HL7V271Field PersonnelResourceId
{
    get
    {
...
Refer to HL7 Table 0904 - Security Check Scheme for valid values",
        ...
        _personnelResourceId = new HL7V271Field
        {
            field = message[@"AIP"][3],
            fieldData = fieldData
        };
        ...
        {
            _personnelResourceId.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_personnelResourceId, fieldData);
        }
...
internal HL7V271Field _resourceType;

public HL7V271Field ResourceType
{
    get
    {
        ...
        var fieldData = new HL7V271FieldData
        {
            ...
            Description = @"This field identifies the type of the personnel requested/scheduled for an appointment.    For all messages, this field is conditionally required if a specific location is not identified in AIP-3 Personnel Resource ID.  Refer to HL7 Table 0182 - Staff Type in Chapter 15, Personnel Management.",
            Sample = @"",
            Fields = new[]
                        {
                            new HL7V2FieldData
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _resourceType = new HL7V271Field
        {
            field = message[@"AIP"][4],
            fieldData = fieldData
        };
        ...
        {
            _resourceType.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_resourceType, fieldData);
        }
...
internal HL7V271Field _resourceGroup;

public HL7V271Field ResourceGroup
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _resourceGroup = new HL7V271Field
        {
            field = message[@"AIP"][5],
            fieldData = fieldData
        };
        ...
        {
            _resourceGroup.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_resourceGroup, fieldData);
        }
...
internal HL7V271Field _startDateTime;
...
This field is conditionally required.  If a value for AIP-7 Start Date/Time Offset is not provided, then a value is required for this field.  To specify that there is no difference between the appointment's start date/time and the resource's start date/time either replicate the appointment's start date/time into this field, or specify an offset of zero (0) in AIP-7 Start Date/Time Offset and any valid time unit code in AIP-8 Start Date/Time Offset Units.",
        ...
        _startDateTime = new HL7V271Field
        {
            field = message[@"AIP"][6],
            fieldData = fieldData
        };
        ...
        {
            _startDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_startDateTime, fieldData);
        }
...
internal HL7V271Field _startDateTimeOffset;

public HL7V271Field StartDateTimeOffset
{
    get
    {
...
This field is conditionally required.  If a value for AIP-6 Start Date/Time is not provided, then a value is required for this field.  To specify that there is no difference between the appointment's start date/time and the resource's start date/time either replicate the appointment's start date/time into this field, or specify an offset of zero (0) in AIP-7 Start Date/Time Offset and any valid time unit code in AIP-8 Start Date/Time Offset Units.",
        ...
        _startDateTimeOffset = new HL7V271Field
        {
            field = message[@"AIP"][7],
            fieldData = fieldData
        };
        ...
        {
            _startDateTimeOffset.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_startDateTimeOffset, fieldData);
        }
...
internal HL7V271Field _startDateTimeOffsetUnits;

public HL7V271Field StartDateTimeOffsetUnits
{
    get
    {
...
Value set version ID is required if CNE.21 is populated.",
        ...
        _startDateTimeOffsetUnits = new HL7V271Field
        {
            field = message[@"AIP"][8],
            fieldData = fieldData
        };
        ...
        {
            _startDateTimeOffsetUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_startDateTimeOffsetUnits, fieldData);
        }
...
internal HL7V271Field _duration;

public HL7V271Field Duration
{
    get
    {
        if (_duration != null)
...
This field must be a positive, non-zero number.  A negative number or zero (0) is nonsensical in the context of a duration.",
        ...
        {
            _duration.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_duration, fieldData);
        }
...
internal HL7V271Field _durationUnits;

public HL7V271Field DurationUnits
{
    get
    {
...
Value set version ID is required if CNE.21 is populated.",
        ...
        _durationUnits = new HL7V271Field
        {
        ...
        {
            _durationUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_durationUnits, fieldData);
        }
...
internal HL7V271Field _allowSubstitutionCode;

public HL7V271Field AllowSubstitutionCode
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _allowSubstitutionCode = new HL7V271Field
        {
        ...
        {
            _allowSubstitutionCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_allowSubstitutionCode, fieldData);
        }
...
internal HL7V271Field _fillerStatusCode;

public HL7V271Field FillerStatusCode
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _fillerStatusCode = new HL7V271Field
        {
        ...
        {
            _fillerStatusCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_fillerStatusCode, fieldData);
        }
