...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V271SegmentODT
    {
        ...
        internal HL7V271Field _trayType;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _trayType.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(_trayType, fieldData);
        }
