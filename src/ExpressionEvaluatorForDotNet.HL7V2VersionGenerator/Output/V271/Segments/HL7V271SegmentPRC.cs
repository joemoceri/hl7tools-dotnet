...
Value set version ID is required if CWE.21 is populated.",
        ...
        internal HL7V271Field primaryKeyValuePrc;
...
public HL7V271Field PrimaryKeyValuePrc
{
    get
    {
        ...
        primaryKeyValuePrc = new HL7V271Field
        {
            field = message[@"PRC"][1],
            Id = @"PRC.1",
            Type = @"Field",
        ...
        if (primaryKeyValuePrc.field.FieldRepetitions != null && primaryKeyValuePrc.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValuePrc.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(primaryKeyValuePrc, fieldData);
        }
...
internal HL7V271Field facilityIdPrc;
...
public HL7V271Field FacilityIdPrc
{
    get
    {
        ...
        facilityIdPrc = new HL7V271Field
        {
            field = message[@"PRC"][2],
            Id = @"PRC.2",
            Type = @"Field",
...
When two PRC segments are sent with the same key values but different facility identifiers, the second is sent in addition to the first, not to replace the first.  The effective unique identifier is the charge code (PRC-1 - Primary Key Value - PRC) plus the facility ID (PRC-2 - Facility ID).  Multiple facility identifiers can be sent in the same segment to indicate that those facilities use the same pricing. Refer to User-defined Table 0464 - Facility ID for suggested values.",
        ...
        if (facilityIdPrc.field.FieldRepetitions != null && facilityIdPrc.field.FieldRepetitions.Count > 0)
        {
            ...
            facilityIdPrc.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(facilityIdPrc, fieldData);
        }
...
internal HL7V271Field department;
...
When two PRC segments are sent the same key values but with different departments, the second is sent in addition to the first, not to replace the first.  The effective unique identifier is the charge code (PRC-1 - Primary Key - PRC) plus the facility ID (PRC-2 - Facility ID) plus the department (PRC-3 - Department).  Multiple departments can be sent in the same segment to indicate that those departments use the same pricing. Refer to User-defined Table 0184 - Department in Chapter 15, Personnel Management, for suggested values.",
        ...
        if (department.field.FieldRepetitions != null && department.field.FieldRepetitions.Count > 0)
        {
            ...
            department.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(department, fieldData);
        }
...
public HL7V271Field Price
{
    get
    {
        ...
        if (price.field.FieldRepetitions != null && price.field.FieldRepetitions.Count > 0)
        {
            ...
            price.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(price, fieldData);
        }
...
public HL7V271Field Formula
{
    get
    {
        ...
        if (formula.field.FieldRepetitions != null && formula.field.FieldRepetitions.Count > 0)
        {
            ...
            formula.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(formula, fieldData);
        }
...
internal HL7V271Field minimumQuantity;
...
public HL7V271Field MinimumQuantity
{
    get
    {
        ...
        minimumQuantity = new HL7V271Field
        {
            field = message[@"PRC"][7],
            Id = @"PRC.7",
            Type = @"Field",
        ...
        if (minimumQuantity.field.FieldRepetitions != null && minimumQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            minimumQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(minimumQuantity, fieldData);
        }
...
internal HL7V271Field maximumQuantity;
...
public HL7V271Field MaximumQuantity
{
    get
    {
        ...
        maximumQuantity = new HL7V271Field
        {
            field = message[@"PRC"][8],
            Id = @"PRC.8",
            Type = @"Field",
        ...
        if (maximumQuantity.field.FieldRepetitions != null && maximumQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            maximumQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(maximumQuantity, fieldData);
        }
...
internal HL7V271Field minimumPrice;
...
public HL7V271Field MinimumPrice
{
    get
    {
        ...
        if (minimumPrice.field.FieldRepetitions != null && minimumPrice.field.FieldRepetitions.Count > 0)
        {
            ...
            minimumPrice.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(minimumPrice, fieldData);
        }
...
internal HL7V271Field maximumPrice;
...
public HL7V271Field MaximumPrice
{
    get
    {
        ...
        if (maximumPrice.field.FieldRepetitions != null && maximumPrice.field.FieldRepetitions.Count > 0)
        {
            ...
            maximumPrice.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(maximumPrice, fieldData);
        }
...
internal HL7V271Field effectiveStartDate;
...
public HL7V271Field EffectiveStartDate
{
    get
    {
        ...
        effectiveStartDate = new HL7V271Field
        {
        ...
        if (effectiveStartDate.field.FieldRepetitions != null && effectiveStartDate.field.FieldRepetitions.Count > 0)
        {
            ...
            effectiveStartDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(effectiveStartDate, fieldData);
        }
...
internal HL7V271Field effectiveEndDate;
...
public HL7V271Field EffectiveEndDate
{
    get
    {
        ...
        effectiveEndDate = new HL7V271Field
        {
        ...
        if (effectiveEndDate.field.FieldRepetitions != null && effectiveEndDate.field.FieldRepetitions.Count > 0)
        {
            ...
            effectiveEndDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(effectiveEndDate, fieldData);
        }
...
internal HL7V271Field priceOverrideFlag;
...
public HL7V271Field PriceOverrideFlag
{
    get
    {
        ...
        priceOverrideFlag = new HL7V271Field
        {
        ...
        if (priceOverrideFlag.field.FieldRepetitions != null && priceOverrideFlag.field.FieldRepetitions.Count > 0)
        {
            ...
            priceOverrideFlag.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(priceOverrideFlag, fieldData);
        }
...
internal HL7V271Field billingCategory;
...
public HL7V271Field BillingCategory
{
    get
    {
        ...
        billingCategory = new HL7V271Field
        {
        ...
        if (billingCategory.field.FieldRepetitions != null && billingCategory.field.FieldRepetitions.Count > 0)
        {
            ...
            billingCategory.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(billingCategory, fieldData);
        }
...
internal HL7V271Field chargeableFlag;
...
public HL7V271Field ChargeableFlag
{
    get
    {
        ...
        chargeableFlag = new HL7V271Field
        {
...
Y - item is billable (this is also the default when NULL)",
        ...
        if (chargeableFlag.field.FieldRepetitions != null && chargeableFlag.field.FieldRepetitions.Count > 0)
        {
            ...
            chargeableFlag.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(chargeableFlag, fieldData);
        }
...
public HL7V271Field Cost
{
    get
    {
        ...
        if (cost.field.FieldRepetitions != null && cost.field.FieldRepetitions.Count > 0)
        {
            ...
            cost.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(cost, fieldData);
        }
...
internal HL7V271Field chargeOnIndicator;
...
public HL7V271Field ChargeOnIndicator
{
    get
    {
        ...
        chargeOnIndicator = new HL7V271Field
        {
        ...
        if (chargeOnIndicator.field.FieldRepetitions != null && chargeOnIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            chargeOnIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV271FieldRepetitions(chargeOnIndicator, fieldData);
        }
