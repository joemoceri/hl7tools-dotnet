...
{
    public class HL7V271TriggerEventRTB_K13
    {
...
public readonly HL7V271SegmentDSC dsc;
        ...
        public string EventDescription { get { return @"Tabular response in response to QBP^Q13"; } }
        ...
        public HL7V271TriggerEventRTB_K13(HL7V2Message message)
        {
