...
{
    public class HL7V271TriggerEventRPA_I09
    {
...
private readonly HL7V271SegmentNTE nte;
        ...
        public string EventDescription { get { return @"Return Modification to an Authorization"; } }
        ...
        public HL7V271TriggerEventRPA_I09(HL7V2Message message)
        {
