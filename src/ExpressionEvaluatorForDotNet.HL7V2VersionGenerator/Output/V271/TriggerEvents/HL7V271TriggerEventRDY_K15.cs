...
{
    public class HL7V271TriggerEventRDY_K15
    {
...
private readonly HL7V271SegmentDSC dsc;
        ...
        public string EventDescription { get { return @"Display response in response to QBP^Q15"; } }
        ...
        public HL7V271TriggerEventRDY_K15(HL7V2Message message)
        {
