...
{
    public class HL7V2271Table0003
    {
                ...
                return new[]
                    {
                        ...
                        {
                            Value = @"A18",
                            Description = @"ADT/ACK -  Merge patient information",
                            Comment = @"Deprecated"
                        },
                        new HL7V2TableEntry
                        {
                        ...
                        {
                            Value = @"A30",
                            Description = @"ADT/ACK -  Merge person information",
                            Comment = @"Deprecated"
                        },
                        new HL7V2TableEntry
                        {
                        ...
                        {
                            Value = @"A36",
                            Description = @"ADT/ACK -  Merge patient information - patient ID and account number",
                            Comment = @"Deprecated"
                        },
                        new HL7V2TableEntry
                        {
                        ...
                        {
                            Value = @"A39",
                            Description = @"ADT/ACK - Merge person - patient ID",
                            Comment = @"Deprecated"
                        },
                        new HL7V2TableEntry
                        {
                        ...
                        {
                            Value = @"A46",
                            Description = @"ADT/ACK - Change patient ID",
                            Comment = @"Deprecated"
                        },
                        new HL7V2TableEntry
                        {
                        ...
                        {
                            Value = @"A48",
                            Description = @"ADT/ACK - Change alternate patient ID",
                            Comment = @"Deprecated"
                        },
                        new HL7V2TableEntry
                        {
                        ...
                        {
                            Value = @"E01",
                            Description = @"Submit HealthCare Services Invoice",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"E02",
                            Description = @"Cancel HealthCare Services Invoice",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"E03",
                            Description = @"HealthCare Services Invoice Status",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"E04",
                            Description = @"Re-Assess HealthCare Services Invoice Request",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                        ...
                        {
                            Value = @"E22",
                            Description = @"Authorization Request Status",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                        ...
                        new HL7V2TableEntry
                        {
                            ...
                            Comment = @"reserved for future/not yet defined"
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"E31",
                        ...
                        {
                            Value = @"I17",
                            Description = @"Modify Collaborative Care Referral",
                            Comment = @"Deprecated"
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"I18",
                            Description = @"Cancel Collaborative Care Referral",
                            Comment = @"Deprecated"
                        },
                        new HL7V2TableEntry
                        {
                        ...
                        {
                            Value = @"K31",
                            Description = @"RSP -Dispense History Response",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                        ...
                        {
                            Value = @"M01",
                            Description = @"MFN/MFK - Master file not otherwise specified",
                            Comment = @"Deprecated"
                        },
                        new HL7V2TableEntry
                        {
                        ...
                        {
                            Value = @"M03",
                            Description = @"MFN/MFK - Master file - test/observation",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                        ...
                        {
                            Value = @"M17",
                            Description = @"DRG Master File Message",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                        ...
                        {
                            Value = @"O38",
                            Description = @"OPR - Population/Location-Based Laboratory Order Acknowledgment Message",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"O39",
                            Description = @"Specimen shipment centric laboratory order",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"O40",
                            Description = @"Specimen Shipment Centric Laboratory Order Acknowledgment Message",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                        ...
                        {
                            Value = @"Q31",
                            Description = @"QBP Query Dispense history",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"Q32",
                            Description = @"Find Candidates including Visit Information",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                        ...
                        {
                            Value = @"R25",
                            Description = @"OPU - Unsolicited Population/Location-Based Laboratory Observation Message",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                        ...
                        {
                            Value = @"R33",
                            Description = @"ORA - Observation Report Acknowledgement",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                        ...
                        {
                            Value = @"S28",
                            Description = @"SLR/SLS - Request new sterilization lot",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"S29",
                            Description = @"SLR/SLS - Request Sterilization lot deletion",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"S30",
                            Description = @"STI/STS - Request item",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                            Value = @"S31",
                            Description = @"SDR/SDS - Request anti-microbial device data",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                        ...
                        {
                            Value = @"S34",
                            Description = @"SLN/ACK - Notification of sterilization lot",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
