...
{
    public class HL7V2231TableCountry
    {
        public string Id { get { return @"Country"; } }

        public string TableId { get { return @"Country"; } }

        public string TableType { get { return @"PreLoaded"; } }

        public string Name { get { return @"Country"; } }
