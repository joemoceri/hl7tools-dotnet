...
{
    public class HL7V2231Table0003
    {
                ...
                return new[]
                    {
                        ...
                        {
                            Value = @"CNQ",
                            Description = @"QRY/EQQ/SPQ/VQQ/RQQ - Cancel query",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                        ...
                        {
                            Value = @"R03",
                            Description = @"QRY/DSR Display-oriented results, query/unsol. update (for backward compatibility only)",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
                        ...
                        {
                            Value = @"S24",
                            Description = @"SIU/ACK - Notification of opened (â€œunblockedâ€) schedule time slot(s)",
                            Comment = null
                        },
                        new HL7V2TableEntry
                        {
