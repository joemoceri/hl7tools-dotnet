...
{
    public class HL7V231DataTypeXON
    {
        ...
        public string Description { get { return @"This data type is used in fields (e.g., PV2-23, NK1-13, PD111-3, OBR-44) to specify the name and ID number of an organization."; } }
