...
{
    public class HL7V231TriggerEventMFK_M07
    {
...
public readonly HL7V231SegmentMFA mfa;
        ...
        public string EventDescription { get { return @"Clinical study without phases but with schedules master file acknowledgment"; } }
        ...
        public HL7V231TriggerEventMFK_M07(HL7V2Message message)
        {
