...
{
    public class HL7V231TriggerEventRPA_I09
    {
...
public HL7V231SegmentNTE nte{ get; init; }
        ...
        public string EventDescription { get { return @"Return for modification to an authorization"; } }
        ...
        public HL7V231TriggerEventRPA_I09(HL7V2Message message)
        {
