...
{
    public class HL7V231TriggerEventMFR_M11
    {
...
public HL7V231SegmentDSC dsc{ get; init; }
        ...
        public string EventDescription { get { return @"Master Files Response - Test/calculated observations"; } }
        ...
        public HL7V231TriggerEventMFR_M11(HL7V2Message message)
        {
