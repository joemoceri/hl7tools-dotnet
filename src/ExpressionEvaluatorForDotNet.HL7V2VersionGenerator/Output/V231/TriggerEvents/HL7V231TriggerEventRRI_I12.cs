...
{
    public class HL7V231TriggerEventRRI_I12
    {
...
public HL7V231SegmentNTE nte{get; init;}
        ...
        public string EventDescription { get { return @"Return patient referral"; } }
        ...
        public HL7V231TriggerEventRRI_I12(HL7V2Message message)
        {
