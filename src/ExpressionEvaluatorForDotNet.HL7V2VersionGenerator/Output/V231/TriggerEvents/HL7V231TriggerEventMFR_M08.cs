...
{
    public class HL7V231TriggerEventMFR_M08
    {
...
public HL7V231SegmentDSC dsc{get; init;}
        ...
        public string EventDescription { get { return @"Master Files Response - Test/observation (Numeric)"; } }
        ...
        public HL7V231TriggerEventMFR_M08(HL7V2Message message)
        {
