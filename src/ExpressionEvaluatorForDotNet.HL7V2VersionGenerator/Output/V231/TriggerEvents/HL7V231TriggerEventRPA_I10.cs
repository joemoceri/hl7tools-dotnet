...
{
    public class HL7V231TriggerEventRPA_I10
    {
...
private readonly HL7V231SegmentNTE nte;
        ...
        public string EventDescription { get { return @"Return for resubmission of an authorization"; } }
        ...
        public HL7V231TriggerEventRPA_I10(HL7V2Message message)
        {
