...
{
    public class HL7V231TriggerEventRPA_I11
    {
...
public HL7V231SegmentNTE nte{get; init;}
        ...
        public string EventDescription { get { return @"Return for cancellation of an authorization"; } }
        ...
        public HL7V231TriggerEventRPA_I11(HL7V2Message message)
        {
