...
{
    public class HL7V231TriggerEventORN_O02
    {
...
private readonly HL7V231SegmentNTE nte;
        ...
        public string EventDescription { get { return @"Non-stock requisition - general order acknowledgment message"; } }
        ...
        public HL7V231TriggerEventORN_O02(HL7V2Message message)
        {
