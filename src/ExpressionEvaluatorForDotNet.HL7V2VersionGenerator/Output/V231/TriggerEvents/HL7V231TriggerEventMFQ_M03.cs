...
{
    public class HL7V231TriggerEventMFQ_M03
    {
...
private readonly HL7V231SegmentDSC dsc;
        ...
        public string EventDescription { get { return @"Query for Master File Record - Test/Observation "; } }
        ...
        public HL7V231TriggerEventMFQ_M03(HL7V2Message message)
        {
