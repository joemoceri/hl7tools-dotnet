...
{
    public class HL7V231TriggerEventSRR_S08
    {
...
public HL7V231SegmentERR err{get; init;}
        ...
        public string EventDescription { get { return @"Result modification of service/resource on appointment"; } }
        ...
        public HL7V231TriggerEventSRR_S08(HL7V2Message message)
        {
