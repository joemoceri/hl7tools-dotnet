...
{
    public class HL7V231TriggerEventMFQ_M09
    {
...
private readonly HL7V231SegmentDSC dsc;
        ...
        public string EventDescription { get { return @"Query for Master File Record - Test/Observation (Categorical)"; } }
        ...
        public HL7V231TriggerEventMFQ_M09(HL7V2Message message)
        {
