...
{
    public class HL7V231SegmentFTS
    {
        ...
        public HL7V231SegmentFTS(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V231Field _fileBatchCount;

public HL7V231Field FileBatchCount
{
    get
    {
        ...
        _fileBatchCount = new HL7V231Field
        {
            field = message[@"FTS"][1],
            fieldData = fieldData
        };
        ...
        {
            _fileBatchCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(_fileBatchCount, fieldData);
        }
...
internal HL7V231Field _fileTrailerComment;

public HL7V231Field FileTrailerComment
{
    get
    {
        ...
        _fileTrailerComment = new HL7V231Field
        {
            field = message[@"FTS"][2],
            fieldData = fieldData
        };
        ...
        {
            _fileTrailerComment.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(_fileTrailerComment, fieldData);
        }
