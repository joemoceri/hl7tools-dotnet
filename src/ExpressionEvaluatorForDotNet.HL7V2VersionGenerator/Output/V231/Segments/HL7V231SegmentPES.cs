...
public HL7V231Field SenderOrganizationName
{
    get
    {
        ...
        if (senderOrganizationName.field.FieldRepetitions != null && senderOrganizationName.field.FieldRepetitions.Count > 0)
        {
            ...
            senderOrganizationName.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(senderOrganizationName, fieldData);
        }
...
public HL7V231Field SenderIndividualName
{
    get
    {
        ...
        if (senderIndividualName.field.FieldRepetitions != null && senderIndividualName.field.FieldRepetitions.Count > 0)
        {
            ...
            senderIndividualName.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(senderIndividualName, fieldData);
        }
...
public HL7V231Field SenderAddress
{
    get
    {
        ...
        if (senderAddress.field.FieldRepetitions != null && senderAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            senderAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(senderAddress, fieldData);
        }
...
public HL7V231Field SenderTelephone
{
    get
    {
        ...
        if (senderTelephone.field.FieldRepetitions != null && senderTelephone.field.FieldRepetitions.Count > 0)
        {
            ...
            senderTelephone.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(senderTelephone, fieldData);
        }
...
public HL7V231Field SenderEventIdentifier
{
    get
    {
        ...
        if (senderEventIdentifier.field.FieldRepetitions != null && senderEventIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            senderEventIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(senderEventIdentifier, fieldData);
        }
...
public HL7V231Field SenderSequenceNumber
{
    get
    {
        ...
        if (senderSequenceNumber.field.FieldRepetitions != null && senderSequenceNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            senderSequenceNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(senderSequenceNumber, fieldData);
        }
...
public HL7V231Field SenderEventDescription
{
    get
    {
        ...
        if (senderEventDescription.field.FieldRepetitions != null && senderEventDescription.field.FieldRepetitions.Count > 0)
        {
            ...
            senderEventDescription.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(senderEventDescription, fieldData);
        }
...
public HL7V231Field SenderComment
{
    get
    {
        ...
        if (senderComment.field.FieldRepetitions != null && senderComment.field.FieldRepetitions.Count > 0)
        {
            ...
            senderComment.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(senderComment, fieldData);
        }
...
public HL7V231Field SenderAwareDateTime
{
    get
    {
        ...
        if (senderAwareDateTime.field.FieldRepetitions != null && senderAwareDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            senderAwareDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(senderAwareDateTime, fieldData);
        }
...
public HL7V231Field EventReportDate
{
    get
    {
        ...
        if (eventReportDate.field.FieldRepetitions != null && eventReportDate.field.FieldRepetitions.Count > 0)
        {
            ...
            eventReportDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(eventReportDate, fieldData);
        }
...
public HL7V231Field EventReportTimingType
{
    get
    {
        ...
        if (eventReportTimingType.field.FieldRepetitions != null && eventReportTimingType.field.FieldRepetitions.Count > 0)
        {
            ...
            eventReportTimingType.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(eventReportTimingType, fieldData);
        }
...
public HL7V231Field EventReportSource
{
    get
    {
        ...
        if (eventReportSource.field.FieldRepetitions != null && eventReportSource.field.FieldRepetitions.Count > 0)
        {
            ...
            eventReportSource.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(eventReportSource, fieldData);
        }
...
public HL7V231Field EventReportedTo
{
    get
    {
        ...
        if (eventReportedTo.field.FieldRepetitions != null && eventReportedTo.field.FieldRepetitions.Count > 0)
        {
            ...
            eventReportedTo.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(eventReportedTo, fieldData);
        }
