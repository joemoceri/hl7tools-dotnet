...
public HL7V231Field SetIDCM0
{
    get
    {
        ...
        if (setIDCM0.field.FieldRepetitions != null && setIDCM0.field.FieldRepetitions.Count > 0)
        {
            ...
            setIDCM0.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(setIDCM0, fieldData);
        }
...
public HL7V231Field TitleofStudy
{
    get
    {
        ...
        if (titleofStudy.field.FieldRepetitions != null && titleofStudy.field.FieldRepetitions.Count > 0)
        {
            ...
            titleofStudy.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(titleofStudy, fieldData);
        }
...
public HL7V231Field ChairmanofStudy
{
    get
    {
        ...
        if (chairmanofStudy.field.FieldRepetitions != null && chairmanofStudy.field.FieldRepetitions.Count > 0)
        {
            ...
            chairmanofStudy.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(chairmanofStudy, fieldData);
        }
...
public HL7V231Field LastIRBApprovalDate
{
    get
    {
        ...
        if (lastIRBApprovalDate.field.FieldRepetitions != null && lastIRBApprovalDate.field.FieldRepetitions.Count > 0)
        {
            ...
            lastIRBApprovalDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(lastIRBApprovalDate, fieldData);
        }
...
public HL7V231Field TotalAccrualtoDate
{
    get
    {
        ...
        if (totalAccrualtoDate.field.FieldRepetitions != null && totalAccrualtoDate.field.FieldRepetitions.Count > 0)
        {
            ...
            totalAccrualtoDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(totalAccrualtoDate, fieldData);
        }
...
public HL7V231Field LastAccrualDate
{
    get
    {
        ...
        if (lastAccrualDate.field.FieldRepetitions != null && lastAccrualDate.field.FieldRepetitions.Count > 0)
        {
            ...
            lastAccrualDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(lastAccrualDate, fieldData);
        }
...
public HL7V231Field ContactforStudy
{
    get
    {
        ...
        if (contactforStudy.field.FieldRepetitions != null && contactforStudy.field.FieldRepetitions.Count > 0)
        {
            ...
            contactforStudy.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(contactforStudy, fieldData);
        }
...
public HL7V231Field ContactsTelNumber
{
    get
    {
        ...
        if (contactsTelNumber.field.FieldRepetitions != null && contactsTelNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            contactsTelNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(contactsTelNumber, fieldData);
        }
...
public HL7V231Field ContactsAddress
{
    get
    {
        ...
        if (contactsAddress.field.FieldRepetitions != null && contactsAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            contactsAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(contactsAddress, fieldData);
        }
