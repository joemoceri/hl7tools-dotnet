...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V231SegmentADD
    {
        ...
        internal HL7V231Field addendumContinuationPointer;
...
public HL7V231Field AddendumContinuationPointer
{
    get
    {
        ...
        addendumContinuationPointer = new HL7V231Field
        {
            field = message[@"ADD"][1],
            Id = @"ADD.1",
            Type = @"Field",
        ...
        if (addendumContinuationPointer.field.FieldRepetitions != null && addendumContinuationPointer.field.FieldRepetitions.Count > 0)
        {
            ...
            addendumContinuationPointer.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(addendumContinuationPointer, fieldData);
        }
