...
{
    public class HL7V231SegmentADD
    {
        ...
        public string LongName { get { return @"Addendum segment"; } }
        ...
        public HL7V231SegmentADD(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V231Field _addendumContinuationPointer;

public HL7V231Field AddendumContinuationPointer
{
    get
    {
        ...
        _addendumContinuationPointer = new HL7V231Field
        {
            field = message[@"ADD"][1],
            fieldData = fieldData
        };
        ...
        {
            _addendumContinuationPointer.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(_addendumContinuationPointer, fieldData);
        }
