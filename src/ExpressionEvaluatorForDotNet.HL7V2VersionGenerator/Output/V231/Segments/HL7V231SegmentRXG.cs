...
{
    public class HL7V231SegmentRXG
    {
        ...
        public string LongName { get { return @"Pharmacy/treatment give segment"; } }
        
        public string Description { get { return @"Figure 4-18. RXG attributes"; } }
...
The time specifies the interval between the predecessor and successor starts or ends (see following examples). Where <time> is defined as:  
 ...
 - L<integer> do for <integer> months",
                        ...
                        new HL7V2FieldData
                        {
                            ...
                            TableId = null,
                            TableName = null,
                            Description = @"The dosage form indicates the manner in which the medication is aggregated for dispensing, e.g., tablets, capsules, suppositories. In some cases, this information is implied by the give code in RXG-4-give code . Use this field when the give code does not specify the dosage form.",
                            Sample = @"",
                            FieldDatas = new []{new HL7V2FieldData
                        {
                            Id = @"RXG.8.1",
        ...
        public HL7V231SegmentRXG(HL7V2Message message)
        {
...
public HL7V231Field DispenseSubIDCounter
{
    get
    {
        ...
        if (dispenseSubIDCounter.field.FieldRepetitions != null && dispenseSubIDCounter.field.FieldRepetitions.Count > 0)
        {
            ...
            dispenseSubIDCounter.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(dispenseSubIDCounter, fieldData);
        }
...
public HL7V231Field DispenseToLocation
{
    get
    {
        ...
        if (dispenseToLocation.field.FieldRepetitions != null && dispenseToLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            dispenseToLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(dispenseToLocation, fieldData);
        }
...
internal HL7V231Field pharmacyTreatmentSuppliersSpecialAdministrationInstructions;

public HL7V231Field PharmacyTreatmentSuppliersSpecialAdministrationInstructions
{
    get
    {
        ...
        pharmacyTreatmentSuppliersSpecialAdministrationInstructions = new HL7V231Field
        {
        ...
        if (pharmacyTreatmentSuppliersSpecialAdministrationInstructions.field.FieldRepetitions != null && pharmacyTreatmentSuppliersSpecialAdministrationInstructions.field.FieldRepetitions.Count > 0)
        {
            ...
            pharmacyTreatmentSuppliersSpecialAdministrationInstructions.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(pharmacyTreatmentSuppliersSpecialAdministrationInstructions, fieldData);
        }
