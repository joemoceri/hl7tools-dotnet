...
public HL7V231Field FileFieldSeparator
{
    get
    {
        ...
        if (fileFieldSeparator.field.FieldRepetitions != null && fileFieldSeparator.field.FieldRepetitions.Count > 0)
        {
            ...
            fileFieldSeparator.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(fileFieldSeparator, fieldData);
        }
...
public HL7V231Field FileEncodingCharacters
{
    get
    {
        ...
        if (fileEncodingCharacters.field.FieldRepetitions != null && fileEncodingCharacters.field.FieldRepetitions.Count > 0)
        {
            ...
            fileEncodingCharacters.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(fileEncodingCharacters, fieldData);
        }
...
public HL7V231Field FileSendingApplication
{
    get
    {
        ...
        if (fileSendingApplication.field.FieldRepetitions != null && fileSendingApplication.field.FieldRepetitions.Count > 0)
        {
            ...
            fileSendingApplication.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(fileSendingApplication, fieldData);
        }
...
public HL7V231Field FileSendingFacility
{
    get
    {
        ...
        if (fileSendingFacility.field.FieldRepetitions != null && fileSendingFacility.field.FieldRepetitions.Count > 0)
        {
            ...
            fileSendingFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(fileSendingFacility, fieldData);
        }
...
public HL7V231Field FileReceivingApplication
{
    get
    {
        ...
        if (fileReceivingApplication.field.FieldRepetitions != null && fileReceivingApplication.field.FieldRepetitions.Count > 0)
        {
            ...
            fileReceivingApplication.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(fileReceivingApplication, fieldData);
        }
...
public HL7V231Field FileReceivingFacility
{
    get
    {
        ...
        if (fileReceivingFacility.field.FieldRepetitions != null && fileReceivingFacility.field.FieldRepetitions.Count > 0)
        {
            ...
            fileReceivingFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(fileReceivingFacility, fieldData);
        }
...
public HL7V231Field FileCreationDateTime
{
    get
    {
        ...
        if (fileCreationDateTime.field.FieldRepetitions != null && fileCreationDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            fileCreationDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(fileCreationDateTime, fieldData);
        }
...
public HL7V231Field FileSecurity
{
    get
    {
        ...
        if (fileSecurity.field.FieldRepetitions != null && fileSecurity.field.FieldRepetitions.Count > 0)
        {
            ...
            fileSecurity.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(fileSecurity, fieldData);
        }
...
public HL7V231Field FileNameID
{
    get
    {
        ...
        if (fileNameID.field.FieldRepetitions != null && fileNameID.field.FieldRepetitions.Count > 0)
        {
            ...
            fileNameID.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(fileNameID, fieldData);
        }
...
public HL7V231Field FileHeaderComment
{
    get
    {
        ...
        if (fileHeaderComment.field.FieldRepetitions != null && fileHeaderComment.field.FieldRepetitions.Count > 0)
        {
            ...
            fileHeaderComment.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(fileHeaderComment, fieldData);
        }
...
public HL7V231Field FileControlID
{
    get
    {
        ...
        if (fileControlID.field.FieldRepetitions != null && fileControlID.field.FieldRepetitions.Count > 0)
        {
            ...
            fileControlID.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(fileControlID, fieldData);
        }
...
public HL7V231Field ReferenceFileControlID
{
    get
    {
        ...
        if (referenceFileControlID.field.FieldRepetitions != null && referenceFileControlID.field.FieldRepetitions.Count > 0)
        {
            ...
            referenceFileControlID.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(referenceFileControlID, fieldData);
        }
