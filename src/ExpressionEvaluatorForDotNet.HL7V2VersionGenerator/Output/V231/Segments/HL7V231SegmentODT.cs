...
{
    public class HL7V231SegmentODT
    {
        ...
        public HL7V231SegmentODT(HL7V2Message message)
        {
            this.message = message;
        }

        
internal HL7V231Field trayType;

public HL7V231Field TrayType
{
    get
    {
        if (trayType != null)
