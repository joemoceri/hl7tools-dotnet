...
{
    public class HL7V231SegmentNPU
    {
        ...
        public string LongName { get { return @"Bed status update segment"; } }
        ...
        public HL7V231SegmentNPU(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V231Field bedLocation;

public HL7V231Field BedLocation
{
    get
    {
        if (bedLocation != null)
        ...
        if (bedLocation.field.FieldRepetitions != null && bedLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            bedLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(bedLocation, fieldData);
        }
