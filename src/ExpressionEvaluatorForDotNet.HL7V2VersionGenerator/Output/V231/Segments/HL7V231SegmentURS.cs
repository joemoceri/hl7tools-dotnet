...
The time specifies the interval between the predecessor and successor starts or ends (see following examples). Where <time> is defined as:  
 ...
 - L<integer> do for <integer> months",
        ...
        internal HL7V231Field rUWhereSubjectDefinition;
...
public HL7V231Field RUWhereSubjectDefinition
{
    get
    {
        ...
        rUWhereSubjectDefinition = new HL7V231Field
        {
            field = message[@"URS"][1],
            Id = @"URS.1",
            Type = @"Field",
        ...
        if (rUWhereSubjectDefinition.field.FieldRepetitions != null && rUWhereSubjectDefinition.field.FieldRepetitions.Count > 0)
        {
            ...
            rUWhereSubjectDefinition.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(rUWhereSubjectDefinition, fieldData);
        }
...
internal HL7V231Field rUWhenDataStartDateTime;
...
public HL7V231Field RUWhenDataStartDateTime
{
    get
    {
        ...
        rUWhenDataStartDateTime = new HL7V231Field
        {
            field = message[@"URS"][2],
            Id = @"URS.2",
            Type = @"Field",
        ...
        if (rUWhenDataStartDateTime.field.FieldRepetitions != null && rUWhenDataStartDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            rUWhenDataStartDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(rUWhenDataStartDateTime, fieldData);
        }
...
internal HL7V231Field rUWhenDataEndDateTime;
...
public HL7V231Field RUWhenDataEndDateTime
{
    get
    {
        ...
        rUWhenDataEndDateTime = new HL7V231Field
        {
            field = message[@"URS"][3],
            Id = @"URS.3",
            Type = @"Field",
        ...
        if (rUWhenDataEndDateTime.field.FieldRepetitions != null && rUWhenDataEndDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            rUWhenDataEndDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(rUWhenDataEndDateTime, fieldData);
        }
...
internal HL7V231Field rUWhatUserQualifier;
...
public HL7V231Field RUWhatUserQualifier
{
    get
    {
        ...
        rUWhatUserQualifier = new HL7V231Field
        {
            field = message[@"URS"][4],
            Id = @"URS.4",
            Type = @"Field",
        ...
        if (rUWhatUserQualifier.field.FieldRepetitions != null && rUWhatUserQualifier.field.FieldRepetitions.Count > 0)
        {
            ...
            rUWhatUserQualifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(rUWhatUserQualifier, fieldData);
        }
...
internal HL7V231Field rUOtherResultsSubjectDefinition;
...
public HL7V231Field RUOtherResultsSubjectDefinition
{
    get
    {
        ...
        rUOtherResultsSubjectDefinition = new HL7V231Field
        {
            field = message[@"URS"][5],
            Id = @"URS.5",
            Type = @"Field",
        ...
        if (rUOtherResultsSubjectDefinition.field.FieldRepetitions != null && rUOtherResultsSubjectDefinition.field.FieldRepetitions.Count > 0)
        {
            ...
            rUOtherResultsSubjectDefinition.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(rUOtherResultsSubjectDefinition, fieldData);
        }
...
internal HL7V231Field rUWhichDateTimeQualifier;
...
public HL7V231Field RUWhichDateTimeQualifier
{
    get
    {
        ...
        rUWhichDateTimeQualifier = new HL7V231Field
        {
            field = message[@"URS"][6],
            Id = @"URS.6",
            Type = @"Field",
        ...
        if (rUWhichDateTimeQualifier.field.FieldRepetitions != null && rUWhichDateTimeQualifier.field.FieldRepetitions.Count > 0)
        {
            ...
            rUWhichDateTimeQualifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(rUWhichDateTimeQualifier, fieldData);
        }
...
internal HL7V231Field rUWhichDateTimeStatusQualifier;
...
public HL7V231Field RUWhichDateTimeStatusQualifier
{
    get
    {
        ...
        rUWhichDateTimeStatusQualifier = new HL7V231Field
        {
            field = message[@"URS"][7],
            Id = @"URS.7",
            Type = @"Field",
        ...
        if (rUWhichDateTimeStatusQualifier.field.FieldRepetitions != null && rUWhichDateTimeStatusQualifier.field.FieldRepetitions.Count > 0)
        {
            ...
            rUWhichDateTimeStatusQualifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(rUWhichDateTimeStatusQualifier, fieldData);
        }
...
internal HL7V231Field rUDateTimeSelectionQualifier;
...
public HL7V231Field RUDateTimeSelectionQualifier
{
    get
    {
        ...
        rUDateTimeSelectionQualifier = new HL7V231Field
        {
            field = message[@"URS"][8],
            Id = @"URS.8",
            Type = @"Field",
        ...
        if (rUDateTimeSelectionQualifier.field.FieldRepetitions != null && rUDateTimeSelectionQualifier.field.FieldRepetitions.Count > 0)
        {
            ...
            rUDateTimeSelectionQualifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(rUDateTimeSelectionQualifier, fieldData);
        }
...
internal HL7V231Field rUQuantityTimingQualifier;
...
public HL7V231Field RUQuantityTimingQualifier
{
    get
    {
        ...
        rUQuantityTimingQualifier = new HL7V231Field
        {
            field = message[@"URS"][9],
            Id = @"URS.9",
            Type = @"Field",
        ...
        if (rUQuantityTimingQualifier.field.FieldRepetitions != null && rUQuantityTimingQualifier.field.FieldRepetitions.Count > 0)
        {
            ...
            rUQuantityTimingQualifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(rUQuantityTimingQualifier, fieldData);
        }
