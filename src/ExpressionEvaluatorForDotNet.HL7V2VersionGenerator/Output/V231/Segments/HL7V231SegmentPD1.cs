...
{
    public class HL7V231SegmentPD1
    {
...
internal HL7V231Field patientPrimaryCareProviderName&IDNo.;

public HL7V231Field PatientPrimaryCareProviderName&IDNo.
{
    get
    {
        ...
        patientPrimaryCareProviderName&IDNo. = new HL7V231Field
        {
            field = message[@"PD1"][4],
            Id = @"PD1.4",
            Type = @"Field",
