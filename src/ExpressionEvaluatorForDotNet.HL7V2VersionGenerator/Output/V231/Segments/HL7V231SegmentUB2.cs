...
internal HL7V231Field valueAmount&Code;

public HL7V231Field ValueAmount&Code
{
    get
    {
        ...
        valueAmount&Code = new HL7V231Field
        {
            field = message[@"UB2"][6],
            Id = @"UB2.6",
            Type = @"Field",
...
internal HL7V231Field occurrenceCode&Date;

public HL7V231Field OccurrenceCode&Date
{
    get
    {
        ...
        occurrenceCode&Date = new HL7V231Field
        {
            field = message[@"UB2"][7],
            Id = @"UB2.7",
            Type = @"Field",
