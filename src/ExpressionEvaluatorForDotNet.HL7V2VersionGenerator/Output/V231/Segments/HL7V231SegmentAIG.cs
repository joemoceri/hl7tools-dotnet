...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V231SegmentAIG
    {
        ...
        internal HL7V231Field setIDAIG;
...
public HL7V231Field SetIDAIG
{
    get
    {
        ...
        if (setIDAIG.field.FieldRepetitions != null && setIDAIG.field.FieldRepetitions.Count > 0)
        {
            ...
            setIDAIG.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(setIDAIG, fieldData);
        }
...
internal HL7V231Field resourceID;
...
public HL7V231Field ResourceID
{
    get
    {
        ...
        if (resourceID.field.FieldRepetitions != null && resourceID.field.FieldRepetitions.Count > 0)
        {
            ...
            resourceID.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(resourceID, fieldData);
        }
...
internal HL7V231Field resourceType;
...
public HL7V231Field ResourceType
{
    get
    {
        ...
        if (resourceType.field.FieldRepetitions != null && resourceType.field.FieldRepetitions.Count > 0)
        {
            ...
            resourceType.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(resourceType, fieldData);
        }
...
internal HL7V231Field resourceGroup;
...
public HL7V231Field ResourceGroup
{
    get
    {
        ...
        resourceGroup = new HL7V231Field
        {
            field = message[@"AIG"][5],
            Id = @"AIG.5",
            Type = @"Field",
        ...
        if (resourceGroup.field.FieldRepetitions != null && resourceGroup.field.FieldRepetitions.Count > 0)
        {
            ...
            resourceGroup.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(resourceGroup, fieldData);
        }
...
internal HL7V231Field resourceQuantity;
...
public HL7V231Field ResourceQuantity
{
    get
    {
        ...
        resourceQuantity = new HL7V231Field
        {
            field = message[@"AIG"][6],
            Id = @"AIG.6",
            Type = @"Field",
        ...
        if (resourceQuantity.field.FieldRepetitions != null && resourceQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            resourceQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(resourceQuantity, fieldData);
        }
...
internal HL7V231Field resourceQuantityUnits;
...
public HL7V231Field ResourceQuantityUnits
{
    get
    {
        ...
        resourceQuantityUnits = new HL7V231Field
        {
            field = message[@"AIG"][7],
            Id = @"AIG.7",
            Type = @"Field",
        ...
        if (resourceQuantityUnits.field.FieldRepetitions != null && resourceQuantityUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            resourceQuantityUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(resourceQuantityUnits, fieldData);
        }
