...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V231SegmentBTS
    {
        ...
        internal HL7V231Field _batchMessageCount;
...
public HL7V231Field BatchMessageCount
{
    get
    {
        ...
        _batchMessageCount = new HL7V231Field
        {
            field = message[@"BTS"][1],
            fieldData = fieldData
        };
        ...
        {
            _batchMessageCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(_batchMessageCount, fieldData);
        }
...
internal HL7V231Field _batchTotals;
...
This field may be defined as a CM data type for backward compatibility with HL7 Versions 2.2 and 2.1 with each total being carried as a separate component.  Each component in this case is an NM data type",
        ...
        {
            _batchTotals.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(_batchTotals, fieldData);
        }
