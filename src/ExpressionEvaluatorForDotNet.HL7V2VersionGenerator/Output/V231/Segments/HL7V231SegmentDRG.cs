...
public HL7V231Field DRGAssignedDateTime
{
    get
    {
        ...
        if (dRGAssignedDateTime.field.FieldRepetitions != null && dRGAssignedDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            dRGAssignedDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(dRGAssignedDateTime, fieldData);
        }
...
public HL7V231Field DRGPayor
{
    get
    {
        ...
        if (dRGPayor.field.FieldRepetitions != null && dRGPayor.field.FieldRepetitions.Count > 0)
        {
            ...
            dRGPayor.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(dRGPayor, fieldData);
        }
...
public HL7V231Field OutlierReimbursement
{
    get
    {
        ...
        if (outlierReimbursement.field.FieldRepetitions != null && outlierReimbursement.field.FieldRepetitions.Count > 0)
        {
            ...
            outlierReimbursement.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(outlierReimbursement, fieldData);
        }
