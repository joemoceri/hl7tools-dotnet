...
internal HL7V231Field _derivationRule;
...
public HL7V231Field DerivationRule
{
    get
    {
        ...
        _derivationRule = new HL7V231Field
        {
            field = message[@"OM6"][2],
            fieldData = fieldData
        };
        ...
        {
            _derivationRule.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(_derivationRule, fieldData);
        }
