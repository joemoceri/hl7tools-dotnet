...
internal HL7V231Field diet,Supplement,orPreferenceCode;

public HL7V231Field Diet,Supplement,orPreferenceCode
{
    get
    {
        ...
        diet,Supplement,orPreferenceCode = new HL7V231Field
        {
            field = message[@"ODS"][3],
            Id = @"ODS.3",
            Type = @"Field",
