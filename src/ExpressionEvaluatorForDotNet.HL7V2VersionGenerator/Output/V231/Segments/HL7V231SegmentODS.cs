...
public HL7V231Field Type
{
    get
    {
        ...
        if (type.field.FieldRepetitions != null && type.field.FieldRepetitions.Count > 0)
        {
            ...
            type.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(type, fieldData);
        }
...
internal HL7V231Field servicePeriod;
...
public HL7V231Field ServicePeriod
{
    get
    {
        ...
        servicePeriod = new HL7V231Field
        {
            field = message[@"ODS"][2],
            Id = @"ODS.2",
            Type = @"Field",
        ...
        if (servicePeriod.field.FieldRepetitions != null && servicePeriod.field.FieldRepetitions.Count > 0)
        {
            ...
            servicePeriod.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(servicePeriod, fieldData);
        }
...
internal HL7V231Field dietSupplementorPreferenceCode;
...
public HL7V231Field DietSupplementorPreferenceCode
{
    get
    {
        ...
        dietSupplementorPreferenceCode = new HL7V231Field
        {
            field = message[@"ODS"][3],
            Id = @"ODS.3",
            Type = @"Field",
        ...
        if (dietSupplementorPreferenceCode.field.FieldRepetitions != null && dietSupplementorPreferenceCode.field.FieldRepetitions.Count > 0)
        {
            ...
            dietSupplementorPreferenceCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(dietSupplementorPreferenceCode, fieldData);
        }
...
internal HL7V231Field textInstruction;
...
public HL7V231Field TextInstruction
{
    get
    {
        ...
        textInstruction = new HL7V231Field
        {
            field = message[@"ODS"][4],
            Id = @"ODS.4",
            Type = @"Field",
        ...
        if (textInstruction.field.FieldRepetitions != null && textInstruction.field.FieldRepetitions.Count > 0)
        {
            ...
            textInstruction.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(textInstruction, fieldData);
        }
