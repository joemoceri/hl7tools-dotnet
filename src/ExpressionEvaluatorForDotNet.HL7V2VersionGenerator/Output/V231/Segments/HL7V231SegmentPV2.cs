...
internal HL7V231Field expectedSurgeryDate&Time;

public HL7V231Field ExpectedSurgeryDate&Time
{
    get
    {
        if (expectedSurgeryDate&Time != null)
        {
            return expectedSurgeryDate&Time;
        }

        expectedSurgeryDate&Time = new HL7V231Field
        {
