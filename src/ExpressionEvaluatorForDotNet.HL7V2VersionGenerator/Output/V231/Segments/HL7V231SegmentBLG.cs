...
public HL7V231Field WhentoCharge
{
    get
    {
        ...
        if (whentoCharge.field.FieldRepetitions != null && whentoCharge.field.FieldRepetitions.Count > 0)
        {
            ...
            whentoCharge.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(whentoCharge, fieldData);
        }
...
public HL7V231Field ChargeType
{
    get
    {
        ...
        if (chargeType.field.FieldRepetitions != null && chargeType.field.FieldRepetitions.Count > 0)
        {
            ...
            chargeType.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(chargeType, fieldData);
        }
...
public HL7V231Field AccountID
{
    get
    {
        ...
        if (accountID.field.FieldRepetitions != null && accountID.field.FieldRepetitions.Count > 0)
        {
            ...
            accountID.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(accountID, fieldData);
        }
