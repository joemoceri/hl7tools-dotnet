...
internal HL7V231Field datetimeStudyPhaseBegan;
...
public HL7V231Field DatetimeStudyPhaseBegan
{
    get
    {
        ...
        datetimeStudyPhaseBegan = new HL7V231Field
        {
            field = message[@"CSP"][2],
            Id = @"CSP.2",
            Type = @"Field",
        ...
        if (datetimeStudyPhaseBegan.field.FieldRepetitions != null && datetimeStudyPhaseBegan.field.FieldRepetitions.Count > 0)
        {
            ...
            datetimeStudyPhaseBegan.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(datetimeStudyPhaseBegan, fieldData);
        }
...
internal HL7V231Field datetimeStudyPhaseEnded;
...
public HL7V231Field DatetimeStudyPhaseEnded
{
    get
    {
        ...
        datetimeStudyPhaseEnded = new HL7V231Field
        {
            field = message[@"CSP"][3],
            Id = @"CSP.3",
            Type = @"Field",
        ...
        if (datetimeStudyPhaseEnded.field.FieldRepetitions != null && datetimeStudyPhaseEnded.field.FieldRepetitions.Count > 0)
        {
            ...
            datetimeStudyPhaseEnded.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(datetimeStudyPhaseEnded, fieldData);
        }
...
internal HL7V231Field studyPhaseEvaluability;
...
public HL7V231Field StudyPhaseEvaluability
{
    get
    {
        ...
        studyPhaseEvaluability = new HL7V231Field
        {
            field = message[@"CSP"][4],
            Id = @"CSP.4",
            Type = @"Field",
        ...
        if (studyPhaseEvaluability.field.FieldRepetitions != null && studyPhaseEvaluability.field.FieldRepetitions.Count > 0)
        {
            ...
            studyPhaseEvaluability.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(studyPhaseEvaluability, fieldData);
        }
