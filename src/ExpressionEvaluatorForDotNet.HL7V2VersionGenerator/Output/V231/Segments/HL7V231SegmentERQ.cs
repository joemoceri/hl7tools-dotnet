...
internal HL7V231Field _eventIdentifier;
...
public HL7V231Field EventIdentifier
{
    get
    {
        ...
        _eventIdentifier = new HL7V231Field
        {
            field = message[@"ERQ"][2],
            fieldData = fieldData
        };
        ...
        {
            _eventIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(_eventIdentifier, fieldData);
        }
