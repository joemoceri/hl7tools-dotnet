...
public HL7V231Field SetIDCM1
{
    get
    {
        ...
        if (setIDCM1.field.FieldRepetitions != null && setIDCM1.field.FieldRepetitions.Count > 0)
        {
            ...
            setIDCM1.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(setIDCM1, fieldData);
        }
...
public HL7V231Field DescriptionofStudyPhase
{
    get
    {
        ...
        if (descriptionofStudyPhase.field.FieldRepetitions != null && descriptionofStudyPhase.field.FieldRepetitions.Count > 0)
        {
            ...
            descriptionofStudyPhase.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(descriptionofStudyPhase, fieldData);
        }
