...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V231SegmentCM1
    {
        ...
        internal HL7V231Field _setIDCM1;
...
public HL7V231Field SetIDCM1
{
    get
    {
        ...
        {
            _setIDCM1.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(_setIDCM1, fieldData);
        }
...
internal HL7V231Field _descriptionofStudyPhase;
...
public HL7V231Field DescriptionofStudyPhase
{
    get
    {
        ...
        _descriptionofStudyPhase = new HL7V231Field
        {
            field = message[@"CM1"][3],
            fieldData = fieldData
        };
        ...
        {
            _descriptionofStudyPhase.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(_descriptionofStudyPhase, fieldData);
        }
