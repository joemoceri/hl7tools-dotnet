...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V231SegmentMFI
    {
        ...
        internal HL7V231Field masterFileIdentifier;
...
public HL7V231Field MasterFileIdentifier
{
    get
    {
        ...
        masterFileIdentifier = new HL7V231Field
        {
            field = message[@"MFI"][1],
            Id = @"MFI.1",
            Type = @"Field",
        ...
        if (masterFileIdentifier.field.FieldRepetitions != null && masterFileIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            masterFileIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(masterFileIdentifier, fieldData);
        }
...
internal HL7V231Field masterFileApplicationIdentifier;
...
public HL7V231Field MasterFileApplicationIdentifier
{
    get
    {
        ...
        masterFileApplicationIdentifier = new HL7V231Field
        {
            field = message[@"MFI"][2],
            Id = @"MFI.2",
            Type = @"Field",
        ...
        if (masterFileApplicationIdentifier.field.FieldRepetitions != null && masterFileApplicationIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            masterFileApplicationIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(masterFileApplicationIdentifier, fieldData);
        }
...
internal HL7V231Field fileLevelEventCode;
...
public HL7V231Field FileLevelEventCode
{
    get
    {
        ...
        fileLevelEventCode = new HL7V231Field
        {
            field = message[@"MFI"][3],
            Id = @"MFI.3",
            Type = @"Field",
        ...
        if (fileLevelEventCode.field.FieldRepetitions != null && fileLevelEventCode.field.FieldRepetitions.Count > 0)
        {
            ...
            fileLevelEventCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(fileLevelEventCode, fieldData);
        }
...
internal HL7V231Field enteredDateTime;
...
public HL7V231Field EnteredDateTime
{
    get
    {
        ...
        enteredDateTime = new HL7V231Field
        {
            field = message[@"MFI"][4],
            Id = @"MFI.4",
            Type = @"Field",
        ...
        if (enteredDateTime.field.FieldRepetitions != null && enteredDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            enteredDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(enteredDateTime, fieldData);
        }
...
internal HL7V231Field responseLevelCode;
...
public HL7V231Field ResponseLevelCode
{
    get
    {
        ...
        responseLevelCode = new HL7V231Field
        {
            field = message[@"MFI"][6],
            Id = @"MFI.6",
            Type = @"Field",
        ...
        if (responseLevelCode.field.FieldRepetitions != null && responseLevelCode.field.FieldRepetitions.Count > 0)
        {
            ...
            responseLevelCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(responseLevelCode, fieldData);
        }
