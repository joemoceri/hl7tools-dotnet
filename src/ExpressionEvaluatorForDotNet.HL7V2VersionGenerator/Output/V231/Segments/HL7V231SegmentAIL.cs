...
public HL7V231Field SetIDAIL
{
    get
    {
        ...
        if (setIDAIL.field.FieldRepetitions != null && setIDAIL.field.FieldRepetitions.Count > 0)
        {
            ...
            setIDAIL.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(setIDAIL, fieldData);
        }
...
public HL7V231Field LocationResourceID
{
    get
    {
        ...
        if (locationResourceID.field.FieldRepetitions != null && locationResourceID.field.FieldRepetitions.Count > 0)
        {
            ...
            locationResourceID.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(locationResourceID, fieldData);
        }
...
public HL7V231Field LocationTypeAIL
{
    get
    {
        ...
        if (locationTypeAIL.field.FieldRepetitions != null && locationTypeAIL.field.FieldRepetitions.Count > 0)
        {
            ...
            locationTypeAIL.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(locationTypeAIL, fieldData);
        }
...
public HL7V231Field LocationGroup
{
    get
    {
        ...
        if (locationGroup.field.FieldRepetitions != null && locationGroup.field.FieldRepetitions.Count > 0)
        {
            ...
            locationGroup.fieldRepetitions = HL7V2FieldGenerator.GenerateV231FieldRepetitions(locationGroup, fieldData);
        }
