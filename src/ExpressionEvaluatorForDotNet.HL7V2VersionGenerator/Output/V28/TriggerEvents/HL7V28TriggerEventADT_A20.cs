...
{
    public class HL7V28TriggerEventADT_A20
    {
...
private readonly HL7V28SegmentNPU npu;
        ...
        public HL7V28TriggerEventADT_A20(HL7V2Message message)
        {
...
this.npu = new HL7V28SegmentNPU(this.message);
