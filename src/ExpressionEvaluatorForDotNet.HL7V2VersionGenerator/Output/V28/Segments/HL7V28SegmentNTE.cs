...
The technical committees define the meaning of the NTE segments within the context of the messages in their chapters. For each NTE, the description in the message attribute table should include an indication of the segment associated with the NTE, for example ""Notes and Comments for the PID""."; } }
        ...
        internal HL7V28Field _setIdNte;
...
public HL7V28Field SetIdNte
{
    get
    {
        ...
        {
            _setIdNte.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_setIdNte, fieldData);
        }
...
internal HL7V28Field _sourceOfComment;
...
public HL7V28Field SourceOfComment
{
    get
    {
        ...
        _sourceOfComment = new HL7V28Field
        {
            field = message[@"NTE"][2],
            fieldData = fieldData
        };
        ...
        {
            _sourceOfComment.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_sourceOfComment, fieldData);
        }
...
Note: As of v2.2, this field uses the FT rather than a TX data type. Since there is no difference between an FT data type without any embedded formatting commands, and a TX data type, this change is compatible with the previous version.",
        ...
        {
            _comment.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_comment, fieldData);
        }
...
internal HL7V28Field _commentType;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _commentType.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_commentType, fieldData);
        }
