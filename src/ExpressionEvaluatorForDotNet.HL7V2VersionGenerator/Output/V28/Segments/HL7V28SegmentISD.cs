...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V28SegmentISD
    {
        ...
        internal HL7V28Field _referenceInteractionNumber;
...
public HL7V28Field ReferenceInteractionNumber
{
    get
    {
        ...
        _referenceInteractionNumber = new HL7V28Field
        {
            field = message[@"ISD"][1],
            fieldData = fieldData
        };
        ...
        {
            _referenceInteractionNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_referenceInteractionNumber, fieldData);
        }
...
internal HL7V28Field _interactionTypeIdentifier;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _interactionTypeIdentifier = new HL7V28Field
        {
            field = message[@"ISD"][2],
            fieldData = fieldData
        };
        ...
        {
            _interactionTypeIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_interactionTypeIdentifier, fieldData);
        }
...
internal HL7V28Field _interactionActiveState;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _interactionActiveState = new HL7V28Field
        {
            field = message[@"ISD"][3],
            fieldData = fieldData
        };
        ...
        {
            _interactionActiveState.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_interactionActiveState, fieldData);
        }
