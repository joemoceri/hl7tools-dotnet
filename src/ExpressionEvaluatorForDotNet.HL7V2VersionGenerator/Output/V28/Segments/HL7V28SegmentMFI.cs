...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V28SegmentMFI
    {
        ...
        public HL7V28SegmentMFI(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V28Field _masterFileIdentifier;

public HL7V28Field MasterFileIdentifier
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _masterFileIdentifier = new HL7V28Field
        {
            field = message[@"MFI"][1],
            fieldData = fieldData
        };
        ...
        {
            _masterFileIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_masterFileIdentifier, fieldData);
        }
...
internal HL7V28Field _masterFileApplicationIdentifier;

public HL7V28Field MasterFileApplicationIdentifier
{
    get
    {
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _masterFileApplicationIdentifier = new HL7V28Field
        {
            field = message[@"MFI"][2],
            fieldData = fieldData
        };
        ...
        {
            _masterFileApplicationIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_masterFileApplicationIdentifier, fieldData);
        }
...
internal HL7V28Field _filelevelEventCode;

public HL7V28Field FilelevelEventCode
{
    get
    {
        ...
        _filelevelEventCode = new HL7V28Field
        {
            field = message[@"MFI"][3],
            fieldData = fieldData
        };
        ...
        {
            _filelevelEventCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_filelevelEventCode, fieldData);
        }
...
internal HL7V28Field _responseLevelCode;

public HL7V28Field ResponseLevelCode
{
    get
    {
        ...
        _responseLevelCode = new HL7V28Field
        {
            field = message[@"MFI"][6],
            fieldData = fieldData
        };
        ...
        {
            _responseLevelCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_responseLevelCode, fieldData);
        }
