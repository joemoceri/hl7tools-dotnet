...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        internal HL7V28Field masterFileIdentifier;
...
public HL7V28Field MasterFileIdentifier
{
    get
    {
        ...
        masterFileIdentifier = new HL7V28Field
        {
            field = message[@"MFI"][1],
            Id = @"MFI.1",
            Type = @"Field",
        ...
        if (masterFileIdentifier.field.FieldRepetitions != null && masterFileIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            masterFileIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(masterFileIdentifier, fieldData);
        }
...
internal HL7V28Field masterFileApplicationIdentifier;
...
public HL7V28Field MasterFileApplicationIdentifier
{
    get
    {
        ...
        masterFileApplicationIdentifier = new HL7V28Field
        {
            field = message[@"MFI"][2],
            Id = @"MFI.2",
            Type = @"Field",
        ...
        if (masterFileApplicationIdentifier.field.FieldRepetitions != null && masterFileApplicationIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            masterFileApplicationIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(masterFileApplicationIdentifier, fieldData);
        }
...
internal HL7V28Field filelevelEventCode;
...
public HL7V28Field FilelevelEventCode
{
    get
    {
        ...
        filelevelEventCode = new HL7V28Field
        {
            field = message[@"MFI"][3],
            Id = @"MFI.3",
            Type = @"Field",
        ...
        if (filelevelEventCode.field.FieldRepetitions != null && filelevelEventCode.field.FieldRepetitions.Count > 0)
        {
            ...
            filelevelEventCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(filelevelEventCode, fieldData);
        }
...
internal HL7V28Field responseLevelCode;
...
public HL7V28Field ResponseLevelCode
{
    get
    {
        ...
        responseLevelCode = new HL7V28Field
        {
            field = message[@"MFI"][6],
            Id = @"MFI.6",
            Type = @"Field",
        ...
        if (responseLevelCode.field.FieldRepetitions != null && responseLevelCode.field.FieldRepetitions.Count > 0)
        {
            ...
            responseLevelCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(responseLevelCode, fieldData);
        }
