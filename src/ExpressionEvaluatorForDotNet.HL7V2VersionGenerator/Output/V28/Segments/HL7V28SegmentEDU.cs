            ...
            get 
            {
                return new[]
                        ...
                        new HL7V2FieldData
                        {
                            ...
                            Description = @"This field contains the standard classification awarded upon completion of a unified program of study.  HL7 suggests using values in User-defined Table 0360 - Degree/License/Certificate.",
                            Sample = @"",
...
Value set version ID is required if CWE.21 is populated.",
        ...
        public HL7V28SegmentEDU(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V28Field setIdEdu;

public HL7V28Field SetIdEdu
{
    get
    {
        if (setIdEdu != null)
        ...
        if (setIdEdu.field.FieldRepetitions != null && setIdEdu.field.FieldRepetitions.Count > 0)
        {
            ...
            setIdEdu.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(setIdEdu, fieldData);
        }
...
internal HL7V28Field academicDegree;

public HL7V28Field AcademicDegree
{
    get
    {
        ...
        academicDegree = new HL7V28Field
        {
            field = message[@"EDU"][2],
            Id = @"EDU.2",
            Type = @"Field",
        ...
        if (academicDegree.field.FieldRepetitions != null && academicDegree.field.FieldRepetitions.Count > 0)
        {
            ...
            academicDegree.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(academicDegree, fieldData);
        }
...
internal HL7V28Field academicDegreeProgramDateRange;

public HL7V28Field AcademicDegreeProgramDateRange
{
    get
    {
        ...
        academicDegreeProgramDateRange = new HL7V28Field
        {
            field = message[@"EDU"][3],
            Id = @"EDU.3",
            Type = @"Field",
        ...
        if (academicDegreeProgramDateRange.field.FieldRepetitions != null && academicDegreeProgramDateRange.field.FieldRepetitions.Count > 0)
        {
            ...
            academicDegreeProgramDateRange.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(academicDegreeProgramDateRange, fieldData);
        }
...
internal HL7V28Field academicDegreeProgramParticipationDateRange;

public HL7V28Field AcademicDegreeProgramParticipationDateRange
{
    get
    {
        ...
        academicDegreeProgramParticipationDateRange = new HL7V28Field
        {
            field = message[@"EDU"][4],
            Id = @"EDU.4",
            Type = @"Field",
        ...
        if (academicDegreeProgramParticipationDateRange.field.FieldRepetitions != null && academicDegreeProgramParticipationDateRange.field.FieldRepetitions.Count > 0)
        {
            ...
            academicDegreeProgramParticipationDateRange.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(academicDegreeProgramParticipationDateRange, fieldData);
        }
...
internal HL7V28Field academicDegreeGrantedDate;

public HL7V28Field AcademicDegreeGrantedDate
{
    get
    {
        ...
        academicDegreeGrantedDate = new HL7V28Field
        {
            field = message[@"EDU"][5],
            Id = @"EDU.5",
            Type = @"Field",
        ...
        if (academicDegreeGrantedDate.field.FieldRepetitions != null && academicDegreeGrantedDate.field.FieldRepetitions.Count > 0)
        {
            ...
            academicDegreeGrantedDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(academicDegreeGrantedDate, fieldData);
        }
...
internal HL7V28Field school;

public HL7V28Field School
{
    get
    {
        if (school != null)
        ...
        if (school.field.FieldRepetitions != null && school.field.FieldRepetitions.Count > 0)
        {
            ...
            school.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(school, fieldData);
        }
...
internal HL7V28Field schoolTypeCode;

public HL7V28Field SchoolTypeCode
{
    get
    {
        ...
        schoolTypeCode = new HL7V28Field
        {
            field = message[@"EDU"][7],
            Id = @"EDU.7",
            Type = @"Field",
        ...
        if (schoolTypeCode.field.FieldRepetitions != null && schoolTypeCode.field.FieldRepetitions.Count > 0)
        {
            ...
            schoolTypeCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(schoolTypeCode, fieldData);
        }
...
internal HL7V28Field schoolAddress;

public HL7V28Field SchoolAddress
{
    get
    {
        ...
        if (schoolAddress.field.FieldRepetitions != null && schoolAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            schoolAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(schoolAddress, fieldData);
        }
...
internal HL7V28Field majorFieldOfStudy;

public HL7V28Field MajorFieldOfStudy
{
    get
    {
        ...
        majorFieldOfStudy = new HL7V28Field
        {
            field = message[@"EDU"][9],
            Id = @"EDU.9",
            Type = @"Field",
        ...
        if (majorFieldOfStudy.field.FieldRepetitions != null && majorFieldOfStudy.field.FieldRepetitions.Count > 0)
        {
            ...
            majorFieldOfStudy.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(majorFieldOfStudy, fieldData);
        }
