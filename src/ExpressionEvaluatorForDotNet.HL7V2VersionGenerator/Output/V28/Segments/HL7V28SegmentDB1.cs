...
public HL7V28Field SetIdDb1
{
    get
    {
        ...
        if (setIdDb1.field.FieldRepetitions != null && setIdDb1.field.FieldRepetitions.Count > 0)
        {
            ...
            setIdDb1.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(setIdDb1, fieldData);
        }
...
internal HL7V28Field disabledPersonCode;
...
public HL7V28Field DisabledPersonCode
{
    get
    {
        ...
        disabledPersonCode = new HL7V28Field
        {
            field = message[@"DB1"][2],
            Id = @"DB1.2",
            Type = @"Field",
        ...
        if (disabledPersonCode.field.FieldRepetitions != null && disabledPersonCode.field.FieldRepetitions.Count > 0)
        {
            ...
            disabledPersonCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(disabledPersonCode, fieldData);
        }
...
internal HL7V28Field disabledPersonIdentifier;
...
public HL7V28Field DisabledPersonIdentifier
{
    get
    {
        ...
        disabledPersonIdentifier = new HL7V28Field
        {
            field = message[@"DB1"][3],
            Id = @"DB1.3",
            Type = @"Field",
        ...
        if (disabledPersonIdentifier.field.FieldRepetitions != null && disabledPersonIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            disabledPersonIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(disabledPersonIdentifier, fieldData);
        }
...
internal HL7V28Field disabilityIndicator;
...
public HL7V28Field DisabilityIndicator
{
    get
    {
        ...
        disabilityIndicator = new HL7V28Field
        {
            field = message[@"DB1"][4],
            Id = @"DB1.4",
            Type = @"Field",
...
N - not a disability visit",
        ...
        if (disabilityIndicator.field.FieldRepetitions != null && disabilityIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            disabilityIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(disabilityIndicator, fieldData);
        }
...
internal HL7V28Field disabilityStartDate;
...
public HL7V28Field DisabilityStartDate
{
    get
    {
        ...
        disabilityStartDate = new HL7V28Field
        {
            field = message[@"DB1"][5],
            Id = @"DB1.5",
            Type = @"Field",
        ...
        if (disabilityStartDate.field.FieldRepetitions != null && disabilityStartDate.field.FieldRepetitions.Count > 0)
        {
            ...
            disabilityStartDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(disabilityStartDate, fieldData);
        }
...
internal HL7V28Field disabilityEndDate;
...
public HL7V28Field DisabilityEndDate
{
    get
    {
        ...
        disabilityEndDate = new HL7V28Field
        {
            field = message[@"DB1"][6],
            Id = @"DB1.6",
            Type = @"Field",
        ...
        if (disabilityEndDate.field.FieldRepetitions != null && disabilityEndDate.field.FieldRepetitions.Count > 0)
        {
            ...
            disabilityEndDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(disabilityEndDate, fieldData);
        }
...
internal HL7V28Field disabilityReturnToWorkDate;
...
public HL7V28Field DisabilityReturnToWorkDate
{
    get
    {
        ...
        disabilityReturnToWorkDate = new HL7V28Field
        {
            field = message[@"DB1"][7],
            Id = @"DB1.7",
            Type = @"Field",
        ...
        if (disabilityReturnToWorkDate.field.FieldRepetitions != null && disabilityReturnToWorkDate.field.FieldRepetitions.Count > 0)
        {
            ...
            disabilityReturnToWorkDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(disabilityReturnToWorkDate, fieldData);
        }
...
internal HL7V28Field disabilityUnableToWorkDate;
...
public HL7V28Field DisabilityUnableToWorkDate
{
    get
    {
        ...
        disabilityUnableToWorkDate = new HL7V28Field
        {
            field = message[@"DB1"][8],
            Id = @"DB1.8",
            Type = @"Field",
        ...
        if (disabilityUnableToWorkDate.field.FieldRepetitions != null && disabilityUnableToWorkDate.field.FieldRepetitions.Count > 0)
        {
            ...
            disabilityUnableToWorkDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(disabilityUnableToWorkDate, fieldData);
        }
