...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V28SegmentLDP
    {
        ...
        public HL7V28SegmentLDP(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V28Field _primaryKeyValueLdp;

public HL7V28Field PrimaryKeyValueLdp
{
    get
    {
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _primaryKeyValueLdp = new HL7V28Field
        {
            field = message[@"LDP"][1],
            fieldData = fieldData
        };
        ...
        {
            _primaryKeyValueLdp.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_primaryKeyValueLdp, fieldData);
        }
...
internal HL7V28Field _locationDepartment;

public HL7V28Field LocationDepartment
{
    get
    {
        ...
        var fieldData = new HL7V28FieldData
        {
            ...
            Description = @"This field contains the institution's department to which this location belongs, or its cost center. Refer to User-defined Table 0264 - Location Department in Chapter 2C, Code Tables, for suggested values.",
            Sample = @"",
            Fields = new[]
                        {
                            new HL7V2FieldData
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _locationDepartment = new HL7V28Field
        {
            field = message[@"LDP"][2],
            fieldData = fieldData
        };
        ...
        {
            _locationDepartment.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_locationDepartment, fieldData);
        }
...
internal HL7V28Field _locationService;

public HL7V28Field LocationService
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _locationService = new HL7V28Field
        {
            field = message[@"LDP"][3],
            fieldData = fieldData
        };
        ...
        {
            _locationService.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_locationService, fieldData);
        }
...
internal HL7V28Field _specialtyType;

public HL7V28Field SpecialtyType
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _specialtyType = new HL7V28Field
        {
            field = message[@"LDP"][4],
            fieldData = fieldData
        };
        ...
        {
            _specialtyType.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_specialtyType, fieldData);
        }
...
internal HL7V28Field _validPatientClasses;

public HL7V28Field ValidPatientClasses
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _validPatientClasses = new HL7V28Field
        {
            field = message[@"LDP"][5],
            fieldData = fieldData
        };
        ...
        {
            _validPatientClasses.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_validPatientClasses, fieldData);
        }
...
internal HL7V28Field _activeInactiveFlag;
...
public HL7V28Field ActiveInactiveFlag
{
    get
    {
        ...
        var fieldData = new HL7V28FieldData
        {
            ...
            Description = @"This field indicates whether the entry for this location is currently an active, that is, valid, usable entry (disregarding whether it's waiting to be maintained by housekeeping).  Refer to HL7 Table 0183 - Active/Inactive in Chapter 2C, Code Tables, for valid values. ",
            Sample = @"",
            Fields = null
        }

        _activeInactiveFlag = new HL7V28Field
        {
            field = message[@"LDP"][6],
            fieldData = fieldData
        };
        ...
        {
            _activeInactiveFlag.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_activeInactiveFlag, fieldData);
        }
...
internal HL7V28Field _activationDateLdp;

public HL7V28Field ActivationDateLdp
{
    get
    {
        ...
        _activationDateLdp = new HL7V28Field
        {
            field = message[@"LDP"][7],
            fieldData = fieldData
        };
        ...
        {
            _activationDateLdp.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_activationDateLdp, fieldData);
        }
...
internal HL7V28Field _inactivationDateLdp;

public HL7V28Field InactivationDateLdp
{
    get
    {
        ...
        _inactivationDateLdp = new HL7V28Field
        {
            field = message[@"LDP"][8],
            fieldData = fieldData
        };
        ...
        {
            _inactivationDateLdp.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_inactivationDateLdp, fieldData);
        }
...
internal HL7V28Field _inactivatedReason;

public HL7V28Field InactivatedReason
{
    get
    {
        ...
        _inactivatedReason = new HL7V28Field
        {
            field = message[@"LDP"][9],
            fieldData = fieldData
        };
        ...
        {
            _inactivatedReason.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_inactivatedReason, fieldData);
        }
...
internal HL7V28Field _visitingHours;

public HL7V28Field VisitingHours
{
    get
    {
        ...
        var fieldData = new HL7V28FieldData
        {
            ...
            TableId = null,
            TableName = null,
            Description = @"This field contains the hours when this location is open for visiting.  Refer to HL7 Table 0267 - Days of the Week in Chapter 2C, Code Tables, for valid values for the first two components.",
            Sample = @"",
            Fields = new[]
                        {
                            new HL7V2FieldData
                        ...
                        new HL7V2FieldData
                        {
                            ...
                            TableId = null,
                            TableName = null,
                            Description = @"Starting hour on starting day of visiting hours range. See first component, 2.A.81.1, ""Start Day Range (ID)"".",
                            Sample = @"",
                            FieldDatas = null
                        },
        ...
        _visitingHours = new HL7V28Field
        {
        ...
        {
            _visitingHours.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_visitingHours, fieldData);
        }
...
internal HL7V28Field _contactPhone;

public HL7V28Field ContactPhone
{
    get
    {
...
Preference order numbers need not be sequential (i.e., three numbers with the priority orders of 0, 5 and 15 are legitimate).  The preference order numbers must be non-negative.",
        ...
        {
            _contactPhone.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_contactPhone, fieldData);
        }
...
internal HL7V28Field _locationCostCenter;

public HL7V28Field LocationCostCenter
{
    get
    {
        ...
        var fieldData = new HL7V28FieldData
        {
            ...
            Description = @"This field contains the cost center to which this location belongs. Refer to User-defined Table 0462 - Location Cost Center in Chapter 2C, Code Tables, for suggested values.",
            Sample = @"",
            Fields = new[]
                        {
                            new HL7V2FieldData
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _locationCostCenter = new HL7V28Field
        {
        ...
        {
            _locationCostCenter.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_locationCostCenter, fieldData);
        }
