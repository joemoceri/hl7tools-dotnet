...
j) scopolamine, xxx mg, 1 hour before surgery. Relative time = -1^hour, priority = P (preop), or alternately repeat pattern = P1H^Preop, 1 Hour before Surgery^99LocalCode, Relative time would be empty and priority would be P (preop)."; } }
        ...
        internal HL7V28Field _setIdTq1;
...
public HL7V28Field SetIdTq1
{
    get
    {
        ...
        {
            _setIdTq1.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_setIdTq1, fieldData);
        }
...
internal HL7V28Field _quantity;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _quantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_quantity, fieldData);
        }
...
internal HL7V28Field _repeatPattern;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _repeatPattern = new HL7V28Field
        {
            field = message[@"TQ1"][3],
            fieldData = fieldData
        };
        ...
        {
            _repeatPattern.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_repeatPattern, fieldData);
        }
...
internal HL7V28Field _explicitTime;
...
Usage Note: This field is not valued if a Repeat Pattern is not present.",
        ...
        {
            _explicitTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_explicitTime, fieldData);
        }
...
internal HL7V28Field _relativeTimeAndUnits;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _relativeTimeAndUnits = new HL7V28Field
        {
            field = message[@"TQ1"][5],
            fieldData = fieldData
        };
        ...
        {
            _relativeTimeAndUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_relativeTimeAndUnits, fieldData);
        }
...
internal HL7V28Field _serviceDuration;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _serviceDuration = new HL7V28Field
        {
            field = message[@"TQ1"][6],
            fieldData = fieldData
        };
        ...
        {
            _serviceDuration.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_serviceDuration, fieldData);
        }
...
internal HL7V28Field _endDateTime;
...
Regardless of the value of the end date/time, the service should be stopped at the earliest of the date/times specified by either the duration or the end date/time.",
        ...
        {
            _endDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_endDateTime, fieldData);
        }
...
internal HL7V28Field _priority;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _priority.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_priority, fieldData);
        }
...
internal HL7V28Field _conditionText;
...
For complex codified conditions see the TQ2 segment below.",
        ...
        _conditionText = new HL7V28Field
        {
        ...
        {
            _conditionText.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_conditionText, fieldData);
        }
...
internal HL7V28Field _textInstruction;
...
public HL7V28Field TextInstruction
{
    get
    {
        ...
        _textInstruction = new HL7V28Field
        {
        ...
        {
            _textInstruction.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_textInstruction, fieldData);
        }
...
internal HL7V28Field _conjunction;
...
Condition Rule: If the TQ1 segment is repeated in the message, this field must be populated with the appropriate Conjunction code indicating the sequencing of the following TQ1 segment.",
        ...
        {
            _conjunction.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_conjunction, fieldData);
        }
...
internal HL7V28Field _occurrenceDuration;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _occurrenceDuration = new HL7V28Field
        {
        ...
        {
            _occurrenceDuration.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_occurrenceDuration, fieldData);
        }
...
internal HL7V28Field _totalOccurrences;
...
TQ1|1||TID|||3^d&&ANS+||||||20^min&&ANS+|9<cr>",
        ...
        _totalOccurrences = new HL7V28Field
        {
        ...
        {
            _totalOccurrences.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_totalOccurrences, fieldData);
        }
