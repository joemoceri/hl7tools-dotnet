...
The assigning authority, the fourth component of the patient identifiers, is an HD data type that is uniquely associated with the assigning authority that originally assigned the number. A given institution, or group of intercommunicating institutions, should establish a list of assigning authorities that may be potential assignors of patient identification (and other important identification) numbers. The list will be one of the institution's master dictionary lists. Since third parties (other than the assignors of patient identification numbers) may send or receive HL7 messages containing patient identification numbers, the assigning authority in the patient identification numbers may not be the same as those of the sending and receiving systems identified in the MSH. The assigning authority must be unique across applications at a given site. This field is required in HL7 implementations that have more than a single Patient Administration application assigning such numbers."; } }
        ...
        internal HL7V28Field _priorPatientIdentifierList;
...
Refer to HL7 Table 0904 - Security Check Scheme for valid values.",
        ...
        _priorPatientIdentifierList = new HL7V28Field
        {
            field = message[@"MRG"][1],
            fieldData = fieldData
        };
        ...
        {
            _priorPatientIdentifierList.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_priorPatientIdentifierList, fieldData);
        }
...
internal HL7V28Field _priorAlternatePatientId;
...
public HL7V28Field PriorAlternatePatientId
{
    get
    {
        ...
        _priorAlternatePatientId = new HL7V28Field
        {
            field = message[@"MRG"][2],
            fieldData = fieldData
        };
        ...
        {
            _priorAlternatePatientId.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_priorAlternatePatientId, fieldData);
        }
...
internal HL7V28Field _priorPatientAccountNumber;
...
Refer to HL7 Table 0904 - Security Check Scheme for valid values.",
        ...
        _priorPatientAccountNumber = new HL7V28Field
        {
            field = message[@"MRG"][3],
            fieldData = fieldData
        };
        ...
        {
            _priorPatientAccountNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_priorPatientAccountNumber, fieldData);
        }
...
internal HL7V28Field _priorPatientId;
...
public HL7V28Field PriorPatientId
{
    get
    {
        ...
        _priorPatientId = new HL7V28Field
        {
            field = message[@"MRG"][4],
            fieldData = fieldData
        };
        ...
        {
            _priorPatientId.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_priorPatientId, fieldData);
        }
...
internal HL7V28Field _priorVisitNumber;
...
Refer to HL7 Table 0904 - Security Check Scheme for valid values.",
        ...
        _priorVisitNumber = new HL7V28Field
        {
            field = message[@"MRG"][5],
            fieldData = fieldData
        };
        ...
        {
            _priorVisitNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_priorVisitNumber, fieldData);
        }
...
internal HL7V28Field _priorAlternateVisitId;
...
Refer to HL7 Table 0904 - Security Check Scheme for valid values.",
        ...
        _priorAlternateVisitId = new HL7V28Field
        {
            field = message[@"MRG"][6],
            fieldData = fieldData
        };
        ...
        {
            _priorAlternateVisitId.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_priorAlternateVisitId, fieldData);
        }
...
internal HL7V28Field _priorPatientName;
...
Examples:
 ...
 - Mary Margaret Elizabeth Jones is Called By Meg.",
        ...
        _priorPatientName = new HL7V28Field
        {
            field = message[@"MRG"][7],
            fieldData = fieldData
        };
        ...
        {
            _priorPatientName.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_priorPatientName, fieldData);
        }
