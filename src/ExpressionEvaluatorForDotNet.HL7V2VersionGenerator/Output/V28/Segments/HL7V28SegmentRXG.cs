...
If the RXG segment carries information about multiple administrations, this field's value is zero (0), since in this case a one-to-one matching with the RXA segment is ambiguous.",
        ...
        if (giveSubidCounter.field.FieldRepetitions != null && giveSubidCounter.field.FieldRepetitions.Count > 0)
        {
            ...
            giveSubidCounter.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(giveSubidCounter, fieldData);
        }
...
Note: The contents of fields 3-8 should be identical to the comparable fields in the RXE (RXE-2 thru 5).",
        ...
        if (quantityTiming.field.FieldRepetitions != null && quantityTiming.field.FieldRepetitions.Count > 0)
        {
            ...
            quantityTiming.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(quantityTiming, fieldData);
        }
...
public HL7V28Field GiveCode
{
    get
    {
        ...
        if (giveCode.field.FieldRepetitions != null && giveCode.field.FieldRepetitions.Count > 0)
        {
            ...
            giveCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(giveCode, fieldData);
        }
...
Another way to say this is that, for pharmacy/treatment orders, the quantity component of the quantity/timing field refers to what is to be given out at each service interval; and thus, in terms of the RX order, that first component always defaults to 1. Hence, in the actual execution of the order, the value of 1 in the first component of the quantity/timing field always refers to one administration of the amount specified in this field (the requested Give Amount field).",
        ...
        if (giveAmountMinimum.field.FieldRepetitions != null && giveAmountMinimum.field.FieldRepetitions.Count > 0)
        {
            ...
            giveAmountMinimum.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(giveAmountMinimum, fieldData);
        }
...
public HL7V28Field GiveAmountMaximum
{
    get
    {
        ...
        if (giveAmountMaximum.field.FieldRepetitions != null && giveAmountMaximum.field.FieldRepetitions.Count > 0)
        {
            ...
            giveAmountMaximum.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(giveAmountMaximum, fieldData);
        }
...
Note: These units can be a ""compound quantity;"" i.e., the units may contain the word ""per."" For example, micrograms per KG (micg/kg) is an acceptable value, which means that the units are micrograms per KG (of body weight).",
        ...
        if (giveUnits.field.FieldRepetitions != null && giveUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            giveUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(giveUnits, fieldData);
        }
...
public HL7V28Field GiveDosageForm
{
    get
    {
        ...
        if (giveDosageForm.field.FieldRepetitions != null && giveDosageForm.field.FieldRepetitions.Count > 0)
        {
            ...
            giveDosageForm.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(giveDosageForm, fieldData);
        }
...
public HL7V28Field AdministrationNotes
{
    get
    {
        ...
        if (administrationNotes.field.FieldRepetitions != null && administrationNotes.field.FieldRepetitions.Count > 0)
        {
            ...
            administrationNotes.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(administrationNotes, fieldData);
        }
...
public HL7V28Field PharmacyTreatmentSuppliersSpecialAdministrationInstructions
{
    get
    {
        ...
        if (pharmacyTreatmentSuppliersSpecialAdministrationInstructions.field.FieldRepetitions != null && pharmacyTreatmentSuppliersSpecialAdministrationInstructions.field.FieldRepetitions.Count > 0)
        {
            ...
            pharmacyTreatmentSuppliersSpecialAdministrationInstructions.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(pharmacyTreatmentSuppliersSpecialAdministrationInstructions, fieldData);
        }
...
Required when relevant (e.g., certain IVs). For example, if the ""give amount/units"" were 300 ml and the ""give per"" time unit were H1 (equivalent to one hour), the rate is 300ml/hr.",
        ...
        if (givePertimeUnit.field.FieldRepetitions != null && givePertimeUnit.field.FieldRepetitions.Count > 0)
        {
            ...
            givePertimeUnit.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(givePertimeUnit, fieldData);
        }
...
public HL7V28Field GiveRateAmount
{
    get
    {
        ...
        if (giveRateAmount.field.FieldRepetitions != null && giveRateAmount.field.FieldRepetitions.Count > 0)
        {
            ...
            giveRateAmount.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(giveRateAmount, fieldData);
        }
...
public HL7V28Field GiveRateUnits
{
    get
    {
        ...
        if (giveRateUnits.field.FieldRepetitions != null && giveRateUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            giveRateUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(giveRateUnits, fieldData);
        }
...
public HL7V28Field GiveStrength
{
    get
    {
        ...
        if (giveStrength.field.FieldRepetitions != null && giveStrength.field.FieldRepetitions.Count > 0)
        {
            ...
            giveStrength.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(giveStrength, fieldData);
        }
...
Note: These units can be a ""compound quantity""; i.e., the units may express a quantity per unit of time. For example, micrograms per hour (micg/h) is an acceptable value. These compound units are contained in the ISO+ table. See Chapter 7 for full definition of ISO+ units.",
        ...
        if (giveStrengthUnits.field.FieldRepetitions != null && giveStrengthUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            giveStrengthUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(giveStrengthUnits, fieldData);
        }
...
RXG|||||||||||||||||120|mg^^ISO|||||5|ml^^ISO ...<cr>",
        ...
        if (giveDrugStrengthVolume.field.FieldRepetitions != null && giveDrugStrengthVolume.field.FieldRepetitions.Count > 0)
        {
            ...
            giveDrugStrengthVolume.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(giveDrugStrengthVolume, fieldData);
        }
...
public HL7V28Field GiveDrugStrengthVolumeUnits
{
    get
    {
        ...
        if (giveDrugStrengthVolumeUnits.field.FieldRepetitions != null && giveDrugStrengthVolumeUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            giveDrugStrengthVolumeUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(giveDrugStrengthVolumeUnits, fieldData);
        }
...
12345678901^IV bottle^3X9",
        ...
        if (giveBarcodeIdentifier.field.FieldRepetitions != null && giveBarcodeIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            giveBarcodeIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(giveBarcodeIdentifier, fieldData);
        }
...
public HL7V28Field DelivertoPatientLocation
{
    get
    {
        ...
        if (delivertoPatientLocation.field.FieldRepetitions != null && delivertoPatientLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            delivertoPatientLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(delivertoPatientLocation, fieldData);
        }
...
public HL7V28Field DelivertoAddress
{
    get
    {
        ...
        if (delivertoAddress.field.FieldRepetitions != null && delivertoAddress.field.FieldRepetitions.Count > 0)
        {
            ...
            delivertoAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(delivertoAddress, fieldData);
        }
...
This differs from RXG-25 Give Barcode Identifier in that RXG-25 may include other workflow content or the product at various levels of granularity.  RXG-31 specifically identifies the product instance.",
        ...
        if (giveTagIdentifier.field.FieldRepetitions != null && giveTagIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            giveTagIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(giveTagIdentifier, fieldData);
        }
...
public HL7V28Field DispenseAmount
{
    get
    {
        ...
        if (dispenseAmount.field.FieldRepetitions != null && dispenseAmount.field.FieldRepetitions.Count > 0)
        {
            ...
            dispenseAmount.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(dispenseAmount, fieldData);
        }
...
public HL7V28Field DispenseUnits
{
    get
    {
        ...
        if (dispenseUnits.field.FieldRepetitions != null && dispenseUnits.field.FieldRepetitions.Count > 0)
        {
            ...
            dispenseUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(dispenseUnits, fieldData);
        }
