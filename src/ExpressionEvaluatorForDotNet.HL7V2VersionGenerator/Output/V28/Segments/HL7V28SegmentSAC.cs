...
internal HL7V28Field primaryparentContainerIdentifier;

public HL7V28Field PrimaryparentContainerIdentifier
{
    get
    {
        ...
        primaryparentContainerIdentifier = new HL7V28Field
        {
            field = message[@"SAC"][4],
            Id = @"SAC.4",
            Type = @"Field",
