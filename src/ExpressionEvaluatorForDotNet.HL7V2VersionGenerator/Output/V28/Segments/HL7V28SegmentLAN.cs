...
public HL7V28Field SetIdLan
{
    get
    {
        ...
        if (setIdLan.field.FieldRepetitions != null && setIdLan.field.FieldRepetitions.Count > 0)
        {
            ...
            setIdLan.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(setIdLan, fieldData);
        }
...
internal HL7V28Field languageCode;
...
public HL7V28Field LanguageCode
{
    get
    {
        ...
        if (languageCode.field.FieldRepetitions != null && languageCode.field.FieldRepetitions.Count > 0)
        {
            ...
            languageCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(languageCode, fieldData);
        }
...
internal HL7V28Field languageAbilityCode;
...
public HL7V28Field LanguageAbilityCode
{
    get
    {
        ...
        languageAbilityCode = new HL7V28Field
        {
            field = message[@"LAN"][3],
            Id = @"LAN.3",
            Type = @"Field",
        ...
        if (languageAbilityCode.field.FieldRepetitions != null && languageAbilityCode.field.FieldRepetitions.Count > 0)
        {
            ...
            languageAbilityCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(languageAbilityCode, fieldData);
        }
...
internal HL7V28Field languageProficiencyCode;
...
public HL7V28Field LanguageProficiencyCode
{
    get
    {
        ...
        languageProficiencyCode = new HL7V28Field
        {
            field = message[@"LAN"][4],
            Id = @"LAN.4",
            Type = @"Field",
        ...
        if (languageProficiencyCode.field.FieldRepetitions != null && languageProficiencyCode.field.FieldRepetitions.Count > 0)
        {
            ...
            languageProficiencyCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(languageProficiencyCode, fieldData);
        }
