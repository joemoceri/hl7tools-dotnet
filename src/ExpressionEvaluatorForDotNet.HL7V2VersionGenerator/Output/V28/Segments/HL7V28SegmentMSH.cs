...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V28SegmentMSH
    {
        ...
        internal HL7V28Field _fieldSeparator;
...
public HL7V28Field FieldSeparator
{
    get
    {
        ...
        _fieldSeparator = new HL7V28Field
        {
            field = message[@"MSH"][1],
            fieldData = fieldData
        };
        ...
        {
            _fieldSeparator.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_fieldSeparator, fieldData);
        }
...
internal HL7V28Field _encodingCharacters;
...
public HL7V28Field EncodingCharacters
{
    get
    {
        ...
        _encodingCharacters = new HL7V28Field
        {
            field = message[@"MSH"][2],
            fieldData = fieldData
        };
        ...
        {
            _encodingCharacters.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_encodingCharacters, fieldData);
        }
...
internal HL7V28Field _sendingApplication;
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _sendingApplication = new HL7V28Field
        {
            field = message[@"MSH"][3],
            fieldData = fieldData
        };
        ...
        {
            _sendingApplication.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_sendingApplication, fieldData);
        }
...
internal HL7V28Field _sendingFacility;
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _sendingFacility = new HL7V28Field
        {
            field = message[@"MSH"][4],
            fieldData = fieldData
        };
        ...
        {
            _sendingFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_sendingFacility, fieldData);
        }
...
internal HL7V28Field _receivingApplication;
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _receivingApplication = new HL7V28Field
        {
            field = message[@"MSH"][5],
            fieldData = fieldData
        };
        ...
        {
            _receivingApplication.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_receivingApplication, fieldData);
        }
...
internal HL7V28Field _receivingFacility;
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _receivingFacility = new HL7V28Field
        {
            field = message[@"MSH"][6],
            fieldData = fieldData
        };
        ...
        {
            _receivingFacility.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_receivingFacility, fieldData);
        }
...
internal HL7V28Field _dateTimeOfMessage;
...
Note: This field was made required in version 2.4. Messages with versions prior to 2.4 are not required to value this field. This usage supports backward compatibility.",
        ...
        _dateTimeOfMessage = new HL7V28Field
        {
            field = message[@"MSH"][7],
            fieldData = fieldData
        };
        ...
        {
            _dateTimeOfMessage.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_dateTimeOfMessage, fieldData);
        }
...
internal HL7V28Field _security;
...
public HL7V28Field Security
{
    get
    {
        ...
        {
            _security.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_security, fieldData);
        }
...
internal HL7V28Field _messageType;
...
This table contains values like A01, O01, R01 etc",
        ...
        {
            _messageType.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_messageType, fieldData);
        }
...
internal HL7V28Field _processingId;
...
public HL7V28Field ProcessingId
{
    get
    {
        ...
        {
            _processingId.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_processingId, fieldData);
        }
...
internal HL7V28Field _versionId;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _versionId.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_versionId, fieldData);
        }
...
internal HL7V28Field _sequenceNumber;
...
public HL7V28Field SequenceNumber
{
    get
    {
        ...
        _sequenceNumber = new HL7V28Field
        {
        ...
        {
            _sequenceNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_sequenceNumber, fieldData);
        }
...
internal HL7V28Field _acceptAcknowledgmentType;
...
public HL7V28Field AcceptAcknowledgmentType
{
    get
    {
        ...
        _acceptAcknowledgmentType = new HL7V28Field
        {
        ...
        {
            _acceptAcknowledgmentType.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_acceptAcknowledgmentType, fieldData);
        }
...
internal HL7V28Field _applicationAcknowledgmentType;
...
If MSH-15-accept acknowledgment type and MSH-16-application acknowledgment type are omitted (or are both null), the original acknowledgment mode rules are used.",
        ...
        _applicationAcknowledgmentType = new HL7V28Field
        {
        ...
        {
            _applicationAcknowledgmentType.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_applicationAcknowledgmentType, fieldData);
        }
...
internal HL7V28Field _countryCode;
...
Refer to External Table 0399 - Country Code for the 3-character codes as defined by ISO 3166-1.",
        ...
        {
            _countryCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_countryCode, fieldData);
        }
...
internal HL7V28Field _characterSet;
...
Note: When describing encoding rules, this standard always speaks in terms of character position, not byte offset. Similarly, comparisons should be done on character values, not their byte equivalents. For this reason, delimiter characters should always have representation in the standard 7-bit ASCII character set, regardless of the actual character set being used, so that a search for the character CR (carriage return) can be performed.
   ...
   c) elements in the remainder of the sequence (i.e., elements 2..n) are alternate character sets that may be used.",
        ...
        {
            _characterSet.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_characterSet, fieldData);
        }
...
internal HL7V28Field _principalLanguageOfMessage;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _principalLanguageOfMessage = new HL7V28Field
        {
        ...
        {
            _principalLanguageOfMessage.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_principalLanguageOfMessage, fieldData);
        }
...
internal HL7V28Field _alternateCharacterSetHandlingScheme;
...
public HL7V28Field AlternateCharacterSetHandlingScheme
{
    get
    {
        ...
        _alternateCharacterSetHandlingScheme = new HL7V28Field
        {
        ...
        {
            _alternateCharacterSetHandlingScheme.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_alternateCharacterSetHandlingScheme, fieldData);
        }
...
internal HL7V28Field _messageProfileIdentifier;
...
By site agreement, implementers may continue to use User-defined Table 0300 – Namespace ID for the first component",
        ...
        _messageProfileIdentifier = new HL7V28Field
        {
        ...
        {
            _messageProfileIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_messageProfileIdentifier, fieldData);
        }
...
internal HL7V28Field _sendingResponsibleOrganization;
...
Note: The check digit and code identifying check digit scheme are null if Organization identifier is alphanumeric.",
        ...
        _sendingResponsibleOrganization = new HL7V28Field
        {
        ...
        {
            _sendingResponsibleOrganization.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_sendingResponsibleOrganization, fieldData);
        }
...
internal HL7V28Field _receivingResponsibleOrganization;
...
Note: The check digit and code identifying check digit scheme are null if Organization identifier is alphanumeric.",
        ...
        _receivingResponsibleOrganization = new HL7V28Field
        {
        ...
        {
            _receivingResponsibleOrganization.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_receivingResponsibleOrganization, fieldData);
        }
...
internal HL7V28Field _sendingNetworkAddress;
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _sendingNetworkAddress = new HL7V28Field
        {
        ...
        {
            _sendingNetworkAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_sendingNetworkAddress, fieldData);
        }
...
internal HL7V28Field _receivingNetworkAddress;
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _receivingNetworkAddress = new HL7V28Field
        {
        ...
        {
            _receivingNetworkAddress.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_receivingNetworkAddress, fieldData);
        }
