...
internal HL7V28Field presentOnAdmission(poa)Indicator;

public HL7V28Field PresentOnAdmission(poa)Indicator
{
    get
    {
        ...
        presentOnAdmission(poa)Indicator = new HL7V28Field
        {
