...
Value set version ID is required if CWE.21 is populated.",
        ...
        internal HL7V28Field contactRole;
...
public HL7V28Field ContactRole
{
    get
    {
        ...
        if (contactRole.field.FieldRepetitions != null && contactRole.field.FieldRepetitions.Count > 0)
        {
            ...
            contactRole.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(contactRole, fieldData);
        }
...
internal HL7V28Field contactName;
...
public HL7V28Field ContactName
{
    get
    {
        ...
        if (contactName.field.FieldRepetitions != null && contactName.field.FieldRepetitions.Count > 0)
        {
            ...
            contactName.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(contactName, fieldData);
        }
...
internal HL7V28Field contactLocation;
...
public HL7V28Field ContactLocation
{
    get
    {
        ...
        contactLocation = new HL7V28Field
        {
            field = message[@"CTD"][4],
            Id = @"CTD.4",
            Type = @"Field",
        ...
        if (contactLocation.field.FieldRepetitions != null && contactLocation.field.FieldRepetitions.Count > 0)
        {
            ...
            contactLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(contactLocation, fieldData);
        }
...
internal HL7V28Field contactCommunicationInformation;
...
public HL7V28Field ContactCommunicationInformation
{
    get
    {
        ...
        contactCommunicationInformation = new HL7V28Field
        {
            field = message[@"CTD"][5],
            Id = @"CTD.5",
            Type = @"Field",
        ...
        if (contactCommunicationInformation.field.FieldRepetitions != null && contactCommunicationInformation.field.FieldRepetitions.Count > 0)
        {
            ...
            contactCommunicationInformation.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(contactCommunicationInformation, fieldData);
        }
...
internal HL7V28Field contactIdentifiers;
...
public HL7V28Field ContactIdentifiers
{
    get
    {
        ...
        contactIdentifiers = new HL7V28Field
        {
            field = message[@"CTD"][7],
            Id = @"CTD.7",
            Type = @"Field",
        ...
        if (contactIdentifiers.field.FieldRepetitions != null && contactIdentifiers.field.FieldRepetitions.Count > 0)
        {
            ...
            contactIdentifiers.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(contactIdentifiers, fieldData);
        }
