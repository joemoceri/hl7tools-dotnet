...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V28SegmentEQP
    {
        ...
        internal HL7V28Field _eventType;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _eventType.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_eventType, fieldData);
        }
...
internal HL7V28Field _fileName;
...
public HL7V28Field FileName
{
    get
    {
        ...
        {
            _fileName.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_fileName, fieldData);
        }
...
internal HL7V28Field _transactionData;
...
public HL7V28Field TransactionData
{
    get
    {
        ...
        _transactionData = new HL7V28Field
        {
            field = message[@"EQP"][5],
            fieldData = fieldData
        };
        ...
        {
            _transactionData.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_transactionData, fieldData);
        }
