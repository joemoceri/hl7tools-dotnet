...
public HL7V28Field QueryPriority
{
    get
    {
        ...
        if (queryPriority.field.FieldRepetitions != null && queryPriority.field.FieldRepetitions.Count > 0)
        {
            ...
            queryPriority.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(queryPriority, fieldData);
        }
...
Refer to HL7 Table 0126 - Quantity limited request in Chapter 2C, Code Tables, for valid entries for the second component.  In a segment pattern response, a line is defined as a single segment. ",
        ...
        if (quantityLimitedRequest.field.FieldRepetitions != null && quantityLimitedRequest.field.FieldRepetitions.Count > 0)
        {
            ...
            quantityLimitedRequest.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(quantityLimitedRequest, fieldData);
        }
...
public HL7V28Field ResponseModality
{
    get
    {
        ...
        if (responseModality.field.FieldRepetitions != null && responseModality.field.FieldRepetitions.Count > 0)
        {
            ...
            responseModality.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(responseModality, fieldData);
        }
...
public HL7V28Field ExecutionAndDeliveryTime
{
    get
    {
        ...
        if (executionAndDeliveryTime.field.FieldRepetitions != null && executionAndDeliveryTime.field.FieldRepetitions.Count > 0)
        {
            ...
            executionAndDeliveryTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(executionAndDeliveryTime, fieldData);
        }
...
public HL7V28Field ModifyIndicator
{
    get
    {
        ...
        if (modifyIndicator.field.FieldRepetitions != null && modifyIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            modifyIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(modifyIndicator, fieldData);
        }
...
Each repetition of this field specifies a single sort field.  Thus, the first repetition of this field specifies the primary sort field; the second repetition specifies the secondary sort field; etc.",
        ...
        if (sortbyField.field.FieldRepetitions != null && sortbyField.field.FieldRepetitions.Count > 0)
        {
            ...
            sortbyField.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(sortbyField, fieldData);
        }
...
public HL7V28Field SegmentGroupInclusion
{
    get
    {
        ...
        if (segmentGroupInclusion.field.FieldRepetitions != null && segmentGroupInclusion.field.FieldRepetitions.Count > 0)
        {
            ...
            segmentGroupInclusion.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(segmentGroupInclusion, fieldData);
        }
