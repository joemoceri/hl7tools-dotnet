...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V28SegmentRFI
    {
        ...
        public HL7V28SegmentRFI(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V28Field _requestDate;

public HL7V28Field RequestDate
{
    get
    {
        ...
        {
            _requestDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_requestDate, fieldData);
        }
...
internal HL7V28Field _responseDueDate;

public HL7V28Field ResponseDueDate
{
    get
    {
        ...
        _responseDueDate = new HL7V28Field
        {
            field = message[@"RFI"][2],
            fieldData = fieldData
        };
        ...
        {
            _responseDueDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_responseDueDate, fieldData);
        }
...
internal HL7V28Field _patientConsent;

public HL7V28Field PatientConsent
{
    get
    {
        ...
        _patientConsent = new HL7V28Field
        {
            field = message[@"RFI"][3],
            fieldData = fieldData
        };
        ...
        {
            _patientConsent.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_patientConsent, fieldData);
        }
...
internal HL7V28Field _dateAdditionalInformationWasSubmitted;

public HL7V28Field DateAdditionalInformationWasSubmitted
{
    get
    {
        ...
        _dateAdditionalInformationWasSubmitted = new HL7V28Field
        {
            field = message[@"RFI"][4],
            fieldData = fieldData
        };
        ...
        {
            _dateAdditionalInformationWasSubmitted.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_dateAdditionalInformationWasSubmitted, fieldData);
        }
