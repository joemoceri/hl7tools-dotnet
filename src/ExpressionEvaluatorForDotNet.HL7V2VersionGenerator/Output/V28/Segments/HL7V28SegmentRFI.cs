...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V28SegmentRFI
    {
        ...
        internal HL7V28Field requestDate;
...
public HL7V28Field RequestDate
{
    get
    {
        ...
        if (requestDate.field.FieldRepetitions != null && requestDate.field.FieldRepetitions.Count > 0)
        {
            ...
            requestDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(requestDate, fieldData);
        }
...
internal HL7V28Field responseDueDate;
...
public HL7V28Field ResponseDueDate
{
    get
    {
        ...
        responseDueDate = new HL7V28Field
        {
            field = message[@"RFI"][2],
            Id = @"RFI.2",
            Type = @"Field",
        ...
        if (responseDueDate.field.FieldRepetitions != null && responseDueDate.field.FieldRepetitions.Count > 0)
        {
            ...
            responseDueDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(responseDueDate, fieldData);
        }
...
internal HL7V28Field patientConsent;
...
public HL7V28Field PatientConsent
{
    get
    {
        ...
        patientConsent = new HL7V28Field
        {
            field = message[@"RFI"][3],
            Id = @"RFI.3",
            Type = @"Field",
        ...
        if (patientConsent.field.FieldRepetitions != null && patientConsent.field.FieldRepetitions.Count > 0)
        {
            ...
            patientConsent.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(patientConsent, fieldData);
        }
...
internal HL7V28Field dateAdditionalInformationWasSubmitted;
...
public HL7V28Field DateAdditionalInformationWasSubmitted
{
    get
    {
        ...
        dateAdditionalInformationWasSubmitted = new HL7V28Field
        {
            field = message[@"RFI"][4],
            Id = @"RFI.4",
            Type = @"Field",
        ...
        if (dateAdditionalInformationWasSubmitted.field.FieldRepetitions != null && dateAdditionalInformationWasSubmitted.field.FieldRepetitions.Count > 0)
        {
            ...
            dateAdditionalInformationWasSubmitted.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(dateAdditionalInformationWasSubmitted, fieldData);
        }
