...
internal HL7V28Field diet,Supplement,OrPreferenceCode;

public HL7V28Field Diet,Supplement,OrPreferenceCode
{
    get
    {
        ...
        diet,Supplement,OrPreferenceCode = new HL7V28Field
        {
            field = message[@"ODS"][3],
            Id = @"ODS.3",
            Type = @"Field",
