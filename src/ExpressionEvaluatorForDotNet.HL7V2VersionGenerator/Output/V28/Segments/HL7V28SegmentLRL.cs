...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V28SegmentLRL
    {
        ...
        public HL7V28SegmentLRL(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V28Field _primaryKeyValueLrl;

public HL7V28Field PrimaryKeyValueLrl
{
    get
    {
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _primaryKeyValueLrl = new HL7V28Field
        {
            field = message[@"LRL"][1],
            fieldData = fieldData
        };
        ...
        {
            _primaryKeyValueLrl.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_primaryKeyValueLrl, fieldData);
        }
...
internal HL7V28Field _segmentUniqueKey;
...
By site agreement, implementers may continue to use User-defined Table 0300 – Namespace ID for the first component",
        ...
        _segmentUniqueKey = new HL7V28Field
        {
            field = message[@"LRL"][3],
            fieldData = fieldData
        };
        ...
        {
            _segmentUniqueKey.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_segmentUniqueKey, fieldData);
        }
...
internal HL7V28Field _locationRelationshipId;

public HL7V28Field LocationRelationshipId
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _locationRelationshipId = new HL7V28Field
        {
            field = message[@"LRL"][4],
            fieldData = fieldData
        };
        ...
        {
            _locationRelationshipId.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_locationRelationshipId, fieldData);
        }
...
internal HL7V28Field _organizationalLocationRelationshipValue;

public HL7V28Field OrganizationalLocationRelationshipValue
{
    get
    {
...
Note: The check digit and code identifying check digit scheme are null if Organization identifier is alphanumeric.",
        ...
        _organizationalLocationRelationshipValue = new HL7V28Field
        {
            field = message[@"LRL"][5],
            fieldData = fieldData
        };
        ...
        {
            _organizationalLocationRelationshipValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_organizationalLocationRelationshipValue, fieldData);
        }
...
internal HL7V28Field _patientLocationRelationshipValue;

public HL7V28Field PatientLocationRelationshipValue
{
    get
    {
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _patientLocationRelationshipValue = new HL7V28Field
        {
            field = message[@"LRL"][6],
            fieldData = fieldData
        };
        ...
        {
            _patientLocationRelationshipValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_patientLocationRelationshipValue, fieldData);
        }
