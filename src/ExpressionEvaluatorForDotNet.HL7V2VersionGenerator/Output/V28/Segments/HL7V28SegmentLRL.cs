...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        internal HL7V28Field primaryKeyValueLrl;
...
public HL7V28Field PrimaryKeyValueLrl
{
    get
    {
        ...
        primaryKeyValueLrl = new HL7V28Field
        {
            field = message[@"LRL"][1],
            Id = @"LRL.1",
            Type = @"Field",
        ...
        if (primaryKeyValueLrl.field.FieldRepetitions != null && primaryKeyValueLrl.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValueLrl.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(primaryKeyValueLrl, fieldData);
        }
...
internal HL7V28Field locationRelationshipId;
...
public HL7V28Field LocationRelationshipId
{
    get
    {
        ...
        locationRelationshipId = new HL7V28Field
        {
            field = message[@"LRL"][4],
            Id = @"LRL.4",
            Type = @"Field",
        ...
        if (locationRelationshipId.field.FieldRepetitions != null && locationRelationshipId.field.FieldRepetitions.Count > 0)
        {
            ...
            locationRelationshipId.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(locationRelationshipId, fieldData);
        }
...
internal HL7V28Field organizationalLocationRelationshipValue;
...
public HL7V28Field OrganizationalLocationRelationshipValue
{
    get
    {
        ...
        organizationalLocationRelationshipValue = new HL7V28Field
        {
            field = message[@"LRL"][5],
            Id = @"LRL.5",
            Type = @"Field",
        ...
        if (organizationalLocationRelationshipValue.field.FieldRepetitions != null && organizationalLocationRelationshipValue.field.FieldRepetitions.Count > 0)
        {
            ...
            organizationalLocationRelationshipValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(organizationalLocationRelationshipValue, fieldData);
        }
...
internal HL7V28Field patientLocationRelationshipValue;
...
public HL7V28Field PatientLocationRelationshipValue
{
    get
    {
        ...
        patientLocationRelationshipValue = new HL7V28Field
        {
            field = message[@"LRL"][6],
            Id = @"LRL.6",
            Type = @"Field",
...
When LRL-4 - Location Relationship ID contains ""PAR""- Parent, this field holds the value of the parent location to allow for nested entries. For example, a bed entry can point to its containing room or nurse unit.  The value for the parent location should match the LOC-1 - Primary Key Value - LOC of the parent entry.  Not intended to be used for multiple designations of the same physical location, but for identifying the larger physical locations (supersets) which include this physical location as a subset. ",
        ...
        if (patientLocationRelationshipValue.field.FieldRepetitions != null && patientLocationRelationshipValue.field.FieldRepetitions.Count > 0)
        {
            ...
            patientLocationRelationshipValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(patientLocationRelationshipValue, fieldData);
        }
