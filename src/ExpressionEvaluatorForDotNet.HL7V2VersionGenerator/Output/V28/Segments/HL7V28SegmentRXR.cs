...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V28SegmentRXR
    {
        ...
        public HL7V28SegmentRXR(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V28Field _route;

public HL7V28Field Route
{
    get
    {
        if (_route != null)
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _route.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_route, fieldData);
        }
...
internal HL7V28Field _administrationSite;

public HL7V28Field AdministrationSite
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _administrationSite = new HL7V28Field
        {
            field = message[@"RXR"][2],
            fieldData = fieldData
        };
        ...
        {
            _administrationSite.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_administrationSite, fieldData);
        }
...
internal HL7V28Field _administrationDevice;

public HL7V28Field AdministrationDevice
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _administrationDevice = new HL7V28Field
        {
            field = message[@"RXR"][3],
            fieldData = fieldData
        };
        ...
        {
            _administrationDevice.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_administrationDevice, fieldData);
        }
...
internal HL7V28Field _administrationMethod;

public HL7V28Field AdministrationMethod
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _administrationMethod = new HL7V28Field
        {
            field = message[@"RXR"][4],
            fieldData = fieldData
        };
        ...
        {
            _administrationMethod.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_administrationMethod, fieldData);
        }
...
internal HL7V28Field _routingInstruction;

public HL7V28Field RoutingInstruction
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _routingInstruction = new HL7V28Field
        {
            field = message[@"RXR"][5],
            fieldData = fieldData
        };
        ...
        {
            _routingInstruction.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_routingInstruction, fieldData);
        }
...
internal HL7V28Field _administrationSiteModifier;

public HL7V28Field AdministrationSiteModifier
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _administrationSiteModifier = new HL7V28Field
        {
            field = message[@"RXR"][6],
            fieldData = fieldData
        };
        ...
        {
            _administrationSiteModifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_administrationSiteModifier, fieldData);
        }
