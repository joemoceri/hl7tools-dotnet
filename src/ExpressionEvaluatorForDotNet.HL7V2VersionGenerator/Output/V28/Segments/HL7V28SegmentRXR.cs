...
Some current ""route codes,"" such as some of the NDC-derived codes include the site already.  In such cases, the entire code can be included in this field as a ""locally-defined code"" for the CE data type.  Refer to User-Defined Table 0162 - Route of Administration for valid values.",
        ...
        if (route.field.FieldRepetitions != null && route.field.FieldRepetitions.Count > 0)
        {
            ...
            route.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(route, fieldData);
        }
...
internal HL7V28Field administrationSite;
...
public HL7V28Field AdministrationSite
{
    get
    {
        ...
        administrationSite = new HL7V28Field
        {
            field = message[@"RXR"][2],
            Id = @"RXR.2",
            Type = @"Field",
...
Refer to HL7 Table 0550 - Body Parts for valid values.  Other appropriate external code sets (e.g., SNOMED) may also be employed.",
        ...
        if (administrationSite.field.FieldRepetitions != null && administrationSite.field.FieldRepetitions.Count > 0)
        {
            ...
            administrationSite.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(administrationSite, fieldData);
        }
...
internal HL7V28Field administrationDevice;
...
public HL7V28Field AdministrationDevice
{
    get
    {
        ...
        administrationDevice = new HL7V28Field
        {
            field = message[@"RXR"][3],
            Id = @"RXR.3",
            Type = @"Field",
        ...
        if (administrationDevice.field.FieldRepetitions != null && administrationDevice.field.FieldRepetitions.Count > 0)
        {
            ...
            administrationDevice.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(administrationDevice, fieldData);
        }
...
internal HL7V28Field administrationMethod;
...
public HL7V28Field AdministrationMethod
{
    get
    {
        ...
        administrationMethod = new HL7V28Field
        {
            field = message[@"RXR"][4],
            Id = @"RXR.4",
            Type = @"Field",
        ...
        if (administrationMethod.field.FieldRepetitions != null && administrationMethod.field.FieldRepetitions.Count > 0)
        {
            ...
            administrationMethod.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(administrationMethod, fieldData);
        }
...
internal HL7V28Field routingInstruction;
...
public HL7V28Field RoutingInstruction
{
    get
    {
        ...
        routingInstruction = new HL7V28Field
        {
            field = message[@"RXR"][5],
            Id = @"RXR.5",
            Type = @"Field",
        ...
        if (routingInstruction.field.FieldRepetitions != null && routingInstruction.field.FieldRepetitions.Count > 0)
        {
            ...
            routingInstruction.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(routingInstruction, fieldData);
        }
...
internal HL7V28Field administrationSiteModifier;
...
public HL7V28Field AdministrationSiteModifier
{
    get
    {
        ...
        administrationSiteModifier = new HL7V28Field
        {
            field = message[@"RXR"][6],
            Id = @"RXR.6",
            Type = @"Field",
...
Condition Rule: This field may only be populated if RXR-2 Administration Site is populated.  This field is not required if RXR-2 is populated.",
        ...
        if (administrationSiteModifier.field.FieldRepetitions != null && administrationSiteModifier.field.FieldRepetitions.Count > 0)
        {
            ...
            administrationSiteModifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(administrationSiteModifier, fieldData);
        }
