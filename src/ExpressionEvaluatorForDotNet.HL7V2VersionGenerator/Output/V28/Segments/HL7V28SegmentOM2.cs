...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V28SegmentOM2
    {
        ...
        public HL7V28SegmentOM2(HL7V2Message message)
        {
...
internal HL7V28Field _unitsOfMeasure;

public HL7V28Field UnitsOfMeasure
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _unitsOfMeasure = new HL7V28Field
        {
            field = message[@"OM2"][2],
            fieldData = fieldData
        };
        ...
        {
            _unitsOfMeasure.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_unitsOfMeasure, fieldData);
        }
...
internal HL7V28Field _rangeOfDecimalPrecision;

public HL7V28Field RangeOfDecimalPrecision
{
    get
    {
        ...
        _rangeOfDecimalPrecision = new HL7V28Field
        {
            field = message[@"OM2"][3],
            fieldData = fieldData
        };
        ...
        {
            _rangeOfDecimalPrecision.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_rangeOfDecimalPrecision, fieldData);
        }
...
internal HL7V28Field _correspondingSiUnitsOfMeasure;

public HL7V28Field CorrespondingSiUnitsOfMeasure
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _correspondingSiUnitsOfMeasure = new HL7V28Field
        {
            field = message[@"OM2"][4],
            fieldData = fieldData
        };
        ...
        {
            _correspondingSiUnitsOfMeasure.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_correspondingSiUnitsOfMeasure, fieldData);
        }
...
internal HL7V28Field _siConversionFactor;

public HL7V28Field SiConversionFactor
{
    get
    {
...
In the case that the relation is simply multiplicative, this field shall include only the conversion factor.  For example, if (results SI units) = c * (results reporting units), then only c would be stored in this field.  In the case of any other functional relationship, the entire equation would be stored as a test.",
        ...
        _siConversionFactor = new HL7V28Field
        {
            field = message[@"OM2"][5],
            fieldData = fieldData
        };
        ...
        {
            _siConversionFactor.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_siConversionFactor, fieldData);
        }
...
internal HL7V28Field _referencenormalRangeForOrdinalAndContinuousObservations;

public HL7V28Field ReferencenormalRangeForOrdinalAndContinuousObservations
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _referencenormalRangeForOrdinalAndContinuousObservations = new HL7V28Field
        {
            field = message[@"OM2"][6],
            fieldData = fieldData
        };
        ...
        {
            _referencenormalRangeForOrdinalAndContinuousObservations.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_referencenormalRangeForOrdinalAndContinuousObservations, fieldData);
        }
...
internal HL7V28Field _criticalRangeForOrdinalAndContinuousObservations;

public HL7V28Field CriticalRangeForOrdinalAndContinuousObservations
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _criticalRangeForOrdinalAndContinuousObservations = new HL7V28Field
        {
            field = message[@"OM2"][7],
            fieldData = fieldData
        };
        ...
        {
            _criticalRangeForOrdinalAndContinuousObservations.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_criticalRangeForOrdinalAndContinuousObservations, fieldData);
        }
...
internal HL7V28Field _absoluteRangeForOrdinalAndContinuousObservations;

public HL7V28Field AbsoluteRangeForOrdinalAndContinuousObservations
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _absoluteRangeForOrdinalAndContinuousObservations = new HL7V28Field
        {
            field = message[@"OM2"][8],
            fieldData = fieldData
        };
        ...
        {
            _absoluteRangeForOrdinalAndContinuousObservations.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_absoluteRangeForOrdinalAndContinuousObservations, fieldData);
        }
...
internal HL7V28Field _deltaCheckCriteria;

public HL7V28Field DeltaCheckCriteria
{
    get
    {
...
For example the threshold may be set to 10.",
        ...
        _deltaCheckCriteria = new HL7V28Field
        {
            field = message[@"OM2"][9],
            fieldData = fieldData
        };
        ...
        {
            _deltaCheckCriteria.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_deltaCheckCriteria, fieldData);
        }
...
internal HL7V28Field _minimumMeaningfulIncrements;

public HL7V28Field MinimumMeaningfulIncrements
{
    get
    {
        ...
        _minimumMeaningfulIncrements = new HL7V28Field
        {
        ...
        {
            _minimumMeaningfulIncrements.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_minimumMeaningfulIncrements, fieldData);
        }
