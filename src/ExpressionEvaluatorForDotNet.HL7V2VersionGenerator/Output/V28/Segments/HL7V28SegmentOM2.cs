...
internal HL7V28Field reference(normal)RangeForOrdinalAndContinuousObservations;

public HL7V28Field Reference(normal)RangeForOrdinalAndContinuousObservations
{
    get
    {
        ...
        reference(normal)RangeForOrdinalAndContinuousObservations = new HL7V28Field
        {
            field = message[@"OM2"][6],
            Id = @"OM2.6",
            Type = @"Field",
