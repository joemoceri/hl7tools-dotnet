...
internal HL7V28Field unitsOfMeasure;
...
public HL7V28Field UnitsOfMeasure
{
    get
    {
        ...
        unitsOfMeasure = new HL7V28Field
        {
            field = message[@"OM2"][2],
            Id = @"OM2.2",
            Type = @"Field",
        ...
        if (unitsOfMeasure.field.FieldRepetitions != null && unitsOfMeasure.field.FieldRepetitions.Count > 0)
        {
            ...
            unitsOfMeasure.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(unitsOfMeasure, fieldData);
        }
...
internal HL7V28Field rangeOfDecimalPrecision;
...
public HL7V28Field RangeOfDecimalPrecision
{
    get
    {
        ...
        rangeOfDecimalPrecision = new HL7V28Field
        {
            field = message[@"OM2"][3],
            Id = @"OM2.3",
            Type = @"Field",
        ...
        if (rangeOfDecimalPrecision.field.FieldRepetitions != null && rangeOfDecimalPrecision.field.FieldRepetitions.Count > 0)
        {
            ...
            rangeOfDecimalPrecision.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(rangeOfDecimalPrecision, fieldData);
        }
...
internal HL7V28Field correspondingSiUnitsOfMeasure;
...
public HL7V28Field CorrespondingSiUnitsOfMeasure
{
    get
    {
        ...
        correspondingSiUnitsOfMeasure = new HL7V28Field
        {
            field = message[@"OM2"][4],
            Id = @"OM2.4",
            Type = @"Field",
        ...
        if (correspondingSiUnitsOfMeasure.field.FieldRepetitions != null && correspondingSiUnitsOfMeasure.field.FieldRepetitions.Count > 0)
        {
            ...
            correspondingSiUnitsOfMeasure.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(correspondingSiUnitsOfMeasure, fieldData);
        }
...
internal HL7V28Field siConversionFactor;
...
public HL7V28Field SiConversionFactor
{
    get
    {
        ...
        siConversionFactor = new HL7V28Field
        {
            field = message[@"OM2"][5],
            Id = @"OM2.5",
            Type = @"Field",
...
In the case that the relation is simply multiplicative, this field shall include only the conversion factor.  For example, if (results SI units) = c * (results reporting units), then only c would be stored in this field.  In the case of any other functional relationship, the entire equation would be stored as a test.",
        ...
        if (siConversionFactor.field.FieldRepetitions != null && siConversionFactor.field.FieldRepetitions.Count > 0)
        {
            ...
            siConversionFactor.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(siConversionFactor, fieldData);
        }
...
internal HL7V28Field referencenormalRangeForOrdinalAndContinuousObservations;
...
public HL7V28Field ReferencenormalRangeForOrdinalAndContinuousObservations
{
    get
    {
        ...
        referencenormalRangeForOrdinalAndContinuousObservations = new HL7V28Field
        {
            field = message[@"OM2"][6],
            Id = @"OM2.6",
            Type = @"Field",
...
When two different methods result in two different reference ranges, two different observations and corresponding OMx segments should be defined.",
        ...
        if (referencenormalRangeForOrdinalAndContinuousObservations.field.FieldRepetitions != null && referencenormalRangeForOrdinalAndContinuousObservations.field.FieldRepetitions.Count > 0)
        {
            ...
            referencenormalRangeForOrdinalAndContinuousObservations.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(referencenormalRangeForOrdinalAndContinuousObservations, fieldData);
        }
...
internal HL7V28Field criticalRangeForOrdinalAndContinuousObservations;
...
public HL7V28Field CriticalRangeForOrdinalAndContinuousObservations
{
    get
    {
        ...
        criticalRangeForOrdinalAndContinuousObservations = new HL7V28Field
        {
            field = message[@"OM2"][7],
            Id = @"OM2.7",
            Type = @"Field",
        ...
        if (criticalRangeForOrdinalAndContinuousObservations.field.FieldRepetitions != null && criticalRangeForOrdinalAndContinuousObservations.field.FieldRepetitions.Count > 0)
        {
            ...
            criticalRangeForOrdinalAndContinuousObservations.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(criticalRangeForOrdinalAndContinuousObservations, fieldData);
        }
...
internal HL7V28Field absoluteRangeForOrdinalAndContinuousObservations;
...
public HL7V28Field AbsoluteRangeForOrdinalAndContinuousObservations
{
    get
    {
        ...
        absoluteRangeForOrdinalAndContinuousObservations = new HL7V28Field
        {
            field = message[@"OM2"][8],
            Id = @"OM2.8",
            Type = @"Field",
        ...
        if (absoluteRangeForOrdinalAndContinuousObservations.field.FieldRepetitions != null && absoluteRangeForOrdinalAndContinuousObservations.field.FieldRepetitions.Count > 0)
        {
            ...
            absoluteRangeForOrdinalAndContinuousObservations.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(absoluteRangeForOrdinalAndContinuousObservations, fieldData);
        }
...
internal HL7V28Field deltaCheckCriteria;
...
public HL7V28Field DeltaCheckCriteria
{
    get
    {
        ...
        deltaCheckCriteria = new HL7V28Field
        {
            field = message[@"OM2"][9],
            Id = @"OM2.9",
            Type = @"Field",
...
More than one delta check rule can apply.  13&16^10^%^100~16.1&20^2^a^100 implies that the delta check will trigger on a 10% change when the value of the observation is between 13 and 16.  The check will trigger on an absolute change of 2 when the value is between 16.1 and 20.  In both cases, the system will keep the last result for 100 days.  In this example, beyond 100 days, the computer will not compute a delta check because it will not have a comparison value.",
        ...
        if (deltaCheckCriteria.field.FieldRepetitions != null && deltaCheckCriteria.field.FieldRepetitions.Count > 0)
        {
            ...
            deltaCheckCriteria.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(deltaCheckCriteria, fieldData);
        }
...
internal HL7V28Field minimumMeaningfulIncrements;
...
public HL7V28Field MinimumMeaningfulIncrements
{
    get
    {
        ...
        minimumMeaningfulIncrements = new HL7V28Field
        {
        ...
        if (minimumMeaningfulIncrements.field.FieldRepetitions != null && minimumMeaningfulIncrements.field.FieldRepetitions.Count > 0)
        {
            ...
            minimumMeaningfulIncrements.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(minimumMeaningfulIncrements, fieldData);
        }
