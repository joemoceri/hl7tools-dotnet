...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V28SegmentCER
    {
        ...
        internal HL7V28Field _setIdCer;
...
public HL7V28Field SetIdCer
{
    get
    {
        ...
        {
            _setIdCer.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_setIdCer, fieldData);
        }
...
internal HL7V28Field _serialNumber;
...
An attribute certificate is a data structure which certifies (either digitally or manually) that one or more attributes (e.g., descriptors, capabilities, qualifications, etc.) are associated with a particular entity as verified/certified by the attribute authority (e.g., Credentialing Organization (US), Physician Chamber ""Ãrztekammer"" (D), Physicians Statutory Association ""Kassenärztliche Vereinigung"" (D)).",
        ...
        {
            _serialNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_serialNumber, fieldData);
        }
...
public HL7V28Field Version
{
    get
    {
        ...
        {
            _version.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_version, fieldData);
        }
...
internal HL7V28Field _grantingAuthority;
...
Note: The check digit and code identifying check digit scheme are null if Organization identifier is alphanumeric.",
        ...
        _grantingAuthority = new HL7V28Field
        {
            field = message[@"CER"][4],
            fieldData = fieldData
        };
        ...
        {
            _grantingAuthority.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_grantingAuthority, fieldData);
        }
...
internal HL7V28Field _issuingAuthority;
...
Refer to HL7 Table 0904 - Security Check Scheme for valid values",
        ...
        _issuingAuthority = new HL7V28Field
        {
            field = message[@"CER"][5],
            fieldData = fieldData
        };
        ...
        {
            _issuingAuthority.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_issuingAuthority, fieldData);
        }
...
internal HL7V28Field _signature;
...
If the encoding component ED.4 does not equal ""A"", then, after encoding, the (encoded) data must be scanned for HL7 delimiter characters, and any found must be escaped by using the HL7 escape sequences. Only then can the component be added to the HL7 segment/message. On the receiving application, the data field must be de-escaped after being parsed out of the message before being decoded. This can be expressed as ""encode"", ""escape"", ""parse"", ""de-escape"" or ""decode"".",
        ...
        // check for repetitions
        if (_signature.field.FieldRepetitions != null && _signature.field.FieldRepetitions.Count > 0)
        {
            _signature.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_signature, fieldData);
        }
...
internal HL7V28Field _grantingCountry;
...
public HL7V28Field GrantingCountry
{
    get
    {
        ...
        _grantingCountry = new HL7V28Field
        {
            field = message[@"CER"][7],
            fieldData = fieldData
        };
        ...
        {
            _grantingCountry.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_grantingCountry, fieldData);
        }
...
internal HL7V28Field _grantingStateProvince;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _grantingStateProvince = new HL7V28Field
        {
            field = message[@"CER"][8],
            fieldData = fieldData
        };
        ...
        {
            _grantingStateProvince.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_grantingStateProvince, fieldData);
        }
...
internal HL7V28Field _grantingCountyParish;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _grantingCountyParish = new HL7V28Field
        {
            field = message[@"CER"][9],
            fieldData = fieldData
        };
        ...
        {
            _grantingCountyParish.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_grantingCountyParish, fieldData);
        }
...
internal HL7V28Field _certificateType;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _certificateType = new HL7V28Field
        {
        ...
        {
            _certificateType.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_certificateType, fieldData);
        }
...
internal HL7V28Field _certificateDomain;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _certificateDomain = new HL7V28Field
        {
        ...
        {
            _certificateDomain.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_certificateDomain, fieldData);
        }
...
internal HL7V28Field _subjectId;
...
By site agreement, implementers may continue to use User-defined Table 0300 – Namespace ID for the first component",
        ...
        {
            _subjectId.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_subjectId, fieldData);
        }
...
internal HL7V28Field _subjectName;
...
public HL7V28Field SubjectName
{
    get
    {
        ...
        {
            _subjectName.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_subjectName, fieldData);
        }
...
internal HL7V28Field _subjectDirectoryAttributeExtension;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _subjectDirectoryAttributeExtension = new HL7V28Field
        {
        ...
        {
            _subjectDirectoryAttributeExtension.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_subjectDirectoryAttributeExtension, fieldData);
        }
...
internal HL7V28Field _subjectPublicKeyInfo;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _subjectPublicKeyInfo = new HL7V28Field
        {
        ...
        {
            _subjectPublicKeyInfo.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_subjectPublicKeyInfo, fieldData);
        }
...
internal HL7V28Field _authorityKeyIdentifier;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _authorityKeyIdentifier = new HL7V28Field
        {
        ...
        {
            _authorityKeyIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_authorityKeyIdentifier, fieldData);
        }
...
internal HL7V28Field _basicConstraint;
...
public HL7V28Field BasicConstraint
{
    get
    {
        ...
        _basicConstraint = new HL7V28Field
        {
        ...
        {
            _basicConstraint.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_basicConstraint, fieldData);
        }
...
internal HL7V28Field _crlDistributionPoint;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _crlDistributionPoint = new HL7V28Field
        {
        ...
        {
            _crlDistributionPoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_crlDistributionPoint, fieldData);
        }
...
internal HL7V28Field _jurisdictionCountry;
...
public HL7V28Field JurisdictionCountry
{
    get
    {
        ...
        _jurisdictionCountry = new HL7V28Field
        {
        ...
        {
            _jurisdictionCountry.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_jurisdictionCountry, fieldData);
        }
...
internal HL7V28Field _jurisdictionStateProvince;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _jurisdictionStateProvince = new HL7V28Field
        {
        ...
        {
            _jurisdictionStateProvince.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_jurisdictionStateProvince, fieldData);
        }
...
internal HL7V28Field _jurisdictionCountyParish;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _jurisdictionCountyParish = new HL7V28Field
        {
        ...
        {
            _jurisdictionCountyParish.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_jurisdictionCountyParish, fieldData);
        }
...
internal HL7V28Field _jurisdictionBreadth;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _jurisdictionBreadth = new HL7V28Field
        {
        ...
        {
            _jurisdictionBreadth.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_jurisdictionBreadth, fieldData);
        }
...
internal HL7V28Field _grantingDate;
...
public HL7V28Field GrantingDate
{
    get
    {
        ...
        {
            _grantingDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_grantingDate, fieldData);
        }
...
internal HL7V28Field _issuingDate;
...
public HL7V28Field IssuingDate
{
    get
    {
        ...
        {
            _issuingDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_issuingDate, fieldData);
        }
...
internal HL7V28Field _activationDate;
...
public HL7V28Field ActivationDate
{
    get
    {
        ...
        _activationDate = new HL7V28Field
        {
        ...
        {
            _activationDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_activationDate, fieldData);
        }
...
internal HL7V28Field _inactivationDate;
...
public HL7V28Field InactivationDate
{
    get
    {
        ...
        _inactivationDate = new HL7V28Field
        {
        ...
        {
            _inactivationDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_inactivationDate, fieldData);
        }
...
internal HL7V28Field _expirationDate;
...
public HL7V28Field ExpirationDate
{
    get
    {
        ...
        _expirationDate = new HL7V28Field
        {
        ...
        {
            _expirationDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_expirationDate, fieldData);
        }
...
internal HL7V28Field _renewalDate;
...
public HL7V28Field RenewalDate
{
    get
    {
        ...
        {
            _renewalDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_renewalDate, fieldData);
        }
...
internal HL7V28Field _revocationDate;
...
public HL7V28Field RevocationDate
{
    get
    {
        ...
        _revocationDate = new HL7V28Field
        {
        ...
        {
            _revocationDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_revocationDate, fieldData);
        }
...
internal HL7V28Field _revocationReasonCode;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _revocationReasonCode = new HL7V28Field
        {
        ...
        {
            _revocationReasonCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_revocationReasonCode, fieldData);
        }
...
internal HL7V28Field _certificateStatusCode;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _certificateStatusCode = new HL7V28Field
        {
        ...
        {
            _certificateStatusCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_certificateStatusCode, fieldData);
        }
