...
public HL7V28Field SetIdCer
{
    get
    {
        ...
        if (setIdCer.field.FieldRepetitions != null && setIdCer.field.FieldRepetitions.Count > 0)
        {
            ...
            setIdCer.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(setIdCer, fieldData);
        }
...
An attribute certificate is a data structure which certifies (either digitally or manually) that one or more attributes (e.g., descriptors, capabilities, qualifications, etc.) are associated with a particular entity as verified/certified by the attribute authority (e.g., Credentialing Organization (US), Physician Chamber ""Ãrztekammer"" (D), Physicians Statutory Association ""Kassenärztliche Vereinigung"" (D)).",
        ...
        if (serialNumber.field.FieldRepetitions != null && serialNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            serialNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(serialNumber, fieldData);
        }
...
public HL7V28Field Version
{
    get
    {
        ...
        if (version.field.FieldRepetitions != null && version.field.FieldRepetitions.Count > 0)
        {
            ...
            version.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(version, fieldData);
        }
...
public HL7V28Field GrantingAuthority
{
    get
    {
        ...
        if (grantingAuthority.field.FieldRepetitions != null && grantingAuthority.field.FieldRepetitions.Count > 0)
        {
            ...
            grantingAuthority.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(grantingAuthority, fieldData);
        }
...
public HL7V28Field IssuingAuthority
{
    get
    {
        ...
        if (issuingAuthority.field.FieldRepetitions != null && issuingAuthority.field.FieldRepetitions.Count > 0)
        {
            ...
            issuingAuthority.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(issuingAuthority, fieldData);
        }
...
public HL7V28Field Signature
{
    get
    {
        ...
        if (signature.field.FieldRepetitions != null && signature.field.FieldRepetitions.Count > 0)
        {
            ...
            signature.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(signature, fieldData);
        }
...
public HL7V28Field GrantingCountry
{
    get
    {
        ...
        if (grantingCountry.field.FieldRepetitions != null && grantingCountry.field.FieldRepetitions.Count > 0)
        {
            ...
            grantingCountry.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(grantingCountry, fieldData);
        }
...
public HL7V28Field GrantingStateProvince
{
    get
    {
        ...
        if (grantingStateProvince.field.FieldRepetitions != null && grantingStateProvince.field.FieldRepetitions.Count > 0)
        {
            ...
            grantingStateProvince.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(grantingStateProvince, fieldData);
        }
...
public HL7V28Field GrantingCountyParish
{
    get
    {
        ...
        if (grantingCountyParish.field.FieldRepetitions != null && grantingCountyParish.field.FieldRepetitions.Count > 0)
        {
            ...
            grantingCountyParish.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(grantingCountyParish, fieldData);
        }
...
public HL7V28Field CertificateType
{
    get
    {
        ...
        if (certificateType.field.FieldRepetitions != null && certificateType.field.FieldRepetitions.Count > 0)
        {
            ...
            certificateType.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(certificateType, fieldData);
        }
...
public HL7V28Field CertificateDomain
{
    get
    {
        ...
        if (certificateDomain.field.FieldRepetitions != null && certificateDomain.field.FieldRepetitions.Count > 0)
        {
            ...
            certificateDomain.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(certificateDomain, fieldData);
        }
...
public HL7V28Field SubjectId
{
    get
    {
        ...
        if (subjectId.field.FieldRepetitions != null && subjectId.field.FieldRepetitions.Count > 0)
        {
            ...
            subjectId.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(subjectId, fieldData);
        }
...
public HL7V28Field SubjectName
{
    get
    {
        ...
        if (subjectName.field.FieldRepetitions != null && subjectName.field.FieldRepetitions.Count > 0)
        {
            ...
            subjectName.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(subjectName, fieldData);
        }
...
public HL7V28Field SubjectDirectoryAttributeExtension
{
    get
    {
        ...
        if (subjectDirectoryAttributeExtension.field.FieldRepetitions != null && subjectDirectoryAttributeExtension.field.FieldRepetitions.Count > 0)
        {
            ...
            subjectDirectoryAttributeExtension.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(subjectDirectoryAttributeExtension, fieldData);
        }
...
X.509 is an ISO standard specifying certificates.",
        ...
        if (subjectPublicKeyInfo.field.FieldRepetitions != null && subjectPublicKeyInfo.field.FieldRepetitions.Count > 0)
        {
            ...
            subjectPublicKeyInfo.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(subjectPublicKeyInfo, fieldData);
        }
...
public HL7V28Field AuthorityKeyIdentifier
{
    get
    {
        ...
        if (authorityKeyIdentifier.field.FieldRepetitions != null && authorityKeyIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            authorityKeyIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(authorityKeyIdentifier, fieldData);
        }
...
public HL7V28Field BasicConstraint
{
    get
    {
        ...
        if (basicConstraint.field.FieldRepetitions != null && basicConstraint.field.FieldRepetitions.Count > 0)
        {
            ...
            basicConstraint.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(basicConstraint, fieldData);
        }
...
public HL7V28Field CrlDistributionPoint
{
    get
    {
        ...
        if (crlDistributionPoint.field.FieldRepetitions != null && crlDistributionPoint.field.FieldRepetitions.Count > 0)
        {
            ...
            crlDistributionPoint.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(crlDistributionPoint, fieldData);
        }
...
public HL7V28Field JurisdictionCountry
{
    get
    {
        ...
        if (jurisdictionCountry.field.FieldRepetitions != null && jurisdictionCountry.field.FieldRepetitions.Count > 0)
        {
            ...
            jurisdictionCountry.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(jurisdictionCountry, fieldData);
        }
...
public HL7V28Field JurisdictionStateProvince
{
    get
    {
        ...
        if (jurisdictionStateProvince.field.FieldRepetitions != null && jurisdictionStateProvince.field.FieldRepetitions.Count > 0)
        {
            ...
            jurisdictionStateProvince.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(jurisdictionStateProvince, fieldData);
        }
...
public HL7V28Field JurisdictionCountyParish
{
    get
    {
        ...
        if (jurisdictionCountyParish.field.FieldRepetitions != null && jurisdictionCountyParish.field.FieldRepetitions.Count > 0)
        {
            ...
            jurisdictionCountyParish.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(jurisdictionCountyParish, fieldData);
        }
...
public HL7V28Field JurisdictionBreadth
{
    get
    {
        ...
        if (jurisdictionBreadth.field.FieldRepetitions != null && jurisdictionBreadth.field.FieldRepetitions.Count > 0)
        {
            ...
            jurisdictionBreadth.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(jurisdictionBreadth, fieldData);
        }
...
public HL7V28Field GrantingDate
{
    get
    {
        ...
        if (grantingDate.field.FieldRepetitions != null && grantingDate.field.FieldRepetitions.Count > 0)
        {
            ...
            grantingDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(grantingDate, fieldData);
        }
...
public HL7V28Field IssuingDate
{
    get
    {
        ...
        if (issuingDate.field.FieldRepetitions != null && issuingDate.field.FieldRepetitions.Count > 0)
        {
            ...
            issuingDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(issuingDate, fieldData);
        }
...
public HL7V28Field ActivationDate
{
    get
    {
        ...
        if (activationDate.field.FieldRepetitions != null && activationDate.field.FieldRepetitions.Count > 0)
        {
            ...
            activationDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(activationDate, fieldData);
        }
...
public HL7V28Field InactivationDate
{
    get
    {
        ...
        if (inactivationDate.field.FieldRepetitions != null && inactivationDate.field.FieldRepetitions.Count > 0)
        {
            ...
            inactivationDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(inactivationDate, fieldData);
        }
...
public HL7V28Field RenewalDate
{
    get
    {
        ...
        if (renewalDate.field.FieldRepetitions != null && renewalDate.field.FieldRepetitions.Count > 0)
        {
            ...
            renewalDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(renewalDate, fieldData);
        }
...
public HL7V28Field RevocationDate
{
    get
    {
        ...
        if (revocationDate.field.FieldRepetitions != null && revocationDate.field.FieldRepetitions.Count > 0)
        {
            ...
            revocationDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(revocationDate, fieldData);
        }
...
public HL7V28Field RevocationReasonCode
{
    get
    {
        ...
        if (revocationReasonCode.field.FieldRepetitions != null && revocationReasonCode.field.FieldRepetitions.Count > 0)
        {
            ...
            revocationReasonCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(revocationReasonCode, fieldData);
        }
...
public HL7V28Field CertificateStatusCode
{
    get
    {
        ...
        if (certificateStatusCode.field.FieldRepetitions != null && certificateStatusCode.field.FieldRepetitions.Count > 0)
        {
            ...
            certificateStatusCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(certificateStatusCode, fieldData);
        }
