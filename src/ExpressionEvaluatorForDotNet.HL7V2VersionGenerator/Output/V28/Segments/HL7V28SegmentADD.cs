...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V28SegmentADD
    {
        ...
        internal HL7V28Field addendumContinuationPointer;
...
public HL7V28Field AddendumContinuationPointer
{
    get
    {
        ...
        addendumContinuationPointer = new HL7V28Field
        {
            field = message[@"ADD"][1],
            Id = @"ADD.1",
            Type = @"Field",
        ...
        if (addendumContinuationPointer.field.FieldRepetitions != null && addendumContinuationPointer.field.FieldRepetitions.Count > 0)
        {
            ...
            addendumContinuationPointer.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(addendumContinuationPointer, fieldData);
        }
