...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V28SegmentADD
    {
        ...
        public HL7V28SegmentADD(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V28Field _addendumContinuationPointer;

public HL7V28Field AddendumContinuationPointer
{
    get
    {
        ...
        _addendumContinuationPointer = new HL7V28Field
        {
            field = message[@"ADD"][1],
            fieldData = fieldData
        };
        ...
        {
            _addendumContinuationPointer.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_addendumContinuationPointer, fieldData);
        }
