...
internal HL7V28Field _lowerAndUpperTrimPoints;
...
Example as used in Germany: The ""lower trim point"" is equivalent to 1/3 of the average length of stay for patients having this DRG.  The ""upper trim point"" is equivalent to 3 times the average length of stay.  It is marked as the right dotted line within the graphics below.",
        ...
        _lowerAndUpperTrimPoints = new HL7V28Field
        {
            field = message[@"DMI"][3],
            fieldData = fieldData
        };
        ...
        {
            _lowerAndUpperTrimPoints.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_lowerAndUpperTrimPoints, fieldData);
        }
...
internal HL7V28Field _averageLengthOfStay;
...
public HL7V28Field AverageLengthOfStay
{
    get
    {
        ...
        _averageLengthOfStay = new HL7V28Field
        {
            field = message[@"DMI"][4],
            fieldData = fieldData
        };
        ...
        {
            _averageLengthOfStay.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_averageLengthOfStay, fieldData);
        }
...
internal HL7V28Field _relativeWeight;
...
public HL7V28Field RelativeWeight
{
    get
    {
        ...
        _relativeWeight = new HL7V28Field
        {
            field = message[@"DMI"][5],
            fieldData = fieldData
        };
        ...
        {
            _relativeWeight.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_relativeWeight, fieldData);
        }
