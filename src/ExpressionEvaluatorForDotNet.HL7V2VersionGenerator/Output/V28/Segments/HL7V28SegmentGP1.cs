...
The GP1 segment is specific to the US and may not be implemented in non-US systems."; } }
        ...
        public HL7V28SegmentGP1(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V28Field _typeOfBillCode;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _typeOfBillCode = new HL7V28Field
        {
            field = message[@"GP1"][1],
            fieldData = fieldData
        };
        ...
        {
            _typeOfBillCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_typeOfBillCode, fieldData);
        }
...
internal HL7V28Field _overallClaimDispositionCode;

public HL7V28Field OverallClaimDispositionCode
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _overallClaimDispositionCode = new HL7V28Field
        {
            field = message[@"GP1"][3],
            fieldData = fieldData
        };
        ...
        {
            _overallClaimDispositionCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_overallClaimDispositionCode, fieldData);
        }
...
internal HL7V28Field _oceEditsPerVisitCode;

public HL7V28Field OceEditsPerVisitCode
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _oceEditsPerVisitCode = new HL7V28Field
        {
            field = message[@"GP1"][4],
            fieldData = fieldData
        };
        ...
        {
            _oceEditsPerVisitCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_oceEditsPerVisitCode, fieldData);
        }
