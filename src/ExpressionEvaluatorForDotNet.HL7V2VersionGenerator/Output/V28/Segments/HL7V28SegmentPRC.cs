...
Value set version ID is required if CWE.21 is populated.",
        ...
        internal HL7V28Field primaryKeyValuePrc;
...
public HL7V28Field PrimaryKeyValuePrc
{
    get
    {
        ...
        primaryKeyValuePrc = new HL7V28Field
        {
            field = message[@"PRC"][1],
            Id = @"PRC.1",
            Type = @"Field",
        ...
        if (primaryKeyValuePrc.field.FieldRepetitions != null && primaryKeyValuePrc.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryKeyValuePrc.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(primaryKeyValuePrc, fieldData);
        }
...
internal HL7V28Field facilityIdPrc;
...
When two PRC segments are sent with the same key values but different facility identifiers, the second is sent in addition to the first, not to replace the first.  The effective unique identifier is the charge code (PRC-1 - Primary Key Value - PRC) plus the facility ID (PRC-2 - Facility ID).  Multiple facility identifiers can be sent in the same segment to indicate that those facilities use the same pricing. Refer to User-defined Table 0464 - Facility ID in Chapter 2C, Code Tables, for suggested values.",
        ...
        if (facilityIdPrc.field.FieldRepetitions != null && facilityIdPrc.field.FieldRepetitions.Count > 0)
        {
            ...
            facilityIdPrc.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(facilityIdPrc, fieldData);
        }
...
internal HL7V28Field department;
...
When two PRC segments are sent the same key values but with different departments, the second is sent in addition to the first, not to replace the first.  The effective unique identifier is the charge code (PRC-1 - Primary Key - PRC) plus the facility ID (PRC-2 - Facility ID) plus the department (PRC-3 - Department).  Multiple departments can be sent in the same segment to indicate that those departments use the same pricing. Refer to User-defined Table 0184 - Department in Chapter 2C, Code Tables, for suggested values.",
        ...
        if (department.field.FieldRepetitions != null && department.field.FieldRepetitions.Count > 0)
        {
            ...
            department.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(department, fieldData);
        }
...
public HL7V28Field Price
{
    get
    {
        ...
        if (price.field.FieldRepetitions != null && price.field.FieldRepetitions.Count > 0)
        {
            ...
            price.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(price, fieldData);
        }
...
public HL7V28Field Formula
{
    get
    {
        ...
        if (formula.field.FieldRepetitions != null && formula.field.FieldRepetitions.Count > 0)
        {
            ...
            formula.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(formula, fieldData);
        }
...
internal HL7V28Field minimumQuantity;
...
public HL7V28Field MinimumQuantity
{
    get
    {
        ...
        minimumQuantity = new HL7V28Field
        {
            field = message[@"PRC"][7],
            Id = @"PRC.7",
            Type = @"Field",
        ...
        if (minimumQuantity.field.FieldRepetitions != null && minimumQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            minimumQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(minimumQuantity, fieldData);
        }
...
internal HL7V28Field maximumQuantity;
...
public HL7V28Field MaximumQuantity
{
    get
    {
        ...
        maximumQuantity = new HL7V28Field
        {
            field = message[@"PRC"][8],
            Id = @"PRC.8",
            Type = @"Field",
        ...
        if (maximumQuantity.field.FieldRepetitions != null && maximumQuantity.field.FieldRepetitions.Count > 0)
        {
            ...
            maximumQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(maximumQuantity, fieldData);
        }
...
internal HL7V28Field minimumPrice;
...
public HL7V28Field MinimumPrice
{
    get
    {
        ...
        if (minimumPrice.field.FieldRepetitions != null && minimumPrice.field.FieldRepetitions.Count > 0)
        {
            ...
            minimumPrice.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(minimumPrice, fieldData);
        }
...
internal HL7V28Field maximumPrice;
...
public HL7V28Field MaximumPrice
{
    get
    {
        ...
        if (maximumPrice.field.FieldRepetitions != null && maximumPrice.field.FieldRepetitions.Count > 0)
        {
            ...
            maximumPrice.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(maximumPrice, fieldData);
        }
...
internal HL7V28Field effectiveStartDate;
...
public HL7V28Field EffectiveStartDate
{
    get
    {
        ...
        effectiveStartDate = new HL7V28Field
        {
        ...
        if (effectiveStartDate.field.FieldRepetitions != null && effectiveStartDate.field.FieldRepetitions.Count > 0)
        {
            ...
            effectiveStartDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(effectiveStartDate, fieldData);
        }
...
internal HL7V28Field effectiveEndDate;
...
public HL7V28Field EffectiveEndDate
{
    get
    {
        ...
        effectiveEndDate = new HL7V28Field
        {
        ...
        if (effectiveEndDate.field.FieldRepetitions != null && effectiveEndDate.field.FieldRepetitions.Count > 0)
        {
            ...
            effectiveEndDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(effectiveEndDate, fieldData);
        }
...
internal HL7V28Field priceOverrideFlag;
...
public HL7V28Field PriceOverrideFlag
{
    get
    {
        ...
        priceOverrideFlag = new HL7V28Field
        {
        ...
        if (priceOverrideFlag.field.FieldRepetitions != null && priceOverrideFlag.field.FieldRepetitions.Count > 0)
        {
            ...
            priceOverrideFlag.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(priceOverrideFlag, fieldData);
        }
...
internal HL7V28Field billingCategory;
...
public HL7V28Field BillingCategory
{
    get
    {
        ...
        billingCategory = new HL7V28Field
        {
        ...
        if (billingCategory.field.FieldRepetitions != null && billingCategory.field.FieldRepetitions.Count > 0)
        {
            ...
            billingCategory.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(billingCategory, fieldData);
        }
...
internal HL7V28Field chargeableFlag;
...
public HL7V28Field ChargeableFlag
{
    get
    {
        ...
        chargeableFlag = new HL7V28Field
        {
...
Y- item is billable (this is also the default when NULL)",
        ...
        if (chargeableFlag.field.FieldRepetitions != null && chargeableFlag.field.FieldRepetitions.Count > 0)
        {
            ...
            chargeableFlag.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(chargeableFlag, fieldData);
        }
...
public HL7V28Field Cost
{
    get
    {
        ...
        if (cost.field.FieldRepetitions != null && cost.field.FieldRepetitions.Count > 0)
        {
            ...
            cost.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(cost, fieldData);
        }
...
internal HL7V28Field chargeOnIndicator;
...
public HL7V28Field ChargeOnIndicator
{
    get
    {
        ...
        chargeOnIndicator = new HL7V28Field
        {
        ...
        if (chargeOnIndicator.field.FieldRepetitions != null && chargeOnIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            chargeOnIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(chargeOnIndicator, fieldData);
        }
