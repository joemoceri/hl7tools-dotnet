...
public HL7V28Field StudyPhaseIdentifier
{
    get
    {
        ...
        if (studyPhaseIdentifier.field.FieldRepetitions != null && studyPhaseIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            studyPhaseIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(studyPhaseIdentifier, fieldData);
        }
...
internal HL7V28Field dateTimeStudyPhaseBegan;
...
public HL7V28Field DateTimeStudyPhaseBegan
{
    get
    {
        ...
        dateTimeStudyPhaseBegan = new HL7V28Field
        {
            field = message[@"CSP"][2],
            Id = @"CSP.2",
            Type = @"Field",
        ...
        if (dateTimeStudyPhaseBegan.field.FieldRepetitions != null && dateTimeStudyPhaseBegan.field.FieldRepetitions.Count > 0)
        {
            ...
            dateTimeStudyPhaseBegan.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(dateTimeStudyPhaseBegan, fieldData);
        }
...
internal HL7V28Field dateTimeStudyPhaseEnded;
...
public HL7V28Field DateTimeStudyPhaseEnded
{
    get
    {
        ...
        dateTimeStudyPhaseEnded = new HL7V28Field
        {
            field = message[@"CSP"][3],
            Id = @"CSP.3",
            Type = @"Field",
        ...
        if (dateTimeStudyPhaseEnded.field.FieldRepetitions != null && dateTimeStudyPhaseEnded.field.FieldRepetitions.Count > 0)
        {
            ...
            dateTimeStudyPhaseEnded.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(dateTimeStudyPhaseEnded, fieldData);
        }
...
internal HL7V28Field studyPhaseEvaluability;
...
public HL7V28Field StudyPhaseEvaluability
{
    get
    {
        ...
        studyPhaseEvaluability = new HL7V28Field
        {
            field = message[@"CSP"][4],
            Id = @"CSP.4",
            Type = @"Field",
        ...
        if (studyPhaseEvaluability.field.FieldRepetitions != null && studyPhaseEvaluability.field.FieldRepetitions.Count > 0)
        {
            ...
            studyPhaseEvaluability.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(studyPhaseEvaluability, fieldData);
        }
