...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V28SegmentFTS
    {
        ...
        internal HL7V28Field _fileBatchCount;
...
public HL7V28Field FileBatchCount
{
    get
    {
        ...
        _fileBatchCount = new HL7V28Field
        {
            field = message[@"FTS"][1],
            fieldData = fieldData
        };
        ...
        {
            _fileBatchCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_fileBatchCount, fieldData);
        }
...
internal HL7V28Field _fileTrailerComment;
...
public HL7V28Field FileTrailerComment
{
    get
    {
        ...
        _fileTrailerComment = new HL7V28Field
        {
            field = message[@"FTS"][2],
            fieldData = fieldData
        };
        ...
        {
            _fileTrailerComment.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_fileTrailerComment, fieldData);
        }
