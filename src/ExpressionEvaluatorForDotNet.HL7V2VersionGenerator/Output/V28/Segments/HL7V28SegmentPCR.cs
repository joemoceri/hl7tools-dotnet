...
Value set version ID is required if CWE.21 is populated.",
        ...
        internal HL7V28Field implicatedProduct;
...
public HL7V28Field ImplicatedProduct
{
    get
    {
        ...
        implicatedProduct = new HL7V28Field
        {
            field = message[@"PCR"][1],
            Id = @"PCR.1",
            Type = @"Field",
        ...
        if (implicatedProduct.field.FieldRepetitions != null && implicatedProduct.field.FieldRepetitions.Count > 0)
        {
            ...
            implicatedProduct.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(implicatedProduct, fieldData);
        }
...
internal HL7V28Field genericProduct;
...
public HL7V28Field GenericProduct
{
    get
    {
        ...
        genericProduct = new HL7V28Field
        {
            field = message[@"PCR"][2],
            Id = @"PCR.2",
            Type = @"Field",
        ...
        if (genericProduct.field.FieldRepetitions != null && genericProduct.field.FieldRepetitions.Count > 0)
        {
            ...
            genericProduct.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(genericProduct, fieldData);
        }
...
internal HL7V28Field productClass;
...
public HL7V28Field ProductClass
{
    get
    {
        ...
        if (productClass.field.FieldRepetitions != null && productClass.field.FieldRepetitions.Count > 0)
        {
            ...
            productClass.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(productClass, fieldData);
        }
...
internal HL7V28Field totalDurationOfTherapy;
...
public HL7V28Field TotalDurationOfTherapy
{
    get
    {
        ...
        totalDurationOfTherapy = new HL7V28Field
        {
            field = message[@"PCR"][4],
            Id = @"PCR.4",
            Type = @"Field",
        ...
        if (totalDurationOfTherapy.field.FieldRepetitions != null && totalDurationOfTherapy.field.FieldRepetitions.Count > 0)
        {
            ...
            totalDurationOfTherapy.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(totalDurationOfTherapy, fieldData);
        }
...
internal HL7V28Field productManufactureDate;
...
public HL7V28Field ProductManufactureDate
{
    get
    {
        ...
        productManufactureDate = new HL7V28Field
        {
            field = message[@"PCR"][5],
            Id = @"PCR.5",
            Type = @"Field",
        ...
        if (productManufactureDate.field.FieldRepetitions != null && productManufactureDate.field.FieldRepetitions.Count > 0)
        {
            ...
            productManufactureDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(productManufactureDate, fieldData);
        }
...
internal HL7V28Field productExpirationDate;
...
public HL7V28Field ProductExpirationDate
{
    get
    {
        ...
        productExpirationDate = new HL7V28Field
        {
            field = message[@"PCR"][6],
            Id = @"PCR.6",
            Type = @"Field",
        ...
        if (productExpirationDate.field.FieldRepetitions != null && productExpirationDate.field.FieldRepetitions.Count > 0)
        {
            ...
            productExpirationDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(productExpirationDate, fieldData);
        }
...
internal HL7V28Field productImplantationDate;
...
public HL7V28Field ProductImplantationDate
{
    get
    {
        ...
        productImplantationDate = new HL7V28Field
        {
            field = message[@"PCR"][7],
            Id = @"PCR.7",
            Type = @"Field",
        ...
        if (productImplantationDate.field.FieldRepetitions != null && productImplantationDate.field.FieldRepetitions.Count > 0)
        {
            ...
            productImplantationDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(productImplantationDate, fieldData);
        }
...
internal HL7V28Field productExplantationDate;
...
public HL7V28Field ProductExplantationDate
{
    get
    {
        ...
        productExplantationDate = new HL7V28Field
        {
            field = message[@"PCR"][8],
            Id = @"PCR.8",
            Type = @"Field",
        ...
        if (productExplantationDate.field.FieldRepetitions != null && productExplantationDate.field.FieldRepetitions.Count > 0)
        {
            ...
            productExplantationDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(productExplantationDate, fieldData);
        }
...
internal HL7V28Field singleUseDevice;
...
public HL7V28Field SingleUseDevice
{
    get
    {
        ...
        singleUseDevice = new HL7V28Field
        {
            field = message[@"PCR"][9],
            Id = @"PCR.9",
            Type = @"Field",
        ...
        if (singleUseDevice.field.FieldRepetitions != null && singleUseDevice.field.FieldRepetitions.Count > 0)
        {
            ...
            singleUseDevice.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(singleUseDevice, fieldData);
        }
...
internal HL7V28Field indicationForProductUse;
...
public HL7V28Field IndicationForProductUse
{
    get
    {
        ...
        indicationForProductUse = new HL7V28Field
        {
        ...
        if (indicationForProductUse.field.FieldRepetitions != null && indicationForProductUse.field.FieldRepetitions.Count > 0)
        {
            ...
            indicationForProductUse.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(indicationForProductUse, fieldData);
        }
...
internal HL7V28Field productProblem;
...
public HL7V28Field ProductProblem
{
    get
    {
        ...
        productProblem = new HL7V28Field
        {
        ...
        if (productProblem.field.FieldRepetitions != null && productProblem.field.FieldRepetitions.Count > 0)
        {
            ...
            productProblem.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(productProblem, fieldData);
        }
...
internal HL7V28Field productSerialLotNumber;
...
public HL7V28Field ProductSerialLotNumber
{
    get
    {
        ...
        productSerialLotNumber = new HL7V28Field
        {
        ...
        if (productSerialLotNumber.field.FieldRepetitions != null && productSerialLotNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            productSerialLotNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(productSerialLotNumber, fieldData);
        }
...
internal HL7V28Field productAvailableForInspection;
...
public HL7V28Field ProductAvailableForInspection
{
    get
    {
        ...
        productAvailableForInspection = new HL7V28Field
        {
        ...
        if (productAvailableForInspection.field.FieldRepetitions != null && productAvailableForInspection.field.FieldRepetitions.Count > 0)
        {
            ...
            productAvailableForInspection.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(productAvailableForInspection, fieldData);
        }
...
internal HL7V28Field productEvaluationPerformed;
...
public HL7V28Field ProductEvaluationPerformed
{
    get
    {
        ...
        productEvaluationPerformed = new HL7V28Field
        {
        ...
        if (productEvaluationPerformed.field.FieldRepetitions != null && productEvaluationPerformed.field.FieldRepetitions.Count > 0)
        {
            ...
            productEvaluationPerformed.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(productEvaluationPerformed, fieldData);
        }
...
internal HL7V28Field productEvaluationStatus;
...
public HL7V28Field ProductEvaluationStatus
{
    get
    {
        ...
        productEvaluationStatus = new HL7V28Field
        {
        ...
        if (productEvaluationStatus.field.FieldRepetitions != null && productEvaluationStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            productEvaluationStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(productEvaluationStatus, fieldData);
        }
...
internal HL7V28Field productEvaluationResults;
...
public HL7V28Field ProductEvaluationResults
{
    get
    {
        ...
        productEvaluationResults = new HL7V28Field
        {
        ...
        if (productEvaluationResults.field.FieldRepetitions != null && productEvaluationResults.field.FieldRepetitions.Count > 0)
        {
            ...
            productEvaluationResults.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(productEvaluationResults, fieldData);
        }
...
internal HL7V28Field evaluatedProductSource;
...
public HL7V28Field EvaluatedProductSource
{
    get
    {
        ...
        evaluatedProductSource = new HL7V28Field
        {
        ...
        if (evaluatedProductSource.field.FieldRepetitions != null && evaluatedProductSource.field.FieldRepetitions.Count > 0)
        {
            ...
            evaluatedProductSource.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(evaluatedProductSource, fieldData);
        }
...
internal HL7V28Field dateProductReturnedToManufacturer;
...
public HL7V28Field DateProductReturnedToManufacturer
{
    get
    {
        ...
        dateProductReturnedToManufacturer = new HL7V28Field
        {
        ...
        if (dateProductReturnedToManufacturer.field.FieldRepetitions != null && dateProductReturnedToManufacturer.field.FieldRepetitions.Count > 0)
        {
            ...
            dateProductReturnedToManufacturer.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(dateProductReturnedToManufacturer, fieldData);
        }
...
internal HL7V28Field deviceOperatorQualifications;
...
public HL7V28Field DeviceOperatorQualifications
{
    get
    {
        ...
        deviceOperatorQualifications = new HL7V28Field
        {
        ...
        if (deviceOperatorQualifications.field.FieldRepetitions != null && deviceOperatorQualifications.field.FieldRepetitions.Count > 0)
        {
            ...
            deviceOperatorQualifications.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(deviceOperatorQualifications, fieldData);
        }
...
internal HL7V28Field relatednessAssessment;
...
public HL7V28Field RelatednessAssessment
{
    get
    {
        ...
        relatednessAssessment = new HL7V28Field
        {
        ...
        if (relatednessAssessment.field.FieldRepetitions != null && relatednessAssessment.field.FieldRepetitions.Count > 0)
        {
            ...
            relatednessAssessment.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(relatednessAssessment, fieldData);
        }
...
internal HL7V28Field actionTakenInResponseToTheEvent;
...
public HL7V28Field ActionTakenInResponseToTheEvent
{
    get
    {
        ...
        actionTakenInResponseToTheEvent = new HL7V28Field
        {
        ...
        if (actionTakenInResponseToTheEvent.field.FieldRepetitions != null && actionTakenInResponseToTheEvent.field.FieldRepetitions.Count > 0)
        {
            ...
            actionTakenInResponseToTheEvent.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(actionTakenInResponseToTheEvent, fieldData);
        }
...
internal HL7V28Field eventCausalityObservations;
...
public HL7V28Field EventCausalityObservations
{
    get
    {
        ...
        eventCausalityObservations = new HL7V28Field
        {
        ...
        if (eventCausalityObservations.field.FieldRepetitions != null && eventCausalityObservations.field.FieldRepetitions.Count > 0)
        {
            ...
            eventCausalityObservations.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(eventCausalityObservations, fieldData);
        }
...
internal HL7V28Field indirectExposureMechanism;
...
public HL7V28Field IndirectExposureMechanism
{
    get
    {
        ...
        indirectExposureMechanism = new HL7V28Field
        {
        ...
        if (indirectExposureMechanism.field.FieldRepetitions != null && indirectExposureMechanism.field.FieldRepetitions.Count > 0)
        {
            ...
            indirectExposureMechanism.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(indirectExposureMechanism, fieldData);
        }
