...
Value set version ID is required if CWE.21 is populated.",
        ...
        public HL7V28SegmentPCE(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V28Field setIdPce;

public HL7V28Field SetIdPce
{
    get
    {
        if (setIdPce != null)
