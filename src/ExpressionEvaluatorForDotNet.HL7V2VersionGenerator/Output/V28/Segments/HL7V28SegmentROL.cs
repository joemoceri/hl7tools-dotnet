...
The positional location of the ROL segment in ADT and Finance messages indicates the relationship.  When the segment is used following the IN3 segment, and the role-ROL value is PP or FHCP, the PP or FHCP is related to the health plan.  When the segment is used following the PID segment, and the role-ROL value is PP or FHCP, the PP or FHCP is related to the person.  When the segment is used following the PV2 segment, and the role-ROL value is PCP or FHCP, the PP or FHCP is related to the patient visit."; } }
        ...
        internal HL7V28Field _roleInstanceId;
...
By site agreement, implementers may continue to use User-defined Table 0300 – Namespace ID for the first component",
        ...
        _roleInstanceId = new HL7V28Field
        {
            field = message[@"ROL"][1],
            fieldData = fieldData
        };
        ...
        {
            _roleInstanceId.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_roleInstanceId, fieldData);
        }
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _rolerol.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_rolerol, fieldData);
        }
...
internal HL7V28Field _rolePerson;
...
Refer to HL7 Table 0904 - Security Check Scheme for valid values",
        ...
        {
            _rolePerson.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_rolePerson, fieldData);
        }
...
internal HL7V28Field _roleBeginDateTime;
...
public HL7V28Field RoleBeginDateTime
{
    get
    {
        ...
        _roleBeginDateTime = new HL7V28Field
        {
            field = message[@"ROL"][5],
            fieldData = fieldData
        };
        ...
        {
            _roleBeginDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_roleBeginDateTime, fieldData);
        }
...
internal HL7V28Field _roleEndDateTime;
...
public HL7V28Field RoleEndDateTime
{
    get
    {
        ...
        _roleEndDateTime = new HL7V28Field
        {
            field = message[@"ROL"][6],
            fieldData = fieldData
        };
        ...
        {
            _roleEndDateTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_roleEndDateTime, fieldData);
        }
...
internal HL7V28Field _roleDuration;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _roleDuration.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_roleDuration, fieldData);
        }
...
internal HL7V28Field _roleActionReason;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _roleActionReason = new HL7V28Field
        {
            field = message[@"ROL"][8],
            fieldData = fieldData
        };
        ...
        {
            _roleActionReason.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_roleActionReason, fieldData);
        }
...
internal HL7V28Field _providerType;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _providerType.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_providerType, fieldData);
        }
...
internal HL7V28Field _organizationUnitType;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _organizationUnitType = new HL7V28Field
        {
        ...
        {
            _organizationUnitType.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_organizationUnitType, fieldData);
        }
...
internal HL7V28Field _officeHomeAddressBirthplace;
...
By site agreement, implementers may continue to use User-defined Table 0300 – Namespace ID for the first component",
        ...
        _officeHomeAddressBirthplace = new HL7V28Field
        {
        ...
        {
            _officeHomeAddressBirthplace.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_officeHomeAddressBirthplace, fieldData);
        }
...
Preference order numbers need not be sequential (i.e., three numbers with the priority orders of 0, 5 and 15 are legitimate).  The preference order numbers must be non-negative.",
        ...
        {
            _phone.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_phone, fieldData);
        }
...
internal HL7V28Field _personsLocation;
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _personsLocation = new HL7V28Field
        {
        ...
        {
            _personsLocation.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_personsLocation, fieldData);
        }
...
internal HL7V28Field _organization;
...
Note: The check digit and code identifying check digit scheme are null if Organization identifier is alphanumeric.",
        ...
        // check for repetitions
        if (_organization.field.FieldRepetitions != null && _organization.field.FieldRepetitions.Count > 0)
        {
            _organization.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_organization, fieldData);
        }
