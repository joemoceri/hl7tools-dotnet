...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V28SegmentBLC
    {
        ...
        public HL7V28SegmentBLC(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V28Field _bloodProductCode;

public HL7V28Field BloodProductCode
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _bloodProductCode = new HL7V28Field
        {
            field = message[@"BLC"][1],
            fieldData = fieldData
        };
        ...
        {
            _bloodProductCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_bloodProductCode, fieldData);
        }
...
internal HL7V28Field _bloodAmount;

public HL7V28Field BloodAmount
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        {
            _bloodAmount.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_bloodAmount, fieldData);
        }
