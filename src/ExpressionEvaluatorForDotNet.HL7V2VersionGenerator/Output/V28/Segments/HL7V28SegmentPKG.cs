...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V28SegmentPKG
    {
        ...
        internal HL7V28Field _setIdPkg;
...
public HL7V28Field SetIdPkg
{
    get
    {
        ...
        {
            _setIdPkg.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_setIdPkg, fieldData);
        }
...
internal HL7V28Field _packagingUnits;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _packagingUnits = new HL7V28Field
        {
            field = message[@"PKG"][2],
            fieldData = fieldData
        };
        ...
        {
            _packagingUnits.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_packagingUnits, fieldData);
        }
...
internal HL7V28Field _defaultOrderUnitOfMeasureIndicator;
...
Value set version ID is required if CNE.21 is populated.",
        ...
        _defaultOrderUnitOfMeasureIndicator = new HL7V28Field
        {
            field = message[@"PKG"][3],
            fieldData = fieldData
        };
        ...
        {
            _defaultOrderUnitOfMeasureIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_defaultOrderUnitOfMeasureIndicator, fieldData);
        }
...
internal HL7V28Field _packageQuantity;
...
public HL7V28Field PackageQuantity
{
    get
    {
        ...
        _packageQuantity = new HL7V28Field
        {
            field = message[@"PKG"][4],
            fieldData = fieldData
        };
        ...
        {
            _packageQuantity.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_packageQuantity, fieldData);
        }
...
internal HL7V28Field _futureItemPrice;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _futureItemPrice = new HL7V28Field
        {
            field = message[@"PKG"][6],
            fieldData = fieldData
        };
        ...
        {
            _futureItemPrice.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_futureItemPrice, fieldData);
        }
...
internal HL7V28Field _futureItemPriceEffectiveDate;
...
public HL7V28Field FutureItemPriceEffectiveDate
{
    get
    {
        ...
        _futureItemPriceEffectiveDate = new HL7V28Field
        {
            field = message[@"PKG"][7],
            fieldData = fieldData
        };
        ...
        {
            _futureItemPriceEffectiveDate.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_futureItemPriceEffectiveDate, fieldData);
        }
...
internal HL7V28Field _globalTradeItemNumber;

public HL7V28Field GlobalTradeItemNumber
{
    get
    {
        if (_globalTradeItemNumber != null)
        {
            return _globalTradeItemNumber;
        }
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _globalTradeItemNumber = new HL7V28Field
        {
            field = message[@"PKG"][8],
            fieldData = fieldData
        };
        ...
        // check for repetitions
        if (_globalTradeItemNumber.field.FieldRepetitions != null && _globalTradeItemNumber.field.FieldRepetitions.Count > 0)
        {
            _globalTradeItemNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_globalTradeItemNumber, fieldData);
        }
