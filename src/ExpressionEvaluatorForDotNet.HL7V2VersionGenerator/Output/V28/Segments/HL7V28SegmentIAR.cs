...
public HL7V28Field AllergyReactionCode
{
    get
    {
        ...
        if (allergyReactionCode.field.FieldRepetitions != null && allergyReactionCode.field.FieldRepetitions.Count > 0)
        {
            ...
            allergyReactionCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(allergyReactionCode, fieldData);
        }
...
public HL7V28Field AllergySeverityCode
{
    get
    {
        ...
        if (allergySeverityCode.field.FieldRepetitions != null && allergySeverityCode.field.FieldRepetitions.Count > 0)
        {
            ...
            allergySeverityCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(allergySeverityCode, fieldData);
        }
...
public HL7V28Field SensitivityToCausativeAgentCode
{
    get
    {
        ...
        if (sensitivityToCausativeAgentCode.field.FieldRepetitions != null && sensitivityToCausativeAgentCode.field.FieldRepetitions.Count > 0)
        {
            ...
            sensitivityToCausativeAgentCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(sensitivityToCausativeAgentCode, fieldData);
        }
...
public HL7V28Field Management
{
    get
    {
        ...
        if (management.field.FieldRepetitions != null && management.field.FieldRepetitions.Count > 0)
        {
            ...
            management.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(management, fieldData);
        }
