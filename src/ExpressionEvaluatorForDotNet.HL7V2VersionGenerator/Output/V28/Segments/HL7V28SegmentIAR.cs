...
internal HL7V28Field _sensitivityToCausativeAgentCode;
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _sensitivityToCausativeAgentCode = new HL7V28Field
        {
            field = message[@"IAR"][3],
            fieldData = fieldData
        };
        ...
        {
            _sensitivityToCausativeAgentCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_sensitivityToCausativeAgentCode, fieldData);
        }
...
internal HL7V28Field _management;
...
public HL7V28Field Management
{
    get
    {
        ...
        {
            _management.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_management, fieldData);
        }
