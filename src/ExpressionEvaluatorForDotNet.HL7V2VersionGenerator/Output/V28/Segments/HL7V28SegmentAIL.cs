...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V28SegmentAIL
    {
        ...
        public HL7V28SegmentAIL(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V28Field _setIdAil;

public HL7V28Field SetIdAil
{
    get
    {
        if (_setIdAil != null)
        ...
        {
            _setIdAil.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_setIdAil, fieldData);
        }
...
internal HL7V28Field _locationResourceId;

public HL7V28Field LocationResourceId
{
    get
    {
...
Note: When the HD is used in a given segment (either as a field or as a component of another data type) this table may be re-defined (given a different user-defined table number and name) by the technical committee responsible for that segment.",
        ...
        _locationResourceId = new HL7V28Field
        {
            field = message[@"AIL"][3],
            fieldData = fieldData
        };
        ...
        {
            _locationResourceId.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_locationResourceId, fieldData);
        }
...
internal HL7V28Field _locationTypeAil;

public HL7V28Field LocationTypeAil
{
    get
    {
        ...
        var fieldData = new HL7V28FieldData
        {
            ...
            TableId = @"0305",
            TableName = @"Person Location Type",
            Description = @"This field identifies the type of the location requested/scheduled for this appointment.    For all messages, this field is conditionally required if a specific location is not identified in AIL-3-Location resource ID.  Refer to HL7 Table 0305 – Person Location Type in Chapter 2C, Code Tables, for suggested values.",
            Sample = @"",
            Fields = new[]
                        {
                            new HL7V2FieldData
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _locationTypeAil = new HL7V28Field
        {
            field = message[@"AIL"][4],
            fieldData = fieldData
        };
        ...
        {
            _locationTypeAil.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_locationTypeAil, fieldData);
        }
...
internal HL7V28Field _locationGroup;

public HL7V28Field LocationGroup
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _locationGroup = new HL7V28Field
        {
            field = message[@"AIL"][5],
            fieldData = fieldData
        };
        ...
        {
            _locationGroup.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_locationGroup, fieldData);
        }
...
public HL7V28Field AllowSubstitutionCode
{
    get
    {
        ...
        var fieldData = new HL7V28FieldData
        {
            ...
            Description = @"This field contains a code indicating whether the identified location can be replaced with an equivalent substitute location by the filler application.  Refer to User-Defined Table 0279 - Allow Substitution Codes in Chapter 2C, Code Tables, for suggested values.
...
public HL7V28Field FillerStatusCode
{
    get
    {
        ...
        var fieldData = new HL7V28FieldData
        {
            ...
            Description = @"This field contains a code that describes the requested/scheduled status of the location, from the point of view of the filler application.  Refer to User-Defined Table 0278 - Filler Status Codes in Chapter 2C, Code Tables, for suggested values.
