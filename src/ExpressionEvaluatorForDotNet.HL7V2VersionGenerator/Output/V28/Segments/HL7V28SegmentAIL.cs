...
public HL7V28Field SetIdAil
{
    get
    {
        ...
        if (setIdAil.field.FieldRepetitions != null && setIdAil.field.FieldRepetitions.Count > 0)
        {
            ...
            setIdAil.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(setIdAil, fieldData);
        }
...
This field is required for all unsolicited transactions from the filler application.  It is optional for all query transactions.",
        ...
        if (locationResourceId.field.FieldRepetitions != null && locationResourceId.field.FieldRepetitions.Count > 0)
        {
            ...
            locationResourceId.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(locationResourceId, fieldData);
        }
...
public HL7V28Field LocationTypeAil
{
    get
    {
        ...
        if (locationTypeAil.field.FieldRepetitions != null && locationTypeAil.field.FieldRepetitions.Count > 0)
        {
            ...
            locationTypeAil.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(locationTypeAil, fieldData);
        }
...
public HL7V28Field LocationGroup
{
    get
    {
        ...
        if (locationGroup.field.FieldRepetitions != null && locationGroup.field.FieldRepetitions.Count > 0)
        {
            ...
            locationGroup.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(locationGroup, fieldData);
        }
