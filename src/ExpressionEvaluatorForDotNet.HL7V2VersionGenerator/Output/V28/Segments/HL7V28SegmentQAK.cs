...
internal HL7V28Field queryResponseStatus;
...
public HL7V28Field QueryResponseStatus
{
    get
    {
        ...
        queryResponseStatus = new HL7V28Field
        {
            field = message[@"QAK"][2],
            Id = @"QAK.2",
            Type = @"Field",
        ...
        if (queryResponseStatus.field.FieldRepetitions != null && queryResponseStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            queryResponseStatus.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(queryResponseStatus, fieldData);
        }
...
internal HL7V28Field hitCountTotal;
...
public HL7V28Field HitCountTotal
{
    get
    {
        ...
        if (hitCountTotal.field.FieldRepetitions != null && hitCountTotal.field.FieldRepetitions.Count > 0)
        {
            ...
            hitCountTotal.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(hitCountTotal, fieldData);
        }
...
internal HL7V28Field thisPayload;
...
public HL7V28Field ThisPayload
{
    get
    {
        ...
        if (thisPayload.field.FieldRepetitions != null && thisPayload.field.FieldRepetitions.Count > 0)
        {
            ...
            thisPayload.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(thisPayload, fieldData);
        }
...
internal HL7V28Field hitsRemaining;
...
public HL7V28Field HitsRemaining
{
    get
    {
        ...
        if (hitsRemaining.field.FieldRepetitions != null && hitsRemaining.field.FieldRepetitions.Count > 0)
        {
            ...
            hitsRemaining.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(hitsRemaining, fieldData);
        }
