...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V28SegmentRDT
    {
        ...
        internal HL7V28Field columnValue;
...
public HL7V28Field ColumnValue
{
    get
    {
        ...
        if (columnValue.field.FieldRepetitions != null && columnValue.field.FieldRepetitions.Count > 0)
        {
            ...
            columnValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(columnValue, fieldData);
        }
