...
namespace ExpressionEvaluatorForDotNet
{
    public class HL7V28SegmentRDT
    {
        ...
        public HL7V28SegmentRDT(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V28Field _columnValue;

public HL7V28Field ColumnValue
{
    get
    {
        ...
        {
            _columnValue.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_columnValue, fieldData);
        }
