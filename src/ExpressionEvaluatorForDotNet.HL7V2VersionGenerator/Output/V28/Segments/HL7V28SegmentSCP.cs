...
public HL7V28Field NumberOfDecontaminationSterilizationDevices
{
    get
    {
        ...
        if (numberOfDecontaminationSterilizationDevices.field.FieldRepetitions != null && numberOfDecontaminationSterilizationDevices.field.FieldRepetitions.Count > 0)
        {
            ...
            numberOfDecontaminationSterilizationDevices.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(numberOfDecontaminationSterilizationDevices, fieldData);
        }
...
public HL7V28Field LaborCalculationType
{
    get
    {
        ...
        if (laborCalculationType.field.FieldRepetitions != null && laborCalculationType.field.FieldRepetitions.Count > 0)
        {
            ...
            laborCalculationType.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(laborCalculationType, fieldData);
        }
...
public HL7V28Field DateFormat
{
    get
    {
        ...
        if (dateFormat.field.FieldRepetitions != null && dateFormat.field.FieldRepetitions.Count > 0)
        {
            ...
            dateFormat.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(dateFormat, fieldData);
        }
...
public HL7V28Field DeviceNumber
{
    get
    {
        ...
        if (deviceNumber.field.FieldRepetitions != null && deviceNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            deviceNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(deviceNumber, fieldData);
        }
...
public HL7V28Field DeviceName
{
    get
    {
        ...
        if (deviceName.field.FieldRepetitions != null && deviceName.field.FieldRepetitions.Count > 0)
        {
            ...
            deviceName.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(deviceName, fieldData);
        }
...
public HL7V28Field DeviceModelName
{
    get
    {
        ...
        if (deviceModelName.field.FieldRepetitions != null && deviceModelName.field.FieldRepetitions.Count > 0)
        {
            ...
            deviceModelName.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(deviceModelName, fieldData);
        }
...
public HL7V28Field DeviceType
{
    get
    {
        ...
        if (deviceType.field.FieldRepetitions != null && deviceType.field.FieldRepetitions.Count > 0)
        {
            ...
            deviceType.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(deviceType, fieldData);
        }
...
public HL7V28Field LotControl
{
    get
    {
        ...
        if (lotControl.field.FieldRepetitions != null && lotControl.field.FieldRepetitions.Count > 0)
        {
            ...
            lotControl.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(lotControl, fieldData);
        }
