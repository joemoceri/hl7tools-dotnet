...
The processing rules for the ERR segment are outside of HL7's scope."; } }
        ...
        public HL7V28SegmentUAC(HL7V2Message message)
        {
            this.message = message;
        }

        internal HL7V28Field _userAuthenticationCredentialTypeCode;

public HL7V28Field UserAuthenticationCredentialTypeCode
{
    get
    {
...
Value set version ID is required if CWE.21 is populated.",
        ...
        _userAuthenticationCredentialTypeCode = new HL7V28Field
        {
            field = message[@"UAC"][1],
            fieldData = fieldData
        };
        ...
        {
            _userAuthenticationCredentialTypeCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_userAuthenticationCredentialTypeCode, fieldData);
        }
...
internal HL7V28Field _userAuthenticationCredential;

public HL7V28Field UserAuthenticationCredential
{
    get
    {
...
If the encoding component ED.4 does not equal ""A"", then, after encoding, the (encoded) data must be scanned for HL7 delimiter characters, and any found must be escaped by using the HL7 escape sequences. Only then can the component be added to the HL7 segment/message. On the receiving application, the data field must be de-escaped after being parsed out of the message before being decoded. This can be expressed as ""encode"", ""escape"", ""parse"", ""de-escape"" or ""decode"".",
        ...
        _userAuthenticationCredential = new HL7V28Field
        {
            field = message[@"UAC"][2],
            fieldData = fieldData
        };
        ...
        {
            _userAuthenticationCredential.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(_userAuthenticationCredential, fieldData);
        }
