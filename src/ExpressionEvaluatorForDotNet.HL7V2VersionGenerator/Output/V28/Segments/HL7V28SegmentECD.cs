...
public HL7V28Field ReferenceCommandNumber
{
    get
    {
        ...
        if (referenceCommandNumber.field.FieldRepetitions != null && referenceCommandNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            referenceCommandNumber.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(referenceCommandNumber, fieldData);
        }
...
public HL7V28Field RemoteControlCommand
{
    get
    {
        ...
        if (remoteControlCommand.field.FieldRepetitions != null && remoteControlCommand.field.FieldRepetitions.Count > 0)
        {
            ...
            remoteControlCommand.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(remoteControlCommand, fieldData);
        }
...
public HL7V28Field ResponseRequired
{
    get
    {
        ...
        if (responseRequired.field.FieldRepetitions != null && responseRequired.field.FieldRepetitions.Count > 0)
        {
            ...
            responseRequired.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(responseRequired, fieldData);
        }
...
public HL7V28Field RequestedCompletionTime
{
    get
    {
        ...
        if (requestedCompletionTime.field.FieldRepetitions != null && requestedCompletionTime.field.FieldRepetitions.Count > 0)
        {
            ...
            requestedCompletionTime.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(requestedCompletionTime, fieldData);
        }
...
Note: Elements of this segment (or other elements not defined here) may be required for certain vendor-specific equipment such as centrifuges, aliquoters, sorters, uncappers, recappers, automated storage units, etc.",
        ...
        if (parameters.field.FieldRepetitions != null && parameters.field.FieldRepetitions.Count > 0)
        {
            ...
            parameters.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(parameters, fieldData);
        }
