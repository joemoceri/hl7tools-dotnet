...
|PLASTIC SILVERWARE|.",
        ...
        public HL7V28SegmentODT(HL7V2Message message)
        {
            this.message = message;
        }

        
internal HL7V28Field trayType;

public HL7V28Field TrayType
{
    get
    {
        if (trayType != null)
