...
public HL7V28Field SetIdOrg
{
    get
    {
        ...
        if (setIdOrg.field.FieldRepetitions != null && setIdOrg.field.FieldRepetitions.Count > 0)
        {
            ...
            setIdOrg.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(setIdOrg, fieldData);
        }
...
public HL7V28Field OrganizationUnitCode
{
    get
    {
        ...
        if (organizationUnitCode.field.FieldRepetitions != null && organizationUnitCode.field.FieldRepetitions.Count > 0)
        {
            ...
            organizationUnitCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(organizationUnitCode, fieldData);
        }
...
public HL7V28Field OrganizationUnitTypeCode
{
    get
    {
        ...
        if (organizationUnitTypeCode.field.FieldRepetitions != null && organizationUnitTypeCode.field.FieldRepetitions.Count > 0)
        {
            ...
            organizationUnitTypeCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(organizationUnitTypeCode, fieldData);
        }
...
public HL7V28Field PrimaryOrgUnitIndicator
{
    get
    {
        ...
        if (primaryOrgUnitIndicator.field.FieldRepetitions != null && primaryOrgUnitIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryOrgUnitIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(primaryOrgUnitIndicator, fieldData);
        }
...
public HL7V28Field PractitionerOrgUnitIdentifier
{
    get
    {
        ...
        if (practitionerOrgUnitIdentifier.field.FieldRepetitions != null && practitionerOrgUnitIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            practitionerOrgUnitIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(practitionerOrgUnitIdentifier, fieldData);
        }
...
public HL7V28Field HealthCareProviderTypeCode
{
    get
    {
        ...
        if (healthCareProviderTypeCode.field.FieldRepetitions != null && healthCareProviderTypeCode.field.FieldRepetitions.Count > 0)
        {
            ...
            healthCareProviderTypeCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(healthCareProviderTypeCode, fieldData);
        }
...
public HL7V28Field HealthCareProviderClassificationCode
{
    get
    {
        ...
        if (healthCareProviderClassificationCode.field.FieldRepetitions != null && healthCareProviderClassificationCode.field.FieldRepetitions.Count > 0)
        {
            ...
            healthCareProviderClassificationCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(healthCareProviderClassificationCode, fieldData);
        }
...
public HL7V28Field HealthCareProviderAreaOfSpecializationCode
{
    get
    {
        ...
        if (healthCareProviderAreaOfSpecializationCode.field.FieldRepetitions != null && healthCareProviderAreaOfSpecializationCode.field.FieldRepetitions.Count > 0)
        {
            ...
            healthCareProviderAreaOfSpecializationCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(healthCareProviderAreaOfSpecializationCode, fieldData);
        }
...
public HL7V28Field EffectiveDateRange
{
    get
    {
        ...
        if (effectiveDateRange.field.FieldRepetitions != null && effectiveDateRange.field.FieldRepetitions.Count > 0)
        {
            ...
            effectiveDateRange.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(effectiveDateRange, fieldData);
        }
...
public HL7V28Field EmploymentStatusCode
{
    get
    {
        ...
        if (employmentStatusCode.field.FieldRepetitions != null && employmentStatusCode.field.FieldRepetitions.Count > 0)
        {
            ...
            employmentStatusCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(employmentStatusCode, fieldData);
        }
...
public HL7V28Field BoardApprovalIndicator
{
    get
    {
        ...
        if (boardApprovalIndicator.field.FieldRepetitions != null && boardApprovalIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            boardApprovalIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(boardApprovalIndicator, fieldData);
        }
...
public HL7V28Field PrimaryCarePhysicianIndicator
{
    get
    {
        ...
        if (primaryCarePhysicianIndicator.field.FieldRepetitions != null && primaryCarePhysicianIndicator.field.FieldRepetitions.Count > 0)
        {
            ...
            primaryCarePhysicianIndicator.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(primaryCarePhysicianIndicator, fieldData);
        }
...
public HL7V28Field CostCenterCode
{
    get
    {
        ...
        if (costCenterCode.field.FieldRepetitions != null && costCenterCode.field.FieldRepetitions.Count > 0)
        {
            ...
            costCenterCode.fieldRepetitions = HL7V2FieldGenerator.GenerateV28FieldRepetitions(costCenterCode, fieldData);
        }
