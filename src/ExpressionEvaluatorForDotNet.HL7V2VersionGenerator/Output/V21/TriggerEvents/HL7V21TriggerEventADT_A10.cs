...
{
    public class HL7V21TriggerEventADT_A10
    {
...
private readonly HL7V21SegmentDG1 dg1;


        public string Id { get { return @"ADT_A10"; } }
        public string MessageStructureId { get { return @"ADT_A10"; } }
        public string EventDescription { get { return @"Patient Arriving"; } }
        ...
        public HL7V21TriggerEventADT_A10(HL7V2Message message)
        {
