...
public HL7V21Field StatisticsAvailable
{
    get
    {
        ...
        if (statisticsAvailable.field.FieldRepetitions != null && statisticsAvailable.field.FieldRepetitions.Count > 0)
        {
            ...
            statisticsAvailable.fieldRepetitions = HL7V2FieldGenerator.GenerateV21FieldRepetitions(statisticsAvailable, fieldData);
        }
...
public HL7V21Field SourceIdentifier
{
    get
    {
        ...
        if (sourceIdentifier.field.FieldRepetitions != null && sourceIdentifier.field.FieldRepetitions.Count > 0)
        {
            ...
            sourceIdentifier.fieldRepetitions = HL7V2FieldGenerator.GenerateV21FieldRepetitions(sourceIdentifier, fieldData);
        }
...
public HL7V21Field SourceType
{
    get
    {
        ...
        if (sourceType.field.FieldRepetitions != null && sourceType.field.FieldRepetitions.Count > 0)
        {
            ...
            sourceType.fieldRepetitions = HL7V2FieldGenerator.GenerateV21FieldRepetitions(sourceType, fieldData);
        }
...
public HL7V21Field StatisticsStart
{
    get
    {
        ...
        if (statisticsStart.field.FieldRepetitions != null && statisticsStart.field.FieldRepetitions.Count > 0)
        {
            ...
            statisticsStart.fieldRepetitions = HL7V2FieldGenerator.GenerateV21FieldRepetitions(statisticsStart, fieldData);
        }
...
public HL7V21Field StatisticsEnd
{
    get
    {
        ...
        if (statisticsEnd.field.FieldRepetitions != null && statisticsEnd.field.FieldRepetitions.Count > 0)
        {
            ...
            statisticsEnd.fieldRepetitions = HL7V2FieldGenerator.GenerateV21FieldRepetitions(statisticsEnd, fieldData);
        }
...
public HL7V21Field ReceiveCharacterCount
{
    get
    {
        ...
        if (receiveCharacterCount.field.FieldRepetitions != null && receiveCharacterCount.field.FieldRepetitions.Count > 0)
        {
            ...
            receiveCharacterCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV21FieldRepetitions(receiveCharacterCount, fieldData);
        }
...
public HL7V21Field SendCharacterCount
{
    get
    {
        ...
        if (sendCharacterCount.field.FieldRepetitions != null && sendCharacterCount.field.FieldRepetitions.Count > 0)
        {
            ...
            sendCharacterCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV21FieldRepetitions(sendCharacterCount, fieldData);
        }
...
public HL7V21Field MessagesReceived
{
    get
    {
        ...
        if (messagesReceived.field.FieldRepetitions != null && messagesReceived.field.FieldRepetitions.Count > 0)
        {
            ...
            messagesReceived.fieldRepetitions = HL7V2FieldGenerator.GenerateV21FieldRepetitions(messagesReceived, fieldData);
        }
...
public HL7V21Field MessagesSent
{
    get
    {
        ...
        if (messagesSent.field.FieldRepetitions != null && messagesSent.field.FieldRepetitions.Count > 0)
        {
            ...
            messagesSent.fieldRepetitions = HL7V2FieldGenerator.GenerateV21FieldRepetitions(messagesSent, fieldData);
        }
...
public HL7V21Field ChecksumErrorsReceived
{
    get
    {
        ...
        if (checksumErrorsReceived.field.FieldRepetitions != null && checksumErrorsReceived.field.FieldRepetitions.Count > 0)
        {
            ...
            checksumErrorsReceived.fieldRepetitions = HL7V2FieldGenerator.GenerateV21FieldRepetitions(checksumErrorsReceived, fieldData);
        }
...
public HL7V21Field LengthErrorsReceived
{
    get
    {
        ...
        if (lengthErrorsReceived.field.FieldRepetitions != null && lengthErrorsReceived.field.FieldRepetitions.Count > 0)
        {
            ...
            lengthErrorsReceived.fieldRepetitions = HL7V2FieldGenerator.GenerateV21FieldRepetitions(lengthErrorsReceived, fieldData);
        }
...
public HL7V21Field OtherErrorsReceived
{
    get
    {
        ...
        if (otherErrorsReceived.field.FieldRepetitions != null && otherErrorsReceived.field.FieldRepetitions.Count > 0)
        {
            ...
            otherErrorsReceived.fieldRepetitions = HL7V2FieldGenerator.GenerateV21FieldRepetitions(otherErrorsReceived, fieldData);
        }
...
public HL7V21Field ConnectTimeouts
{
    get
    {
        ...
        if (connectTimeouts.field.FieldRepetitions != null && connectTimeouts.field.FieldRepetitions.Count > 0)
        {
            ...
            connectTimeouts.fieldRepetitions = HL7V2FieldGenerator.GenerateV21FieldRepetitions(connectTimeouts, fieldData);
        }
...
public HL7V21Field ReceiveTimeouts
{
    get
    {
        ...
        if (receiveTimeouts.field.FieldRepetitions != null && receiveTimeouts.field.FieldRepetitions.Count > 0)
        {
            ...
            receiveTimeouts.fieldRepetitions = HL7V2FieldGenerator.GenerateV21FieldRepetitions(receiveTimeouts, fieldData);
        }
...
public HL7V21Field NetworkErrors
{
    get
    {
        ...
        if (networkErrors.field.FieldRepetitions != null && networkErrors.field.FieldRepetitions.Count > 0)
        {
            ...
            networkErrors.fieldRepetitions = HL7V2FieldGenerator.GenerateV21FieldRepetitions(networkErrors, fieldData);
        }
