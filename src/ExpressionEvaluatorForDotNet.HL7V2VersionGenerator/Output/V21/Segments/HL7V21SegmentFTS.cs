...
public HL7V21Field FileBatchCount
{
    get
    {
        ...
        if (fileBatchCount.field.FieldRepetitions != null && fileBatchCount.field.FieldRepetitions.Count > 0)
        {
            ...
            fileBatchCount.fieldRepetitions = HL7V2FieldGenerator.GenerateV21FieldRepetitions(fileBatchCount, fieldData);
        }
...
public HL7V21Field FileTrailerComment
{
    get
    {
        ...
        if (fileTrailerComment.field.FieldRepetitions != null && fileTrailerComment.field.FieldRepetitions.Count > 0)
        {
            ...
            fileTrailerComment.fieldRepetitions = HL7V2FieldGenerator.GenerateV21FieldRepetitions(fileTrailerComment, fieldData);
        }
