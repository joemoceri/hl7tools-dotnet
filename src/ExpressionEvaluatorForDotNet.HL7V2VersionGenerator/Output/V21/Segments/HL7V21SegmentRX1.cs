...
public HL7V21Field Unused
{
    get
    {
        ...
        if (unused.field.FieldRepetitions != null && unused.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < unused.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V21FieldRepetition
                {
                    fieldRepetition = unused.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    for (var j = 0; j < unused.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V21Component
                        {
                            component = unused.field.FieldRepetitions[i].Components[j],
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < unused.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V21SubComponent
                                {
                                    subComponent = unused.field.FieldRepetitions[i].Components[j].SubComponents[k],
            ...
            unused.fieldRepetitions = fieldRepetitions;
        }
...
public HL7V21Field SiteAdministered
{
    get
    {
        ...
        if (siteAdministered.field.FieldRepetitions != null && siteAdministered.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < siteAdministered.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V21FieldRepetition
                {
                    fieldRepetition = siteAdministered.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < siteAdministered.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V21Component
                        {
                            component = siteAdministered.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < siteAdministered.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V21SubComponent
                                {
                                    subComponent = siteAdministered.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = subComponentFieldData.Id,
                                    Type = subComponentFieldData.Type,
                                    Position = subComponentFieldData.Position,
                                    Name = subComponentFieldData.Name,
            ...
            siteAdministered.fieldRepetitions = fieldRepetitions;
        }
...
public HL7V21Field IvSolutionRate
{
    get
    {
        ...
        if (ivSolutionRate.field.FieldRepetitions != null && ivSolutionRate.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < ivSolutionRate.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V21FieldRepetition
                {
                    fieldRepetition = ivSolutionRate.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < ivSolutionRate.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V21Component
                        {
                            component = ivSolutionRate.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < ivSolutionRate.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V21SubComponent
                                {
                                    subComponent = ivSolutionRate.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = subComponentFieldData.Id,
                                    Type = subComponentFieldData.Type,
                                    Position = subComponentFieldData.Position,
                                    Name = subComponentFieldData.Name,
            ...
            ivSolutionRate.fieldRepetitions = fieldRepetitions;
        }
...
public HL7V21Field DrugStrength
{
    get
    {
        ...
        if (drugStrength.field.FieldRepetitions != null && drugStrength.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < drugStrength.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V21FieldRepetition
                {
                    fieldRepetition = drugStrength.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < drugStrength.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V21Component
                        {
                            component = drugStrength.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < drugStrength.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V21SubComponent
                                {
                                    subComponent = drugStrength.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = subComponentFieldData.Id,
                                    Type = subComponentFieldData.Type,
                                    Position = subComponentFieldData.Position,
                                    Name = subComponentFieldData.Name,
            ...
            drugStrength.fieldRepetitions = fieldRepetitions;
        }
...
public HL7V21Field FinalConcentration
{
    get
    {
        ...
        if (finalConcentration.field.FieldRepetitions != null && finalConcentration.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < finalConcentration.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V21FieldRepetition
                {
                    fieldRepetition = finalConcentration.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < finalConcentration.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V21Component
                        {
                            component = finalConcentration.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < finalConcentration.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V21SubComponent
                                {
                                    subComponent = finalConcentration.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = subComponentFieldData.Id,
                                    Type = subComponentFieldData.Type,
                                    Position = subComponentFieldData.Position,
                                    Name = subComponentFieldData.Name,
            ...
            finalConcentration.fieldRepetitions = fieldRepetitions;
        }
...
public HL7V21Field FinalVolumeInMl
{
    get
    {
        ...
        if (finalVolumeInMl.field.FieldRepetitions != null && finalVolumeInMl.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < finalVolumeInMl.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V21FieldRepetition
                {
                    fieldRepetition = finalVolumeInMl.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < finalVolumeInMl.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V21Component
                        {
                            component = finalVolumeInMl.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < finalVolumeInMl.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V21SubComponent
                                {
                                    subComponent = finalVolumeInMl.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = subComponentFieldData.Id,
                                    Type = subComponentFieldData.Type,
                                    Position = subComponentFieldData.Position,
                                    Name = subComponentFieldData.Name,
            ...
            finalVolumeInMl.fieldRepetitions = fieldRepetitions;
        }
...
public HL7V21Field DrugDose
{
    get
    {
        ...
        if (drugDose.field.FieldRepetitions != null && drugDose.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < drugDose.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V21FieldRepetition
                {
                    fieldRepetition = drugDose.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < drugDose.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V21Component
                        {
                            component = drugDose.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < drugDose.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V21SubComponent
                                {
                                    subComponent = drugDose.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = subComponentFieldData.Id,
                                    Type = subComponentFieldData.Type,
                                    Position = subComponentFieldData.Position,
                                    Name = subComponentFieldData.Name,
            ...
            drugDose.fieldRepetitions = fieldRepetitions;
        }
...
public HL7V21Field DrugRole
{
    get
    {
        ...
        if (drugRole.field.FieldRepetitions != null && drugRole.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < drugRole.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V21FieldRepetition
                {
                    fieldRepetition = drugRole.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < drugRole.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V21Component
                        {
                            component = drugRole.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < drugRole.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V21SubComponent
                                {
                                    subComponent = drugRole.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = subComponentFieldData.Id,
                                    Type = subComponentFieldData.Type,
                                    Position = subComponentFieldData.Position,
                                    Name = subComponentFieldData.Name,
            ...
            drugRole.fieldRepetitions = fieldRepetitions;
        }
...
public HL7V21Field PrescriptionSequence#
{
    get
    {
        ...
        if (prescriptionSequence#.field.FieldRepetitions != null && prescriptionSequence#.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < prescriptionSequence#.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V21FieldRepetition
                {
                    fieldRepetition = prescriptionSequence#.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < prescriptionSequence#.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V21Component
                        {
                            component = prescriptionSequence#.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < prescriptionSequence#.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V21SubComponent
                                {
                                    subComponent = prescriptionSequence#.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = subComponentFieldData.Id,
                                    Type = subComponentFieldData.Type,
                                    Position = subComponentFieldData.Position,
                                    Name = subComponentFieldData.Name,
            ...
            prescriptionSequence#.fieldRepetitions = fieldRepetitions;
        }
...
public HL7V21Field QuantityDispensed
{
    get
    {
        ...
        if (quantityDispensed.field.FieldRepetitions != null && quantityDispensed.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < quantityDispensed.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V21FieldRepetition
                {
                    fieldRepetition = quantityDispensed.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < quantityDispensed.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V21Component
                        {
                            component = quantityDispensed.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < quantityDispensed.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V21SubComponent
                                {
                                    subComponent = quantityDispensed.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = subComponentFieldData.Id,
                                    Type = subComponentFieldData.Type,
                                    Position = subComponentFieldData.Position,
                                    Name = subComponentFieldData.Name,
            ...
            quantityDispensed.fieldRepetitions = fieldRepetitions;
        }
...
public HL7V21Field DrugId
{
    get
    {
        ...
        if (drugId.field.FieldRepetitions != null && drugId.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < drugId.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V21FieldRepetition
                {
                    fieldRepetition = drugId.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < drugId.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V21Component
                        {
                            component = drugId.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < drugId.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V21SubComponent
                                {
                                    subComponent = drugId.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = subComponentFieldData.Id,
                                    Type = subComponentFieldData.Type,
                                    Position = subComponentFieldData.Position,
                                    Name = subComponentFieldData.Name,
            ...
            drugId.fieldRepetitions = fieldRepetitions;
        }
...
public HL7V21Field ComponentDrugIds
{
    get
    {
        ...
        if (componentDrugIds.field.FieldRepetitions != null && componentDrugIds.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < componentDrugIds.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V21FieldRepetition
                {
                    fieldRepetition = componentDrugIds.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < componentDrugIds.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V21Component
                        {
                            component = componentDrugIds.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < componentDrugIds.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V21SubComponent
                                {
                                    subComponent = componentDrugIds.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = subComponentFieldData.Id,
                                    Type = subComponentFieldData.Type,
                                    Position = subComponentFieldData.Position,
                                    Name = subComponentFieldData.Name,
            ...
            componentDrugIds.fieldRepetitions = fieldRepetitions;
        }
...
public HL7V21Field PrescriptionType
{
    get
    {
        ...
        if (prescriptionType.field.FieldRepetitions != null && prescriptionType.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < prescriptionType.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V21FieldRepetition
                {
                    fieldRepetition = prescriptionType.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < prescriptionType.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V21Component
                        {
                            component = prescriptionType.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < prescriptionType.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V21SubComponent
                                {
                                    subComponent = prescriptionType.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = subComponentFieldData.Id,
                                    Type = subComponentFieldData.Type,
                                    Position = subComponentFieldData.Position,
                                    Name = subComponentFieldData.Name,
            ...
            prescriptionType.fieldRepetitions = fieldRepetitions;
        }
...
public HL7V21Field RxOrderStatus
{
    get
    {
        ...
        if (rxOrderStatus.field.FieldRepetitions != null && rxOrderStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < rxOrderStatus.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V21FieldRepetition
                {
                    fieldRepetition = rxOrderStatus.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < rxOrderStatus.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V21Component
                        {
                            component = rxOrderStatus.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < rxOrderStatus.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V21SubComponent
                                {
                                    subComponent = rxOrderStatus.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = subComponentFieldData.Id,
                                    Type = subComponentFieldData.Type,
                                    Position = subComponentFieldData.Position,
                                    Name = subComponentFieldData.Name,
            ...
            rxOrderStatus.fieldRepetitions = fieldRepetitions;
        }
...
public HL7V21Field RefillsRemaining
{
    get
    {
        ...
        if (refillsRemaining.field.FieldRepetitions != null && refillsRemaining.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < refillsRemaining.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V21FieldRepetition
                {
                    fieldRepetition = refillsRemaining.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < refillsRemaining.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V21Component
                        {
                            component = refillsRemaining.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < refillsRemaining.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V21SubComponent
                                {
                                    subComponent = refillsRemaining.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = subComponentFieldData.Id,
                                    Type = subComponentFieldData.Type,
                                    Position = subComponentFieldData.Position,
                                    Name = subComponentFieldData.Name,
            ...
            refillsRemaining.fieldRepetitions = fieldRepetitions;
        }
...
public HL7V21Field DeaClass
{
    get
    {
        ...
        if (deaClass.field.FieldRepetitions != null && deaClass.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < deaClass.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V21FieldRepetition
                {
                    fieldRepetition = deaClass.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < deaClass.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V21Component
                        {
                            component = deaClass.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < deaClass.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V21SubComponent
                                {
                                    subComponent = deaClass.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = subComponentFieldData.Id,
                                    Type = subComponentFieldData.Type,
                                    Position = subComponentFieldData.Position,
                                    Name = subComponentFieldData.Name,
            ...
            deaClass.fieldRepetitions = fieldRepetitions;
        }
...
public HL7V21Field LastRefillDateTime
{
    get
    {
        ...
        if (lastRefillDateTime.field.FieldRepetitions != null && lastRefillDateTime.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < lastRefillDateTime.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V21FieldRepetition
                {
                    fieldRepetition = lastRefillDateTime.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < lastRefillDateTime.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V21Component
                        {
                            component = lastRefillDateTime.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < lastRefillDateTime.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V21SubComponent
                                {
                                    subComponent = lastRefillDateTime.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = subComponentFieldData.Id,
                                    Type = subComponentFieldData.Type,
                                    Position = subComponentFieldData.Position,
                                    Name = subComponentFieldData.Name,
            ...
            lastRefillDateTime.fieldRepetitions = fieldRepetitions;
        }
...
public HL7V21Field RxNumber
{
    get
    {
        ...
        if (rxNumber.field.FieldRepetitions != null && rxNumber.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < rxNumber.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V21FieldRepetition
                {
                    fieldRepetition = rxNumber.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < rxNumber.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V21Component
                        {
                            component = rxNumber.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < rxNumber.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V21SubComponent
                                {
                                    subComponent = rxNumber.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = subComponentFieldData.Id,
                                    Type = subComponentFieldData.Type,
                                    Position = subComponentFieldData.Position,
                                    Name = subComponentFieldData.Name,
            ...
            rxNumber.fieldRepetitions = fieldRepetitions;
        }
...
public HL7V21Field PrnStatus
{
    get
    {
        ...
        if (prnStatus.field.FieldRepetitions != null && prnStatus.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < prnStatus.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V21FieldRepetition
                {
                    fieldRepetition = prnStatus.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < prnStatus.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V21Component
                        {
                            component = prnStatus.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < prnStatus.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V21SubComponent
                                {
                                    subComponent = prnStatus.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = subComponentFieldData.Id,
                                    Type = subComponentFieldData.Type,
                                    Position = subComponentFieldData.Position,
                                    Name = subComponentFieldData.Name,
            ...
            prnStatus.fieldRepetitions = fieldRepetitions;
        }
...
public HL7V21Field PharmacyInstructions
{
    get
    {
        ...
        if (pharmacyInstructions.field.FieldRepetitions != null && pharmacyInstructions.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < pharmacyInstructions.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V21FieldRepetition
                {
                    fieldRepetition = pharmacyInstructions.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < pharmacyInstructions.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V21Component
                        {
                            component = pharmacyInstructions.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < pharmacyInstructions.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V21SubComponent
                                {
                                    subComponent = pharmacyInstructions.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = subComponentFieldData.Id,
                                    Type = subComponentFieldData.Type,
                                    Position = subComponentFieldData.Position,
                                    Name = subComponentFieldData.Name,
            ...
            pharmacyInstructions.fieldRepetitions = fieldRepetitions;
        }
...
public HL7V21Field PatientInstructions
{
    get
    {
        ...
        if (patientInstructions.field.FieldRepetitions != null && patientInstructions.field.FieldRepetitions.Count > 0)
        {
            ...
            for (var i = 0; i < patientInstructions.field.FieldRepetitions.Count; i++)
            {
                var fieldRepetition = new HL7V21FieldRepetition
                {
                    fieldRepetition = patientInstructions.field.FieldRepetitions[i],
                    Id = fieldData.Id,
                    Type = fieldData.Type,
                    Position = fieldData.Position,
                    Name = fieldData.Name,
                ...
                if (fieldData.FieldDatas != null && fieldData.FieldDatas.Count > 0)
                {
                    ...
                    // there should be components per repetition
                    for (var j = 0; j < patientInstructions.field.Components(i + 1).Count; j++)
                    {
                        var componentFieldData = fieldData.FieldDatas[j];
                        var component = new HL7V21Component
                        {
                            component = patientInstructions.field.FieldRepetitions[i].Components[j],
                            Id = componentFieldData.Id,
                            Type = componentFieldData.Type,
                            Position = componentFieldData.Position,
                            Name = componentFieldData.Name,
                        ...
                        if (componentFieldData.FieldDatas != null && componentFieldData.FieldDatas.Count > 0)
                        {
                            ...
                            for (var k = 0; k < patientInstructions.field.Components(i + 1)[j].SubComponents.Count; k++)
                            {
                                var subComponentFieldData = componentFieldData.FieldDatas[k];
                                var subComponent = new HL7V21SubComponent
                                {
                                    subComponent = patientInstructions.field.FieldRepetitions[i].Components[j].SubComponents[k],
                                    Id = subComponentFieldData.Id,
                                    Type = subComponentFieldData.Type,
                                    Position = subComponentFieldData.Position,
                                    Name = subComponentFieldData.Name,
            ...
            patientInstructions.fieldRepetitions = fieldRepetitions;
        }
