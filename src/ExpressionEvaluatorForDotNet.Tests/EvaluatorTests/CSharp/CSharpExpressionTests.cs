...
namespace ExpressionEvaluatorForDotNet.Tests
{
	...
	public class CSharpExpressionTests
	{
		...
		[DataRow(4.563 + 12 * 3 * 4 + 31 / 3 - 4 * 2 + 3 + 12 % 5, "4.563 + 12 * 3 * 4 + 31 / 3 - 4 * 2 + 3 + 12 % 5", VariableType.Float)]
		[DataRow(-4.563 + -12 * -3 * -4 + -31 / -3 - -4 * -2 + -3 + -12 % -5, "-4.563 + -12 * -3 * -4 + -31 / -3 - -4 * -2 + -3 + -12 % -5", VariableType.Float)]
		[DataRow((((((4) + 12) * 3) * 4) + ((31) / 3) - (4 * 2 + 3)), "(((((4) + 12) * 3) * 4) + ((31) / 3) - (4 * 2 + 3))", VariableType.Int)]
		[DataRow((((((-4) + -12) * -3) * -4) + ((-31) / -3) - (-4 * -2 + -3)), "(((((-4) + -12) * -3) * -4) + ((-31) / -3) - (-4 * -2 + -3))", VariableType.Int)]
		...
		[DataRow(1 > 11 || 2 > 1, "1 > 11 || 2 > 1", VariableType.Boolean)]
		...
		[DataRow(true || false, "true || false", VariableType.Boolean)]
		[DataRow(false || true, "false || true", VariableType.Boolean)]
		[DataRow(false && false && 1 == 11, "false && false && 1 == 11", VariableType.Boolean)]
		[DataRow(false || false || 1 == 11, "false || false || 1 == 11", VariableType.Boolean)]
