...
{
    public class HL7V231DataTypeRP
    {
            ...
            get 
            {
                return new[]
                        ...
                        new HL7V2FieldData
                        {
                            ...
                            Description = @"An ID data type that declares the general type of data. Refer to HL7 table 0191- Type of referenceddata for valid values.",
                            Sample = null,
                            FieldDatas = null
                        },
