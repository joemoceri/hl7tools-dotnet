...
{
    public class HL7V271DataTypeDR
    {
        ...
        public string Description { get { return @"Note: DR cannot be legally expressed when embedded within another data type. Its use is constrained to a segment field."; } }
