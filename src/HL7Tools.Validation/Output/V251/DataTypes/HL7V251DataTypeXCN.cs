...
{
    public class HL7V251DataTypeXCN
    {
        ...
        public string Description { get { return @"Example without assigning authority and assigning facility: |1234567^Everyman^Adam^A^III^DR^PHD^ADT01^^L^4^M11^MR| 
