...
{
    public class HL7V251DataTypeCE
    {
        ...
        public string Description { get { return @"This data type transmits codes and the text associated with the code.
...
Example: |F-11380^CREATININE^I9^2148-5^CREATININE^LN| "; } }
        ...
        public int Length { get { return 483; } }
