...
{
    public class HL7V251DataTypeSAD
    {
        public string Id { get { return @"SAD"; } }

        public string Type { get { return @"DataType"; } }

        public string Name { get { return @"Street Address"; } }

        public string Description { get { return @"This data type specifies an entity's street address and associated detail."; } }

        public string DataType { get { return null; } }

        public string DataTypeName { get { return null; } }

        public int Length { get { return 184; } }
